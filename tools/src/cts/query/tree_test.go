...
func TestNewSingle(t *testing.T) {
	...
	type Node = query.Node[string]
	type QueryData = query.QueryData[string]
	type Children = query.Children[string]
	...
	for _, test := range []Test{
		{ /////////////////////////////////////////////////////////////////////
			...
			expect: Tree{
				Node: Node{
					Children: Children{
						query.ChildKey{`suite`, query.Suite}: {
							Query: Q(`suite`),
							Children: Children{
								query.ChildKey{`*`, query.Files}: {
									Query: Q(`suite:*`),
									Data:  &pass,
								},
							},
						...
						query.ChildKey{`suite`, query.Suite}: {
							...
							Children: Children{
								query.ChildKey{`a`, query.Files}: {
									Query: Q(`suite:a`),
									Children: Children{
										query.ChildKey{`b`, query.Files}: {
											Query: Q(`suite:a,b`),
											Children: Children{
												query.ChildKey{`*`, query.Tests}: {
													Query: Q(`suite:a,b:*`),
													Data:  &pass,
												},
											},
								...
								query.ChildKey{`a`, query.Files}: {
									...
									Children: Children{
										query.ChildKey{`b`, query.Files}: {
											Query: Q(`suite:a,b`),
											Children: Children{
												query.ChildKey{`c`, query.Tests}: {
													Query: Q(`suite:a,b:c`),
													Children: Children{
														query.ChildKey{`*`, query.Cases}: {
															Query: Q(`suite:a,b:c:*`),
															Data:  &pass,
														},
													},
								...
								query.ChildKey{`a`, query.Files}: {
									...
									Children: Children{
										query.ChildKey{`b`, query.Files}: {
											Query: Q(`suite:a,b`),
											Children: Children{
												query.ChildKey{`c`, query.Files}: {
													Query: Q(`suite:a,b,c`),
													Children: Children{
														query.ChildKey{`d`, query.Tests}: {
															Query: Q(`suite:a,b,c:d`),
															Children: Children{
																query.ChildKey{`e`, query.Tests}: {
																	Query: Q(`suite:a,b,c:d,e`),
																	Children: Children{
																		query.ChildKey{`f="g";h=[1,2,3];i=4;*`, query.Cases}: {
																			Query: Q(`suite:a,b,c:d,e:f="g";h=[1,2,3];i=4;*`),
																			Data:  &pass,
																		},
																	},
										...
										query.ChildKey{`b`, query.Files}: {
											...
											Children: Children{
												query.ChildKey{`c`, query.Tests}: {
													Query: Q(`suite:a,b:c`),
													Children: Children{
														query.ChildKey{`d="e";*`, query.Cases}: {
															Query: Q(`suite:a,b:c:d="e";*`),
															Data:  &pass,
														},
													},
									...
									Children: Children{
										query.ChildKey{`c`, query.Tests}: {
											...
											Children: Children{
												...
												query.ChildKey{`f="g";*`, query.Cases}: {
