...
func TestReduce(t *testing.T) {
	...
	for _, test := range []Test{
		{ //////////////////////////////////////////////////////////////////////
			name: "Single variant, different file results",
			in: result.List{
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Single variants, different test results",
			in: result.List{
				{Query: Q(`suite:a,b:*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c:*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Single variant, same file results",
			in: result.List{
				{Query: Q(`suite:a,b,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Single variants, same test results",
			in: result.List{
				{Query: Q(`suite:a,b:*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c:*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
			},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Multiple variants, different file results",
			in: result.List{
				{Query: Q(`suite:a,b,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Multiple variants, different test results",
			in: result.List{
				{Query: Q(`suite:a,b:*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c:*`), Status: result.Pass, Variant: result.Variant{GPU: "Y"}},
				{Query: Q(`suite:a,d:*`), Status: result.Fail, Variant: result.Variant{GPU: "Y"}},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Multiple variants, same file results",
			in: result.List{
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Multiple variants, same test results",
			in: result.List{
				{Query: Q(`suite:a,b:*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c:*`), Status: result.Fail, Variant: result.Variant{GPU: "Y"}},
				{Query: Q(`suite:a,d:*`), Status: result.Fail, Variant: result.Variant{GPU: "Y"}},
		...
		{ //////////////////////////////////////////////////////////////////////
			...
			expect: result.List{
				{Query: Q(`suite:a:*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
		},
		{ //////////////////////////////////////////////////////////////////////
		...
		{ //////////////////////////////////////////////////////////////////////
			...
			skip: !tree.EnableSimplifyCases,
			in: result.List{
				{Query: Q(`suite:a:b:x=1;common="value";*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a:b:x=2;common="value";*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a:b:x=3;common="value";*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a:b:x=4;*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
			expect: result.List{
				{Query: Q(`suite:a:b:x=1;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a:b:x=2;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a:b:x=3;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a:b:x=4;*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
		},
	} {
...
func TestReplace(t *testing.T) {
	...
	for _, test := range []Test{
		{ //////////////////////////////////////////////////////////////////////
			name: "Replace file. Direct. Single variant",
			base: result.List{
				{Query: Q(`suite:a,b,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:a,b,*`),
			variant: result.Variant{GPU: "X"},
			status:  result.Skip,
			expect: result.List{
				{Query: Q(`suite:a,b,*`), Status: result.Skip, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
		},
		{ //////////////////////////////////////////////////////////////////////
			name: "Replace file. Direct. Multiple variants",
			base: result.List{
				{Query: Q(`suite:a,b,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,b,*`), Status: result.Fail, Variant: result.Variant{GPU: "Y"}},
				{Query: Q(`suite:a,c,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:a,b,*`),
			variant: result.Variant{GPU: "X"},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Replace file. Indirect. Single variant",
			base: result.List{
				{Query: Q(`suite:a,b,c,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,b,d,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,c,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:a,b,*`),
			variant: result.Variant{GPU: "X"},
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Replace file. Indirect. Multiple variants",
			base: result.List{
				{Query: Q(`suite:a,b,c,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,b,d,*`), Status: result.Pass, Variant: result.Variant{GPU: "Y"}},
				{Query: Q(`suite:a,c,*`), Status: result.Pass, Variant: result.Variant{GPU: "Z"}},
			},
			query:   Q(`suite:a,b,*`),
			variant: result.Variant{GPU: "X"},
			status:  result.Skip,
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "File vs Test",
			base: result.List{
				{Query: Q(`suite:a,b:c,*`), Status: result.Crash, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,b:d,*`), Status: result.Abort, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,b,c,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:a,b,d,*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:a,b,*`),
		...
		{ //////////////////////////////////////////////////////////////////////
			name: "Cases. * with *",
			base: result.List{
				{Query: Q(`suite:file:test:*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:file:test:*`),
			variant: result.Variant{GPU: "X"},
			status:  result.Pass,
			expect: result.List{
				{Query: Q(`suite:file:test:*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
		},
		{ //////////////////////////////////////////////////////////////////////
			name: "Cases. Mixed with *",
			base: result.List{
				{Query: Q(`suite:file:test:a=1,*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:file:test:a=2,*`), Status: result.Skip, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:file:test:a=3,*`), Status: result.Crash, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:file:test:*`),
			variant: result.Variant{GPU: "X"},
			status:  result.Pass,
		...
		{ //////////////////////////////////////////////////////////////////////
			...
			base: result.List{
				{Query: Q(`suite:file:test:a=1;b=x;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:file:test:a=1;b=y;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:file:test:a=2;b=y;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
			},
			query:   Q(`suite:file:test:a=1;*`),
			variant: result.Variant{GPU: "X"},
			status:  result.Pass,
			expect: result.List{
				{Query: Q(`suite:file:test:a=1;*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:file:test:a=2;b=y;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
			},
		},
		{ //////////////////////////////////////////////////////////////////////
			...
			expect: result.List{
				{Query: Q(`suite:file:test:a=1;b=x;*`), Status: result.Fail, Variant: result.Variant{GPU: "X"}},
				{Query: Q(`suite:file:test:b=y;*`), Status: result.Pass, Variant: result.Variant{GPU: "X"}},
			},
		},
	} {
		...
		err = tree.Replace(test.query, test.variant, test.status)
		if err != nil {
