...
func TestReduce(t *testing.T) {
	...
	for _, test := range []Test{
		...
		{ //////////////////////////////////////////////////////////////////////
			...
			results: result.List{
				{Query: Q("a:b,c:d,*"), Tags: T("x", "1"), Status: result.Pass},
				{Query: Q("a:b,c:d,*"), Tags: T("x", "2"), Status: result.Fail},
				{Query: Q("a:b,c:d,*"), Tags: T("x", "3"), Status: result.Pass},
				{Query: Q("a:b,c:d,*"), Tags: T("y", "1"), Status: result.Fail},
				{Query: Q("a:b,c:d,*"), Tags: T("y", "2"), Status: result.Pass},
				...
				{Query: Q("a:b,c:d,*"), Tags: T("z", "3"), Status: result.Fail},
			},
			expect: result.List{
				{Query: Q("a:b,c:d,*"), Tags: T("x", "1"), Status: result.Pass},
				{Query: Q("a:b,c:d,*"), Tags: T("x", "2"), Status: result.Fail},
		...
		test.results.Reduce()
		if diff := cmp.Diff(test.results, test.expect); diff != "" {
