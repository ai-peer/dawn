...
func TestUpdate(t *testing.T) {
	...
	for _, test := range []Test{
		{ //////////////////////////////////////////////////////////////////////
			...
			expectations: `crbug.com/a/123 a:b,c:* [ FAIL ]`,
			results: result.List{
				result.Result{
					Query:   Q("some:other,test,a:*"),
					Variant: result.Variant{OS: "os_a", GPU: "gpu_a"},
					Status:  result.Pass,
				},
				result.Result{
					Query:   Q("some:other,test,b:*"),
			...
			updated: ``,
			messages: []expectations.Diagnostic{
				{1, "no result found for query 'a:b,c:*' for [OS: 'os_a', GPU: 'gpu_a']"},
				{1, "no result found for query 'a:b,c:*' for [OS: 'os_b', GPU: 'gpu_b']"},
			},
		}, { ///////////////////////////////////////////////////////////////////
