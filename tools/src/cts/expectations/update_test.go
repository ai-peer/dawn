...
[ os-a ] some:other,test:* [ Failure ]
[ os-b ] some:other,test:* [ Failure ]
`,
			results: result.List{
				result.Result{
...
crbug.com/dawn/0000 [ os-a ] suite:dir_a,dir_b:test_b:* [ Skip ]
crbug.com/dawn/0000 suite:dir_a,dir_b:test_c:* [ Failure ]
`,
		},
		{ //////////////////////////////////////////////////////////////////////
