...
// A chunk is an optional comment followed by a run of expectations.
...
// A named collection of tags, parsed from the 'TAG HEADER'
type TagSet struct {
...
// Returns true if the Content has no chunks.
