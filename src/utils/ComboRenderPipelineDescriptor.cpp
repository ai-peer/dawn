...
namespace utils {
    ...
    ComboVertexStateDescriptor::ComboVertexStateDescriptor() {
        ...
        // cVertexBuffers[i].attributes points to somewhere in cAttributes. cVertexBuffers[0].attributes
        // points to &cAttributes[0] by default. Assuming cVertexBuffers[0] has two attributes, then
        // cVertexBuffers[1].attributes should point to &cAttributes[2]. Likewise, if cVertexBuffers[1]
        // has 3 attributes, then cVertexBuffers[2].attributes should point to &cAttributes[5].
