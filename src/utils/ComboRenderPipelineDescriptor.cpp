...
namespace utils {
    ...
    ComboVertexInputDescriptor::ComboVertexInputDescriptor() {
        ...
        // cBuffers[i].attributes points to somewhere of cAttributes. cBuffers[0].attributes
        // points to &cAttributes[0] by default. If cBuffers[0] has two attributes, then
