...
namespace utils {
    ...
    namespace {
        ...
        class WireServerTraceLayer : public dawn_wire::CommandHandler {
            struct ScopedWireTraceImpl : WireHelper::ScopedWireTrace {
          ...
          public:
            ...
            std::unique_ptr<WireHelper::ScopedWireTrace> BeginScopedWireTrace(const char* name) {
                ...
                return std::unique_ptr<WireHelper::ScopedWireTrace>(
    ...
    std::unique_ptr<WireHelper::ScopedWireTrace> WireHelper::BeginScopedWireTrace(
        const char* name) {
