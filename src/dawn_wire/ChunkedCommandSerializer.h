    ...
    class ChunkedCommandSerializer {
      public:
        ...
        void SerializeCommand(const Cmd& cmd) {
            SerializeCommand(cmd, 0, [](SerializeBuffer*) {});
        }
        ...
        void SerializeCommand(const Cmd& cmd, const ObjectIdProvider& objectIdProvider) {
            SerializeCommand(cmd, objectIdProvider, 0, [](SerializeBuffer*) {});
        }
        ...
        void SerializeCommandImpl(const Cmd& cmd,
            ...
            if (requiredSize <= mMaxAllocationSize) {
                ...
                if (allocatedBuffer != nullptr) {
                    ...
                    SerializeCmd(cmd, requiredSize, &serializeBuffer);
                    SerializeExtraSize(&serializeBuffer);
                }
                return;
            }
