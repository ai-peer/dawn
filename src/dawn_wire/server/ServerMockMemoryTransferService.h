...
#ifndef DAWNWIRE_SERVER_SERVERMOCKMEMORYTRANSFERSERVICE_H_
#define DAWNWIRE_SERVER_SERVERMOCKMEMORYTRANSFERSERVICE_H_
    ...
    class MockMemoryTransferService : public MemoryTransferService {
        class MockReadHandle : public ReadHandle {
          public:
            ...
            size_t SerializeInitialData(const void* data, size_t dataLength, void* serializePointer) override;
      ...
      public:
        ...
        MOCK_METHOD3(OnDeserializeReadHandle,
                     bool(const void* deserializePointer,
                          size_t deserializeSize,
...
#endif  // DAWNWIRE_SERVER_SERVERMOCKMEMORYTRANSFERSERVICE_H_
