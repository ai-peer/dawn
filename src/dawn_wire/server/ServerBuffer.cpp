...
namespace dawn_wire { namespace server {
    ...
    bool Server::DoBufferMapAsync(ObjectId bufferId,
        ...
        // if (isWriteMode) {
        //     // // Deserialize metadata produced from the client to create a companion server
        //     handle.
        //     // MemoryTransferService::WriteHandle* writeHandle = nullptr;
        //     // if (!mMemoryTransferService->DeserializeWriteHandle(
        //     //         handleCreateInfo, static_cast<size_t>(handleCreateInfoLength),
        //     &writeHandle)) {
        //     //     return false;
        //     // }
    ...
    bool Server::DoDeviceCreateBuffer(ObjectId deviceId,
        ...
        if (isWriteMode) {
            ...
            resultData->readHandle = std::unique_ptr<MemoryTransferService::ReadHandle>(readHandle);
        }
