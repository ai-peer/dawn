      ...
      public:
        ...
        class WriteHandleImpl : public WriteHandle {
          public:
            ...
            bool DeserializeClose(const void* deserializePointer, size_t deserializeSize) override {
        ...
        bool DeserializeReadHandle(const void* ptr,
        ...
        bool DeserializeWriteHandle(const void* ptr,
                                    size_t deserializeSize,
