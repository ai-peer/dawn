...
namespace dawn_wire { namespace client {
    ...
    void ClientBufferMapWriteAsync(DawnBuffer cBuffer,
        ...
        // Store a mapping from serial -> MapRequest. It is invalid to map a buffer more than once,
        // but a client may do so and we need to track each request individually.
        buffer->requests[serial] = std::move(request);
    ...
    DawnCreateBufferMappedResult ClientDeviceCreateBufferMapped(
        ...
        // available. The buffer now owns the WriteHandle.
