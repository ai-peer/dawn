...
namespace dawn_wire { namespace client {
    ...
    bool ClientImpl::HandleDeviceErrorCallback(const char** commands, size_t* size) {
    ...
    bool ClientImpl::HandleBufferMapReadAsyncCallback(const char** commands, size_t* size) {
    ...
    bool ClientImpl::HandleBufferMapWriteAsyncCallback(const char** commands, size_t* size) {
    ...
    bool ClientImpl::HandleFenceUpdateCompletedValue(const char** commands, size_t* size) {
