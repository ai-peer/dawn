...
namespace dawn_wire { namespace client {
    ...
    ShaderModule::~ShaderModule() {
        mCompilationInfoRequests.CloseAll([](CompilationInfoRequest* request) {
            request->callback(WGPUCompilationInfoRequestStatus_Unknown, nullptr, request->userdata);
        });
    }
    ...
    void ShaderModule::CancelCallbacksForDisconnect() {
        mCompilationInfoRequests.CloseAll([](CompilationInfoRequest* request) {
            request->callback(WGPUCompilationInfoRequestStatus_DeviceLost, nullptr,
                              request->userdata);
        });
    }
