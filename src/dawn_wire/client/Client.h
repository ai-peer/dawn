...
namespace dawn_wire { namespace client {
    ...
    class Client : public ClientBase {
      public:
        ...
        template <typename T>
        T* FindAncestor() {
            // Hacky workaround to used to keep support of the autogenerated, deprecated,
            // same-device validation. TODO(enga): Remove when the old validation is removed.
            static_assert(std::is_same<T, Client>::value || std::is_same<T, Device>::value, "");
            if (std::is_same<T, Client>::value) {
                return reinterpret_cast<T*>(this);
            }
            return reinterpret_cast<T*>(mDevice);
        }
        ...
        const T* FindAncestor() const {
            ...
            return reinterpret_cast<const T*>(mDevice);
        }
