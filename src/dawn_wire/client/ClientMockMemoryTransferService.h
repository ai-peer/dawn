...
#ifndef DAWNWIRE_CLIENT_CLIENTMOCKMEMORYTRANSFERSERVICE_H_
#define DAWNWIRE_CLIENT_CLIENTMOCKMEMORYTRANSFERSERVICE_H_
...
#endif  // DAWNWIRE_CLIENT_CLIENTMOCKMEMORYTRANSFERSERVICE_H_
