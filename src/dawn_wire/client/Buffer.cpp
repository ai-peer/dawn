...
namespace dawn_wire { namespace client {
    ...
    void Buffer::Unmap() {
        ...
        // TODO: find a way to throw validation error for map allocation failure
        // and separate from destroy before unmap (have a flag)
        ...
        cmd.self = ToAPI(this);
        client->SerializeCommand(cmd);
        return;  // TODO change to return bool for map oom handling
    }
