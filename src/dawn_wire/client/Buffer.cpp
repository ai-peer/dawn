...
namespace dawn_wire { namespace client {
    ...
    WGPUBuffer Buffer::Create(Device* device, const WGPUBufferDescriptor* descriptor) {
        ...
        if (mappable) {
            if ((descriptor->usage & WGPUBufferUsage_MapRead) != 0) {
                ...
                mappedData = const_cast<void*>(readHandle->GetData());
                // If allocation failed the readHandle would be nullptr and rejected earlier
            ...
            if ((descriptor->usage & WGPUBufferUsage_MapWrite) != 0 ||
                ...
                mappedData = writeHandle->GetData();
        ...
        if (descriptor->mappedAtCreation) {
            ...
            buffer->mIsMappingWrite = descriptor->mappedAtCreation;
            ...
            buffer->mDestructWriteHandleOnUnmap =
                descriptor->mappedAtCreation && (descriptor->usage & WGPUBufferUsage_MapWrite) == 0;
        ...
        wireClient->SerializeCommand(
            ...
            [&](SerializeBuffer* serializeBuffer) {
                ...
                if (writeHandle != nullptr) {
                    ...
                    // This could overwrite readHandle's mappedData if buffer is both MapRead and
                    // mappedAtCreation. We will call mReadHandle->GetData() again at unmap for this
                    // special case.
                    buffer->mMappedData = mappedData;
                }
    ...
    void Buffer::MapAsync(WGPUMapModeFlags mode,
        ...
        if (mode & WGPUMapMode_Read) {
            ...
            // just to be safe not having uninitialized value
            request.type = MapRequestType::None;
        }
    ...
    void Buffer::Unmap() {
        ...
        // mWriteHandle can still be nullptr if buffer could be destroyed before unmap
