...
namespace dawn_wire { namespace client {
    ...
    void Buffer::MapAsync(WGPUMapModeFlags mode,
        ...
        // Step 1. Create the request structure that will hold information while this mapping is
        // in flight.
        ...
        request.type = isReadMode ? wgpu::MapMode::Read : wgpu::MapMode::Write;

        // Step 2. Serialize the command to send to the server.
        ...
        // Step 3. Register this request so that we can retrieve it from its serial when the server
        // sends the callback.
