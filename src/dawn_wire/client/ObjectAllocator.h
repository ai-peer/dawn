...
namespace dawn_wire { namespace client {
    ...
    class ObjectAllocator {
      ...
      public:
        ...
        void Free(T* obj) {
            if (!obj->IsInList()) {
                // If the object is not in the linked list, it has already been destroyed. This may
                // happen if the wire client is destroyed before an object's refcount reaches 0.
                return;
            }
