...
#ifndef DAWNWIRE_CLIENT_WIRECLIENTOBJECTALLOCATOR_H_
#define DAWNWIRE_CLIENT_WIRECLIENTOBJECTALLOCATOR_H_
...
#endif  // DAWNWIRE_CLIENT_WIRECLIENTOBJECTALLOCATOR_H_
