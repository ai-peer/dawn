...
namespace dawn_wire { namespace client {
    ...
    bool Client::DoBufferMapReadAsyncCallback(Buffer* buffer,
                                              ...
                                              const uint8_t* handleInitializeInfo) {
        ...
        if (status == DAWN_BUFFER_MAP_ASYNC_STATUS_SUCCESS) {
            ...
            std::tie(mappedData, mappedDataLength) = buffer->readHandle->DeserializeOpen(
                handleInitializeInfo, handleInitializeInfoLength);
