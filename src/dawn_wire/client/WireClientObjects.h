...
#ifndef DAWNWIRE_CLIENT_WIRECLIENTOBJECTS_H_
#define DAWNWIRE_CLIENT_WIRECLIENTOBJECTS_H_
...
namespace dawn_wire { namespace client {
    ...
    struct ObjectBase {
        ObjectBase(WireClient* client, uint32_t refcount, uint32_t id)
...
#include "dawn_wire/client/WireClientObjects_autogen.h"

#endif  // DAWNWIRE_CLIENT_WIRECLIENTOBJECTS_H_
