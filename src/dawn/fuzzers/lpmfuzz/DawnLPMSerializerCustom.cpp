...
void GetCustomSerializedData(const fuzzing::Command& command,
                             ...
                             ityp::array<ObjectType, DawnLPMObjectStore, 24>& gObjectStores,
    ...
    switch (command.command_case()) {
        case fuzzing::Command::kDeviceCreateShaderModule: {
            ...
            if (cmd_self_id == static_cast<ObjectId>(DawnLPMFuzzer::invalid_object_id)) {
                break;
            }
            ...
            if (gObjectStores[ObjectType::ShaderModule].size() >= DawnLPMFuzzer::shader_module_limit) {
                break;
            }
        ...
        case fuzzing::Command::kDestroyObject: {
            ...
            if (cmd.objectId == static_cast<ObjectId>(DawnLPMFuzzer::invalid_object_id)) {
                break;
            }
