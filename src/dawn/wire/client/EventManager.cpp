...
void EventManager::ProcessPollEvents() {
    ...
    // TODO(crbug.com/dawn/1987): We shouldn't bother to track ProcessEvents-type events at all
    // until they've completed. We can queue them up when they're received on the wire.
    mTrackedEvents.Use([&](auto trackedEvents) {
