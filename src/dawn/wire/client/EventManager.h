...
enum class EventStatus {
    ...
    Ready,
    // The event is completing because the wire (or just the instance) is shutting down.
    Shutdown,
};
// Code to run to complete the event (after receiving a ready notification from the wire).
using EventCallback = std::function<void(EventStatus)>;
...
//
// TODO(crbug.com/dawn/1987): Can this eventually replace RequestTracker?
