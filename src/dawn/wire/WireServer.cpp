...
bool WireServer::InjectTexture(WGPUTexture texture,
    ...
    return mImpl->InjectTexture(texture, id, generation, deviceId, deviceGeneration) == WireResult::Success;
}
...
bool WireServer::InjectSwapChain(WGPUSwapChain swapchain,
                                 ...
                                 uint32_t deviceId,
                                 uint32_t deviceGeneration) {
    return mImpl->InjectSwapChain(swapchain, id, generation, deviceId, deviceGeneration) == WireResult::Success;
}
