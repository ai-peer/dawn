...
TEST_P(DepthStencilCopyTests, RegressionDawn1083) {
    uint32_t mipLevelCount = 2;
...
DAWN_INSTANTIATE_TEST_P(
    ...
    {D3D12Backend(), MetalBackend(),
     MetalBackend({"use_blit_for_texture_to_texture_copy_to_nonzero_depth_layer"}),
...
DAWN_INSTANTIATE_TEST_P(
    ...
    {D3D12Backend(),
     ...
     MetalBackend(), MetalBackend({"use_blit_for_texture_to_texture_copy_to_nonzero_depth_layer"}),
