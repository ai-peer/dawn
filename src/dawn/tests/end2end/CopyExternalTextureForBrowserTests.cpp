...
class CopyExternalTextureForBrowserTests : public Parent {
  protected:
    wgpu::ExternalTexture CreateDefaultExternalTexture() {
        ...
        this->queue.WriteTexture(&plane0, yPlaneData.data(), yPlaneData.size() * sizeof(uint8_t),
        ...
        this->queue.WriteTexture(&plane1, uvPlaneData.data(), uvPlaneData.size() * sizeof(uint8_t),
