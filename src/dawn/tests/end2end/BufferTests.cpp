  ...
  protected:
    void SubmitCommandBuffer(wgpu::Buffer buffer) {
...

        {
            ...
            // quickly.
            wgpu::Buffer tempWriteBuffer = CreateMapWriteBuffer(4);
            wgpu::Buffer tempReadBuffer = CreateMapReadBuffer(4);
            for (int i = 0; i < kRepeatCount; ++i) {
                encoder.CopyBufferToBuffer(tempWriteBuffer, 0, tempReadBuffer, 0, 4);
            }
        }
