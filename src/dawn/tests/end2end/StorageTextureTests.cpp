...
TEST_P(StorageTextureTests, WriteonlyStorageTextureInComputeShader) {
    for (wgpu::TextureFormat format : utils::kAllTextureFormats) {
        ...
        // BGRA8Unorm has not been supported as storage textures on OpenGL ES backends with ANGLE.
        // right now.
        // TODO(crbug.com/dawn/1641): Support BGRA8Unorm as storage textures on Vulkan.
        if (format == wgpu::TextureFormat::BGRA8Unorm && (IsVulkan() || IsOpenGLES())) {
            continue;
        }
