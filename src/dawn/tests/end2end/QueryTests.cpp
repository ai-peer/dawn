...
TEST_P(TimestampQueryTests, TimestampOnCommandEncoder) {
    // TODO (dawn:1473): Metal bug: It fails to store GPU counters to sample buffer on a blit pass
    // encoder without any commands.
...
TEST_P(TimestampQueryTests, TimestampWritesOnComputePass) {
    ...
    // TODO (dawn:1473): Metal bug: It fails to store GPU counters to different sample buffer in the
    // second case.
