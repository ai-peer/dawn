...
DAWN_INSTANTIATE_TEST_P(D3D12SharedHandleValidation, {D3D12Backend()});
DAWN_INSTANTIATE_TEST_P(D3D12SharedHandleUsageTests, {D3D12Backend()});
DAWN_INSTANTIATE_TEST_P(D3D12SharedHandleMultithreadTests, {D3D12Backend()});
