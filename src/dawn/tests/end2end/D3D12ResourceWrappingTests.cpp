  ...
  protected:
    std::unique_ptr<dawn::native::d3d12::ExternalImageDXGI> CreateExternalImage(
        ...
        std::unique_ptr<dawn::native::d3d12::ExternalImageDXGI> externalImage =
            dawn::native::d3d12::ExternalImageDXGI::Create(device, &externalImageDesc);
...
TEST_P(D3D12SharedHandleUsageTests, ConcurrentExternalImageReadAccess) {
    ...
    dawn::native::d3d12::ExternalImageDXGIFenceDescriptor signalFence3;
    {
        ...
        AddTextureExpectation(__FILE__, __LINE__, solidRed, texture2.Get(), /*origin=*/{0, 0, 0},
                              /*level=*/0, wgpu::TextureAspect::All, /*bytesPerRow=*/0, device2);
        AddTextureExpectation(__FILE__, __LINE__, solidRed, texture3.Get(), /*origin=*/{0, 0, 0},
                              /*level=*/0, wgpu::TextureAspect::All, /*bytesPerRow=*/0, device3);
    ...
    dawn::native::d3d12::ExternalImageDXGIFenceDescriptor signalFence4;
    {
        ...
        const utils::RGBA8 solidRed(0xFF, 0, 0, 0xFF);
        AddTextureExpectation(__FILE__, __LINE__, solidRed, texture4.Get(), /*origin=*/{0, 0, 0},
                              /*level=*/0, wgpu::TextureAspect::All, /*bytesPerRow=*/0, device4);
    ...
    // Concurrent read access on device 1 (twice), 2 and 3.
    {
        ...
        EXPECT_PIXEL_RGBA8_EQ(solidBlue, texture.Get(), 0, 0);
        EXPECT_PIXEL_RGBA8_EQ(solidBlue, texture1.Get(), 0, 0);

        AddTextureExpectation(__FILE__, __LINE__, solidBlue, texture2.Get(), /*origin=*/{0, 0, 0},
                              /*level=*/0, wgpu::TextureAspect::All, /*bytesPerRow=*/0, device2);
        AddTextureExpectation(__FILE__, __LINE__, solidBlue, texture3.Get(), /*origin=*/{0, 0, 0},
                              /*level=*/0, wgpu::TextureAspect::All, /*bytesPerRow=*/0, device3);
