...
// Tests creating texture views.
TEST_P(VideoViewsRenderTargetTests, CreateViewWithRenderAttachmentValidation) {
    auto platformTexture =
        mBackend->CreateVideoTextureForTest(GetFormat(), wgpu::TextureUsage::RenderAttachment,
                                            /*isCheckerboard*/ true,
                                            /*initialized*/ true);
...
// TODO(crbug.com/dawn/1337): Create similar test for P010.
