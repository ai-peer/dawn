...
TEST_P(VideoViewsValidationTests, RenderToMultiplanarVideoTexture) {
    ...
    std::vector<uint8_t> r8SourceData = GetTestTextureDataWithPlaneIndex(
    ...
    std::vector<uint8_t> rg8SourceData = GetTestTextureDataWithPlaneIndex(
    ...
    // Perform operations for the Y plane.
    {
        ...
        std::vector<uint8_t> expectedLumaData = GetTestTextureDataWithPlaneIndex(
    ...
    // Perform operations for the UV plane.
    {
        ...
        std::vector<uint8_t> expectedChromaData =
