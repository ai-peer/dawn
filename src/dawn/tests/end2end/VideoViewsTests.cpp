...
class VideoViewsPlatformTextureTests : public VideoViewsTests {
  protected:
    void SetUp() override {
...
TEST_P(VideoViewsPlatformTextureTests, CreateVideoTextureWithoutInitializedData) {
    ASSERT_DEVICE_ERROR(
...
TEST_P(VideoViewsPlatformTextureTests, NV12SampleYtoR) {
    std::unique_ptr<VideoViewsTestBackend::PlatformTexture> platformTexture =
        mBackend->CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
                                            wgpu::TextureUsage::TextureBinding,
                                            /*isCheckerboard*/ false,
...
TEST_P(VideoViewsPlatformTextureTests, NV12SampleUVtoRG) {
    std::unique_ptr<VideoViewsTestBackend::PlatformTexture> platformTexture =
        mBackend->CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
                                            wgpu::TextureUsage::TextureBinding,
                                            /*isCheckerboard*/ false,
...
TEST_P(VideoViewsPlatformTextureTests, NV12SampleYUVtoRGB) {
    std::unique_ptr<VideoViewsTestBackend::PlatformTexture> platformTexture =
        mBackend->CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
                                            wgpu::TextureUsage::TextureBinding,
                                            /*isCheckerboard*/ true,
...
TEST_P(VideoViewsPlatformTextureTests, NV12SampleYUVtoRGBMultipleSamplers) {
    std::unique_ptr<VideoViewsTestBackend::PlatformTexture> platformTexture =
        mBackend->CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
                                            wgpu::TextureUsage::TextureBinding,
                                            /*isCheckerboard*/ true,
...
class VideoViewsValidationTests : public VideoViewsPlatformTextureTests {
  protected:
    void SetUp() override {
        VideoViewsPlatformTextureTests::SetUp();
...
DAWN_INSTANTIATE_TEST_V(VideoViewsPlatformTextureTests, VideoViewsTestBackend::Backends());
