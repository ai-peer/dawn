...
bool VideoViewsTests::IsFormatSupported() const {
...
wgpu::TextureFormat VideoViewsTests::GetFormat() const {
    return GetParam().mFormat;
}

wgpu::TextureFormat VideoViewsTests::GetPlaneFormat(int plane) const {
    switch (GetFormat()) {
        case wgpu::TextureFormat::R8BG8Biplanar420Unorm:
