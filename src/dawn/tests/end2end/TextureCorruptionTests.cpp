...
enum class WriteType {
    ...
    Rendering,     // Write the tested texture via rendering the whole rectangle with solid color
                   // (0xFFFFFFFF)
    SamplingAndWrite,  // Write the tested texture via sampling from a temp texture and writing the
                       // sampled data
    TextureLoadAndWrite  // Write the tested texture via textureLoad() from a temp texture and
