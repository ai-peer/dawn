...
// test for dawn:1083 where Intel Metal devices fail to do that correctly, requiring a workaround.
class RenderPassTest_RegressionDawn1083 : public RenderPassTest {};
TEST_P(RenderPassTest_RegressionDawn1083, ClearMultisubresourceAfterWriteDepth16Unorm) {
...
DAWN_INSTANTIATE_TEST(RenderPassTest_RegressionDawn1083,
                      D3D12Backend(),
                      MetalBackend(),
