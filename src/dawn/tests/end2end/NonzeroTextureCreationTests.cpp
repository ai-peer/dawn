    ...
    class NonzeroTextureCreationTests : public DawnTestWithParams<Params> {
      protected:
        ...
        void Run() {
            ...
            // TODO(crbug.com/dawn/667): ANGLE claims to support NV_read_stencil, but won't read correctly from
            // a depth/stencil texture.
            DAWN_SUPPRESS_TEST_IF(GetParam().mAspect == wgpu::TextureAspect::StencilOnly &&
                                  IsANGLE());
