    ...
    auto GenerateParams() {
        auto params = MakeParamGenerator<ComputeLayoutMemoryBufferTestParams>(
            ...
            {StorageClass::Storage, StorageClass::Uniform},
            {
                ...
                Field{"array<vec4<u32>, 1>", /* align */ 16, /* size */ 16}.StorageBufferOnly(),
                Field{"array<vec4<u32>, 2>", /* align */ 16, /* size */ 32}.StorageBufferOnly(),
                Field{"array<vec4<u32>, 3>", /* align */ 16, /* size */ 48}.StorageBufferOnly(),
                Field{"array<vec4<u32>, 4>", /* align */ 16, /* size */ 64}.StorageBufferOnly(),
