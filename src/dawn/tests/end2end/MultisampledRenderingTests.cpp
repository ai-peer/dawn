  ...
  protected:
    ...
    wgpu::Texture CreateTextureForRenderAttachment(wgpu::TextureFormat format,
        ...
        if (supportMSAARenderToSingleSampled) {
            descriptor.usage |= wgpu::TextureUsage::MSAARenderToSingleSampledAttachment;
        }
...
TEST_P(MultisampledRenderToSingleSampledTest, DrawThenLoad) {
    ...
    wgpu::DawnRenderPassDescriptorRenderToSingleSampled mssaRenderToSingleSampledDesc;
    mssaRenderToSingleSampledDesc.sampleCount = kSampleCount;
    ...
    // In first render pass we draw a green triangle.
    {
        utils::ComboRenderPassDescriptor renderPass = CreateComboRenderPassDescriptorForTest(
            ...
            /*testDepth=*/false);
        renderPass.nextInChain = &mssaRenderToSingleSampledDesc;
...
// Test clear a color attachment and start another render pass with LoadOp::Load plus additional
...
TEST_P(MultisampledRenderToSingleSampledTest, ClearThenLoadThenDraw) {
    ...
    // In first render pass we clear to red.
    {
        utils::ComboRenderPassDescriptor renderPass = CreateComboRenderPassDescriptorForTest(
            {singleSampledTextureView}, {nullptr}, wgpu::LoadOp::Clear, wgpu::LoadOp::Clear,
            /*testDepth=*/false);
    ...
    // In second render pass we use LoadOp::Load then draw a green triangle.
    {
        utils::ComboRenderPassDescriptor renderPass = CreateComboRenderPassDescriptorForTest(
            {singleSampledTextureView}, {nullptr}, wgpu::LoadOp::Load, wgpu::LoadOp::Load,
            /*testDepth=*/false);
