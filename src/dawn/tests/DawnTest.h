...
class DawnTestBase {
  ...
  protected:
    ...
    std::ostringstream& AddTextureExpectation(const char* file,
                                              ...
                                              wgpu::TextureAspect aspect = wgpu::TextureAspect::All,
                                              uint32_t bytesPerRow = 0) {
        return AddTextureExpectationImpl(file, line, targetDevice,
    ...
    std::ostringstream& AddTextureExpectation(const char* file,
                                              ...
                                              wgpu::TextureAspect aspect = wgpu::TextureAspect::All,
                                              uint32_t bytesPerRow = 0) {
        return AddTextureExpectationImpl(file, line, targetDevice, expectation, texture, origin,
                                         extent, level, aspect, expectation->DataSize(),
                                         bytesPerRow);
    }
    ...
    std::ostringstream& AddTextureBetweenColorsExpectation(
        ...
        uint32_t bytesPerRow = 0) {
        return AddTextureExpectationImpl(
            file, line, targetDevice, new detail::ExpectBetweenColors<T>(color0, color1), texture,
            {x, y}, {1, 1}, level, aspect, sizeof(T), bytesPerRow);
    }
