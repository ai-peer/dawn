...
WGPUDevice DawnTestBase::CreateDeviceImpl(std::string isolationKey) {
    ...
    deviceDescriptor.deviceLostUserdata = mDeviceLostCallback.MakeUserdata(this);
    EXPECT_CALL(mDeviceLostCallback, Call(WGPUDeviceLostReason_Destroyed, testing::_, this))
...
void DawnTestBase::LoseDeviceForTesting(wgpu::Device device) {
    ...
    EXPECT_CALL(mDeviceLostCallback, Call(WGPUDeviceLostReason_Undefined, testing::_, this))
        .Times(1);
