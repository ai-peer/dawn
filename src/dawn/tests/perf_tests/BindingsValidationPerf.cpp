...
struct BindingsValidationPerf : AdapterTestParam {
    BindingsValidationPerf(const AdapterTestParam& param,
    ...
    wgpu::Buffer mStorageBuffers[kNumDraws];
...
std::ostream& operator<<(std::ostream& ostream, const BindingsValidationPerf& param) {
...
// Test
class BindingsValidationPerf : public DawnPerfTestWithParams<BindingsValidationPerf> {
  public:
    BindingsValidationPerf()
...
void BindingsValidationPerf::SetUp() {
    DawnPerfTestWithParams<BindingsValidationPerf>::SetUp();
