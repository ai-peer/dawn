...
namespace dawn::wire {
    ...
    namespace {
        ...
        std::unique_ptr<testing::StrictMock<MockBufferMapCallback>> mockBufferMapCallback;
    ...
    class WireMemoryTransferServiceTests : public WireTest {
      public:
        ...
        void SetUp() override {
            ...
            mockBufferMapCallback = std::make_unique<testing::StrictMock<MockBufferMapCallback>>();
        ...
        void FlushClient(bool success = true) {
            ...
            testing::Mock::VerifyAndClearExpectations(&serverMemoryTransferService);
        }

        void FlushServer(bool success = true) {
            WireTest::FlushServer(success);

            testing::Mock::VerifyAndClearExpectations(&mockBufferMapCallback);
            testing::Mock::VerifyAndClearExpectations(&clientMemoryTransferService);
        }
      ...
      protected:
        ...
        std::pair<WGPUBuffer, WGPUBuffer> CreateBufferMapped(
            ...
            EXPECT_CALL(api, BufferGetMappedRange(apiBuffer, 0, sizeof(mBufferContent)))
                .WillOnce(testing::Return(&mMappedBufferContent));
        ...
        ClientReadHandle* ExpectReadHandleCreation() {
            ...
            EXPECT_CALL(clientMemoryTransferService, OnCreateReadHandle(sizeof(mBufferContent)))
                .WillOnce(testing::InvokeWithoutArgs([=]() { return handle; }));
        ...
        void MockReadHandleCreationFailure() {
            EXPECT_CALL(clientMemoryTransferService, OnCreateReadHandle(sizeof(mBufferContent)))
                .WillOnce(testing::InvokeWithoutArgs([=]() { return nullptr; }));
        }
        ...
        void ExpectReadHandleSerialization(ClientReadHandle* handle) {
            EXPECT_CALL(clientMemoryTransferService, OnReadHandleSerializeCreateSize(handle))
                .WillOnce(
                    testing::InvokeWithoutArgs([&]() { return sizeof(mSerializeCreateInfo); }));
            EXPECT_CALL(clientMemoryTransferService,
                        OnReadHandleSerializeCreate(handle, testing::_))
                .WillOnce(testing::WithArg<1>([&](void* serializePointer) {
        ...
        ServerReadHandle* ExpectServerReadHandleDeserialize() {
            ...
            EXPECT_CALL(serverMemoryTransferService,
                        OnDeserializeReadHandle(testing::Pointee(testing::Eq(mSerializeCreateInfo)),
                                                sizeof(mSerializeCreateInfo), testing::_))
                .WillOnce(testing::WithArg<2>(
                    [=](server::MemoryTransferService::ReadHandle** readHandle) {
                        *readHandle = handle;
                        return true;
                    }));
        ...
        void ExpectServerReadHandleSerializeDataUpdate(ServerReadHandle* handle) {
            EXPECT_CALL(serverMemoryTransferService,
                        OnReadHandleSizeOfSerializeDataUpdate(handle, testing::_, testing::_))
                .WillOnce(testing::InvokeWithoutArgs(
                    [&]() { return sizeof(mReadHandleSerializeDataInfo); }));
            EXPECT_CALL(serverMemoryTransferService,
                        OnReadHandleSerializeDataUpdate(handle, testing::_, testing::_, testing::_,
                                                        testing::_))
                .WillOnce(testing::WithArg<4>([&](void* serializePointer) {
        ...
        void ExpectClientReadHandleDeserializeDataUpdate(ClientReadHandle* handle,
            ...
            EXPECT_CALL(clientMemoryTransferService,
                        OnReadHandleDeserializeDataUpdate(
                            handle, testing::Pointee(testing::Eq(mReadHandleSerializeDataInfo)),
                            sizeof(mReadHandleSerializeDataInfo), testing::_, testing::_))
        ...
        ClientWriteHandle* ExpectWriteHandleCreation(bool mappedAtCreation) {
            ...
            if (mappedAtCreation) {
                EXPECT_CALL(clientMemoryTransferService, OnWriteHandleGetData(handle))
                    .WillOnce(testing::Return(&mBufferContent));
            }
        ...
        void ExpectWriteHandleSerialization(ClientWriteHandle* handle) {
            EXPECT_CALL(clientMemoryTransferService, OnWriteHandleSerializeCreateSize(handle))
                .WillOnce(
                    testing::InvokeWithoutArgs([&]() { return sizeof(mSerializeCreateInfo); }));
            EXPECT_CALL(clientMemoryTransferService,
                        OnWriteHandleSerializeCreate(handle, testing::_))
                .WillOnce(testing::WithArg<1>([&](void* serializePointer) {
                    memcpy(serializePointer, &mSerializeCreateInfo, sizeof(mSerializeCreateInfo));
                    return sizeof(mSerializeCreateInfo);
                }));
        ...
        ServerWriteHandle* ExpectServerWriteHandleDeserialization() {
            ...
            EXPECT_CALL(
                ...
                OnDeserializeWriteHandle(testing::Pointee(testing::Eq(mSerializeCreateInfo)),
                                         sizeof(mSerializeCreateInfo), testing::_))
                .WillOnce(testing::WithArg<2>(
                    [=](server::MemoryTransferService::WriteHandle** writeHandle) {
                        *writeHandle = handle;
                        return true;
                    }));
        ...
        void ExpectClientWriteHandleSerializeDataUpdate(ClientWriteHandle* handle) {
            EXPECT_CALL(clientMemoryTransferService,
                        OnWriteHandleSizeOfSerializeDataUpdate(handle, testing::_, testing::_))
                .WillOnce(testing::InvokeWithoutArgs(
                    [&]() { return sizeof(mWriteHandleSerializeDataInfo); }));
            EXPECT_CALL(
                clientMemoryTransferService,
                OnWriteHandleSerializeDataUpdate(handle, testing::_, testing::_, testing::_))
                .WillOnce(testing::WithArg<1>([&](void* serializePointer) {
        ...
        void ExpectServerWriteHandleDeserializeDataUpdate(ServerWriteHandle* handle,
            ...
            EXPECT_CALL(serverMemoryTransferService,
                        OnWriteHandleDeserializeDataUpdate(
                            handle, testing::Pointee(testing::Eq(mWriteHandleSerializeDataInfo)),
                            sizeof(mWriteHandleSerializeDataInfo), testing::_, testing::_))
                .WillOnce(testing::Return(true));
        }
        ...
        testing::StrictMock<dawn::wire::server::MockMemoryTransferService>
            serverMemoryTransferService;
        testing::StrictMock<dawn::wire::client::MockMemoryTransferService>
            clientMemoryTransferService;
    };
    ...
    TEST_F(WireMemoryTransferServiceTests, BufferMapReadSuccess) {
        ...
        EXPECT_CALL(api, OnBufferMapAsync(apiBuffer, WGPUMapMode_Read, 0, kBufferSize, testing::_,
                                          testing::_))
            .WillOnce(testing::InvokeWithoutArgs([&]() {
        ...
        EXPECT_CALL(*mockBufferMapCallback, Call(WGPUBufferMapAsyncStatus_Success, testing::_))
            .Times(1);
    ...
    TEST_F(WireMemoryTransferServiceTests, BufferMapReadError) {
        ...
        EXPECT_CALL(*mockBufferMapCallback, Call(WGPUBufferMapAsyncStatus_Error, testing::_))
            .Times(1);
    ...
    TEST_F(WireMemoryTransferServiceTests, BufferMapReadDeserializeDataUpdateFailure) {
        ...
        EXPECT_CALL(*mockBufferMapCallback, Call(WGPUBufferMapAsyncStatus_DeviceLost, testing::_))
            .Times(1);
    ...
    TEST_F(WireMemoryTransferServiceTests, BufferMapWriteSuccess) {
        ...
        // Mock a successful callback.
        EXPECT_CALL(api, OnBufferMapAsync(apiBuffer, WGPUMapMode_Write, 0, kBufferSize, testing::_,
                                          testing::_))
            .WillOnce(testing::InvokeWithoutArgs([&]() {
                api.CallBufferMapAsyncCallback(apiBuffer, WGPUBufferMapAsyncStatus_Success);
            }));
