...
namespace dawn::wire {
    namespace {
        ...
        std::unique_ptr<testing::StrictMock<MockCreateComputePipelineAsyncCallback>>
        ...
        std::unique_ptr<testing::StrictMock<MockCreateRenderPipelineAsyncCallback>>
    ...
    class WireCreatePipelineAsyncTest : public WireTest {
      public:
        void SetUp() override {
            ...
            mockCreateComputePipelineAsyncCallback =
                std::make_unique<testing::StrictMock<MockCreateComputePipelineAsyncCallback>>();
            mockCreateRenderPipelineAsyncCallback =
                std::make_unique<testing::StrictMock<MockCreateRenderPipelineAsyncCallback>>();
        }
        ...
        void FlushClient() {
            ...
            testing::Mock::VerifyAndClearExpectations(&mockCreateComputePipelineAsyncCallback);
        }
    ...
    TEST_F(WireCreatePipelineAsyncTest, CreateComputePipelineAsyncSuccess) {
        ...
        EXPECT_CALL(api, DeviceCreateShaderModule(apiDevice, testing::_))
            .WillOnce(testing::Return(apiCsModule));
        ...
        EXPECT_CALL(
            api, OnDeviceCreateComputePipelineAsync(apiDevice, testing::_, testing::_, testing::_))
        ...
        EXPECT_CALL(
            *mockCreateComputePipelineAsyncCallback,
            Call(WGPUCreatePipelineAsyncStatus_Success, testing::_, testing::StrEq(""), this))
            .Times(1);
    ...
    TEST_F(WireCreatePipelineAsyncTest, CreateComputePipelineAsyncError) {
        ...
        EXPECT_CALL(*mockCreateComputePipelineAsyncCallback,
                    Call(WGPUCreatePipelineAsyncStatus_Error, testing::_,
    ...
    TEST_F(WireCreatePipelineAsyncTest, CreateRenderPipelineAsyncSuccess) {
        ...
        EXPECT_CALL(
            api, OnDeviceCreateRenderPipelineAsync(apiDevice, testing::_, testing::_, testing::_))
            .WillOnce(testing::InvokeWithoutArgs([&]() {
    ...
    TEST_F(WireCreatePipelineAsyncTest, CreateRenderPipelineAsyncThenDisconnect) {
        ...
        EXPECT_CALL(*mockCreateRenderPipelineAsyncCallback,
                    Call(WGPUCreatePipelineAsyncStatus_DeviceLost, testing::_, testing::_, this))
            .Times(1);
    ...
    TEST_F(WireCreatePipelineAsyncTest, CreateRenderPipelineAsyncAfterDisconnect) {
        ...
        EXPECT_CALL(*mockCreateRenderPipelineAsyncCallback,
                    Call(WGPUCreatePipelineAsyncStatus_DeviceLost, nullptr, testing::_, this))
            .Times(1);
        wgpuDeviceCreateRenderPipelineAsync(device, &pipelineDescriptor,
                                            ToMockCreateRenderPipelineAsyncCallback, this);
    }
    ...
    TEST_F(WireCreatePipelineAsyncTest, DeviceDeletedBeforeCallback) {
        ...
        EXPECT_CALL(api, DeviceCreateShaderModule(apiDevice, testing::_))
            .WillOnce(testing::Return(apiModule));
        ...
        EXPECT_CALL(*mockCreateRenderPipelineAsyncCallback,
                    Call(WGPUCreatePipelineAsyncStatus_DeviceDestroyed, nullptr, testing::_, this))
            .Times(1);
