...
std::vector<WireFutureTestParam>& CallbackModes() {
    static std::vector<WireFutureTestParam> kCallbackModes = {
        CallbackMode::Async, CallbackMode::WaitAny, CallbackMode::ProcessEvents,
        CallbackMode::Spontaneous};
    return kCallbackModes;
}

WireFutureTestParam::WireFutureTestParam(CallbackMode callbackMode) : mCallbackMode(callbackMode) {}
