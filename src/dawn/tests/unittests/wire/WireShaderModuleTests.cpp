...
namespace dawn::wire {
    namespace {
        ...
        std::unique_ptr<testing::StrictMock<MockCompilationInfoCallback>>
    ...
    class WireShaderModuleTests : public WireTest {
      public:
        ...
        void SetUp() override {
            ...
            mockCompilationInfoCallback =
                std::make_unique<testing::StrictMock<MockCompilationInfoCallback>>();
            ...
            EXPECT_CALL(api, DeviceCreateShaderModule(apiDevice, testing::_))
                .WillOnce(testing::Return(apiShaderModule))
                .RetiresOnSaturation();
            FlushClient();
        }
        ...
        void FlushClient() {
            ...
            testing::Mock::VerifyAndClearExpectations(&mockCompilationInfoCallback);
        }
    ...
    TEST_F(WireShaderModuleTests, GetCompilationInfo) {
        ...
        EXPECT_CALL(api, OnShaderModuleGetCompilationInfo(apiShaderModule, testing::_, testing::_))
    ...
    TEST_F(WireShaderModuleTests, GetCompilationInfoBeforeDisconnect) {
        ...
        EXPECT_CALL(*mockCompilationInfoCallback,
                    Call(WGPUCompilationInfoRequestStatus_DeviceLost, nullptr, testing::_));
    ...
    TEST_F(WireShaderModuleTests, GetCompilationInfoInsideCallbackBeforeDestruction) {
        ...
        EXPECT_CALL(*mockCompilationInfoCallback,
                    Call(WGPUCompilationInfoRequestStatus_Unknown, nullptr, testing::_))
            .Times(1 + testData.numRequests);
