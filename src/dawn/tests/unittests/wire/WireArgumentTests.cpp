...
namespace dawn::wire {
    ...
    TEST_F(WireArgumentTests, ValueArgument) {
        ...
        EXPECT_CALL(api, DeviceCreateCommandEncoder(apiDevice, nullptr))
            .WillOnce(testing::Return(apiEncoder));
        ...
        EXPECT_CALL(api, CommandEncoderBeginComputePass(apiEncoder, nullptr))
            .WillOnce(testing::Return(apiPass));
    ...
    TEST_F(WireArgumentTests, ValueArrayArgument) {
        ...
        EXPECT_CALL(api, DeviceCreateBindGroupLayout(apiDevice, testing::_))
            .WillOnce(testing::Return(apiBgl));
        ...
        EXPECT_CALL(api, DeviceCreateBindGroup(apiDevice, testing::_))
            .WillOnce(testing::Return(apiBindGroup));
    ...
    TEST_F(WireArgumentTests, CStringArgument) {
        ...
        EXPECT_CALL(api, DeviceCreateShaderModule(apiDevice, testing::_))
            .WillOnce(testing::Return(apiVsModule));
        ...
        EXPECT_CALL(api, DeviceCreatePipelineLayout(apiDevice, testing::_))
            .WillOnce(testing::Return(apiLayout));
        ...
        EXPECT_CALL(
            ...
            .WillOnce(testing::Return(apiPlaceholderPipeline));
    ...
    TEST_F(WireArgumentTests, ObjectAsValueArgument) {
        ...
        EXPECT_CALL(api, DeviceCreateBuffer(apiDevice, testing::_))
            .WillOnce(testing::Return(apiBuffer))
            .RetiresOnSaturation();
    ...
    TEST_F(WireArgumentTests, StructureOfValuesArgument) {
        ...
        EXPECT_CALL(
            ...
            .WillOnce(testing::Return(apiPlaceholderSampler));
    ...
    TEST_F(WireArgumentTests, StructureOfObjectArrayArgument) {
        ...
        EXPECT_CALL(
            ...
            .WillOnce(testing::Return(apiPlaceholderLayout));
