...
namespace dawn::wire {
    ...
    TEST_F(WireInjectDeviceTests, CallAfterReserveInject) {
        ...
        EXPECT_CALL(api, OnDeviceSetUncapturedErrorCallback(serverDevice, testing::_, testing::_));
        EXPECT_CALL(api, OnDeviceSetLoggingCallback(serverDevice, testing::_, testing::_));
        EXPECT_CALL(api, OnDeviceSetDeviceLostCallback(serverDevice, testing::_, testing::_));
        ASSERT_TRUE(
        ...
        EXPECT_CALL(api, DeviceCreateBuffer(serverDevice, testing::_))
            .WillOnce(testing::Return(serverBuffer));
        FlushClient();
    ...
    TEST_F(WireInjectDeviceTests, GetQueueAfterInject) {
        ...
        EXPECT_CALL(api, DeviceGetQueue(serverDevice)).WillOnce(testing::Return(apiQueue));
        FlushClient();
    ...
    TEST_F(WireInjectDeviceTests, ReflectLiveDevices) {
        ...
        EXPECT_CALL(api, OnDeviceSetUncapturedErrorCallback(serverDevice1, testing::_, testing::_));
        EXPECT_CALL(api, OnDeviceSetLoggingCallback(serverDevice1, testing::_, testing::_));
        EXPECT_CALL(api, OnDeviceSetDeviceLostCallback(serverDevice1, testing::_, testing::_));
        ASSERT_TRUE(
        ...
        EXPECT_CALL(api, OnDeviceSetUncapturedErrorCallback(serverDevice2, testing::_, testing::_));
        EXPECT_CALL(api, OnDeviceSetLoggingCallback(serverDevice2, testing::_, testing::_));
        EXPECT_CALL(api, OnDeviceSetDeviceLostCallback(serverDevice2, testing::_, testing::_));
        ASSERT_TRUE(
    ...
    TEST_F(WireInjectDeviceTests, TrackChildObjectsWithTwoReservedDevices) {
        ...
        EXPECT_CALL(api, DeviceCreateCommandEncoder(serverDevice1, testing::_))
            .WillOnce(testing::Return(serverCommandEncoder));
        FlushClient();
