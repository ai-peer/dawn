...
namespace dawn::wire {
    ...
    TEST_F(WireExtensionTests, ChainedStruct) {
        ...
        EXPECT_CALL(api, DeviceCreateRenderPipeline(apiDevice, testing::NotNull()))
    ...
    TEST_F(WireExtensionTests, MutlipleChainedStructs) {
        ...
        wgpuDeviceCreateRenderPipeline(device, &renderPipelineDesc);
        EXPECT_CALL(api, DeviceCreateRenderPipeline(apiDevice, testing::NotNull()))
            .WillOnce(testing::Invoke([&](testing::Unused,
                                          const WGPURenderPipelineDescriptor* serverDesc)
                                          -> WGPURenderPipeline {
