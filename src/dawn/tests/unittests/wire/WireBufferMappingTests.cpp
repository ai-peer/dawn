...
// Check that trying to create a buffer of size MAX_SIZE_T with mappedAtCreation == true is an error
// handling in the client and never gets to the server-side, while other OOM errors shouldn't.
