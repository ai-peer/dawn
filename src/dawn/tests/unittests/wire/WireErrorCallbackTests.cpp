...
namespace dawn::wire {
    ...
    namespace {
        ...
        std::unique_ptr<testing::StrictMock<MockDeviceErrorCallback>> mockDeviceErrorCallback;
        ...
        std::unique_ptr<testing::StrictMock<MockDevicePopErrorScopeCallback>>
        ...
        std::unique_ptr<testing::StrictMock<MockDeviceLoggingCallback>> mockDeviceLoggingCallback;
        ...
        std::unique_ptr<testing::StrictMock<MockDeviceLostCallback>> mockDeviceLostCallback;
      ...
      public:
        ...
        void SetUp() override {
            ...
            mockDeviceErrorCallback =
                std::make_unique<testing::StrictMock<MockDeviceErrorCallback>>();
            mockDeviceLoggingCallback =
                std::make_unique<testing::StrictMock<MockDeviceLoggingCallback>>();
            mockDevicePopErrorScopeCallback =
                std::make_unique<testing::StrictMock<MockDevicePopErrorScopeCallback>>();
            mockDeviceLostCallback =
                std::make_unique<testing::StrictMock<MockDeviceLostCallback>>();
        }
        ...
        void FlushServer() {
            ...
            testing::Mock::VerifyAndClearExpectations(&mockDeviceErrorCallback);
            testing::Mock::VerifyAndClearExpectations(&mockDevicePopErrorScopeCallback);
        }
    };
    ...
    TEST_F(WireErrorCallbackTests, DeviceErrorCallback) {
        ...
        EXPECT_CALL(*mockDeviceErrorCallback,
                    Call(WGPUErrorType_Validation, testing::StrEq("Some error message"), this))
            .Times(1);
    ...
    TEST_F(WireErrorCallbackTests, DeviceLoggingCallback) {
        ...
        EXPECT_CALL(*mockDeviceLoggingCallback,
                    Call(WGPULoggingType_Info, testing::StrEq("Some message"), this))
            .Times(1);
    ...
    TEST_F(WireErrorCallbackTests, PushPopErrorScopeCallback) {
        ...
        void* userdata;
        EXPECT_CALL(api, OnDevicePopErrorScope(apiDevice, testing::_, testing::_))
            .WillOnce(testing::DoAll(testing::SaveArg<1>(&callback), testing::SaveArg<2>(&userdata),
                                     testing::Return(true)));
    ...
    TEST_F(WireErrorCallbackTests, PopErrorScopeCallbackOrdering) {
        // Two error scopes are popped, and the first one returns first.
        {
            ...
            void* userdata2;
            EXPECT_CALL(api, OnDevicePopErrorScope(apiDevice, testing::_, testing::_))
                .WillOnce(testing::DoAll(testing::SaveArg<1>(&callback1),
                                         testing::SaveArg<2>(&userdata1), testing::Return(true)))
                .WillOnce(testing::DoAll(testing::SaveArg<1>(&callback2),
                                         testing::SaveArg<2>(&userdata2), testing::Return(true)));
            wgpuDevicePopErrorScope(device, ToMockDevicePopErrorScopeCallback, this);
            wgpuDevicePopErrorScope(device, ToMockDevicePopErrorScopeCallback, this + 1);
            FlushClient();

            EXPECT_CALL(*mockDevicePopErrorScopeCallback,
                        Call(WGPUErrorType_Validation, testing::StrEq("First error message"), this))
                .Times(1);
            ...
            EXPECT_CALL(
                *mockDevicePopErrorScopeCallback,
                Call(WGPUErrorType_Validation, testing::StrEq("Second error message"), this + 1))
                .Times(1);
    ...
    TEST_F(WireErrorCallbackTests, PopErrorScopeEmptyStack) {
        ...
        EXPECT_CALL(*mockDevicePopErrorScopeCallback,
                    Call(WGPUErrorType_Validation, testing::StrEq("No error scopes to pop"), this))
            .Times(1);
    ...
    TEST_F(WireErrorCallbackTests, DeviceLostCallback) {
        ...
        EXPECT_CALL(*mockDeviceLostCallback, Call(WGPUDeviceLostReason_Undefined,
                                                  testing::StrEq("Some error message"), this))
            .Times(1);
