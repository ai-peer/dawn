...
TEST(ChainUtilsTests, FindEmptyChain) {
    ...
    {
        dawn::native::DawnAdapterPropertiesPowerPreferenceDescriptor* info = nullptr;
...
TEST(ChainUtilsTests, FindPresentInChain) {
    ...
    {
        dawn::native::DawnAdapterPropertiesPowerPreferenceDescriptor chain;
        dawn::native::DawnAdapterPropertiesPowerPreferenceDescriptor* output = nullptr;
...
TEST(ChainUtilsTests, ValidateDuplicateSTypes) {
    ...
    {
        dawn::native::DawnAdapterPropertiesPowerPreferenceDescriptor chain1;
        dawn::native::DawnAdapterPropertiesPowerPreferenceDescriptor chain2;
        chain1.nextInChain = &chain2;
...
TEST(ChainUtilsTests, ValidateUnspecifiedSTypes) {
...

    {
        ...
        dawn::native::MaybeError result = dawn::native::ValidateSTypes(
            &chain1, {{wgpu::SType::DawnAdapterPropertiesPowerPreferenceDescriptor}});
        ASSERT_TRUE(result.IsError());
        result.AcquireError();
    }
}
...
TEST(ChainUtilsTests, ValidateEmptyChain) {
...

    {
        ...
        dawn::native::MaybeError result = dawn::native::ValidateSTypes(
            chain, {{wgpu::SType::DawnAdapterPropertiesPowerPreferenceDescriptor}});
        ASSERT_TRUE(result.IsSuccess());
