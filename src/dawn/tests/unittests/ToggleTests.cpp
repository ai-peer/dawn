...
TEST_F(InstanceToggleTest, InstanceTogglesSet) {
    ...
    // Create instance with no toggles descriptor
    {
        ...
        // Create an instance with default toggles, where DisallowUnsafeApis is enabled and UseDXC
        // is disabled.
        instance = std::make_unique<dawn::native::Instance>();
        validateInstanceToggles(instance.get(), {"disallow_unsafe_apis"}, {"use_dxc"});
    }
