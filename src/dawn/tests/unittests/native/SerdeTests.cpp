...
// Test that ByteVectorSink::Record calls serialize on the single member of a struct.
...
// Test that ByteVectorSink::Record calls serialize on all members of a struct.
...
// Test that ByteVectorSink::Record calls serialize on all elements of an iterable.
...
// Test that ByteVectorSink::Record calls serialize on all members and nested struct members.
...
// Test that ByteVectorSink::Record serializes integral data as expected.
...
// Test that ByteVectorSink::Record serializes floating-point data as expected.
...
// Test that ByteVectorSink::Record serializes literal strings as expected.
...
// Test that ByteVectorSink::Record serializes std::strings as expected.
...
// Test that ByteVectorSink::Record serializes std::string_views as expected.
...
// Test that ByteVectorSink::Record serializes other ByteVectorSinks as expected.
...
// Test that ByteVectorSink::Record serializes std::pair as expected.
...
// Test that ByteVectorSink::Record serializes std::unordered_map as expected.
...
// Test that ByteVectorSink::Record serializes tint::sem::BindingPoint as expected.
...
// Test that ByteVectorSink::Record serializes tint::transform::BindingPoints as expected.
...
static auto kSerdeValueVectorParams = std::make_tuple(
    ...
    std::vector<std::bitset<67>>{0x0C0FFEE0, 0xDEADC0DE, 0x00000000, 0xFFFFFFFF},
    // Test vectors.
