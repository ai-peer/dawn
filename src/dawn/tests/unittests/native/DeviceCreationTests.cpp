...
TEST_F(DeviceCreationTest, CreateDeviceRequiringExperimentalFeatures) {
    ...
    auto safeAdapterBase = reinterpret_cast<dawn::native::AdapterBase*>(adapter.Get());
    ASSERT_TRUE(
    ...
    auto unsafeAdapterBase = reinterpret_cast<dawn::native::AdapterBase*>(unsafeAdapter.Get());
    ASSERT_FALSE(
