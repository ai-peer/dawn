...
class FeatureTests : public testing::Test {
  ...
  protected:
    // By default DiasllowUnsafeAPIs is enabled in this instance.
    ...
    // A TogglesState that set DisallowUnsafeAPIs to disabled, use to force override the adapter
    // toggles state for testing.
    dawn::native::TogglesState mUnsafeAdapterTogglesState;
    // The adapter that take unsafeAdapterTogglesState as toggles state, have DisallowUnsafeAPIs
    // disabled.
