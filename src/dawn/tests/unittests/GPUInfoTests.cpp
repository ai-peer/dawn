...
TEST(GPUInfo, CompareVulkanDriverVersion) {
    EXPECT_EQ(gpu_info::CompareVulkanDriverVersion(vendorID, version1, version2), -1);
    EXPECT_EQ(gpu_info::CompareVulkanDriverVersion(vendorID, version2, version3), -1);
    EXPECT_EQ(gpu_info::CompareVulkanDriverVersion(vendorID, version3, version4), -1);
}
