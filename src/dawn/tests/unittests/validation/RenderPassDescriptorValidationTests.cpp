...
TEST_F(MSAARenderToSingleSampledRenderPassDescriptorValidationTest,
       ValidateUnsupportedSampleCount) {
    // Create a texture with sample count = 1.
    ...
    AssertBeginRenderPassError(&renderPass,
                               testing::HasSubstr("implicitSampleCount (3) is not supported"));
}

// When MSAARenderToSingleSampled is enabled in a render pass, there should be an error if a color
// attachment's format doesn't support resolve. Example, RGBA8Sint format.
