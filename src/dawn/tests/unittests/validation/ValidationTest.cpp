...
ValidationTest::ValidationTest() {
    ...
    procs.instanceRequestAdapter = [](WGPUInstance instance, const WGPURequestAdapterOptions*,
        ...
        ASSERT(gCurrentTest);
        std::vector<dawn::native::Adapter> adapters = gCurrentTest->dawnInstance->GetAdapters();
...
void ValidationTest::SetUp() {
    ...
    instance = mWireHelper->RegisterInstance(dawnInstance->Get());
    ...
    // mWireHelper->RegisterDevice(CreateTestDevice(dawn::native::Adapter adapter););
    ...
    // device = wgpu::Device::Acquire(CreateTestDevice(dawn::native::Adapter adapter););
    // std::tie(device, backendDevice) =
    // mWireHelper->RegisterDevice(CreateTestDevice(dawn::native::Adapter adapter););
...
ValidationTest::~ValidationTest() {
    ...
    EXPECT_EQ(dawnInstance->GetDeviceCountForTesting(), 0u);
