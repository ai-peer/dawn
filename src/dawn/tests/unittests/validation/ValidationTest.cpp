    ...
    wgpuInstanceRequestAdapter(
        ...
        [](WGPURequestAdapterStatus status, WGPUAdapter adapter, const char* message,
           void* userdata) {
            ...
            ValidationTest::RequestAdapterResolve(reinterpret_cast<ValidationTest*>(userdata),
            ...
            wgpuAdapterRequestDevice(
                ...
                [](WGPURequestDeviceStatus status, WGPUDevice dev, const char* message,
                   void* userdata) {
                    ...
                    ValidationTest::RequestDeviceResolve(
                        reinterpret_cast<ValidationTest*>(userdata), device);
                },
                userdata);
        },
