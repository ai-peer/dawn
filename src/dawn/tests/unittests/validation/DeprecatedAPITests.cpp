...
// Test that endPass() is deprecated for render passes.
TEST_P(DeprecationTests, RenderEndPass) {
    wgpu::CommandEncoder encoder = device.CreateCommandEncoder();
...
// Test that endPass() is deprecated for compute passes.
TEST_P(DeprecationTests, ComputeEndPass) {
    wgpu::CommandEncoder encoder = device.CreateCommandEncoder();
