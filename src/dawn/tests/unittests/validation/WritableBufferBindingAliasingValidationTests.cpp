...
// Test if validate bind group lazy aspect flag is set and check properly
...
// Test if validate bind group lazy aspect flag is set and check properly for bind group layout with
// dynamic offset
