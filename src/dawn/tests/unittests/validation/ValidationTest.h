...
#ifdef __EMSCRIPTEN__
    // static void GetDevice(void (*callback)(wgpu::Device));
    // static void GetDevice(void (*callback)(ValidationTest*));
    static void RequestAdapterResolve(ValidationTest* self, wgpu::Adapter adapter);
    static void RequestDeviceResolve(ValidationTest* self, wgpu::Device device);
