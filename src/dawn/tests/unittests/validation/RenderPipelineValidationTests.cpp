...
// Tests that depth stencil state is required when frag_depth is written in fragment stage.
TEST_F(RenderPipelineValidationTest, DepthStencilStateRequiredWhenFragDepthIsWritten) {
