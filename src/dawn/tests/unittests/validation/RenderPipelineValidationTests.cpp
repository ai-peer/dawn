...
TEST_F(MSAARenderToSingleSampledPipelineDescriptorValidationTest, ValidUse) {
    ...
    auto texture = CreateTexture(wgpu::TextureUsage::RenderAttachment |
                                     wgpu::TextureUsage::MSAARenderToSingleSampledAttachment,
                                 1);

    // Create render pass (with DawnRenderPassDescriptorRenderToSingleSampled).
    ...
    renderPassDescriptor.nextInChain = &renderPassRenderToSingleSampledDesc;
...
TEST_F(MSAARenderToSingleSampledPipelineDescriptorValidationTest,
    ...
    // Create render pass (without DawnRenderPassDescriptorRenderToSingleSampled).
    utils::ComboRenderPassDescriptor renderPassDescriptor({texture.CreateView()});
