...
struct ExternalImageDescriptorVkForTesting : public ExternalImageDescriptorVk {
  public:
    ExternalImageDescriptorVkForTesting(ExternalImageType type) : ExternalImageDescriptorVk(type) {}
};

struct ExternalImageExportInfoVkForTesting : public ExternalImageExportInfoVk {
  public:
    ExternalImageExportInfoVkForTesting(ExternalImageType type) : ExternalImageExportInfoVk(type) {}
