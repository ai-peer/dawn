...
class SharedTextureMemoryTestsBase : public DawnTestWithParams<SharedTextureMemoryTestParams> {};
...
class SharedTextureMemoryTests : public DawnTestWithParams<SharedTextureMemoryTestParams> {
  protected:
    ...
    wgpu::CommandBuffer MakeClearCommandBuffer(wgpu::Device& deviceObj,
                                               wgpu::Texture& texture,
                                               wgpu::Color clearValue);
    wgpu::CommandBuffer MakeSampleCommandBuffer(wgpu::Device& deviceObj,
                                                wgpu::Texture& texture,
