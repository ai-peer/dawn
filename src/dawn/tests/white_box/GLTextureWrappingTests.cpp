...
TEST_P(GLTextureUsageTests, SampleRGBA8GLTexture) {
    ...
    ScopedGLTexture glTexture = CreateGLTexture(1, 1, GL_RGBA8, GL_RGBA, GL_UNSIGNED_BYTE, pixels);
    ...
    wgpu::Texture wrappedTexture = WrapGLTexture(&textureDescriptor, glTexture.Get(), true);
