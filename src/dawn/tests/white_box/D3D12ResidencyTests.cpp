...
class D3D12ResidencyTestBase : public DawnTest {
  protected:
    void SetUp() override {
        ...
        dawn::native::d3d::d3d12::Device* d3dDevice =
            dawn::native::d3d::d3d12::ToBackend(dawn::native::FromAPI((device.Get())));
...
class D3D12ResourceResidencyTests : public D3D12ResidencyTestBase {
  protected:
    bool CheckAllocationMethod(wgpu::Buffer buffer,
        ...
        dawn::native::d3d::d3d12::Buffer* d3dBuffer =
            dawn::native::d3d::d3d12::ToBackend(dawn::native::FromAPI((buffer.Get())));
    ...
    bool IsUMA() const {
        return dawn::native::d3d::d3d12::ToBackend(dawn::native::FromAPI(device.Get()))
            ->GetDeviceInfo()
            .isUMA;
    }
};
...
TEST_P(D3D12ResourceResidencyTests, SetExternalReservation) {
    ...
    // request.
    uint64_t amountReserved = dawn::native::d3d::d3d12::SetExternalMemoryReservation(
        device.Get(), kRestrictedBudgetSize * .2, dawn::native::d3d::d3d12::MemorySegment::Local);
    ...
    if (!IsUMA()) {
        amountReserved = dawn::native::d3d::d3d12::SetExternalMemoryReservation(
            device.Get(), kRestrictedBudgetSize * .2, dawn::native::d3d::d3d12::MemorySegment::NonLocal);
        EXPECT_EQ(amountReserved, kRestrictedBudgetSize * .2);
    }
}
...
TEST_P(D3D12DescriptorResidencyTests, SwitchedViewHeapResidency) {
    ...
    EXPECT_EQ(allocator->GetShaderVisibleHeapSerialForTesting(),
              heapSerial + dawn::native::d3d::d3d12::HeapVersionID(1));
