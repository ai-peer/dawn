...
class VulkanImageWrappingTestBase : public DawnTestWithParams<ImageWrappingParams> {
  ...
  public:
    void SetUp() override {
        ...
        // TODO(dawn:XXXX): Nvidia doesn't seem to correctly reflect whether an import requires a dedicated allocation.
...
class VulkanImageWrappingUsageTests : public VulkanImageWrappingTestBase {
  public:
    ...
    void TearDown() override {
        WaitForAllOperations(secondDevice);
...
// Mmmmmmh Nvidia deadlock but why?
