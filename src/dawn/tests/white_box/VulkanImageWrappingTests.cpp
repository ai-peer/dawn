...
class VulkanImageWrappingTestBase : public DawnTestWithParams<ImageWrappingParams> {
  ...
  public:
    ...
    ExternalImageDescriptorVk GetExternalImageDescriptor() {
        return ExternalImageDescriptorVk(GetParam().mExternalImageType);
    }

    ExternalImageExportInfoVk GetExternalImageExportInfo() {
        return ExternalImageExportInfoVk(GetParam().mExternalImageType);
    }
    ...
    wgpu::Texture WrapVulkanImage(wgpu::Device dawnDevice,
        ...
        ExternalImageDescriptorVk descriptor = GetExternalImageDescriptor();
    ...
    void IgnoreSignalSemaphore(wgpu::Texture wrappedTexture) {
        ExternalImageExportInfoVk exportInfo = GetExternalImageExportInfo();
...
TEST_P(VulkanImageWrappingUsageTests, CopyTextureToTextureDstSync) {
    ...
    ExternalImageExportInfoVk secondExportInfo = GetExternalImageExportInfo();
...
TEST_P(VulkanImageWrappingUsageTests, ChainTextureCopy) {
    ...
    ExternalImageExportInfoVk exportInfoTexBDevice3 = GetExternalImageExportInfo();
    ...
    ExternalImageExportInfoVk exportInfoTexCDevice2 = GetExternalImageExportInfo();
