...
class WGSLBasicType final : public interop::WGSLType {
  public:
    WGSLBasicType(interop::WGSLKind kind, const tint::Program*, const tint::type::Type*);
    ~WGSLBasicType();
...
class WGSLVectorType final : public interop::WGSLVectorType {
  public:
    ...
    interop::Interface<interop::WGSLType> getElementType(Napi::Env) override;
...
class WGSLMatrixType final : public interop::WGSLMatrixType {
  public:
    ...
    interop::Interface<interop::WGSLType> getElementType(Napi::Env) override;
    interop::Interface<interop::WGSLType> getColumnType(Napi::Env) override;
...
class WGSLStructMember final : public interop::WGSLStructMember {
  public:
    ...
    interop::Interface<interop::WGSLType> getType(Napi::Env) override;
