...
interop::Interface<interop::WGSLTypeBase> createType(Napi::Env env,
    ...
    return tint::Switch(
        ...
        [&](const tint::type::Atomic* ty) -> interop::Interface<interop::WGSLTypeBase> {
            return interop::WGSLAtomicType::Create<WGSLAtomicType>(env, program, ty);
        },
        [&](const tint::type::Vector* ty) -> interop::Interface<interop::WGSLTypeBase> {
            return interop::WGSLVectorType::Create<WGSLVectorType>(env, program, ty);
        },
        [&](const tint::type::Matrix* ty) -> interop::Interface<interop::WGSLTypeBase> {
            return interop::WGSLMatrixType::Create<WGSLMatrixType>(env, program, ty);
        },
        [&](const tint::type::Array* ty) -> interop::Interface<interop::WGSLTypeBase> {
            return interop::WGSLArrayType::Create<WGSLArrayType>(env, program, ty);
        },
        [&](const tint::type::Struct* ty) -> interop::Interface<interop::WGSLTypeBase> {
...
// WGSLScalarType
////////////////////////////////////////////////////////////////////////////////
WGSLScalarType::WGSLScalarType(interop::WGSLKind kind,
                               const tint::Program* program,
                               const tint::type::Type* type)
...
interop::Interface<interop::WGSLTypeBase> WGSLBindGroupEntry::getType(Napi::Env env) {
