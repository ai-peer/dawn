...
class GPUAdapterInfo final : public interop::GPUAdapterInfo {
  public:
    explicit GPUAdapterInfo(wgpu::AdapterProperties);

    // interop::GPUAdapterInfo interface compliance
    std::string getVendor(Napi::Env) const override;
    std::string getArchitecture(Napi::Env) const override;
    std::string getDevice(Napi::Env) const override;
    std::string getDescription(Napi::Env) const override;
