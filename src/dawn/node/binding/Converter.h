...
class Converter {
  public:
    ...
    Converter(Napi::Env e, wgpu::Device extensionDevice) : env(e), device(extensionDevice) {}
    ~Converter();
  ...
  private:
    ...
    bool HasFeature(wgpu::FeatureName feature) { return device.HasFeature(feature); }
