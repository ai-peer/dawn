...
<SNIP>
Running:
  Cmd: /usr/local/google/home/amaiorano/src/dawn/third_party/node/node-linux-x64/bin/node -e "require('./out-node/common/runtime/cmdline.js');" -- placeholder-arg --gpu-provider /usr/local/google/home/amaiorano/src/dawn/build-clang/cts.js --verbose --quiet --gpu-provider-flag verbose=1 --colors --unroll-const-eval-loops --gpu-provider-flag enable-dawn-features=allow_unsafe_apis "webgpu:shader,execution,flow_control,loop:nested_loops:preventValueOptimizations=false"
  Dir: /usr/local/google/home/amaiorano/src/dawn/third_party/webgpu-cts

  For VS Code launch.json:
    "program": "/usr/local/google/home/amaiorano/src/dawn/third_party/node/node-linux-x64/bin/node",
    "args": [
        "-e",
        ...
        "placeholder-arg",
        "--gpu-provider",
        "/usr/local/google/home/amaiorano/src/dawn/build-clang/cts.js",
        "--verbose",
        "--quiet",
        "--gpu-provider-flag",
        "verbose=1",
    ...
    "cwd": "/usr/local/google/home/amaiorano/src/dawn/third_party/webgpu-cts",
