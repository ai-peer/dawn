...
constexpr char kWGSLShaderAllSubgroups[] = R"(
...
@builtin(subgroup_invocation_id) reserved_subgroup_id : u32,
@builtin(subgroup_size) reserved_subgroup_size : u32) {
  var linear_spatial : i32= i32(reserved_gid.x);
  var DST_X : i32= linear_spatial % U.i0.w;
  linear_spatial = linear_spatial / U.i0.w;
  var DST_Y : i32= linear_spatial % U.i1.x;
  linear_spatial = linear_spatial / U.i1.x;
  var DST_S : i32= i32(reserved_group_id.y);
  DST_S *= 4;
  if (DST_S >= U.i0.y) {return;}
  var simd_id : i32= i32(reserved_subgroup_id);
  var r_w0_h0_s0 : vec4<f32>= vec4<f32>(0.0);
  var r_w0_h0_s1 : vec4<f32>= vec4<f32>(0.0);
  var r_w0_h0_s2 : vec4<f32>= vec4<f32>(0.0);
  var r_w0_h0_s3 : vec4<f32>= vec4<f32>(0.0);
  var xc0 : i32= DST_X + 0;
  var yc0 : i32= DST_Y + 0;
  var filters_offset : i32= DST_S * 4 * U.i0.z;
  var s : i32= 0;
  loop {
    var src_w0_h0 : vec4<f32>;
    if (reserved_subgroup_size == 4u) {
    var simd_w0 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 0];
    var simd_w1 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 4];
    var simd_w2 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 8];
    var simd_w3 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 12];
    src_w0_h0 = vec4<f32>(textureLoad(src_tensor_image2d, vec2<i32>((xc0), ((yc0) * U.i0.z + (s))), 0));
    s += 1;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.x, 0u) * src_w0_h0.x;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.y, 0u) * src_w0_h0.y;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.z, 0u) * src_w0_h0.z;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.w, 0u) * src_w0_h0.w;
    r_w0_h0_s0.y += subgroupBroadcast(simd_w0.x, 1u) * src_w0_h0.x;
    r_w0_h0_s0.y += subgroupBroadcast(simd_w0.y, 1u) * src_w0_h0.y;
    r_w0_h0_s0.y += subgroupBroadcast(simd_w0.z, 1u) * src_w0_h0.z;
    r_w0_h0_s0.y += subgroupBroadcast(simd_w0.w, 1u) * src_w0_h0.w;
    r_w0_h0_s0.z += subgroupBroadcast(simd_w0.x, 2u) * src_w0_h0.x;
    r_w0_h0_s0.z += subgroupBroadcast(simd_w0.y, 2u) * src_w0_h0.y;
    r_w0_h0_s0.z += subgroupBroadcast(simd_w0.z, 2u) * src_w0_h0.z;
    r_w0_h0_s0.z += subgroupBroadcast(simd_w0.w, 2u) * src_w0_h0.w;
    r_w0_h0_s0.w += subgroupBroadcast(simd_w0.x, 3u) * src_w0_h0.x;
    r_w0_h0_s0.w += subgroupBroadcast(simd_w0.y, 3u) * src_w0_h0.y;
    r_w0_h0_s0.w += subgroupBroadcast(simd_w0.z, 3u) * src_w0_h0.z;
    r_w0_h0_s0.w += subgroupBroadcast(simd_w0.w, 3u) * src_w0_h0.w;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w1.x, 0u) * src_w0_h0.x;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w1.y, 0u) * src_w0_h0.y;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w1.z, 0u) * src_w0_h0.z;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w1.w, 0u) * src_w0_h0.w;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w1.x, 1u) * src_w0_h0.x;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w1.y, 1u) * src_w0_h0.y;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w1.z, 1u) * src_w0_h0.z;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w1.w, 1u) * src_w0_h0.w;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w1.x, 2u) * src_w0_h0.x;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w1.y, 2u) * src_w0_h0.y;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w1.z, 2u) * src_w0_h0.z;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w1.w, 2u) * src_w0_h0.w;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w1.x, 3u) * src_w0_h0.x;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w1.y, 3u) * src_w0_h0.y;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w1.z, 3u) * src_w0_h0.z;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w1.w, 3u) * src_w0_h0.w;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w2.x, 0u) * src_w0_h0.x;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w2.y, 0u) * src_w0_h0.y;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w2.z, 0u) * src_w0_h0.z;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w2.w, 0u) * src_w0_h0.w;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w2.x, 1u) * src_w0_h0.x;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w2.y, 1u) * src_w0_h0.y;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w2.z, 1u) * src_w0_h0.z;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w2.w, 1u) * src_w0_h0.w;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w2.x, 2u) * src_w0_h0.x;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w2.y, 2u) * src_w0_h0.y;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w2.z, 2u) * src_w0_h0.z;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w2.w, 2u) * src_w0_h0.w;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w2.x, 3u) * src_w0_h0.x;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w2.y, 3u) * src_w0_h0.y;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w2.z, 3u) * src_w0_h0.z;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w2.w, 3u) * src_w0_h0.w;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w3.x, 0u) * src_w0_h0.x;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w3.y, 0u) * src_w0_h0.y;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w3.z, 0u) * src_w0_h0.z;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w3.w, 0u) * src_w0_h0.w;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w3.x, 1u) * src_w0_h0.x;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w3.y, 1u) * src_w0_h0.y;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w3.z, 1u) * src_w0_h0.z;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w3.w, 1u) * src_w0_h0.w;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w3.x, 2u) * src_w0_h0.x;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w3.y, 2u) * src_w0_h0.y;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w3.z, 2u) * src_w0_h0.z;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w3.w, 2u) * src_w0_h0.w;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w3.x, 3u) * src_w0_h0.x;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w3.y, 3u) * src_w0_h0.y;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w3.z, 3u) * src_w0_h0.z;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w3.w, 3u) * src_w0_h0.w;
    filters_offset += 16;
    }
    if (reserved_subgroup_size == 8u) {
    var simd_w0 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 0];
    var simd_w1 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 8];
    src_w0_h0 = vec4<f32>(textureLoad(src_tensor_image2d, vec2<i32>((xc0), ((yc0) * U.i0.z + (s))), 0));
    s += 1;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.x, 0u) * src_w0_h0.x;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.y, 0u) * src_w0_h0.y;
    ...
    r_w0_h0_s0.w += subgroupBroadcast(simd_w0.z, 3u) * src_w0_h0.z;
    r_w0_h0_s0.w += subgroupBroadcast(simd_w0.w, 3u) * src_w0_h0.w;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w0.x, 4u) * src_w0_h0.x;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w0.y, 4u) * src_w0_h0.y;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w0.z, 4u) * src_w0_h0.z;
    r_w0_h0_s1.x += subgroupBroadcast(simd_w0.w, 4u) * src_w0_h0.w;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w0.x, 5u) * src_w0_h0.x;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w0.y, 5u) * src_w0_h0.y;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w0.z, 5u) * src_w0_h0.z;
    r_w0_h0_s1.y += subgroupBroadcast(simd_w0.w, 5u) * src_w0_h0.w;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w0.x, 6u) * src_w0_h0.x;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w0.y, 6u) * src_w0_h0.y;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w0.z, 6u) * src_w0_h0.z;
    r_w0_h0_s1.z += subgroupBroadcast(simd_w0.w, 6u) * src_w0_h0.w;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w0.x, 7u) * src_w0_h0.x;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w0.y, 7u) * src_w0_h0.y;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w0.z, 7u) * src_w0_h0.z;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w0.w, 7u) * src_w0_h0.w;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w1.x, 0u) * src_w0_h0.x;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w1.y, 0u) * src_w0_h0.y;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w1.z, 0u) * src_w0_h0.z;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w1.w, 0u) * src_w0_h0.w;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w1.x, 1u) * src_w0_h0.x;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w1.y, 1u) * src_w0_h0.y;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w1.z, 1u) * src_w0_h0.z;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w1.w, 1u) * src_w0_h0.w;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w1.x, 2u) * src_w0_h0.x;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w1.y, 2u) * src_w0_h0.y;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w1.z, 2u) * src_w0_h0.z;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w1.w, 2u) * src_w0_h0.w;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w1.x, 3u) * src_w0_h0.x;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w1.y, 3u) * src_w0_h0.y;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w1.z, 3u) * src_w0_h0.z;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w1.w, 3u) * src_w0_h0.w;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w1.x, 4u) * src_w0_h0.x;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w1.y, 4u) * src_w0_h0.y;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w1.z, 4u) * src_w0_h0.z;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w1.w, 4u) * src_w0_h0.w;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w1.x, 5u) * src_w0_h0.x;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w1.y, 5u) * src_w0_h0.y;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w1.z, 5u) * src_w0_h0.z;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w1.w, 5u) * src_w0_h0.w;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w1.x, 6u) * src_w0_h0.x;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w1.y, 6u) * src_w0_h0.y;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w1.z, 6u) * src_w0_h0.z;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w1.w, 6u) * src_w0_h0.w;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w1.x, 7u) * src_w0_h0.x;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w1.y, 7u) * src_w0_h0.y;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w1.z, 7u) * src_w0_h0.z;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w1.w, 7u) * src_w0_h0.w;
    filters_offset += 16;
    }
    if (reserved_subgroup_size == 16u) {
    var simd_w0 : vec4<f32>= weights_buffer.data[filters_offset + simd_id + 0];
    src_w0_h0 = vec4<f32>(textureLoad(src_tensor_image2d, vec2<i32>((xc0), ((yc0) * U.i0.z + (s))), 0));
    s += 1;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.x, 0u) * src_w0_h0.x;
    ...
    r_w0_h0_s1.w += subgroupBroadcast(simd_w0.z, 7u) * src_w0_h0.z;
    r_w0_h0_s1.w += subgroupBroadcast(simd_w0.w, 7u) * src_w0_h0.w;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w0.x, 8u) * src_w0_h0.x;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w0.y, 8u) * src_w0_h0.y;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w0.z, 8u) * src_w0_h0.z;
    r_w0_h0_s2.x += subgroupBroadcast(simd_w0.w, 8u) * src_w0_h0.w;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w0.x, 9u) * src_w0_h0.x;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w0.y, 9u) * src_w0_h0.y;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w0.z, 9u) * src_w0_h0.z;
    r_w0_h0_s2.y += subgroupBroadcast(simd_w0.w, 9u) * src_w0_h0.w;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w0.x, 10u) * src_w0_h0.x;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w0.y, 10u) * src_w0_h0.y;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w0.z, 10u) * src_w0_h0.z;
    r_w0_h0_s2.z += subgroupBroadcast(simd_w0.w, 10u) * src_w0_h0.w;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w0.x, 11u) * src_w0_h0.x;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w0.y, 11u) * src_w0_h0.y;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w0.z, 11u) * src_w0_h0.z;
    r_w0_h0_s2.w += subgroupBroadcast(simd_w0.w, 11u) * src_w0_h0.w;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w0.x, 12u) * src_w0_h0.x;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w0.y, 12u) * src_w0_h0.y;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w0.z, 12u) * src_w0_h0.z;
    r_w0_h0_s3.x += subgroupBroadcast(simd_w0.w, 12u) * src_w0_h0.w;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w0.x, 13u) * src_w0_h0.x;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w0.y, 13u) * src_w0_h0.y;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w0.z, 13u) * src_w0_h0.z;
    r_w0_h0_s3.y += subgroupBroadcast(simd_w0.w, 13u) * src_w0_h0.w;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w0.x, 14u) * src_w0_h0.x;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w0.y, 14u) * src_w0_h0.y;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w0.z, 14u) * src_w0_h0.z;
    r_w0_h0_s3.z += subgroupBroadcast(simd_w0.w, 14u) * src_w0_h0.w;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w0.x, 15u) * src_w0_h0.x;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w0.y, 15u) * src_w0_h0.y;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w0.z, 15u) * src_w0_h0.z;
    r_w0_h0_s3.w += subgroupBroadcast(simd_w0.w, 15u) * src_w0_h0.w;
    filters_offset += 16;
    }
    if (reserved_subgroup_size == 32u) {
    var simd_w0 : vec4<f32>;
    if (simd_id < 16) {
      simd_w0 = weights_buffer.data[filters_offset + simd_id + 0];
    }
    src_w0_h0 = vec4<f32>(textureLoad(src_tensor_image2d, vec2<i32>((xc0), ((yc0) * U.i0.z + (s))), 0));
    s += 1;
    r_w0_h0_s0.x += subgroupBroadcast(simd_w0.x, 0u) * src_w0_h0.x;
    ...
    if (reserved_subgroup_size == 128u) {
    var simd_w0 : vec4<f32>;
    if (simd_id < 16) {
      simd_w0 = weights_buffer.data[filters_offset + simd_id + 0];
    }
  ...
  {
    var bias_val : vec4<f32>= vec4<f32>(biases_buffer.data[(DST_S + 0)]);
  {
    var res : vec4<f32>= vec4<f32>(r_w0_h0_s0) + bias_val;
    textureStore(dst_tensor_image2d, vec2<i32>((DST_X + 0), ((DST_Y + 0) * U.i0.y + (DST_S + 0))), res);
  }
  }
  if (DST_S + 1 >= U.i0.y) {return;}
  {
    var bias_val : vec4<f32>= vec4<f32>(biases_buffer.data[(DST_S + 1)]);
  {
    var res : vec4<f32>= vec4<f32>(r_w0_h0_s1) + bias_val;
    textureStore(dst_tensor_image2d, vec2<i32>((DST_X + 0), ((DST_Y + 0) * U.i0.y + (DST_S + 1))), res);
  }
  }
  if (DST_S + 2 >= U.i0.y) {return;}
  {
    var bias_val : vec4<f32>= vec4<f32>(biases_buffer.data[(DST_S + 2)]);
  {
    var res : vec4<f32>= vec4<f32>(r_w0_h0_s2) + bias_val;
    textureStore(dst_tensor_image2d, vec2<i32>((DST_X + 0), ((DST_Y + 0) * U.i0.y + (DST_S + 2))), res);
  }
  }
  if (DST_S + 3 >= U.i0.y) {return;}
  {
    var bias_val : vec4<f32>= vec4<f32>(biases_buffer.data[(DST_S + 3)]);
  {
    var res : vec4<f32>= vec4<f32>(r_w0_h0_s3) + bias_val;
...
void TestWebGPU() {
    ...
    if (!adapters.empty()) {
        ...
        const char* s1 = kWGSLShader;
        const char* s2 = kWGSLShaderAllSubgroups;
        (void)s1;
        (void)s2;
        wgpu::ShaderModuleWGSLDescriptor shaderModuleWGSLDesc;
        shaderModuleWGSLDesc.code = s1;
