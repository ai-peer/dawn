  ...
  int4 shared_int4_1)
{
  ...
  int s = 0;
  while(true) {
    FLT4 src_w0_h0_s0 = READIMG(src_tensor_image2d, smp_zero, (int2)((DST_X), ((DST_Y) * shared_int4_0.z + (s))));
    FLT4 src_w0_h0_s1 = READIMG(src_tensor_image2d, smp_zero, (int2)((DST_X), ((DST_Y) * shared_int4_0.z + (s + 1))));
    if (get_sub_group_size() == 16) {
      FLT4 w0 = weights_buffer[filters_offset + get_sub_group_local_id()];
      filters_offset += 16;
      FLT4 w1 = weights_buffer[filters_offset + get_sub_group_local_id()];
      filters_offset += 16;

      FLT4 w_0 = sub_group_broadcast(w0, 0);
      FLT4 w_1 = sub_group_broadcast(w0, 1);
      FLT4 w_2 = sub_group_broadcast(w0, 2);
      FLT4 w_3 = sub_group_broadcast(w0, 3);
      FLT4 w_4 = sub_group_broadcast(w0, 4);
      FLT4 w_5 = sub_group_broadcast(w0, 5);
      FLT4 w_6 = sub_group_broadcast(w0, 6);
      FLT4 w_7 = sub_group_broadcast(w0, 7);
      FLT4 w_8 = sub_group_broadcast(w0, 8);
      FLT4 w_9 = sub_group_broadcast(w0, 9);
      FLT4 w_10 = sub_group_broadcast(w0, 10);
      FLT4 w_11 = sub_group_broadcast(w0, 11);
      FLT4 w_12 = sub_group_broadcast(w0, 12);
      FLT4 w_13 = sub_group_broadcast(w0, 13);
      FLT4 w_14 = sub_group_broadcast(w0, 14);
      FLT4 w_15 = sub_group_broadcast(w0, 15);
