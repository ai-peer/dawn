  ...
  int4 shared_int4_1)
{
  ...
  while(true) {
    ...
    r_w0_h0_s0.x += sub_group_broadcast(w0.x, 0) * src_w0_h0.x;
    r_w0_h0_s0.y += sub_group_broadcast(w0.y, 0) * src_w0_h0.x;
    r_w0_h0_s0.z += sub_group_broadcast(w0.z, 0) * src_w0_h0.x;
    r_w0_h0_s0.w += sub_group_broadcast(w0.w, 0) * src_w0_h0.x;
    r_w0_h0_s0.x += sub_group_broadcast(w0.x, 1) * src_w0_h0.y;
    r_w0_h0_s0.y += sub_group_broadcast(w0.y, 1) * src_w0_h0.y;
    r_w0_h0_s0.z += sub_group_broadcast(w0.z, 1) * src_w0_h0.y;
    r_w0_h0_s0.w += sub_group_broadcast(w0.w, 1) * src_w0_h0.y;
    r_w0_h0_s0.x += sub_group_broadcast(w0.x, 2) * src_w0_h0.z;
    r_w0_h0_s0.y += sub_group_broadcast(w0.y, 2) * src_w0_h0.z;
    r_w0_h0_s0.z += sub_group_broadcast(w0.z, 2) * src_w0_h0.z;
    r_w0_h0_s0.w += sub_group_broadcast(w0.w, 2) * src_w0_h0.z;
    r_w0_h0_s0.x += sub_group_broadcast(w0.x, 3) * src_w0_h0.w;
    r_w0_h0_s0.y += sub_group_broadcast(w0.y, 3) * src_w0_h0.w;
    r_w0_h0_s0.z += sub_group_broadcast(w0.z, 3) * src_w0_h0.w;
    r_w0_h0_s0.w += sub_group_broadcast(w0.w, 3) * src_w0_h0.w;
    r_w0_h0_s1.x += sub_group_broadcast(w0.x, 4) * src_w0_h0.x;
    r_w0_h0_s1.y += sub_group_broadcast(w0.y, 4) * src_w0_h0.x;
    r_w0_h0_s1.z += sub_group_broadcast(w0.z, 4) * src_w0_h0.x;
    r_w0_h0_s1.w += sub_group_broadcast(w0.w, 4) * src_w0_h0.x;
    r_w0_h0_s1.x += sub_group_broadcast(w0.x, 5) * src_w0_h0.y;
    r_w0_h0_s1.y += sub_group_broadcast(w0.y, 5) * src_w0_h0.y;
    r_w0_h0_s1.z += sub_group_broadcast(w0.z, 5) * src_w0_h0.y;
    r_w0_h0_s1.w += sub_group_broadcast(w0.w, 5) * src_w0_h0.y;
    r_w0_h0_s1.x += sub_group_broadcast(w0.x, 6) * src_w0_h0.z;
    r_w0_h0_s1.y += sub_group_broadcast(w0.y, 6) * src_w0_h0.z;
    r_w0_h0_s1.z += sub_group_broadcast(w0.z, 6) * src_w0_h0.z;
    r_w0_h0_s1.w += sub_group_broadcast(w0.w, 6) * src_w0_h0.z;
    r_w0_h0_s1.x += sub_group_broadcast(w0.x, 7) * src_w0_h0.w;
    r_w0_h0_s1.y += sub_group_broadcast(w0.y, 7) * src_w0_h0.w;
    r_w0_h0_s1.z += sub_group_broadcast(w0.z, 7) * src_w0_h0.w;
    r_w0_h0_s1.w += sub_group_broadcast(w0.w, 7) * src_w0_h0.w;
    r_w0_h0_s2.x += sub_group_broadcast(w0.x, 8) * src_w0_h0.x;
    r_w0_h0_s2.y += sub_group_broadcast(w0.y, 8) * src_w0_h0.x;
    r_w0_h0_s2.z += sub_group_broadcast(w0.z, 8) * src_w0_h0.x;
    r_w0_h0_s2.w += sub_group_broadcast(w0.w, 8) * src_w0_h0.x;
    r_w0_h0_s2.x += sub_group_broadcast(w0.x, 9) * src_w0_h0.y;
    r_w0_h0_s2.y += sub_group_broadcast(w0.y, 9) * src_w0_h0.y;
    r_w0_h0_s2.z += sub_group_broadcast(w0.z, 9) * src_w0_h0.y;
    r_w0_h0_s2.w += sub_group_broadcast(w0.w, 9) * src_w0_h0.y;
    r_w0_h0_s2.x += sub_group_broadcast(w0.x, 10) * src_w0_h0.z;
    r_w0_h0_s2.y += sub_group_broadcast(w0.y, 10) * src_w0_h0.z;
    r_w0_h0_s2.z += sub_group_broadcast(w0.z, 10) * src_w0_h0.z;
    r_w0_h0_s2.w += sub_group_broadcast(w0.w, 10) * src_w0_h0.z;
    r_w0_h0_s2.x += sub_group_broadcast(w0.x, 11) * src_w0_h0.w;
    r_w0_h0_s2.y += sub_group_broadcast(w0.y, 11) * src_w0_h0.w;
    r_w0_h0_s2.z += sub_group_broadcast(w0.z, 11) * src_w0_h0.w;
    r_w0_h0_s2.w += sub_group_broadcast(w0.w, 11) * src_w0_h0.w;
    r_w0_h0_s3.x += sub_group_broadcast(w0.x, 12) * src_w0_h0.x;
    r_w0_h0_s3.y += sub_group_broadcast(w0.y, 12) * src_w0_h0.x;
    r_w0_h0_s3.z += sub_group_broadcast(w0.z, 12) * src_w0_h0.x;
    r_w0_h0_s3.w += sub_group_broadcast(w0.w, 12) * src_w0_h0.x;
    r_w0_h0_s3.x += sub_group_broadcast(w0.x, 13) * src_w0_h0.y;
    r_w0_h0_s3.y += sub_group_broadcast(w0.y, 13) * src_w0_h0.y;
    r_w0_h0_s3.z += sub_group_broadcast(w0.z, 13) * src_w0_h0.y;
    r_w0_h0_s3.w += sub_group_broadcast(w0.w, 13) * src_w0_h0.y;
    r_w0_h0_s3.x += sub_group_broadcast(w0.x, 14) * src_w0_h0.z;
    r_w0_h0_s3.y += sub_group_broadcast(w0.y, 14) * src_w0_h0.z;
    r_w0_h0_s3.z += sub_group_broadcast(w0.z, 14) * src_w0_h0.z;
    r_w0_h0_s3.w += sub_group_broadcast(w0.w, 14) * src_w0_h0.z;
    r_w0_h0_s3.x += sub_group_broadcast(w0.x, 15) * src_w0_h0.w;
    r_w0_h0_s3.y += sub_group_broadcast(w0.y, 15) * src_w0_h0.w;
    r_w0_h0_s3.z += sub_group_broadcast(w0.z, 15) * src_w0_h0.w;
    r_w0_h0_s3.w += sub_group_broadcast(w0.w, 15) * src_w0_h0.w;
    s += 1;

    src_w0_h0 = read_imagef(src_tensor_image2d, smp_zero, (int2)((DST_X), ((DST_Y) * shared_int4_0.z + (s))));
    r_w0_h0_s0.x += sub_group_broadcast(w1.x, 0) * src_w0_h0.x;
    r_w0_h0_s0.y += sub_group_broadcast(w1.y, 0) * src_w0_h0.x;
    r_w0_h0_s0.z += sub_group_broadcast(w1.z, 0) * src_w0_h0.x;
    r_w0_h0_s0.w += sub_group_broadcast(w1.w, 0) * src_w0_h0.x;
    r_w0_h0_s0.x += sub_group_broadcast(w1.x, 1) * src_w0_h0.y;
    r_w0_h0_s0.y += sub_group_broadcast(w1.y, 1) * src_w0_h0.y;
    r_w0_h0_s0.z += sub_group_broadcast(w1.z, 1) * src_w0_h0.y;
    r_w0_h0_s0.w += sub_group_broadcast(w1.w, 1) * src_w0_h0.y;
    r_w0_h0_s0.x += sub_group_broadcast(w1.x, 2) * src_w0_h0.z;
    r_w0_h0_s0.y += sub_group_broadcast(w1.y, 2) * src_w0_h0.z;
    r_w0_h0_s0.z += sub_group_broadcast(w1.z, 2) * src_w0_h0.z;
    r_w0_h0_s0.w += sub_group_broadcast(w1.w, 2) * src_w0_h0.z;
    r_w0_h0_s0.x += sub_group_broadcast(w1.x, 3) * src_w0_h0.w;
    r_w0_h0_s0.y += sub_group_broadcast(w1.y, 3) * src_w0_h0.w;
    r_w0_h0_s0.z += sub_group_broadcast(w1.z, 3) * src_w0_h0.w;
    r_w0_h0_s0.w += sub_group_broadcast(w1.w, 3) * src_w0_h0.w;
    r_w0_h0_s1.x += sub_group_broadcast(w1.x, 4) * src_w0_h0.x;
    r_w0_h0_s1.y += sub_group_broadcast(w1.y, 4) * src_w0_h0.x;
    r_w0_h0_s1.z += sub_group_broadcast(w1.z, 4) * src_w0_h0.x;
    r_w0_h0_s1.w += sub_group_broadcast(w1.w, 4) * src_w0_h0.x;
    r_w0_h0_s1.x += sub_group_broadcast(w1.x, 5) * src_w0_h0.y;
    r_w0_h0_s1.y += sub_group_broadcast(w1.y, 5) * src_w0_h0.y;
    r_w0_h0_s1.z += sub_group_broadcast(w1.z, 5) * src_w0_h0.y;
    r_w0_h0_s1.w += sub_group_broadcast(w1.w, 5) * src_w0_h0.y;
    r_w0_h0_s1.x += sub_group_broadcast(w1.x, 6) * src_w0_h0.z;
    r_w0_h0_s1.y += sub_group_broadcast(w1.y, 6) * src_w0_h0.z;
    r_w0_h0_s1.z += sub_group_broadcast(w1.z, 6) * src_w0_h0.z;
    r_w0_h0_s1.w += sub_group_broadcast(w1.w, 6) * src_w0_h0.z;
    r_w0_h0_s1.x += sub_group_broadcast(w1.x, 7) * src_w0_h0.w;
    r_w0_h0_s1.y += sub_group_broadcast(w1.y, 7) * src_w0_h0.w;
    r_w0_h0_s1.z += sub_group_broadcast(w1.z, 7) * src_w0_h0.w;
    r_w0_h0_s1.w += sub_group_broadcast(w1.w, 7) * src_w0_h0.w;
    r_w0_h0_s2.x += sub_group_broadcast(w1.x, 8) * src_w0_h0.x;
    r_w0_h0_s2.y += sub_group_broadcast(w1.y, 8) * src_w0_h0.x;
    r_w0_h0_s2.z += sub_group_broadcast(w1.z, 8) * src_w0_h0.x;
    r_w0_h0_s2.w += sub_group_broadcast(w1.w, 8) * src_w0_h0.x;
    r_w0_h0_s2.x += sub_group_broadcast(w1.x, 9) * src_w0_h0.y;
    r_w0_h0_s2.y += sub_group_broadcast(w1.y, 9) * src_w0_h0.y;
    r_w0_h0_s2.z += sub_group_broadcast(w1.z, 9) * src_w0_h0.y;
    r_w0_h0_s2.w += sub_group_broadcast(w1.w, 9) * src_w0_h0.y;
    r_w0_h0_s2.x += sub_group_broadcast(w1.x, 10) * src_w0_h0.z;
    r_w0_h0_s2.y += sub_group_broadcast(w1.y, 10) * src_w0_h0.z;
    r_w0_h0_s2.z += sub_group_broadcast(w1.z, 10) * src_w0_h0.z;
    r_w0_h0_s2.w += sub_group_broadcast(w1.w, 10) * src_w0_h0.z;
    r_w0_h0_s2.x += sub_group_broadcast(w1.x, 11) * src_w0_h0.w;
    r_w0_h0_s2.y += sub_group_broadcast(w1.y, 11) * src_w0_h0.w;
    r_w0_h0_s2.z += sub_group_broadcast(w1.z, 11) * src_w0_h0.w;
    r_w0_h0_s2.w += sub_group_broadcast(w1.w, 11) * src_w0_h0.w;
    r_w0_h0_s3.x += sub_group_broadcast(w1.x, 12) * src_w0_h0.x;
    r_w0_h0_s3.y += sub_group_broadcast(w1.y, 12) * src_w0_h0.x;
    r_w0_h0_s3.z += sub_group_broadcast(w1.z, 12) * src_w0_h0.x;
    r_w0_h0_s3.w += sub_group_broadcast(w1.w, 12) * src_w0_h0.x;
    r_w0_h0_s3.x += sub_group_broadcast(w1.x, 13) * src_w0_h0.y;
    r_w0_h0_s3.y += sub_group_broadcast(w1.y, 13) * src_w0_h0.y;
    r_w0_h0_s3.z += sub_group_broadcast(w1.z, 13) * src_w0_h0.y;
    r_w0_h0_s3.w += sub_group_broadcast(w1.w, 13) * src_w0_h0.y;
    r_w0_h0_s3.x += sub_group_broadcast(w1.x, 14) * src_w0_h0.z;
    r_w0_h0_s3.y += sub_group_broadcast(w1.y, 14) * src_w0_h0.z;
    r_w0_h0_s3.z += sub_group_broadcast(w1.z, 14) * src_w0_h0.z;
    r_w0_h0_s3.w += sub_group_broadcast(w1.w, 14) * src_w0_h0.z;
    r_w0_h0_s3.x += sub_group_broadcast(w1.x, 15) * src_w0_h0.w;
    r_w0_h0_s3.y += sub_group_broadcast(w1.y, 15) * src_w0_h0.w;
    r_w0_h0_s3.z += sub_group_broadcast(w1.z, 15) * src_w0_h0.w;
    r_w0_h0_s3.w += sub_group_broadcast(w1.w, 15) * src_w0_h0.w;
    s += 1;
