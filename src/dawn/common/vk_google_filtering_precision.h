...
#ifndef SRC_DAWN_COMMON_VK_GOOGLE_SAMPLER_FILTERING_PRECISION_H_
#define SRC_DAWN_COMMON_VK_GOOGLE_SAMPLER_FILTERING_PRECISION_H_
...
#endif  // SRC_DAWN_COMMON_VK_GOOGLE_SAMPLER_FILTERING_PRECISION_H_
