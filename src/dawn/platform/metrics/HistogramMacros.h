...
#define DAWN_HISTOGRAM_BOOLEAN(platformObj, name, true_or_false) \
    dawn::platform::histogram::Boolean(platformObj, name, true_or_false)

// Histogram for enumeration values.
#define DAWN_HISTOGRAM_ENUMERATION(platformObj, name, enum_value, enum_boundary_value) \
    dawn::platform::histogram::Enumeration(platformObj, name, enum_value, enum_boundary_value)
...
#define DAWN_HISTOGRAM_SPARSE(platformObj, name, sample) \
