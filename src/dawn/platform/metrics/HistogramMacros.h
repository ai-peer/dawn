...
#define SCOPED_DAWN_HISTOGRAM_TIMER(platform, name)                                           \
    SCOPED_DAWN_HISTOGRAM_TIMER_EXPANDER(platform, name, ScopedHistogramTiming::kMediumTimes, \
                                         __COUNTER__)
...
#define SCOPED_DAWN_HISTOGRAM_LONG_TIMER(platform, name)                                    \
    SCOPED_DAWN_HISTOGRAM_TIMER_EXPANDER(platform, name, ScopedHistogramTiming::kLongTimes, \
                                         __COUNTER__)
...
#define SCOPED_DAWN_HISTOGRAM_TIMER_MICROS(platform, name)                                         \
    SCOPED_DAWN_HISTOGRAM_TIMER_EXPANDER(platform, name, ScopedHistogramTiming::kMicrosecondTimes, \
                                         __COUNTER__)
