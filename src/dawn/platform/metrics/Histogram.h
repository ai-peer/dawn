...
// The functions in this header are used to forward their respective calls
// onto the Platform object. This layer of indirection is used to keep the
// Platform implementation private (PIMPL).

// Forwards call to platform->HistogramCustomCounts
