...
class SwapChain final : public d3d::SwapChain {
  ...
  private:
    ...
    virtual void ReuseBuffers(SwapChainBase* previousSwapChain) override;
    // Does the swapchain initialization step of gathering the buffers.
    virtual MaybeError CollectSwapChainBuffers() override;
    ...
    virtual MaybeError DetachAndWaitForDeallocation() override;
