...
bool Adapter::SupportsExternalImages() const {
    // TODO(crbug.com/dawn/1724): Implement external images on D3D11.
    return false;
}
...
bool Adapter::AreTimestampQueriesSupported() const {
    // TODO(crbug.com/dawn/1723): Implement timestamp queries on D3D11.
    return false;
}
...
void Adapter::InitializeSupportedFeaturesImpl() {
    ...
    // TODO(crbug.com/dawn/1722): Implement pipeline statistics queries on D3D11.
...
MaybeError Adapter::InitializeSupportedLimitsImpl(CombinedLimits* limits) {
    ...
    // TODO(crbug.com/dawn/1720): support more than one bind group?
    limits->v1.maxBindGroups = 1;
    // TODO(crbug.com/dawn/1721): support dynamic uniform buffers and storage buffers?
