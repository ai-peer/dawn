...
// #include "dawn/native/d3d11/IntegerTypes.h"
...
class Texture final : public TextureBase {
  public:
    ...
    ID3D11Resource* GetD3D11Texture() { return mResource.Get(); }
  ...
  private:
    ...
    //     D3D11_RESOURCE_STATES lastState;
    ...
    //                                           D3D11_RESOURCE_STATES newState,
    //                                           const SubresourceRange& range);
    // void TransitionSubresourceRange(std::vector<D3D11_RESOURCE_BARRIER>* barriers,
    //                                 const SubresourceRange& range,
    //                                 StateAndDecay* state,
    //                                 D3D11_RESOURCE_STATES subresourceNewState,
    ...
    // D3D11_RESOURCE_FLAGS mD3D11ResourceFlags;
...
class TextureView final : public TextureViewBase {
  public:
    ...
    const D3D11_SHADER_RESOURCE_VIEW_DESC& GetSRVDescriptor() const;
    D3D11_RENDER_TARGET_VIEW_DESC GetRTVDescriptor() const;
    D3D11_DEPTH_STENCIL_VIEW_DESC GetDSVDescriptor(bool depthReadOnly, bool stencilReadOnly) const;
    D3D11_UNORDERED_ACCESS_VIEW_DESC GetUAVDescriptor() const;
