...
MaybeError Device::Initialize(const DeviceDescriptor* descriptor) {
    ...
    mD3d11Device->GetImmediateContext(&immediateContext);
    DAWN_TRY(CheckHRESULT(immediateContext.As(&mD3d11ImmediateContext4),
                          "D3D11: getting immediate context"));
...
MaybeError Device::NextSerial() {
    ...
    DAWN_TRY(CheckHRESULT(
        mD3d11ImmediateContext4->Signal(mFence.Get(), uint64_t(GetLastSubmittedCommandSerial())),
