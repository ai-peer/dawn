...
// #include "dawn/native/d3d11/ResourceHeapAllocationD3D11.h"
...
class Buffer final : public BufferBase {
  public:
    ...
    // D3D11_GPU_VIRTUAL_ADDRESS GetVA() const;
    ...
    uint8_t* GetStagingBufferPointer() { return mMappableBuffer.data(); }
  ...
  private:
    ...
    std::vector<uint8_t> mMappableBuffer;
    ...
    // D3D11_RANGE mWrittenMappedRange = {0, 0};
