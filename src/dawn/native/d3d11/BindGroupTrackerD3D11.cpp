...
void CheckAllSlotsAreEmpty(CommandRecordingContext* commandContext) {
    ID3D11DeviceContext1* deviceContext1 = commandContext->GetD3D11DeviceContext1();
    // Check constant buffer slots
    for (UINT slot = 0; slot < D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - 1; ++slot) {
...
void CheckAllSlotsAreEmpty(CommandRecordingContext*) {}
...
BindGroupTracker::~BindGroupTracker() {
    ...
    CheckAllSlotsAreEmpty(mCommandContext);
}
