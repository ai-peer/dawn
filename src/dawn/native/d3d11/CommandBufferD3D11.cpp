...
MaybeError CommandBuffer::Execute() {
    ...
    auto LazyClearSyncScope = [commandContext](const SyncScopeResourceUsage& scope) {
        ...
        for (BufferBase* buffer : scope.buffers) {
            std::ignore = ToBackend(buffer)->EnsureDataInitialized(commandContext);
        }
    };
    ...
    while (mCommands.NextCommandId(&type)) {
        switch (type) {
            ...
            case Command::BeginRenderPass: {
                ...
                return DAWN_UNIMPLEMENTED_ERROR("Render passes are not supported");
                break;
            }
            ...
            case Command::CopyBufferToBuffer: {
                ...
                DAWN_TRY(Buffer::Copy(commandContext, destination, copy->destinationOffset,
            ...
            case Command::CopyBufferToTexture: {
                ...
                if (!scopedMap.GetMappedData()) {
                    // TODO(): implement CopyBufferToTexture with non-mappable buffers.
                    return DAWN_UNIMPLEMENTED_ERROR(
                        "CopyBufferToTexture is implemented with non-mappable buffers");
                }
            ...
            case Command::CopyTextureToBuffer: {
                ...
                if (src.texture->GetDimension() == wgpu::TextureDimension::e3D) {
                    subresource = src.texture->GetSubresourceIndex(src.mipLevel, 0, src.aspect);
                } else {
            ...
            case Command::CopyTextureToTexture: {
                ...
                DAWN_TRY(Texture::CopyTextureToTexture(commandContext, copy));
                break;
            }
