        ...
        for (BindingIndex bindingIndex{0}; bindingIndex < group->GetLayout()->GetBindingCount();
            ...
            switch (bindingInfo.bindingType) {
                ...
                case BindingInfoType::StorageTexture: {
                    ...
                    // GLuint imageIndex = static_cast<uint32_t>(bindingIndex);
    ...
    while (mCommands.NextCommandId(&type)) {
        switch (type) {
            ...
            case Command::CopyBufferToBuffer: {
                ...
                if (source->GetD3D11Buffer() && destination->GetD3D11Buffer()) {
                    ...
                    if (destination->GetUsage() & wgpu::BufferUsage::Uniform) {
                        // D3D11 doesn't allow updating part of a uniform buffer.
                        DAWN_ASSERT(copy->destinationOffset == 0);
                    } else {
            ...
            case Command::CopyTextureToBuffer: {
                ...
                // TODO: figure out the memcpy size.
