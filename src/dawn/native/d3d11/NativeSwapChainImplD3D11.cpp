...
#include "dawn/native/d3d11/NativeSwapChainImplD3D11.h"
...
namespace {
DXGI_USAGE D3D11SwapChainBufferUsage(WGPUTextureUsage allowedUsages) {
...
void NativeSwapChainImpl::Init(DawnWSIContextD3D11* /*context*/) {}
...
DawnSwapChainError NativeSwapChainImpl::Configure(WGPUTextureFormat format,
    ...
    // Create the D3D11 swapchain, assuming only two buffers for now
    DXGI_SWAP_CHAIN_DESC1 swapChainDesc = {};
    swapChainDesc.Width = width;
    swapChainDesc.Height = height;
    swapChainDesc.Format = D3D11TextureFormat(GetPreferredFormat());
    swapChainDesc.BufferUsage = D3D11SwapChainBufferUsage(usage);
    ...
    ASSERT_SUCCESS(factory->CreateSwapChainForHwnd(mDevice->GetD3D11Device(), mWindow,
