...
#ifndef SRC_DAWN_NATIVE_D3D11_D3D11_PLATFORM_H_
#define SRC_DAWN_NATIVE_D3D11_D3D11_PLATFORM_H_

// Pre-emptively include windows.h but remove its macros so that they aren't set when declaring the
// COM interfaces. Otherwise ID3D11InfoQueue::GetMessage would be either GetMessageA or GetMessageW
...
#endif  // SRC_DAWN_NATIVE_D3D11_D3D11_PLATFORM_H_
