...
class Device final : public DeviceBase {
  public:
    ...
    // ComPtr<ID3D11CommandQueue> GetCommandQueue() const;
    // ID3D11SharingContract* GetSharingContract() const;
    HANDLE GetFenceHandle() const;

    // ComPtr<ID3D11CommandSignature> GetDispatchIndirectSignature() const;
    // ComPtr<ID3D11CommandSignature> GetDrawIndirectSignature() const;
    // ComPtr<ID3D11CommandSignature> GetDrawIndexedIndirectSignature() const;
    ...
    //                                             d3d11on12Resource, bool isSwapChainTexture, bool
    //                                             isInitialized);
  ...
  private:
    ...
    // ComPtr<ID3D11CommandQueue> mCommandQueue;
    // ComPtr<ID3D11SharingContract> mD3d12SharingContract;

    // 11on12 device corresponding to mCommandQueue
    // ComPtr<ID3D11On12Device> mD3d11On12Device;

    // ComPtr<ID3D11CommandSignature> mDispatchIndirectSignature;
    // ComPtr<ID3D11CommandSignature> mDrawIndirectSignature;
    // ComPtr<ID3D11CommandSignature> mDrawIndexedIndirectSignature;
