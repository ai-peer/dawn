...
namespace dawn::native {
    ...
    DeviceBase::GetOrCreateDummyTextureViewForExternalTexture() {
        if (!mExternalTextureDummyView.Get()) {
            ASSERT(!mExternalTextureDummy.Get());
            ...
            DAWN_TRY_ASSIGN(mExternalTextureDummy, CreateTexture(&textureDesc));
            ...
            DAWN_TRY_ASSIGN(mExternalTextureDummyView,
                            CreateTextureView(mExternalTextureDummy.Get(), &textureViewDesc));
        }
