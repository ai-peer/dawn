...
namespace {
Mutex& GetGlobalDeviceMutex() {
    static Mutex gMutex;
    return gMutex;
}

bool IsMutexLockedByCurrentThreadOrNull(Mutex* mutex) {
...
Ref<ComputePipelineBase> DeviceBase::AddOrGetCachedComputePipeline(
    ...
    ASSERT(IsMutexLockedByCurrentThreadOrNull(mMutex));
