...
TripleStatesTogglesSet TripleStatesTogglesSet::CreateFromTogglesDeviceDescriptor(
    const DawnTogglesDeviceDescriptor* togglesDesc) {
    TripleStatesTogglesSet userToggles;
...
bool TripleStatesTogglesSet::IsDisabled(Toggle toggle) const {
    return togglesIsProvided.Has(toggle) && !providedTogglesEnabled.Has(toggle);
}

std::vector<const char*> TripleStatesTogglesSet::GetEnabledToggleNames() const {
...
std::vector<const char*> TripleStatesTogglesSet::GetDisabledToggleNames() const {
