...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    ...
    {Toggle::UseBlitForBufferToStencilTextureCopy,
     {"use_blit_for_buffer_to_stencil_texture_copy",
      ...
      "to a render or compute pass.",
      "https://crbug.com/dawn/1389"}},
    {Toggle::UseBlitForDepthTextureToTextureCopy,
     {"use_blit_for_depth_texture_to_texture_copy",
      "Use a blit to copy from a depth texture to a depth texture. Works around an issue where "
      "the copy command does not work correctly.",
