...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    ...
    {Toggle::VulkanUseBufferRobustAccess2,
     {"vulkan_use_buffer_robust_access_2",
      ...
      "https://crbug.com/tint/1890", ToggleStage::Device}},
    {Toggle::D3D12SupportMSAA64KBAlignedTexture,
     {"d3d12_support_msaa_64kb_alignment_texture",
      "Support creating MSAA textures with 64KB (D3D12_SMALL_MSAA_RESOURCE_PLACEMENT_ALIGNMENT) "
      "alignment.",
