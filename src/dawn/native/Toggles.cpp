...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    ...
    {Toggle::D3D12ForceInitializeCopyableDepthStencilTextureOnCreation,
     {"d3d12_force_initialize_copyable_depth_stencil_texture_on_creation",
      "Always initializing the copyable depth stencil textures when creating them instead of "
      "skipping the initialization when the entire subresource is the copy destination as a "
      "workaround on Intel D3D12 drivers.",
