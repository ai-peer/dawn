...
TogglesState TogglesState::CreateFromInitializerForTesting(
    ...
    for (auto enabledToggle : enabledToggles) {
        ...
        if (toggleStage < togglesStateStage) {
            // For a toggle of earlier stage than required stage, pretend that it is
            // inherited.
            togglesState.Inherit(enabledToggle, true);
        } else {
            // For a toggle of the same stage of required stage, directly set it.
            togglesState.Set(enabledToggle, true);
        }
    }
    for (auto disabledToggle : disabledToggles) {
        ...
        if (toggleStage < togglesStateStage) {
            // For a toggle of earlier stage than required stage, pretend that it is
            // inherited.
            togglesState.Inherit(disabledToggle, false);
        } else {
            // For a toggle of the same stage of required stage, directly set it.
            togglesState.Set(disabledToggle, false);
        }
    }
    return togglesState;
}
