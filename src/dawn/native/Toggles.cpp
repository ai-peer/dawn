...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    ...
    {Toggle::MetalUseCombinedDepthStencilFormatForStencil8,
     {"metal_use_combined_depth_stencil_format_for_stencil8",
      ...
      "https://crbug.com/dawn/1389", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::UseBlitForDepthTextureToTextureCopyToNonzeroSubresource,
     {"use_blit_for_depth_texture_to_texture_copy_to_nonzero_subresource",
      ...
      "https://crbug.com/dawn/1083", ToggleInfo::ToggleStage::Device}},
...
TogglesState TogglesState::CreateFromRequiredAndInheritedToggles(
    ...
    for (uint32_t i : IterateBitSet(inheritedToggles.GetSetBitSet())) {
        ...
        toggles.Inherit(toggle, inheritedToggles.IsEnabled(toggle),
                        inheritedToggles.IsForced(toggle));
    }
...
void TogglesState::Inherit(Toggle toggle, bool enabled, bool forced) {
    ...
    togglesIsSet.Set(toggle, true);
    togglesIsEnabled.Set(toggle, enabled);
    togglesIsForced.Set(toggle, forced);
}
