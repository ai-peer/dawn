...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    ...
    {Toggle::DisableTimestampQueryConversion,
     {"disable_timestamp_query_conversion",
      ...
      ToggleStage::Device}},
    {Toggle::ForceClearBufferBeforeResolveQueries,
     {"force_clear_buffer_before_resolve_queries",
      "Froce to clear destination buffer to zero before resolving queries. This toggle is"
