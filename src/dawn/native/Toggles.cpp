...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    ...
    {Toggle::D3D11UseFeatureLevel10,
     {"d3d11_use_feature_level_10", "Force using feature level 10.0 when creating D3D11 device.",
      "https://crbug.com/dawn/1820", ToggleStage::Device}},
