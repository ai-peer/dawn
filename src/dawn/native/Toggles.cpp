...
static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
    {Toggle::EmulateStoreAndMSAAResolve,
     {"emulate_store_and_msaa_resolve",
      ...
      "https://crbug.com/dawn/56", ToggleInfo::ToggleStage::Device}},
    {Toggle::NonzeroClearResourcesOnCreationForTesting,
     {"nonzero_clear_resources_on_creation_for_testing",
      ...
      "memory.",
      "https://crbug.com/dawn/145", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::TurnOffVsync,
     {"turn_off_vsync",
      ...
      "https://crbug.com/dawn/237", ToggleInfo::ToggleStage::Device}},
    {Toggle::UseTemporaryBufferInCompressedTextureToTextureCopy,
     {"use_temporary_buffer_in_texture_to_texture_copy",
      ...
      "https://crbug.com/dawn/42", ToggleInfo::ToggleStage::Device}},
    {Toggle::UseD3D12ResourceHeapTier2,
     {"use_d3d12_resource_heap_tier2",
      ...
      "https://crbug.com/dawn/27", ToggleInfo::ToggleStage::Device}},
    {Toggle::UseD3D12RenderPass,
     {"use_d3d12_render_pass",
      ...
      "pass.",
      "https://crbug.com/dawn/36", ToggleInfo::ToggleStage::Device}},
    {Toggle::UseD3D12ResidencyManagement,
     {"use_d3d12_residency_management",
      ...
      "https://crbug.com/dawn/193", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisableResourceSuballocation,
     {"disable_resource_suballocation",
      ...
      "https://crbug.com/1313172", ToggleInfo::ToggleStage::Device}},
    {Toggle::SkipValidation,
     {"skip_validation", "Skip expensive validation of Dawn commands.",
      "https://crbug.com/dawn/271", ToggleInfo::ToggleStage::Device}},
    {Toggle::VulkanUseD32S8,
     {"vulkan_use_d32s8",
      ...
      "https://crbug.com/dawn/286", ToggleInfo::ToggleStage::Device}},
    {Toggle::VulkanUseS8,
     {"vulkan_use_s8",
      ...
      "D24S8.",
      "https://crbug.com/dawn/666", ToggleInfo::ToggleStage::Device}},
    {Toggle::MetalDisableSamplerCompare,
     {"metal_disable_sampler_compare",
      ...
      "https://crbug.com/dawn/342", ToggleInfo::ToggleStage::Device}},
    {Toggle::MetalUseSharedModeForCounterSampleBuffer,
     {"metal_use_shared_mode_for_counter_sample_buffer",
      ...
      "https://crbug.com/dawn/434", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisableBaseVertex,
     {"disable_base_vertex",
      "Disables the use of non-zero base vertex which is unsupported on some platforms.",
      "https://crbug.com/dawn/343", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::DisableIndexedDrawBuffers,
     {"disable_indexed_draw_buffers",
      ...
      "https://crbug.com/dawn/582", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisableSnormRead,
     {"disable_snorm_read",
      "Disables reading from Snorm textures which is unsupported on some platforms.",
      "https://crbug.com/dawn/667", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::DisableBGRARead,
     {"disable_bgra_read",
      ...
      "https://crbug.com/dawn/1393", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisableSampleVariables,
     {"disable_sample_variables",
      ...
      "https://crbug.com/dawn/673", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::DisallowUnsafeAPIs,
     {"disallow_unsafe_apis",
      ...
      "http://crbug.com/1138528", ToggleInfo::ToggleStage::Instance}},
    {Toggle::FlushBeforeClientWaitSync,
     {"flush_before_client_wait_sync",
      ...
      "https://crbug.com/dawn/633", ToggleInfo::ToggleStage::Device}},
    {Toggle::UseTempBufferInSmallFormatTextureToTextureCopyFromGreaterToLessMipLevel,
     {"use_temp_buffer_in_small_format_texture_to_texture_copy_from_greater_to_less_mip_level",
      ...
      "backends.",
      "https://crbug.com/1161355", ToggleInfo::ToggleStage::Device}},
    {Toggle::EmitHLSLDebugSymbols,
     {"emit_hlsl_debug_symbols",
      ...
      "https://crbug.com/dawn/776", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisallowSpirv,
     {"disallow_spirv",
      ...
      "https://crbug.com/1214923", ToggleInfo::ToggleStage::Device}},
    {Toggle::DumpShaders,
     {"dump_shaders",
      ...
      "https://crbug.com/dawn/792", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::UseUserDefinedLabelsInBackend,
     {"use_user_defined_labels_in_backend",
      ...
      "https://crbug.com/dawn/840", ToggleInfo::ToggleStage::Device}},
    {Toggle::UsePlaceholderFragmentInVertexOnlyPipeline,
     {"use_placeholder_fragment_in_vertex_only_pipeline",
      ...
      "https://crbug.com/dawn/136", ToggleInfo::ToggleStage::Device}},
    {Toggle::FxcOptimizations,
     {"fxc_optimizations",
      ...
      "https://crbug.com/dawn/1203", ToggleInfo::ToggleStage::Device}},
    {Toggle::RecordDetailedTimingInTraceEvents,
     {"record_detailed_timing_in_trace_events",
      ...
      "frequency.",
      "https://crbug.com/dawn/1264", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::VulkanUseZeroInitializeWorkgroupMemoryExtension,
     {"use_vulkan_zero_initialize_workgroup_memory_extension",
      ...
      "https://crbug.com/dawn/1302", ToggleInfo::ToggleStage::Device}},
    {Toggle::D3D12SplitBufferTextureCopyForRowsPerImagePaddings,
     {"d3d12_split_buffer_texture_copy_for_rows_per_image_paddings",
      ...
      "https://crbug.com/dawn/1289", ToggleInfo::ToggleStage::Device}},
    {Toggle::MetalRenderR8RG8UnormSmallMipToTempTexture,
     {"metal_render_r8_rg8_unorm_small_mip_to_temp_texture",
      ...
      "https://crbug.com/dawn/1071", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisableBlobCache,
     {"disable_blob_cache",
      ...
      "https://crbug.com/dawn/549", ToggleInfo::ToggleStage::Device}},
    {Toggle::D3D12ForceClearCopyableDepthStencilTextureOnCreation,
     {"d3d12_force_clear_copyable_depth_stencil_texture_on_creation",
      ...
      "D3D12 drivers.",
      "https://crbug.com/dawn/1487", ToggleInfo::ToggleStage::Device}},
    ...
    {Toggle::D3D12AlwaysUseTypelessFormatsForCastableTexture,
     {"d3d12_always_use_typeless_formats_for_castable_texture",
      ...
      "is false.",
      "https://crbug.com/dawn/1276", ToggleInfo::ToggleStage::Device}},
    {Toggle::D3D12AllocateExtraMemoryFor2DArrayColorTexture,
     {"d3d12_allocate_extra_memory_for_2d_array_color_texture",
      ...
      "https://crbug.com/dawn/949", ToggleInfo::ToggleStage::Device}},
    {Toggle::D3D12UseTempBufferInDepthStencilTextureAndBufferCopyWithNonZeroBufferOffset,
     {"d3d12_use_temp_buffer_in_depth_stencil_texture_and_buffer_copy_with_non_zero_buffer_offset",
      ...
      "https://crbug.com/dawn/727", ToggleInfo::ToggleStage::Device}},
    {Toggle::ApplyClearBigIntegerColorValueWithDraw,
     {"apply_clear_big_integer_color_value_with_draw",
      ...
      "https://crbug.com/dawn/537", ToggleInfo::ToggleStage::Device}},
    {Toggle::MetalUseMockBlitEncoderForWriteTimestamp,
     {"metal_use_mock_blit_encoder_for_write_timestamp",
      ...
      "https://crbug.com/dawn/1473", ToggleInfo::ToggleStage::Device}},
    {Toggle::VulkanSplitCommandBufferOnDepthStencilComputeSampleAfterRenderPass,
     {"vulkan_split_command_buffer_on_depth_stencil_compute_sample_after_render_pass",
      ...
      "situation.",
      "https://crbug.com/dawn/1564", ToggleInfo::ToggleStage::Device}},
    {Toggle::D3D12Allocate2DTexturewithCopyDstAsCommittedResource,
     {"d3d12_allocate_2d_texture_with_copy_dst_as_committed_resource",
      ...
      "https://crbug.com/1237175", ToggleInfo::ToggleStage::Device}},
    {Toggle::DisallowDeprecatedAPIs,
     {"disallow_deprecated_apis",
      ...
      "https://crbug.com/dawn/1563", ToggleInfo::ToggleStage::Device}},
    {Toggle::NoWorkaroundSampleMaskBecomesZeroForAllButLastColorTarget,
     {"no_workaround_sample_mask_becomes_zero_for_all_but_last_color_target",
      ...
      "of zero.",
      "https://crbug.com/dawn/1462", ToggleInfo::ToggleStage::Device}},
    {Toggle::NoWorkaroundIndirectBaseVertexNotApplied,
     {"no_workaround_indirect_base_vertex_not_applied",
      ...
      "https://crbug.com/dawn/966", ToggleInfo::ToggleStage::Device}},
    {Toggle::NoWorkaroundDstAlphaBlendDoesNotWork,
     {"no_workaround_dst_alpha_blend_does_not_work",
      ...
      "https://crbug.com/dawn/1579", ToggleInfo::ToggleStage::Device}},
...
bool TogglesSet::operator==(const TogglesSet& rhs) const {
    return toggleBitset == rhs.toggleBitset;
}
...
bool RequiredTogglesSet::operator==(const RequiredTogglesSet& rhs) const {
    return (togglesIsProvided == rhs.togglesIsProvided) &&
           (providedTogglesEnabled == rhs.providedTogglesEnabled);
}
...
RequiredTogglesSet RequiredTogglesSet::CreateFromTogglesDescriptor(
    ...
    if (togglesDesc != nullptr) {
        // TODO: Use a global TogglesInfo object if possible, and remove Instance.TogglesInfo
...
TogglesState TogglesState::CreateFromTogglesDescriptor(const DawnTogglesDescriptor* togglesDesc) {
    return TogglesState::CreateFromRequiredTogglesSet(
        RequiredTogglesSet::CreateFromTogglesDescriptor(togglesDesc));
}
*/

TogglesState TogglesState::CreateFromRequiredTogglesSet(
    const RequiredTogglesSet& requiredTogglesSet) {
    ToggleInfo::ToggleStage requiredStage = requiredTogglesSet.requiredStage;
    // Assert that all toggles required in RequiredTogglesSet is of correct ToggleStage.
    for (uint32_t i : IterateBitSet(requiredTogglesSet.togglesIsProvided.toggleBitset)) {
        const Toggle& toggle = static_cast<Toggle>(i);
        const ToggleInfo* toggleInfo = TogglesInfo::GetToggleInfo(toggle);
        ASSERT(toggleInfo && toggleInfo->stage == requiredStage);
    }
    // Create a toggles state of the required stage, and assign all required toggles
    TogglesState toggles(requiredStage);
    toggles.togglesIsSet = requiredTogglesSet.togglesIsProvided;
    toggles.togglesIsEnabled = requiredTogglesSet.providedTogglesEnabled;
    toggles.requiredTogglesSet = requiredTogglesSet;
    return toggles;
}
...
TogglesState TogglesState::CreateFromRequiredAndInheritedToggles(
    ...
    ASSERT(inheritedToggles.togglesStateStage < requiredStage);

    // Create a TogglesState from required toggles
    TogglesState toggles = TogglesState::CreateFromRequiredTogglesSet(requiredTogglesSet);

    // Do inheritance.
    // Policy:
    // For each possible toggle,
    // 1. If it is force set in inherited toggles set, it is force set in result toggle set as well.
    // 2. Otherwise, if it is enabled or disabled in required toggles set, it is also
    //    enabled/disabled in result toggles set;
    // 3. Otherwise, if it is enabled or disabled in inherited toggles set, it is also
    //    enabled/disabled in result toggles set;
    // 4. Otherwise, this toggle is left unset in result toggles set.
    for (uint32_t i : IterateBitSet(inheritedToggles.GetSetBitSet())) {
        const Toggle& toggle = static_cast<Toggle>(i);
        if (inheritedToggles.IsForced(toggle)) {
            toggles.ForceSet(toggle, inheritedToggles.IsEnabled(toggle));
        } else {
            // Required toggles set must have different (later) stage than inherited toggles state,
            // so any toggle in inherited toggles state would not be required in required toggles
            // set.
            ASSERT(!requiredTogglesSet.IsRequired(toggle));
            toggles.Inherit(toggle, inheritedToggles.IsEnabled(toggle));
        }
    }
...
TogglesState TogglesState::CreateFromInitializerForTesting(
    ...
    for (auto enabledToggle : enabledToggles) {
        ...
        ToggleInfo::ToggleStage toggleStage = TogglesInfo::GetToggleInfo(enabledToggle)->stage;
        ASSERT(toggleStage <= togglesStateStage);
        togglesState.togglesIsSet.Set(enabledToggle, true);
        togglesState.togglesIsEnabled.Set(enabledToggle, true);
    }
    for (auto disabledToggle : disabledToggles) {
        // Ensure that all toggles are of required stage or earlier.
        ToggleInfo::ToggleStage toggleStage = TogglesInfo::GetToggleInfo(disabledToggle)->stage;
        ASSERT(toggleStage <= togglesStateStage);
        togglesState.togglesIsSet.Set(disabledToggle, true);
        togglesState.togglesIsEnabled.Set(disabledToggle, false);
    }
    return togglesState;
}

namespace {
// TODO: Remove these helper.
#define PRINT_TOGGLE_STAGE_ASSERT 0
void ASSERT_TOGGLE_STAGE_EQ(Toggle toggle, ToggleInfo::ToggleStage stage) {
#if PRINT_TOGGLE_STAGE_ASSERT
    printf("Checking toggle stage of %s == %zu\n", TogglesInfo::GetToggleInfo(toggle)->name,
           (size_t)stage);
#endif  // PRINT_TOGGLE_STAGE_ASSERT
    ASSERT(TogglesInfo::GetToggleInfo(toggle)->stage == stage);
}

void ASSERT_TOGGLE_STAGE_LE(Toggle toggle, ToggleInfo::ToggleStage stage) {
#if PRINT_TOGGLE_STAGE_ASSERT
    printf("Checking toggle stage of %s <= %zu\n", TogglesInfo::GetToggleInfo(toggle)->name,
           (size_t)stage);
#endif  // PRINT_TOGGLE_STAGE_ASSERT
...
void ASSERT_TOGGLE_STAGE_LT(Toggle toggle, ToggleInfo::ToggleStage stage) {
#if PRINT_TOGGLE_STAGE_ASSERT
    printf("Checking toggle stage of %s <= %zu\n", TogglesInfo::GetToggleInfo(toggle)->name,
           (size_t)stage);
#endif  // PRINT_TOGGLE_STAGE_ASSERT
...
#undef PRINT_TOGGLE_STAGE_ASSERT
}  // namespace
...
void TogglesState::Default(Toggle toggle, bool enabled) {
    ASSERT(toggle != Toggle::InvalidEnum);
    ASSERT_TOGGLE_STAGE_EQ(toggle, togglesStateStage);
    ASSERT(TogglesInfo::GetToggleInfo(toggle)->stage == togglesStateStage);
...
void TogglesState::ForceSet(Toggle toggle, bool enabled) {
    ASSERT(toggle != Toggle::InvalidEnum);
    ASSERT_TOGGLE_STAGE_LE(toggle, togglesStateStage);
    ASSERT(TogglesInfo::GetToggleInfo(toggle)->stage <= togglesStateStage);
...
void TogglesState::Inherit(Toggle toggle, bool enabled) {
    ASSERT(toggle != Toggle::InvalidEnum);
    ASSERT_TOGGLE_STAGE_LT(toggle, togglesStateStage);
    ASSERT(TogglesInfo::GetToggleInfo(toggle)->stage < togglesStateStage);
    togglesIsSet.Set(toggle, true);
    togglesIsEnabled.Set(toggle, enabled);
}
...
bool TogglesState::IsForced(Toggle toggle) const {
    // Ensure that the toggle never used earlier than its stage.
    ASSERT_TOGGLE_STAGE_LE(toggle, togglesStateStage);
    ASSERT(TogglesInfo::GetToggleInfo(toggle)->stage <= togglesStateStage);
    return togglesIsForced.Has(toggle);
}
...
ToggleInfo::ToggleStage TogglesState::GetStage() const {
    return togglesStateStage;
}
...
const RequiredTogglesSet& TogglesState::GetRequiredTogglesSet() const {
    return requiredTogglesSet;
}
