...
class AdapterBase : public RefCounted {
  public:
    ...
    // Check if all required features are supported with adapter toggles state.
    ...
    // Set the toggle in adapter toggles state for testing.
    void SetToggleForTesting(Toggle toggle, bool enabled, bool forced);
