...
#include "dawn/native/emulator/CommandBufferEmulator.h"
...
MaybeError Queue::Dispatch(const ComputePass* pass,
    ...
    if (GetDevice()->IsToggleEnabled(Toggle::EmulatorEnableDRD)) {
    ...
    if (GetDevice()->IsToggleEnabled(Toggle::EmulatorInteractive)) {
