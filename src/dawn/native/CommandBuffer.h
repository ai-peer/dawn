...
// TODO(dawn:813): The clears could be scheduled in LazyClearRenderPassAttachments if the RecordingContext was a frontend concept (so we could call Texture::Clear inside the function).
