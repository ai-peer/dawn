...
namespace dawn::native {
    ...
    MaybeError ValidateWriteBuffer(const DeviceBase* device,
        ...
        DAWN_INVALID_IF(!(buffer->GetUsageExternalOnly() & wgpu::BufferUsage::CopyDst),
                        "%s usage (%s) does not include %s.", buffer,
                        buffer->GetUsageExternalOnly(), wgpu::BufferUsage::CopyDst);
