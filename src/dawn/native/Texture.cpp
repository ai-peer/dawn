...
TextureBase::TextureBase(DeviceBase* device, const TextureDescriptor* descriptor)
    ...
    if (mInternalUsage & wgpu::TextureUsage::StorageBinding) {
        ...
        // We should never use wgpu::TextureUsage::StorageBinding internally. Instead we should use
        // kReadableStorageBinding, kWritableStorageBinding and kReadWriteStorageBinding.
