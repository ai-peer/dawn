...
MaybeError ValidateRenderPassDescriptor(DeviceBase* device,
    ...
    if (descriptor->timestampWrites != nullptr) {
        ...
        DAWN_INVALID_IF(beginningOfPassWriteIndex == wgpu::kQueryIndexUndefined &&
        ...
        DAWN_INVALID_IF(
            ...
            "beginningOfPassWriteIndex (%u) is equal to endOfPassWriteIndex (%u) in %s.",
            beginningOfPassWriteIndex, endOfPassWriteIndex, querySet);
    }
