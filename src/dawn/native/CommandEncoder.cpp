...
namespace dawn::native {
    ...
    namespace {
        ...
        bool hasDeprecatedColor(const RenderPassColorAttachment& attachment) {
            return attachment.clearColor.r != -1.0f || attachment.clearColor.g != -1.0f ||
                   attachment.clearColor.b != -1.0f || attachment.clearColor.a != -1.0f;
        }
        ...
        MaybeError ValidateRenderPassDepthStencilAttachment(
            ...
            if (depthStencilAttachment->depthClearValue == 0.0 &&
                depthStencilAttachment->clearDepth != 0.0) {
                // TODO(dawn:1269): Remove this branch after the deprecation period.
                device->EmitDeprecationWarning(
