...
MaybeError ValidateQuerySetResolve(const QuerySetBase* querySet,
    ...
    DAWN_INVALID_IF(destinationOffset % kResolveQuerySetDestinationBufferOffsetAlignment != 0,
                    "The destination buffer %s offset (%u) is not a multiple of %u.", destination,
                    destinationOffset, kResolveQuerySetDestinationBufferOffsetAlignment);
