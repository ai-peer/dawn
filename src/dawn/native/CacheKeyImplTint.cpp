...
// static
template <>
void serde::Serde<tint::Program>::SerializeImpl(serde::Sink* sink, const tint::Program& p) {
#if TINT_BUILD_WGSL_WRITER
    tint::writer::wgsl::Options options{};
    Serialize(sink, tint::writer::wgsl::Generate(&p, options).wgsl);
#else
...
// static
template <>
void serde::Serde<tint::sem::BindingPoint>::SerializeImpl(serde::Sink* sink,
    ...
    static_assert(sizeof(tint::sem::BindingPoint) == 8,
                  "Please update serialization for tint::sem::BindingPoint");
    Serialize(sink, p.group, p.binding);
}

// static
template <>
void serde::Serde<tint::transform::BindingPoints>::SerializeImpl(
    serde::Sink* sink,
    ...
    static_assert(sizeof(tint::transform::BindingPoints) == 16,
                  "Please update serialization for tint::transform::BindingPoints");
    Serialize(sink, points.plane_1, points.params);
}
