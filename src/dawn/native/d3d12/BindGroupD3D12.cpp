...
ResultOrError<Ref<BindGroup>> BindGroup::Create(Device* device,
    ...
    return ToBackend(descriptor->layout->GetInternalBindGroupLayout())->AllocateBindGroup(device, descriptor);
}
...
void BindGroup::DestroyImpl() {
    ...
    ToBackend(GetLayout()->GetInternalBindGroupLayout())->DeallocateBindGroup(this, &mCPUViewAllocation);
