...
namespace dawn::native::d3d12 {
    ...
    namespace {
        ...
        bool NeedBufferSizeWorkaroundForBufferTextureCopyOnD3D12(const BufferCopy& bufferCopy,
            ...
            if (!device->IsToggleEnabled(
                    Toggle::D3D12SplitBufferTextureCopyIfRowsPerImageGreaterThanCopyHeight) ||
            ...
            return bufferCopy.buffer->GetSize() - bufferCopy.offset < requiredCopySizeByD3D12;
        }
    ...
    void RecordBufferTextureCopy(BufferTextureCopyDirection direction,
        ...
        bool needBufferSizeWorkaround =
            NeedBufferSizeWorkaroundForBufferTextureCopyOnD3D12(bufferCopy, textureCopy, copySize);
