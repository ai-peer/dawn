...
namespace dawn::native::d3d12 {
    ...
    class RenderPassBuilder {
      public:
        ...
        // Returns the max color attachment index. If there is no color attachment, returns -1.
        // Range: [-1, kMaxColorAttachments)
        int8_t GetMaxColorAttachmentIndex() const;
      ...
      private:
        int8_t mMaxColorAttachmentIndex = -1;
