...
namespace dawn::native::d3d12 {
    ...
    MaybeError ValidateD3D12TextureCanBeWrapped(ID3D12Resource* d3d12Resource,
        ...
        //                 "D3D12 texture array size (%u) is not 1.",
    ...
    ResultOrError<Ref<Texture>> Texture::CreateExternalImage(
        ...
        DAWN_TRY(dawnTexture->InitializeAsExternalTexture(
            ...
            textureArrayIndex, fenceWaitValue, fenceSignalValue, isSwapChainTexture));
    ...
    MaybeError Texture::InitializeAsExternalTexture(
        ...
        mTextureArrayIndex = textureArrayIndex;
    ...
    int Texture::GetTextureArrayIndex() const {
        return mTextureArrayIndex;
    }
        ...
        if (GetTexture()->IsMultisampledTexture()) {
            ...
            switch (descriptor->dimension) {
                ...
                case wgpu::TextureViewDimension::e2DArray: {
                    ...
                    int overrideTextureArrayIndex = ToBackend(texture)->GetTextureArrayIndex();
                    if (overrideTextureArrayIndex >= 0) {
                        mSrvDesc.Texture2DArray.ArraySize = 1;
                        mSrvDesc.Texture2DArray.FirstArraySlice =
                            static_cast<UINT>(overrideTextureArrayIndex);
                    } else {
