...
void serde::Serde<D3D12_INPUT_ELEMENT_DESC>::SerializeImpl(serde::Sink* sink,
    ...
    Serialize(sink, t.SemanticName, t.SemanticIndex, t.Format, t.InputSlot, t.AlignedByteOffset,
...
void serde::Serde<D3D12_SO_DECLARATION_ENTRY>::SerializeImpl(serde::Sink* sink,
    ...
    Serialize(sink, t.Stream, t.SemanticName, t.SemanticIndex, t.StartComponent, t.ComponentCount,
              t.OutputSlot);
}
