            ...
            switch (type) {
                ...
                case Command::CopyTextureToBuffer: {
                    ...
                    if (!needBufferSizeWorkaround) {
                        ...
                        // If buffer is not big enough for D3D12, then split the copy into two:
                        //   - The first one copy all depth images but the last depth image,
                        //   - The second one copy the last depth image.
