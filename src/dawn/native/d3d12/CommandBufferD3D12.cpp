        ...
        auto EncodeRenderBundleCommand = [&](CommandIterator* iter, Command type) -> MaybeError {
            switch (type) {
                ...
                case Command::DrawIndirect: {
                    ...
                    // TODO(crbug.com/dawn/1197): update when we add support for
                    // "indirect-first-instance". Validation shader allocates a zeroed out
                    // first_instance only when vertex_index is duplicated.
