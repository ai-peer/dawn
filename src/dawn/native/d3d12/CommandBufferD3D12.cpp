...
MaybeError CommandBuffer::RecordComputePass(CommandRecordingContext* commandContext,
    ...
    if (querySet != nullptr &&
        computePass->timestampWrites.beginningOfPassWriteIndex != wgpu::kQuerySetIndexUndefined) {
...
MaybeError CommandBuffer::RecordRenderPass(CommandRecordingContext* commandContext,
    ...
    Device* device = ToBackend(GetDevice());
    QuerySetBase* timestampWritesQuerySet = renderPass->timestampWrites.querySet.Get();
    ...
    if (timestampWritesQuerySet != nullptr &&
        renderPass->timestampWrites.beginningOfPassWriteIndex != wgpu::kQuerySetIndexUndefined) {
        RecordWriteTimestampCmd(commandList, timestampWritesQuerySet,
