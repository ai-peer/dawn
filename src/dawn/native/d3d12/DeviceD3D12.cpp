...
void Device::InitTogglesFromDriver() {
    ...
    if (gpu_info::IsSkylake(vendorId, deviceId) || gpu_info::IsKabylake(vendorId, deviceId) ||
        gpu_info::IsCoffeelake(vendorId, deviceId) || gpu_info::IsWhiskylake(vendorId, deviceId) ||
        gpu_info::IsCometlake(vendorId, deviceId)) {
