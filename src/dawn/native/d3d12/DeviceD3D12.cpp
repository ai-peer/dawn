...
namespace dawn::native::d3d12 {
    ...
    Ref<TextureBase> Device::CreateExternalD3D12Texture(
        ...
        if (ConsumedError(Texture::CreateExternalImage(
                              ...
                              std::move(d3d11on12Resource), textureArrayIndex, fenceWaitValue,
                              fenceSignalValue, isSwapChainTexture, isInitialized),
                          &dawnTexture)) {
            return nullptr;
        }
        return {dawnTexture};
