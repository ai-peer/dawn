...
class PipelineCache final : public PipelineCacheBase {
  ...
  private:
    ...
    DeviceBase* mDevice;
    // const PipelineBase* mPipeline;
    // VkPipelineCache mHandle = VK_NULL_HANDLE;

    // D3D12_CACHED_PIPELINE_STATE mCachedPSO = {};
    ...
    // TODO: compiled shader, pipeline states
};
