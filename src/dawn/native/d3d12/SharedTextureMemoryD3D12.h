...
class SharedTextureMemory final
    : public d3d::SharedTextureMemory<D3D12BackendTraits, ID3D12Resource> {
  public:
  ...
  private:
    using Base = d3d::SharedTextureMemory<D3D12BackendTraits, ID3D12Resource>;
    using Base::SharedTextureMemory;
