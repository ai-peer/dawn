...
ResultOrError<CompiledShader> CompileShader(D3DCompilationRequest r) {
    ...
    DAWN_TRY_ASSIGN(
        ...
        TranslateToHLSL(&r, &remappedEntryPoint, &compiledShader.usesVertexOrInstanceIndex));
    ...
    switch (r.compiler) {
        case Compiler::DXC: {
            ...
            DAWN_TRY_ASSIGN(compiledDXCShader,
                            CompileShaderDXC(r, remappedEntryPoint, compiledShader.hlslSource));
        ...
        case Compiler::FXC: {
            ...
            DAWN_TRY_ASSIGN(compiledFXCShader,
                            CompileShaderFXC(r, remappedEntryPoint, compiledShader.hlslSource));
...
void BlobCache::Store<d3d12::CompiledShader>(const CacheKey& key, const d3d12::CompiledShader& c) {
    ...
    StreamIn(&sink, stream::StructMembers(c, d3d12::CompiledShader::kMembers));
...
ResultOrError<d3d12::CompiledShader> d3d12::CompiledShader::FromBlob(Blob blob) {
    ...
    DAWN_TRY(StreamOut(&source, stream::StructMembers(&c, d3d12::CompiledShader::kMembers)));
    return c;
}
...
template <>
void stream::Stream<IDxcLibrary*>::Write(stream::Sink*, IDxcLibrary*) {}

template <>
void stream::Stream<IDxcCompiler*>::Write(stream::Sink*, IDxcCompiler*) {}
