...
namespace dawn::native::d3d12 {
    ...
    void RenderPassBuilder::SetRenderTargetView(ColorAttachmentIndex attachmentIndex,
        ...
        mHighestColorAttachmentIndexExclusive = std::max(
            mHighestColorAttachmentIndexExclusive,
    ...
    ColorAttachmentIndex RenderPassBuilder::GetHighestColorAttachmentIndexExclusive() const {
        return mHighestColorAttachmentIndexExclusive;
    }
    ...
    RenderPassBuilder::GetRenderPassRenderTargetDescriptors() const {
        return {mRenderPassRenderTargetDescriptors.data(),
                static_cast<uint8_t>(mHighestColorAttachmentIndexExclusive)};
    }
