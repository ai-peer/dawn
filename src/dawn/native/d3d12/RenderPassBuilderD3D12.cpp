...
namespace dawn::native::d3d12 {
    ...
    void RenderPassBuilder::SetRenderTargetView(ColorAttachmentIndex attachmentIndex,
        ...
        mMaxColorAttachmentIndex = std::max(
            mMaxColorAttachmentIndex, static_cast<int8_t>(static_cast<uint8_t>(attachmentIndex)));
    }
    ...
    int8_t RenderPassBuilder::GetMaxColorAttachmentIndex() const {
        ASSERT(mMaxColorAttachmentIndex >= -1);
        return mMaxColorAttachmentIndex;
    }
    ...
    RenderPassBuilder::GetRenderPassRenderTargetDescriptors() const {
        return {mRenderPassRenderTargetDescriptors.data(),
                static_cast<uint8_t>(mMaxColorAttachmentIndex + 1)};
    }
