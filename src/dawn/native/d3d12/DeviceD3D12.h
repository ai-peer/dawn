...
class Device final : public DeviceBase {
  public:
    ...
    Ref<ExternalImageResourcesD3D12> CreateExternalImageResources(
        const ExternalImageDescriptorDXGISharedHandle* descriptor);

    void ReleaseExternalImageResources(ExternalImageResourcesD3D12* resources);
  ...
  private:
    ...
    std::vector<Ref<ExternalImageResourcesD3D12>> mExternalImageResources;
};
