...
MaybeError PipelineLayout::Initialize() {
    ...
    renderOrComputeInternalConstants.Constants.RegisterSpace = GetFirstIndexOffsetRegisterSpace();
    renderOrComputeInternalConstants.Constants.ShaderRegister = GetFirstIndexOffsetShaderRegister();
    ...
    uint32_t dynamicStorageBufferLengthsShaderRegisterOffset =
        Base::GetDynamicStorageBufferLengthsShaderRegisterOffset();
