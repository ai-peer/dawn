...
namespace dawn::native::d3d12 {
    ...
    PipelineLayout::GetDrawIndirectCommandSignatureWithInstanceVertexOffsets() {
        // mDrawIndirectCommandSignatureWithInstaceVertexOffsets won't be created until it is
        // needed.
        if (mDrawIndirectCommandSignatureWithInstaceVertexOffsets.Get() != nullptr) {
            return mDrawIndirectCommandSignatureWithInstaceVertexOffsets.Get();
        }
        ...
        ToBackend(GetDevice())
            ...
            ->CreateCommandSignature(
                &programDesc, GetRootSignature(),
                IID_PPV_ARGS(&mDrawIndirectCommandSignatureWithInstaceVertexOffsets));
        return mDrawIndirectCommandSignatureWithInstaceVertexOffsets.Get();
    }
