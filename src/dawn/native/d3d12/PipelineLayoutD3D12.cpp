...
namespace dawn::native::d3d12 {
    ...
    PipelineLayout::GetDrawIndirectCommandSignatureWithInstanceVertexOffsets() {
        // mDrawIndirectCommandSignatureWithIndexVertexOffsets won't be created until it is
        // needed.
        if (mDrawIndirectCommandSignatureWithIndexVertexOffsets.Get() != nullptr) {
            return mDrawIndirectCommandSignatureWithIndexVertexOffsets.Get();
        }
        ...
        ToBackend(GetDevice())
            ...
            ->CreateCommandSignature(
                &programDesc, GetRootSignature(),
                IID_PPV_ARGS(&mDrawIndirectCommandSignatureWithIndexVertexOffsets));
        return mDrawIndirectCommandSignatureWithIndexVertexOffsets.Get();
    }

    ID3D12CommandSignature*
    PipelineLayout::GetDrawIndexedIndirectCommandSignatureWithInstanceVertexOffsets() {
        // mDrawIndexedIndirectCommandSignatureWithIndexVertexOffsets won't be created until it is
        // needed.
        if (mDrawIndexedIndirectCommandSignatureWithIndexVertexOffsets.Get() != nullptr) {
            return mDrawIndexedIndirectCommandSignatureWithIndexVertexOffsets.Get();
        }
        ...
        ToBackend(GetDevice())
            ...
            ->CreateCommandSignature(
                &programDesc, GetRootSignature(),
                IID_PPV_ARGS(&mDrawIndexedIndirectCommandSignatureWithIndexVertexOffsets));
        return mDrawIndexedIndirectCommandSignatureWithIndexVertexOffsets.Get();
    }
