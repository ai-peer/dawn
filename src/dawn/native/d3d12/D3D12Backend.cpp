...
namespace dawn::native::d3d12 {
    ...
    WGPUTexture ExternalImageDXGI::ProduceTexture(
        ...
        Ref<TextureBase> texture = backendDevice->CreateExternalD3D12Texture(
            &textureDescriptor, mD3D12Resource, mD3D12Fence, std::move(d3d11on12Resource),
            mTextureArrayIndex, descriptor->fenceWaitValue, descriptor->fenceSignalValue,
    ...
    std::unique_ptr<ExternalImageDXGI> ExternalImageDXGI::Create(
        ...
        std::unique_ptr<ExternalImageDXGI> result(
            new ExternalImageDXGI(std::move(d3d12Resource), std::move(d3d12Fence),
                                  descriptor->textureArrayIndex, descriptor->cTextureDescriptor));
        return result;
    }
