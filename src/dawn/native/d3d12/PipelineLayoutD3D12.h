...
namespace dawn::native::d3d12 {
    ...
    class PipelineLayout final : public PipelineLayoutBase {
      ...
      private:
        ...
        ComPtr<ID3D12CommandSignature> mDrawIndirectCommandSignatureWithIndexVertexOffsets;
        ComPtr<ID3D12CommandSignature> mDrawIndexedIndirectCommandSignatureWithIndexVertexOffsets;
    };
