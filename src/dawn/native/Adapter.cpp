...
MaybeError AdapterBase::Initialize() {
    ...
    mSupportedFeaturesWithAdapterToggles = mUnfilteredSupportedFeatures;
...
bool AdapterBase::APIHasFeature(wgpu::FeatureName feature) const {
    ...
    return mSupportedFeaturesWithAdapterToggles.IsEnabled(feature);
}
...
FeaturesSet AdapterBase::GetUnfilteredSupportedFeaturesForTesting() const {
    return mUnfilteredSupportedFeatures;
}
