...
MaybeError AdapterBase::Initialize() {
    ...
    mSupportedFeaturesWithAdapterToggles = GetFilteredSupportedFeature(mTogglesState);
...
bool AdapterBase::SupportsAllRequiredFeaturesWithToggles(
    ...
    FeaturesSet filteredSupportedFeatures = GetFilteredSupportedFeature(toggles);
...
FeaturesSet AdapterBase::GetFilteredSupportedFeature(const TogglesState& toggles) const {
