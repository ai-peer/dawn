...
ResultOrError<Ref<ComputePipelineBase>> GetOrCreateTextureToBufferPipeline(
    ...
    switch (format.format) {
        case wgpu::TextureFormat::R8Snorm:
            ...
            shader << kCommon << kPackR8SnormToU32 << kCommonEnd;
            textureSampleType = wgpu::TextureSampleType::Float;
            break;
        case wgpu::TextureFormat::RG8Snorm:
            AppendFloatTextureHead();
            shader << kCommon << kPackRG8SnormToU32 << kCommonEnd;
            textureSampleType = wgpu::TextureSampleType::Float;
            break;
        case wgpu::TextureFormat::RGBA8Snorm:
            AppendFloatTextureHead();
            shader << kCommon << kPackRGBA8SnormToU32 << kCommonEnd;
            textureSampleType = wgpu::TextureSampleType::Float;
            break;
        case wgpu::TextureFormat::BGRA8Unorm:
            AppendFloatTextureHead();
            shader << kCommon << kPackBGRA8UnormToU32 << kCommonEnd;
            textureSampleType = wgpu::TextureSampleType::Float;
            break;
        case wgpu::TextureFormat::Depth16Unorm:
            AppendDepthTextureHead();
            shader << kCommon << kPackDepth16UnormToU32 << kCommonEnd;
            textureSampleType = wgpu::TextureSampleType::Depth;
            break;
        case wgpu::TextureFormat::Depth32Float:
            AppendDepth32FloatTextureHead();
            shader << kCommon << kLoadDepth32Float;
            textureSampleType = wgpu::TextureSampleType::Depth;
            break;
        ...
        case wgpu::TextureFormat::Depth24PlusStencil8:
            ...
            shader << kCommon << kPackStencil8ToU32 << kCommonEnd;
