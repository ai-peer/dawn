...
#include "src/dawn/native/ChainUtils_autogen.h"
...
template <>
inline wgpu::SType STypeFor<d3d::RequestAdapterOptionsIDXGIAdapter> =
    wgpu::SType(WGPUSType_RequestAdapterOptionsIDXGIAdapter);
