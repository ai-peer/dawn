...
LogSink::LogSink(const LogSink& rhs) = default;
LogSink& LogSink::operator=(const LogSink& rhs) = default;
LogSink::LogSink(LogSink&& rhs) = default;
LogSink& LogSink::operator=(LogSink&& rhs) = default;
