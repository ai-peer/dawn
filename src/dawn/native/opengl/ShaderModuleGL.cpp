...
ResultOrError<GLuint> ShaderModule::CompileShader(
    ...
    // Texture Builtins from uniforms transform is needed for most GLSL version to emit a valid
    // shader.
    ...
    *needsTextureBuiltinUniformBuffer = compilationResult->needsInternalUniformBuffer;
    ...
    // Since the TextureBuiltinsFromUniform transform run before BindingRemapper,
