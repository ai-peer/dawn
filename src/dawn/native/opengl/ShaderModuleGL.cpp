...
ResultOrError<GLuint> ShaderModule::CompileShader(const OpenGLFunctions& gl,
    ...
    exteranlTextureOptions.bindings_map = BuildExternalTextureTransformBindings(layout);

    GLSLCompilationRequest req = {};
    req.inputProgram = GetTintProgram();
    req.stage = stage;
    req.entryPointName = programmableStage.entryPoint;
    req.externalTextureOptions = externalTextureOptions;
    ...
    DAWN_TRY_LOAD_OR_RUN(
        ...
        [](GLSLCompilationRequest r) -> ResultOrError<GLSLCompilation> {
            ...
            tintOptions.external_texture_options = r.exteranlTextureOptions;
