...
MaybeError PhysicalDevice::InitializeSupportedLimitsImpl(CombinedLimits* limits) {
    ...
    limits->v1.maxTextureDimension1D = limits->v1.maxTextureDimension2D =
        limits->v1.maxTextureDimension3D = Get(gl, GL_MAX_TEXTURE_SIZE);
    ...
    // TODO(crbug.com/dawn/1834): determine if GL has equivalent values here.
    ...
    limits->v1.maxSampledTexturesPerShaderStage = Get(gl, GL_MAX_TEXTURE_IMAGE_UNITS);
    ...
    // image units, so this isn't technically correct for vertex shaders.
    ...
    limits->v1.maxColorAttachments = Get(gl, GL_MAX_COLOR_ATTACHMENTS);
