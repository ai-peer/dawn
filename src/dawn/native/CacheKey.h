...
namespace dawn::native {
    ...
    // types/classes.
    template <typename T,
              bool Integer = std::is_integral_v<T>,
              bool Float = std::is_floating_point_v<T>>
    ...
    struct CacheKeySerializer<Integer, true, false> {
    ...
    struct CacheKeySerializer<Float, false, true> {
    ...
    template <size_t N>
    struct CacheKeySerializer<char[N], false, false> {
