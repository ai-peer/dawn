...
class CacheKey : public serde::ByteVectorSink {
  public:
    using serde::ByteVectorSink::ByteVectorSink;
    ...
    class UnsafeUnkeyedValue {
      public:
        ...
        friend constexpr void Serialize(serde::Sink*, const UnsafeUnkeyedValue&) {}
