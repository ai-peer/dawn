...
#ifndef SRC_DAWN_NATIVE_SERDE_BYTEVECTORSINK_H_
#define SRC_DAWN_NATIVE_SERDE_BYTEVECTORSINK_H_
...
// Implementation of serde::Sink backed by a byte vector.
...
#endif  // SRC_DAWN_NATIVE_SERDE_BYTEVECTORSINK_H_
