...
#ifndef SRC_DAWN_NATIVE_INTERPRETER_BACKENDINTERPRETER_H_
#define SRC_DAWN_NATIVE_INTERPRETER_BACKENDINTERPRETER_H_
...
class Backend : public BackendConnection {
  ...
  private:
    Ref<PhysicalDeviceBase> mDevice = nullptr;
};

}  // namespace dawn::native::interpreter

#endif  // SRC_DAWN_NATIVE_INTERPRETER_BACKENDINTERPRETER_H_
