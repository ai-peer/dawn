...
#ifndef SRC_DAWN_NATIVE_BLITBUFFERTOSTENCIL_H_
#define SRC_DAWN_NATIVE_BLITBUFFERTOSTENCIL_H_
...
//  - Copies buffer data to an r8 texture.
...
#endif  // SRC_DAWN_NATIVE_BLITBUFFERTOSTENCIL_H_
