...
class PipelineBase : public ApiObjectBase, public CachedObject {
  ...
  protected:
    ...
    //
    MaybeError RunTintProgramTransformForOverrides(ProgrammableStage* stage);
    // MaybeError RunTintProgramTransformForOverrides(const ProgrammableStage& stage);
    // TransformedProgram RunTintProgramTransformForOverrides(const ProgrammableStage& stage);
