...
MaybeError PipelineLayout::Initialize() {
    ...
    // This data will be used by shader translation to emit a load from the root constantfigure
...
// TODO(crbug.com/dawn/1716): figure out how to setup space & register for D3D11
