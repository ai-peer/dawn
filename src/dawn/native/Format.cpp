...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    auto AddColorFormat =
        [&AddFormat](wgpu::TextureFormat format, bool renderable, bool supportsStorageUsage,
                     ...
                     uint8_t renderPixelByteSize = 0, uint8_t renderComponentAlignment = 0,
            ...
            if (renderable) {
                ...
                // alignment specified.
                ASSERT(renderPixelByteSize != 0 && renderComponentAlignment != 0);
                internalFormat.renderPixelByteSize = renderPixelByteSize;
                internalFormat.renderComponentAlignment = renderComponentAlignment;
            }
