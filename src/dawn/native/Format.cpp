...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    // clang-format off
        ...
        AddColorFormat(wgpu::TextureFormat::R32Sint, Cap::Renderable | Cap::StorageW, ByteSize(4), SampleTypeBit::Sint, ComponentCount(1), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::R32Float, Cap::Renderable | Cap::StorageW | Cap::Multisample | supportsReadWriteStorageUsage, ByteSize(4), sampleTypeFor32BitFloatFormats, ComponentCount(1), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(4));
