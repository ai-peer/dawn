...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    // clang-format off
        ...
        SampleTypeBit sampleTypeFor32BitFormats = device->HasFeature(Feature::Float32Filterable) ? kAnyFloat : SampleTypeBit::UnfilterableFloat;
        ...
        AddColorFormat(wgpu::TextureFormat::R32Float, true, true, true, false, 4, sampleTypeFor32BitFormats, 1, 4, 4);
        ...
        AddColorFormat(wgpu::TextureFormat::RG32Float, true, true, false, false, 8, sampleTypeFor32BitFormats, 2, 8, 4);
        ...
        AddColorFormat(wgpu::TextureFormat::RGBA32Float, true, true, false, false, 16, sampleTypeFor32BitFormats, 4, 16, 4);
