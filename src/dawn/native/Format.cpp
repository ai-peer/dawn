...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    // clang-format off
        ...
        auto isNorm16Capabilities = device->HasFeature(Feature::Norm16TextureFormats) ? Cap::Renderable | Cap::Multisample | Cap::Resolve : Cap::None;
        AddColorFormat(wgpu::TextureFormat::R16Unorm, isNorm16Capabilities, ByteSize(2), kAnyFloat, ComponentCount(1), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RG16Unorm, isNorm16Capabilities, ByteSize(4), kAnyFloat, ComponentCount(2), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RGBA16Unorm, isNorm16Capabilities, ByteSize(8), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::R16Snorm, isNorm16Capabilities, ByteSize(2), kAnyFloat, ComponentCount(1), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RG16Snorm, isNorm16Capabilities, ByteSize(4), kAnyFloat, ComponentCount(2), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RGBA16Snorm, isNorm16Capabilities, ByteSize(8), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(2));
