...
enum class Cap : uint16_t {
    None = 0x0,
    Renderable = 0x1,
    SupportsStorageUsage = 0x2,
    SupportsMultisample = 0x4,
    SupportsResolveTarget = 0x4,
    SupportsReadWriteStorageUsage = 0x8,
};
...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    auto AddConditionalColorFormat =
        [&AddFormat](
            ...
            internalFormat.supportsStorageUsage = capabilities & Cap::SupportsStorageUsage;
            internalFormat.supportsReadWriteStorageUsage =
                capabilities & Cap::SupportsReadWriteStorageUsage;

            bool supportsMultisample = capabilities & Cap::SupportsMultisample;
            if (supportsMultisample) {
                ASSERT(renderable);
            }
            internalFormat.supportsMultisample = supportsMultisample;
            internalFormat.supportsResolveTarget = capabilities & Cap::SupportsResolveTarget;
    ...
    auto AddMultiAspectFormat =
        [&AddFormat, &table](wgpu::TextureFormat format, Aspect aspects,
            ...
            internalFormat.unsupportedReason = unsupportedReason;
            internalFormat.supportsStorageUsage = false;
            internalFormat.supportsMultisample = capabilites & Cap::SupportsMultisample;
            internalFormat.supportsResolveTarget = false;
    ...
    // clang-format off
        ...
        AddColorFormat(wgpu::TextureFormat::R8Unorm, Cap::Renderable | Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(1), kAnyFloat, ComponentCount(1), RenderTargetPixelByteCost(1), RenderTargetComponentAlignment(1));
        AddColorFormat(wgpu::TextureFormat::R8Snorm, Cap::None, ByteSize(1), kAnyFloat, ComponentCount(1));
        AddColorFormat(wgpu::TextureFormat::R8Uint, Cap::Renderable | Cap::SupportsMultisample, ByteSize(1), SampleTypeBit::Uint, ComponentCount(1), RenderTargetPixelByteCost(1), RenderTargetComponentAlignment(1));
        AddColorFormat(wgpu::TextureFormat::R8Sint, Cap::Renderable | Cap::SupportsMultisample, ByteSize(1), SampleTypeBit::Sint, ComponentCount(1), RenderTargetPixelByteCost(1), RenderTargetComponentAlignment(1));

        // 2 bytes color formats
        AddColorFormat(wgpu::TextureFormat::R16Uint, Cap::Renderable | Cap::SupportsMultisample, ByteSize(2), SampleTypeBit::Uint, ComponentCount(1), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::R16Sint, Cap::Renderable | Cap::SupportsMultisample, ByteSize(2), SampleTypeBit::Sint, ComponentCount(1), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::R16Float, Cap::Renderable | Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(2), kAnyFloat, ComponentCount(1), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RG8Unorm, Cap::Renderable | Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(2), kAnyFloat, ComponentCount(2), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(1));
        AddColorFormat(wgpu::TextureFormat::RG8Snorm, Cap::None, ByteSize(2), kAnyFloat, ComponentCount(2));
        AddColorFormat(wgpu::TextureFormat::RG8Uint, Cap::Renderable | Cap::SupportsMultisample, ByteSize(2), SampleTypeBit::Uint, ComponentCount(2), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(1));
        AddColorFormat(wgpu::TextureFormat::RG8Sint, Cap::Renderable | Cap::SupportsMultisample, ByteSize(2), SampleTypeBit::Sint, ComponentCount(2), RenderTargetPixelByteCost(2), RenderTargetComponentAlignment(1));
        ...
        auto supportsReadWriteStorageUsage = device->HasFeature(Feature::ChromiumExperimentalReadWriteStorageTexture) ? Cap::SupportsReadWriteStorageUsage : Cap::None;

        AddColorFormat(wgpu::TextureFormat::R32Uint, Cap::Renderable | Cap::SupportsStorageUsage | supportsReadWriteStorageUsage, ByteSize(4), SampleTypeBit::Uint, ComponentCount(1), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::R32Sint, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(4), SampleTypeBit::Sint, ComponentCount(1), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::R32Float, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample | supportsReadWriteStorageUsage, ByteSize(4), sampleTypeFor32BitFloatFormats, ComponentCount(1), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::RG16Uint, Cap::Renderable |  Cap::SupportsMultisample, ByteSize(4), SampleTypeBit::Uint, ComponentCount(2), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RG16Sint, Cap::Renderable |  Cap::SupportsMultisample, ByteSize(4), SampleTypeBit::Sint, ComponentCount(2), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RG16Float, Cap::Renderable |  Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(4), kAnyFloat, ComponentCount(2), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RGBA8Unorm, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(4), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(1));
        AddColorFormat(wgpu::TextureFormat::RGBA8UnormSrgb, Cap::Renderable |  Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(4), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(1), wgpu::TextureFormat::RGBA8Unorm);
        AddColorFormat(wgpu::TextureFormat::RGBA8Snorm,  Cap::SupportsStorageUsage, ByteSize(4), kAnyFloat, ComponentCount(4));
        AddColorFormat(wgpu::TextureFormat::RGBA8Uint, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample, ByteSize(4), SampleTypeBit::Uint, ComponentCount(4), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(1));
        AddColorFormat(wgpu::TextureFormat::RGBA8Sint, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample, ByteSize(4), SampleTypeBit::Sint, ComponentCount(4), RenderTargetPixelByteCost(4), RenderTargetComponentAlignment(1));

        auto BGRA8UnormSupportsStorageUsage = device->HasFeature(Feature::BGRA8UnormStorage) ? Cap::SupportsStorageUsage : Cap::None;
        AddColorFormat(wgpu::TextureFormat::BGRA8Unorm, Cap::Renderable | BGRA8UnormSupportsStorageUsage | Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(4), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(1));
        AddConditionalColorFormat(wgpu::TextureFormat::BGRA8UnormSrgb, device->IsCompatibilityMode() ? UnsupportedReason(CompatibilityMode{}) : Format::supported, Cap::Renderable |  Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(4), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(1), wgpu::TextureFormat::BGRA8Unorm);
        AddColorFormat(wgpu::TextureFormat::RGB10A2Unorm, Cap::Renderable |  Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(4), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(4));

        auto isRG11B10UfloatCapabilities = device->HasFeature(Feature::RG11B10UfloatRenderable) ? Cap::Renderable | Cap::SupportsMultisample | Cap::SupportsResolveTarget : Cap::None;
        ...
        AddColorFormat(wgpu::TextureFormat::RG32Uint, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(8), SampleTypeBit::Uint, ComponentCount(2), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::RG32Sint, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(8), SampleTypeBit::Sint, ComponentCount(2), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::RG32Float, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(8), sampleTypeFor32BitFloatFormats, ComponentCount(2), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::RGBA16Uint, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample, ByteSize(8), SampleTypeBit::Uint, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RGBA16Sint, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample, ByteSize(8), SampleTypeBit::Sint, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(2));
        AddColorFormat(wgpu::TextureFormat::RGBA16Float, Cap::Renderable | Cap::SupportsStorageUsage | Cap::SupportsMultisample | Cap::SupportsResolveTarget, ByteSize(8), kAnyFloat, ComponentCount(4), RenderTargetPixelByteCost(8), RenderTargetComponentAlignment(2));

        // 16 bytes color formats
        AddColorFormat(wgpu::TextureFormat::RGBA32Uint, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(16), SampleTypeBit::Uint, ComponentCount(4), RenderTargetPixelByteCost(16), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::RGBA32Sint, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(16), SampleTypeBit::Sint, ComponentCount(4), RenderTargetPixelByteCost(16), RenderTargetComponentAlignment(4));
        AddColorFormat(wgpu::TextureFormat::RGBA32Float, Cap::Renderable | Cap::SupportsStorageUsage, ByteSize(16), sampleTypeFor32BitFloatFormats, ComponentCount(4), RenderTargetPixelByteCost(16), RenderTargetComponentAlignment(4));
        ...
        AddMultiAspectFormat(wgpu::TextureFormat::Depth24PlusStencil8,
                              Aspect::Depth | Aspect::Stencil, wgpu::TextureFormat::Depth24Plus, wgpu::TextureFormat::Stencil8, Cap::Renderable | Cap::SupportsMultisample, Format::supported, ComponentCount(2));
        ...
        AddMultiAspectFormat(wgpu::TextureFormat::Depth32FloatStencil8,
                              Aspect::Depth | Aspect::Stencil, wgpu::TextureFormat::Depth32Float, wgpu::TextureFormat::Stencil8, Cap::Renderable | Cap::SupportsMultisample, d32s8UnsupportedReason, ComponentCount(2));
