...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    auto isMultiPlanarCapabilities = device->HasFeature(Feature::MultiPlanarRenderTargets) ? Cap::Renderable : Cap::None;
    AddMultiAspectFormat(wgpu::TextureFormat::R8BG8Biplanar420Unorm, Aspect::Plane0 | Aspect::Plane1,
        wgpu::TextureFormat::R8Unorm, wgpu::TextureFormat::RG8Unorm, isMultiPlanarCapabilities, multiPlanarFormatUnsupportedReason, ComponentCount(3));
    ...
    AddMultiAspectFormat(wgpu::TextureFormat::R10X6BG10X6Biplanar420Unorm, Aspect::Plane0 | Aspect::Plane1,
        wgpu::TextureFormat::R16Unorm, wgpu::TextureFormat::RG16Unorm, isMultiPlanarCapabilities, multiPlanarFormatP010UnsupportedReason, ComponentCount(3));
