...
bool Format::IsSupported() const {
    return unsupportedReason == UnsupportedReason::None;
}
...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    auto AddColorFormat = [&AddConditionalColorFormat](
                              ...
                              uint8_t renderTargetComponentAlignment = 0,
                              wgpu::TextureFormat baseFormat = wgpu::TextureFormat::Undefined) {
        AddConditionalColorFormat(format, UnsupportedReason::None, renderable, supportsStorageUsage,
                                  supportsMultisample, supportsResolveTarget, byteSize, sampleTypes,
    ...
    // clang-format off
        ...
        AddConditionalColorFormat(wgpu::TextureFormat::BGRA8UnormSrgb, device->IsCompatibilityMode() ? UnsupportedReason::Compatibility : UnsupportedReason::None, true, false, true, true, 4, kAnyFloat, 4, 8, 1, wgpu::TextureFormat::BGRA8Unorm);
        ...
        AddStencilFormat(wgpu::TextureFormat::Stencil8, UnsupportedReason::None);
        AddDepthFormat(wgpu::TextureFormat::Depth16Unorm, 2, UnsupportedReason::None);
        ...
        AddDepthFormat(wgpu::TextureFormat::Depth24Plus, 4, UnsupportedReason::None);
        AddMultiAspectFormat(wgpu::TextureFormat::Depth24PlusStencil8,
                              Aspect::Depth | Aspect::Stencil, wgpu::TextureFormat::Depth24Plus, wgpu::TextureFormat::Stencil8, true, UnsupportedReason::None, true, 2);
        AddDepthFormat(wgpu::TextureFormat::Depth32Float, 4, UnsupportedReason::None);
        UnsupportedReason d32s8UnsupportedReason = device->HasFeature(Feature::Depth32FloatStencil8) ? UnsupportedReason::None : UnsupportedReason::Depth32FloatStencil8NotEnabled;
        ...
        UnsupportedReason bcFormatUnsupportedReason = device->HasFeature(Feature::TextureCompressionBC) ? UnsupportedReason::None : UnsupportedReason::TextureBCNotEnabled;
        ...
        UnsupportedReason etc2FormatUnsupportedReason = device->HasFeature(Feature::TextureCompressionETC2) ? UnsupportedReason::None : UnsupportedReason::TextureETC2NotEnabled;
        ...
        UnsupportedReason astcFormatUnsupportedReason = device->HasFeature(Feature::TextureCompressionASTC) ? UnsupportedReason::None : UnsupportedReason::TextureASTCNotEnabled;
        ...
        const UnsupportedReason multiPlanarFormatUnsupportedReason = device->HasFeature(Feature::MultiPlanarFormats) ? UnsupportedReason::None : UnsupportedReason::MultiPlanarFormatsNotEnabled;
