...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    // clang-format off
        ...
        AddColorFormat(wgpu::TextureFormat::R16Snorm, true, false, true, true, 2, kAnyFloat, 1, 2, 2);
        AddColorFormat(wgpu::TextureFormat::RG16Snorm, true, false, true, true, 4, kAnyFloat, 2, 4, 2);
        AddColorFormat(wgpu::TextureFormat::RGBA16Snorm, true, false, true, true, 8, kAnyFloat, 4, 8, 2);
