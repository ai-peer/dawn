...
FormatTable BuildFormatTable(const DeviceBase* device) {
    ...
    // clang-format off
        ...
        // TODO(dawn:1641): Support storage usage for BGRA8Unorm.
        bool supportBGRA8UnormAsStorage = !device->IsToggleEnabled(Toggle::DisallowUnsafeAPIs);
        AddColorFormat(wgpu::TextureFormat::BGRA8Unorm, true, supportBGRA8UnormAsStorage, true, true, 4, kAnyFloat, 4, 8, 1);
