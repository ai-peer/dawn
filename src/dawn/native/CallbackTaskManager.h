...
struct CallbackTask {
  public:
    ...
    static void HandleShutDownInNextTick(DeviceBase& device, std::unique_ptr<CallbackTask> task);
    static void HandleDeviceLossInNextTick(DeviceBase& device, std::unique_ptr<CallbackTask> task);
