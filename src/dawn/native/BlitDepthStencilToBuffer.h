...
// // It dispatches a compute shader textureLoad from the depth texture and writes to the buffer as
// a
// // storage buffer.
...
// // It dispatches a compute shader textureLoad from the stencil texture and writes to the buffer
// as a
// // storage buffer.
