...
void PhysicalDevice::SetupBackendDeviceToggles(TogglesState* deviceToggles) const {
    ...
    // By default try to skip robustness transform on the unsized arrays on storage buffers with
    // unsigned integer indices according to the Vulkan extension VK_EXT_robustness2.
