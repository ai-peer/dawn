...
#define SPIRV_COMPILATION_REQUEST_MEMBERS(X)                                                     \
    ...
    X(bool, disableUnsizedArrayAccessWithUintIndexRobustness)                                    \
...
ResultOrError<ShaderModule::ModuleAndSpirv> ShaderModule::GetHandleAndSpirv(
    ...
    // Currently we can disable robustness transform on all unsized array accesses with unsigned
    // integer indices as they can only be declared on storage address space.
    req.disableUnsizedArrayAccessWithUintIndexRobustness =
    ...
    DAWN_TRY_LOAD_OR_RUN(
        ...
        [](SpirvCompilationRequest r) -> ResultOrError<CompiledSpirv> {
            ...
            options.disable_unsized_array_access_with_uint_index_robustness =
                r.disableUnsizedArrayAccessWithUintIndexRobustness;
