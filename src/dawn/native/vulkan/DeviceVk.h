...
class Device final : public DeviceBase {
  ...
  private:
    ...
    // This tracks the in-flight signal semaphores for exporting in an increasing serial order.
    std::vector<std::tuple<ExecutionSerial, ExternalSemaphoreHandle, VkFence>>
        mExternalSemaphoresInFlight;
