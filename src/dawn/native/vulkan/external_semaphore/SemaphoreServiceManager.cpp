...
#if DAWN_PLATFORM_IS(LINUX) || DAWN_PLATFORM_IS(ANDROID)
#include "dawn/native/vulkan/external_semaphore/SemaphoreServiceFD.h"
#endif  // DAWN_PLATFORM_IS(LINUX) || DAWN_PLATFORM_IS(ANDROID)
...
#elif DAWN_PLATFORM_IS(LINUX) || DAWN_PLATFORM_IS(ANDROID)
