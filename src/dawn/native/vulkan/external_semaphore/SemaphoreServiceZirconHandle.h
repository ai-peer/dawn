...
#ifndef SRC_DAWN_NATIVE_VULKAN_EXTERNAL_SEMAPHORE_SEMAPHORESERVICEZIRCONHANDLE_H_
#define SRC_DAWN_NATIVE_VULKAN_EXTERNAL_SEMAPHORE_SEMAPHORESERVICEZIRCONHANDLE_H_

#include "dawn/native/vulkan/external_semaphore/SemaphoreService.h"

namespace dawn::native::vulkan::external_semaphore {

class SemaphoreServiceZirconHandle : public Service {
  public:
    explicit SemaphoreServiceZirconHandle(Device* device);
    ~SemaphoreServiceZirconHandle() override;
...
#endif  // SRC_DAWN_NATIVE_VULKAN_EXTERNAL_SEMAPHORE_SEMAPHORESERVICEZIRCONHANDLE_H_
