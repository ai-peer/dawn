...
SemaphoreServiceZirconHandle::SemaphoreServiceZirconHandle(Device* device)
    : Service(device),
      mSupported(CheckSupport(device->GetDeviceInfo(),
                              ToBackend(device->GetAdapter())->GetPhysicalDevice(),
                              device->fn)) {}

SemaphoreServiceZirconHandle::~SemaphoreServiceZirconHandle() = default;

// static
bool SemaphoreServiceZirconHandle::CheckSupport(const VulkanDeviceInfo& deviceInfo,
...
bool SemaphoreServiceZirconHandle::Supported() {
    return mSupported;
}

ResultOrError<VkSemaphore> SemaphoreServiceZirconHandle::ImportSemaphore(
...
ResultOrError<VkSemaphore> SemaphoreServiceZirconHandle::CreateExportableSemaphore() {
...
ResultOrError<ExternalSemaphoreHandle> SemaphoreServiceZirconHandle::ExportSemaphore(
...
ExternalSemaphoreHandle SemaphoreServiceZirconHandle::DuplicateHandle(
    ExternalSemaphoreHandle handle) {
...
// static
void SemaphoreServiceZirconHandle::CloseHandle(ExternalSemaphoreHandle handle) {
