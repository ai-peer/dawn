...
#ifndef SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEAHARDWAREBUFFER_H_
#define SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEAHARDWAREBUFFER_H_

#include "dawn/native/vulkan/external_memory/MemoryService.h"

namespace dawn::native::vulkan::external_memory {

class MemoryServiceAHardwareBuffer : public Service {
  public:
    explicit MemoryServiceAHardwareBuffer(Device* device);
    ~MemoryServiceAHardwareBuffer() override;
...
#endif  // SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEAHARDWAREBUFFER_H_
