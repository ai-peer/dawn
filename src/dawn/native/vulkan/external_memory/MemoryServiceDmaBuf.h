...
#ifndef SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEDMABUFFER_H_
#define SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEDMABUFFER_H_

#include "dawn/native/vulkan/external_memory/MemoryService.h"

namespace dawn::native::vulkan::external_memory {

class MemoryServiceDmaBuffer : public Service {
  public:
    explicit MemoryServiceDmaBuffer(Device* device);
    ~MemoryServiceDmaBuffer() override;
...
#endif  // SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEDMABUFFER_H_
