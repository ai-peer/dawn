...
#ifndef SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEOPAQUEFD_H_
#define SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEOPAQUEFD_H_

#include "dawn/native/vulkan/external_memory/MemoryService.h"

namespace dawn::native::vulkan::external_memory {

class MemoryServiceOpaqueFD : public Service {
  public:
    explicit MemoryServiceOpaqueFD(Device* device);
    ~MemoryServiceOpaqueFD() override;
...
#endif  // SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEOPAQUEFD_H_
