...
#if (DAWN_PLATFORM_IS(LINUX) && !DAWN_PLATFORM_IS(ANDROID)) || DAWN_PLATFORM_IS(CHROMEOS)
...
#endif  // (DAWN_PLATFORM_IS(LINUX) && !DAWN_PLATFORM_IS(ANDROID)) || DAWN_PLATFORM_IS(CHROMEOS)
...
#elif (DAWN_PLATFORM_IS(LINUX) && !DAWN_PLATFORM_IS(ANDROID)) || DAWN_PLATFORM_IS(CHROMEOS)
