...
#include "dawn/native/vulkan/external_memory/ServiceImplementationDmaBuf.h"
#include "dawn/native/vulkan/external_memory/ServiceImplementationOpaqueFD.h"
#endif  // DAWN_PLATFORM_IS(LINUX)

#if DAWN_PLATFORM_IS(ANDROID)
#include "dawn/native/vulkan/external_memory/ServiceImplementationAHardwareBuffer.h"
#endif  // DAWN_PLATFORM_IS(ANDROID)

#if DAWN_PLATFORM_IS(FUCHSIA)
#include "dawn/native/vulkan/external_memory/ServiceImplementationZirconHandle.h"
