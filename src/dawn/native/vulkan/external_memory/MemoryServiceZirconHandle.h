...
#ifndef SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEZIRONHANDLE_H_
#define SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEZIRONHANDLE_H_

#include "dawn/native/vulkan/external_memory/MemoryService.h"

namespace dawn::native::vulkan::external_memory {

class MemoryServiceZirconHandle : public Service {
  public:
    explicit MemoryServiceZirconHandle(Device* device);
    ~MemoryServiceZirconHandle() override;
...
#endif  // SRC_DAWN_NATIVE_VULKAN_EXTERNAL_MEMORY_MEMORYSERVICEZIRONHANDLE_H_
