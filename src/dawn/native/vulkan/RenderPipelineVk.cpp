...
MaybeError RenderPipeline::Initialize() {
    ...
    for (auto stage : IterateStages(this->GetStageMask())) {
        ...
        Serialize(&mCacheKey, serde::Iterable(moduleAndSpirv.spirv, moduleAndSpirv.wordCount));
    }
    ...
    Serialize(&mCacheKey, createInfo, layout->GetCacheKey());
