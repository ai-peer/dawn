...
ResultOrError<tint::Program> ParseWGSL(DeviceBase* device,
    ...
    tint::Program program = [&] {
        SCOPED_DAWN_HISTOGRAM_TIMER_MICROS(device->GetPlatform(), "GPU.Dawn.ParseWGSL_US");
...
ResultOrError<tint::Program> ParseSPIRV(DeviceBase* device,
    ...
    tint::Program program = [&] {
        SCOPED_DAWN_HISTOGRAM_TIMER_MICROS(device->GetPlatform(), "GPU.Dawn.ParseSPIRV_US");
