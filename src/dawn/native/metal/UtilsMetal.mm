...
TextureBufferCopySplit ComputeTextureBufferCopySplit(const Texture* texture,
    ...
    if (needCopyRowByRow || forceCopyRowByRow) {
        ...
        const uint32_t localBytesPerImage = 0;//localBytesPerRow * copyExtent.height / blockInfo.height;
    ...
    copy.push_back(
        TextureBufferCopySplit::CopyInfo(currentOffset, lastRowDataSize, 0 /*lastRowDataSize*/,
