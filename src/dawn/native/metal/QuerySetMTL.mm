...
MaybeError QuerySet::Initialize() {
    ...
    switch (GetQueryType()) {
        case wgpu::QueryType::Occlusion: {
            ...
            SetDebugName(this, mVisibilityBuffer.Get(), "VisibilityBuffer");
        ...
        case wgpu::QueryType::PipelineStatistics:
            if (@available(macOS 10.15, iOS 14.0, *)) {
                NSRef<NSString> label = GetDebugName(this, "PipelineStatisticCounterSampleBuffer");
                DAWN_TRY_ASSIGN(
        ...
        case wgpu::QueryType::Timestamp:
            if (@available(macOS 10.15, iOS 14.0, *)) {
                NSRef<NSString> label = GetDebugName(this, "TimestampCounterSampleBuffer");
                DAWN_TRY_ASSIGN(
                    mCounterSampleBuffer,
