...
MaybeError RenderPipeline::Initialize() {
    ...
    DAWN_TRY(RunTintProgramTransformForOverrides(GetStageRef(SingleShaderStage::Vertex)));
    ShaderModule::MetalFunctionData vertexData;
    DAWN_TRY(CreateMTLFunction(
        vertexStage, SingleShaderStage::Vertex, ToBackend(GetLayout()), &vertexData,
        GetDevice()->IsToggleEnabled(Toggle::UseBackendOverridesImplementation), 0xFFFFFFFF, this));
    ...
    if (GetStageMask() & wgpu::ShaderStage::Fragment) {
        ...
        DAWN_TRY(RunTintProgramTransformForOverrides(GetStageRef(SingleShaderStage::Fragment)));
        ShaderModule::MetalFunctionData fragmentData;
        DAWN_TRY(CreateMTLFunction(
            fragmentStage, SingleShaderStage::Fragment, ToBackend(GetLayout()), &fragmentData,
