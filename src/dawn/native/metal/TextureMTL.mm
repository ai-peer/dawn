...
#    error "Unsupported Apple platform."
    ...
    MaybeError ValidateIOSurfaceCanBeWrapped(const DeviceBase*,
        ...
        uint32_t surfaceWidth = IOSurfaceGetWidthOfPlane(ioSurface, 0);
        uint32_t surfaceHeight = IOSurfaceGetHeightOfPlane(ioSurface, 0);
    ...
    MaybeError Texture::InitializeFromIOSurface(const ExternalImageDescriptor* descriptor,
                                                ...
                                                IOSurfaceRef ioSurface) {
        mIOSurface = AcquireCFRef(ioSurface);
