...
#    error "Unsupported Apple platform."
    ...
    id<MTLTexture> Texture::GetPlane

        NSPRef<id<MTLTexture>>
        Texture::CreateFormatView(wgpu::TextureFormat format) {
    ...
    MaybeError TextureView::Initialize(const TextureViewDescriptor* descriptor) {
        ...
        if (!UsageNeedsTextureView(texture->GetInternalUsage())) {
            ...
            u int32_t plane = descriptor->aspect == wgpu::TextureAspect::Plane0Only ? 0 : 1;
            ...
            mMtlTextureView = AcquireNSPRef([GetDevice()->GetMTLDevice()
