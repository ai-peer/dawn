    ...
    ResultOrError<std::string> ShaderModule::TranslateToMSL(
        ...
        DAWN_TRY_ASSIGN(
            ...
            Memoize<TranslateToMSLImpl>(&blobStore)(
                ...
                GetTintProgram(), entryPointName, stage, sampleMask,
                std::move(externalTextureBindingsMap), std::move(bindingPoints),
                std::move(vertexPullingConfig), GetDevice()->IsRobustnessEnabled(),
