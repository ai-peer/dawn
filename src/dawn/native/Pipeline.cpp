...
MaybeError PipelineBase::ValidateGetBindGroupLayout(BindGroupIndex groupIndex) {
    ...
    DAWN_INVALID_IF(!mLayout->GetBindGroupLayoutsMask()[groupIndex],
                    "Bind group layout index (%u) doesn't correspond to an implicitly created bind "
                    "group for this pipeline.",
