...
class PhysicalDeviceBase : public RefCounted {
  public:
    ...
    // HasFeature and EnumerateFeatures should be called with adapter toggles.
    bool HasFeature(wgpu::FeatureName feature, const TogglesState& toggles) const;
    size_t EnumerateFeatures(wgpu::FeatureName* features, const TogglesState& toggles) const;
