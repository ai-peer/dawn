...
MaybeError ExternalTextureBase::Initialize(DeviceBase* device,
    ...
    switch (descriptor->rotation) {
        case wgpu::ExternalTextureRotation::Rotate0Degrees:
            params.coordTransformMatrix = {xScale, 0.0, xOffset, 0.0, 0.0, flipY * yScale, yOffset};
            break;
        case wgpu::ExternalTextureRotation::Rotate90Degrees:
            params.coordTransformMatrix = {0.0, flipY * yScale, xOffset, 0.0, -xScale,
                                           0.0, yOffset};
            break;
        case wgpu::ExternalTextureRotation::Rotate180Degrees:
            params.coordTransformMatrix = {-xScale,         0.0,    xOffset, 0.0, 0.0,
                                           flipY * -yScale, yOffset};
            break;
