...
namespace gpu_info {
    namespace {
        ...
        const std::array<uint32_t, 10> Tigerlake = {
            {0x9A60, 0x9A68, 0x9A70, 0x9A40, 0x9A49, 0x9A78, 0x9AC0, 0x9AC9, 0x9AD9, 0x9AF8}};
        const uint32_t DG1 = 0x4905;
    ...
    bool IsDG1(PCIDeviceID deviceId) {
        return deviceId == DG1;
    }
}  // namespace gpu_info
