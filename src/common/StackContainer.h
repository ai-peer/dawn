...
// This file is a copy of Chromium's /src/base/containers/stack_container.h
...
class StackAllocator : public std::allocator<T> {
    ...
    struct StackCapacity {
        static constexpr size_t value = sizeof(T[count]);
    };

    template <>
    struct StackCapacity<0> {
  ...
  public:
    ...
    struct Source {
        ...
        alignas(T) char stack_buffer_[StackCapacity<stack_capacity>::value];
