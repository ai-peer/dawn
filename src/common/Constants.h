...
static constexpr uint32_t kMaxDynamicUniformBufferCount = 5u;
// Max numbers of dynamic storage buffers
static constexpr uint32_t kMaxDynamicStorageBufferCount = 2u;
// Max numbers of dynamic buffers
static constexpr uint32_t kMaxDynamicBufferCount = 7u;
