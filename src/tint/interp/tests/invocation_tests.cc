...
TEST_F(InvocationTest, Memory_LoadThroughView) {
    ...
    auto* view1 = alloc.CreateView(executor_.get(), builtin::AddressSpace::kPrivate, i32, 0, 4, {});
    auto* view2 = alloc.CreateView(executor_.get(), builtin::AddressSpace::kPrivate, i32, 4, 4, {});
...
TEST_F(InvocationTest, Memory_ArrayStoreThroughView) {
    ...
    auto* view = alloc.CreateView(executor_.get(), builtin::AddressSpace::kPrivate, arr_ty, {});
...
TEST_F(InvocationTest, Memory_MatrixLoadThroughView) {
    ...
    auto* mat3x3 = executor_->Builder().create<type::Matrix>(
        ...
        3u);
    auto* view =
        alloc.CreateView(executor_.get(), builtin::AddressSpace::kPrivate, mat3x3, 0, 48, {});
