...
class InteractiveDebuggerTest : public testing::Test {
  protected:
    ...
    void Run(UVec3 group_count,
        ...
        debugger_ = std::make_unique<InteractiveDebugger>(*file_, *executor_, iss);
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:12:16
    9: fn main() {
   10:   a++;
   11:   a++;
-> 12:   a = foo(10 + a);
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:6:14
   3: @compute @workgroup_size(1)
   4: fn main() {
   5:   var a = array<i32, 4>(1, 2, 3, 4);
-> 6:   a[a[0]] = a[1] + a[3];
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:6:21
   3: @compute @workgroup_size(1)
   4: fn main() {
   5:   var a = array<i32, 4>(1, 2, 3, 4);
-> 6:   a[a[0]] = a[1] + a[3];
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:6:18
   3: @compute @workgroup_size(1)
   4: fn main() {
   5:   var a = array<i32, 4>(1, 2, 3, 4);
-> 6:   a[a[0]] = a[1] + a[3];
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:8:13
    5:   let b = 2;
    6:   let c = a + b;
    7:   let d = a + b + c;
->  8:   let e = a + b + c + d;
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:8:17
    5:   let b = 2;
    6:   let c = a + b;
    7:   let d = a + b + c;
->  8:   let e = a + b + c + d;
...
* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:8:21
    5:   let b = 2;
    6:   let c = a + b;
    7:   let d = a + b + c;
->  8:   let e = a + b + c + d;
...
c
        ...
        R"(* workgroup_id(0,0,0)
  * local_invocation_id(0,0,0)
    * frame #0: main() at test.wgsl:12:7
    9:
...
b = 0.000000
        ...
        R"(test.wgsl:6:13 warning: '1.5 / 0' cannot be represented as 'f32'
  var c = a / b;
            ^
