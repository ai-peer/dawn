...
int main(int argc, const char** argv) {
    ...
    // TODO(jrprice): Generate named override values.
    ...
    if (options.interactive) {
        debugger = std::make_unique<tint::interp::InteractiveDebugger>(*executor, std::cin);
    }

    // Run the executor.
    // TODO(jrprice): Generate resource bindings.
