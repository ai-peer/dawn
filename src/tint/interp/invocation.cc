        ...
        return Switch(
            ...
            [&](const sem::ValueConstructor*) {
                ...
                auto mat_vec = [&](const core::type::Type* type,
                    ...
                    auto op = executor_.IntrinsicTable().Lookup(intrinsic, type, arg_types,
...
ExprResult Invocation::EvaluateBuiltin(const sem::BuiltinFn* builtin,
    ...
    auto op = executor_.IntrinsicTable().Lookup(builtin->Fn(), arg_types,
                                                core::EvaluationStage::kConstant);
    if (op->const_eval_fn) {
        ...
        switch (obj.Kind()) {
            ...
            case ExprResult::Kind::kValue:
                if (idx * stride >= obj.Value()->Type()->Size()) {
                    diag::List list;
                    list.AddWarning(diag::System::Interpreter,
