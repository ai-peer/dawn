...
class MemoryView {
  ...
  private:
    ...
    builtin::AddressSpace address_space_ = builtin::AddressSpace::kUndefined;
...
/// A Memory object represents an allocation in the emulator. This is used for buffers, workgroup
