...
class SymbolTable {
  ...
  private:
    ...
    utils::Hashmap<Symbol, std::string, 128> symbol_to_name_;
    utils::Hashmap<std::string, Symbol, 128> name_to_symbol_;
    utils::Hashmap<std::string, size_t, 128> last_prefix_to_index_;
