...
TEST_F(ResolverStorageClassLayoutValidationTest, StorageBuffer_UnalignedMember) {
    ...
    Structure(Source{{12, 34}}, "S",
              utils::Vector{
                  ...
                  Member(Source{{34, 56}}, "b", ty.f32(), utils::Vector{MemberAlign(Expr(1_u))}),
              });
...
TEST_F(ResolverStorageClassLayoutValidationTest, StorageBuffer_UnalignedMember_SuggestedFix) {
    ...
    Structure(Source{{12, 34}}, "S",
              utils::Vector{
                  Member("a", ty.f32(), utils::Vector{MemberSize(5)}),
                  Member(Source{{34, 56}}, "b", ty.f32(), utils::Vector{MemberAlign(Expr(4_u))}),
              });
...
TEST_F(ResolverStorageClassLayoutValidationTest, UniformBuffer_MembersOffsetNotMultipleOf16) {
    ...
    Structure(Source{{12, 34}}, "Inner",
              utils::Vector{
                  Member("scalar", ty.i32(), utils::Vector{MemberAlign(Expr(1_u)), MemberSize(5)}),
              });
...
TEST_F(ResolverStorageClassLayoutValidationTest,
    ...
    Structure(
        ...
        utils::Vector{
            Member(Source{{56, 78}}, "inner", ty.type_name("Inner")),
            Member(Source{{78, 90}}, "scalar", ty.i32(), utils::Vector{MemberAlign(Expr(16_u))}),
        });
...
TEST_F(ResolverStorageClassLayoutValidationTest, PushConstant_Aligned) {
    ...
    Structure("S", utils::Vector{Member("a", ty.f32(), utils::Vector{MemberSize(5)}),
                                 Member("b", ty.f32(), utils::Vector{MemberAlign(Expr(4_u))})});
