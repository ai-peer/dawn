...
const sem::Constant* ConstEval::vec_splat(const sem::Type* ty,
                                          sem::Expression const* const* args,
                                          size_t) {
...
const sem::Constant* ConstEval::vec_ctor_s(const sem::Type* ty,
                                           sem::Expression const* const* args,
                                           size_t num_args) {
    std::vector<const Constant*> els;
...
const sem::Constant* ConstEval::vec_ctor_m(const sem::Type* ty,
                                           sem::Expression const* const* args,
                                           size_t num_args) {
    std::vector<const Constant*> els;
    els.reserve(num_args);
...
const sem::Constant* ConstEval::mat_ctor_s(const sem::Type* ty,
                                           sem::Expression const* const* args,
                                           size_t num_args) {
...
const sem::Constant* ConstEval::mat_ctor_v(const sem::Type* ty,
                                           sem::Expression const* const* args,
                                           size_t num_args) {
    std::vector<const Constant*> els;
    els.reserve(num_args);
