...
TEST_F(ResolverStorageClassValidationTest, Storage_ReadAccessMode) {
    ...
    Global(Source{{56, 78}}, "a", ty.i32(), ast::StorageClass::kStorage, ast::Access::kRead,
           GroupAndBinding(0, 0));
...
TEST_F(ResolverStorageClassValidationTest, Storage_ReadWriteAccessMode) {
    ...
    Global(Source{{56, 78}}, "a", ty.i32(), ast::StorageClass::kStorage, ast::Access::kReadWrite,
           GroupAndBinding(0, 0));
...
TEST_F(ResolverStorageClassValidationTest, Storage_WriteAccessMode) {
    // @group(0) @binding(0) var<storage, read_write> a : i32;
    Global(Source{{56, 78}}, "a", ty.i32(), ast::StorageClass::kStorage, ast::Access::kWrite,
           GroupAndBinding(0, 0));
