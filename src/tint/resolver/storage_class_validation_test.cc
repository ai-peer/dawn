...
TEST_F(ResolverStorageClassValidationTest, StorageBufferF16_TemporallyBan) {
    ...
    GlobalVar(Source{{56, 78}}, "g", ty.f16(), ast::StorageClass::kStorage,
              ast::AttributeList{
                  create<ast::BindingAttribute>(0u),
                  create<ast::GroupAttribute>(0u),
              });
    ...
    EXPECT_EQ(
        r()->error(),
        "error: using f16 types in 'uniform' or 'storage' storage class is not implemented yet");
}
...
TEST_F(ResolverStorageClassValidationTest, StorageBufferVectorF16_TemporallyBan) {
    ...
    GlobalVar(Source{{56, 78}}, "g", ty.vec4<f16>(), ast::StorageClass::kStorage,
              ast::AttributeList{
                  create<ast::BindingAttribute>(0u),
                  create<ast::GroupAttribute>(0u),
              });
...
TEST_F(ResolverStorageClassValidationTest, StorageBufferArrayF16_TemporallyBan) {
    ...
    auto* s = Structure("S", {Member("a", ty.f16())});
    ...
    EXPECT_THAT(r()->error(), HasSubstr("error: using f16 types in 'uniform' or 'storage' storage "
...
TEST_F(ResolverStorageClassValidationTest, StorageBufferStructF16_TemporallyBan) {
    ...
    auto* s = Structure("S", {Member(Source{{12, 34}}, "x", ty.f16())});
...
TEST_F(ResolverStorageClassValidationTest, UniformBufferF16_TemporallyBan) {
    ...
    GlobalVar(Source{{56, 78}}, "g", ty.f16(), ast::StorageClass::kUniform,
              ast::AttributeList{
                  create<ast::BindingAttribute>(0u),
                  create<ast::GroupAttribute>(0u),
              });
...
TEST_F(ResolverStorageClassValidationTest, UniformBufferVectorF16_TemporallyBan) {
    ...
    GlobalVar(Source{{56, 78}}, "g", ty.vec4<f16>(), ast::StorageClass::kUniform,
              ast::AttributeList{
                  create<ast::BindingAttribute>(0u),
                  create<ast::GroupAttribute>(0u),
              });
...
TEST_F(ResolverStorageClassValidationTest, UniformBufferArrayF16_TemporallyBan) {
    ...
    auto* s = Structure("S", {Member("a", ty.f16(), {MemberSize(16)})});
    auto* a = ty.array(ty.Of(s), 3_u);
