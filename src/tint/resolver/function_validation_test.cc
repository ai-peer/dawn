...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(TestParams{builtin::AddressSpace::kNone, Expectation::kInvalid},
                    TestParams{builtin::AddressSpace::kIn, Expectation::kInvalid},
                    TestParams{builtin::AddressSpace::kOut, Expectation::kInvalid},
