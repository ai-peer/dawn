...
TEST_F(ResolverConstEvalTest, StructMemberAccess) {
    ...
    Structure("Outer", utils::Vector{
                           Member("o1", Ident("Inner")),
                           Member("o2", Ident("Inner")),
                       });
...
TEST_F(ResolverConstEvalTest, MatrixMemberAccess_AFloat) {
    auto* c = Const("a", Call(ty.mat(nullptr, 2, 3),  //
                              Call(ty.vec3(nullptr), Expr(1.0_a), Expr(2.0_a), Expr(3.0_a)),
                              Call(ty.vec3(nullptr), Expr(4.0_a), Expr(5.0_a), Expr(6.0_a))));
...
TEST_F(ResolverConstEvalTest, MatrixMemberAccess_f32) {
    auto* c = Const("a", Call(ty.mat(nullptr, 2, 3),  //
                              Call(ty.vec3(nullptr), Expr(1.0_f), Expr(2.0_f), Expr(3.0_f)),
                              Call(ty.vec3(nullptr), Expr(4.0_f), Expr(5.0_f), Expr(6.0_f))));
