...
using DiagnosticFilterStack = ScopeStack<type::DiagnosticRule, type::DiagnosticSeverity>;
...
class Validator {
  public:
    ...
    bool AddDiagnostic(type::DiagnosticRule rule,
  ...
  private:
    ...
    const type::Extensions& enabled_extensions_;
