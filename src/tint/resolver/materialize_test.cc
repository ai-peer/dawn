...
TEST_P(MaterializeAbstractNumeric, Test) {
    ...
    switch (expectation) {
        ...
        case Expectation::kValueTooSmall:
            ASSERT_FALSE(r()->Resolve());
            EXPECT_THAT(r()->error(), testing::HasSubstr("is too small to be represented as '" +
                                                         data.target_element_type_name + "'"));
            break;
    }
}
...
INSTANTIATE_TEST_SUITE_P(
    ScalarValueTooSmall,
    MaterializeAbstractNumeric,                                                //
    testing::Combine(testing::Values(Expectation::kValueTooSmall),             //
                     testing::ValuesIn(kScalarMethods),                        //
                     testing::Values(Types<f32, AFloat>(0.0_a, kTooSmallF32),  //
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(Expectation::kValueTooSmall),               //
                     testing::ValuesIn(kVectorMethods),                          //
                     testing::Values(Types<f32V, AFloatV>(0.0_a, kTooSmallF32),  //
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(Expectation::kValueTooSmall),               //
                     testing::ValuesIn(kMatrixMethods),                          //
                     testing::Values(Types<f32M, AFloatM>(0.0_a, kTooSmallF32),  //
