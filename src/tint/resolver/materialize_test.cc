...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(Expectation::kMaterialize),
                     ...
                     testing::ValuesIn(std::vector<Data>{
                         ...
                         Types<i32, AInt>(-1_a, -1.0),                                      //
                         Types<i32, AInt>(AInt(kHighest<i32>), kHighest<i32>),              //
                         Types<i32, AInt>(AInt(kLowest<i32>), kLowest<i32>),                //
                         Types<u32, AInt>(0_a, 0.0),                                        //
                         Types<u32, AInt>(1_a, 1.0),                                        //
                         Types<u32, AInt>(AInt(kHighest<u32>), kHighest<u32>),              //
                         Types<u32, AInt>(AInt(kLowest<u32>), kLowest<u32>),                //
                         Types<f32, AFloat>(0.0_a, 0.0),                                    //
                         Types<f32, AFloat>(AFloat(kHighest<f32>), kHighest<f32>),          //
                         Types<f32, AFloat>(AFloat(kLowest<f32>), kLowest<f32>),            //
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(Expectation::kMaterialize),
                     ...
                     testing::ValuesIn(std::vector<Data>{
                         ...
                         Types<i32V, AIntV>(-1_a, -1.0),                                      //
                         Types<i32V, AIntV>(AInt(kHighest<i32>), kHighest<i32>),              //
                         Types<i32V, AIntV>(AInt(kLowest<i32>), kLowest<i32>),                //
                         Types<u32V, AIntV>(0_a, 0.0),                                        //
                         Types<u32V, AIntV>(1_a, 1.0),                                        //
                         Types<u32V, AIntV>(AInt(kHighest<u32>), kHighest<u32>),              //
                         Types<u32V, AIntV>(AInt(kLowest<u32>), kLowest<u32>),                //
                         Types<f32V, AFloatV>(0.0_a, 0.0),                                    //
                         Types<f32V, AFloatV>(1.0_a, 1.0),                                    //
                         Types<f32V, AFloatV>(-1.0_a, -1.0),                                  //
                         Types<f32V, AFloatV>(AFloat(kHighest<f32>), kHighest<f32>),          //
                         Types<f32V, AFloatV>(AFloat(kLowest<f32>), kLowest<f32>),            //
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(Expectation::kMaterialize),
                     ...
                     testing::ValuesIn(std::vector<Data>{
                         ...
                         Types<f32M, AFloatM>(-1.0_a, -1.0),                                  //
                         Types<f32M, AFloatM>(AFloat(kHighest<f32>), kHighest<f32>),          //
                         Types<f32M, AFloatM>(AFloat(kLowest<f32>), kLowest<f32>),            //
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::Values(Expectation::kMaterialize),
                     ...
                     testing::ValuesIn(std::vector<Data>{
                         ...
                         // Note: kHighest<i32> cannot be used due to max-byte-size validation
                     })));
