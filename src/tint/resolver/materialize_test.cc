...
enum class Method {
    ...
    kBuiltinArg,  // min(T(), literal);
    kReturn,      // fn F() : T { return literal; }
    kArray,       // array<T, 1>(literal);
    kStruct,      // struct S { v : T };  fn x() { _ = S(literal) }
    kBinaryOp,    // T() + literal
};
...
TEST_P(MaterializeAbstractNumeric, Test) {
    ...
    switch (method) {
        ...
        case Method::kFnArg:
            ...
            break;
        case Method::kBuiltinArg:
            WrapInFunction(CallStmt(Call("min", Construct(target_ty), literal)));
            break;
        case Method::kReturn:
        ...
        case Method::kStruct:
            ...
            break;
        case Method::kBinaryOp:
            WrapInFunction(Add(Construct(target_ty), literal));
            break;
    }
