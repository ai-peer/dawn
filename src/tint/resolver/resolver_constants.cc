...
sem::Constant::Scalars CastScalars(sem::Constant::Scalars in, const sem::Type* target_type) {
    ...
    for (size_t i = 0; i < in.size(); ++i) {
        ...
        out.emplace_back(Switch<sem::Constant::Scalar>(
            target_type,  //
            [&](const sem::AbstractInt*) { return sem::Constant::Cast<AInt>(in[i]); },
            [&](const sem::AbstractFloat*) { return sem::Constant::Cast<AFloat>(in[i]); },
            [&](const sem::I32*) { return sem::Constant::Cast<AInt>(in[i]); },
            [&](const sem::U32*) { return sem::Constant::Cast<AInt>(in[i]); },
            [&](const sem::F32*) { return sem::Constant::Cast<AFloat>(in[i]); },
            [&](const sem::F16*) { return sem::Constant::Cast<AFloat>(in[i]); },
            [&](const sem::Bool*) { return sem::Constant::Cast<bool>(in[i]); },
            [&](Default) {
                diag::List diags;
