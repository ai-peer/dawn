...
class ConstEval {
  public:
    ...
    /// @param args the input arguments
    /// @return the converted value, or null if the value cannot be calculated
    ConstantResult Conv(const sem::Type* ty, utils::ConstVectorRef<const sem::Expression*> args);

    /// Zero value type constructor
    /// @param ty the result type
    /// @param args the input arguments (no arguments provided)
    /// @return the constructed value, or null if the value cannot be calculated
    ConstantResult Zero(const sem::Type* ty, utils::ConstVectorRef<const sem::Expression*> args);
    ...
    /// @param args the input arguments
    /// @return the result value, or null if the value cannot be calculated
    ConstantResult OpMinus(const sem::Type* ty, utils::ConstVectorRef<const sem::Expression*> args);
    ...
    /// @param args the input arguments
    /// @return the result value, or null if the value cannot be calculated
    ConstantResult OpPlus(const sem::Type* ty, utils::ConstVectorRef<const sem::Expression*> args);
    ...
    /// @param args the input arguments
    /// @return the result value, or null if the value cannot be calculated
    ConstantResult atan2(const sem::Type* ty, utils::ConstVectorRef<const sem::Expression*> args);

    /// clamp builtin
    /// @param ty the expression type
    /// @param args the input arguments
    /// @return the result value, or null if the value cannot be calculated
    ConstantResult clamp(const sem::Type* ty, utils::ConstVectorRef<const sem::Expression*> args);
