...
class ConstEval {
  ...
  private:
    ...
    /// Returns a callable that calls VecLength with two elements, and creates a Constant with its
    ...
    /// Returns a callable that calls VecLength with three elements, and creates a Constant with its
    /// result of type `elem_ty` if successful, or returns Failure otherwise.
    /// @param source the source location
    /// @param elem_ty the element type of the Constant to create on success
    /// @returns the callable function
    ...
    /// Returns a callable that calls VecLength with four elements, and creates a Constant with its
    /// result of type `elem_ty` if successful, or returns Failure otherwise.
    /// @param source the source location
    /// @param elem_ty the element type of the Constant to create on success
    /// @returns the callable function
