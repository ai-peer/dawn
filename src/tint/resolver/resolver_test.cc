...
TEST_F(ResolverTest, Expr_Bitcast) {
    ...
    auto* bitcast = Bitcast(ty.f32(), Expr("name"));
...
TEST_F(ResolverTest, Function_WorkgroupSize_ViaConst_NestedInitializer) {
    ...
    // fn main() {}
    GlobalConst("width", ty.i32(), Call(ty.i32(), Call(ty.i32(), Call(ty.i32(), 8_i))));
    GlobalConst("height", ty.i32(), Call(ty.i32(), Call(ty.i32(), Call(ty.i32(), 4_i))));
    auto* func = Func("main", utils::Empty, ty.void_, utils::Empty,
                      utils::Vector{
                          Stage(ast::PipelineStage::kCompute),
...
TEST_P(Expr_Binary_Test_Invalid_VectorMatrixMultiply, All) {
    ...
    const ast::Identifier* lhs_type = nullptr;
    const ast::Identifier* rhs_type = nullptr;
