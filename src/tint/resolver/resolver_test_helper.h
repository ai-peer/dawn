...
struct AstExprArgs {
    ...
    struct Storage {
      ...
      private:
        std::variant<i32, u32, f32, f16, AInt, AFloat, bool> data;
    };
...
struct DataType<bool> {
    ...
    /// @param b the ProgramBuilder
    /// @param v arg of type double that will be cast to the T.
...
struct Value {
    ...
    /// @returns a Value<T>
    static Value Create(AstExprArgs args) { return Value{DataType::Expr, std::move(args)}; }
