...
Case C(ValuePtr lhs, ValuePtr rhs, ValuePtr expected) {
...
template <typename T, typename U, typename V, typename = std::enable_if_t<!IsValuePtr<T>>>
...
Case E(ValuePtr lhs, ValuePtr rhs, std::string error) {
