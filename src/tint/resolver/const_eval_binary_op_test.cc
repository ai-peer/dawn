...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        // ...
        OverflowCase{ast::BinaryOp::kShiftLeft, Val(u32(1 << 28)), Val(4_u)},
        OverflowCase{ast::BinaryOp::kShiftLeft, Val(u32(1 << 29)), Val(3_u)},
        OverflowCase{ast::BinaryOp::kShiftLeft, Val(u32(1 << 30)), Val(2_u)},
        OverflowCase{ast::BinaryOp::kShiftLeft, Val(u32(1 << 31)), Val(1_u)},
        // And some more
