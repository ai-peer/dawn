...
// TODO(crbug.com/tint/1581): Requires @const in intrinsics.def
TEST_F(ResolverEvaluationStageTest, DISABLED_Vector_Ctor) {
    auto* expr = vec3<f32>();
    WrapInFunction(expr);
...
// TODO(crbug.com/tint/1581): Requires @const in intrinsics.def
TEST_F(ResolverEvaluationStageTest, DISABLED_Vector_Ctor_Const_Const) {
    // const f = 1.f;
    // vec2<f32>(f, f);
...
// TODO(crbug.com/tint/1581): Requires @const in intrinsics.def
TEST_F(ResolverEvaluationStageTest, DISABLED_Vector_Ctor_Runtime_Runtime) {
    // var f = 1.f;
    // vec2<f32>(f, f);
...
// TODO(crbug.com/tint/1581): Requires @const in intrinsics.def
TEST_F(ResolverEvaluationStageTest, DISABLED_Vector_Conv_Const) {
    // const f = 1.f;
    // vec2<u32>(vec2<f32>(f));
    auto* f = Const("f", nullptr, Expr(1_f));
...
// TODO(crbug.com/tint/1581): Requires @const in intrinsics.def
TEST_F(ResolverEvaluationStageTest, DISABLED_Vector_Conv_Runtime) {
    // var f = 1.f;
    // vec2<u32>(vec2<f32>(f));
    auto* f = Var("f", nullptr, Expr(1_f));
    auto* expr = vec2<u32>(vec2<f32>(f));
...
// TODO(crbug.com/tint/1581): Requires @const in intrinsics.def
TEST_F(ResolverEvaluationStageTest, DISABLED_Matrix_Ctor) {
