...
constexpr IntrinsicInfo kBuiltins[] = {
  ...
  {
    /* [9] */
    /* fn atan2<T : fia_fi32_f16>(T, T) -> T */
    /* fn atan2<N : num, T : fia_fi32_f16>(vec<N, T>, vec<N, T>) -> vec<N, T> */
    /* num overloads */ 2,
  ...
  {
    /* [12] */
    /* fn clamp<T : fia_fi32_f16>(T, T, T) -> T */
    /* fn clamp<N : num, T : fia_fi32_f16>(vec<N, T>, vec<N, T>, vec<N, T>) -> vec<N, T> */
    /* num overloads */ 2,
