...
class MatchState {
  public:
    ...
    /// The evaluation stage of the builtin call
...
bool match_fa(MatchState& state, const sem::Type* ty) {
    return (state.stage == sem::EvaluationStage::kConstant) &&
...
bool match_ia(MatchState& state, const sem::Type* ty) {
    return (state.stage == sem::EvaluationStage::kConstant) && ty->IsAnyOf<Any, sem::AbstractInt>();
}
