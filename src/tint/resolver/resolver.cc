...
sem::Expression* Resolver::Binary(const ast::BinaryExpression* expr) {
    ...
    auto* sem = builder_->create<sem::Expression>(expr, op.result, stage, current_statement_, val,
                                                  has_side_effects);
...
sem::Expression* Resolver::UnaryOp(const ast::UnaryOpExpression* unary) {
    ...
    auto* sem = builder_->create<sem::Expression>(unary, ty, stage, current_statement_, val,
