...
type::Type* Resolver::BuiltinType(builtin::Builtin builtin_ty, const ast::Identifier* ident) {
    ...
    switch (builtin_ty) {
        ...
        case builtin::Builtin::kAtomicCompareExchangeResultI32:
            return builtin::CreateAtomicCompareExchangeResult(builder_->Types(),
        ...
        case builtin::Builtin::kFrexpResultAbstract:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(), af());
        case builtin::Builtin::kFrexpResultF16:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(), f16());
        case builtin::Builtin::kFrexpResultF32:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(), f32());
        case builtin::Builtin::kFrexpResultVec2Abstract:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(), vec(af(), 2));
        case builtin::Builtin::kFrexpResultVec2F16:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(),
                                              vec(f16(), 2));
        case builtin::Builtin::kFrexpResultVec2F32:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(),
                                              vec(f32(), 2));
        case builtin::Builtin::kFrexpResultVec3Abstract:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(), vec(af(), 3));
        ...
        case builtin::Builtin::kFrexpResultVec4Abstract:
            return builtin::CreateFrexpResult(builder_->Types(), builder_->Symbols(), vec(af(), 4));
        ...
        case builtin::Builtin::kModfResultAbstract:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), af());
        case builtin::Builtin::kModfResultF16:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), f16());
        case builtin::Builtin::kModfResultF32:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), f32());
        case builtin::Builtin::kModfResultVec2Abstract:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(af(), 2));
        case builtin::Builtin::kModfResultVec2F16:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(f16(), 2));
        case builtin::Builtin::kModfResultVec2F32:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(f32(), 2));
        case builtin::Builtin::kModfResultVec3Abstract:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(af(), 3));
        case builtin::Builtin::kModfResultVec3F16:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(f16(), 3));
        case builtin::Builtin::kModfResultVec3F32:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(f32(), 3));
        case builtin::Builtin::kModfResultVec4Abstract:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(af(), 4));
        case builtin::Builtin::kModfResultVec4F16:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(f16(), 4));
        case builtin::Builtin::kModfResultVec4F32:
            return builtin::CreateModfResult(builder_->Types(), builder_->Symbols(), vec(f32(), 4));
