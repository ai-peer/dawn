...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Empty_DefaultEmpty) {
    auto* stmt = Switch(1_i, Case(CaseSelector(Expr(0_i)), Block()), DefaultCase(Block()));
    WrapInFunction(stmt);
...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Empty_DefaultDiscard) {
    auto* stmt = Switch(1_i, Case(CaseSelector(Expr(0_i)), Block()), DefaultCase(Block(Discard())));
...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Empty_DefaultReturn) {
    auto* stmt = Switch(1_i, Case(CaseSelector(Expr(0_i)), Block()), DefaultCase(Block(Return())));
    WrapInFunction(stmt);
...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Discard_DefaultEmpty) {
    auto* stmt = Switch(1_i, Case(CaseSelector(Expr(0_i)), Block(Discard())), DefaultCase(Block()));
...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Discard_DefaultDiscard) {
    auto* stmt =
        Switch(1_i, Case(CaseSelector(Expr(0_i)), Block(Discard())), DefaultCase(Block(Discard())));
...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Discard_DefaultReturn) {
    auto* stmt =
        Switch(1_i, Case(CaseSelector(Expr(0_i)), Block(Discard())), DefaultCase(Block(Return())));
...
TEST_F(ResolverBehaviorTest, StmtSwitch_CondLiteral_Case0Discard_Case1Return_DefaultEmpty) {
    auto* stmt = Switch(1_i,                                              //
                        Case(CaseSelector(Expr(0_i)), Block(Discard())),  //
                        Case(CaseSelector(Expr(1_i)), Block(Return())),   //
                        DefaultCase(Block()));
