...
std::vector<Case> AtanhCases() {
    ...
    ConcatIntoIf<finite_only>(  //
        cases,
        std::vector<Case>{
            E({1.1_a}, "12:34 error: atanh must be called with a value in the range [-1, 1]"),
            E({-1.1_a}, "12:34 error: atanh must be called with a value in the range [-1, 1]"),
            E({T::Inf()}, "12:34 error: atanh must be called with a value in the range [-1, 1]"),
            E({-T::Inf()}, "12:34 error: atanh must be called with a value in the range [-1, 1]"),
        });
...
std::vector<Case> AcosCases() {
    ...
    ConcatIntoIf<finite_only>(  //
        cases,
        std::vector<Case>{
            E({1.1_a}, "12:34 error: acos must be called with a value in the range [-1, 1]"),
            E({-1.1_a}, "12:34 error: acos must be called with a value in the range [-1, 1]"),
            E({T::Inf()}, "12:34 error: acos must be called with a value in the range [-1, 1]"),
            E({-T::Inf()}, "12:34 error: acos must be called with a value in the range [-1, 1]"),
        });
...
std::vector<Case> AsinCases() {
    ...
    ConcatIntoIf<finite_only>(  //
        cases,
        std::vector<Case>{
            E({1.1_a}, "12:34 error: asin must be called with a value in the range [-1, 1]"),
            E({-1.1_a}, "12:34 error: asin must be called with a value in the range [-1, 1]"),
            E({T::Inf()}, "12:34 error: asin must be called with a value in the range [-1, 1]"),
            E({-T::Inf()}, "12:34 error: asin must be called with a value in the range [-1, 1]"),
        });
