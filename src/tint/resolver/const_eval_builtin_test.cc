...
using AtanhRangeTest = ResolverTestWithParam<Types>;
TEST_P(AtanhRangeTest, Test) {
    auto param = std::get<0>(GetParam());
    auto* expr = Call(Source{{12, 24}}, "atanh", Expr(param));
...
INSTANTIATE_TEST_SUITE_P(Test,
                         AtanhRangeTest,
                         testing::Values(1.0_a, -1.0_a, f32::Inf(), -f32::Inf()));
