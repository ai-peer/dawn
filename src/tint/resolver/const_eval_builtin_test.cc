...
std::vector<Case> CountLeadingZerosCases() {
    return {
        ...
        // Vector tests
        C({Vec(T(1 << 31), T(1 << 30), T(1 << 29))}, Vec(T(0), T(1), T(2))),
        C({Vec(T(1 << 2), T(1 << 1), T(1 << 0))}, Vec(T(29), T(30), T(31))),
    };
}
INSTANTIATE_TEST_SUITE_P(  //
    CountLeadingZeros,
...
std::vector<Case> CountTrailingZerosCases() {
    return {
        ...
        // Vector tests
        C({Vec(T(1 << 31), T(1 << 30), T(1 << 29))}, Vec(T(31), T(30), T(29))),
        C({Vec(T(1 << 2), T(1 << 1), T(1 << 0))}, Vec(T(2), T(1), T(0))),
    };
}
INSTANTIATE_TEST_SUITE_P(  //
    CountTrailingZeros,
...
std::vector<Case> CountOneBitsCases() {
    return {
        ...
        // Vector tests
        C({Vec(T(1 << 31), T(1 << 30), T(1 << 29))}, Vec(T(1), T(1), T(1))),
        C({Vec(T(1 << 2), T(1 << 1), T(1 << 0))}, Vec(T(1), T(1), T(1))),
