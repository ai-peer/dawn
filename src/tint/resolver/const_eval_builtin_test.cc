...
std::vector<Case> InsertBitsCases() {
    ...
    auto r = std::vector<Case>{
        ...
        C({e, newbits, UT(3), UT(8)}, T(0b0101'1100'0011'1010'0101'1011'1100'0010)),
        C({e, newbits, UT(7), UT(3)}, T(0b0101'1100'0011'1010'0101'1111'1011'1010)),
        C({e, newbits, UT(8), UT(8)}, T(0b0101'1100'0011'1010'1010'0011'0011'1010)),
        C({e, newbits, UT(15), UT(1)}, T(0b0101'1100'0011'1010'1101'1100'0011'1010)),

        // offset is clamped to bit width
        C({e, newbits, UT(32), UT(1)}, e),    //
        C({e, newbits, UT(33), UT(1)}, e),    //
        C({e, newbits, UT(1000), UT(1)}, e),  //
        C({e, newbits, UT::Highest(), UT(1)}, e),

        // count is clamped to bit width - offset
        C({e, newbits, UT(0), UT(32)}, newbits),    //
        C({e, newbits, UT(0), UT(33)}, newbits),    //
        C({e, newbits, UT(0), UT(1000)}, newbits),  //
        C({e, newbits, UT(0), UT::Highest()}, newbits),
