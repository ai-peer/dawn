...
std::vector<Case> LogF16Cases() {
    return std::vector<Case>{
        C({T(54.598150033)}, T(3.9980649)).FloatComp(),  //
...
std::vector<Case> LogF32Cases() {
    return std::vector<Case>{
        C({T(54.598150033)}, T(4)).FloatComp(),  //
...
INSTANTIATE_TEST_SUITE_P(  //
    ...
    ResolverConstEvalBuiltinTest,
    testing::Combine(testing::Values(sem::BuiltinType::kLog2),
                     testing::ValuesIn(Log2Cases<f16>())));
template <typename T>
...
INSTANTIATE_TEST_SUITE_P(  //
    ...
    ResolverConstEvalBuiltinTest,
    testing::Combine(testing::Values(sem::BuiltinType::kLog2),
                     testing::ValuesIn(Log2Cases<f32>())));
template <typename T>
...
INSTANTIATE_TEST_SUITE_P(  //
    ...
    ResolverConstEvalBuiltinTest,
    testing::Combine(testing::Values(sem::BuiltinType::kLog2),
                     testing::ValuesIn(Log2Cases<AFloat>())));
