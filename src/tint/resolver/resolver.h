...
class Resolver {
  public:
    ...
    /// @param enable_abstract_int if true, then treat unsuffixed integers as abstract integers
    explicit Resolver(ProgramBuilder* builder, bool enable_abstract_int = false);
  ...
  private:
    ...
    bool enable_abstract_int_ = false;
};
