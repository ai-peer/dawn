...
class Resolver {
  ...
  private:
    ...
    /// @returns the semantic info for the variable `var`. If an error is raised, nullptr is
    /// returned.
    ...
    /// @returns the semantic info for the parameter `param`. If an error is raised, nullptr is
    /// returned.
