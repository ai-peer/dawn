...
TEST_F(ResolverTypeValidationTest, ArraySize_NamedOverride_Equivalence) {
    // override size = 10i;
    ...
    // }
    Override("size", Expr(10_i));
    GlobalVar("a", ty.array(ty.f32(), Expr("size")), ast::AddressSpace::kWorkgroup);
    GlobalVar("b", ty.array(ty.f32(), Expr("size")), ast::AddressSpace::kWorkgroup);
