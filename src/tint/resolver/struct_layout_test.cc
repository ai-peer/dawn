...
TEST_F(ResolverStructLayoutTest, AlignAttributes) {
    auto* inner =
        Structure("Inner", utils::Vector{
                               Member("a", ty.f32(), utils::Vector{MemberAlign(Expr(8_u))}),
                               Member("b", ty.f32(), utils::Vector{MemberAlign(Expr(16_u))}),
                               Member("c", ty.f32(), utils::Vector{MemberAlign(Expr(4_u))}),
                           });
    auto* s = Structure("S", utils::Vector{
                                 Member("a", ty.f32(), utils::Vector{MemberAlign(Expr(4_u))}),
                                 Member("b", ty.u32(), utils::Vector{MemberAlign(Expr(8_u))}),
                                 Member("c", ty.Of(inner)),
                                 Member("d", ty.i32(), utils::Vector{MemberAlign(Expr(32_u))}),
                             });
...
TEST_F(ResolverStructLayoutTest, StructWithLotsOfPadding) {
    auto* s = Structure("S", utils::Vector{
                                 Member("a", ty.i32(), utils::Vector{MemberAlign(Expr(1024_u))}),
                             });
