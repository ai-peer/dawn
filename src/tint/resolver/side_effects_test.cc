...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<Case>{
        ...
        C("abs", utils::Vector{"f"}, false), C("acos", utils::Vector{"f"}, false),
        C("acosh", utils::Vector{"f"}, false), C("all", utils::Vector{"vb"}, false),
        C("any", utils::Vector{"vb"}, false),
        C("arrayLength", utils::Vector{"pstorage_arr"}, false),
        C("asin", utils::Vector{"f"}, false), C("asinh", utils::Vector{"f"}, false),
        C("atan", utils::Vector{"f"}, false), C("atan2", utils::Vector{"f", "f"}, false),
        C("atanh", utils::Vector{"f"}, false), C("atomicLoad", utils::Vector{"pa"}, false),
        C("ceil", utils::Vector{"f"}, false), C("clamp", utils::Vector{"f", "f", "f"}, false),
        C("cos", utils::Vector{"f"}, false), C("cosh", utils::Vector{"f"}, false),
        C("countLeadingZeros", utils::Vector{"i"}, false),
        C("countOneBits", utils::Vector{"i"}, false),
        C("countTrailingZeros", utils::Vector{"i"}, false),
        C("cross", utils::Vector{"vf", "vf"}, false), C("degrees", utils::Vector{"f"}, false),
        C("determinant", utils::Vector{"m"}, false), C("distance", utils::Vector{"f", "f"}, false),
        C("dot", utils::Vector{"vf", "vf"}, false),
        C("dot4I8Packed", utils::Vector{"u", "u"}, false),
        C("dot4U8Packed", utils::Vector{"u", "u"}, false), C("dpdx", utils::Vector{"f"}, false),
        C("dpdxCoarse", utils::Vector{"f"}, false), C("dpdxFine", utils::Vector{"f"}, false),
        C("dpdy", utils::Vector{"f"}, false), C("dpdyCoarse", utils::Vector{"f"}, false),
        C("dpdyFine", utils::Vector{"f"}, false), C("exp", utils::Vector{"f"}, false),
        C("exp2", utils::Vector{"f"}, false), C("extractBits", utils::Vector{"i", "u", "u"}, false),
        C("faceForward", utils::Vector{"vf", "vf", "vf"}, false),
        C("firstLeadingBit", utils::Vector{"u"}, false),
        C("firstTrailingBit", utils::Vector{"u"}, false), C("floor", utils::Vector{"f"}, false),
        C("fma", utils::Vector{"f", "f", "f"}, false), C("fract", utils::Vector{"vf"}, false),
        C("frexp", utils::Vector{"f"}, false), C("fwidth", utils::Vector{"f"}, false),
        C("fwidthCoarse", utils::Vector{"f"}, false), C("fwidthFine", utils::Vector{"f"}, false),
        C("insertBits", utils::Vector{"i", "i", "u", "u"}, false),
        C("inverseSqrt", utils::Vector{"f"}, false), C("ldexp", utils::Vector{"f", "i"}, false),
        C("length", utils::Vector{"vf"}, false), C("log", utils::Vector{"f"}, false),
        C("log2", utils::Vector{"f"}, false), C("max", utils::Vector{"f", "f"}, false),
        C("min", utils::Vector{"f", "f"}, false), C("mix", utils::Vector{"f", "f", "f"}, false),
        C("modf", utils::Vector{"f"}, false), C("normalize", utils::Vector{"vf"}, false),
        ...
        C("pack4x8unorm", utils::Vector{"vf4"}, false), C("pow", utils::Vector{"f", "f"}, false),
        C("radians", utils::Vector{"f"}, false), C("reflect", utils::Vector{"vf", "vf"}, false),
        C("refract", utils::Vector{"vf", "vf", "f"}, false),
        C("reverseBits", utils::Vector{"u"}, false), C("round", utils::Vector{"f"}, false),
        C("select", utils::Vector{"f", "f", "b"}, false), C("sign", utils::Vector{"f"}, false),
        C("sin", utils::Vector{"f"}, false), C("sinh", utils::Vector{"f"}, false),
        C("smoothstep", utils::Vector{"f", "f", "f"}, false), C("sqrt", utils::Vector{"f"}, false),
        C("step", utils::Vector{"f", "f"}, false), C("tan", utils::Vector{"f"}, false),
        C("tanh", utils::Vector{"f"}, false), C("textureDimensions", utils::Vector{"t2d"}, false),
        ...
        C("transpose", utils::Vector{"m"}, false), C("trunc", utils::Vector{"f"}, false),
        ...
        C("storageBarrier", utils::Empty, true, ast::PipelineStage::kCompute),
        C("workgroupBarrier", utils::Empty, true, ast::PipelineStage::kCompute),
