...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<Case>{
        ...
        C("textureSample", utils::Vector{"t2d", "s2d", "vf2"}, true),                     //
        C("textureSampleBias", utils::Vector{"t2d", "s2d", "vf2", "f"}, true),            //
        C("textureSampleCompare", utils::Vector{"tdepth2d", "scomp", "vf2", "f"}, true),  //
        C("dpdx", utils::Vector{"f"}, true),                                              //
        C("dpdxCoarse", utils::Vector{"f"}, true),                                        //
        C("dpdxFine", utils::Vector{"f"}, true),                                          //
        C("dpdy", utils::Vector{"f"}, true),                                              //
        C("dpdyCoarse", utils::Vector{"f"}, true),                                        //
        C("dpdyFine", utils::Vector{"f"}, true),                                          //
        C("fwidth", utils::Vector{"f"}, true),                                            //
        C("fwidthCoarse", utils::Vector{"f"}, true),                                      //
        C("fwidthFine", utils::Vector{"f"}, true),                                        //
