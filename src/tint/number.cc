...
f16::type f16::Quantize(f16::type value) {
    ...
    // representable by normal f32 values.
    //   1.1. We can denote the set of all f32 number that are exact representation of finate f16
    //   values by `R`.
    //   1.2. We can do the quantization by mapping a normal f32 value v (in the f16 finate range)
    //   to a certain f32 value v' in the set R, which is the largest (by the meaning of absolute
    ...
    //   finate f16 value and can not be in set R.
    ...
    //   2.4. If 2^-24 > abs(v) > 0, i.e. 103 > e, v is smaller than any finate f16 value and not
    ...
    //          ==  (s==0?1:-1)*(uint(1mmmm_mmmmm_0)*(2^-11))*(2^-14)
    //          ==  (s==0?1:-1)*(uint(1_mmmmm_mmmm0)*(2^-10))*(2^-15)
    //          ==  (s==0?1:-1)*(1+uint(mmmmm_mmmm0)*(2^-10))*(2^-15)
    ...
    //          ==  (s==0?1:-1)*(uint(1mmm_mmmmm_00)*(2^-12))*(2^-14)
    //          ==  (s==0?1:-1)*(uint(1_mmmmm_mmm00)*(2^-10))*(2^-16)
    //          ==  (s==0?1:-1)*(1+uint(mmmmm_mmm00)*(2^-10))*(2^-16)
    ...
    //          ==  (s==0?1:-1)*(uint(1m_00000_0000)*(2^-19))*(2^-14)
    //          ==  (s==0?1:-1)*(uint(1_m0000_00000)*(2^-10))*(2^-23)
    //          ==  (s==0?1:-1)*(1+uint(m0000_00000)*(2^-10))*(2^-23)
