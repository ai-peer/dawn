...
class Inspector {
  public:
    ...
    /// @returns the entry point information, if there is an entry point with the given entry point
    /// name
    std::optional<EntryPoint> GetEntryPoint(const std::string& entry_point);
