...
class InspectorBuilder : public ProgramBuilder {
  public:
    ...
    std::string StructMemberName(size_t idx, const ast::Identifier* type);
    ...
    void AddWorkgroupStorage(const std::string& name, const ast::Identifier* type);
    ...
    using MemberInfo = std::tuple<size_t, const ast::Identifier*>;
    ...
    /// @param name the name of the variable
    /// @param type the type to use
    void AddGlobalVariable(const std::string& name, const ast::Identifier* type);
    ...
    const ast::Identifier* GetBaseType(ResourceBinding::SampledKind sampled_kind);
    ...
    /// @returns a pointer to a type appropriate for the coord param
    const ast::Identifier* GetCoordsType(type::TextureDimension dim, const ast::Identifier* scalar);
    ...
    const ast::Identifier* MakeStorageTextureTypes(type::TextureDimension dim,
    ...
    std::function<const ast::Identifier*()> GetTypeFunction(ComponentType component,
