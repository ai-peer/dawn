...
TINT_INSTANTIATE_TYPEINFO(Animal, false);
TINT_INSTANTIATE_TYPEINFO(Amphibian, false);
TINT_INSTANTIATE_TYPEINFO(Mammal, false);
TINT_INSTANTIATE_TYPEINFO(Reptile, false);
TINT_INSTANTIATE_TYPEINFO(Frog, true);
TINT_INSTANTIATE_TYPEINFO(Bear, true);
TINT_INSTANTIATE_TYPEINFO(Lizard, true);
TINT_INSTANTIATE_TYPEINFO(Gecko, true);
