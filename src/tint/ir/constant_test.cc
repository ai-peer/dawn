...
TEST_F(IR_ConstantTest, f32) {
    ...
    auto* val = b.builder.ConstantValue(1.2_f);
...
TEST_F(IR_ConstantTest, f16) {
    ...
    auto* val = b.builder.ConstantValue(1.1_h);
...
TEST_F(IR_ConstantTest, i32) {
    ...
    auto* val = b.builder.ConstantValue(1_i);
...
TEST_F(IR_ConstantTest, u32) {
    ...
    auto* val = b.builder.ConstantValue(2_u);
...
TEST_F(IR_ConstantTest, bool) {
    ...
    auto* val = b.builder.ConstantValue(false);
    ...
    str.str("");
    val = b.builder.ConstantValue(true);
