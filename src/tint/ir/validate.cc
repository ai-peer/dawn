...
class Validator {
  ...
  private:
    ...
    void CheckLoadVectorElement(LoadVectorElement* l) {
        CheckOperandNotNull(l, l->From(), LoadVectorElement::kFromOperandOffset,
                            "load_vector_element", [](size_t) { return "from"; });
        CheckOperandNotNull(l, l->Index(), LoadVectorElement::kIndexOperandOffset,
                            "load_vector_element", [](size_t) { return "index"; });
    ...
    void CheckStoreVectorElement(StoreVectorElement* s) {
        CheckOperandNotNull(s, s->To(), StoreVectorElement::kToOperandOffset,
                            "store_vector_element", [](size_t) { return "to"; });
        CheckOperandNotNull(s, s->Index(), StoreVectorElement::kIndexOperandOffset,
                            "store_vector_element", [](size_t) { return "index"; });
        CheckOperandNotNull(s, s->Value(), StoreVectorElement::kValueOperandOffset,
                            "store_vector_element", [](size_t) { return "value"; });
