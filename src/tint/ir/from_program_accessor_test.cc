...
TEST_F(IR_BuilderImplTest, Accessor_Var_SingleIndex) {
    // var a: vec3<u32>
    // let b = a[2]
...
TEST_F(IR_BuilderImplTest, Accessor_Var_MultiIndex) {
    // var a: mat3x4<f32>
    // let b = a[2][3]
...
TEST_F(IR_BuilderImplTest, Accessor_Var_SingleMember) {
...
TEST_F(IR_BuilderImplTest, Accessor_Var_MultiMember) {
...
TEST_F(IR_BuilderImplTest, Accessor_Var_Mixed) {
...
TEST_F(IR_BuilderImplTest, Accessor_Var_SingleElementSwizzle) {
    // var a: vec2<f32>
    // let b = a.y
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Var_MultiElementSwizzle) {
    // var a: vec3<f32>
    // let b = a.zyxz
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Var_MultiElementSwizzleOfSwizzle) {
    // var a: vec3<f32>
    // let b = a.zyx.yy
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Var_MultiElementSwizzle_MiddleOfChain) {
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_SingleIndex) {
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_MultiIndex) {
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_SingleMember) {
    // struct MyStruct { foo: i32 }
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_MultiMember) {
    // struct Inner { bar: f32 }
    // struct Outer { a: i32, foo: Inner }
    // let a: Outer = Outer();
    // let b = a.foo.bar
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_Mixed) {
    // struct Outer { a: i32, foo: array<Inner, 4> }
    // struct Inner { b: i32, c: f32, bar: vec4<f32> }
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_SingleElement) {
    // let a: vec2<f32> = vec2()
    // let b = a.y
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_MultiElementSwizzle) {
    // let a: vec3<f32 = vec3()>
    // let b = a.zyxz
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_MultiElementSwizzleOfSwizzle) {
    // let a: vec3<f32> = vec3();
    // let b = a.zyx.yy
...
TEST_F(IR_BuilderImplTest, DISABLED_Accessor_Let_MultiElementSwizzle_MiddleOfChain) {
    // struct MyStruct { a: i32; foo: vec4<f32> }
    // let a: MyStruct = MyStruct();
    // let b = a.foo.zyx.yx[0]
