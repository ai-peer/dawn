...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalAnd_Inline_2) {
    Test(R"(
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalAnd_Inline_3) {
    Test(R"(
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalAnd_Let_3) {
    Test(R"(
fn f(a : bool, b : bool, c : bool) -> bool {
  let l = ((a && b) && c);
  return l;
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalOr_Inline_2) {
    Test(R"(
fn f(a : bool, b : bool) -> bool {
  return (a || b);
}
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalOr_Inline_3) {
    Test(R"(
fn f(a : bool, b : bool, c : bool) -> bool {
  return ((a || b) || c);
}
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalOr_Let_3) {
    Test(R"(
fn f(a : bool, b : bool, c : bool) -> bool {
  let l = ((a || b) || c);
  return l;
