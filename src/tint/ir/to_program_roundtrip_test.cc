...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalAnd_Inline) {
    Test(R"(
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalOr_Inline) {
    Test(R"(
fn f(a : bool, b : bool) -> bool {
  return (a || b);
}
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalAnd_Let) {
    Test(R"(
fn f(a : bool, b : bool) -> bool {
  let l = (a && b);
  return l;
...
TEST_F(IRToProgramRoundtripTest, BinaryOp_LogicalOr_Let) {
    Test(R"(
fn f(a : bool, b : bool) -> bool {
  let l = (a || b);
  return l;
