...
class Builtin : public Castable<Builtin, Instruction> {
  public:
    /// Constructor
    ...
    /// @returns the builtin arguments
    utils::VectorRef<Value*> Args() const { return args_; }

    /// Emits the arguments to the given stream
...
#endif  // SRC_TINT_IR_BUILTINS_BUILTIN_
