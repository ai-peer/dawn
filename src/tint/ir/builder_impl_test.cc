...
using BuilderImplTest = TestHelper;

TEST_F(BuilderImplTest, Func) {
    ...
    ASSERT_EQ(2u, f->control_flow.Length());
...
TEST_F(BuilderImplTest, EntryPoint) {
    Func("f", utils::Empty, ty.void_(), utils::Empty,
    ...
    EXPECT_EQ(0u, m.entry_points[0]);
}

TEST_F(BuilderImplTest, IfStatement) {
...
TEST_F(BuilderImplTest, IfStatement_TrueReturns) {
...
TEST_F(BuilderImplTest, IfStatement_FalseReturns) {
...
TEST_F(BuilderImplTest, IfStatement_BothReturn) {
