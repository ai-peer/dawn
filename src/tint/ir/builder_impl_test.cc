...
TEST_F(IR_BuilderImplTest, IfStatement) {
    ...
    EXPECT_EQ(Disassemble(m), R"(%fn0 = func test_function [compute {1, 1, 1}]
  %fn1 = block
  branch %fn2
...
%1(ref<private, u32, read_write>) = declare private read_write
ret
...
TEST_F(IR_BuilderImplTest, Emit_Var_NoInit) {
    ...
    EXPECT_EQ(Disassemble(m), R"(%fn0 = func test_function [compute {1, 1, 1}]
  %fn1 = block
  %1(ref<function, u32, read_write>) = declare function read_write
  ret
func_end
...
%fn2 = func test_function [compute {1, 1, 1}]
  %fn3 = block
  %1(bool) = call my_func
  %2(bool) = declare function read_write
  store %2(bool), %1(bool)
  branch %fn4
...
%fn2 = func test_function [compute {1, 1, 1}]
  ...
  %3(bool) = declare function read_write
  store %3(bool), %2(bool)
  branch %fn4
...
TEST_F(IR_BuilderImplTest, EmitExpression_ConstructEmpty) {
    ...
    EXPECT_EQ(Disassemble(m), R"(%fn0 = block
%1(ref<private, vec3<f32>, read_write>) = declare private read_write
...
TEST_F(IR_BuilderImplTest, EmitExpression_Construct) {
    ...
    EXPECT_EQ(Disassemble(m), R"(%fn0 = block
%1(ref<private, f32, read_write>) = declare private read_write
store %1(ref<private, f32, read_write>), 1.0f
ret

%fn1 = func test_function [compute {1, 1, 1}]
  %fn2 = block
...
TEST_F(IR_BuilderImplTest, EmitExpression_Convert) {
    ...
    EXPECT_EQ(Disassemble(m), R"(%fn0 = block
%1(ref<private, i32, read_write>) = declare private read_write
...
TEST_F(IR_BuilderImplTest, EmitFunction_Compute) {
    ...
    EXPECT_EQ(Disassemble(m), R"(%fn0 = func test [compute {8, 4, 2}]
  %fn1 = block
  ret
func_end
