...
class BuilderImpl {
  public:
    ...
    BlockFlowNode* CreateBlock();

    /// Creates a function flow node for the given ast::Function
    /// @param func the ast::Function
    /// @returns the flow node
    FunctionFlowNode* CreateFunction(const ast::Function* func);

    /// Creates an if flow node for the given ast::IfStatement
    /// @param stmt the ast::IfStatement
    /// @returns the flow node
    IfFlowNode* CreateIf(const ast::IfStatement* stmt);
  ...
  private:
    ...
    FunctionFlowNode* current_function_ = nullptr;
