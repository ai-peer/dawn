...
class Builder {
  ...
  public:
    ...
    ir::Binary* Binary(enum Binary::Kind kind, type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* And(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Or(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Xor(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Equal(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* NotEqual(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* LessThan(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* GreaterThan(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* LessThanEqual(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* GreaterThanEqual(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* ShiftLeft(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* ShiftRight(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Add(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Subtract(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Multiply(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Divide(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    /// @returns the operation
    template <typename LHS, typename RHS>
    ir::Binary* Modulo(type::Type* type, LHS&& lhs, RHS&& rhs) {
    ...
    ir::Unary* Unary(enum Unary::Kind kind, type::Type* type, VAL&& val) {
    ...
    /// @returns the operation
    template <typename VAL>
    ir::Unary* Complement(type::Type* type, VAL&& val) {
    ...
    /// @returns the operation
    template <typename VAL>
    ir::Unary* Negation(type::Type* type, VAL&& val) {
    ...
    /// @returns the operation
    template <typename VAL>
    ir::Binary* Not(type::Type* type, VAL&& val) {
    ...
    /// @returns the instruction
    template <typename VAL>
    ir::Bitcast* Bitcast(type::Type* type, VAL&& val) {
    ...
    ir::UserCall* Call(type::Type* type, ir::Function* func, ARGS&&... args) {
    ...
    /// @returns the instruction
    template <typename... ARGS>
    ir::BuiltinCall* Call(type::Type* type, builtin::Function func, ARGS&&... args) {
    ...
    /// @returns the instruction
    template <typename VAL>
    ir::Convert* Convert(type::Type* to, VAL&& val) {
    ...
    /// @returns the instruction
    template <typename... ARGS>
    ir::Construct* Construct(type::Type* type, ARGS&&... args) {
    ...
    /// @returns the value
    ir::BlockParam* BlockParam(type::Type* type);

    /// Creates a new `FunctionParam`
    /// @param type the parameter type
    /// @returns the value
    ir::FunctionParam* FunctionParam(type::Type* type);
    ...
    ir::Access* Access(type::Type* type, OBJ&& object, ARGS&&... indices) {
    ...
    ir::Swizzle* Swizzle(type::Type* type, OBJ&& object, utils::VectorRef<uint32_t> indices) {
    ...
    /// @returns the instruction
    template <typename OBJ>
    ir::Swizzle* Swizzle(type::Type* type, OBJ&& object, std::initializer_list<uint32_t> indices) {
    ...
    /// @param type the return type
    /// @returns the value
    ir::InstructionResult* InstructionResult(type::Type* type) {
