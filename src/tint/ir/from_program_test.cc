...
TEST_F(IR_FromProgramTest, IfStatement) {
    ...
    EXPECT_EQ(2u, if_->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, IfStatement_TrueReturns) {
    ...
    EXPECT_EQ(1u, if_->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, IfStatement_BothReturn) {
    ...
    EXPECT_EQ(0u, if_->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, Loop_WithBreak) {
    ...
    EXPECT_EQ(0u, loop->Body()->InboundBranches().Length());
    EXPECT_EQ(0u, loop->Continuing()->InboundBranches().Length());
    EXPECT_EQ(1u, loop->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, Loop_WithContinue) {
    ...
    EXPECT_EQ(1u, loop->Body()->InboundBranches().Length());
    EXPECT_EQ(1u, loop->Continuing()->InboundBranches().Length());
    EXPECT_EQ(1u, loop->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, Loop_WithReturn) {
    ...
    EXPECT_EQ(1u, loop->Body()->InboundBranches().Length());
    EXPECT_EQ(1u, loop->Continuing()->InboundBranches().Length());
    EXPECT_EQ(0u, loop->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, Loop_WithIf_BothBranchesBreak) {
    ...
    EXPECT_EQ(0u, loop->Body()->InboundBranches().Length());
    EXPECT_EQ(0u, loop->Continuing()->InboundBranches().Length());
    EXPECT_EQ(2u, loop->Merge()->InboundBranches().Length());
...
TEST_F(IR_FromProgramTest, DISABLED_For) {
    ...
    EXPECT_EQ(2u, loop->Body()->InboundBranches().Length());
    EXPECT_EQ(1u, loop->Continuing()->InboundBranches().Length());
    EXPECT_EQ(2u, loop->Merge()->InboundBranches().Length());
