...
TEST_F(IR_BuilderImplTest, EmitFunction_Vertex) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%1 = func test():vec4<f32> [@vertex ra: @position] -> %fn1 {
  %fn1 = block {
...
TEST_F(IR_BuilderImplTest, EmitFunction_Fragment) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%1 = func test():void [@fragment] -> %fn1 {
  %fn1 = block {
    br %fn2  # return
  }
  %fn2 = func_terminator
...
TEST_F(IR_BuilderImplTest, EmitFunction_Compute) {
    ...
    EXPECT_EQ(Disassemble(m.Get()),
              R"(%1 = func test():void [@compute @workgroup_size(8, 4, 2)] -> %fn1 {
  %fn1 = block {
    br %fn2  # return
  }
  %fn2 = func_terminator
...
TEST_F(IR_BuilderImplTest, EmitFunction_Return) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%1 = func test():vec3<f32> -> %fn1 {
  %fn1 = block {
...
TEST_F(IR_BuilderImplTest, EmitFunction_ReturnPositionInvariant) {
    ...
    EXPECT_EQ(Disassemble(m.Get()),
              R"(%1 = func test():vec4<f32> [@vertex ra: @position @invariant] -> %fn1 {
  %fn1 = block {
    br %fn2 vec4<f32> 1.0f, 2.0f, 3.0f, 4.0f  # return
  }
  %fn2 = func_terminator
...
TEST_F(IR_BuilderImplTest, EmitFunction_ReturnLocation) {
    ...
    EXPECT_EQ(Disassemble(m.Get()),
              R"(%1 = func test():vec4<f32> [@fragment ra: @location(1)] -> %fn1 {
  %fn1 = block {
    br %fn2 vec4<f32> 1.0f, 2.0f, 3.0f, 4.0f  # return
  }
  %fn2 = func_terminator
...
TEST_F(IR_BuilderImplTest, EmitFunction_ReturnFragDepth) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%1 = func test():f32 [@fragment ra: @frag_depth] -> %fn1 {
  %fn1 = block {
    br %fn2 1.0f  # return
  }
  %fn2 = func_terminator
...
TEST_F(IR_BuilderImplTest, EmitFunction_ReturnSampleMask) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%1 = func test():u32 [@fragment ra: @sample_mask] -> %fn1 {
  %fn1 = block {
    br %fn2 1u  # return
  }
  %fn2 = func_terminator
