...
TEST_F(IR_InstructionTest, CreateLoad) {
    ...
    auto* var =
        b.Declare(b.ir.types.Get<type::Pointer>(store_type, builtin::AddressSpace::kFunction,
                                                builtin::Access::kReadWrite),
                  builtin::AddressSpace::kFunction, builtin::Access::kReadWrite);
    const auto* inst = b.Load(store_type, var);
