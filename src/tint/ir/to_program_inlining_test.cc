...
// Access
////////////////////////////////////////////////////////////////////////////////
TEST_F(IRToProgramInliningTest, Access_ArrayOrArrayOfArray_XYZ) {
    auto* fn_a = b.Function("a", ty.i32());
    b.With(fn_a->Block(), [&] { b.Return(fn_a, 1_i); });
    fn_a->SetParams({b.FunctionParam(ty.i32())});
...
TEST_F(IRToProgramInliningTest, Access_ArrayOrArrayOfArray_YXZ) {
    auto* fn_a = b.Function("a", ty.i32());
    b.With(fn_a->Block(), [&] { b.Return(fn_a, 1_i); });
    fn_a->SetParams({b.FunctionParam(ty.i32())});
...
TEST_F(IRToProgramInliningTest, Access_ArrayOrArrayOfArray_ZXY) {
    auto* fn_a = b.Function("a", ty.i32());
    b.With(fn_a->Block(), [&] { b.Return(fn_a, 1_i); });
    fn_a->SetParams({b.FunctionParam(ty.i32())});
...
TEST_F(IRToProgramInliningTest, Access_ArrayOrArrayOfArray_ZYX) {
    auto* fn_a = b.Function("a", ty.i32());
    b.With(fn_a->Block(), [&] { b.Return(fn_a, 1_i); });
    fn_a->SetParams({b.FunctionParam(ty.i32())});
