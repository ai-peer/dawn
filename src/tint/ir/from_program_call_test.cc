...
%i:ref<private, i32, read_write> = var 1i, private, read_write
...
TEST_F(IR_BuilderImplTest, EmitExpression_ConstructEmpty) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%fn1 = block
%i:ref<private, vec3<f32>, read_write> = var vec3<f32> 0.0f, private, read_write
...
TEST_F(IR_BuilderImplTest, EmitExpression_Construct) {
    ...
    EXPECT_EQ(Disassemble(m.Get()), R"(%fn1 = block
%i:ref<private, f32, read_write> = var 1.0f, private, read_write
