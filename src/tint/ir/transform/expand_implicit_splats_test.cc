...
TEST_F(IR_ExpandImplicitSplatsTest, Mix_VectorOperands_ScalarFactor) {
    ...
    auto* src = R"(
%foo = func(%arg1:vec4<f32>, %arg2:vec4<f32>, %factor:bool):vec4<f32> -> %b1 {
  %b1 = block {
    %5:vec4<f32> = select %arg1, %arg2, %factor
    ret %5
  }
}
)";
...
%foo = func(%arg1:vec4<f32>, %arg2:vec4<f32>, %factor:bool):vec4<f32> -> %b1 {
  %b1 = block {
    %5:vec4<bool> = construct %factor, %factor, %factor, %factor
    %6:vec4<f32> = spirv.select %5, %arg2, %arg1
    ret %6
  }
}
)";
