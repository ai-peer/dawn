...
/// Materialize is a semantic expression which represents the materialization of an abstract numeric
/// to a concrete type.
/// Abstract numeric materialization is implcit in WGSL, and so there is no AST node that this
/// semantic node refers to.
