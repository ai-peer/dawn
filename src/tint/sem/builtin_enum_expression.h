...
class BuiltinEnumExpression : public Castable<BuiltinEnumExpression<ENUM>, Expression> {
  public:
    /// Constructor
    ...
    BuiltinEnumExpression(const ast::Expression* declaration,
                          ...
                          ENUM value)
        : Castable<BuiltinEnumExpression<ENUM>, Expression>::Base(declaration, statement),
          value_(value) {}
