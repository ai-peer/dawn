...
type::DiagnosticSeverity Info::DiagnosticSeverity(const ast::Node* ast_node,
                                                  type::DiagnosticRule rule) const {
    ...
    TINT_ASSERT(Resolver, severity != type::DiagnosticSeverity::kUndefined);
    return severity;
}
