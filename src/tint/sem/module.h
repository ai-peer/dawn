...
class Module final : public Castable<Module, Node> {
  public:
    ...
    Module(utils::VectorRef<const ast::Node*> dep_ordered_decls, type::Extensions extensions);
    ...
    const type::Extensions& Extensions() const { return extensions_; }
