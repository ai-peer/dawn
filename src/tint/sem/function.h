...
class Function final : public Castable<Function, CallTarget> {
  public:
    ...
    const auto& DirectlyReferencedGlobals() const { return directly_referenced_globals_; }
    ...
    const auto& TransitivelyReferencedGlobals() const { return transitively_referenced_globals_; }
    ...
    const auto& TransitivelyCalledFunctions() const { return transitively_called_functions_; }
    ...
    const auto& DirectlyCalledBuiltins() const { return directly_called_builtins_; }
    ...
    const auto& TextureSamplerPairs() const { return texture_sampler_pairs_; }
