...
/// A Constant holds a compile-time evaluated expression value.
class Constant {
  public:
    /// Constructor
    Constant();
    ...
    /// @returns true if child elements of this constant are zero valued.
    virtual bool AllZero() const = 0;

    /// @returns true if any child elements of this constant are zero valued.
