...
CallTarget::CallTarget(const sem::Type* return_type, utils::ListRef<const Parameter*> parameters)
    : signature_{return_type, std::move(parameters)} {
...
CallTargetSignature::CallTargetSignature(const sem::Type* ret_ty,
                                         utils::ListRef<const Parameter*> params)
