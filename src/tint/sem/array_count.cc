...
ArrayCount::ArrayCount() : Base(TypeFlags{}) {}
...
bool ConstantArrayCount::Equals(const Type& other) const {
...
bool NamedOverrideArrayCount::Equals(const Type& other) const {
...
std::string NamedOverrideArrayCount::FriendlyName(const SymbolTable&) const {
    return "named-override-array-count";
}
...
bool UnnamedOverrideArrayCount::Equals(const Type& other) const {
...
std::string UnnamedOverrideArrayCount::FriendlyName(const SymbolTable&) const {
    return "unnamed-override-array-count";
}
