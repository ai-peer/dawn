...
BuiltinValue ParseBuiltinValue(std::string_view str) {
    ...
    switch (((u64 * 537) % 83591) % 11) {
        case 0:
            return (str == "sample_index") ? BuiltinValue::kSampleIndex : BuiltinValue::kUndefined;
        case 1:
            return (str == "workgroup_id") ? BuiltinValue::kWorkgroupId : BuiltinValue::kUndefined;
        case 2:
            ...
            break;
        case 3:
            return (str == "vertex_index") ? BuiltinValue::kVertexIndex : BuiltinValue::kUndefined;
        case 4:
            return (str == "global_invocation_id") ? BuiltinValue::kGlobalInvocationId
                                                   : BuiltinValue::kUndefined;
        case 5:
            return (str == "sample_mask") ? BuiltinValue::kSampleMask : BuiltinValue::kUndefined;
        case 6:
        ...
        case 7:
            return (str == "instance_index") ? BuiltinValue::kInstanceIndex
                                             : BuiltinValue::kUndefined;
        case 8:
            return (str == "front_facing") ? BuiltinValue::kFrontFacing : BuiltinValue::kUndefined;
        case 9:
            return (str == "frag_depth") ? BuiltinValue::kFragDepth : BuiltinValue::kUndefined;
        case 10:
            return (str == "position") ? BuiltinValue::kPosition : BuiltinValue::kUndefined;
    }
