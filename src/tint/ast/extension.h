...
/// @return the Extension enum value for the extension of given name, or
/// kNone if no known extension has the given name
Extension ParseExtension(const std::string& name);

/// Convert the Extension enum value to corresponding extension name string. If the given enum value
/// is kNone or don't have a known name, return an empty string instead.
