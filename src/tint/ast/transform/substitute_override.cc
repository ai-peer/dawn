...
Transform::ApplyResult SubstituteOverride::Apply(const Program* src,
    ...
    ctx.ReplaceAll([&](const Override* w) -> const Const* {
        ...
        auto* ctor = Switch(
            sem->Type(), [&](type::Bool*) { return b.Expr(!std::equal_to<double>()(value, 0.0)); },
            [&](type::I32*) { return b.Expr(i32(value)); },
            [&](type::U32*) { return b.Expr(u32(value)); },
            [&](type::F32*) { return b.Expr(f32(value)); },
            [&](type::F16*) { return b.Expr(f16(value)); });
