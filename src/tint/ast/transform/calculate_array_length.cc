...
Transform::ApplyResult CalculateArrayLength::Apply(const Program* src,
    ...
    std::unordered_map<type::Reference*, Symbol> buffer_size_intrinsics;
    auto get_buffer_size_intrinsic = [&](type::Reference* buffer_type) {
