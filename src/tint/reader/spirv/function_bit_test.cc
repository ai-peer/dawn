...
TEST_F(SpvUnaryBitTest, InsertBits_Uint_UnsignedOffsetAndCount) {
    const auto assembly = BitTestPreamble() + R"(
...
TEST_F(SpvUnaryBitTest, InsertBits_UintVector_UnsignedOffsetAndCount) {
    const auto assembly = BitTestPreamble() + R"(
...
TEST_F(SpvUnaryBitTest, ExtractBits_Int_UnsignedOffsetAndCount) {
    const auto assembly = BitTestPreamble() + R"(
...
TEST_F(SpvUnaryBitTest, ExtractBits_IntVector_UnsignedOffsetAndCount) {
    const auto assembly = BitTestPreamble() + R"(
...
TEST_F(SpvUnaryBitTest, ExtractBits_Uint_UnsignedOffsetAndCount) {
    const auto assembly = BitTestPreamble() + R"(
...
TEST_F(SpvUnaryBitTest, ExtractBits_UintVector_UnsignedOffsetAndCount) {
    const auto assembly = BitTestPreamble() + R"(
