...
TEST_F(SpvParserTest, GlslStd450_MatrixInverse_mat3x3) {
    ...
    std::string expected =
        ...
        "let x_1 : mat3x3<f32> = mat3x3<f32>(vec3<f32>((s * ((m3x3f1[1u][1u] * m3x3f1[2u][2u]) - "
        "(m3x3f1[1u][2u] * m3x3f1[2u][1u]))), (s * ((m3x3f1[0u][2u] * m3x3f1[2u][1u]) - "
        "(m3x3f1[0u][1u] * m3x3f1[2u][2u]))), (s * ((m3x3f1[0u][1u] * m3x3f1[1u][2u]) - "
        "(m3x3f1[0u][2u] * m3x3f1[1u][1u])))), vec3<f32>((s * ((m3x3f1[1u][2u] * m3x3f1[2u][0u]) - "
        "(m3x3f1[1u][0u] * m3x3f1[2u][2u]))), (s * ((m3x3f1[0u][0u] * m3x3f1[2u][2u]) - "
        "(m3x3f1[0u][2u] * m3x3f1[2u][0u]))), (s * ((m3x3f1[0u][2u] * m3x3f1[1u][0u]) - "
        "(m3x3f1[0u][0u] * m3x3f1[1u][2u])))), vec3<f32>((s * ((m3x3f1[1u][0u] * m3x3f1[2u][1u]) - "
        "(m3x3f1[1u][1u] * m3x3f1[2u][0u]))), (s * ((m3x3f1[0u][1u] * m3x3f1[2u][0u]) - "
        "(m3x3f1[0u][0u] * m3x3f1[2u][1u]))), (s * ((m3x3f1[0u][0u] * m3x3f1[1u][1u]) - "
        "(m3x3f1[0u][1u] * m3x3f1[1u][0u])))));";
...
TEST_F(SpvParserTest, GlslStd450_MatrixInverse_mat4x4) {
    ...
    std::string expected =
        ...
        "let x_1 : mat4x4<f32> = mat4x4<f32>(vec4<f32>((s * "
        "(((m4x4f1[1u][1u] * ((m4x4f1[2u][2u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * "
        "m4x4f1[3u][2u]))) - (m4x4f1[1u][2u] * ((m4x4f1[2u][1u] * m4x4f1[3u][3u]) - "
        "(m4x4f1[2u][3u] * m4x4f1[3u][1u])))) + (m4x4f1[1u][3u] * ((m4x4f1[2u][1u] * "
        "m4x4f1[3u][2u]) - (m4x4f1[2u][2u] * m4x4f1[3u][1u]))))), (s * (((-(m4x4f1[0u][1u]) * "
        "((m4x4f1[2u][2u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * m4x4f1[3u][2u]))) + "
        "(m4x4f1[0u][2u] * ((m4x4f1[2u][1u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * "
        "m4x4f1[3u][1u])))) - (m4x4f1[0u][3u] * ((m4x4f1[2u][1u] * m4x4f1[3u][2u]) - "
        "(m4x4f1[2u][2u] * m4x4f1[3u][1u]))))), (s * (((m4x4f1[0u][1u] * ((m4x4f1[1u][2u] * "
        "m4x4f1[3u][3u]) - (m4x4f1[1u][3u] * m4x4f1[3u][2u]))) - (m4x4f1[0u][2u] * "
        "((m4x4f1[1u][1u] * m4x4f1[3u][3u]) - (m4x4f1[1u][3u] * m4x4f1[3u][1u])))) + "
        "(m4x4f1[0u][3u] * ((m4x4f1[1u][1u] * m4x4f1[3u][2u]) - (m4x4f1[1u][2u] * "
        "m4x4f1[3u][1u]))))), (s * (((-(m4x4f1[0u][1u]) * ((m4x4f1[1u][2u] * m4x4f1[2u][3u]) - "
        "(m4x4f1[1u][3u] * m4x4f1[2u][2u]))) + (m4x4f1[0u][2u] * ((m4x4f1[1u][1u] * "
        "m4x4f1[2u][3u]) - (m4x4f1[1u][3u] * m4x4f1[2u][1u])))) - (m4x4f1[0u][3u] * "
        "((m4x4f1[1u][1u] * m4x4f1[2u][2u]) - (m4x4f1[1u][2u] * m4x4f1[2u][1u])))))), vec4<f32>((s "
        "* (((-(m4x4f1[1u][0u]) * ((m4x4f1[2u][2u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * "
        "m4x4f1[3u][2u]))) + (m4x4f1[1u][2u] * ((m4x4f1[2u][0u] * m4x4f1[3u][3u]) - "
        "(m4x4f1[2u][3u] * m4x4f1[3u][0u])))) - (m4x4f1[1u][3u] * ((m4x4f1[2u][0u] * "
        "m4x4f1[3u][2u]) - (m4x4f1[2u][2u] * m4x4f1[3u][0u]))))), (s * (((m4x4f1[0u][0u] * "
        "((m4x4f1[2u][2u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * m4x4f1[3u][2u]))) - "
        "(m4x4f1[0u][2u] * ((m4x4f1[2u][0u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * "
        "m4x4f1[3u][0u])))) + (m4x4f1[0u][3u] * ((m4x4f1[2u][0u] * m4x4f1[3u][2u]) - "
        "(m4x4f1[2u][2u] * m4x4f1[3u][0u]))))), (s * (((-(m4x4f1[0u][0u]) * ((m4x4f1[1u][2u] * "
        "m4x4f1[3u][3u]) - (m4x4f1[1u][3u] * m4x4f1[3u][2u]))) + (m4x4f1[0u][2u] * "
        "((m4x4f1[1u][0u] * m4x4f1[3u][3u]) - (m4x4f1[1u][3u] * m4x4f1[3u][0u])))) - "
        "(m4x4f1[0u][3u] * ((m4x4f1[1u][0u] * m4x4f1[3u][2u]) - (m4x4f1[1u][2u] * "
        "m4x4f1[3u][0u]))))), (s * (((m4x4f1[0u][0u] * ((m4x4f1[1u][2u] * m4x4f1[2u][3u]) - "
        "(m4x4f1[1u][3u] * m4x4f1[2u][2u]))) - (m4x4f1[0u][2u] * ((m4x4f1[1u][0u] * "
        "m4x4f1[2u][3u]) - (m4x4f1[1u][3u] * m4x4f1[2u][0u])))) + (m4x4f1[0u][3u] * "
        "((m4x4f1[1u][0u] * m4x4f1[2u][2u]) - (m4x4f1[1u][2u] * m4x4f1[2u][0u])))))), vec4<f32>((s "
        "* (((m4x4f1[1u][0u] * ((m4x4f1[2u][1u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * "
        "m4x4f1[3u][1u]))) - (m4x4f1[1u][1u] * ((m4x4f1[2u][0u] * m4x4f1[3u][3u]) - "
        "(m4x4f1[2u][3u] * m4x4f1[3u][0u])))) + (m4x4f1[1u][3u] * ((m4x4f1[2u][0u] * "
        "m4x4f1[3u][1u]) - (m4x4f1[2u][1u] * m4x4f1[3u][0u]))))), (s * (((-(m4x4f1[0u][0u]) * "
        "((m4x4f1[2u][1u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * m4x4f1[3u][1u]))) + "
        "(m4x4f1[0u][1u] * ((m4x4f1[2u][0u] * m4x4f1[3u][3u]) - (m4x4f1[2u][3u] * "
        "m4x4f1[3u][0u])))) - (m4x4f1[0u][3u] * ((m4x4f1[2u][0u] * m4x4f1[3u][1u]) - "
        "(m4x4f1[2u][1u] * m4x4f1[3u][0u]))))), (s * (((m4x4f1[0u][0u] * ((m4x4f1[1u][1u] * "
        "m4x4f1[3u][3u]) - (m4x4f1[1u][3u] * m4x4f1[3u][1u]))) - (m4x4f1[0u][1u] * "
        "((m4x4f1[1u][0u] * m4x4f1[3u][3u]) - (m4x4f1[1u][3u] * m4x4f1[3u][0u])))) + "
        "(m4x4f1[0u][3u] * ((m4x4f1[1u][0u] * m4x4f1[3u][1u]) - (m4x4f1[1u][1u] * "
        "m4x4f1[3u][0u]))))), (s * (((-(m4x4f1[0u][0u]) * ((m4x4f1[1u][1u] * m4x4f1[2u][3u]) - "
        "(m4x4f1[1u][3u] * m4x4f1[2u][1u]))) + (m4x4f1[0u][1u] * ((m4x4f1[1u][0u] * "
        "m4x4f1[2u][3u]) - (m4x4f1[1u][3u] * m4x4f1[2u][0u])))) - (m4x4f1[0u][3u] * "
        "((m4x4f1[1u][0u] * m4x4f1[2u][1u]) - (m4x4f1[1u][1u] * m4x4f1[2u][0u])))))), vec4<f32>((s "
        "* (((-(m4x4f1[1u][0u]) * ((m4x4f1[2u][1u] * m4x4f1[3u][2u]) - (m4x4f1[2u][2u] * "
        "m4x4f1[3u][1u]))) + (m4x4f1[1u][1u] * ((m4x4f1[2u][0u] * m4x4f1[3u][2u]) - "
        "(m4x4f1[2u][2u] * m4x4f1[3u][0u])))) - (m4x4f1[1u][2u] * ((m4x4f1[2u][0u] * "
        "m4x4f1[3u][1u]) - (m4x4f1[2u][1u] * m4x4f1[3u][0u]))))), (s * (((m4x4f1[0u][0u] * "
        "((m4x4f1[2u][1u] * m4x4f1[3u][2u]) - (m4x4f1[2u][2u] * m4x4f1[3u][1u]))) - "
        "(m4x4f1[0u][1u] * ((m4x4f1[2u][0u] * m4x4f1[3u][2u]) - (m4x4f1[2u][2u] * "
        "m4x4f1[3u][0u])))) + (m4x4f1[0u][2u] * ((m4x4f1[2u][0u] * m4x4f1[3u][1u]) - "
        "(m4x4f1[2u][1u] * m4x4f1[3u][0u]))))), (s * (((-(m4x4f1[0u][0u]) * ((m4x4f1[1u][1u] * "
        "m4x4f1[3u][2u]) - (m4x4f1[1u][2u] * m4x4f1[3u][1u]))) + (m4x4f1[0u][1u] * "
        "((m4x4f1[1u][0u] * m4x4f1[3u][2u]) - (m4x4f1[1u][2u] * m4x4f1[3u][0u])))) - "
        "(m4x4f1[0u][2u] * ((m4x4f1[1u][0u] * m4x4f1[3u][1u]) - (m4x4f1[1u][1u] * "
        "m4x4f1[3u][0u]))))), (s * (((m4x4f1[0u][0u] * ((m4x4f1[1u][1u] * m4x4f1[2u][2u]) - "
        "(m4x4f1[1u][2u] * m4x4f1[2u][1u]))) - (m4x4f1[0u][1u] * ((m4x4f1[1u][0u] * "
        "m4x4f1[2u][2u]) - (m4x4f1[1u][2u] * m4x4f1[2u][0u])))) + (m4x4f1[0u][2u] * "
        "((m4x4f1[1u][0u] * m4x4f1[2u][1u]) - (m4x4f1[1u][1u] * m4x4f1[2u][0u])))))));";
