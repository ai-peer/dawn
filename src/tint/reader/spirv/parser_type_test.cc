...
TEST(SpvParserTypeTest, SameArgumentsGivesSamePointer) {
    ...
    EXPECT_EQ(ty.Pointer(ty.I32(), builtin::AddressSpace::kNone),
              ty.Pointer(ty.I32(), builtin::AddressSpace::kNone));
...
TEST(SpvParserTypeTest, DifferentArgumentsGivesDifferentPointer) {
    ...
    TypeManager ty;
    EXPECT_NE(ty.Pointer(ty.I32(), builtin::AddressSpace::kNone),
              ty.Pointer(ty.U32(), builtin::AddressSpace::kNone));
    EXPECT_NE(ty.Pointer(ty.I32(), builtin::AddressSpace::kNone),
