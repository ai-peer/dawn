...
type::BuiltinValue EnumConverter::ToBuiltin(spv::BuiltIn b) {
    switch (b) {
        case spv::BuiltIn::Position:
            return type::BuiltinValue::kPosition;
        case spv::BuiltIn::VertexIndex:
            return type::BuiltinValue::kVertexIndex;
        case spv::BuiltIn::InstanceIndex:
            return type::BuiltinValue::kInstanceIndex;
        case spv::BuiltIn::FrontFacing:
            return type::BuiltinValue::kFrontFacing;
        case spv::BuiltIn::FragCoord:
            return type::BuiltinValue::kPosition;
        case spv::BuiltIn::FragDepth:
            return type::BuiltinValue::kFragDepth;
        case spv::BuiltIn::LocalInvocationId:
            return type::BuiltinValue::kLocalInvocationId;
        case spv::BuiltIn::LocalInvocationIndex:
            return type::BuiltinValue::kLocalInvocationIndex;
        case spv::BuiltIn::GlobalInvocationId:
            return type::BuiltinValue::kGlobalInvocationId;
        case spv::BuiltIn::NumWorkgroups:
            return type::BuiltinValue::kNumWorkgroups;
        case spv::BuiltIn::WorkgroupId:
            return type::BuiltinValue::kWorkgroupId;
        case spv::BuiltIn::SampleId:
            return type::BuiltinValue::kSampleIndex;
        case spv::BuiltIn::SampleMask:
            return type::BuiltinValue::kSampleMask;
        default:
            break;
    }

    Fail() << "unknown SPIR-V builtin: " << uint32_t(b);
    return type::BuiltinValue::kUndefined;
}
