...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Bool) {
    ...
    EXPECT_EQ(p->builder().Symbols().NameFor(t.value->As<ast::TypeName>()->name), "bool");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_F16) {
    ...
    ASSERT_NE(t.value, nullptr) << p->error();
    ASSERT_TRUE(t.value->Is<ast::TypeName>());
    EXPECT_EQ(p->builder().Symbols().NameFor(t.value->As<ast::TypeName>()->name), "f16");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_F32) {
    ...
    ASSERT_NE(t.value, nullptr) << p->error();
    ASSERT_TRUE(t.value->Is<ast::TypeName>());
    EXPECT_EQ(p->builder().Symbols().NameFor(t.value->As<ast::TypeName>()->name), "f32");
    EXPECT_EQ(t.value->source.range, (Source::Range{{1u, 1u}, {1u, 4u}}));
}
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_I32) {
    ...
    ASSERT_NE(t.value, nullptr) << p->error();
    ASSERT_TRUE(t.value->Is<ast::TypeName>());
    EXPECT_EQ(p->builder().Symbols().NameFor(t.value->As<ast::TypeName>()->name), "i32");
    EXPECT_EQ(t.value->source.range, (Source::Range{{1u, 1u}, {1u, 4u}}));
}
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_U32) {
    ...
    ASSERT_NE(t.value, nullptr) << p->error();
    ASSERT_TRUE(t.value->Is<ast::TypeName>());
    EXPECT_EQ(p->builder().Symbols().NameFor(t.value->As<ast::TypeName>()->name), "u32");
    EXPECT_EQ(t.value->source.range, (Source::Range{{1u, 1u}, {1u, 4u}}));
}
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Ptr) {
    ...
    EXPECT_EQ(p->builder().Symbols().NameFor(ptr->type->As<ast::TypeName>()->name), "f32");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Ptr_ToVec) {
    ...
    EXPECT_EQ(p->builder().Symbols().NameFor(vec->type->As<ast::TypeName>()->name), "f32");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Atomic) {
    ...
    EXPECT_EQ(p->builder().Symbols().NameFor(atomic->type->As<ast::TypeName>()->name), "f32");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Array_AbstractIntLiteralSize) {
    ...
    EXPECT_EQ(p->builder().Symbols().NameFor(a->type->As<ast::TypeName>()->name), "f32");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Array_Runtime) {
    ...
    ASSERT_TRUE(a->type->Is<ast::TypeName>());
    EXPECT_EQ(p->builder().Symbols().NameFor(a->type->As<ast::TypeName>()->name), "u32");
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Array_Runtime_Vec) {
    ...
    EXPECT_EQ(
        p->builder().Symbols().NameFor(a->type->As<ast::Vector>()->type->As<ast::TypeName>()->name),
        "u32");
    EXPECT_EQ(t.value->source.range, (Source::Range{{1u, 1u}, {1u, 17u}}));
}
...
TEST_F(ParserImplTest, TypeDeclWithoutIdent_Texture) {
    ...
    EXPECT_EQ(p->builder().Symbols().NameFor(
                  t.value->As<ast::SampledTexture>()->type->As<ast::TypeName>()->name),
              "f32");
    EXPECT_EQ(t.value->source.range, (Source::Range{{1u, 1u}, {1u, 18u}}));
}
