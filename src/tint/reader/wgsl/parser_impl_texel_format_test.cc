...
TEST_F(ParserImplTest, TexelFormat_R32Uint) {
    ...
    EXPECT_EQ(t.value, builtin::TexelFormat::kR32Uint);
...
TEST_F(ParserImplTest, TexelFormat_R32Sint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kR32Sint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_R32Float) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kR32Float);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba8Unorm) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba8Unorm);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba8Snorm) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba8Snorm);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba8Uint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba8Uint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba8Sint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba8Sint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rg32Uint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRg32Uint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rg32Sint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRg32Sint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rg32Float) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRg32Float);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba16Uint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba16Uint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba16Sint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba16Sint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba16Float) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba16Float);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba32Uint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba32Uint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba32Sint) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba32Sint);
    EXPECT_FALSE(p->has_error());
}
...
TEST_F(ParserImplTest, TexelFormat_Rgba32Float) {
    ...
    auto t = p->expect_texel_format("test");
    EXPECT_FALSE(t.errored);
    EXPECT_EQ(t.value, builtin::TexelFormat::kRgba32Float);
    EXPECT_FALSE(p->has_error());
}
