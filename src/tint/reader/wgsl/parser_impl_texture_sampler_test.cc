...
TEST_F(ParserImplTest, TextureSamplerTypes_SampledTexture_F32) {
    ...
    EXPECT_EQ(Symbols().NameFor(t->As<ast::SampledTexture>()->type->As<ast::TypeName>()->name),
              "f32");
...
TEST_F(ParserImplTest, TextureSamplerTypes_MultisampledTexture_I32) {
    ...
    EXPECT_EQ(Symbols().NameFor(t->As<ast::MultisampledTexture>()->type->As<ast::TypeName>()->name),
              "i32");
    EXPECT_EQ(t->As<ast::Texture>()->dim, ast::TextureDimension::k2d);
