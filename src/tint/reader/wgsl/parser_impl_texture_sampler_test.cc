...
TEST_F(ParserImplTest, TextureSamplerTypes_Sampler) {
    ...
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 8u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_SamplerComparison) {
    ...
    EXPECT_TRUE(t.matched);
    EXPECT_FALSE(t.errored);
    CheckIdentifier(p->builder().Symbols(), t.value, "sampler_comparison");
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 19u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_DepthTexture) {
    ...
    EXPECT_FALSE(t.errored);
    ASSERT_NE(t.value, nullptr);
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_depth_2d");
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 17u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_SampledTexture_F32) {
    ...
    EXPECT_FALSE(t.errored);
    ASSERT_NE(t.value, nullptr);
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_1d", "f32");
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 16u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_SampledTexture_I32) {
    ...
    EXPECT_FALSE(t.errored);
    ASSERT_NE(t.value, nullptr);
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_1d", "i32");
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 16u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_SampledTexture_U32) {
    ...
    EXPECT_FALSE(t.errored);
    ASSERT_NE(t.value, nullptr);
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_3d", "u32");
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 16u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_MultisampledTexture_I32) {
    ...
    EXPECT_FALSE(t.errored);
    ASSERT_NE(t.value, nullptr);
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_multisampled_2d", "i32");
    EXPECT_EQ(t->source.range, (Source::Range{{1u, 1u}, {1u, 29u}}));
}
...
TEST_F(ParserImplTest, TextureSamplerTypes_StorageTexture_Readonly1dRg32Float) {
    ...
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_storage_1d", "rg32float", "read");
...
TEST_F(ParserImplTest, TextureSamplerTypes_StorageTexture_Writeonly2dR32Uint) {
    ...
    CheckIdentifier(p->builder().Symbols(), t.value, "texture_storage_2d", "r32uint", "write");
