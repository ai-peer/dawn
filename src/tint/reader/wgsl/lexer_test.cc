...
INSTANTIATE_TEST_SUITE_P(LexerTest,
                         ...
                         testing::Values(
                             ...
                             FloatData{"5.7h", static_cast<double>(f16::Quantize(5.7))},
                             FloatData{"5.h", static_cast<double>(f16::Quantize(5.))},
                             FloatData{".7h", static_cast<double>(f16::Quantize(.7))},
                             FloatData{"-5.7h", static_cast<double>(f16::Quantize(-5.7))},
                             FloatData{"-5.h", static_cast<double>(f16::Quantize(-5.))},
                             FloatData{"-.7h", static_cast<double>(f16::Quantize(-.7))},
                             ...
                             FloatData{"6e4h", static_cast<double>(f16::Quantize(6e4))},
                             FloatData{"6E4h", static_cast<double>(f16::Quantize(6e4))},
                             FloatData{"1e-5h", static_cast<double>(f16::Quantize(1e-5))},
                             FloatData{"1E-5h", static_cast<double>(f16::Quantize(1e-5))},
                             ...
                             FloatData{"0.2e+5h", static_cast<double>(f16::Quantize(0.2e5))},
                             FloatData{"1.2e-5h", static_cast<double>(f16::Quantize(1.2e-5))},
                             FloatData{"6.55e4h", static_cast<double>(f16::Quantize(6.55e4))},
                             FloatData{"2.5e+0h", static_cast<double>(f16::Quantize(2.5))},
                             FloatData{"2.5e-0h", static_cast<double>(f16::Quantize(2.5))},
                             // Quantization
