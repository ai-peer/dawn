...
ast::Builtin ident_to_builtin(std::string_view str) {
    ...
    if (str[0] == 'w' && str[1] == '0' && str == "workgroup_id") {
...
bool is_reserved(const Token& t) {
    ...
    if (str[0] == 'u') {
        ...
        return (str[1] == 'u' && str == "unless") || (str[1] == 's' && str == "using");
    }
    if (str[0] == 'v') {
...
Expect<ast::TexelFormat> ParserImpl::expect_texel_format(std::string_view use) {
    ...
    if (s[4] == '1') {
        ...
        if (s[6] == 'u') {
            if (s[7] == 'i' && t == "rgba16uint") {
                return ast::TexelFormat::kRgba16Uint;
            }
            return err();
        }
        if (s[6] == 's') {
            if (s[7] == 'i' && t == "rgba16sint") {
                return ast::TexelFormat::kRgba16Sint;
            }
            return err();
        }
        if (s[6] == 'f' && s[7] == 'l' && t == "rgba16float") {
    ...
    if (s[4] == '3') {
        ...
        if (s[6] == 'u') {
            if (s[7] == 'i' && t == "rgba32uint") {
                return ast::TexelFormat::kRgba32Uint;
            }
            return err();
        }
        if (s[6] == 's') {
            if (s[7] == 'i' && t == "rgba32sint") {
                return ast::TexelFormat::kRgba32Sint;
            }
            return err();
        }
        if (s[6] == 'f' && s[7] == 'l' && t == "rgba32float") {
...
Expect<ast::StorageClass> ParserImpl::expect_storage_class(std::string_view use) {
    ...
    auto err = [&]() { return add_error(source, "invalid storage class", use); };
