...
bool is_reserved(const Token& t) {
    return t == "CompileShader" || t == "ComputeShader" || t == "DomainShader" ||
           ...
           t == "throw" || t == "trait" || t == "try" || t == "typedef" || t == "typeid" ||
           t == "typename" || t == "typeof" || t == "union" || t == "unless" || t == "unorm" ||
           t == "unsafe" || t == "unsized" || t == "use" || t == "using" || t == "varying" ||
           t == "virtual" || t == "volatile" || t == "wgsl" || t == "where" || t == "with" ||
           t == "writeonly" || t == "yield";
}
    ...
    auto decl = sync(Token::Type::kSemicolon, [&]() -> Maybe<Void> {
        ...
        while (continue_parsing()) {
            ...
            if (t2.IsIdentifier()) {
                ...
                return add_error(t2.source(), "'" + t2.to_str() + "' is not a valid feature name");
            }
