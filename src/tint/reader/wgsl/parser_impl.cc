...
Expect<ParserImpl::TypedIdentifier> ParserImpl::expect_optionally_typed_ident(std::string_view use) {
...
Expect<ParserImpl::TypedIdentifier> ParserImpl::expect_ident_with_type_specifier(std::string_view use) {
