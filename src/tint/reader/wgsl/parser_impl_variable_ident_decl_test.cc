...
TEST_F(ParserImplTest, VariableIdentDecl_Parses_InferredType) {
    auto p = parser("my_var : f32");
...
TEST_F(ParserImplTest, VariableIdentDecl_Inferred_Parses_InferredType) {
    auto p = parser("my_var = 1.0");
    auto decl = p->expect_variable_ident_decl("test", /*allow_inferred = */ true);
    ASSERT_FALSE(p->has_error()) << p->error();
    ASSERT_FALSE(decl.errored);
...
TEST_F(ParserImplTest, VariableIdentDecl_MissingIdent_InferredType) {
    auto p = parser(": f32");
    auto decl = p->expect_variable_ident_decl("test", /*allow_inferred = */ true);
    ASSERT_TRUE(p->has_error());
    ASSERT_TRUE(decl.errored);
...
TEST_F(ParserImplTest, VariableIdentDecl_MissingType_InferredType) {
    auto p = parser("my_var :");
    auto decl = p->expect_variable_ident_decl("test", /*allow_inferred = */ true);
    ASSERT_TRUE(p->has_error());
    ASSERT_TRUE(decl.errored);
...
TEST_F(ParserImplTest, VariableIdentDecl_InvalidIdent_InferredType) {
    auto p = parser("123 : f32");
    auto decl = p->expect_variable_ident_decl("test", /*allow_inferred = */ true);
    ASSERT_TRUE(p->has_error());
    ASSERT_TRUE(decl.errored);
