...
test.wgsl:1:11 error: expected ';' for 'const' declaration
let i = 1 < 2;
          ^
)");
}
...
test.wgsl:2:1 warning: use of deprecated language feature: module-scope 'let' has been replaced with 'const'
let b = a;
^^^
