...
TEST_F(ConstantTest_Scalar, AllZero) {
    ...
    auto* afPos0 = create<Scalar<tint::AFloat>>(f32, tint::Number<AFloat>{0.0});
    auto* afNeg0 = create<Scalar<tint::AFloat>>(f32, tint::Number<AFloat>{-0.0});
    auto* afPos1 = create<Scalar<tint::AFloat>>(f32, tint::Number<AFloat>{1.0});
    auto* afNeg1 = create<Scalar<tint::AFloat>>(f32, tint::Number<AFloat>{-1.0});

    auto* ai0 = create<Scalar<tint::AInt>>(i32, tint::Number<AInt>{0});
    auto* aiPos1 = create<Scalar<tint::AInt>>(i32, tint::Number<AInt>{1});
    auto* aiNeg1 = create<Scalar<tint::AInt>>(i32, tint::Number<AInt>{-1});
...
TEST_F(ConstantTest_Scalar, ValueOf) {
    ...
    auto* bf = create<Scalar<bool>>(bool_, false);
    auto* bt = create<Scalar<bool>>(bool_, true);
    auto* af1 = create<Scalar<tint::AFloat>>(f32, tint::Number<AFloat>{1.0});
    auto* ai1 = create<Scalar<tint::AInt>>(i32, tint::Number<AInt>{1});
