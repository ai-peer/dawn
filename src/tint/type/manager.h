...
class Manager final {
  public:
    ...
    type::Matrix* mat(type::Type* inner, uint32_t cols, uint32_t rows);

    /// @param inner the inner type
    /// @returns a mat2x2 with the element @p inner
    type::Matrix* mat2x2(type::Type* inner);
    ...
    type::Matrix* mat2x3(type::Type* inner);
    ...
    type::Matrix* mat2x4(type::Type* inner);
    ...
    type::Matrix* mat3x2(type::Type* inner);
    ...
    type::Matrix* mat3x3(type::Type* inner);
    ...
    type::Matrix* mat3x4(type::Type* inner);
    ...
    type::Matrix* mat4x2(type::Type* inner);
    ...
    type::Matrix* mat4x3(type::Type* inner);
    ...
    type::Matrix* mat4x4(type::Type* inner);
    ...
    template <typename T>
    type::Matrix* mat(uint32_t columns, uint32_t rows) {
    ...
    type::Array* array(type::Type* elem_ty, uint32_t count, uint32_t stride = 0);

    /// @param elem_ty the array element type
    /// @param stride the optional array element stride
    /// @returns the runtime array type
    type::Array* runtime_array(type::Type* elem_ty, uint32_t stride = 0);
    ...
    type::Array* array(uint32_t stride = 0) {
        if constexpr (N == 0) {
    ...
    type::Pointer* ptr(builtin::AddressSpace address_space,
                       type::Type* subtype,
    ...
    type::Pointer* ptr(type::Type* subtype) {
