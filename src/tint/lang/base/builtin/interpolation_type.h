...
#ifndef SRC_TINT_LANG_BASE_BUILITIN_INTERPOLATION_TYPE_H_
#define SRC_TINT_LANG_BASE_BUILITIN_INTERPOLATION_TYPE_H_
...
#endif  // SRC_TINT_LANG_BASE_BUILITIN_INTERPOLATION_TYPE_H_
