...
#ifndef SRC_TINT_LANG_BASE_BUILITIN_DIAGNOSTIC_RULE_H_
#define SRC_TINT_LANG_BASE_BUILITIN_DIAGNOSTIC_RULE_H_
...
#endif  // SRC_TINT_LANG_BASE_BUILITIN_DIAGNOSTIC_RULE_H_
