...
#ifndef SRC_TINT_LANG_BASE_BUILITIN_INTERPOLATION_H_
#define SRC_TINT_LANG_BASE_BUILITIN_INTERPOLATION_H_
...
#endif  // SRC_TINT_LANG_BASE_BUILITIN_INTERPOLATION_H_
