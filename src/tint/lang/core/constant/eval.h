...
class Eval {
  public:
    ...
    Result OpComplement(const core::type::Type* ty,
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpUnaryMinus(const core::type::Type* ty,
                        VectorRef<const Value*> args,
                        const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpNot(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpPlus(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpMinus(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpMultiply(const core::type::Type* ty,
                      VectorRef<const Value*> args,
                      const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpMultiplyMatVec(const core::type::Type* ty,
                            VectorRef<const Value*> args,
                            const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpMultiplyVecMat(const core::type::Type* ty,
                            VectorRef<const Value*> args,
                            const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpMultiplyMatMat(const core::type::Type* ty,
                            VectorRef<const Value*> args,
                            const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpDivide(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpModulo(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpEqual(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpNotEqual(const core::type::Type* ty,
                      VectorRef<const Value*> args,
                      const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpLessThan(const core::type::Type* ty,
                      VectorRef<const Value*> args,
                      const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpGreaterThan(const core::type::Type* ty,
                         VectorRef<const Value*> args,
                         const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpLessThanEqual(const core::type::Type* ty,
                           VectorRef<const Value*> args,
                           const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpGreaterThanEqual(const core::type::Type* ty,
                              VectorRef<const Value*> args,
                              const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpLogicalAnd(const core::type::Type* ty,
                        VectorRef<const Value*> args,
                        const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpLogicalOr(const core::type::Type* ty,
                       VectorRef<const Value*> args,
                       const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpAnd(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpOr(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpXor(const core::type::Type* ty, VectorRef<const Value*> args, const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpShiftLeft(const core::type::Type* ty,
                       VectorRef<const Value*> args,
                       const Source& source);
    ...
    /// @param source the source location
    /// @return the result value, or null if the value cannot be calculated
    Result OpShiftRight(const core::type::Type* ty,
                        VectorRef<const Value*> args,
                        const Source& source);
