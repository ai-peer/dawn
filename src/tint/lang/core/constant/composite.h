...
class Composite : public tint::Castable<Composite, Value> {
  public:
    /// Constructor
    ...
    Composite(const type::Type* t, tint::VectorRef<const Value*> els, bool all_0, bool any_0);
    ~Composite() override;
    ...
    const tint::Vector<const Value*, 4> elements;
