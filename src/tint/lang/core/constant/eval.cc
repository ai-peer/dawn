...
Eval::Result Eval::OpComplement(const core::type::Type* ty,
                                VectorRef<const Value*> args,
                                const Source& source) {
...
Eval::Result Eval::OpUnaryMinus(const core::type::Type* ty,
                                VectorRef<const Value*> args,
                                const Source& source) {
    auto transform = [&](const Value* c) {
        auto create = [&](auto i) {
...
Eval::Result Eval::OpNot(const core::type::Type* ty,
                         VectorRef<const Value*> args,
                         const Source& source) {
    auto transform = [&](const Value* c) {
...
Eval::Result Eval::OpPlus(const core::type::Type* ty,
                          VectorRef<const Value*> args,
                          const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
...
Eval::Result Eval::OpMinus(const core::type::Type* ty,
                           VectorRef<const Value*> args,
                           const Source& source) {
    return Sub(source, ty, args[0], args[1]);
}

Eval::Result Eval::OpMultiply(const core::type::Type* ty,
                              VectorRef<const Value*> args,
                              const Source& source) {
    return Mul(source, ty, args[0], args[1]);
}

Eval::Result Eval::OpMultiplyMatVec(const core::type::Type* ty,
                                    VectorRef<const Value*> args,
                                    const Source& source) {
...
Eval::Result Eval::OpMultiplyVecMat(const core::type::Type* ty,
                                    VectorRef<const Value*> args,
                                    const Source& source) {
...
Eval::Result Eval::OpMultiplyMatMat(const core::type::Type* ty,
                                    VectorRef<const Value*> args,
                                    const Source& source) {
    auto* mat1 = args[0];
    auto* mat2 = args[1];
...
Eval::Result Eval::OpDivide(const core::type::Type* ty,
                            VectorRef<const Value*> args,
                            const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
...
Eval::Result Eval::OpModulo(const core::type::Type* ty,
                            VectorRef<const Value*> args,
                            const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
...
Eval::Result Eval::OpEqual(const core::type::Type* ty,
                           VectorRef<const Value*> args,
                           const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
...
Eval::Result Eval::OpNotEqual(const core::type::Type* ty,
                              VectorRef<const Value*> args,
                              const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpLessThan(const core::type::Type* ty,
                              VectorRef<const Value*> args,
                              const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpGreaterThan(const core::type::Type* ty,
                                 VectorRef<const Value*> args,
                                 const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpLessThanEqual(const core::type::Type* ty,
                                   VectorRef<const Value*> args,
                                   const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpGreaterThanEqual(const core::type::Type* ty,
                                      VectorRef<const Value*> args,
                                      const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpLogicalAnd(const core::type::Type* ty,
                                VectorRef<const Value*> args,
                                const Source& source) {
...
Eval::Result Eval::OpLogicalOr(const core::type::Type* ty,
                               VectorRef<const Value*> args,
                               const Source& source) {
...
Eval::Result Eval::OpAnd(const core::type::Type* ty,
                         VectorRef<const Value*> args,
                         const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpOr(const core::type::Type* ty,
                        VectorRef<const Value*> args,
                        const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpXor(const core::type::Type* ty,
                         VectorRef<const Value*> args,
                         const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto i, auto j) -> Eval::Result {
...
Eval::Result Eval::OpShiftLeft(const core::type::Type* ty,
                               VectorRef<const Value*> args,
                               const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
...
Eval::Result Eval::OpShiftRight(const core::type::Type* ty,
                                VectorRef<const Value*> args,
                                const Source& source) {
    auto transform = [&](const Value* c0, const Value* c1) {
        auto create = [&](auto e1, auto e2) -> Eval::Result {
