...
TEST_F(ConstantTest_Composite, AllZero) {
    ...
    auto* compositeAll = constants.Composite(vec3f, tint::Vector{fPos0, fPos0});
    auto* compositeAny = constants.Composite(vec3f, tint::Vector{fNeg0, fPos1, fPos0});
    auto* compositeNone = constants.Composite(vec3f, tint::Vector{fNeg0, fNeg0});
...
TEST_F(ConstantTest_Composite, Index) {
    ...
    auto* composite = constants.Composite(vec3f, tint::Vector{fPos1, fPos0});
