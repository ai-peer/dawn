...
/// An array count
class ArrayCount : public tint::Castable<ArrayCount, UniqueNode> {
  public:
    ~ArrayCount() override;
...
/// ```
class ConstantArrayCount final : public tint::Castable<ConstantArrayCount, ArrayCount> {
  public:
    /// Constructor
...
/// type arr = array<i32>
/// ```
class RuntimeArrayCount final : public tint::Castable<RuntimeArrayCount, ArrayCount> {
  public:
    /// Constructor
    RuntimeArrayCount();
