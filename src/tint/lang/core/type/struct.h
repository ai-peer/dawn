...
class Struct : public tint::Castable<Struct, Type> {
  public:
    /// Constructor
    ...
    tint::VectorRef<const StructMember*> Members() const { return members_; }
    ...
    void SetConcreteTypes(tint::VectorRef<const Struct*> concrete) { concrete_types_ = concrete; }
    ...
    tint::VectorRef<const Struct*> ConcreteTypes() const { return concrete_types_; }
...
class StructMember : public tint::Castable<StructMember, Node> {
  public:
    /// Constructor
