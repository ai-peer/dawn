...
#ifndef SRC_TINT_LANG_CORE_BUILTIN_NUMBER_H_
#define SRC_TINT_LANG_CORE_BUILTIN_NUMBER_H_
...
template <typename T>
inline tint::StringStream& operator<<(tint::StringStream& out, Number<T> num) {
...
/// @return the stream so calls can be chained
tint::StringStream& operator<<(tint::StringStream& out, ConversionFailure failure);
...
#endif  // SRC_TINT_LANG_CORE_BUILTIN_NUMBER_H_
