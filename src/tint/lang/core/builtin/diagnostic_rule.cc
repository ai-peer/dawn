...
tint::StringStream& operator<<(tint::StringStream& out, CoreDiagnosticRule value) {
    switch (value) {
...
tint::StringStream& operator<<(tint::StringStream& out, ChromiumDiagnosticRule value) {
    switch (value) {
