...
class Function : public tint::Castable<Function, Value> {
  public:
    ...
    void SetParams(tint::VectorRef<FunctionParam*> params);
    ...
    const tint::VectorRef<FunctionParam*> Params() { return params_; }
  ...
  private:
    ...
    tint::Vector<FunctionParam*, 1> params_;
    ir::Block* block_ = nullptr;
};

tint::StringStream& operator<<(tint::StringStream& out, Function::PipelineStage value);
tint::StringStream& operator<<(tint::StringStream& out, enum Function::ReturnBuiltin value);
