...
/// Value in the IR.
class Value : public tint::Castable<Value> {
  public:
    /// Destructor
    ~Value() override;
    ...
    const tint::Hashset<Usage, 4, Usage::Hasher>& Usages() { return uses_; }
  ...
  private:
    ...
    tint::Hashset<Usage, 4, Usage::Hasher> uses_;
