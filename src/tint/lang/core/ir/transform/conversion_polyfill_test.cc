...
%foo = func(%src:vec2<f32>):vec2<i32> -> %b1 {
  %b1 = block {
    %result:vec2<i32> = call %tint_f32_to_v2i32, %src
    ret %result
  }
}
%tint_f32_to_v2i32 = func(%value:vec2<f32>):vec2<i32> -> %b2 {
  %b2 = block {
...
%foo = func(%src:vec2<f32>):vec2<u32> -> %b1 {
  %b1 = block {
    %result:vec2<u32> = call %tint_f32_to_v2u32, %src
    ret %result
  }
}
%tint_f32_to_v2u32 = func(%value:vec2<f32>):vec2<u32> -> %b2 {
  %b2 = block {
...
%foo = func(%src:vec2<f16>):vec2<i32> -> %b1 {
  %b1 = block {
    %result:vec2<i32> = call %tint_f16_to_v2i32, %src
    ret %result
  }
}
%tint_f16_to_v2i32 = func(%value:vec2<f16>):vec2<i32> -> %b2 {
  %b2 = block {
    %6:vec2<i32> = convert %value
...
%foo = func(%src:vec2<f16>):vec2<u32> -> %b1 {
  %b1 = block {
    %result:vec2<u32> = call %tint_f16_to_v2u32, %src
    ret %result
  }
}
%tint_f16_to_v2u32 = func(%value:vec2<f16>):vec2<u32> -> %b2 {
  %b2 = block {
    %6:vec2<u32> = convert %value
