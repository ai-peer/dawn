...
struct State {
    ...
    ir::Value* CountLeadingZeros(ir::CoreBuiltinCall* call) {
        ...
        b.InsertBefore(call, [&] {
            ...
            auto* b16 = b.Call(uint_ty, builtin::Function::kSelect, V(0), V(16),
                               b.LessThanEqual(bool_ty, x, V(0x0000ffff)));
            x = b.ShiftLeft(uint_ty, x, b16)->Result();
            auto* b8 = b.Call(uint_ty, builtin::Function::kSelect, V(0), V(8),
                              b.LessThanEqual(bool_ty, x, V(0x00ffffff)));
            x = b.ShiftLeft(uint_ty, x, b8)->Result();
            auto* b4 = b.Call(uint_ty, builtin::Function::kSelect, V(0), V(4),
                              b.LessThanEqual(bool_ty, x, V(0x0fffffff)));
            x = b.ShiftLeft(uint_ty, x, b4)->Result();
            auto* b2 = b.Call(uint_ty, builtin::Function::kSelect, V(0), V(2),
                              b.LessThanEqual(bool_ty, x, V(0x3fffffff)));
            x = b.ShiftLeft(uint_ty, x, b2)->Result();
            auto* b1 = b.Call(uint_ty, builtin::Function::kSelect, V(0), V(1),
                              b.LessThanEqual(bool_ty, x, V(0x7fffffff)));
            auto* b0 =
                b.Call(uint_ty, builtin::Function::kSelect, V(0), V(1), b.Equal(bool_ty, x, V(0)));
    ...
    ir::Value* FirstLeadingBit(ir::CoreBuiltinCall* call) {
        ...
        b.InsertBefore(call, [&] {
            ...
            if (result_ty->is_signed_integer_scalar_or_vector()) {
                ...
                x = b.Call(uint_ty, builtin::Function::kSelect, inverted, x,
                           b.LessThan(bool_ty, x, V(0x80000000)))
                        ->Result();
            }
            auto* b16 = b.Call(uint_ty, builtin::Function::kSelect, V(16), V(0),
                               b.Equal(bool_ty, b.And(uint_ty, x, V(0xffff0000)), V(0)));
            x = b.ShiftRight(uint_ty, x, b16)->Result();
            auto* b8 = b.Call(uint_ty, builtin::Function::kSelect, V(8), V(0),
                              b.Equal(bool_ty, b.And(uint_ty, x, V(0x0000ff00)), V(0)));
            x = b.ShiftRight(uint_ty, x, b8)->Result();
            auto* b4 = b.Call(uint_ty, builtin::Function::kSelect, V(4), V(0),
                              b.Equal(bool_ty, b.And(uint_ty, x, V(0x000000f0)), V(0)));
            x = b.ShiftRight(uint_ty, x, b4)->Result();
            auto* b2 = b.Call(uint_ty, builtin::Function::kSelect, V(2), V(0),
                              b.Equal(bool_ty, b.And(uint_ty, x, V(0x0000000c)), V(0)));
            x = b.ShiftRight(uint_ty, x, b2)->Result();
            auto* b1 = b.Call(uint_ty, builtin::Function::kSelect, V(1), V(0),
            ...
            result = b.Or(uint_ty, b16, b.Or(uint_ty, b8, b.Or(uint_ty, b4, b.Or(uint_ty, b2, b1))))
                         ->Result();
            result = b.Call(uint_ty, builtin::Function::kSelect, result, V(0xffffffff),
    ...
    ir::Value* TextureSampleBaseClampToEdge_2d_f32(ir::CoreBuiltinCall* call) {
        ...
        b.InsertBefore(call, [&] {
            ...
            auto* dims = b.Call(ty.vec2<u32>(), builtin::Function::kTextureDimensions, texture);
            ...
            auto* clamped =
                b.Call(vec2f, builtin::Function::kClamp, coords, half_texel, one_minus_half_texel);
            result = b.Call(ty.vec4<f32>(), builtin::Function::kTextureSampleLevel, texture,
                            sampler, clamped, 0_f)
                         ->Result();
        });
        return result;
