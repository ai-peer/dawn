...
class ShaderIO : public tint::Castable<ShaderIO, Transform> {
  public:
    /// Constructor
    ShaderIO();
    /// Destructor
    ...
    struct BackendState {
        ...
        virtual tint::Vector<FunctionParam*, 4> FinalizeInputs() = 0;
      ...
      protected:
        ...
        tint::Vector<type::Manager::StructMemberDesc, 4> inputs;

        /// The list of shader outputs.
        tint::Vector<type::Manager::StructMemberDesc, 4> outputs;
    };
