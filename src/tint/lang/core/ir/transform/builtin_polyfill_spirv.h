...
class BuiltinPolyfillSpirv final : public tint::Castable<BuiltinPolyfillSpirv, Transform> {
  public:
    /// Constructor
    ...
    class LiteralOperand final : public tint::Castable<LiteralOperand, ir::Constant> {
      public:
        /// Constructor
    ...
    class SampledImage final : public tint::Castable<SampledImage, type::Type> {
      public:
        /// Constructor
