...
struct StateImpl : ShaderIO::BackendState {
    ...
    tint::Vector<uint32_t, 4> input_indices;
    /// The member indices for outputs.
    tint::Vector<uint32_t, 4> output_indices;
    ...
    void MakeStructs(Var*& builtin_var,
                     ...
                     tint::Vector<type::Manager::StructMemberDesc, 4>& entries,
        ...
        tint::Vector<type::Manager::StructMemberDesc, 4> builtin_members;
        tint::Vector<type::Manager::StructMemberDesc, 4> location_members;
        for (auto io : entries) {
    ...
    tint::Vector<FunctionParam*, 4> FinalizeInputs() override {
