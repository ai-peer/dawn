...
struct State {
    ...
    void Process() {
        ...
        if (ir->root_block) {
            ...
            for (auto inst : *ir->root_block) {
                ...
                if (storage_texture &&
                    storage_texture->texel_format() == builtin::TexelFormat::kBgra8Unorm) {
    ...
    void ReplaceVar(Var* old_var, const type::StorageTexture* bgra8) {
        ...
        auto* rgba8 = ty.Get<type::StorageTexture>(bgra8->dim(), builtin::TexelFormat::kRgba8Unorm,
        ...
        old_value->ForEachUse([&](Usage use) {
            tint::Switch(
                ...
                [&](CoreBuiltinCall* call) {
                    ...
                    if (call->Func() == builtin::Function::kTextureStore) {
                    ...
                    } else if (call->Func() == builtin::Function::kTextureLoad) {
