...
TEST_F(IR_Bgra8UnormPolyfillTest, NoModify_ModuleScopeVariable_Rgba) {
    auto format = builtin::TexelFormat::kRgba8Unorm;
    ...
    b.Append(func->Block(), [&] {
        ...
        b.Call(ty.void_(), builtin::Function::kTextureStore, load, coords, value);
        b.Return(func);
    });
...
TEST_F(IR_Bgra8UnormPolyfillTest, NoModify_UserFunctionParameter_Rgba) {
    ...
    b.Append(func->Block(), [&] {
        b.Call(ty.void_(), builtin::Function::kTextureStore, texture, coords, value);
        b.Return(func);
    });
...
TEST_F(IR_Bgra8UnormPolyfillTest, ModuleScopeVariable) {
    auto format = builtin::TexelFormat::kBgra8Unorm;
    auto* texture_ty = ty.Get<type::StorageTexture>(type::TextureDimension::k2d, format, write,
                                                    type::StorageTexture::SubtypeFor(format, ty));
...
TEST_F(IR_Bgra8UnormPolyfillTest, ModuleScopePassedToUserFunction_MultipleTextures) {
    ...
    auto* bar = b.Function("bar", ty.void_());
    {
        ...
        b.Append(bar->Block(), [&] {
            b.Call(ty.void_(), builtin::Function::kTextureStore, texture_a, coords, value);
            b.Call(ty.void_(), builtin::Function::kTextureStore, texture_b, coords, value);
            b.Call(ty.void_(), builtin::Function::kTextureStore, texture_c, coords, value);
            b.Return(bar);
        });
    }
...
TEST_F(IR_Bgra8UnormPolyfillTest, MutipleUsesOfOneTexture) {
    ...
    auto* foo = b.Function("foo", ty.void_());
    {
        ...
        b.Append(foo->Block(), [&] {
            auto* load_a = b.Load(var_a->Result());
            b.Call(ty.void_(), builtin::Function::kTextureStore, load_a, coords, value);
...
TEST_F(IR_Bgra8UnormPolyfillTest, ArrayedImage) {
    ...
    b.Append(func->Block(), [&] {
        auto* load = b.Load(var->Result());
        b.Call(ty.void_(), builtin::Function::kTextureStore, load, coords, index, value);
        b.Return(func);
    });
...
TEST_F(IR_Bgra8UnormPolyfillTest, TextureDimensions) {
    ...
    b.Append(func->Block(), [&] {
        auto* load = b.Load(var->Result());
        auto* dims = b.Call(ty.vec2<u32>(), builtin::Function::kTextureDimensions, load);
        b.Return(func, dims);
