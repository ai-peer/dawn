  ...
  %b2 = block {
    loop [i: %b3, b: %b4, c: %b5] {  # loop_1
      ...
      %b4 = block (%4:u32) {  # body
        ...
        %7:u32 = div %4:u32, 5u
        %8:u32 = mod %7, 7u
        %9:ptr<workgroup, u32, read_write> = access %wgvar, %8, %6
        store %9, 0u
        continue %b5
      }
      %b5 = block {  # continuing
...
TEST_F(IR_ZeroInitWorkgroupMemoryTest, NestedArraySizeOne) {
  ...
  %b2 = block {
    ...
    loop [i: %b7, b: %b8, c: %b9] {  # loop_2
      ...
      %b8 = block (%11:u32) {  # body
        ...
        %13:u32 = mod %11:u32, 13u
        %14:u32 = div %11:u32, 13u
        %15:u32 = mod %14, 7u
        %16:ptr<workgroup, i32, read_write> = access %wgvar, %15, 1u, %13, 0u
        store %16, 0i
        %17:u32 = mod %11:u32, 13u
        %18:u32 = div %11:u32, 13u
        %19:u32 = mod %18, 7u
        %20:ptr<workgroup, atomic<u32>, read_write> = access %wgvar, %19, 1u, %17, 1u
  ...
  %b2 = block {
    ...
    loop [i: %b8, b: %b9, c: %b10] {  # loop_2
      ...
      %b9 = block (%12:u32) {  # body
        ...
        %14:u32 = mod %12:u32, 5u
        %15:u32 = div %12:u32, 5u
        %16:u32 = mod %15, 7u
        %17:ptr<workgroup, u32, read_write> = access %var_c, %16, %14
        store %17, 0u
        continue %b10
      }
  ...
  %b2 = block {
    ...
    loop [i: %b4, b: %b5, c: %b6] {  # loop_1
      ...
      %b5 = block (%8:u32) {  # body
        ...
        %13:u32 = div %8:u32, 6u
        %14:u32 = mod %13, 7u
        %15:ptr<workgroup, u32, read_write> = access %var_d, %14, %12
        store %15, 0u
        continue %b6
      }
      %b6 = block {  # continuing
...
%func = @compute @workgroup_size(1, 1, 1) func(%7:u32 [@local_invocation_index]):void -> %b7 {
  %b7 = block {
    %8:bool = eq %7, 0u
    if %8 [t: %b8] {  # if_2
      %b8 = block {  # true
...
%ep1 = @compute @workgroup_size(1, 1, 1) func(%5:u32 [@local_invocation_index]):void -> %b5 {
  %b5 = block {
    %6:bool = eq %5, 0u
    if %6 [t: %b6] {  # if_1
      %b6 = block {  # true
...
%ep2 = @compute @workgroup_size(1, 1, 1) func(%10:u32 [@local_invocation_index]):void -> %b7 {
  %b7 = block {
    %11:bool = eq %10, 0u
    if %11 [t: %b8] {  # if_2
      %b8 = block {  # true
