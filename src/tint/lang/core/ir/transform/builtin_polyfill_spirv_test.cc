...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSample_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSample, t, s, coords,
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSample_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSample, t, s, coords, array_idx,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleBias_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSampleBias, t, s, coords, bias,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleBias_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSampleBias, t, s, coords, array_idx, bias,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleCompare_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.f32(), core::Function::kTextureSampleCompare, t, s, coords, dref,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleCompare_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.f32(), core::Function::kTextureSampleCompare, t, s, coords, array_idx, bias,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleCompareLevel_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.f32(), core::Function::kTextureSampleCompareLevel, t, s, coords, dref,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleCompareLevel_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.f32(), core::Function::kTextureSampleCompareLevel, t, s, coords, array_idx, bias,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleGrad_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSampleBias, t, s, coords, ddx, ddy,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleGrad_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSampleBias, t, s, coords, array_idx, ddx, ddy,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleLevel_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSampleLevel, t, s, coords, lod,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureSampleLevel_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureSampleLevel, t, s, coords, array_idx, lod,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureGather_2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureGather, component, t, s, coords,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureGather_2DArray_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureGather, component, t, s, coords, array_idx,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
...
TEST_F(IR_BuiltinPolyfillSpirvTest, TextureGatherCompare_Depth2D_Offset) {
    ...
    b.Append(func->Block(), [&] {
        auto* result = b.Call(
            ty.vec4<f32>(), core::Function::kTextureGatherCompare, t, s, coords, depth,
            b.Constant(mod.constant_values.Splat(ty.vec2<i32>(), mod.constant_values.Get(1_i), 2)));
        b.Return(func, result);
    });
