  ...
  %b3 = block {
    ...
    loop [i: %b4, b: %b5, c: %b6] {  # loop_1
      %b4 = block {  # initializer
        next_iteration %b5 0i
      }
      %b5 = block (%idx:i32) {  # body
        %10:bool = eq %idx:i32, 4u
        if %10 [t: %b7] {  # if_1
          %b7 = block {  # true
            exit_loop  # loop_1
          }
        }
        %11:ptr<function, Inner, read_write> = access %8, %idx:i32
        %12:Inner_std140 = access %7, %idx:i32
        %13:Inner = call %convert_Inner, %12
        store %11, %13
        continue %b6
      }
      %b6 = block {  # continuing
        %15:i32 = add %idx:i32, 1i
  ...
  %b2 = block {
    ...
    loop [i: %b3, b: %b4, c: %b5] {  # loop_1
      %b3 = block {  # initializer
        next_iteration %b4 0i
      }
      %b4 = block (%idx:i32) {  # body
        %16:bool = eq %idx:i32, 4u
        if %16 [t: %b6] {  # if_1
          %b6 = block {  # true
            exit_loop  # loop_1
          }
        }
        %17:ptr<function, Inner, read_write> = access %14, %idx:i32
        %18:Inner_std140 = access %13, %idx:i32
        %19:Inner = call %convert_Inner, %18
        store %17, %19
        continue %b5
      }
      %b5 = block {  # continuing
        %21:i32 = add %idx:i32, 1i
...
%foo = func(%arr_idx:i32, %col_idx:i32, %el_idx:i32):void -> %b2 {
  %b2 = block {
    ...
    loop [i: %b3, b: %b4, c: %b5] {  # loop_1
      ...
      %b4 = block (%idx:i32) {  # body
        %19:bool = eq %idx:i32, 4u
        if %19 [t: %b6] {  # if_1
          %b6 = block {  # true
            exit_loop  # loop_1
          }
        }
        %20:ptr<function, Inner, read_write> = access %17, %idx:i32
        %21:Inner_std140 = access %16, %idx:i32
        %22:Inner = call %convert_Inner, %21
        store %20, %22
        continue %b5
      }
      %b5 = block {  # continuing
        %24:i32 = add %idx:i32, 1i
