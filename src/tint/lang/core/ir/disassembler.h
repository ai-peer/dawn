...
class Disassembler {
  ...
  private:
    ...
    Module& mod_;
    tint::StringStream out_;
    tint::Hashmap<Block*, size_t, 32> block_ids_;
    tint::Hashmap<Value*, std::string, 32> value_ids_;
    tint::Hashset<std::string, 32> ids_;
    ...
    tint::Hashmap<Block*, Source, 8> block_to_src_;
    tint::Hashmap<Instruction*, Source, 8> instruction_to_src_;
    tint::Hashmap<Usage, Source, 8, Usage::Hasher> operand_to_src_;
    tint::Hashmap<Usage, Source, 8, Usage::Hasher> result_to_src_;
    tint::Hashmap<If*, std::string, 8> if_names_;
    tint::Hashmap<Loop*, std::string, 8> loop_names_;
    tint::Hashmap<Switch*, std::string, 8> switch_names_;
};
