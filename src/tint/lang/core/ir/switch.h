...
///                           out
/// ```
class Switch : public tint::Castable<Switch, ControlInstruction> {
  public:
    ...
    struct Case {
        ...
        tint::Vector<CaseSelector, 4> selectors;
        /// The case block.
    ...
    tint::Vector<Case, 4>& Cases() { return cases_; }
