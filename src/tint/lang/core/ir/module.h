...
class Module {
    ...
    tint::Hashmap<Value*, Symbol, 32> value_to_name_;
  ...
  public:
    ...
    /// The block allocator
    tint::BlockAllocator<Block> blocks;

    /// The constant value manager
    constant::Manager constant_values;

    /// The instruction allocator
    tint::BlockAllocator<Instruction> instructions;

    /// The value allocator
    tint::BlockAllocator<Value> values;

    /// List of functions in the program
    tint::Vector<Function*, 8> functions;
    ...
    tint::Hashmap<const constant::Value*, ir::Constant*, 16> constants;
