...
class Builder {
    ...
    /// A namespace for the various instruction insertion modes
    struct InsertionPoints {
        /// Insertion point behaviour that does no insertion
        struct NoInsertion {
            /// The insertion point function
            void operator()(ir::Instruction*) {}
        };
        /// Insertion point behaviour that inserts the instruction to the end of #block
        ...
        /// Insertion point behaviour that inserts the instruction to the front of #block
        ...
        /// Insertion point behaviour that inserts the instruction after #after
        struct InsertAfter {
        ...
        /// Insertion point behaviour that inserts the instruction before #before
        struct InsertBefore {
    ...
    /// The insertion mode in use for new instructions.
