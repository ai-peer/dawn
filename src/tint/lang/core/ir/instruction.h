...
class Instruction : public tint::Castable<Instruction> {
  public:
    /// Destructor
    ...
    virtual tint::VectorRef<ir::Value*> Operands() = 0;
    ...
    virtual tint::VectorRef<InstructionResult*> Results() { return tint::Empty; }
