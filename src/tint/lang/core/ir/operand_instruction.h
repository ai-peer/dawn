...
class OperandInstruction : public tint::Castable<OperandInstruction<N, R>, Instruction> {
  public:
    /// Destructor
    ...
    void SetOperands(tint::VectorRef<ir::Value*> operands) {
        ClearOperands();
    ...
    tint::VectorRef<ir::Value*> Operands() override { return operands_; }
    ...
    tint::VectorRef<InstructionResult*> Results() override { return results_; }
  ...
  protected:
    ...
    void AddOperands(size_t start_idx, tint::VectorRef<ir::Value*> values) {
    ...
    tint::Vector<ir::Value*, N> operands_;
    /// The results of this instruction.
    tint::Vector<ir::InstructionResult*, R> results_;
};
