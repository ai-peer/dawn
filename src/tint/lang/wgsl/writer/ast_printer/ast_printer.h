...
class ASTPrinter : public tint::TextGenerator {
  public:
    ...
    void EmitDiagnosticControl(tint::StringStream& out, const ast::DiagnosticControl& diagnostic);
    ...
    void EmitBinaryOp(tint::StringStream& out, const ast::BinaryOp op);
    ...
    void EmitBlockHeader(tint::StringStream& out, const ast::BlockStatement* stmt);
    ...
    void EmitLiteral(tint::StringStream& out, const ast::LiteralExpression* expr);
    ...
    void EmitIdentifier(tint::StringStream& out, const ast::Identifier* ident);
    ...
    void EmitImageFormat(tint::StringStream& out, const builtin::TexelFormat fmt);
    ...
    void EmitVariable(tint::StringStream& out, const ast::Variable* var);
    /// Handles generating a attribute list
    /// @param out the output stream
    /// @param attrs the attribute list
    void EmitAttributes(tint::StringStream& out, tint::VectorRef<const ast::Attribute*> attrs);
