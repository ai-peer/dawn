...
#ifndef SRC_TINT_LANG_WGSL_AST_PRINTER_AST_PRINTER_H_
#define SRC_TINT_LANG_WGSL_AST_PRINTER_AST_PRINTER_H_
...
#endif  // SRC_TINT_LANG_WGSL_AST_PRINTER_AST_PRINTER_H_
