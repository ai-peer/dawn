...
TEST_F(WgslASTPrinterTest, EmitType_Array_Attribute) {
    auto type =
        Alias("make_type_reachable", ty.array(ty.bool_(), 4_u, tint::Vector{Stride(16)}))->type;
...
TEST_F(WgslASTPrinterTest, EmitType_StructOffsetDecl) {
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.i32(), tint::Vector{MemberOffset(8_a)}),
                                 Member("b", ty.f32(), tint::Vector{MemberOffset(16_a)}),
                             });
...
TEST_F(WgslASTPrinterTest, EmitType_StructOffsetDecl_WithSymbolCollisions) {
    auto* s =
        Structure("S", tint::Vector{
                           Member("tint_0_padding", ty.i32(), tint::Vector{MemberOffset(8_a)}),
                           Member("tint_2_padding", ty.f32(), tint::Vector{MemberOffset(16_a)}),
                       });
...
TEST_F(WgslASTPrinterTest, EmitType_StructAlignDecl) {
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.i32(), tint::Vector{MemberAlign(8_a)}),
                                 Member("b", ty.f32(), tint::Vector{MemberAlign(16_a)}),
                             });
...
TEST_F(WgslASTPrinterTest, EmitType_StructSizeDecl) {
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.i32(), tint::Vector{MemberSize(16_a)}),
                                 Member("b", ty.f32(), tint::Vector{MemberSize(32_a)}),
                             });
...
TEST_F(WgslASTPrinterTest, EmitType_Struct_WithAttribute) {
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.i32()),
                                 Member("b", ty.f32(), tint::Vector{MemberAlign(8_a)}),
                             });
...
TEST_F(WgslASTPrinterTest, EmitType_Struct_WithEntryPointAttributes) {
    auto* s = Structure(
        "S", tint::Vector{
                 Member("a", ty.u32(), tint::Vector{Builtin(builtin::BuiltinValue::kVertexIndex)}),
                 Member("b", ty.f32(), tint::Vector{Location(2_a)}),
             });
