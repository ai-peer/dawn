...
IRToProgramTest::Result IRToProgramTest::Run() {
    ...
    auto output = tint::writer::wgsl::Generate(&output_program, {});
    if (!output.success) {
        std::stringstream ss;
...
TEST_F(IRToProgramTest, Switch_Default) {
    ...
    b.With(fn->Block(), [&] {
        ...
        b.With(b.Case(s, {ir::Switch::CaseSelector{}}), [&] {
            b.Call(ty.void_(), fn_a);
            b.ExitSwitch(s);
        });
...
TEST_F(IRToProgramTest, Switch_3_Cases) {
    ...
    b.With(fn->Block(), [&] {
        ...
        auto s = b.Switch(b.Load(v));
        b.With(b.Case(s, {ir::Switch::CaseSelector{b.Constant(0_i)}}), [&] {
            b.Call(ty.void_(), fn_a);
            b.ExitSwitch(s);
        });
        b.With(b.Case(s,
        ...
        b.With(b.Case(s, {ir::Switch::CaseSelector{b.Constant(2_i)}}), [&] {
            b.Call(ty.void_(), fn_c);
            b.ExitSwitch(s);
        });
...
TEST_F(IRToProgramTest, Switch_3_Cases_AllReturn) {
    ...
    b.With(fn->Block(), [&] {
        ...
        auto s = b.Switch(b.Load(v));
        b.With(b.Case(s, {ir::Switch::CaseSelector{b.Constant(0_i)}}), [&] { b.Return(fn); });
        b.With(b.Case(s,
                      {
                          ir::Switch::CaseSelector{b.Constant(1_i)},
                          ir::Switch::CaseSelector{},
               ...
               [&] { b.Return(fn); });
        b.With(b.Case(s, {ir::Switch::CaseSelector{b.Constant(2_i)}}), [&] { b.Return(fn); });
...
TEST_F(IRToProgramTest, Switch_Nested) {
    ...
    b.With(fn->Block(), [&] {
        ...
        b.With(b.Case(s1, {ir::Switch::CaseSelector{b.Constant(0_i)}}), [&] {
            b.Call(ty.void_(), fn_a);
            b.ExitSwitch(s1);
        });
        b.With(b.Case(s1,
               ...
               [&] {
                   ...
                   b.With(b.Case(s2, {ir::Switch::CaseSelector{b.Constant(0_i)}}),
                          [&] { b.ExitSwitch(s2); });
                   b.With(b.Case(s2,
                                 {
                                     ir::Switch::CaseSelector{b.Constant(1_i)},
        ...
        b.With(b.Case(s1, {ir::Switch::CaseSelector{b.Constant(2_i)}}), [&] {
            b.Call(ty.void_(), fn_c);
            b.ExitSwitch(s1);
        });
