...
class BuiltinEnumExpressionBase : public tint::Castable<BuiltinEnumExpressionBase, Expression> {
  public:
    /// Constructor
...
class BuiltinEnumExpression
    : public tint::Castable<BuiltinEnumExpression<ENUM>, BuiltinEnumExpressionBase> {
  public:
    /// Constructor
    /// @param declaration the AST node
    /// @param statement the statement that owns this expression
