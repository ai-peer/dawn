...
struct CallTargetSignature {
    ...
    CallTargetSignature(const type::Type* ret_ty, tint::VectorRef<const Parameter*> params);
...
/// conversions.
class CallTarget : public tint::Castable<CallTarget, Node> {
  public:
    /// Constructor
    ...
    CallTarget(const type::Type* return_type,
               tint::VectorRef<Parameter*> parameters,
