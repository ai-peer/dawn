...
class SwitchStatement final : public tint::Castable<SwitchStatement, CompoundStatement> {
  public:
    /// Constructor
...
class CaseStatement final : public tint::Castable<CaseStatement, CompoundStatement> {
  public:
    /// Constructor
...
class CaseSelector final : public tint::Castable<CaseSelector, Node> {
  public:
    /// Constructor
