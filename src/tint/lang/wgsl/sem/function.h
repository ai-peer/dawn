...
class Function final : public tint::Castable<Function, CallTarget> {
  public:
    ...
    const tint::UniqueVector<const GlobalVariable*, 4>& DirectlyReferencedGlobals() const {
    ...
    const tint::UniqueVector<const GlobalVariable*, 8>& TransitivelyReferencedGlobals() const {
    ...
    const tint::UniqueVector<const Function*, 8>& TransitivelyCalledFunctions() const {
    ...
    const tint::UniqueVector<const Builtin*, 4>& DirectlyCalledBuiltins() const {
    ...
    tint::VectorRef<VariablePair> TextureSamplerPairs() const { return texture_sampler_pairs_; }
  ...
  private:
    ...
    tint::UniqueVector<const GlobalVariable*, 4> directly_referenced_globals_;
    tint::UniqueVector<const GlobalVariable*, 8> transitively_referenced_globals_;
    tint::UniqueVector<const Function*, 8> transitively_called_functions_;
    tint::UniqueVector<const Builtin*, 4> directly_called_builtins_;
    tint::UniqueVector<VariablePair, 8> texture_sampler_pairs_;
