...
class Struct final : public tint::Castable<Struct, type::Struct> {
  public:
    /// Constructor
    ...
    Struct(const ast::Struct* declaration,
           Symbol name,
           tint::VectorRef<const StructMember*> members,
           uint32_t align,
           uint32_t size,
    ...
    tint::VectorRef<const StructMember*> Members() const {
...
class StructMember final : public tint::Castable<StructMember, type::StructMember> {
  public:
    /// Constructor
