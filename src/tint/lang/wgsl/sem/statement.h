...
class Statement : public tint::Castable<Statement, Node> {
  public:
    /// Constructor
...
/// statements.
class CompoundStatement : public tint::Castable<CompoundStatement, Statement> {
  public:
    /// Constructor
    /// @param declaration the AST node for this statement
    ...
    const tint::Hashmap<Symbol, OrderedLocalVariable, 4>& Decls() const { return decls_; }
  ...
  private:
    tint::Hashmap<Symbol, OrderedLocalVariable, 4> decls_;
};
