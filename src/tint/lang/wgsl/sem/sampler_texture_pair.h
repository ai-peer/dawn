...
inline tint::StringStream& operator<<(tint::StringStream& o, const SamplerTexturePair& stp) {
...
class hash<tint::sem::SamplerTexturePair> {
  public:
    ...
    inline std::size_t operator()(const tint::sem::SamplerTexturePair& stp) const {
        return tint::Hash(stp.sampler_binding_point, stp.texture_binding_point);
    }
};
