...
/// parameters.
class Variable : public tint::Castable<Variable, Node> {
  public:
    /// Constructor
    ...
    tint::VectorRef<const VariableUser*> Users() const { return users_; }
...
class LocalVariable final : public tint::Castable<LocalVariable, Variable> {
  public:
    /// Constructor
    /// @param declaration the AST declaration node
    /// @param type the variable type
    ...
    const tint::CastableBase* Shadows() const { return shadows_; }
    ...
    void SetShadows(const tint::CastableBase* shadows) { shadows_ = shadows; }

  private:
    const sem::Statement* const statement_;
    const tint::CastableBase* shadows_ = nullptr;
};

/// GlobalVariable is a module-scope variable
class GlobalVariable final : public tint::Castable<GlobalVariable, Variable> {
  public:
    /// Constructor
    /// @param declaration the AST declaration node
    /// @param type the variable type
...
class Parameter final : public tint::Castable<Parameter, Variable> {
  public:
...
class VariableUser final : public tint::Castable<VariableUser, ValueExpression> {
  public:
    /// Constructor
...
class hash<tint::sem::VariablePair> {
  public:
    ...
    inline std::size_t operator()(const tint::sem::VariablePair& i) const {
        return tint::Hash(i.first, i.second);
    }
};
