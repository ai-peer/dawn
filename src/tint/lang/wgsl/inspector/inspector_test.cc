...
TEST_F(InspectorGetEntryPointTest, OneEntryPoint) {
    MakeEmptyBodyFunction("foo", tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, MultipleEntryPoints) {
    ...
    MakeEmptyBodyFunction("bar", tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, MixFunctionsAndEntryPoints) {
    ...
    MakeCallerBodyFunction("foo", tint::Vector{std::string("func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });

    MakeCallerBodyFunction("bar", tint::Vector{std::string("func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kFragment),
                           });
...
TEST_P(InspectorGetEntryPointComponentAndCompositionTest, Test) {
    ...
    Func("foo", tint::Vector{in_var}, tint_type(),
         tint::Vector{
             Return("in_var"),
         },
         tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, MultipleInOutVariables) {
    ...
    Func("foo", tint::Vector{in_var0, in_var1, in_var4}, ty.u32(),
         tint::Vector{
             Return("in_var0"),
         },
         tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, MultipleEntryPointsInOutVariables) {
    ...
    Func("foo", tint::Vector{in_var_foo}, ty.u32(),
         tint::Vector{
             Return("in_var_foo"),
         },
         tint::Vector{
    ...
    Func("bar", tint::Vector{in_var_bar}, ty.u32(),
         tint::Vector{
             Return("in_var_bar"),
         },
         tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, BuiltInsNotStageVariables) {
    ...
    Func("foo", tint::Vector{in_var0, in_var1}, ty.f32(),
         tint::Vector{
             Return("in_var1"),
         },
         tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, InOutStruct) {
    auto* interface = MakeInOutStruct("interface", tint::Vector{
                                                       InOutInfo{"a", 0u},
                                                       InOutInfo{"b", 1u},
                                                   });
    Func("foo",
...
TEST_F(InspectorGetEntryPointTest, MultipleEntryPointsInOutSharedStruct) {
    ...
    Func("bar", tint::Vector{Param("param", ty.Of(interface))}, ty.void_(), tint::Empty,
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         });
    Inspector& inspector = Build();
...
TEST_F(InspectorGetEntryPointTest, MixInOutVariablesAndStruct) {
    auto* struct_a = MakeInOutStruct("struct_a", tint::Vector{
                                                     InOutInfo{"a", 0u},
                                                     InOutInfo{"b", 1u},
                                                 });
    auto* struct_b = MakeInOutStruct("struct_b", tint::Vector{
                                                     InOutInfo{"a", 2u},
                                                 });
    Func("foo",
         tint::Vector{
             ...
             Param("param_c", ty.f32(), tint::Vector{Location(3_u)}),
             Param("param_d", ty.f32(), tint::Vector{Location(4_u)}),
         },
         ty.Of(struct_a),
         tint::Vector{
             Return("param_a"),
...
TEST_F(InspectorGetEntryPointTest, OverrideUnreferenced) {
    Override("foo", ty.f32());
    MakeEmptyBodyFunction("ep_func", tint::Vector{
                                         Stage(ast::PipelineStage::kCompute),
                                         WorkgroupSize(1_i),
                                     });
...
TEST_F(InspectorGetEntryPointTest, OverrideReferencedByCallee) {
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("callee_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
...
TEST_F(InspectorGetEntryPointTest, OverrideTypes) {
    ...
    MakeCallerBodyFunction(
        "ep_func",
        tint::Vector{std::string("bool_func"), "float_func", "u32_func", "i32_func", "f16_func"},
        tint::Vector{
            Stage(ast::PipelineStage::kCompute),
            WorkgroupSize(1_i),
        });
...
TEST_F(InspectorGetEntryPointTest, OverrideNumericIDSpecified) {
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("no_id_func"), "id_func"},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
...
TEST_F(InspectorGetEntryPointTest, NonOverrideSkipped) {
    auto* foo_struct_type = MakeUniformBufferType("foo_type", tint::Vector{
                                                                  ty.i32(),
                                                              });
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("ub_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kFragment),
                           });
...
TEST_F(InspectorGetEntryPointTest, InputSampleMaskSimpleReferenced) {
    ...
    Func("ep_func", tint::Vector{in_var}, ty.void_(),
         tint::Vector{
             Return(),
         },
         tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, OutputSampleMaskSimpleReferenced) {
    Func("ep_func",
         tint::Vector{
             Param("in_var", ty.u32(), tint::Vector{Builtin(builtin::BuiltinValue::kSampleMask)}),
         },
         ty.u32(),
         tint::Vector{
             Return("in_var"),
...
TEST_F(InspectorGetEntryPointTest, OutputSampleMaskStructReferenced) {
    Structure("out_struct", tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, InputPositionStructReferenced) {
    Structure("in_struct", tint::Vector{
...
TEST_F(InspectorGetEntryPointTest, FrontFacingSimpleReferenced) {
    Func(
        "ep_func",
        tint::Vector{
            Param("in_var", ty.bool_(), tint::Vector{Builtin(builtin::BuiltinValue::kFrontFacing)}),
        },
        ty.void_(),
        tint::Vector{
            Return(),
...
TEST_F(InspectorGetEntryPointTest, FrontFacingStructReferenced) {
    Structure("in_struct", tint::Vector{
                               Member("inner_position", ty.bool_(),
                                      tint::Vector{Builtin(builtin::BuiltinValue::kFrontFacing)}),
                           });
...
TEST_F(InspectorGetEntryPointTest, SampleIndexSimpleReferenced) {
    Func("ep_func",
         tint::Vector{
             Param("in_var", ty.u32(), tint::Vector{Builtin(builtin::BuiltinValue::kSampleIndex)}),
         },
         ty.void_(),
         tint::Vector{
             Return(),
    ...
    Func("ep_func",
         tint::Vector{
             Param("in_var", ty.vec3<u32>(),
                   tint::Vector{Builtin(builtin::BuiltinValue::kNumWorkgroups)}),
         },
         ty.void_(),
         tint::Vector{
             Return(),
         },
         tint::Vector{Stage(ast::PipelineStage::kCompute), WorkgroupSize(1_i)}, tint::Empty);
...
TEST_F(InspectorGetEntryPointTest, ImplicitInterpolate) {
    Structure("in_struct", tint::Vector{
                               Member("struct_inner", ty.f32(), tint::Vector{Location(0_a)}),
                           });
    ...
    Structure(
        ...
        tint::Vector{
            Member("struct_inner", ty.f32(),
                   tint::Vector{Interpolate(params.in_type, params.in_sampling), Location(0_a)}),
        });
...
TEST_F(InspectorGetStorageSizeTest, Simple_Struct) {
    auto* ub_struct_type = MakeUniformBufferType("ub_type", tint::Vector{
                                                                ty.i32(),
                                                                ty.i32(),
                                                            });
    ...
    auto sb = MakeStorageBufferTypes("sb_type", tint::Vector{
                                                    ty.i32(),
                                                });
    ...
    auto ro_sb = MakeStorageBufferTypes("rosb_type", tint::Vector{
                                                         ty.i32(),
                                                     });
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("ub_func"), "sb_func", "rosb_func"},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
...
TEST_F(InspectorGetUniformBufferResourceBindingsTest, ContainingArray) {
    ...
    auto* foo_struct_type = Structure("foo_type", tint::Vector{
                                                      Member("0i32", ty.i32()),
                                                      Member("b",
                                                             ty.array<u32, 4>(tint::Vector{
                                                                 Stride(16),
                                                             }),
                                                             tint::Vector{
                                                                 MemberAlign(16_i),
...
TEST_F(InspectorGetStorageBufferResourceBindingsTest, Simple_NonStruct) {
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("sb_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kFragment),
                           });
...
TEST_F(InspectorGetStorageBufferResourceBindingsTest, Simple_Struct) {
    auto foo_struct_type = MakeStorageBufferTypes("foo_type", tint::Vector{
                                                                  ty.i32(),
                                                              });
...
TEST_F(InspectorGetStorageBufferResourceBindingsTest, MultipleStorageBuffers) {
    auto sb_struct_type = MakeStorageBufferTypes("sb_type", tint::Vector{
                                                                ty.i32(),
                                                                ty.u32(),
                                                                ty.f32(),
                                                            });
...
TEST_F(InspectorGetSamplerResourceBindingsTest, InFunction) {
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("foo_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kFragment),
                           });
...
TEST_F(InspectorGetStorageTextureResourceBindingsTest, Empty) {
    MakeEmptyBodyFunction("ep", tint::Vector{
                                    Stage(ast::PipelineStage::kFragment),
                                });
...
fn main(@location(0) fragUV: vec2<f32>,
  ...
  return textureSample(myTexture, mySampler, fragUV) * fragPosition;
    ...
    EXPECT_EQ((tint::Vector<sem::SamplerTexturePair, 4>(result_0)),
              (tint::Vector<sem::SamplerTexturePair, 4>(result_1)));
}
...
TEST_F(InspectorGetWorkgroupStorageSizeTest, Simple) {
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("f32_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
...
TEST_F(InspectorGetWorkgroupStorageSizeTest, CompoundTypes) {
    ...
    auto* wg_struct_type = MakeStructType("WgStruct", tint::Vector{
                                                          ty.i32(),
                                                          ty.array<i32, 4>(tint::Vector{
                                                              Stride(16),
                                                          }),
                                                      });
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("wg_struct_func"), "f32_func"},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
...
TEST_F(InspectorGetWorkgroupStorageSizeTest, AlignmentPadding) {
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("wg_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
...
TEST_F(InspectorGetWorkgroupStorageSizeTest, StructAlignment) {
    ...
    const auto* wg_struct_type = MakeStructTypeFromMembers(
        "WgStruct", tint::Vector{
                        MakeStructMember(0, ty.f32(), tint::Vector{MemberAlign(1024_i)}),
                    });
    ...
    MakeCallerBodyFunction("ep_func", tint::Vector{std::string("wg_struct_func")},
                           tint::Vector{
                               Stage(ast::PipelineStage::kCompute),
                               WorkgroupSize(1_i),
                           });
