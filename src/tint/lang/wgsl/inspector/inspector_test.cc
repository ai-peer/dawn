...
TEST_F(InspectorGetEntryPointTest, PixelLocalMemberTypes) {
    ...
    ASSERT_EQ(1u, result.size());
    EXPECT_EQ(4u, result[0].pixel_local_members.size());
    EXPECT_EQ(PixelLocalMemberType::kU32, result[0].pixel_local_members[0]);
    EXPECT_EQ(PixelLocalMemberType::kF32, result[0].pixel_local_members[1]);
    EXPECT_EQ(PixelLocalMemberType::kI32, result[0].pixel_local_members[2]);
    EXPECT_EQ(PixelLocalMemberType::kU32, result[0].pixel_local_members[3]);
}
