...
struct Allocator {
  ...
  private:
    utils::BlockAllocator<ast::Node> alloc;
};

struct TestNode : public utils::Castable<TestNode, ast::Node> {
    ...
    utils::Vector<const TestNode*, 8> vec;
...
struct Replaceable : public utils::Castable<Replaceable, TestNode> {
...
struct IDTestNode : public utils::Castable<IDTestNode, ast::Node> {
...
using CloneContextTestNodeTest = ::testing::Test;

TEST_F(CloneContextTestNodeTest, Clone) {
    Allocator alloc;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplaceAll_TestNode) {
    Allocator alloc;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplaceAll_Symbols) {
    Allocator alloc;
...
TEST_F(CloneContextTestNodeTest, CloneWithoutTransform) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplacePointer) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithRepeatedImmediateReplacePointer) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplaceFunction) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithRepeatedImmediateReplaceFunction) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithRemove) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertFront) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertFrontFunction) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertFront_Empty) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertFront_Empty_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBack) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBack_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBack_Empty) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBack_Empty_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertFrontAndBack_Empty) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertFrontAndBack_Empty_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBefore) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBefore_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertAfter) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertAfter_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertAfterInVectorNodeClone) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertAfterInVectorNodeClone_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBackInVectorNodeClone) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBackInVectorNodeClone_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBeforeAndAfterRemoved) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithInsertBeforeAndAfterRemoved_Function) {
    Allocator a;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplaceAll_SameTypeTwice) {
    std::string Testnode_name = utils::TypeInfo::Of<TestNode>().name;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplaceAll_BaseThenDerived) {
    std::string Testnode_name = utils::TypeInfo::Of<TestNode>().name;
...
TEST_F(CloneContextTestNodeTest, CloneWithReplaceAll_DerivedThenBase) {
    std::string Testnode_name = utils::TypeInfo::Of<TestNode>().name;
    std::string replaceable_name = utils::TypeInfo::Of<Replaceable>().name;
