...
struct Allocator {
  ...
  private:
    tint::BlockAllocator<Cloneable> alloc;
};

struct Node : public tint::Castable<Node, Cloneable> {
...
struct Replaceable : public tint::Castable<Replaceable, Node> {
...
struct Replacement : public tint::Castable<Replacement, Replaceable> {
    Replacement(Allocator* alloc, Symbol n) : Base(alloc, n) {}
};

struct NotANode : public tint::Castable<NotANode, Cloneable> {
...
struct ProgramNode : public tint::Castable<ProgramNode, Cloneable> {
