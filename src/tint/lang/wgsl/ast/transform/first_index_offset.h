...
/// ```
///
class FirstIndexOffset final : public tint::Castable<FirstIndexOffset, Transform> {
  public:
    ...
    /// buffer.
    struct BindingPoint final : public tint::Castable<BindingPoint, Data> {
        /// Constructor
        BindingPoint();
    ...
    struct Data final : public tint::Castable<Data, transform::Data> {
        /// Constructor
