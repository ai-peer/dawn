...
class DecomposeMemoryAccess final : public tint::Castable<DecomposeMemoryAccess, Transform> {
  public:
    ...
    class Intrinsic final : public tint::Castable<Intrinsic, InternalAttribute> {
      public:
        /// Intrinsic op
        enum class Op {
            kLoad,
