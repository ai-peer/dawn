...
fn main() {
  var len : u32 = f(tex1, tex2, tex3);
    ...
    EXPECT_EQ(std::make_pair(TextureBuiltinsFromUniformOptions::DataType::TextureNumLevels, 0u),
              val->bindpoint_to_data.at(BindingPoint{0, 0}));
    EXPECT_EQ(std::make_pair(TextureBuiltinsFromUniformOptions::DataType::TextureNumLevels, 1u),
              val->bindpoint_to_data.at(BindingPoint{0, 1}));
    EXPECT_EQ(std::make_pair(TextureBuiltinsFromUniformOptions::DataType::TextureNumLevels, 2u),
