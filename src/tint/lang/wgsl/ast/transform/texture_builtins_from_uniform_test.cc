...
TEST_F(TextureBuiltinsFromUniformTest, ShouldRunEmptyModule) {
    ...
    cfg.bindpoint_to_index.emplace(sem::BindingPoint{0, 0}, 0);
...
//     TextureBuiltinsFromUniform::Config cfg({0, 30u});
//     cfg.bindpoint_to_index.emplace(sem::BindingPoint{0, 2u}, 0);
//     cfg.bindpoint_to_index.emplace(sem::BindingPoint{1u, 2u}, 1);
//     cfg.bindpoint_to_index.emplace(sem::BindingPoint{2u, 2u}, 2);
//     cfg.bindpoint_to_index.emplace(sem::BindingPoint{3u, 2u}, 3);
//     cfg.bindpoint_to_index.emplace(sem::BindingPoint{4u, 2u}, 4);
...
//     TextureBuiltinsFromUniform::Config cfg({0, 30u});
//     cfg.bindpoint_to_index.emplace(sem::BindingPoint{0, 2}, 0);
