...
@compute @workgroup_size(1)
fn main() {
  var len : u32 = tint_symbol_1.texture_builtin_value;
}
)";
...
@compute @workgroup_size(1)
fn main() {
  var samples : u32 = tint_symbol_1.texture_builtin_value;
}
)";
...
fn main() {
  var len : u32 = tint_symbol_1.texture_builtin_value;
  len = tint_symbol_1.texture_builtin_value;
}
)";
...
@compute @workgroup_size(1)
fn main() {
  var len : u32 = f(tex, tint_symbol_2.texture_builtin_value);
}
)";
...
@compute @workgroup_size(1)
fn main() {
  var len : u32 = f1(tex, tint_symbol_3.texture_builtin_value);
}
)";
...
fn f1(a : u32, t : texture_2d<f32>, tint_symbol_2 : u32) -> u32 {
  return ((a + f_nested(t, tex1, tint_symbol_2, tint_symbol_4.texture_builtin_value_3)) + tint_symbol_4.texture_builtin_value_2);
}

@compute @workgroup_size(1)
fn main() {
  _ = textureNumLayers(tex4);
  _ = f1(9u, tex0, tint_symbol_4.texture_builtin_value_1);
  _ = f_nested(tex2, tex2, tint_symbol_4.texture_builtin_value, tint_symbol_4.texture_builtin_value);
  _ = f_nested(tex1, tex0, tint_symbol_4.texture_builtin_value_3, tint_symbol_4.texture_builtin_value_1);
}
)";
...
fn main() {
  ...
  _ = tint_symbol_1.texture_builtin_value;
