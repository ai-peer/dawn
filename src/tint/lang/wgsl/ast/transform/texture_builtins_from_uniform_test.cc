...
fn f1(a : u32, t : texture_2d<f32>, tint_symbol_2 : u32) -> u32 {
  return ((a + f_nested(t, tex1, tint_symbol_2, tint_symbol_4.texture_builtin_values[0u][0u])) + tint_symbol_4.texture_builtin_values[0u][1u]);
}
...
fn main() {
  ...
  _ = f_nested(tex2, tex2, tint_symbol_4.texture_builtin_values[0u][3u], tint_symbol_4.texture_builtin_values[0u][3u]);
  _ = f_nested(tex1, tex0, tint_symbol_4.texture_builtin_values[0u][0u], tint_symbol_4.texture_builtin_values[0u][2u]);
}
)";
