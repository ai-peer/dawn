...
struct BuiltinPolyfill::State {
  ...
  private:
    ...
    tint::Hashmap<BinaryOpSignature, Symbol, 8> binary_op_polyfills;
    /// Polyfill builtins.
    tint::Hashmap<const sem::Builtin*, Symbol, 8> builtin_polyfills;
    /// Polyfill f32 conversion to i32 or u32 (or vectors of)
    tint::Hashmap<const type::Type*, Symbol, 2> f32_conv_polyfills;
            ...
            [&](const sem::ValueConversion* conv) {
                if (cfg.builtins.conv_f32_to_iu32) {
                    ...
                    if (tint::Is<type::F32>(src_ty->Elements(src_ty).type)) {
                        ...
                        if (tint::IsAnyOf<type::I32, type::U32>(
