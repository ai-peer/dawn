...
TEST_F(HoistToDeclBeforeTest, VarInit) {
    ...
    b.Func("f", tint::Empty, b.ty.void_(), tint::Vector{var});
...
TEST_F(HoistToDeclBeforeTest, ForLoopInit) {
    ...
    b.Func("f", tint::Empty, b.ty.void_(), tint::Vector{s});
...
TEST_F(HoistToDeclBeforeTest, ForLoopCond) {
    ...
    b.Func("f", tint::Empty, b.ty.void_(), tint::Vector{var, s});
...
TEST_F(HoistToDeclBeforeTest, Array1D) {
    ...
    b.Func("f", tint::Empty, b.ty.void_(), tint::Vector{var1, var2});
