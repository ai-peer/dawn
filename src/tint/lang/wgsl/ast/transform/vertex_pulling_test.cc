...
fn main(@builtin(vertex_index) tint_pulling_vertex_index : u32) -> @builtin(position) vec4<f32> {
  ...
  var rgb10a2 : vec4<f32>;
  {
    ...
    rgb10a2 = (vec4<f32>(((vec4<u32>(tint_pulling_vertex_buffer_0.tint_vertex_data[(buffer_array_base_0 + 16u)]) >> vec4<u32>(0u, 10u, 20u, 30u)) & vec4<u32>(1023u, 1023u, 1023u, 3u))) / vec4<f32>(1023.0f, 1023.0f, 1023.0f, 3.0f));
  }
  return vec4<f32>(0.0, 0.0, 0.0, 1.0);
}
)";
...
fn main(@builtin(vertex_index) tint_pulling_vertex_index : u32) -> @builtin(position) vec4<f32> {
  ...
  var rgb10a2 : vec4<f32>;
  {
    ...
    rgb10a2 = (vec4<f32>(((vec4<u32>(((tint_pulling_vertex_buffer_0.tint_vertex_data[(buffer_array_base_0 + 15u)] >> 24u) | (tint_pulling_vertex_buffer_0.tint_vertex_data[(buffer_array_base_0 + 16u)] << 8u))) >> vec4<u32>(0u, 10u, 20u, 30u)) & vec4<u32>(1023u, 1023u, 1023u, 3u))) / vec4<f32>(1023.0f, 1023.0f, 1023.0f, 3.0f));
  }
  return vec4<f32>(0.0, 0.0, 0.0, 1.0);
}
)";
...
fn main(
    ...
    @location(26) sclr_rgb10a2   :      f32 ,
    @location(27) vec2_rgb10a2   : vec2<f32>,
    @location(28) vec3_rgb10a2   : vec3<f32>,
  ) -> @builtin(position) vec4<f32> {
  return vec4<f32>(0.0, 0.0, 0.0, 1.0);
}
)";
...
fn main(@builtin(vertex_index) tint_pulling_vertex_index : u32) -> @builtin(position) vec4<f32> {
  ...
  var sclr_rgb10a2 : f32;
  var vec2_rgb10a2 : vec2<f32>;
  var vec3_rgb10a2 : vec3<f32>;
  {
    let buffer_array_base_0 = (tint_pulling_vertex_index * 64u);
    ...
    sclr_rgb10a2 = ((vec4<f32>(((vec4<u32>(tint_pulling_vertex_buffer_0.tint_vertex_data[(buffer_array_base_0 + 16u)]) >> vec4<u32>(0u, 10u, 20u, 30u)) & vec4<u32>(1023u, 1023u, 1023u, 3u))) / vec4<f32>(1023.0f, 1023.0f, 1023.0f, 3.0f))).x;
    vec2_rgb10a2 = ((vec4<f32>(((vec4<u32>(tint_pulling_vertex_buffer_0.tint_vertex_data[(buffer_array_base_0 + 16u)]) >> vec4<u32>(0u, 10u, 20u, 30u)) & vec4<u32>(1023u, 1023u, 1023u, 3u))) / vec4<f32>(1023.0f, 1023.0f, 1023.0f, 3.0f))).xy;
    vec3_rgb10a2 = ((vec4<f32>(((vec4<u32>(tint_pulling_vertex_buffer_0.tint_vertex_data[(buffer_array_base_0 + 16u)]) >> vec4<u32>(0u, 10u, 20u, 30u)) & vec4<u32>(1023u, 1023u, 1023u, 3u))) / vec4<f32>(1023.0f, 1023.0f, 1023.0f, 3.0f))).xyz;
  }
  return vec4<f32>(0.0, 0.0, 0.0, 1.0);
}
)";
    ...
    cfg.vertex_state = {
        {{256,
          VertexStepMode::kVertex,
          {
              ...
              {VertexFormat::kRgb10a2, 64, 26},   {VertexFormat::kRgb10a2, 64, 27},
              {VertexFormat::kRgb10a2, 64, 28},
          }}}};
