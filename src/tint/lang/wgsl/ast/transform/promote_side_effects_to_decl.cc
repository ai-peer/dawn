...
struct SimplifySideEffectStatements : tint::Castable<PromoteSideEffectsToDecl, Transform> {
...
struct DecomposeSideEffects : tint::Castable<PromoteSideEffectsToDecl, Transform> {
