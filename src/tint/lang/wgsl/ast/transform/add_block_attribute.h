...
class AddBlockAttribute final : public tint::Castable<AddBlockAttribute, Transform> {
  public:
    /// BlockAttribute is an InternalAttribute that is used to decorate a
    // structure that is used as a buffer in SPIR-V or GLSL.
    class BlockAttribute final : public tint::Castable<BlockAttribute, InternalAttribute> {
      public:
        /// Constructor
