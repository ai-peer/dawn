...
struct CanonicalizeEntryPointIO::State {
    ...
    void CreateInputStruct() {
        ...
        auto* in_struct = b.create<Struct>(b.Ident(struct_name), std::move(members), utils::Empty);
    ...
    Struct* CreateOutputStruct() {
        ...
        // Create the new struct type.
        auto* out_struct = b.create<Struct>(b.Ident(b.Sym()), std::move(members), utils::Empty);
    ...
    void Process() {
        ...
        auto* wrapper_func = b.create<Function>(b.Ident(name), wrapper_ep_parameters,
                                                b.ty(wrapper_ret_type()), b.Block(wrapper_body),
