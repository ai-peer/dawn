...
Transform::ApplyResult TruncateInterstageVariables::Apply(const Program* src,
    ...
    tint::Hashmap<const sem::Function*, Symbol, 4u> entry_point_functions_to_truncate_functions;
    tint::Hashmap<const sem::Struct*, TruncatedStructAndConverter, 4u>
    ...
    for (auto* func_ast : ctx.src->AST().Functions()) {
        ...
        tint::Hashset<const sem::StructMember*, 16u> omit_members;
