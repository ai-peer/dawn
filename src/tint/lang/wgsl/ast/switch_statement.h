...
/// A switch statement
class SwitchStatement final : public tint::Castable<SwitchStatement, Statement> {
  public:
    /// Constructor
    ...
    SwitchStatement(GenerationID pid,
                    ...
                    tint::VectorRef<const CaseStatement*> body,
                    tint::VectorRef<const Attribute*> stmt_attributes,
                    tint::VectorRef<const Attribute*> body_attributes);
