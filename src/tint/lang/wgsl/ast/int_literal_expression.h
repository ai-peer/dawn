...
class IntLiteralExpression final : public tint::Castable<IntLiteralExpression, LiteralExpression> {
  public:
    /// Literal suffix
    enum class Suffix {
        /// No suffix
...
tint::StringStream& operator<<(tint::StringStream& out, IntLiteralExpression::Suffix suffix);
