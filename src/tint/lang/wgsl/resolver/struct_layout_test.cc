...
TEST_F(ResolverStructLayoutTest, ExplicitStrideArrayStaticSize) {
    ...
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.array<i32, 3>(tint::Vector{Stride(8)})),
                                 Member("b", ty.array<f32, 5>(tint::Vector{Stride(16)})),
                                 Member("c", ty.array<f16, 7>(tint::Vector{Stride(4)})),
                                 Member("d", ty.array<f32, 1>(tint::Vector{Stride(32)})),
                             });
...
TEST_F(ResolverStructLayoutTest, ExplicitStrideArrayRuntimeSized) {
    auto* s = Structure("S", tint::Vector{
                                 Member("c", ty.array<f32>(tint::Vector{Stride(32)})),
                             });
...
TEST_F(ResolverStructLayoutTest, ImplicitStrideArrayOfExplicitStrideArray) {
    auto inner = ty.array<i32, 2>(tint::Vector{Stride(16)});  // size: 32
...
TEST_F(ResolverStructLayoutTest, ImplicitStrideArrayOfStructure) {
    auto* inner = Structure("Inner", tint::Vector{
...
TEST_F(ResolverStructLayoutTest, SizeAttributes) {
    auto* inner = Structure("Inner", tint::Vector{
                                         Member("a", ty.f32(), tint::Vector{MemberSize(8_a)}),
                                         Member("b", ty.f32(), tint::Vector{MemberSize(16_a)}),
                                         Member("c", ty.f32(), tint::Vector{MemberSize(8_a)}),
                                     });
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.f32(), tint::Vector{MemberSize(4_a)}),
                                 Member("b", ty.u32(), tint::Vector{MemberSize(8_a)}),
                                 Member("c", ty.Of(inner)),
                                 Member("d", ty.i32(), tint::Vector{MemberSize(32_a)}),
                             });
...
TEST_F(ResolverStructLayoutTest, AlignAttributes) {
    auto* inner = Structure("Inner", tint::Vector{
                                         Member("a", ty.f32(), tint::Vector{MemberAlign(8_i)}),
                                         Member("b", ty.f32(), tint::Vector{MemberAlign(16_i)}),
                                         Member("c", ty.f32(), tint::Vector{MemberAlign(4_i)}),
                                     });
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.f32(), tint::Vector{MemberAlign(4_i)}),
                                 Member("b", ty.u32(), tint::Vector{MemberAlign(8_i)}),
                                 Member("c", ty.Of(inner)),
                                 Member("d", ty.i32(), tint::Vector{MemberAlign(32_i)}),
                             });
...
TEST_F(ResolverStructLayoutTest, StructWithLotsOfPadding) {
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.i32(), tint::Vector{MemberAlign(1024_i)}),
                             });
...
TEST_F(ResolverStructLayoutTest, OffsetAttributes) {
    auto* inner = Structure("Inner", tint::Vector{
                                         Member("a", ty.f32(), tint::Vector{MemberOffset(8_i)}),
                                         Member("b", ty.f32(), tint::Vector{MemberOffset(16_i)}),
                                         Member("c", ty.f32(), tint::Vector{MemberOffset(32_i)}),
                                     });
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.f32(), tint::Vector{MemberOffset(4_i)}),
                                 Member("b", ty.u32(), tint::Vector{MemberOffset(8_i)}),
                                 Member("c", ty.Of(inner), tint::Vector{MemberOffset(32_i)}),
                                 Member("d", ty.i32()),
                                 Member("e", ty.i32(), tint::Vector{MemberOffset(128_i)}),
                             });
