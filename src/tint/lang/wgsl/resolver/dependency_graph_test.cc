...
struct SymbolTestHelper {
    ...
    tint::Vector<const ast::Parameter*, 8> parameters;
    /// Shallow function var / let declaration statements
    tint::Vector<const ast::Statement*, 8> statements;
    /// Nested function local var / let declaration statements
    tint::Vector<const ast::Statement*, 8> nested_statements;
    /// Function attributes
    tint::Vector<const ast::Attribute*, 8> func_attrs;
...
const ast::Node* SymbolTestHelper::Add(SymbolDeclKind kind, Symbol symbol, Source source = {}) {
    ...
    switch (kind) {
        ...
        case SymbolDeclKind::Struct:
            return b.Structure(source, symbol, tint::Vector{b.Member("m", b.ty.i32())});
        case SymbolDeclKind::Function:
...
const ast::Identifier* SymbolTestHelper::Add(SymbolUseKind kind,
    ...
    switch (kind) {
        ...
        case SymbolUseKind::StructMemberType: {
            auto node = b.ty(source, symbol);
            b.Structure(b.Sym(), tint::Vector{b.Member("m", node)});
            return node->identifier;
        }
        case SymbolUseKind::CallFunction: {
...
TEST_F(ResolverDependencyGraphUsedBeforeDeclTest, FuncCall) {
    ...
    Func("A", tint::Empty, ty.void_(), tint::Vector{CallStmt(Call(Ident(Source{{12, 34}}, "B")))});
    Func(Source{{56, 78}}, "B", tint::Empty, ty.void_(), tint::Vector{Return()});
...
TEST_F(ResolverDependencyGraphUsedBeforeDeclTest, TypeConstructed) {
    ...
    Func("F", tint::Empty, ty.void_(),
         tint::Vector{Block(Ignore(Call(Ident(Source{{12, 34}}, "T"))))});
...
TEST_F(ResolverDependencyGraphUsedBeforeDeclTest, TypeUsedByLocal) {
    ...
    Func("F", tint::Empty, ty.void_(),
         tint::Vector{Block(Decl(Var("v", ty(Source{{12, 34}}, "T"))))});
    Alias(Source{{56, 78}}, "T", ty.i32());
...
TEST_F(ResolverDependencyGraphUsedBeforeDeclTest, TypeUsedByParam) {
    ...
    Func("F", tint::Vector{Param("p", ty(Source{{12, 34}}, "T"))}, ty.void_(), tint::Empty);
    Alias(Source{{56, 78}}, "T", ty.i32());
...
TEST_F(ResolverDependencyGraphUsedBeforeDeclTest, TypeByStructMember) {
    ...
    Structure("S", tint::Vector{Member("m", ty(Source{{12, 34}}, "T"))});
    Alias(Source{{56, 78}}, "T", ty.i32());
...
TEST_F(ResolverDependencyGraphCyclicRefTest, DirectCall) {
    ...
    Func(Source{{12, 34}}, "main", tint::Empty, ty.void_(),
         tint::Vector{CallStmt(Call(Ident(Source{{56, 78}}, "main")))});
...
TEST_F(ResolverDependencyGraphCyclicRefTest, IndirectCall) {
    ...
    Func(Source{{1, 1}}, "a", tint::Empty, ty.void_(),
         tint::Vector{CallStmt(Call(Ident(Source{{1, 10}}, "b")))});
    ...
    Func(Source{{4, 1}}, "c", tint::Empty, ty.void_(),
         tint::Vector{CallStmt(Call(Ident(Source{{4, 10}}, "d")))});
    Func(Source{{5, 1}}, "b", tint::Empty, ty.void_(),
         tint::Vector{CallStmt(Call(Ident(Source{{5, 10}}, "c")))});
...
TEST_F(ResolverDependencyGraphCyclicRefTest, Struct_Direct) {
    ...
    Structure(Source{{12, 34}}, "S", tint::Vector{Member("a", ty(Source{{56, 78}}, "S"))});
...
TEST_F(ResolverDependencyGraphCyclicRefTest, Struct_Indirect) {
    ...
    Structure(Source{{1, 1}}, "Y", tint::Vector{Member("z", ty(Source{{1, 10}}, "Z"))});
    Structure(Source{{2, 1}}, "X", tint::Vector{Member("y", ty(Source{{2, 10}}, "Y"))});
    Structure(Source{{3, 1}}, "Z", tint::Vector{Member("x", ty(Source{{3, 10}}, "X"))});
...
TEST_F(ResolverDependencyGraphCyclicRefTest, Mixed_RecursiveDependencies) {
    ...
    Func(Source{{1, 1}}, "F", tint::Empty, ty(Source{{1, 5}}, "R"),
         tint::Vector{Return(Expr(Source{{1, 10}}, "Z"))});
    Alias(Source{{2, 1}}, "A", ty(Source{{2, 10}}, "S"));
    Structure(Source{{3, 1}}, "S", tint::Vector{Member("a", ty(Source{{3, 10}}, "A"))});
...
TEST_P(ResolverDependencyGraphShadowKindTest, ShadowedByStruct) {
    ...
    SymbolTestHelper helper(this);
    auto* decl = Structure(symbol, tint::Vector{
...
TEST_F(ResolverDependencyGraphTraversalTest, SymbolsReached) {
    ...
    tint::Vector<SymbolUse, 64> symbol_uses;
...
#define F add_use(func_decl, Ident(func_sym), __LINE__, "F()")
    ...
    Func(Sym(),
         ...
         tint::Vector{Location(V)});  // return attributes
    ...
    GlobalVar(Sym(), ty.i32(), tint::Vector{Binding(V), Group(V)});
    GlobalVar(Sym(), ty.i32(), tint::Vector{Location(V)});
    Override(Sym(), ty.i32(), tint::Vector{Id(V)});
...
TEST_F(ResolverDependencyGraphTraversalTest, chromium_1273451) {
    Structure("A", tint::Vector{Member("a", ty.i32())});
    Structure("B", tint::Vector{Member("b", ty.i32())});
    Func("f", tint::Vector{Param("a", ty("A"))}, ty("B"),
         tint::Vector{
             Return(Call("B")),
         });
    Build();
