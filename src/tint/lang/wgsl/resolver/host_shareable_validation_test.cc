...
TEST_F(ResolverHostShareableValidationTest, BoolMember) {
    auto* s =
        Structure("S", tint::Vector{Member(Source{{56, 78}}, "x", ty.bool_(Source{{12, 34}}))});
...
TEST_F(ResolverHostShareableValidationTest, BoolVectorMember) {
    auto* s = Structure(
        "S", tint::Vector{Member(Source{{56, 78}}, "x", ty.vec3<bool>(Source{{12, 34}}))});
...
TEST_F(ResolverHostShareableValidationTest, Aliases) {
    Alias("a1", ty.bool_());
    auto* s =
        Structure("S", tint::Vector{Member(Source{{56, 78}}, "x", ty(Source{{12, 34}}, "a1"))});
...
TEST_F(ResolverHostShareableValidationTest, NestedStructures) {
    auto* i1 = Structure("I1", tint::Vector{Member(Source{{1, 2}}, "x", ty.bool_())});
    auto* i2 = Structure("I2", tint::Vector{Member(Source{{3, 4}}, "y", ty.Of(i1))});
    auto* i3 = Structure("I3", tint::Vector{Member(Source{{5, 6}}, "z", ty.Of(i2))});

    auto* s = Structure("S", tint::Vector{Member(Source{{7, 8}}, "m", ty.Of(i3))});
...
TEST_F(ResolverHostShareableValidationTest, NoError) {
    ...
    auto* i1 = Structure("I1", tint::Vector{
    ...
    auto* i2 = Structure("I2", tint::Vector{
    ...
    auto* i3 = Structure("I3", tint::Vector{
