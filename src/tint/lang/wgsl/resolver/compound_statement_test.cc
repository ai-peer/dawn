...
TEST_F(ResolverCompoundStatementTest, FunctionBlock) {
    ...
    auto* f = Func("F", tint::Empty, ty.void_(), tint::Vector{stmt});
...
TEST_F(ResolverCompoundStatementTest, Block) {
    ...
    auto* f = Func("F", tint::Empty, ty.void_(), tint::Vector{block});
...
TEST_F(ResolverCompoundStatementTest, Loop) {
    ...
    auto* f = Func("F", tint::Empty, ty.void_(), tint::Vector{loop});
...
TEST_F(ResolverCompoundStatementTest, Loop_EmptyContinuing) {
    ...
    Func("F", tint::Empty, ty.void_(), tint::Vector{loop});
...
TEST_F(ResolverCompoundStatementTest, ForLoop) {
    ...
    auto* f = Func("F", tint::Empty, ty.void_(), tint::Vector{for_});
...
TEST_F(ResolverCompoundStatementTest, While) {
    ...
    auto* f = Func("W", tint::Empty, ty.void_(), tint::Vector{while_});
