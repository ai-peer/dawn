...
Validator::Validator(
    ...
    const tint::Hashmap<const type::Type*, const Source*, 8>& atomic_composite_info,
    tint::Hashset<TypeAndAddressSpace, 8>& valid_type_storage_layouts)
...
bool Validator::GlobalVariable(
    ...
    const tint::Hashmap<OverrideId, const sem::Variable*, 8>& override_ids) const {
...
bool Validator::EntryPoint(const sem::Function* func, ast::PipelineStage stage) const {
    ...
    tint::Hashset<builtin::BuiltinValue, 4> builtins;
    tint::Hashset<std::pair<uint32_t, uint32_t>, 8> locationsAndIndexes;
    ...
    auto validate_entry_point_attributes_inner = [&](tint::VectorRef<const ast::Attribute*> attrs,
    ...
    auto validate_entry_point_attributes = [&](tint::VectorRef<const ast::Attribute*> attrs,
                                               const type::Type* ty, Source source,
                                               ParamOrRetType param_or_ret,
                                               std::optional<uint32_t> location,
                                               std::optional<uint32_t> index) {
    ...
    tint::Hashmap<BindingPoint, const ast::Variable*, 8> binding_points;
    for (auto* global : func->TransitivelyReferencedGlobals()) {
...
bool Validator::Statements(tint::VectorRef<const ast::Statement*> stmts) const {
    for (auto* stmt : stmts) {
...
bool Validator::PipelineStages(tint::VectorRef<sem::Function*> entry_points) const {
...
bool Validator::PushConstants(tint::VectorRef<sem::Function*> entry_points) const {
    for (auto* entry_point : entry_points) {
...
bool Validator::SwitchStatement(const ast::SwitchStatement* s) {
    ...
    tint::Hashmap<int64_t, Source, 4> selectors;
...
bool Validator::NoDuplicateAttributes(tint::VectorRef<const ast::Attribute*> attributes) const {
    tint::Hashmap<const tint::TypeInfo*, Source, 8> seen;
...
bool Validator::DiagnosticControls(tint::VectorRef<const ast::DiagnosticControl*> controls,
    ...
    tint::Hashmap<std::pair<Symbol, Symbol>, const ast::DiagnosticControl*, 8> diagnostics;
...
bool Validator::IsValidationDisabled(tint::VectorRef<const ast::Attribute*> attributes,
...
bool Validator::IsValidationEnabled(tint::VectorRef<const ast::Attribute*> attributes,
                                    ast::DisabledValidation validation) const {
...
bool Validator::CheckTypeAccessAddressSpace(
    ...
    builtin::AddressSpace address_space,
    tint::VectorRef<const tint::ast::Attribute*> attributes,
    const Source& source) const {
