...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Add_AInt_Overflow) {
    ...
    auto result = const_eval.OpPlus(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Sub_AInt_Overflow) {
    ...
    auto* b = constants.Get(AInt(1));
    auto result = const_eval.OpMinus(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<AInt>(), 0);
    EXPECT_EQ(error(),
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Mul_AInt_Overflow) {
    ...
    auto result = const_eval.OpMultiply(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<AInt>(), 0);
    EXPECT_EQ(error(),
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Div_AInt_ZeroDenominator) {
    ...
    auto result = const_eval.OpDivide(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Mod_AInt_ZeroDenominator) {
    auto* a = constants.Get(AInt(42));
    auto* b = constants.Get(AInt(0));
    auto result = const_eval.OpModulo(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<AInt>(), 0);
    EXPECT_EQ(error(), R"(warning: '42 % 0' cannot be represented as 'abstract-int')");
}
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, ShiftLeft_AInt_SignChange) {
    ...
    auto result = const_eval.OpShiftLeft(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, ShiftRight_I32_MoreThanBitWidth) {
    ...
    auto* b = constants.Get(u32(33));
    auto result = const_eval.OpShiftRight(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Acos_F32_OutOfRange) {
    ...
    auto result = const_eval.acos(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
    EXPECT_EQ(error(),
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Acosh_F32_OutOfRange) {
    ...
    auto result = const_eval.acosh(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Asin_F32_OutOfRange) {
    auto* a = constants.Get(f32(2));
    auto result = const_eval.asin(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
    EXPECT_EQ(error(),
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Atanh_F32_OutOfRange) {
    auto* a = constants.Get(f32(2));
    auto result = const_eval.atanh(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
    EXPECT_EQ(error(),
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Exp_F32_Overflow) {
    ...
    auto result = const_eval.exp(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Exp2_F32_Overflow) {
    auto* a = constants.Get(f32(1000));
    auto result = const_eval.exp2(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, ExtractBits_I32_TooManyBits) {
    ...
    auto result = const_eval.extractBits(a->Type(), tint::Vector{a, offset, count}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, InsertBits_I32_TooManyBits) {
    ...
    auto* offset = constants.Get(u32(24));
    auto* count = constants.Get(u32(16));
    auto result = const_eval.insertBits(a->Type(), tint::Vector{a, b, offset, count}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, InverseSqrt_F32_OutOfRange) {
    auto* a = constants.Get(f32(-1));
    auto result = const_eval.inverseSqrt(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, LDExpr_F32_OutOfRange) {
    ...
    auto result = const_eval.ldexp(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Log_F32_OutOfRange) {
    auto* a = constants.Get(f32(-1));
    auto result = const_eval.log(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Log2_F32_OutOfRange) {
    auto* a = constants.Get(f32(-1));
    auto result = const_eval.log2(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Normalize_ZeroLength) {
    ...
    auto* vec =
        const_eval.VecSplat(create<type::Vector>(create<type::F32>(), 4u), tint::Vector{zero}, {})
            .Get();
    auto result = const_eval.normalize(vec->Type(), tint::Vector{vec}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Pack2x16Float_OutOfRange) {
    ...
    auto* vec =
        const_eval.VecInitS(create<type::Vector>(create<type::F32>(), 2u), tint::Vector{a, b}, {})
            .Get();
    auto result = const_eval.pack2x16float(create<type::U32>(), tint::Vector{vec}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Pow_F32_Overflow) {
    ...
    auto result = const_eval.pow(a->Type(), tint::Vector{a, b}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Unpack2x16Float_OutOfRange) {
    ...
    auto result = const_eval.unpack2x16float(create<type::U32>(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, QuantizeToF16_OutOfRange) {
    auto* a = constants.Get(f32(75250.f));
    auto result = const_eval.quantizeToF16(create<type::U32>(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<u32>(), 0);
    EXPECT_EQ(error(), R"(warning: value 75250.0 cannot be represented as 'f16')");
}
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Sqrt_F32_OutOfRange) {
    auto* a = constants.Get(f32(-1));
    auto result = const_eval.sqrt(a->Type(), tint::Vector{a}, {});
    ASSERT_TRUE(result);
    EXPECT_EQ(result.Get()->ValueAs<f32>(), 0.f);
...
TEST_F(ResolverConstEvalRuntimeSemanticsTest, Clamp_F32_LowGreaterThanHigh) {
    ...
    auto result = const_eval.clamp(e->Type(), tint::Vector{e, low, high}, {});
    ASSERT_TRUE(result);
