...
TEST_P(ResolverBuiltinsStageTest, All_input) {
    ...
    auto* input =
        Param("input", params.type(*this), tint::Vector{Builtin(Source{{12, 34}}, params.builtin)});
    switch (params.stage) {
        case ast::PipelineStage::kVertex:
            Func("main", tint::Vector{input}, ty.vec4<f32>(), tint::Vector{Return(p)},
                 tint::Vector{Stage(ast::PipelineStage::kVertex)},
                 tint::Vector{
                     Builtin(Source{{12, 34}}, builtin::BuiltinValue::kPosition),
                 });
            break;
        case ast::PipelineStage::kFragment:
            Func("main", tint::Vector{input}, ty.void_(), tint::Empty,
                 tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, StructBuiltinInsideEntryPoint_Ignored) {
    ...
    Func("fragShader", tint::Empty, ty.void_(), tint::Vector{Decl(Var("s", ty("S")))},
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         });
...
TEST_F(ResolverBuiltinsValidationTest, FragDepthNotF32_Struct_Fail) {
    ...
    Func("fragShader", tint::Vector{Param("arg", ty.Of(s))}, ty.f32(),
         tint::Vector{
             Return(1_f),
         },
         tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, SampleMaskNotU32_ReturnType_Fail) {
    ...
    Func("main", tint::Empty, ty.i32(), tint::Vector{Return(1_i)},
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         },
         tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, VertexIndexIsNotU32_Fail) {
    ...
    Func("main", tint::Vector{vi, p}, ty.vec4<f32>(), tint::Vector{Return(Expr("p"))},
         tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, InstanceIndexIsNotU32) {
    ...
    Func("main", tint::Vector{ii, p}, ty.vec4<f32>(), tint::Vector{Return(Expr("p"))},
         tint::Vector{
             Stage(ast::PipelineStage::kVertex),
         },
         tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, FragmentBuiltin_Pass) {
    ...
    Func("fs_main", tint::Vector{p, ff, si, sm}, ty.f32(),
         tint::Vector{
             Decl(var_fd),
             Return(var_fd),
         },
...
TEST_F(ResolverBuiltinsValidationTest, VertexBuiltin_Pass) {
    ...
    Func("main", tint::Vector{vi, ii}, ty.vec4<f32>(),
         tint::Vector{
             Decl(p),
             Return(p),
         },
...
TEST_F(ResolverBuiltinsValidationTest, ComputeBuiltin_Pass) {
    ...
    Func("main", tint::Vector{li_id, li_index, gi, wi, nwgs}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute),
...
TEST_F(ResolverBuiltinsValidationTest, ComputeBuiltin_WorkGroupIdNotVec3U32) {
    ...
    Func("main", tint::Vector{wi}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute),
                      WorkgroupSize(Expr(Source{Source::Location{12, 34}}, 2_i))});
...
TEST_F(ResolverBuiltinsValidationTest, ComputeBuiltin_NumWorkgroupsNotVec3U32) {
    ...
    Func("main", tint::Vector{nwgs}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute),
                      WorkgroupSize(Expr(Source{Source::Location{12, 34}}, 2_i))});
...
TEST_F(ResolverBuiltinsValidationTest, ComputeBuiltin_GlobalInvocationNotVec3U32) {
    ...
    Func("main", tint::Vector{gi}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute),
                      WorkgroupSize(Expr(Source{Source::Location{12, 34}}, 2_i))});
...
TEST_F(ResolverBuiltinsValidationTest, ComputeBuiltin_LocalInvocationIndexNotU32) {
    ...
    Func("main", tint::Vector{li_index}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute),
                      WorkgroupSize(Expr(Source{Source::Location{12, 34}}, 2_i))});
...
TEST_F(ResolverBuiltinsValidationTest, ComputeBuiltin_LocalInvocationNotVec3U32) {
    ...
    Func("main", tint::Vector{li_id}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute),
                      WorkgroupSize(Expr(Source{Source::Location{12, 34}}, 2_i))});
...
TEST_F(ResolverBuiltinsValidationTest, FragmentBuiltinStruct_Pass) {
    ...
    auto* s = Structure("MyInputs", tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, FrontFacingParamIsNotBool_Fail) {
    ...
    Func("fs_main", tint::Vector{is_front}, ty.f32(),
         tint::Vector{
             Return(1_f),
         },
         tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, FrontFacingMemberIsNotBool_Fail) {
    ...
    Func("fragShader", tint::Vector{Param("is_front", ty.Of(s))}, ty.f32(),
         tint::Vector{
             Return(1_f),
         },
         tint::Vector{
...
TEST_F(ResolverBuiltinsValidationTest, StructMemberAttributeMapsToSemBuiltinEnum) {
    ...
    auto* s = Structure("S", tint::Vector{
                                 Member("f", ty.bool_(), tint::Vector{builtin}),
                             });
    Func("f", tint::Vector{Param("b", ty.Of(s))}, ty.void_(), tint::Empty,
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         });
...
TEST_F(ResolverBuiltinsValidationTest, ParamAttributeMapsToSemBuiltinEnum) {
    ...
    auto* builtin = Builtin(builtin::BuiltinValue::kFrontFacing);
    Func("f", tint::Vector{Param("b", ty.bool_(), tint::Vector{builtin})}, ty.void_(), tint::Empty,
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         });
...
TEST_P(FloatAllMatching, Scalar) {
    ...
    tint::Vector<const ast::Expression*, 8> params;
