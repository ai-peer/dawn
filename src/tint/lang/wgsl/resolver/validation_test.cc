...
class FakeStmt final : public tint::Castable<FakeStmt, ast::Statement> {
  public:
    FakeStmt(GenerationID pid, ast::NodeID nid, Source src) : Base(pid, nid, src) {}
    FakeStmt* Clone(CloneContext*) const override { return nullptr; }
};

class FakeExpr final : public tint::Castable<FakeExpr, ast::Expression> {
  public:
...
TEST_F(ResolverValidationTest, WorkgroupMemoryUsedInFragmentStage) {
    ...
    Func(Source{{5, 6}}, "f2", tint::Empty, ty.void_(), tint::Vector{stmt});
    Func(Source{{7, 8}}, "f1", tint::Empty, ty.void_(),
         tint::Vector{
             CallStmt(Call("f2")),
         });
    Func(Source{{9, 10}}, "f0", tint::Empty, ty.void_(), tint::Vector{CallStmt(Call("f1"))},
         tint::Vector{
...
TEST_F(ResolverValidationTest, EXpr_MemberAccessor_FuncGoodParent) {
    ...
    Func("func", tint::Vector{p}, ty.f32(),
         tint::Vector{
             Decl(x),
             Return(x),
         });
...
TEST_F(ResolverTest, Stmt_ForLoop_DiscardInContinuing_Direct) {
    ...
    Func("my_func", tint::Empty, ty.void_(),
         tint::Vector{For(nullptr, nullptr, Discard(Source{{12, 34}}),  //
                           Block(Break()))});
...
TEST_F(ResolverValidationTest, NegativeStructMemberAlignAttribute) {
    Structure("S", tint::Vector{
                       Member("a", ty.f32(), tint::Vector{MemberAlign(Source{{12, 34}}, -2_i)}),
                   });
...
TEST_F(ResolverValidationTest, NonPOTStructMemberAlignAttribute) {
    Structure("S", tint::Vector{
                       Member("a", ty.f32(), tint::Vector{MemberAlign(Source{{12, 34}}, 3_i)}),
                   });
...
TEST_F(ResolverValidationTest, ZeroStructMemberAlignAttribute) {
    Structure("S", tint::Vector{
                       Member("a", ty.f32(), tint::Vector{MemberAlign(Source{{12, 34}}, 0_i)}),
                   });
...
TEST_F(ResolverValidationTest, ZeroStructMemberSizeAttribute) {
    Structure("S", tint::Vector{
                       Member("a", ty.f32(), tint::Vector{MemberSize(Source{{12, 34}}, 1_a)}),
                   });
...
TEST_F(ResolverValidationTest, OffsetAndSizeAttribute) {
    Structure("S", tint::Vector{
                       Member(Source{{12, 34}}, "a", ty.f32(),
                              tint::Vector{MemberOffset(0_a), MemberSize(4_a)}),
                   });
...
TEST_F(ResolverValidationTest, OffsetAndAlignAttribute) {
    Structure("S", tint::Vector{
                       Member(Source{{12, 34}}, "a", ty.f32(),
                              tint::Vector{MemberOffset(0_a), MemberAlign(4_i)}),
                   });
...
TEST_F(ResolverValidationTest, OffsetAndAlignAndSizeAttribute) {
    Structure("S", tint::Vector{
                       Member(Source{{12, 34}}, "a", ty.f32(),
                              tint::Vector{MemberOffset(0_a), MemberAlign(4_i), MemberSize(4_a)}),
                   });
