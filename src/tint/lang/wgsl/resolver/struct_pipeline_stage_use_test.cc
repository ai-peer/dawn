...
TEST_F(ResolverPipelineStageUseTest, UnusedStruct) {
    auto* s = Structure("S", tint::Vector{Member("a", ty.f32(), tint::Vector{Location(0_a)})});
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsNonEntryPointParam) {
    ...
    Func("foo", tint::Vector{Param("param", ty.Of(s))}, ty.void_(), tint::Empty, tint::Empty);
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsNonEntryPointReturnType) {
    ...
    Func("foo", tint::Empty, ty.Of(s), tint::Vector{Return(Call(ty.Of(s), Expr(0_f)))},
         tint::Empty);
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsVertexShaderParam) {
    ...
    Func("main", tint::Vector{Param("param", ty.Of(s))}, ty.vec4<f32>(),
         tint::Vector{Return(Call<vec4<f32>>())}, tint::Vector{Stage(ast::PipelineStage::kVertex)},
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsVertexShaderReturnType) {
    auto* s = Structure(
        "S", tint::Vector{Member("a", ty.vec4<f32>(),
                                 tint::Vector{Builtin(builtin::BuiltinValue::kPosition)})});

    Func("main", tint::Empty, ty.Of(s), tint::Vector{Return(Call(ty.Of(s)))},
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsFragmentShaderParam) {
    ...
    Func("main", tint::Vector{Param("param", ty.Of(s))}, ty.void_(), tint::Empty,
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsFragmentShaderReturnType) {
    ...
    Func("main", tint::Empty, ty.Of(s), tint::Vector{Return(Call(ty.Of(s), Expr(0_f)))},
         tint::Vector{Stage(ast::PipelineStage::kFragment)});
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsComputeShaderParam) {
    auto* s = Structure(
        "S",
        tint::Vector{Member("a", ty.u32(),
                            tint::Vector{Builtin(builtin::BuiltinValue::kLocalInvocationIndex)})});
...
TEST_F(ResolverPipelineStageUseTest, StructUsedMultipleStages) {
    ...
    Func("vert_main", tint::Empty, ty.Of(s), tint::Vector{Return(Call(ty.Of(s)))},
         tint::Vector{Stage(ast::PipelineStage::kVertex)});

    Func("frag_main", tint::Vector{Param("param", ty.Of(s))}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kFragment)});
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsShaderParamViaAlias) {
    ...
    Func("main", tint::Vector{Param("param", ty.Of(s_alias))}, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kFragment)});
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsShaderParamLocationSet) {
    auto* s = Structure("S", tint::Vector{Member("a", ty.f32(), tint::Vector{Location(3_a)})});
...
TEST_F(ResolverPipelineStageUseTest, StructUsedAsShaderReturnTypeViaAlias) {
    ...
    Func("main", tint::Empty, ty.Of(s_alias), tint::Vector{Return(Call(ty.Of(s_alias), Expr(0_f)))},
         tint::Vector{Stage(ast::PipelineStage::kFragment)});
