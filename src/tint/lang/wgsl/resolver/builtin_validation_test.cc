...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastWithoutExtension) {
    ...
    Func("func", tint::Empty, ty.i32(),
         Vector{
             Return(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", i32(1), i32(0))),
         });
...
TEST_F(ResolverBuiltinValidationTest, SubroupBroadcastInVertexStageIsError) {
    ...
    Func(Source{{1, 2}}, "func", tint::Empty, ty.vec4<f32>(),
         Vector{Ignore(call), Return(Call(ty.vec4<f32>()))},
         Vector{
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastTooFewArgs) {
    ...
    Func("func", tint::Empty, ty.i32(),
         Vector{
             Return(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", i32(1))),
         });
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastTooManyArgs) {
    ...
    Func("func", tint::Empty, ty.i32(),
         Vector{
             Return(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", i32(1), i32(1),
                         i32(1))),
         });
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastValueF32) {
    ...
    Func("func", tint::Empty, ty.f32(),
         Vector{
             Return(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", f32(1), i32(0))),
         });
    EXPECT_TRUE(r()->Resolve());
}
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastValueU32) {
    ...
    Func("func", tint::Empty, ty.u32(),
         Vector{
             Return(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", u32(1), i32(0))),
         });
    EXPECT_TRUE(r()->Resolve());
}
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastValueBoolIsError) {
    ...
    Func("func", tint::Empty, ty.bool_(),
         Vector{
             Return(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", value, i32(0))),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(),
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastValueF32ResultTypeDifferentIsError) {
    ...
    Func("func", tint::Empty, ty.i32(),
         Vector{
             Return(Source{Source::Location{12, 34}}, Call("subgroupBroadcast", f32(1), i32(0))),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastValueI32ResultTypeDifferentIsError) {
    ...
    Func("func", tint::Empty, ty.u32(),
         Vector{
             Return(Source{Source::Location{12, 34}}, Call("subgroupBroadcast", i32(1), i32(0))),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastValueU32ResultTypeDifferentIsError) {
    ...
    Func("func", tint::Empty, ty.f32(),
         Vector{
             Return(Source{Source::Location{12, 34}}, Call("subgroupBroadcast", u32(1), i32(0))),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastLaneArgMustBeConst) {
    ...
    Func("func", tint::Empty, ty.void_(),
         Vector{
             Decl(Let("lane", Expr(u32(1)))),
             Ignore(Call("subgroupBroadcast", f32(1),
                         Ident(Source{Source::Location{12, 34}}, "lane"))),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastLaneArgI32) {
    ...
    Func("func", tint::Empty, ty.void_(),
         Vector{
             Ignore(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", f32(1), i32(0))),
         });
    EXPECT_TRUE(r()->Resolve());
}
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastLaneArgU32) {
    ...
    Func("func", tint::Empty, ty.void_(),
         Vector{
             Ignore(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", f32(1), u32(0))),
         });
    EXPECT_TRUE(r()->Resolve());
}
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastLaneArgF32IsError) {
    ...
    Func("func", tint::Empty, ty.void_(),
         Vector{
             Decl(Let("lane", Expr(u32(1)))),
             Ignore(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", f32(1), f32(0))),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(),
...
TEST_F(ResolverBuiltinValidationTest, SubgroupBroadcastLaneArgBoolIsError) {
    ...
    Func("func", tint::Empty, ty.void_(),
         Vector{
             Decl(Let("lane", Expr(u32(1)))),
             Ignore(Call(Source{Source::Location{12, 34}}, "subgroupBroadcast", f32(1), value)),
         });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(),
