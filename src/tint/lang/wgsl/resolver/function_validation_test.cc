...
TEST_F(ResolverFunctionValidationTest, DuplicateParameterName) {
    ...
    Func("func_a", tint::Vector{Param("common_name", ty.f32())}, ty.void_(), tint::Empty);
    Func("func_b", tint::Vector{Param("common_name", ty.f32())}, ty.void_(), tint::Empty);
...
TEST_F(ResolverFunctionValidationTest, ParameterMayShadowGlobal) {
    ...
    Func("func", tint::Vector{Param("common_name", ty.f32())}, ty.void_(), tint::Empty);
...
TEST_F(ResolverFunctionValidationTest, LocalConflictsWithParameter) {
    ...
    //   let common_name = 1i;
    // }
    Func("func", tint::Vector{Param(Source{{12, 34}}, "common_name", ty.f32())}, ty.void_(),
         tint::Vector{
...
TEST_F(ResolverFunctionValidationTest, UnreachableCode_return) {
    ...
    Func("func", tint::Empty, ty.void_(), tint::Vector{decl_a, ret, assign_a});
...
TEST_F(ResolverFunctionValidationTest, UnreachableCode_return_InBlocks) {
    ...
    Func("func", tint::Empty, ty.void_(), tint::Vector{decl_a, Block(Block(Block(ret))), assign_a});
...
TEST_F(ResolverFunctionValidationTest, UnreachableCode_discard_nowarning) {
    ...
    Func("func", tint::Empty, ty.void_(), tint::Vector{decl_a, discard, assign_a});
...
TEST_F(ResolverFunctionValidationTest, DiscardCalledDirectlyFromVertexEntryPoint) {
    ...
    Func(Source{{1, 2}}, "func", tint::Empty, ty.vec4<f32>(),
         ...
         tint::Vector{Builtin(builtin::BuiltinValue::kPosition)});
...
TEST_F(ResolverFunctionValidationTest, FunctionVarInitWithParam) {
    ...
    Func("foo", tint::Vector{bar}, ty.void_(),
         tint::Vector{
             Decl(baz),
         });
...
TEST_F(ResolverFunctionValidationTest, ParameterStoreType_NonAtomicFree) {
    ...
    Func("f", tint::Vector{bar}, ty.void_(), tint::Empty);
...
TEST_F(ResolverFunctionValidationTest, ParametersAtLimit) {
    tint::Vector<const ast::Parameter*, 256> params;
    for (int i = 0; i < 255; i++) {
...
TEST_F(ResolverFunctionValidationTest, ParameterVectorNoType) {
    ...
    Func(Source{{12, 34}}, "f", tint::Vector{Param("p", ty.vec3<Infer>(Source{{12, 34}}))},
         ty.void_(), tint::Empty);
...
TEST_F(ResolverFunctionValidationTest, ParameterMatrixNoType) {
    ...
    Func(Source{{12, 34}}, "f", tint::Vector{Param("p", ty.mat3x3<Infer>(Source{{12, 34}}))},
         ty.void_(), tint::Empty);
...
TEST_P(ResolverFunctionParameterValidationTest, AddressSpaceNoExtension) {
    ...
    Func("f", tint::Vector{arg}, ty.void_(), tint::Empty);
