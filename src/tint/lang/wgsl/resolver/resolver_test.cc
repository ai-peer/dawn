...
TEST_F(ResolverTest, Stmt_Return) {
    ...
    Func("test", tint::Empty, ty.i32(), tint::Vector{ret}, tint::Empty);
...
TEST_F(ResolverTest, Stmt_VariableDecl_OuterScopeAfterInnerScope) {
    ...
    Func("func", tint::Empty, ty.void_(), tint::Vector{inner, foo_f32_decl, bar_f32_decl});
    ...
    EXPECT_TRUE(CheckVarUsers(foo_i32, tint::Vector{bar_i32->initializer}));
    EXPECT_TRUE(CheckVarUsers(foo_f32, tint::Vector{bar_f32->initializer}));
...
TEST_F(ResolverTest, Stmt_VariableDecl_ModuleScopeAfterFunctionScope) {
    ...
    Func("func_i32", tint::Empty, ty.void_(), tint::Vector{fn_i32_decl});
    ...
    Func("func_f32", tint::Empty, ty.void_(), tint::Vector{fn_f32_decl});
    ...
    EXPECT_TRUE(CheckVarUsers(mod_f32, tint::Vector{fn_f32->initializer}));
...
TEST_F(ResolverTest, Expr_Call_InBinaryOp) {
    Func("func", tint::Empty, ty.f32(), tint::Vector{Return(0_f)});
...
TEST_F(ResolverTest, Expr_Call_WithParams) {
    Func("my_func", tint::Vector{Param(Sym(), ty.f32())}, ty.f32(),
         tint::Vector{
             Return(1.2_f),
         });
...
TEST_F(ResolverTest, Expr_Identifier_GlobalVariable) {
    ...
    EXPECT_TRUE(CheckVarUsers(my_var, tint::Vector{ident}));
...
TEST_F(ResolverTest, Expr_Identifier_FunctionVariable_Const) {
    ...
    EXPECT_TRUE(CheckVarUsers(var, tint::Vector{my_var_a}));
...
TEST_F(ResolverTest, Expr_Identifier_FunctionVariable) {
    ...
    EXPECT_TRUE(CheckVarUsers(var, tint::Vector{my_var_a, my_var_b}));
    ASSERT_NE(VarOf(my_var_a), nullptr);
    EXPECT_EQ(VarOf(my_var_a)->Declaration(), var);
...
TEST_F(ResolverTest, Function_Parameters_Locations) {
    auto* param_a = Param("a", ty.f32(), tint::Vector{Location(3_a)});
    auto* param_b =
        Param("b", ty.u32(), tint::Vector{Builtin(builtin::BuiltinValue::kVertexIndex)});
    auto* param_c = Param("c", ty.u32(), tint::Vector{Location(1_a)});
...
TEST_F(ResolverTest, Function_GlobalVariable_Location) {
    auto* var = GlobalVar(
        ...
        tint::Vector{Location(3_a), Disable(ast::DisabledValidation::kIgnoreAddressSpace)});
...
TEST_F(ResolverTest, Function_RegisterInputOutputVariables) {
    auto* s = Structure("S", tint::Vector{Member("m", ty.u32())});
...
TEST_F(ResolverTest, Function_RegisterInputOutputVariables_SubFunction) {
    ...
    Func("my_func", tint::Empty, ty.f32(),
         tint::Vector{Assign("wg_var", "wg_var"), Assign("sb_var", "sb_var"),
...
TEST_F(ResolverTest, Function_NotRegisterFunctionParams) {
    auto* func = Func("my_func", tint::Vector{Param("var", ty.f32())}, ty.void_(), tint::Empty);
    EXPECT_TRUE(r()->Resolve()) << r()->error();
...
TEST_F(ResolverTest, Expr_MemberAccessor_Struct) {
    auto* st = Structure(
        "S", tint::Vector{Member("first_member", ty.i32()), Member("second_member", ty.f32())});
...
TEST_F(ResolverTest, Expr_Accessor_MultiLevel) {
    ...
    auto* stB = Structure("B", tint::Vector{Member("foo", ty.vec4<f32>())});
    auto* stA = Structure("A", tint::Vector{Member("mem", ty.array(ty.Of(stB), 3_i))});
...
TEST_F(ResolverTest, Expr_MemberAccessor_InBinaryOp) {
    auto* st = Structure(
        "S", tint::Vector{Member("first_member", ty.f32()), Member("second_member", ty.f32())});
    GlobalVar("my_struct", ty.Of(st), builtin::AddressSpace::kPrivate);
...
TEST_F(ResolverTest, Access_SetForStorageBuffer) {
    // struct S { x : i32 };
    // var<storage> g : S;
    auto* s = Structure("S", tint::Vector{Member(Source{{12, 34}}, "x", ty.i32())});
...
TEST_F(ResolverTest, ASTNodesAreReached) {
    Structure("A", tint::Vector{Member("x", ty.array<f32, 4>(tint::Vector{Stride(4)}))});
    Structure("B", tint::Vector{Member("x", ty.array<f32, 4>(tint::Vector{Stride(4)}))});
    ASSERT_TRUE(r()->Resolve()) << r()->error();
}
...
TEST_F(ResolverTest, TextureSampler_TextureSample) {
    ...
    const ast::Function* f =
        Func("test_function", tint::Empty, ty.void_(), tint::Vector{Assign(Phony(), call)},
...
TEST_F(ResolverTest, TextureSampler_TextureSampleInFunction) {
    ...
    const ast::Function* inner_func =
        Func("inner_func", tint::Empty, ty.void_(), tint::Vector{inner_call});
    auto* outer_call = CallStmt(Call("inner_func"));
    const ast::Function* outer_func =
        Func("outer_func", tint::Empty, ty.void_(), tint::Vector{outer_call},
             tint::Vector{Stage(ast::PipelineStage::kFragment)});
...
TEST_F(ResolverTest, TextureSampler_TextureSampleFunctionDiamondSameVariables) {
    ...
    const ast::Function* inner_func_1 =
        Func("inner_func_1", tint::Empty, ty.void_(), tint::Vector{inner_call_1});
    auto* inner_call_2 =
        Assign(Phony(), Call("textureSample", "t", "s", Call<vec2<f32>>(3_f, 4_f)));
    const ast::Function* inner_func_2 =
        Func("inner_func_2", tint::Empty, ty.void_(), tint::Vector{inner_call_2});
    auto* outer_call_1 = CallStmt(Call("inner_func_1"));
    auto* outer_call_2 = CallStmt(Call("inner_func_2"));
    const ast::Function* outer_func =
        Func("outer_func", tint::Empty, ty.void_(), tint::Vector{outer_call_1, outer_call_2},
             tint::Vector{Stage(ast::PipelineStage::kFragment)});
...
TEST_F(ResolverTest, ModuleDependencyOrderedDeclarations) {
    ...
    auto* s0 = Structure("s0", tint::Vector{Member("m", ty.i32())});
    ...
    auto* s1 = Structure("s1", tint::Vector{Member("m", ty.i32())});
    ...
    auto* s2 = Structure("s2", tint::Vector{Member("m", ty.i32())});
...
TEST_F(ResolverTest, MaxNumStructMembers_Valid) {
    tint::Vector<const ast::StructMember*, 0> members;
...
TEST_F(ResolverTest, MaxNumStructMembers_WithIgnoreStructMemberLimit_Valid) {
    ...
    Structure("S", std::move(members),
              tint::Vector{Disable(ast::DisabledValidation::kIgnoreStructMemberLimit)});
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}
...
TEST_F(ResolverTest, MaxNestDepthOfCompositeType_Structs_Valid) {
    ...
    for (size_t i = 0; i < iterations; ++i) {
        s = Structure("S" + std::to_string(i), tint::Vector{Member("m", ty.Of(s))});
    }
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}
...
TEST_F(ResolverTest, MaxNestDepthOfCompositeType_Structs_Invalid) {
    ...
    for (size_t i = 0; i < iterations; ++i) {
        ...
        s = Structure(source, "S" + std::to_string(i), tint::Vector{Member("m", ty.Of(s))});
    }
    EXPECT_FALSE(r()->Resolve());
...
TEST_F(ResolverTest, MaxNestDepthOfCompositeType_StructsWithVector_Valid) {
    auto* s = Structure("S", tint::Vector{Member("m", ty.vec3<i32>())});
...
TEST_F(ResolverTest, MaxNestDepthOfCompositeType_StructsWithMatrix_Valid) {
    auto* s = Structure("S", tint::Vector{Member("m", ty.mat3x3<f32>())});
...
TEST_F(ResolverTest, MaxNestDepthOfCompositeType_StructsOfArray_Valid) {
    auto a = ty.array(ty.mat3x3<f32>(), 10_u);
    auto* s = Structure("S", tint::Vector{Member("m", a)});
