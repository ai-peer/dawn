...
TEST_F(IntrinsicTableTest, MatchF32) {
    ...
    auto result = table->Lookup(builtin::Function::kCos, tint::Vector{f32},
...
TEST_F(IntrinsicTableTest, MismatchF32) {
    ...
    auto result = table->Lookup(builtin::Function::kCos, tint::Vector{i32},
                                sem::EvaluationStage::kConstant, Source{});
...
TEST_F(IntrinsicTableTest, MatchU32) {
    ...
    auto result = table->Lookup(builtin::Function::kUnpack2X16Float, tint::Vector{u32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchU32) {
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(builtin::Function::kUnpack2X16Float, tint::Vector{f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchI32) {
    ...
    auto result = table->Lookup(builtin::Function::kTextureLoad, tint::Vector{tex, i32, i32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchI32) {
    auto* f32 = create<type::F32>();
    auto* tex = create<type::SampledTexture>(type::TextureDimension::k1d, f32);
    auto result = table->Lookup(builtin::Function::kTextureLoad, tint::Vector{tex, f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchIU32AsI32) {
    auto* i32 = create<type::I32>();
    auto result = table->Lookup(builtin::Function::kCountOneBits, tint::Vector{i32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MatchIU32AsU32) {
    auto* u32 = create<type::U32>();
    auto result = table->Lookup(builtin::Function::kCountOneBits, tint::Vector{u32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
    EXPECT_EQ(result.sem->Type(), builtin::Function::kCountOneBits);
...
TEST_F(IntrinsicTableTest, MismatchIU32) {
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(builtin::Function::kCountOneBits, tint::Vector{f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchFIU32AsI32) {
    auto* i32 = create<type::I32>();
    auto result = table->Lookup(builtin::Function::kClamp, tint::Vector{i32, i32, i32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MatchFIU32AsU32) {
    auto* u32 = create<type::U32>();
    auto result = table->Lookup(builtin::Function::kClamp, tint::Vector{u32, u32, u32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
    EXPECT_EQ(result.sem->Type(), builtin::Function::kClamp);
...
TEST_F(IntrinsicTableTest, MatchFIU32AsF32) {
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(builtin::Function::kClamp, tint::Vector{f32, f32, f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
    EXPECT_EQ(result.sem->Type(), builtin::Function::kClamp);
...
TEST_F(IntrinsicTableTest, MismatchFIU32) {
    ...
    auto result = table->Lookup(builtin::Function::kClamp, tint::Vector{bool_, bool_, bool_},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchBool) {
    auto* f32 = create<type::F32>();
    auto* bool_ = create<type::Bool>();
    auto result = table->Lookup(builtin::Function::kSelect, tint::Vector{f32, f32, bool_},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchBool) {
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(builtin::Function::kSelect, tint::Vector{f32, f32, f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchPointer) {
    ...
    auto result = table->Lookup(builtin::Function::kAtomicLoad, tint::Vector{ptr},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchPointer) {
    auto* i32 = create<type::I32>();
    auto* atomicI32 = create<type::Atomic>(i32);
    auto result = table->Lookup(builtin::Function::kAtomicLoad, tint::Vector{atomicI32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchArray) {
    ...
    auto result = table->Lookup(builtin::Function::kArrayLength, tint::Vector{arr_ptr},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchArray) {
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(builtin::Function::kArrayLength, tint::Vector{f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchSampler) {
    ...
    auto result =
        table->Lookup(builtin::Function::kTextureSample, tint::Vector{tex, sampler, vec2_f32},
                      sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchSampler) {
    ...
    auto* vec2_f32 = create<type::Vector>(f32, 2u);
    auto* tex = create<type::SampledTexture>(type::TextureDimension::k2d, f32);
    auto result = table->Lookup(builtin::Function::kTextureSample, tint::Vector{tex, f32, vec2_f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchSampledTexture) {
    ...
    auto* vec4_f32 = create<type::Vector>(f32, 4u);
    auto* tex = create<type::SampledTexture>(type::TextureDimension::k2d, f32);
    auto result = table->Lookup(builtin::Function::kTextureLoad, tint::Vector{tex, vec2_i32, i32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
    EXPECT_EQ(result.sem->Type(), builtin::Function::kTextureLoad);
...
TEST_F(IntrinsicTableTest, MatchExternalTexture) {
    ...
    auto result = table->Lookup(builtin::Function::kTextureLoad, tint::Vector{tex, vec2_i32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
    EXPECT_EQ(result.sem->Type(), builtin::Function::kTextureLoad);
...
TEST_F(IntrinsicTableTest, MatchWOStorageTexture) {
    ...
    auto result =
        table->Lookup(builtin::Function::kTextureStore, tint::Vector{tex, vec2_i32, vec4_f32},
                      sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchTexture) {
    ...
    auto* i32 = create<type::I32>();
    auto* vec2_i32 = create<type::Vector>(i32, 2u);
    auto result = table->Lookup(builtin::Function::kTextureLoad, tint::Vector{f32, vec2_i32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MismatchTemplateType) {
    auto* f32 = create<type::F32>();
    auto* u32 = create<type::U32>();
    auto result = table->Lookup(builtin::Function::kClamp, tint::Vector{f32, u32, f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchOpenSizeVector) {
    ...
    auto* vec2_f32 = create<type::Vector>(f32, 2u);
    auto result =
        table->Lookup(builtin::Function::kClamp, tint::Vector{vec2_f32, vec2_f32, vec2_f32},
                      sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
    EXPECT_EQ(result.sem->Type(), builtin::Function::kClamp);
...
TEST_F(IntrinsicTableTest, MismatchOpenSizeVector) {
    ...
    auto* u32 = create<type::U32>();
    auto* vec2_f32 = create<type::Vector>(f32, 2u);
    auto result = table->Lookup(builtin::Function::kClamp, tint::Vector{vec2_f32, u32, vec2_f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchOpenSizeMatrix) {
    ...
    auto result = table->Lookup(builtin::Function::kDeterminant, tint::Vector{mat3_f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MismatchOpenSizeMatrix) {
    ...
    auto result = table->Lookup(builtin::Function::kDeterminant, tint::Vector{mat3x2_f32},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(result.sem, nullptr);
    ASSERT_THAT(Diagnostics().str(), HasSubstr("no matching call"));
}
...
TEST_F(IntrinsicTableTest, MatchDifferentArgsElementType_Builtin_ConstantEval) {
    ...
    auto* bool_ = create<type::Bool>();
    auto result = table->Lookup(builtin::Function::kSelect, tint::Vector{af, af, bool_},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");
...
TEST_F(IntrinsicTableTest, MatchDifferentArgsElementType_Builtin_RuntimeEval) {
    ...
    auto* bool_ref = create<type::Reference>(builtin::AddressSpace::kFunction, create<type::Bool>(),
                                             builtin::Access::kReadWrite);
    auto result = table->Lookup(builtin::Function::kSelect, tint::Vector{af, af, bool_ref},
...
TEST_F(IntrinsicTableTest, OverloadOrderByNumberOfParameters) {
    ...
    // come first
    auto* bool_ = create<type::Bool>();
    table->Lookup(builtin::Function::kTextureDimensions, tint::Vector{bool_, bool_},
                  sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(Diagnostics().str(),
...
TEST_F(IntrinsicTableTest, OverloadOrderByMatchingParameter) {
    auto* tex = create<type::DepthTexture>(type::TextureDimension::k2d);
    auto* bool_ = create<type::Bool>();
    table->Lookup(builtin::Function::kTextureDimensions, tint::Vector{tex, bool_},
                  sem::EvaluationStage::kConstant, Source{});
    ASSERT_EQ(Diagnostics().str(),
...
TEST_F(IntrinsicTableTest, SameOverloadReturnsSameBuiltinPointer) {
    ...
    auto* bool_ = create<type::Bool>();
    auto a = table->Lookup(builtin::Function::kSelect, tint::Vector{f32, f32, bool_},
                           sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(a.sem, nullptr) << Diagnostics().str();

    auto b = table->Lookup(builtin::Function::kSelect, tint::Vector{f32, f32, bool_},
                           sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(b.sem, nullptr) << Diagnostics().str();
    ASSERT_EQ(Diagnostics().str(), "");

    auto c = table->Lookup(builtin::Function::kSelect, tint::Vector{vec2_f32, vec2_f32, bool_},
                           sem::EvaluationStage::kConstant, Source{});
...
TEST_F(IntrinsicTableTest, MatchTypeInitializerImplicit) {
    auto* i32 = create<type::I32>();
    auto* vec3_i32 = create<type::Vector>(i32, 3u);
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, nullptr, tint::Vector{i32, i32, i32},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
...
TEST_F(IntrinsicTableTest, MatchTypeInitializerExplicit) {
    auto* i32 = create<type::I32>();
    auto* vec3_i32 = create<type::Vector>(i32, 3u);
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, i32, tint::Vector{i32, i32, i32},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_NE(result.target, nullptr);
    EXPECT_EQ(result.target->ReturnType(), vec3_i32);
    EXPECT_TRUE(result.target->Is<sem::ValueConstructor>());
...
TEST_F(IntrinsicTableTest, MismatchTypeInitializerImplicit) {
    auto* i32 = create<type::I32>();
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, nullptr, tint::Vector{i32, f32, i32},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
...
TEST_F(IntrinsicTableTest, MismatchTypeInitializerExplicit) {
    auto* i32 = create<type::I32>();
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, i32, tint::Vector{i32, f32, i32},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_EQ(result.target, nullptr);
    EXPECT_EQ(Diagnostics().str(),
...
TEST_F(IntrinsicTableTest, MatchTypeInitializerImplicitVecFromVecAbstract) {
    ...
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, nullptr, tint::Vector{vec3_ai},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_NE(result.target, nullptr);
...
TEST_F(IntrinsicTableTest, MatchTypeInitializerImplicitMatFromVec) {
    ...
    auto result = table->Lookup(CtorConvIntrinsic::kMat2x2, nullptr, tint::Vector{vec2_ai, vec2_ai},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_NE(result.target, nullptr);
...
TEST_F(IntrinsicTableTest, MatchTypeInitializer_ConstantEval) {
    auto* ai = create<type::AbstractInt>();
    auto* vec3_ai = create<type::Vector>(ai, 3u);
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, nullptr, tint::Vector{ai, ai, ai},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_NE(result.target, nullptr);
...
TEST_F(IntrinsicTableTest, MatchTypeConversion) {
    ...
    auto* f32 = create<type::F32>();
    auto* vec3_f32 = create<type::Vector>(f32, 3u);
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, i32, tint::Vector{vec3_f32},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_NE(result.target, nullptr);
    EXPECT_EQ(result.target->ReturnType(), vec3_i32);
...
TEST_F(IntrinsicTableTest, MismatchTypeConversion) {
    auto* arr =
        create<type::Array>(create<type::U32>(), create<type::RuntimeArrayCount>(), 4u, 4u, 4u, 4u);
    auto* f32 = create<type::F32>();
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, f32, tint::Vector{arr},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_EQ(result.target, nullptr);
    EXPECT_EQ(Diagnostics().str(),
...
TEST_F(IntrinsicTableTest, MatchTypeConversion_ConstantEval) {
    ...
    auto* f32 = create<type::F32>();
    auto* vec3_f32 = create<type::Vector>(f32, 3u);
    auto result = table->Lookup(CtorConvIntrinsic::kVec3, af, tint::Vector{vec3_ai},
                                sem::EvaluationStage::kConstant, Source{{12, 34}});
    ASSERT_NE(result.target, nullptr);
    EXPECT_EQ(result.target->Stage(), sem::EvaluationStage::kConstant);
...
TEST_F(IntrinsicTableTest, Err257Arguments) {  // crbug.com/1323605
    auto* f32 = create<type::F32>();
    tint::Vector<const type::Type*, 0> arg_tys;
...
TEST_F(IntrinsicTableTest, OverloadResolution) {
    ...
    auto* ai = create<type::AbstractInt>();
    auto* i32 = create<type::I32>();
    auto result = table->Lookup(CtorConvIntrinsic::kI32, nullptr, tint::Vector{ai},
                                sem::EvaluationStage::kConstant, Source{});
    ASSERT_NE(result.target, nullptr);
...
TEST_P(IntrinsicTableAbstractTernaryTest, MatchClamp) {
    ...
    auto builtin = table->Lookup(builtin::Function::kClamp, tint::Vector{arg_a, arg_b, arg_c},
                                 sem::EvaluationStage::kConstant, Source{{12, 34}});
