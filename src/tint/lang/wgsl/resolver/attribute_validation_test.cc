...
static tint::Vector<const ast::Attribute*, 2> createAttributes(const Source& source,
...
TEST_P(FragmentShaderParameterAttributeTest, IsValid) {
    ...
    Func("frag_main", tint::Vector{p}, ty.void_(), tint::Empty,
         tint::Vector{
...
TEST_P(VertexShaderParameterAttributeTest, IsValid) {
    ...
    auto* p = Param("a", ty.vec4<f32>(), attrs);
    Func("vertex_main", tint::Vector{p}, ty.vec4<f32>(),
         tint::Vector{
...
TEST_P(FragmentShaderReturnTypeAttributeTest, IsValid) {
    ...
    auto attrs = createAttributes(Source{{12, 34}}, *this, params.kind);
    attrs.Push(Location(Source{{34, 56}}, 2_a));
    Func("frag_main", tint::Empty, ty.vec4<f32>(), tint::Vector{Return(Call<vec4<f32>>())},
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         },
         attrs);
...
TEST_F(EntryPointParameterAttributeTest, DuplicateInternalAttribute) {
    ...
    Func("f", tint::Vector{s}, ty.void_(), tint::Empty,
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         });
...
TEST_P(StructAttributeTest, IsValid) {
    ...
    Structure("mystruct", tint::Vector{Member("a", ty.f32())},
              createAttributes(Source{{12, 34}}, *this, params.kind));
...
TEST_P(StructMemberAttributeTest, IsValid) {
    auto& params = GetParam();
    EnableExtensionIfNecessary(params.kind);
    tint::Vector<const ast::StructMember*, 1> members;
    if (params.kind == AttributeKind::kBuiltin) {
        members.Push(
...
TEST_F(StructMemberAttributeTest, DuplicateAttribute) {
    Structure("mystruct", tint::Vector{
                              Member("a", ty.i32(),
                                     tint::Vector{
...
TEST_F(StructMemberAttributeTest, Align_Attribute_Const) {
    ...
    Structure("mystruct", tint::Vector{Member("a", ty.f32(), tint::Vector{MemberAlign("val")})});
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}
...
TEST_F(StructMemberAttributeTest, Align_Attribute_ConstNegative) {
    ...
    Structure("mystruct", tint::Vector{Member(
                              "a", ty.f32(), tint::Vector{MemberAlign(Source{{12, 34}}, "val")})});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(),
...
TEST_F(StructMemberAttributeTest, Align_Attribute_Var) {
    ...
    Structure(Source{{6, 4}}, "mystruct",
              tint::Vector{Member(Source{{12, 5}}, "a", ty.f32(),
                                   tint::Vector{MemberAlign(Expr(Source{{12, 35}}, "val"))})});
    EXPECT_FALSE(r()->Resolve());
...
TEST_F(StructMemberAttributeTest, Align_Attribute_Override) {
    ...
    Structure("mystruct",
              tint::Vector{Member("a", ty.f32(),
                                   tint::Vector{MemberAlign(Expr(Source{{12, 34}}, "val"))})});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(StructMemberAttributeTest, Size_Attribute_Const) {
    ...
    Structure("mystruct", tint::Vector{Member("a", ty.f32(), tint::Vector{MemberSize("val")})});
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}
...
TEST_F(StructMemberAttributeTest, Size_Attribute_ConstNegative) {
    ...
    Structure("mystruct", tint::Vector{Member(
                              "a", ty.f32(), tint::Vector{MemberSize(Source{{12, 34}}, "val")})});
    EXPECT_FALSE(r()->Resolve());
...
TEST_F(StructMemberAttributeTest, Size_Attribute_Var) {
    ...
    Structure(Source{{6, 4}}, "mystruct",
              tint::Vector{Member(Source{{12, 5}}, "a", ty.f32(),
                                   tint::Vector{MemberSize(Expr(Source{{12, 35}}, "val"))})});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(), R"(12:35 error: var 'val' cannot be referenced at module-scope
1:2 note: var 'val' declared here)");
}
...
TEST_F(StructMemberAttributeTest, Size_Attribute_Override) {
    ...
    Structure("mystruct",
              tint::Vector{
                  Member("a", ty.f32(), tint::Vector{MemberSize(Expr(Source{{12, 34}}, "val"))}),
              });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(StructMemberAttributeTest, Size_On_RuntimeSizedArray) {
    Structure("mystruct",
              tint::Vector{
                  Member("a", ty.array<i32>(), tint::Vector{MemberSize(Source{{12, 34}}, 8_a)}),
              });
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(VariableAttributeTest, LocalVar) {
    auto* v = Var("a", ty.f32(), tint::Vector{Binding(Source{{12, 34}}, 2_a)});
...
TEST_F(VariableAttributeTest, LocalLet) {
    auto* v = Let("a", tint::Vector{Binding(Source{{12, 34}}, 2_a)}, Expr(1_a));
...
TEST_P(SwitchStatementAttributeTest, IsValid) {
    ...
    WrapInFunction(Switch(Expr(0_a), tint::Vector{DefaultCase()},
                          createAttributes(Source{{12, 34}}, *this, params.kind)));
...
TEST_P(SwitchBodyAttributeTest, IsValid) {
    ...
    WrapInFunction(Switch(Expr(0_a), tint::Vector{DefaultCase()}, tint::Empty,
                          createAttributes(Source{{12, 34}}, *this, params.kind)));
...
TEST_P(BlockStatementTest, CompoundStatement) {
    Func("foo", tint::Empty, ty.void_(),
         tint::Vector{
             Block(tint::Vector{Return()}, createAttributes({}, *this, GetParam().kind)),
         });
    Check();
}
...
TEST_P(BlockStatementTest, ElseStatementBody) {
    Func("foo", tint::Empty, ty.void_(),
         tint::Vector{
             If(Expr(true), Block(tint::Vector{Return()}),
                Else(Block(tint::Vector{Return()}, createAttributes({}, *this, GetParam().kind)))),
         });
    Check();
}
    ...
    Func("foo", tint::Empty, ty.void_(),
         tint::Vector{
             For(nullptr, Expr(true), nullptr,
                 Block(tint::Vector{Break()}, createAttributes({}, *this, GetParam().kind))),
         });
    Check();
}
TEST_P(BlockStatementTest, LoopStatementBody) {
    Func("foo", tint::Empty, ty.void_(),
         tint::Vector{
             Loop(Block(tint::Vector{Break()}, createAttributes({}, *this, GetParam().kind))),
         });
    Check();
}
...
TEST_P(BlockStatementTest, CaseStatementBody) {
    Func("foo", tint::Empty, ty.void_(),
         tint::Vector{
             Switch(1_a,
                    Case(CaseSelector(1_a), Block(tint::Vector{Break()},
    ...
    Func("foo", tint::Empty, ty.void_(),
         tint::Vector{
             Switch(1_a, Case(CaseSelector(1_a), Block()),
                    DefaultCase(Block(tint::Vector{Break()},
                                      createAttributes({}, *this, GetParam().kind)))),
         });
    Check();
}
...
TEST_F(ResourceAttributeTest, UniformBufferMissingBinding) {
    auto* s = Structure("S", tint::Vector{
                                 Member("x", ty.i32()),
                             });
...
TEST_F(InvariantAttributeTests, InvariantWithPosition) {
    ...
    Func("main", tint::Vector{param}, ty.vec4<f32>(),
         tint::Vector{
             Return(Call<vec4<f32>>()),
         },
         tint::Vector{
...
TEST_F(InterpolateTest, FragmentInput_Integer_MissingFlatInterpolation) {
    Func("main",
         tint::Vector{Param(Source{{12, 34}}, "a", ty.i32(), tint::Vector{Location(0_a)})},
         ty.void_(), tint::Empty,
         tint::Vector{
             Stage(ast::PipelineStage::kFragment),
         });
...
TEST_F(InterpolateTest, VertexOutput_Integer_MissingFlatInterpolation) {
    auto* s = Structure(
        ...
        tint::Vector{
            ...
            Member(Source{{12, 34}}, "u", ty.u32(), tint::Vector{Location(0_a)}),
        });
...
TEST_F(InterpolateTest, MissingLocationAttribute_Struct) {
    Structure(
        ...
        tint::Vector{
            Member("a", ty.f32(),
                   tint::Vector{Interpolate(Source{{12, 34}}, builtin::InterpolationType::kFlat)}),
        });
...
TEST_F(IdTest, Const_I32) {
    Override("val", ty.f32(), tint::Vector{Id(1_i)});
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}

TEST_F(IdTest, Const_U32) {
    Override("val", ty.f32(), tint::Vector{Id(1_u)});
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}

TEST_F(IdTest, Const_AInt) {
    Override("val", ty.f32(), tint::Vector{Id(1_a)});
    EXPECT_TRUE(r()->Resolve()) << r()->error();
}

TEST_F(IdTest, NonConstant) {
    Override("val", ty.f32(), tint::Vector{Id(Call<u32>(Call(Source{{12, 34}}, "dpdx", 1_a)))});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(
        r()->error(),
...
TEST_F(IdTest, Negative) {
    Override("val", ty.f32(), tint::Vector{Id(Source{{12, 34}}, -1_i)});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(), R"(12:34 error: @id value must be non-negative)");
}

TEST_F(IdTest, F32) {
    Override("val", ty.f32(), tint::Vector{Id(Source{{12, 34}}, 1_f)});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(), R"(12:34 error: @id must be an i32 or u32 value)");
}

TEST_F(IdTest, AFloat) {
    Override("val", ty.f32(), tint::Vector{Id(Source{{12, 34}}, 1.0_a)});
    EXPECT_FALSE(r()->Resolve());
    EXPECT_EQ(r()->error(), R"(12:34 error: @id must be an i32 or u32 value)");
}
    ...
    void Build(const ast::Expression* location_value) {
        switch (GetParam()) {
            case LocationAttributeType::kEntryPointParameter:
                Func("main",
                     tint::Vector{Param(Source{{12, 34}}, "a", ty.i32(),
                                         tint::Vector{
...
TEST_F(MustUseAttributeTest, UsedOnFnWithNoReturnValue) {
    Func("fn_must_use", tint::Empty, ty.void_(), tint::Empty,
         tint::Vector{MustUse(Source{{12, 34}})});
...
class TestAttribute : public tint::Castable<TestAttribute, ast::InternalAttribute> {
  public:
    TestAttribute(GenerationID pid, ast::NodeID nid, const ast::IdentifierExpression* dep)
        : Base(pid, nid, tint::Vector{dep}) {}
...
TEST_F(InternalAttributeDepsTest, Dependency) {
    ...
    auto* f = Func("f", tint::Empty, ty.void_(), tint::Empty, tint::Vector{attr});
