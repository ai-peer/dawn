...
TEST_F(ResolverCallValidationTest, PointerArgument_VariableIdentExpr) {
    ...
    Func("foo", tint::Vector{param}, ty.void_(), tint::Empty);
    Func("main", tint::Empty, ty.void_(),
         tint::Vector{
...
TEST_F(ResolverCallValidationTest, MustUseFunction) {
    Func(Source{{56, 78}}, "fn_must_use", tint::Empty, ty.i32(), tint::Vector{Return(1_i)},
         tint::Vector{MustUse()});
    Func("f", tint::Empty, ty.void_(),
         tint::Vector{CallStmt(Call(Source{{12, 34}}, "fn_must_use"))});
...
TEST_F(ResolverCallValidationTest, MustUseBuiltin) {
    Func("f", tint::Empty, ty.void_(),
         tint::Vector{CallStmt(Call(Source{{12, 34}}, "max", 1_a, 2_a))});
