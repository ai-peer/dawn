...
template <size_t N>
inline void CollectScalars(const constant::Value* c, tint::Vector<builder::Scalar, N>& scalars) {
    Switch(
        c->Type(),  //
...
inline tint::Vector<builder::Scalar, 16> ScalarsFrom(const constant::Value* c) {
    tint::Vector<builder::Scalar, 16> out;
