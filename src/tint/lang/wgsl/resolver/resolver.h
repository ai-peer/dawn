...
class Resolver {
  ...
  private:
    ...
    template <size_t N>
    bool MaybeMaterializeAndLoadArguments(tint::Vector<const sem::ValueExpression*, N>& args,
    ...
    template <size_t N>
    tint::Result<tint::Vector<const constant::Value*, N>> ConvertArguments(
    ...
    bool Statements(tint::VectorRef<const ast::Statement*>);
    ...
    /// @returns true on success, false on failure
    bool ArrayAttributes(tint::VectorRef<const ast::Attribute*> attributes,
    ...
    tint::Vector<sem::Function*, 8> entry_points_;
    tint::Hashmap<const type::Type*, const Source*, 8> atomic_composite_info_;
    ...
    tint::Hashmap<OverrideId, const sem::Variable*, 8> override_ids_;
    tint::Hashmap<ArrayConstructorSig, sem::CallTarget*, 8> array_ctors_;
    tint::Hashmap<StructConstructorSig, sem::CallTarget*, 8> struct_ctors_;
    sem::Function* current_function_ = nullptr;
    sem::Statement* current_statement_ = nullptr;
    sem::CompoundStatement* current_compound_statement_ = nullptr;
    uint32_t current_scoping_depth_ = 0;
    tint::UniqueVector<const sem::GlobalVariable*, 4>* resolved_overrides_ = nullptr;
    tint::Hashset<TypeAndAddressSpace, 8> valid_type_storage_layouts_;
    tint::Hashmap<const ast::Expression*, const ast::BinaryExpression*, 8>
        logical_binary_lhs_to_parent_;
    tint::Hashset<const ast::Expression*, 8> skip_const_eval_;
    IdentifierResolveHint identifier_resolve_hint_;
    tint::Hashmap<const type::Type*, size_t, 8> nest_depth_;
};
