...
TEST_F(ProgramToIRFunctionTest, EmitFunction_Vertex) {
    Func("test", tint::Empty, ty.vec4<f32>(),
         tint::Vector{Return(Call<vec4<f32>>(0_f, 0_f, 0_f, 0_f))},
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_Compute) {
    Func("test", tint::Empty, ty.void_(), tint::Empty,
         tint::Vector{Stage(ast::PipelineStage::kCompute), WorkgroupSize(8_i, 4_i, 2_i)});
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_Return) {
    Func("test", tint::Empty, ty.vec3<f32>(),
         tint::Vector{Return(Call<vec3<f32>>(0_f, 0_f, 0_f))}, tint::Empty);
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_UnreachableEnd_ReturnValue) {
    Func("test", tint::Empty, ty.f32(),
         tint::Vector{If(true, Block(Return(0_f)), Else(Block(Return(1_f))))}, tint::Empty);
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_ReturnPosition) {
    Func("test", tint::Empty, ty.vec4<f32>(),
         tint::Vector{Return(Call<vec4<f32>>(1_f, 2_f, 3_f, 4_f))},
         tint::Vector{Stage(ast::PipelineStage::kVertex)},
         tint::Vector{Builtin(builtin::BuiltinValue::kPosition)});
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_ReturnPositionInvariant) {
    Func("test", tint::Empty, ty.vec4<f32>(),
         tint::Vector{Return(Call<vec4<f32>>(1_f, 2_f, 3_f, 4_f))},
         tint::Vector{Stage(ast::PipelineStage::kVertex)},
         tint::Vector{Builtin(builtin::BuiltinValue::kPosition), Invariant()});
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_ReturnLocation) {
    Func("test", tint::Empty, ty.vec4<f32>(),
         tint::Vector{Return(Call<vec4<f32>>(1_f, 2_f, 3_f, 4_f))},
         tint::Vector{Stage(ast::PipelineStage::kFragment)}, tint::Vector{Location(1_i)});
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_ReturnLocation_Interpolate) {
    Func("test", tint::Empty, ty.vec4<f32>(),
         tint::Vector{Return(Call<vec4<f32>>(1_f, 2_f, 3_f, 4_f))},
         tint::Vector{Stage(ast::PipelineStage::kFragment)},
         tint::Vector{Location(1_i), Interpolate(builtin::InterpolationType::kLinear,
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_ReturnFragDepth) {
    Func("test", tint::Empty, ty.f32(), tint::Vector{Return(1_f)},
         tint::Vector{Stage(ast::PipelineStage::kFragment)},
         tint::Vector{Builtin(builtin::BuiltinValue::kFragDepth)});
...
TEST_F(ProgramToIRFunctionTest, EmitFunction_ReturnSampleMask) {
    Func("test", tint::Empty, ty.u32(), tint::Vector{Return(1_u)},
         tint::Vector{Stage(ast::PipelineStage::kFragment)},
         tint::Vector{Builtin(builtin::BuiltinValue::kSampleMask)});
