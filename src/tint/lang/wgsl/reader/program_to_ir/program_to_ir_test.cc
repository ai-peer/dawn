...
TEST_F(IR_FromProgramTest, Func_WithParam) {
    Func("f", tint::Vector{Param("a", ty.u32())}, ty.u32(), tint::Vector{Return("a")});
...
TEST_F(IR_FromProgramTest, Func_WithMultipleParam) {
    Func("f", tint::Vector{Param("a", ty.u32()), Param("b", ty.i32()), Param("c", ty.bool_())},
         ty.void_(), tint::Empty);
...
TEST_F(IR_FromProgramTest, Switch) {
    auto* ast_switch = Switch(
        1_i, tint::Vector{Case(tint::Vector{CaseSelector(0_i)}, Block()),
                          Case(tint::Vector{CaseSelector(1_i)}, Block()), DefaultCase(Block())});
...
TEST_F(IR_FromProgramTest, Switch_MultiSelector) {
    auto* ast_switch = Switch(
        1_i,
        tint::Vector{Case(tint::Vector{CaseSelector(0_i), CaseSelector(1_i), DefaultCaseSelector()},
                          Block())});
...
TEST_F(IR_FromProgramTest, Switch_OnlyDefault) {
    auto* ast_switch = Switch(1_i, tint::Vector{DefaultCase(Block())});
    WrapInFunction(ast_switch);
...
TEST_F(IR_FromProgramTest, Switch_WithBreak) {
    auto* ast_switch = Switch(1_i, tint::Vector{Case(tint::Vector{CaseSelector(0_i)},
...
TEST_F(IR_FromProgramTest, Switch_AllReturn) {
    auto* ast_switch =
        Switch(1_i, tint::Vector{Case(tint::Vector{CaseSelector(0_i)}, Block(Return())),
...
TEST_F(IR_FromProgramTest, Func_WithParam_WithAttribute_Invariant) {
    Func("f",
         tint::Vector{Param("a", ty.vec4<f32>(),
                            tint::Vector{Invariant(), Builtin(builtin::BuiltinValue::kPosition)})},
         ty.vec4<f32>(), tint::Vector{Return("a")},
...
TEST_F(IR_FromProgramTest, Func_WithParam_WithAttribute_Location) {
    Func("f", tint::Vector{Param("a", ty.f32(), tint::Vector{Location(2_i)})}, ty.f32(),
         tint::Vector{Return("a")}, tint::Vector{Stage(ast::PipelineStage::kFragment)},
         tint::Vector{Location(1_i)});
...
TEST_F(IR_FromProgramTest, Func_WithParam_WithAttribute_Location_WithInterpolation_LinearCentroid) {
    Func("f",
         tint::Vector{Param(
             "a", ty.f32(),
             tint::Vector{Location(2_i), Interpolate(builtin::InterpolationType::kLinear,
                                                     builtin::InterpolationSampling::kCentroid)})},
         ty.f32(), tint::Vector{Return("a")}, tint::Vector{Stage(ast::PipelineStage::kFragment)},
         tint::Vector{Location(1_i)});
...
TEST_F(IR_FromProgramTest, Func_WithParam_WithAttribute_Location_WithInterpolation_Flat) {
    Func("f",
         tint::Vector{
             Param("a", ty.f32(),
                   tint::Vector{Location(2_i), Interpolate(builtin::InterpolationType::kFlat)})},
         ty.f32(), tint::Vector{Return("a")}, tint::Vector{Stage(ast::PipelineStage::kFragment)},
         tint::Vector{Location(1_i)});
