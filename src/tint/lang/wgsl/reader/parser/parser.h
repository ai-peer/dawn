...
class Parser {
  ...
  public:
    ...
    using AttributeList = tint::Vector<const ast::Attribute*, 4>;
    using CaseSelectorList = tint::Vector<const ast::CaseSelector*, 4>;
    using CaseStatementList = tint::Vector<const ast::CaseStatement*, 4>;
    ...
    struct FunctionHeader {
        ...
        FunctionHeader(Source src,
                       ...
                       tint::VectorRef<const ast::Parameter*> p,
                       ast::Type ret_ty,
                       tint::VectorRef<const ast::Attribute*> ret_attrs);
        /// Destructor
        ~FunctionHeader();
        /// Assignment operator
        /// @param other the FunctionHeader to copy
  ...
  private:
    ...
    Expect<Void> expect_attributes_consumed(tint::VectorRef<const ast::Attribute*> list);
