...
#ifndef SRC_TINT_LANG_WGSL_AST_WRITER_GENERATOR_IMPL_H_
#define SRC_TINT_LANG_WGSL_AST_WRITER_GENERATOR_IMPL_H_
...
#endif  // SRC_TINT_LANG_WGSL_AST_WRITER_GENERATOR_IMPL_H_
