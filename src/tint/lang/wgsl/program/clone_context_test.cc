...
struct Node : public utils::Castable<Node, ast::Node> {
...
struct IDNode : public utils::Castable<IDNode, ast::Node> {
...
TEST_F(CloneContextNodeTest, CloneWithReplaceAll_Node) {
    Allocator alloc;
