...
/// @returns the stream
inline tint::StringStream& operator<<(tint::StringStream& o, const Construct& c) {
...
/// @param c the structured construct
/// @returns the stream
inline tint::StringStream& operator<<(tint::StringStream& o, const std::unique_ptr<Construct>& c) {
    return o << *(c.get());
}
...
/// @returns the stream
inline tint::StringStream& operator<<(tint::StringStream& o, const ConstructList& cl) {
    o << "ConstructList{\n";
    for (const auto& c : cl) {
        o << "  " << c << "\n";
    }
