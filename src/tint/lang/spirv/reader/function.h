...
inline tint::StringStream& operator<<(tint::StringStream& o, const BlockInfo& bi) {
    o << "BlockInfo{"
...
/// @returns the stream so calls can be chained
inline tint::StringStream& operator<<(tint::StringStream& o, const DefInfo& di) {
    o << "DefInfo{"
...
class StatementBuilder : public tint::Castable<StatementBuilder, ast::Statement> {
  public:
    /// Constructor
