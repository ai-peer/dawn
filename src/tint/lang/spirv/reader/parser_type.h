...
class Type : public tint::Castable<Type> {
  public:
    /// Constructor
    Type();
    /// Copy constructor
...
/// `void` type
struct Void final : public tint::Castable<Void, Type> {
    /// @param b the ProgramBuilder used to construct the AST types
    /// @returns the constructed ast::Type node for the given type
...
/// `bool` type
struct Bool final : public tint::Castable<Bool, Type> {
    /// @param b the ProgramBuilder used to construct the AST types
    /// @returns the constructed ast::Type node for the given type
    ast::Type Build(ProgramBuilder& b) const override;
...
/// `u32` type
struct U32 final : public tint::Castable<U32, Type> {
    /// @param b the ProgramBuilder used to construct the AST types
    /// @returns the constructed ast::Type node for the given type
    ast::Type Build(ProgramBuilder& b) const override;
...
/// `f32` type
struct F32 final : public tint::Castable<F32, Type> {
    /// @param b the ProgramBuilder used to construct the AST types
    /// @returns the constructed ast::Type node for the given type
    ast::Type Build(ProgramBuilder& b) const override;
...
/// `i32` type
struct I32 final : public tint::Castable<I32, Type> {
    /// @param b the ProgramBuilder used to construct the AST types
    /// @returns the constructed ast::Type node for the given type
    ast::Type Build(ProgramBuilder& b) const override;
...
/// `ptr<SC, T, AM>` type
struct Pointer final : public tint::Castable<Pointer, Type> {
    /// Constructor
...
/// reader.
struct Reference final : public tint::Castable<Reference, Type> {
    /// Constructor
...
/// `vecN<T>` type
struct Vector final : public tint::Castable<Vector, Type> {
    /// Constructor
...
/// `matNxM<T>` type
struct Matrix final : public tint::Castable<Matrix, Type> {
    /// Constructor
...
/// `array<T, N>` type
struct Array final : public tint::Castable<Array, Type> {
    /// Constructor
...
/// `sampler` type
struct Sampler final : public tint::Castable<Sampler, Type> {
    /// Constructor
...
struct Texture : public tint::Castable<Texture, Type> {
    ~Texture() override;
...
struct DepthTexture final : public tint::Castable<DepthTexture, Texture> {
    /// Constructor
    /// @param d the texture dimensions
...
struct DepthMultisampledTexture final : public tint::Castable<DepthMultisampledTexture, Texture> {
    /// Constructor
    /// @param d the texture dimensions
...
struct MultisampledTexture final : public tint::Castable<MultisampledTexture, Texture> {
    /// Constructor
    /// @param d the texture dimensions
...
/// `texture_D<T>` type
struct SampledTexture final : public tint::Castable<SampledTexture, Texture> {
    /// Constructor
    /// @param d the texture dimensions
...
struct StorageTexture final : public tint::Castable<StorageTexture, Texture> {
    /// Constructor
    /// @param d the texture dimensions
...
struct Named : public tint::Castable<Named, Type> {
    /// Constructor
...
/// `type T = N` type
struct Alias final : public tint::Castable<Alias, Named> {
    /// Constructor
...
/// `struct N { ... };` type
struct Struct final : public tint::Castable<Struct, Named> {
    /// Constructor
