...
struct SwitchStatementBuilder final
    : public tint::Castable<SwitchStatementBuilder, StatementBuilder> {
    /// Constructor
...
/// @see StatementBuilder
struct IfStatementBuilder final : public tint::Castable<IfStatementBuilder, StatementBuilder> {
    /// Constructor
...
/// @see StatementBuilder
struct LoopStatementBuilder final : public tint::Castable<LoopStatementBuilder, StatementBuilder> {
    /// @param builder the program builder
...
bool FunctionEmitter::EmitStatementsInBasicBlock(const BlockInfo& block_info,
    ...
    if (!block_info.phi_assignments.IsEmpty()) {
        ...
        tint::Hashset<uint32_t, 8> read_set;
        ...
        tint::Hashmap<uint32_t, Symbol, 8> copied_phis;
        for (const auto assignment : worklist) {
