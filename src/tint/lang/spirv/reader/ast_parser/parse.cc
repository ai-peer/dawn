...
#ifndef SRC_TINT_LANG_SPIRV_READER_AST_PARSER_PARSER_H_
#define SRC_TINT_LANG_SPIRV_READER_AST_PARSER_PARSER_H_
...
#endif  // SRC_TINT_LANG_SPIRV_READER_AST_PARSER_PARSER_H_
