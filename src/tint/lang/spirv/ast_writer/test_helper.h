...
#ifndef SRC_TINT_LANG_SPIRV_AST_WRITER_TEST_HELPER_H_
#define SRC_TINT_LANG_SPIRV_AST_WRITER_TEST_HELPER_H_
...
#endif  // SRC_TINT_LANG_SPIRV_AST_WRITER_TEST_HELPER_H_
