...
#ifndef SRC_TINT_LANG_SPIRV_WRITER_SCALAR_CONSTANT_H_
#define SRC_TINT_LANG_SPIRV_WRITER_SCALAR_CONSTANT_H_
...
#endif  // SRC_TINT_LANG_SPIRV_WRITER_SCALAR_CONSTANT_H_
