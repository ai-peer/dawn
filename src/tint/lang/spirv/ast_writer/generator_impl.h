...
#ifndef SRC_TINT_LANG_SPIRV_WRITER_GENERATOR_IMPL_H_
#define SRC_TINT_LANG_SPIRV_WRITER_GENERATOR_IMPL_H_
...
#endif  // SRC_TINT_LANG_SPIRV_WRITER_GENERATOR_IMPL_H_
