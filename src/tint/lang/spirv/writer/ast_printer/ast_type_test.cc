...
TEST_F(SpirvASTPrinterTest_Type, GenerateArray_WithStride) {
    auto ary = ty.array<i32, 4>(tint::Vector{Stride(16)});
...
TEST_F(SpirvASTPrinterTest_Type, GenerateStruct) {
    ...
    auto* s = Structure("my_struct", tint::Vector{Member("a", ty.f32()), Member("b", ty.f16())});
...
TEST_F(SpirvASTPrinterTest_Type, GenerateStruct_DecoratedMembers) {
    ...
    auto* s = Structure("S", tint::Vector{
                                 Member("a", ty.f32()),
                                 Member("b", ty.f32(), tint::Vector{MemberAlign(8_i)}),
                                 Member("c", ty.f16(), tint::Vector{MemberAlign(8_u)}),
                                 Member("d", ty.f16()),
                             });
...
TEST_F(SpirvASTPrinterTest_Type, GenerateStruct_DecoratedMembers_Matrix) {
    ...
    auto* s =
        Structure("S", tint::Vector{
                           ...
                           Member("mat2x3_f32", ty.mat2x3<f32>(), tint::Vector{MemberAlign(64_i)}),
                           Member("mat4x4_f32", ty.mat4x4<f32>()),
                           Member("mat2x2_f16", ty.mat2x2<f16>(), tint::Vector{MemberAlign(32_i)}),
                           Member("mat2x3_f16", ty.mat2x3<f16>()),
                           Member("mat4x4_f16", ty.mat4x4<f16>(), tint::Vector{MemberAlign(64_i)}),
                       });
...
TEST_F(SpirvASTPrinterTest_Type, GenerateStruct_DecoratedMembers_ArraysOfMatrix) {
    ...
    auto* s = Structure(
        "S", tint::Vector{
                 ...
                 Member("arr_mat2x2_f16", arr_mat2x2_f16, tint::Vector{MemberAlign(64_i)}),
                 Member("arr_arr_mat2x3_f32", arr_arr_mat2x3_f32, tint::Vector{MemberAlign(64_i)}),
