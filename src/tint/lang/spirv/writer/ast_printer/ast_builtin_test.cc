...
TEST_F(BuiltinSpirvASTPrinterTest, Call_ArrayLength) {
    auto* s = Structure("my_struct", tint::Vector{
...
using Builtin_Builder_ThreeParam_Sint_Test = BuiltinSpirvASTPrinterTestWithParam<BuiltinData>;
...
using Builtin_Builder_ThreeParam_Uint_Test = BuiltinSpirvASTPrinterTestWithParam<BuiltinData>;
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_ExtractBits_i32) {
    auto* v = Var("v", ty.i32());
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_ExtractBits_u32) {
    auto* v = Var("v", ty.u32());
    auto* offset = Var("offset", ty.u32());
    auto* count = Var("count", ty.u32());
    auto* call = Call("extractBits", v, offset, count);
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_ExtractBits_vec3_i32) {
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_ExtractBits_vec3_u32) {
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_InsertBits_i32) {
    auto* v = Var("v", ty.i32());
    auto* n = Var("n", ty.i32());
    auto* offset = Var("offset", ty.u32());
    auto* count = Var("count", ty.u32());
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_InsertBits_u32) {
    auto* v = Var("v", ty.u32());
    auto* n = Var("n", ty.u32());
    auto* offset = Var("offset", ty.u32());
    auto* count = Var("count", ty.u32());
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_InsertBits_vec3_i32) {
    auto* v = Var("v", ty.vec3<i32>());
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_InsertBits_vec3_u32) {
    auto* v = Var("v", ty.vec3<u32>());
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_AtomicLoad) {
    // struct S {
    //   u : atomic<u32>;
    //   i : atomic<i32>;
    // }
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_AtomicStore) {
    // struct S {
    //   u : atomic<u32>;
    //   i : atomic<i32>;
    // }
...
using Builtin_Builder_AtomicRMW_i32 = BuiltinSpirvASTPrinterTestWithParam<BuiltinData>;
...
using Builtin_Builder_AtomicRMW_u32 = BuiltinSpirvASTPrinterTestWithParam<BuiltinData>;
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_AtomicExchange) {
    // struct S {
    //   u : atomic<u32>;
    //   i : atomic<i32>;
    // }
...
TEST_F(BuiltinSpirvASTPrinterTest, Call_AtomicCompareExchangeWeak) {
    // struct S {
    //   u : atomic<u32>,
    //   i : atomic<i32>,
    // }
...
using Builtin_Builder_DataPacking_Test = BuiltinSpirvASTPrinterTestWithParam<BuiltinData>;
...
using Builtin_Builder_DataUnpacking_Test = BuiltinSpirvASTPrinterTestWithParam<BuiltinData>;
