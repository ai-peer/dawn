...
#ifndef SRC_TINT_LANG_SPIRV_AST_WRITER_SCALAR_CONSTANT_H_
#define SRC_TINT_LANG_SPIRV_AST_WRITER_SCALAR_CONSTANT_H_
...
#endif  // SRC_TINT_LANG_SPIRV_AST_WRITER_SCALAR_CONSTANT_H_
