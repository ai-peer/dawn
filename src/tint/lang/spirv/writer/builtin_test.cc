...
TEST_F(SpirvWriterTest, Builtin_CountLeadingZeros_U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.u32(), builtin::Function::kCountLeadingZeros, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_CountLeadingZeros_I32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.i32(), builtin::Function::kCountLeadingZeros, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_CountLeadingZeros_Vec2U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.vec2<u32>(), builtin::Function::kCountLeadingZeros, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_CountTrailingZeros_U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.u32(), builtin::Function::kCountTrailingZeros, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_CountTrailingZeros_I32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.i32(), builtin::Function::kCountTrailingZeros, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_CountTrailingZeros_Vec2U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.vec2<u32>(), builtin::Function::kCountTrailingZeros, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_FirstLeadingBit_U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.u32(), builtin::Function::kFirstLeadingBit, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_FirstLeadingBit_I32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.i32(), builtin::Function::kFirstLeadingBit, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_FirstLeadingBit_Vec2U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.vec2<u32>(), builtin::Function::kFirstLeadingBit, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_FirstTrailingBit_U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.u32(), builtin::Function::kFirstTrailingBit, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_FirstTrailingBit_I32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.i32(), builtin::Function::kFirstTrailingBit, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
...
TEST_F(SpirvWriterTest, Builtin_FirstTrailingBit_Vec2U32) {
    ...
    func->SetParams({arg});
    b.Append(func->Block(), [&] {
        auto* result = b.Call(ty.vec2<u32>(), builtin::Function::kFirstTrailingBit, arg);
        b.Return(func, result);
        mod.SetName(result, "result");
    });
