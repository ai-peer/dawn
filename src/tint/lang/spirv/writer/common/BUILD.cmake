...
add_library(lib_tint_lang_spirv_writer_common STATIC
  ...
  "lang/spirv/writer/common/result.h"
  "lang/spirv/writer/common/spv_dump.cc"
  "lang/spirv/writer/common/spv_dump.h"
)

target_link_libraries(lib_tint_lang_spirv_writer_common
  lib_tint_utils_math
  lib_tint_utils_reflection
)

tint_default_compile_options(lib_tint_lang_spirv_writer_common)

add_library(tint_lang_spirv_writer_common_test STATIC
...
target_link_libraries(tint_lang_spirv_writer_common_test
...
tint_default_compile_options(tint_lang_spirv_writer_common_test)
