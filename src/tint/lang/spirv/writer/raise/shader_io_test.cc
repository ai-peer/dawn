...
%foo = @fragment func(%front_facing:bool [@front_facing], %position:vec4<f32> [@invariant, @position], %color1:f32 [@location(0)], %color2:f32 [@location(1), @interpolate(linear, sample)]):void -> %b1 {
  %b1 = block {
    ...
    auto* expect = R"(
%b1 = block {  # root
  %foo_front_facing_Input:ptr<__in, bool, read> = var
  %foo_position_Input:ptr<__in, vec4<f32>, read> = var
  %foo_loc0_Input:ptr<__in, f32, read> = var
  %foo_loc1_Input:ptr<__in, f32, read> = var
}
...
%foo = @vertex func():vec4<f32> [@invariant, @position] -> %b1 {
  %b1 = block {
    ...
    auto* expect = R"(
%b1 = block {  # root
  %foo_position_Output:ptr<__out, vec4<f32>, write> = var
}
...
%foo = @fragment func():vec4<f32> [@location(1)] -> %b1 {
  %b1 = block {
    ...
    auto* expect = R"(
%b1 = block {  # root
  %foo_loc1_Output:ptr<__out, vec4<f32>, write> = var
}
...
%b1 = block {  # root
  %foo_position_Output:ptr<__out, vec4<f32>, write> = var
  %foo_loc0_Output:ptr<__out, f32, write> = var
  %foo_loc1_Output:ptr<__out, f32, write> = var
}
...
%b1 = block {  # root
  %vert_position_Output:ptr<__out, vec4<f32>, write> = var
  %vert_loc0_Output:ptr<__out, vec4<f32>, write> = var
  %frag_position_Input:ptr<__in, vec4<f32>, read> = var
  %frag_loc0_Input:ptr<__in, vec4<f32>, read> = var
  %frag_loc0_Output:ptr<__out, vec4<f32>, write> = var
}
...
%b1 = block {  # root
  %foo_sample_mask_Input:ptr<__in, array<u32, 1>, read> = var
  %foo_loc0_Output:ptr<__out, f32, write> = var
  %foo_sample_mask_Output:ptr<__out, array<u32, 1>, write> = var
}
...
%b1 = block {  # root
  %foo_loc0_Output:ptr<__out, f32, write> = var
  %foo_frag_depth_Output:ptr<__out, f32, write> = var
