...
TEST_F(SpirvWriterTest, Switch_Basic) {
    ...
    b.Append(func->Block(), [&] {
        ...
        auto* def_case = b.Case(swtch, tint::Vector{ir::Switch::CaseSelector()});
        b.Append(def_case, [&] {  //
            b.ExitSwitch(swtch);
        });
...
TEST_F(SpirvWriterTest, Switch_MultipleCases) {
    ...
    b.Append(func->Block(), [&] {
        ...
        auto* case_a = b.Case(swtch, tint::Vector{ir::Switch::CaseSelector{b.Constant(1_i)}});
        b.Append(case_a, [&] {  //
            b.ExitSwitch(swtch);
        });

        auto* case_b = b.Case(swtch, tint::Vector{ir::Switch::CaseSelector{b.Constant(2_i)}});
        b.Append(case_b, [&] {  //
            b.ExitSwitch(swtch);
        });
...
TEST_F(SpirvWriterTest, Switch_MultipleSelectorsPerCase) {
    ...
    b.Append(func->Block(), [&] {
        ...
        auto* def_case = b.Case(swtch, tint::Vector{ir::Switch::CaseSelector{b.Constant(5_i)},
...
TEST_F(SpirvWriterTest, Switch_Phi_SingleValue) {
    ...
    b.Append(func->Block(), [&] {
        ...
        auto* case_a = b.Case(s, tint::Vector{ir::Switch::CaseSelector{b.Constant(1_i)},
                                              ir::Switch::CaseSelector{nullptr}});
        b.Append(case_a, [&] {  //
            b.ExitSwitch(s, 10_i);
        });

        auto* case_b = b.Case(s, tint::Vector{ir::Switch::CaseSelector{b.Constant(2_i)}});
        b.Append(case_b, [&] {  //
            b.ExitSwitch(s, 20_i);
        });
