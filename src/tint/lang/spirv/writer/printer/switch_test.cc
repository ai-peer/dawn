...
TEST_F(SpirvPrinterTest, Switch_Basic) {
...
TEST_F(SpirvPrinterTest, Switch_MultipleCases) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* swtch = b.Switch(42_i);
...
TEST_F(SpirvPrinterTest, Switch_MultipleSelectorsPerCase) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* swtch = b.Switch(42_i);
...
TEST_F(SpirvPrinterTest, Switch_AllCasesReturn) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* swtch = b.Switch(42_i);
...
TEST_F(SpirvPrinterTest, Switch_ConditionalBreak) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* swtch = b.Switch(42_i);
...
TEST_F(SpirvPrinterTest, Switch_Phi_SingleValue) {
...
TEST_F(SpirvPrinterTest, Switch_Phi_SingleValue_CaseReturn) {
    auto* func = b.Function("foo", ty.i32());
    b.With(func->Block(), [&] {
        auto* s = b.Switch(42_i);
        s->SetResults(b.InstructionResult(ty.i32()));
...
TEST_F(SpirvPrinterTest, Switch_Phi_MultipleValue_0) {
    auto* func = b.Function("foo", ty.i32());
    b.With(func->Block(), [&] {
        auto* s = b.Switch(42_i);
...
TEST_F(SpirvPrinterTest, Switch_Phi_MultipleValue_1) {
