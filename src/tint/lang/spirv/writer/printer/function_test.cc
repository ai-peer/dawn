...
TEST_F(SpirvPrinterTest, Function_Empty) {
...
TEST_F(SpirvPrinterTest, Function_DeduplicateType) {
...
TEST_F(SpirvPrinterTest, Function_EntryPoint_Compute) {
    auto* func =
...
TEST_F(SpirvPrinterTest, Function_EntryPoint_Fragment) {
...
TEST_F(SpirvPrinterTest, Function_EntryPoint_Vertex) {
...
TEST_F(SpirvPrinterTest, Function_EntryPoint_Multiple) {
...
TEST_F(SpirvPrinterTest, Function_ReturnValue) {
...
TEST_F(SpirvPrinterTest, Function_Parameters) {
    auto* i32 = ty.i32();
...
TEST_F(SpirvPrinterTest, Function_Call) {
    auto* i32 = ty.i32();
    auto* x = b.FunctionParam("x", i32);
    auto* y = b.FunctionParam("y", i32);
...
TEST_F(SpirvPrinterTest, Function_Call_Void) {
