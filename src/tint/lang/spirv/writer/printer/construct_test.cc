...
TEST_F(SpirvPrinterTest, Construct_Vector) {
...
TEST_F(SpirvPrinterTest, Construct_Matrix) {
...
TEST_F(SpirvPrinterTest, Construct_Array) {
...
TEST_F(SpirvPrinterTest, Construct_Struct) {
    auto* str =
...
TEST_F(SpirvPrinterTest, Construct_Scalar_Identity) {
...
TEST_F(SpirvPrinterTest, Construct_Vector_Identity) {
    auto* func = b.Function("foo", ty.vec4<i32>());
