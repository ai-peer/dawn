...
TEST_F(SpirvPrinterTest, Type_Void) {
...
TEST_F(SpirvPrinterTest, Type_Bool) {
...
TEST_F(SpirvPrinterTest, Type_I32) {
    writer_.Type(ty.i32());
...
TEST_F(SpirvPrinterTest, Type_U32) {
    writer_.Type(ty.u32());
...
TEST_F(SpirvPrinterTest, Type_F32) {
    writer_.Type(ty.f32());
...
TEST_F(SpirvPrinterTest, Type_F16) {
    writer_.Type(ty.f16());
...
TEST_F(SpirvPrinterTest, Type_Vec2i) {
...
TEST_F(SpirvPrinterTest, Type_Vec3u) {
...
TEST_F(SpirvPrinterTest, Type_Vec4f) {
...
TEST_F(SpirvPrinterTest, Type_Vec2h) {
...
TEST_F(SpirvPrinterTest, Type_Vec4Bool) {
...
TEST_F(SpirvPrinterTest, Type_Mat2x3f) {
...
TEST_F(SpirvPrinterTest, Type_Mat4x2h) {
...
TEST_F(SpirvPrinterTest, Type_Array_DefaultStride) {
...
TEST_F(SpirvPrinterTest, Type_Array_ExplicitStride) {
...
TEST_F(SpirvPrinterTest, Type_Array_NestedArray) {
...
TEST_F(SpirvPrinterTest, Type_RuntimeArray_DefaultStride) {
...
TEST_F(SpirvPrinterTest, Type_RuntimeArray_ExplicitStride) {
...
TEST_F(SpirvPrinterTest, Type_Struct) {
    auto* str =
...
TEST_F(SpirvPrinterTest, Type_Struct_MatrixLayout) {
    auto* str = ty.Struct(
...
TEST_F(SpirvPrinterTest, Type_Atomic) {
...
TEST_F(SpirvPrinterTest, Type_Sampler) {
...
TEST_F(SpirvPrinterTest, Type_SamplerComparison) {
...
TEST_F(SpirvPrinterTest, Type_Samplers_Dedup) {
...
using Type_SampledTexture = SpirvPrinterTestWithParam<TextureCase>;
...
using Type_MultisampledTexture = SpirvPrinterTestWithParam<TextureCase>;
...
using Type_DepthTexture = SpirvPrinterTestWithParam<TextureCase>;
...
TEST_F(SpirvPrinterTest, Type_DepthTexture_DedupWithSampledTexture) {
...
TEST_F(SpirvPrinterTest, Type_DepthMultiSampledTexture) {
...
TEST_F(SpirvPrinterTest, Type_DepthMultisampledTexture_DedupWithMultisampledTexture) {
...
using Type_StorageTexture = SpirvPrinterTestWithParam<StorageTextureCase>;
...
TEST_F(SpirvPrinterTest, Type_Multiple) {
    writer_.Type(ty.i32());
    writer_.Type(ty.u32());
    writer_.Type(ty.f32());
    writer_.Type(ty.f16());
...
TEST_F(SpirvPrinterTest, Type_Deduplicate) {
