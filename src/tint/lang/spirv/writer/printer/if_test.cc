...
TEST_F(SpirvPrinterTest, If_TrueEmpty_FalseEmpty) {
...
TEST_F(SpirvPrinterTest, If_FalseEmpty) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
        b.With(i->True(), [&] {
...
TEST_F(SpirvPrinterTest, If_TrueEmpty) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
        b.With(i->True(), [&] {  //
...
TEST_F(SpirvPrinterTest, If_BothBranchesReturn) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
        b.With(i->True(), [&] {  //
...
TEST_F(SpirvPrinterTest, If_Phi_SingleValue) {
...
TEST_F(SpirvPrinterTest, If_Phi_SingleValue_TrueReturn) {
    auto* func = b.Function("foo", ty.i32());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
        i->SetResults(b.InstructionResult(ty.i32()));
...
TEST_F(SpirvPrinterTest, If_Phi_SingleValue_FalseReturn) {
    auto* func = b.Function("foo", ty.i32());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
        i->SetResults(b.InstructionResult(ty.i32()));
...
TEST_F(SpirvPrinterTest, If_Phi_MultipleValue_0) {
    auto* func = b.Function("foo", ty.i32());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
...
TEST_F(SpirvPrinterTest, If_Phi_MultipleValue_1) {
