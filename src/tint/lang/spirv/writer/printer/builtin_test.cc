...
using Builtin_1arg = SpirvPrinterTestWithParam<BuiltinTestCase>;
...
TEST_F(SpirvPrinterTest, Builtin_Abs_u32) {
...
TEST_F(SpirvPrinterTest, Builtin_Abs_vec2u) {
...
TEST_F(SpirvPrinterTest, Builtin_All_Scalar) {
...
TEST_F(SpirvPrinterTest, Builtin_All_Vector) {
...
TEST_F(SpirvPrinterTest, Builtin_Any_Scalar) {
    auto* arg = b.FunctionParam("arg", ty.bool_());
    auto* func = b.Function("foo", ty.bool_());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Any_Vector) {
    auto* arg = b.FunctionParam("arg", ty.vec4<bool>());
    auto* func = b.Function("foo", ty.bool_());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Determinant_Mat4x4f) {
...
TEST_F(SpirvPrinterTest, Builtin_Determinant_Mat3x3h) {
...
TEST_F(SpirvPrinterTest, Builtin_Frexp_F32) {
...
TEST_F(SpirvPrinterTest, Builtin_Frexp_F16) {
...
TEST_F(SpirvPrinterTest, Builtin_Frexp_Vec2f) {
...
TEST_F(SpirvPrinterTest, Builtin_Frexp_Vec3h) {
...
TEST_F(SpirvPrinterTest, Builtin_Length_vec4f) {
...
TEST_F(SpirvPrinterTest, Builtin_Modf_F32) {
...
TEST_F(SpirvPrinterTest, Builtin_Modf_F16) {
...
TEST_F(SpirvPrinterTest, Builtin_Modf_Vec2f) {
...
TEST_F(SpirvPrinterTest, Builtin_Modf_Vec3h) {
...
TEST_F(SpirvPrinterTest, Builtin_Normalize_vec4f) {
    auto* arg = b.FunctionParam("arg", ty.vec4<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_Transpose_Mat2x3f) {
...
TEST_F(SpirvPrinterTest, Builtin_Transpose_Mat4x4f) {
    auto* arg = b.FunctionParam("arg", ty.mat4x4<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_Transpose_Mat4x3h) {
...
TEST_F(SpirvPrinterTest, Builtin_Transpose_Mat2x2h) {
...
TEST_F(SpirvPrinterTest, Builtin_Pack2X16Float) {
    auto* arg = b.FunctionParam("arg", ty.vec2<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_Pack2X16Snorm) {
    auto* arg = b.FunctionParam("arg", ty.vec2<f32>());
    auto* func = b.Function("foo", ty.u32());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Pack2X16Unorm) {
    auto* arg = b.FunctionParam("arg", ty.vec2<f32>());
    auto* func = b.Function("foo", ty.u32());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Pack4X8Snorm) {
    auto* arg = b.FunctionParam("arg", ty.vec4<f32>());
    auto* func = b.Function("foo", ty.u32());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Pack4X8Unorm) {
    auto* arg = b.FunctionParam("arg", ty.vec4<f32>());
    auto* func = b.Function("foo", ty.u32());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Unpack2X16Float) {
...
TEST_F(SpirvPrinterTest, Builtin_Unpack2X16Snorm) {
    auto* arg = b.FunctionParam("arg", ty.u32());
    auto* func = b.Function("foo", ty.vec2<f32>());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Unpack2X16Unorm) {
    auto* arg = b.FunctionParam("arg", ty.u32());
    auto* func = b.Function("foo", ty.vec2<f32>());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Unpack4X8Snorm) {
    auto* arg = b.FunctionParam("arg", ty.u32());
    auto* func = b.Function("foo", ty.vec4<f32>());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_Unpack4X8Unorm) {
    auto* arg = b.FunctionParam("arg", ty.u32());
    auto* func = b.Function("foo", ty.vec4<f32>());
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
using Builtin_2arg = SpirvPrinterTestWithParam<BuiltinTestCase>;
...
TEST_F(SpirvPrinterTest, Builtin_Cross_vec3f) {
...
TEST_F(SpirvPrinterTest, Builtin_Distance_vec2f) {
...
TEST_F(SpirvPrinterTest, Builtin_Distance_vec3h) {
...
TEST_F(SpirvPrinterTest, Builtin_Dot_vec4f) {
...
TEST_F(SpirvPrinterTest, Builtin_Dot_vec2i) {
...
TEST_F(SpirvPrinterTest, Builtin_Dot_vec4u) {
...
TEST_F(SpirvPrinterTest, Builtin_Ldexp_F32) {
...
TEST_F(SpirvPrinterTest, Builtin_Ldexp_F16) {
...
TEST_F(SpirvPrinterTest, Builtin_Ldexp_Vec2_F32) {
...
TEST_F(SpirvPrinterTest, Builtin_Ldexp_Vec3_F16) {
...
TEST_F(SpirvPrinterTest, Builtin_Reflect_F32) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec3<f32>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec3<f32>());
    auto* func = b.Function("foo", ty.vec3<f32>());
    func->SetParams({arg1, arg2});
...
TEST_F(SpirvPrinterTest, Builtin_Reflect_F16) {
...
using Builtin_3arg = SpirvPrinterTestWithParam<BuiltinTestCase>;
...
TEST_F(SpirvPrinterTest, Builtin_ExtractBits_Scalar_I32) {
...
TEST_F(SpirvPrinterTest, Builtin_ExtractBits_Scalar_U32) {
    auto* arg = b.FunctionParam("arg", ty.u32());
    auto* offset = b.FunctionParam("offset", ty.u32());
    auto* count = b.FunctionParam("count", ty.u32());
    auto* func = b.Function("foo", ty.u32());
...
TEST_F(SpirvPrinterTest, Builtin_ExtractBits_Vector_I32) {
...
TEST_F(SpirvPrinterTest, Builtin_ExtractBits_Vector_U32) {
...
TEST_F(SpirvPrinterTest, Builtin_InsertBits_Scalar_I32) {
    auto* arg = b.FunctionParam("arg", ty.i32());
...
TEST_F(SpirvPrinterTest, Builtin_InsertBits_Scalar_U32) {
    auto* arg = b.FunctionParam("arg", ty.u32());
...
TEST_F(SpirvPrinterTest, Builtin_InsertBits_Vector_I32) {
    auto* arg = b.FunctionParam("arg", ty.vec4<i32>());
...
TEST_F(SpirvPrinterTest, Builtin_InsertBits_Vector_U32) {
    auto* arg = b.FunctionParam("arg", ty.vec2<u32>());
...
TEST_F(SpirvPrinterTest, Builtin_FaceForward_F32) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec3<f32>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec3<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_FaceForward_F16) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec4<f16>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec4<f16>());
...
TEST_F(SpirvPrinterTest, Builtin_Mix_VectorOperands_ScalarFactor) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec4<f32>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec4<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_Mix_VectorOperands_VectorFactor) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec4<f32>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec4<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_Refract_F32) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec4<f32>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec4<f32>());
...
TEST_F(SpirvPrinterTest, Builtin_Refract_F16) {
    auto* arg1 = b.FunctionParam("arg1", ty.vec4<f16>());
    auto* arg2 = b.FunctionParam("arg2", ty.vec4<f16>());
...
TEST_F(SpirvPrinterTest, Builtin_Select_ScalarCondition_ScalarOperands) {
...
TEST_F(SpirvPrinterTest, Builtin_Select_VectorCondition_VectorOperands) {
...
TEST_F(SpirvPrinterTest, Builtin_Select_ScalarCondition_VectorOperands) {
    auto* argf = b.FunctionParam("argf", ty.vec4<i32>());
    auto* argt = b.FunctionParam("argt", ty.vec4<i32>());
    auto* cond = b.FunctionParam("cond", ty.bool_());
    auto* func = b.Function("foo", ty.vec4<i32>());
...
TEST_F(SpirvPrinterTest, Builtin_StorageBarrier) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_WorkgroupBarrier) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Builtin_ArrayLength) {
...
TEST_F(SpirvPrinterTest, Builtin_ArrayLength_WithStruct) {
