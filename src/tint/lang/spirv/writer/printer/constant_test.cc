...
TEST_F(SpirvPrinterTest, Constant_Bool) {
...
TEST_F(SpirvPrinterTest, Constant_I32) {
...
TEST_F(SpirvPrinterTest, Constant_U32) {
...
TEST_F(SpirvPrinterTest, Constant_F32) {
...
TEST_F(SpirvPrinterTest, Constant_F16) {
...
TEST_F(SpirvPrinterTest, Constant_Vec4Bool) {
...
TEST_F(SpirvPrinterTest, Constant_Vec2i) {
...
TEST_F(SpirvPrinterTest, Constant_Vec3u) {
...
TEST_F(SpirvPrinterTest, Constant_Vec4f) {
...
TEST_F(SpirvPrinterTest, Constant_Vec2h) {
...
TEST_F(SpirvPrinterTest, Constant_Mat2x3f) {
    auto const_f32 = [&](float val) { return mod.constant_values.Get(f32(val)); };
    auto* f32 = ty.f32();
    auto* v = mod.constant_values.Composite(
        ty.mat2x3(f32),
...
TEST_F(SpirvPrinterTest, Constant_Mat4x2h) {
    auto const_f16 = [&](float val) { return mod.constant_values.Get(f16(val)); };
    auto* f16 = ty.f16();
    auto* v = mod.constant_values.Composite(
...
TEST_F(SpirvPrinterTest, Constant_Array_I32) {
    auto* arr =
...
TEST_F(SpirvPrinterTest, Constant_Array_Array_I32) {
    auto* inner =
        mod.constant_values.Composite(ty.array(ty.i32(), 4), utils::Vector{
                                                                 mod.constant_values.Get(1_i),
                                                                 mod.constant_values.Get(2_i),
...
TEST_F(SpirvPrinterTest, Constant_Struct) {
...
TEST_F(SpirvPrinterTest, Constant_Deduplicate) {
    writer_.Constant(b.Constant(i32(42)));
    writer_.Constant(b.Constant(i32(42)));
    writer_.Constant(b.Constant(i32(42)));
    ASSERT_TRUE(Generate()) << Error() << output_;
