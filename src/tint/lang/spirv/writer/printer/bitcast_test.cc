...
using Bitcast = SpirvPrinterTestWithParam<BitcastCase>;
...
INSTANTIATE_TEST_SUITE_P(SpirvPrinterTest,
                         Bitcast,
                         testing::Values(
                             // To f32.
...
TEST_F(SpirvPrinterTest, Bitcast_u32_to_vec2h) {
...
TEST_F(SpirvPrinterTest, Bitcast_vec2i_to_vec4h) {
...
TEST_F(SpirvPrinterTest, Bitcast_vec2h_to_u32) {
...
TEST_F(SpirvPrinterTest, Bitcast_vec4h_to_vec2i) {
