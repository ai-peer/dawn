...
TEST_F(SpirvPrinterTest, AtomicAdd_Storage) {
...
TEST_F(SpirvPrinterTest, AtomicAdd_Workgroup) {
...
TEST_F(SpirvPrinterTest, AtomicAnd) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicCompareExchangeWeak) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicExchange) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicLoad) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicMax_I32) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicMax_U32) {
...
TEST_F(SpirvPrinterTest, AtomicMin_I32) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicMin_U32) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.u32()))));
...
TEST_F(SpirvPrinterTest, AtomicOr) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicStore) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicSub) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
...
TEST_F(SpirvPrinterTest, AtomicXor) {
    auto* var = b.RootBlock()->Append(b.Var("var", ty.ptr(workgroup, ty.atomic(ty.i32()))));
