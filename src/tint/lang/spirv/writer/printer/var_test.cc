...
TEST_F(SpirvPrinterTest, FunctionVar_NoInit) {
...
TEST_F(SpirvPrinterTest, FunctionVar_WithInit) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, FunctionVar_DeclInsideBlock) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* i = b.If(true);
        b.With(i->True(), [&] {
...
TEST_F(SpirvPrinterTest, FunctionVar_Load) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* v = b.Var("v", ty.ptr<function, i32>());
...
TEST_F(SpirvPrinterTest, FunctionVar_Store) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* v = b.Var("v", ty.ptr<function, i32>());
        b.Store(v, 42_i);
...
TEST_F(SpirvPrinterTest, PrivateVar_NoInit) {
...
TEST_F(SpirvPrinterTest, PrivateVar_WithInit) {
...
TEST_F(SpirvPrinterTest, PrivateVar_LoadAndStore) {
    auto* v = b.Var("v", ty.ptr<private_, i32>());
    v->SetInitializer(b.Constant(42_i));
    b.RootBlock()->Append(v);
...
TEST_F(SpirvPrinterTest, WorkgroupVar) {
...
TEST_F(SpirvPrinterTest, WorkgroupVar_LoadAndStore) {
...
TEST_F(SpirvPrinterTest, WorkgroupVar_ZeroInitializeWithExtension) {
    b.RootBlock()->Append(b.Var("v", ty.ptr<workgroup, i32>()));
...
TEST_F(SpirvPrinterTest, StorageVar) {
...
TEST_F(SpirvPrinterTest, StorageVar_LoadAndStore) {
    auto* v = b.Var("v", ty.ptr<storage, i32>());
    v->SetBindingPoint(0, 0);
    b.RootBlock()->Append(v);
...
TEST_F(SpirvPrinterTest, UniformVar) {
...
TEST_F(SpirvPrinterTest, UniformVar_Load) {
    auto* v = b.Var("v", ty.ptr<uniform, i32>());
    v->SetBindingPoint(0, 0);
    b.RootBlock()->Append(v);
...
TEST_F(SpirvPrinterTest, PushConstantVar) {
...
TEST_F(SpirvPrinterTest, PushConstantVar_Load) {
    auto* v = b.Var("v", ty.ptr<push_constant, i32>());
    b.RootBlock()->Append(v);
...
TEST_F(SpirvPrinterTest, SamplerVar) {
    auto* v =
...
TEST_F(SpirvPrinterTest, SamplerVar_Load) {
    auto* v =
        b.Var("v", ty.ptr(builtin::AddressSpace::kHandle, ty.sampler(), builtin::Access::kRead));
    v->SetBindingPoint(0, 0);
    b.RootBlock()->Append(v);
...
TEST_F(SpirvPrinterTest, TextureVar) {
...
TEST_F(SpirvPrinterTest, TextureVar_Load) {
    auto* v = b.Var("v", ty.ptr(builtin::AddressSpace::kHandle,
                                ty.Get<type::SampledTexture>(type::TextureDimension::k2d, ty.f32()),
                                builtin::Access::kRead));
    v->SetBindingPoint(0, 0);
