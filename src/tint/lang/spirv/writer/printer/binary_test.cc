...
using Arithmetic_Bitwise = SpirvPrinterTestWithParam<BinaryTestCase>;
...
TEST_F(SpirvPrinterTest, Binary_ScalarTimesVector_F32) {
...
TEST_F(SpirvPrinterTest, Binary_VectorTimesScalar_F32) {
    auto* scalar = b.FunctionParam("scalar", ty.f32());
    auto* vector = b.FunctionParam("vector", ty.vec4<f32>());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({scalar, vector});
...
TEST_F(SpirvPrinterTest, Binary_ScalarTimesMatrix_F32) {
    auto* scalar = b.FunctionParam("scalar", ty.f32());
...
TEST_F(SpirvPrinterTest, Binary_MatrixTimesScalar_F32) {
    auto* scalar = b.FunctionParam("scalar", ty.f32());
    auto* matrix = b.FunctionParam("matrix", ty.mat3x4<f32>());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({scalar, matrix});
...
TEST_F(SpirvPrinterTest, Binary_VectorTimesMatrix_F32) {
    auto* vector = b.FunctionParam("vector", ty.vec4<f32>());
    auto* matrix = b.FunctionParam("matrix", ty.mat3x4<f32>());
    auto* func = b.Function("foo", ty.void_());
...
TEST_F(SpirvPrinterTest, Binary_MatrixTimesVector_F32) {
...
TEST_F(SpirvPrinterTest, Binary_MatrixTimesMatrix_F32) {
...
using Comparison = SpirvPrinterTestWithParam<BinaryTestCase>;
...
INSTANTIATE_TEST_SUITE_P(SpirvPrinterTest_Binary_Bool,
                         Comparison,
...
TEST_F(SpirvPrinterTest, Binary_Chain) {
    auto* func = b.Function("foo", ty.void_());
