...
#ifndef SRC_TINT_LANG_SPIRV_WRITER_PRINTER_TEST_HELPER_H_
#define SRC_TINT_LANG_SPIRV_WRITER_PRINTER_TEST_HELPER_H_
...
class SpirvPrinterTestHelperBase : public BASE {
  public:
    SpirvPrinterTestHelperBase() : writer_(&mod, false) {}
...
using SpirvPrinterTest = SpirvPrinterTestHelperBase<testing::Test>;

template <typename T>
using SpirvPrinterTestWithParam = SpirvPrinterTestHelperBase<testing::TestWithParam<T>>;

}  // namespace tint::spirv::writer

#endif  // SRC_TINT_LANG_SPIRV_WRITER_PRINTER_TEST_HELPER_H_
