...
TEST_F(SpirvPrinterTest, Swizzle_TwoElements) {
...
TEST_F(SpirvPrinterTest, Swizzle_ThreeElements) {
    auto* vec = b.FunctionParam("vec", ty.vec4<i32>());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({vec});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Swizzle_FourElements) {
    auto* vec = b.FunctionParam("vec", ty.vec4<i32>());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({vec});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Swizzle_RepeatedElements) {
