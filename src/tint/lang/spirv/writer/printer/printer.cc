...
void Printer::EmitIOAttributes(uint32_t id,
                               const ir::IOVarAttributes& attrs,
...
void Printer::EmitVar(core::ir::Var* var) {
    ...
    switch (ptr->AddressSpace()) {
        ...
        case core::AddressSpace::kIn: {
            ...
            auto* iovar = var->As<ir::IOVar>();
            TINT_ASSERT(iovar);
            EmitIOAttributes(id, iovar->Attributes(), core::AddressSpace::kIn);
        ...
        case core::AddressSpace::kOut: {
            ...
            auto* iovar = var->As<ir::IOVar>();
            TINT_ASSERT(iovar);
            EmitIOAttributes(id, iovar->Attributes(), core::AddressSpace::kOut);
