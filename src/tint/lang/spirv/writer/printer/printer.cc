...
void Printer::EmitSpirvBuiltinCall(spirv::ir::BuiltinCall* builtin) {
    ...
    switch (builtin->Func()) {
        ...
        case spirv::ir::Function::kImageRead:
            ...
            break;
        case spirv::ir::Function::kImageSampleImplicitLod:
            op = spv::Op::OpImageSampleImplicitLod;
            break;
        case spirv::ir::Function::kImageSampleExplicitLod:
            op = spv::Op::OpImageSampleExplicitLod;
            break;
        case spirv::ir::Function::kImageSampleDrefImplicitLod:
            op = spv::Op::OpImageSampleDrefImplicitLod;
            break;
        case spirv::ir::Function::kImageSampleDrefExplicitLod:
            op = spv::Op::OpImageSampleDrefExplicitLod;
            break;
        case spirv::ir::Function::kImageWrite:
