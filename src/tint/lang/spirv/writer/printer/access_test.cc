...
#include "src/tint/lang/spirv/writer/printer/test_helper.h"
...
TEST_F(SpirvPrinterTest, Access_Array_Value_ConstantIndex) {
...
TEST_F(SpirvPrinterTest, Access_Array_Pointer_ConstantIndex) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Access_Array_Pointer_DynamicIndex) {
...
TEST_F(SpirvPrinterTest, Access_Matrix_Value_ConstantIndex) {
...
TEST_F(SpirvPrinterTest, Access_Matrix_Pointer_ConstantIndex) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Access_Matrix_Pointer_DynamicIndex) {
    auto* idx = b.FunctionParam("idx", ty.i32());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({idx});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Access_Vector_Value_ConstantIndex) {
...
TEST_F(SpirvPrinterTest, Access_Vector_Value_DynamicIndex) {
    auto* vec_val = b.FunctionParam("vec", ty.vec4(ty.i32()));
    auto* idx = b.FunctionParam("idx", ty.i32());
    auto* func = b.Function("foo", ty.void_());
...
TEST_F(SpirvPrinterTest, Access_NestedVector_Value_DynamicIndex) {
...
TEST_F(SpirvPrinterTest, Access_Struct_Value_ConstantIndex) {
    auto* str =
...
TEST_F(SpirvPrinterTest, Access_Struct_Pointer_ConstantIndex) {
    auto* str =
        ty.Struct(mod.symbols.New("MyStruct"), {
                                                   {mod.symbols.Register("a"), ty.f32()},
                                                   {mod.symbols.Register("b"), ty.vec4<i32>()},
...
TEST_F(SpirvPrinterTest, LoadVectorElement_ConstantIndex) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, LoadVectorElement_DynamicIndex) {
    auto* idx = b.FunctionParam("idx", ty.i32());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({idx});
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, StoreVectorElement_ConstantIndex) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* vec_var = b.Var("vec", ty.ptr<function, vec4<i32>>());
...
TEST_F(SpirvPrinterTest, StoreVectorElement_DynamicIndex) {
    auto* idx = b.FunctionParam("idx", ty.i32());
    auto* func = b.Function("foo", ty.void_());
    func->SetParams({idx});
    b.With(func->Block(), [&] {
