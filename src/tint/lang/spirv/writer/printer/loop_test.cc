...
TEST_F(SpirvPrinterTest, Loop_BreakIf) {
...
TEST_F(SpirvPrinterTest, Loop_UnconditionalBreakInBody) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* loop = b.Loop();
        b.With(loop->Body(), [&] {  //
...
TEST_F(SpirvPrinterTest, Loop_ConditionalBreakInBody) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* loop = b.Loop();
        b.With(loop->Body(), [&] {
...
TEST_F(SpirvPrinterTest, Loop_ConditionalContinueInBody) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* loop = b.Loop();
        b.With(loop->Body(), [&] {
...
TEST_F(SpirvPrinterTest, Loop_UnconditionalReturnInBody) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* loop = b.Loop();
        b.With(loop->Body(), [&] {  //
...
TEST_F(SpirvPrinterTest, Loop_UseResultFromBodyInContinuing) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* loop = b.Loop();
        b.With(loop->Body(), [&] {
...
TEST_F(SpirvPrinterTest, Loop_NestedLoopInBody) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
...
TEST_F(SpirvPrinterTest, Loop_NestedLoopInContinuing) {
    auto* func = b.Function("foo", ty.void_());
    b.With(func->Block(), [&] {
        auto* outer_loop = b.Loop();
        b.With(outer_loop->Body(), [&] {
...
TEST_F(SpirvPrinterTest, Loop_Phi_SingleValue) {
    auto* func = b.Function("foo", ty.void_());
...
TEST_F(SpirvPrinterTest, Loop_Phi_MultipleValue) {
    auto* func = b.Function("foo", ty.void_());
