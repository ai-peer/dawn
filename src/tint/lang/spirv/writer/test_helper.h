...
inline tint::StringStream& operator<<(tint::StringStream& out, TestElementType type) {
    switch (type) {
        case kBool:
            out << "bool";
            break;
        ...
        switch (type) {
            case kBool:
                return b.Constant(mod.constant_values.Composite(
                    MakeVectorType(type),
                    tint::Vector<const constant::Value*, 2>{mod.constant_values.Get(true),
                                                            mod.constant_values.Get(false)}));
            case kI32:
                return b.Constant(mod.constant_values.Composite(
                    MakeVectorType(type),
                    tint::Vector<const constant::Value*, 2>{mod.constant_values.Get(i32(42)),
                                                            mod.constant_values.Get(i32(-10))}));
            case kU32:
                return b.Constant(mod.constant_values.Composite(
                    MakeVectorType(type),
                    tint::Vector<const constant::Value*, 2>{mod.constant_values.Get(u32(42)),
                                                            mod.constant_values.Get(u32(10))}));
            case kF32:
                return b.Constant(mod.constant_values.Composite(
                    MakeVectorType(type),
                    tint::Vector<const constant::Value*, 2>{mod.constant_values.Get(f32(42)),
                                                            mod.constant_values.Get(f32(-0.5))}));
            case kF16:
                return b.Constant(mod.constant_values.Composite(
                    MakeVectorType(type),
                    tint::Vector<const constant::Value*, 2>{mod.constant_values.Get(f16(42)),
