...
%int_2147483647 = OpConstant %int 2147483647
       ...
       %void = OpTypeVoid
        ...
        %arg = OpFunctionParameter %v2float
          %8 = OpLabel
     %result = OpFunctionCall %v2int %tint_f32_to_v2i32 %arg
               OpReturnValue %result
               OpFunctionEnd

               ; Function tint_f32_to_v2i32
%tint_f32_to_v2i32 = OpFunction %v2int None %7
...
%uint_4294967295 = OpConstant %uint 4294967295
       ...
       %void = OpTypeVoid
        ...
        %arg = OpFunctionParameter %v3float
          %8 = OpLabel
     %result = OpFunctionCall %v3uint %tint_f32_to_v3u32 %arg
               OpReturnValue %result
               OpFunctionEnd

               ; Function tint_f32_to_v3u32
%tint_f32_to_v3u32 = OpFunction %v3uint None %7
...
%int_2147483647 = OpConstant %int 2147483647
       ...
       %void = OpTypeVoid
        ...
        %arg = OpFunctionParameter %v2half
          %8 = OpLabel
     %result = OpFunctionCall %v2int %tint_f16_to_v2i32 %arg
               OpReturnValue %result
               OpFunctionEnd

               ; Function tint_f16_to_v2i32
%tint_f16_to_v2i32 = OpFunction %v2int None %7
...
%uint_4294967295 = OpConstant %uint 4294967295
       ...
       %void = OpTypeVoid
        ...
        %arg = OpFunctionParameter %v4half
          %8 = OpLabel
     %result = OpFunctionCall %v4uint %tint_f16_to_v4u32 %arg
               OpReturnValue %result
               OpFunctionEnd

               ; Function tint_f16_to_v4u32
%tint_f16_to_v4u32 = OpFunction %v4uint None %7
