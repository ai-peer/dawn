...
#ifndef SRC_TINT_LANG_SPIRV_WRITER_IR_TEST_HELPER_IR_H_
#define SRC_TINT_LANG_SPIRV_WRITER_IR_TEST_HELPER_IR_H_
...
#endif  // SRC_TINT_LANG_SPIRV_WRITER_IR_TEST_HELPER_IR_H_
