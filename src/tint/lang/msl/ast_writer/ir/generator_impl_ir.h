...
#ifndef SRC_TINT_LANG_MSL_AST_WRITER_IR_GENERATOR_IMPL_IR_H_
#define SRC_TINT_LANG_MSL_AST_WRITER_IR_GENERATOR_IMPL_IR_H_
...
#endif  // SRC_TINT_LANG_MSL_AST_WRITER_IR_GENERATOR_IMPL_IR_H_
