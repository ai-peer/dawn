...
/// The result will contain the MSL and supplementary information, or error diagnostics.
/// @param program the program to translate to MSL
/// @param options the configuration options to use when generating MSL
/// @returns the resulting MSL and supplementary information, or error diagnostics
