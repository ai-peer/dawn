...
TEST_F(MslPrinterTest, LetVec3F32) {
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", b.Composite(ty.vec3<f32>(), b.Constant(1_f), b.Constant(2_f), b.Constant(3_f)));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetVec3F16) {
    ...
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", b.Composite(ty.vec3<f16>(), b.Constant(1_h), b.Constant(2_h), b.Constant(3_h)));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetMat2x3F32) {
    ...
    b.Append(func->Block(), [&] {
        b.Let("l",
              b.Composite(
                  ty.mat2x3<f32>(),
                  b.Composite(ty.vec3<f32>(), b.Constant(1_f), b.Constant(2_f), b.Constant(3_f)),
                  b.Composite(ty.vec3<f32>(), b.Constant(4_f), b.Constant(5_f), b.Constant(6_f))));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetMat2x3F16) {
    ...
    b.Append(func->Block(), [&] {
        b.Let("l",
              b.Composite(
                  ty.mat2x3<f16>(),
                  b.Composite(ty.vec3<f16>(), b.Constant(1_h), b.Constant(2_h), b.Constant(3_h)),
                  b.Composite(ty.vec3<f16>(), b.Constant(4_h), b.Constant(5_h), b.Constant(6_h))));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetArrF32) {
    ...
    b.Append(func->Block(), [&] {
        b.Let("l",
              b.Composite(ty.array<f32, 3>(), b.Constant(1_f), b.Constant(2_f), b.Constant(3_f)));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetArrVec2BoolEmit_VariableDeclStatement_Const_arr_vec2_bool) {
    ...
    b.Append(func->Block(), [&] {
        b.Let("l", b.Composite(ty.array<vec2<bool>, 3>(),
                               b.Composite(ty.vec2<bool>(), b.Constant(true), b.Constant(false)),
                               b.Composite(ty.vec2<bool>(), b.Constant(false), b.Constant(true)),
                               b.Composite(ty.vec2<bool>(), b.Constant(true), b.Constant(false))));
        b.Return(func);
    });
