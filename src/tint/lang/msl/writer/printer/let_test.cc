...
TEST_F(MslPrinterTest, LetVec3F32) {
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", b.Constant(mod.constant_values.Composite(
                       ty.vec3<f32>(), Vector<const constant::Value*, 3>{
                                           b.Constant(1_f)->Value(), b.Constant(2_f)->Value(),
                                           b.Constant(3_f)->Value()})));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetVec3F16) {
    ...
    b.Append(func->Block(), [&] {
        b.Let("l", b.Constant(mod.constant_values.Composite(
                       ty.vec3<f16>(), Vector<const constant::Value*, 3>{
                                           b.Constant(1_h)->Value(), b.Constant(2_h)->Value(),
                                           b.Constant(3_h)->Value()})));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetMat2x3F32) {
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", b.Call<mat2x3<f32>>(1_f, 2_f, 3_f, 4_f, 5_f, 6_f));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetMat2x3F16) {
    ...
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", Call<mat2x3<f16>>(1_h, 2_h, 3_h, 4_h, 5_h, 6_h));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetArrF32) {
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", Call<array<f32, 3>>(1_f, 2_f, 3_f));
        b.Return(func);
    });
...
TEST_F(MslPrinterTest, LetArrVec2BoolEmit_VariableDeclStatement_Const_arr_vec2_bool) {
    auto* func = b.Function("foo", ty.void_());
    b.Append(func->Block(), [&] {
        b.Let("l", array<vec2<bool>, 3>(vec2<bool>(true, false), vec2<bool>(false, true),
                                        vec2<bool>(true, true)));
        b.Return(func);
    });
...
void foo() {
  tint_array<bool2, 3> const l = tint_array<bool2, 3>{bool2(true, false), bool2(false, true),
bool2(true)};
}
)");
}
