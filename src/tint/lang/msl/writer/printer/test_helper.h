...
#ifndef SRC_TINT_LANG_MSL_WRITER_PRINTER_TEST_HELPER_IR_H_
#define SRC_TINT_LANG_MSL_WRITER_PRINTER_TEST_HELPER_IR_H_
...
#endif  // SRC_TINT_LANG_MSL_WRITER_PRINTER_TEST_HELPER_IR_H_
