...
void Printer::EmitAddressSpace(tint::StringStream& out, builtin::AddressSpace sc) {
    switch (sc) {
...
void Printer::EmitType(tint::StringStream& out, const type::Type* ty) {
    tint::Switch(
        ty,                                         //
...
void Printer::EmitPointerType(tint::StringStream& out, const type::Pointer* ptr) {
...
void Printer::EmitAtomicType(tint::StringStream& out, const type::Atomic* atomic) {
...
void Printer::EmitArrayType(tint::StringStream& out, const type::Array* arr) {
...
void Printer::EmitVectorType(tint::StringStream& out, const type::Vector* vec) {
    if (vec->Packed()) {
        out << "packed_";
    }
...
void Printer::EmitMatrixType(tint::StringStream& out, const type::Matrix* mat) {
    EmitType(out, mat->type());
    out << mat->columns() << "x" << mat->rows();
}

void Printer::EmitTextureType(tint::StringStream& out, const type::Texture* tex) {
...
void Printer::EmitStructType(const type::Struct* str) {
    ...
    auto add_byte_offset_comment = [&](tint::StringStream& out, uint32_t offset) {
...
void Printer::EmitConstant(tint::StringStream& out, ir::Constant* c) {
    EmitConstant(out, c->Value());
}

void Printer::EmitConstant(tint::StringStream& out, const constant::Value* c) {
