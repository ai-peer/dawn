...
TEST_F(MslPrinterTest, Constant_Vector_Composite) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.vec3<f32>(), tint::Vector{b.Constant(1.5_f)->Value(), b.Constant(1.0_f)->Value(),
...
TEST_F(MslPrinterTest, Constant_Vector_Composite_AnyZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.vec3<f32>(), tint::Vector{b.Constant(1.0_f)->Value(), b.Constant(0.0_f)->Value(),
                                     b.Constant(1.5_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
...
TEST_F(MslPrinterTest, Constant_Vector_Composite_AllZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.vec3<f32>(), tint::Vector{b.Constant(0.0_f)->Value(), b.Constant(0.0_f)->Value(),
...
TEST_F(MslPrinterTest, Constant_Matrix_Composite) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.mat3x2<f32>(),
        tint::Vector{
            mod.constant_values.Composite(ty.vec2<f32>(), tint::Vector{b.Constant(1.5_f)->Value(),
                                                                       b.Constant(1.0_f)->Value()}),
            mod.constant_values.Composite(ty.vec2<f32>(), tint::Vector{b.Constant(1.5_f)->Value(),
                                                                       b.Constant(2.0_f)->Value()}),
            mod.constant_values.Composite(
                ty.vec2<f32>(),
                tint::Vector{b.Constant(2.5_f)->Value(), b.Constant(3.5_f)->Value()})}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
...
TEST_F(MslPrinterTest, Constant_Matrix_Composite_AnyZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.mat2x2<f32>(),
        tint::Vector{
            mod.constant_values.Composite(ty.vec2<f32>(), tint::Vector{b.Constant(1.0_f)->Value(),
                                                                       b.Constant(0.0_f)->Value()}),
            mod.constant_values.Composite(
                ty.vec2<f32>(),
                tint::Vector{b.Constant(1.5_f)->Value(), b.Constant(2.5_f)->Value()})}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()),
...
TEST_F(MslPrinterTest, Constant_Matrix_Composite_AllZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.mat3x2<f32>(),
        tint::Vector{
            mod.constant_values.Composite(ty.vec2<f32>(), tint::Vector{b.Constant(0.0_f)->Value(),
                                                                       b.Constant(0.0_f)->Value()}),
            mod.constant_values.Composite(ty.vec2<f32>(), tint::Vector{b.Constant(0.0_f)->Value(),
                                                                       b.Constant(0.0_f)->Value()}),
            mod.constant_values.Composite(
                ty.vec2<f32>(),
                tint::Vector{b.Constant(0.0_f)->Value(), b.Constant(0.0_f)->Value()})}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()),
...
TEST_F(MslPrinterTest, Constant_Array_Composite) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.array<f32, 3>(), tint::Vector{b.Constant(1.5_f)->Value(), b.Constant(1.0_f)->Value(),
                                         b.Constant(2.0_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
...
TEST_F(MslPrinterTest, Constant_Array_Composite_AnyZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.array<f32, 2>(), tint::Vector{b.Constant(1.0_f)->Value(), b.Constant(0.0_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()), R"(template<typename T, size_t N>
struct tint_array {
...
TEST_F(MslPrinterTest, Constant_Array_Composite_AllZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.array<f32, 3>(), tint::Vector{b.Constant(0.0_f)->Value(), b.Constant(0.0_f)->Value(),
                                         b.Constant(0.0_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()), R"(template<typename T, size_t N>
...
TEST_F(MslPrinterTest, Constant_Struct_Composite) {
    ...
    auto* c = b.Constant(mod.constant_values.Composite(
        s, tint::Vector{b.Constant(1.5_f)->Value(), b.Constant(1.0_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()), std::string(R"(struct S {
  float a;
...
TEST_F(MslPrinterTest, Constant_Struct_Composite_AnyZero) {
    ...
    auto* c = b.Constant(mod.constant_values.Composite(
        s, tint::Vector{b.Constant(1.0_f)->Value(), b.Constant(0.0_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()), std::string(R"(struct S {
  float a;
...
TEST_F(MslPrinterTest, Constant_Struct_Composite_AllZero) {
    ...
    auto* c = b.Constant(mod.constant_values.Composite(
        s, tint::Vector{b.Constant(0.0_f)->Value(), b.Constant(0.0_f)->Value()}));
    generator_.EmitConstant(generator_.Line(), c);
    ASSERT_TRUE(generator_.Diagnostics().empty()) << generator_.Diagnostics().str();
    EXPECT_EQ(tint::TrimSpace(generator_.Result()), std::string(R"(struct S {
  float a;
