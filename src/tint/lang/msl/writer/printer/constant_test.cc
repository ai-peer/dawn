...
TEST_F(MslPrinterTest, Constant_Matrix_Composite) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ty.mat3x2<f32>(),
        tint::Vector{mod.constant_values.Composite(
                          ty.vec2<f32>(),
                          tint::Vector{b.Constant(1.5_f)->Value(), b.Constant(1.0_f)->Value()}),
                      mod.constant_values.Composite(
                          ty.vec2<f32>(),
                          tint::Vector{b.Constant(1.5_f)->Value(), b.Constant(2.0_f)->Value()}),
                      mod.constant_values.Composite(
                          ty.vec2<f32>(),
...
TEST_F(MslPrinterTest, Constant_Matrix_Composite_AnyZero) {
    auto* c = b.Constant(mod.constant_values.Composite(
        ...
        tint::Vector{mod.constant_values.Composite(
                          ty.vec2<f32>(),
                          tint::Vector{b.Constant(1.0_f)->Value(), b.Constant(0.0_f)->Value()}),
                      mod.constant_values.Composite(
                          ty.vec2<f32>(),
