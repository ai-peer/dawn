...
struct Options {
    ...
    tint::writer::ExternalTextureOptions external_texture_options = {};

    /// Options used to specify a mapping of binding points to indices into a UBO
    /// from which to load buffer sizes.
    tint::writer::ArrayLengthFromUniformOptions array_length_from_uniform = {};

    /// Options used in the bindings remapper
    tint::writer::BindingRemapperOptions binding_remapper_options = {};
