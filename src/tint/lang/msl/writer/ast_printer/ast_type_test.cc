...
TEST_F(MslASTPrinterTest, EmitType_Struct_Layout_NonComposites) {
    auto* s = Structure(
        "S", tint::Vector{
                 Member("a", ty.i32(), tint::Vector{MemberSize(32_a)}),
                 Member("b", ty.f32(), tint::Vector{MemberAlign(128_i), MemberSize(128_a)}),
...
TEST_F(MslASTPrinterTest, EmitType_Struct_Layout_Structures) {
    ...
    auto* inner_x =
        Structure("inner_x", tint::Vector{
                                 Member("a", ty.i32()),
                                 Member("b", ty.f32(), tint::Vector{MemberAlign(512_i)}),
                             });

    // inner_y: size(516), align(4)
    auto* inner_y = Structure("inner_y", tint::Vector{
                                             Member("a", ty.i32(), tint::Vector{MemberSize(512_a)}),
                                             Member("b", ty.f32()),
                                         });
...
TEST_F(MslASTPrinterTest, AttemptTintPadSymbolCollision) {
    auto* s = Structure("S", tint::Vector{
                                 ...
                                 Member("tint_pad_2", ty.i32(), tint::Vector{MemberSize(32_a)}),
                                 Member("tint_pad_20", ty.f32(),
                                        tint::Vector{MemberAlign(128_i), MemberSize(128_u)}),
