...
TEST_P(MslBuiltinTest, Emit) {
    ...
    Func("func", tint::Empty, ty.void_(), tint::Vector{Ignore(call)},
...
TEST_F(MslASTPrinterTest, Ignore) {
    Func("f", tint::Vector{Param("a", ty.i32()), Param("b", ty.i32()), Param("c", ty.i32())},
         ty.i32(), tint::Vector{Return(Mul(Add("a", "b"), "c"))});

    Func("func", tint::Empty, ty.void_(), tint::Vector{CallStmt(Call("f", 1_i, 2_i, 3_i))},
         tint::Vector{
