...
TEST_F(HlslASTPrinterTest_Function, PtrParameter) {
    ...
    //   return *foo;
    // }
    Func("f", tint::Vector{Param("foo", ty.ptr<function, f32>())}, ty.f32(),
         tint::Vector{Return(Deref("foo"))});
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_EntryPoint_WithInOutVars) {
    ...
    //   return foo;
    // }
    auto* foo_in = Param("foo", ty.f32(), tint::Vector{Location(0_a)});
    Func("frag_main", tint::Vector{foo_in}, ty.f32(),
         tint::Vector{
             Return("foo"),
         },
         tint::Vector{
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_EntryPoint_WithInOut_Builtins) {
    ...
    // }
    auto* coord_in =
        Param("coord", ty.vec4<f32>(), tint::Vector{Builtin(builtin::BuiltinValue::kPosition)});
    Func("frag_main", tint::Vector{coord_in}, ty.f32(),
         tint::Vector{
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_EntryPoint_SharedStruct_DifferentStages) {
    ...
    auto* interface_struct = Structure(
        ...
        tint::Vector{
            ...
            Member("col1", ty.f32(), tint::Vector{Location(1_a)}),
            Member("col2", ty.f32(), tint::Vector{Location(2_a)}),
        });
    ...
    Func("frag_main", tint::Vector{Param("inputs", ty.Of(interface_struct))}, ty.void_(),
         tint::Vector{
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_EntryPoint_SharedStruct_HelperFunction) {
    ...
    auto* vertex_output_struct =
        Structure("VertexOutput",
                  tint::Vector{Member("pos", ty.vec4<f32>(),
                                       tint::Vector{Builtin(builtin::BuiltinValue::kPosition)})});

    Func("foo", tint::Vector{Param("x", ty.f32())}, ty.Of(vertex_output_struct),
         tint::Vector{
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_EntryPoint_With_Uniform) {
    auto* ubo_ty = Structure("UBO", tint::Vector{Member("coord", ty.vec4<f32>())});
    auto* ubo =
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_EntryPoint_With_UniformStruct) {
    auto* s = Structure("Uniforms", tint::Vector{Member("coord", ty.vec4<f32>())});
...
TEST_F(HlslASTPrinterTest_Function, Emit_Attribute_Called_By_EntryPoint_With_Uniform) {
    auto* s = Structure("S", tint::Vector{Member("x", ty.f32())});
...
TEST_F(HlslASTPrinterTest_Function, Emit_Function_WithDiscardAndVoidReturn) {
    Func("my_func", tint::Vector{Param("a", ty.i32())}, ty.void_(),
         tint::Vector{
             If(Equal("a", 0_i),  //
                Block(Discard())),
             Return(),
...
TEST_F(HlslASTPrinterTest_Function, Emit_Function_WithDiscardAndNonVoidReturn) {
    Func("my_func", tint::Vector{Param("a", ty.i32())}, ty.i32(),
         tint::Vector{
             If(Equal("a", 0_i),  //
                Block(Discard())),
             Return(42_i),
...
TEST_F(HlslASTPrinterTest_Function, Emit_Multiple_EntryPoint_With_Same_ModuleVar) {
    ...
    auto* s = Structure("Data", tint::Vector{Member("d", ty.f32())});
