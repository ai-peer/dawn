...
add_library(lib_tint_lang_hlsl_writer_ast_printer STATIC
  "lang/hlsl/writer/ast_printer/ast_printer.cc"
  "lang/hlsl/writer/ast_printer/ast_printer.h"
)

target_link_libraries(lib_tint_lang_hlsl_writer_ast_printer
...
tint_default_compile_options(lib_tint_lang_hlsl_writer_ast_printer)

add_library(tint_lang_hlsl_writer_ast_printer_test STATIC
...
target_link_libraries(tint_lang_hlsl_writer_ast_printer_test
  lib_tint_lang_core_type
  lib_tint_lang_hlsl_writer
  lib_tint_lang_hlsl_writer_ast_printer
  lib_tint_lang_hlsl_writer_common
  lib_tint_lang_wgsl_ast
  lib_tint_lang_wgsl_ast_transform
...
tint_default_compile_options(tint_lang_hlsl_writer_ast_printer_test)
