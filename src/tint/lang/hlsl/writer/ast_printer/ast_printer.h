...
class ASTPrinter : public tint::TextGenerator {
  public:
    ...
    bool EmitIndexAccessor(tint::StringStream& out, const ast::IndexAccessorExpression* expr);
    ...
    bool EmitBinary(tint::StringStream& out, const ast::BinaryExpression* expr);
    /// Handles generating a bitcast expression
    /// @param out the output of the expression stream
    /// @param expr the as expression
    /// @returns true if the bitcast was emitted
    bool EmitBitcast(tint::StringStream& out, const ast::BitcastExpression* expr);
    /// Emits a list of statements
    /// @param stmts the statement list
    /// @returns true if the statements were emitted successfully
    bool EmitStatements(tint::VectorRef<const ast::Statement*> stmts);
    /// Emits a list of statements with an indentation
    /// @param stmts the statement list
    /// @returns true if the statements were emitted successfully
    bool EmitStatementsWithIndent(tint::VectorRef<const ast::Statement*> stmts);
    ...
    bool EmitCall(tint::StringStream& out, const ast::CallExpression* expr);
    /// Handles generating a function call expression
    /// @param out the output of the expression stream
    /// @param call the call expression
    /// @param function the function being called
    /// @returns true if the expression is emitted
    bool EmitFunctionCall(tint::StringStream& out,
                          const sem::Call* call,
    ...
    /// @returns true if the expression is emitted
    bool EmitBuiltinCall(tint::StringStream& out,
                         const sem::Call* call,
    ...
    /// @returns true if the expression is emitted
    bool EmitValueConversion(tint::StringStream& out,
                             const sem::Call* call,
    ...
    /// @returns true if the expression is emitted
    bool EmitValueConstructor(tint::StringStream& out,
                              const sem::Call* call,
    ...
    /// @returns true if the call expression is emitted
    bool EmitUniformBufferAccess(tint::StringStream& out,
    ...
    /// @param intrinsic the ast::transform::DecomposeMemoryAccess::Intrinsic
    /// @returns true if the call expression is emitted
    bool EmitStorageBufferAccess(tint::StringStream& out,
                                 const ast::CallExpression* expr,
                                 const ast::transform::DecomposeMemoryAccess::Intrinsic* intrinsic);
    ...
    /// @returns true if the call expression is emitted
    bool EmitBarrierCall(tint::StringStream& out, const sem::Builtin* builtin);
    /// Handles generating an atomic intrinsic call for a storage buffer variable
    /// @param out the output of the expression stream
    /// @param expr the call expression
    /// @param intrinsic the atomic intrinsic
    /// @returns true if the call expression is emitted
    bool EmitStorageAtomicCall(tint::StringStream& out,
                               const ast::CallExpression* expr,
                               const ast::transform::DecomposeMemoryAccess::Intrinsic* intrinsic);
    ...
    /// @returns true if the call expression is emitted
    bool EmitWorkgroupAtomicCall(tint::StringStream& out,
                                 const ast::CallExpression* expr,
                                 const sem::Builtin* builtin);
    ...
    /// @returns true if the call expression is emitted
    bool EmitTextureCall(tint::StringStream& out,
                         const sem::Call* call,
                         const sem::Builtin* builtin);
    ...
    /// @param expr the call expression
    /// @returns true if the call expression is emitted
    bool EmitSelectCall(tint::StringStream& out, const ast::CallExpression* expr);
    /// Handles generating a call to the `modf()` builtin
    /// @param out the output of the expression stream
    /// @param expr the call expression
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitModfCall(tint::StringStream& out,
                      const ast::CallExpression* expr,
                      const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitFrexpCall(tint::StringStream& out,
                       const ast::CallExpression* expr,
                       const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitDegreesCall(tint::StringStream& out,
                         const ast::CallExpression* expr,
                         const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitRadiansCall(tint::StringStream& out,
                         const ast::CallExpression* expr,
                         const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitSignCall(tint::StringStream& out, const sem::Call* call, const sem::Builtin* builtin);
    /// Handles generating a call to data packing builtin
    /// @param out the output of the expression stream
    /// @param expr the call expression
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitDataPackingCall(tint::StringStream& out,
                             const ast::CallExpression* expr,
                             const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitDataUnpackingCall(tint::StringStream& out,
                               const ast::CallExpression* expr,
                               const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitQuantizeToF16Call(tint::StringStream& out,
                               const ast::CallExpression* expr,
                               const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitTruncCall(tint::StringStream& out,
                       const ast::CallExpression* expr,
                       const sem::Builtin* builtin);
    ...
    /// @param builtin the semantic information for the builtin
    /// @returns true if the call expression is emitted
    bool EmitDP4aCall(tint::StringStream& out,
                      const ast::CallExpression* expr,
                      const sem::Builtin* builtin);
    ...
    bool EmitExpression(tint::StringStream& out, const ast::Expression* expr);
    ...
    bool EmitConstant(tint::StringStream& out,
    ...
    bool EmitLiteral(tint::StringStream& out, const ast::LiteralExpression* lit);
    ...
    bool EmitIdentifier(tint::StringStream& out, const ast::IdentifierExpression* expr);
    /// Handles a member accessor expression
    /// @param out the output of the expression stream
    /// @param expr the member accessor expression
    /// @returns true if the member accessor was emitted
    bool EmitMemberAccessor(tint::StringStream& out, const ast::MemberAccessorExpression* expr);
    ...
    bool EmitType(tint::StringStream& out,
    ...
    /// @returns true if the type is emitted
    bool EmitTypeAndName(tint::StringStream& out,
                         const type::Type* type,
                         builtin::AddressSpace address_space,
                         builtin::Access access,
                         const std::string& name);
    ...
    /// @param expr the expression to emit
    /// @returns true if the expression was emitted
    bool EmitUnaryOp(tint::StringStream& out, const ast::UnaryOpExpression* expr);
    /// Emits `value` for the given type
    /// @param out the output stream
    /// @param type the type to emit the value for
    /// @param value the value to emit
    /// @returns true if the value was successfully emitted.
    bool EmitValue(tint::StringStream& out, const type::Type* type, int value);
    /// Emits the zero value for the given type
    /// @param out the output stream
    /// @param type the type to emit the value for
    /// @returns true if the zero value was successfully emitted.
    bool EmitZeroValue(tint::StringStream& out, const type::Type* type);
  ...
  private:
    ...
    /// @returns true if the call expression is emitted
    template <typename F>
    bool CallBuiltinHelper(tint::StringStream& out,
