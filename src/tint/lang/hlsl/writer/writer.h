...
/// The result will contain the HLSL and supplementary information, or error diagnostics.
/// @param program the program to translate to HLSL
/// @param options the configuration options to use when generating HLSL
/// @returns the resulting HLSL and supplementary information, or error diagnostics
