...
/// The result will contain the GLSL and supplementary information, or error diagnostics.
/// information.
...
/// @returns the resulting GLSL and supplementary information, or error diagnostics
