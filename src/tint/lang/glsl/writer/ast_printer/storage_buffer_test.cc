...
void TestAlign(ProgramBuilder* ctx) {
    ...
    auto* nephews = ctx->Structure(
        "Nephews", tint::Vector{
                       ctx->Member("huey", ctx->ty.f32(), tint::Vector{ctx->MemberAlign(256_i)}),
                       ctx->Member("dewey", ctx->ty.f32(), tint::Vector{ctx->MemberAlign(256_i)}),
                       ctx->Member("louie", ctx->ty.f32(), tint::Vector{ctx->MemberAlign(256_i)}),
                   });
