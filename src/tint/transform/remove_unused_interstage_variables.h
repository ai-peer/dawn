...
#ifndef SRC_TINT_TRANSFORM_REMOVE_UNUSED_INTERSTAGE_VARIABLES_H_
#define SRC_TINT_TRANSFORM_REMOVE_UNUSED_INTERSTAGE_VARIABLES_H_
...
class RemoveUnusedInterstageVariables final
    : public Castable<RemoveUnusedInterstageVariables, Transform> {
  public:
    ...
    struct Config final : public Castable<Config, Data> {
        ...
        std::bitset<kMaxInterStageShaderVariables> variables;
    ...
    /// Constructor
    RemoveUnusedInterstageVariables();

    /// Destructor
    ~RemoveUnusedInterstageVariables() override;
...
#endif  // SRC_TINT_TRANSFORM_REMOVE_UNUSED_INTERSTAGE_VARIABLES_H_
