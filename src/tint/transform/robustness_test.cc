...
fn dimensions_signed(level : i32) {
  ...
  let l = textureDimensions(t, level_1);
}

fn dimensions_unsigned(level : u32) {
  let level_2 = min(u32(level), (textureNumLevels(t) - 1));
  let l = textureDimensions(t, level_2);
}
...
fn dimensions_signed(level : i32) {
  ...
  if ((level_1 < num_levels)) {
    predicated_value = textureDimensions(t, level_1);
  }
...
fn dimensions_unsigned(level : u32) {
  ...
  if ((level_2 < num_levels_1)) {
    predicated_value_1 = textureDimensions(t, level_2);
  }
...
fn gather_signed(coords : vec2f, array : i32) {
  let l = textureGather(1, t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))));
}

fn gather_unsigned(coords : vec2f, array : u32) {
  let l = textureGather(1, t, s, coords, min(array, (textureNumLayers(t) - 1)));
}
...
fn gather_signed(coords : vec2f, array : i32) {
  ...
  if ((array_idx < textureNumLayers(t))) {
    predicated_value = textureGather(1, t, s, coords, array_idx);
  }
  let l = predicated_value;
}
...
fn gather_unsigned(coords : vec2f, array : u32) {
  ...
  if ((array_idx_1 < textureNumLayers(t))) {
    predicated_value_1 = textureGather(1, t, s, coords, array_idx_1);
  }
  let l = predicated_value_1;
}
...
fn gather_signed(coords : vec2f, array : i32, depth_ref : f32) {
  let l = textureGatherCompare(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))), depth_ref);
}

fn gather_unsigned(coords : vec2f, array : u32, depth_ref : f32) {
  let l = textureGatherCompare(t, s, coords, min(array, (textureNumLayers(t) - 1)), depth_ref);
}
...
fn gather_signed(coords : vec2f, array : i32, depth_ref : f32) {
  ...
  var predicated_value : vec4<f32>;
  if ((array_idx < textureNumLayers(t))) {
    predicated_value = textureGatherCompare(t, s, coords, array_idx, depth_ref);
  }
  let l = predicated_value;
}
...
fn gather_unsigned(coords : vec2f, array : u32, depth_ref : f32) {
  ...
  var predicated_value_1 : vec4<f32>;
  if ((array_idx_1 < textureNumLayers(t))) {
    predicated_value_1 = textureGatherCompare(t, s, coords, array_idx_1, depth_ref);
  }
  let l = predicated_value_1;
}
...
fn load_signed(coords : i32, level : i32) {
  ...
  var predicated_value : vec4<f32>;
  if (((level_1 < num_levels) & all((coords_1 < textureDimensions(t, min(level_1, (num_levels - 1))))))) {
    predicated_value = textureLoad(t, coords_1, level_1);
  }
  let l = predicated_value;
}
...
fn load_unsigned(coords : u32, level : u32) {
  ...
  var predicated_value_1 : vec4<f32>;
  if (((level_2 < num_levels_1) & all((coords_2 < textureDimensions(t, min(level_2, (num_levels_1 - 1))))))) {
    predicated_value_1 = textureLoad(t, coords_2, level_2);
  }
  let l = predicated_value_1;
}
...
fn load_mixed(coords : i32, level : u32) {
  ...
  if (((level_3 < num_levels_2) & all((coords_3 < textureDimensions(t, min(level_3, (num_levels_2 - 1))))))) {
    predicated_value_2 = textureLoad(t, coords_3, level_3);
  }
...
fn load_signed(coords : vec2i, array : i32, level : i32) {
  ...
  let array_idx = u32(array);
  var predicated_value : vec4<f32>;
  if ((((level_1 < num_levels) & all((coords_1 < textureDimensions(t, min(level_1, (num_levels - 1)))))) & (array_idx < textureNumLayers(t)))) {
    predicated_value = textureLoad(t, coords_1, array_idx, level_1);
  }
  let l = predicated_value;
}
...
fn load_unsigned(coords : vec2u, array : u32, level : u32) {
  ...
  let array_idx_1 = u32(array);
  var predicated_value_1 : vec4<f32>;
  if ((((level_2 < num_levels_1) & all((coords_2 < textureDimensions(t, min(level_2, (num_levels_1 - 1)))))) & (array_idx_1 < textureNumLayers(t)))) {
    predicated_value_1 = textureLoad(t, coords_2, array_idx_1, level_2);
  }
  let l = predicated_value_1;
}
...
fn load_mixed(coords : vec2u, array : i32, level : u32) {
  ...
  var predicated_value_2 : vec4<f32>;
  if ((((level_3 < num_levels_2) & all((coords_3 < textureDimensions(t, min(level_3, (num_levels_2 - 1)))))) & (array_idx_2 < textureNumLayers(t)))) {
    predicated_value_2 = textureLoad(t, coords_3, array_idx_2, level_3);
  }
  let l = predicated_value_2;
}
...
fn sample_signed(coords : vec2f, array : i32) {
  let l = textureSample(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))));
}

fn sample_unsigned(coords : vec2f, array : u32) {
  let l = textureSample(t, s, coords, min(array, (textureNumLayers(t) - 1)));
}
...
fn sample_bias_signed(coords : vec2f, array : i32, bias : f32) {
  let l = textureSampleBias(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))), bias);
}

fn sample_bias_unsigned(coords : vec2f, array : u32, bias : f32) {
  let l = textureSampleBias(t, s, coords, min(array, (textureNumLayers(t) - 1)), bias);
}
...
fn sample_compare_signed(coords : vec2f, array : i32, depth_ref : f32) {
  let l = textureSampleCompare(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))), depth_ref);
}

fn sample_compare_unsigned(coords : vec2f, array : u32, depth_ref : f32) {
  let l = textureSampleCompare(t, s, coords, min(array, (textureNumLayers(t) - 1)), depth_ref);
}
...
fn sample_compare_level_signed(coords : vec2f, array : i32, depth_ref : f32) {
  let l = textureSampleCompareLevel(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))), depth_ref);
}

fn sample_compare_level_unsigned(coords : vec2f, array : u32, depth_ref : f32) {
  let l = textureSampleCompareLevel(t, s, coords, min(array, (textureNumLayers(t) - 1)), depth_ref);
}
...
fn sample_compare_level_signed(coords : vec2f, array : i32, depth_ref : f32) {
  ...
  var predicated_value : f32;
  if ((array_idx < textureNumLayers(t))) {
    predicated_value = textureSampleCompareLevel(t, s, coords, array_idx, depth_ref);
  }
  let l = predicated_value;
}
...
fn sample_compare_level_unsigned(coords : vec2f, array : u32, depth_ref : f32) {
  ...
  var predicated_value_1 : f32;
  if ((array_idx_1 < textureNumLayers(t))) {
    predicated_value_1 = textureSampleCompareLevel(t, s, coords, array_idx_1, depth_ref);
  }
  let l = predicated_value_1;
}
...
fn sample_grad_signed(coords : vec2f, array : i32, ddx : vec2f, ddy : vec2f) {
  let l = textureSampleGrad(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))), ddx, ddy);
}

fn sample_grad_unsigned(coords : vec2f, array : u32, ddx : vec2f, ddy : vec2f) {
  let l = textureSampleGrad(t, s, coords, min(array, (textureNumLayers(t) - 1)), ddx, ddy);
}
...
fn sample_grad_signed(coords : vec2f, array : i32, ddx : vec2f, ddy : vec2f) {
  ...
  var predicated_value : vec4<f32>;
  if ((array_idx < textureNumLayers(t))) {
    predicated_value = textureSampleGrad(t, s, coords, array_idx, ddx, ddy);
  }
  let l = predicated_value;
}
...
fn sample_grad_unsigned(coords : vec2f, array : u32, ddx : vec2f, ddy : vec2f) {
  ...
  var predicated_value_1 : vec4<f32>;
  if ((array_idx_1 < textureNumLayers(t))) {
    predicated_value_1 = textureSampleGrad(t, s, coords, array_idx_1, ddx, ddy);
  }
  let l = predicated_value_1;
}
...
fn sample_compare_level_signed(coords : vec2f, array : i32, level : f32) {
  let l = textureSampleLevel(t, s, coords, clamp(array, 0, i32((textureNumLayers(t) - 1))), level);
}

fn sample_compare_level_unsigned(coords : vec2f, array : u32, level : f32) {
  let l = textureSampleLevel(t, s, coords, min(array, (textureNumLayers(t) - 1)), level);
}
...
fn sample_compare_level_signed(coords : vec2f, array : i32, level : f32) {
  ...
  var predicated_value : vec4<f32>;
  if ((array_idx < textureNumLayers(t))) {
    predicated_value = textureSampleLevel(t, s, coords, array_idx, level);
  }
  let l = predicated_value;
}
...
fn sample_compare_level_unsigned(coords : vec2f, array : u32, level : f32) {
  ...
  var predicated_value_1 : vec4<f32>;
  if ((array_idx_1 < textureNumLayers(t))) {
    predicated_value_1 = textureSampleLevel(t, s, coords, array_idx_1, level);
  }
  let l = predicated_value_1;
}
...
fn f() {
  ...
  {
    let level_1 = min(u32(level), (textureNumLevels(t) - 1));
    var i = textureLoad(t, clamp(coords, vec2(0), vec2<i32>((textureDimensions(t, level_1) - vec2(1)))), level_1).x;
    loop {
      if (!((i < 3))) {
        break;
      }
...
fn f() {
  ...
  var level = 1;
  {
    ...
    loop {
      let level_1 = min(u32(level), (textureNumLevels(t) - 1));
      if (!((i < textureLoad(t, clamp(coords, vec2(0), vec2<i32>((textureDimensions(t, level_1) - vec2(1)))), level_1).x))) {
        break;
      }
      {
        var in_loop = 42;
...
fn f() {
  var level = 1;
  {
    ...
    loop {
      ...
      continuing {
        let level_1 = min(u32(i), (textureNumLevels(t) - 1));
        i = textureLoad(t, clamp(vec2(i), vec2(0), vec2<i32>((textureDimensions(t, level_1) - vec2(1)))), level_1).x;
      }
    }
  }
}
  ...
  var level = 1;
  {
    ...
    loop {
      ...
      continuing {
        ...
        var predicated_value : vec4<i32>;
        if (((level_1 < num_levels) & all((coords < textureDimensions(t, min(level_1, (num_levels - 1))))))) {
          predicated_value = textureLoad(t, coords, level_1);
        }
...
TEST_P(RobustnessTest, Read_PrivatePointerParameter) {
    auto* src = R"(
...
TEST_P(RobustnessTest, Read_WorkgroupPointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Read_UniformPointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Read_StoragePointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Read_FunctionPointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Write_PrivatePointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Write_WorkgroupPointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Write_StoragePointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
...
TEST_P(RobustnessTest, Write_FunctionPointerParameter) {
    auto* src = R"(
enable chromium_experimental_full_ptr_parameters;
