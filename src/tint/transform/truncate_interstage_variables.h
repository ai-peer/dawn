...
/// that assigns the members of `new wrapper struct` with values from `original shader IO struct`.
/// IO attributes of members in `original shader IO struct` are removed, other attributes still
/// preserve.
///
/// For example:
///
