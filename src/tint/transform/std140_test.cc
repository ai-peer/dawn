...
// `mat3x2<f32>` otherwise, and set all constant index to 1. For exhaustive tests, i.e. tests on all
...
fn load_a_1_m_p0(p0 : u32) -> vec2<f32> {
  switch(p0) {
    case 0u: {
      return a[1u].m_0;
    }
...
fn load_a_1_1_p0(p0 : u32) -> vec2<f32> {
  switch(p0) {
    case 0u: {
      return a[1u][1u].col0;
    }
...
fn load_a_1_p0_p1(p0 : u32, p1 : u32) -> vec2<f32> {
  switch(p1) {
    case 0u: {
      return a[1u][p0].col0;
    }
...
fn f() {
  let I = 1;
  let J = 2;
  let l = load_a_1_p0_p1(u32(I), u32(J));
}
)";
...
fn load_a_p0_1_p1(p0 : u32, p1 : u32) -> vec2<f32> {
  switch(p1) {
    case 0u: {
      return a[p0][1u].col0;
    }
...
fn f() {
  let I = 1;
  let J = 2;
  let l = load_a_p0_1_p1(u32(I), u32(J));
}
)";
