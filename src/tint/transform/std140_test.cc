...
TEST_F(Std140Test, StructMat4x4Uniform) {
    auto* src = R"(
struct S {
  m : mat4x4<f32>,
}
...
TEST_F(Std140Test, StructMixedMatricesUniform) {
    auto* src = R"(
struct S2x2 {
  m : mat2x2<f32>,
}
...
fn f() {
  ...
  let l_a_1 = a[1];
  let l_a_2_a = a[2].a;
  let l_a_3_a_1 = a[3].a[1];
  let l_a_0_a_2_m = a[0].a[2].m;
  let l_a_1_a_3_m_0 = a[1].a[3].m[0];
  let l_a_2_a_0_m_1_2 = a[2].a[0].m[1][2];
}
)";
...
fn f() {
  let I = 1;
  let l_a = conv_arr_4_Outer(a);
  let l_a_1 = conv_Outer(a[1u]);
  let l_a_2_a = conv_arr_4_Inner(a[2u].a);
  let l_a_3_a_1 = conv_Inner(a[3u].a[1u]);
  let l_a_0_a_2_m = load_a_0_a_2_m();
  let l_a_1_a_3_m_0 = a[1u].a[3u].m_0;
  let l_a_2_a_0_m_1_2 = a[2u].a[0u].m_1[2u];
}
)";
...
fn f() {
  ...
  let l_a_1           : Outer           = *p_a_3;
  let l_a_2_a         : array<Inner, 4> = *p_a_3_a;
  let l_a_3_a_1       : Inner           = *p_a_3_a_2;
  let l_a_0_a_2_m     : mat4x2<f32>     = *p_a_3_a_2_m;
  let l_a_1_a_3_m_0   : vec2<f32>       = *p_a_3_a_2_m_1;
  let l_a_2_a_0_m_1_2 : f32             = (*p_a_3_a_2_m_1)[0];
}
)";
...
fn f() {
  ...
  let l_a_1 : Outer = conv_Outer(a[3u]);
  let l_a_2_a : array<Inner, 4> = conv_arr_4_Inner(a[3u].a);
  let l_a_3_a_1 : Inner = conv_Inner(a[3u].a[2u]);
  let l_a_0_a_2_m : mat4x2<f32> = load_a_3_a_2_m();
  let l_a_1_a_3_m_0 : vec2<f32> = a[3u].a[2u].m_1;
  let l_a_2_a_0_m_1_2 : f32 = a[3u].a[2u].m_1[0u];
}
)";
...
fn f() {
  for(var i = u32(u.m_0[1u]); (i < u32(load_u_p0_2(u32(i)))); i += u32(u.m_1[i])) {
  }
}
)";
