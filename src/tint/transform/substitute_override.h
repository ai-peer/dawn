...
#ifndef SRC_TINT_TRANSFORM_SUBSTITUDE_OVERRIDE_H_
#define SRC_TINT_TRANSFORM_SUBSTITUDE_OVERRIDE_H_
...
///
/// ```
/// override width: f32 = f32(1);
/// @id(1) override height: i32 = i32(22);
/// override depth = i32(42);
/// ```
///
...
#endif  // SRC_TINT_TRANSFORM_SUBSTITUDE_OVERRIDE_H_
