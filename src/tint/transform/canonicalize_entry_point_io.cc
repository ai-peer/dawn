...
struct CanonicalizeEntryPointIO::State {
    ...
    void CreateInputStruct() {
        ...
        std::sort(wrapper_struct_param_members.begin(), wrapper_struct_param_members.end(),
                  [this](const MemberInfo a, const MemberInfo b) {
                      return this->StructMemberComparator(a, b);
                  });
    ...
    ast::Struct* CreateOutputStruct() {
        ...
        // Sort the struct members to satisfy HLSL interfacing matching rules.
        std::sort(
            wrapper_struct_output_members.begin(), wrapper_struct_output_members.end(),
            [this](MemberInfo a, MemberInfo b) { return this->StructMemberComparator(a, b); });
