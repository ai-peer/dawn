...
fn truncate_shader_output_0(io : tint_symbol) -> tint_symbol_1 {
  var result : tint_symbol_1;
...
fn f() -> tint_symbol_1 {
  ...
  return truncate_shader_output_0(wrapper_result);
}
)";
...
fn truncate_shader_output_0(io : ShaderIO) -> tint_symbol {
...
fn f() -> tint_symbol {
  ...
  io.f_1 = 1.0;
  io.f_3 = (io.f_1 + 3.0);
  return truncate_shader_output_0(io);
}
)";
...
fn truncate_shader_output_1(io : ShaderIO) -> tint_symbol_1 {
  var result : tint_symbol_1;
  result.pos = io.pos;
  result.f_3 = io.f_3;
  return result;
...
fn truncate_shader_output_0(io : ShaderIO1) -> tint_symbol {
  var result : tint_symbol;
  result.pos = io.pos;
  result.f_3 = io.f_3;
  return result;
