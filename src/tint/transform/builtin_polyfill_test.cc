...
TEST_F(BuiltinPolyfillTest, ShouldRunIntDivMod) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = 20i / v;
...
TEST_F(BuiltinPolyfillTest, ai_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = 20 / v;
...
TEST_F(BuiltinPolyfillTest, i32_ai) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = v / 20;
...
TEST_F(BuiltinPolyfillTest, i32_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = 20i / v;
...
TEST_F(BuiltinPolyfillTest, ai_u32) {
    auto* src = R"(
fn f() {
  let v = 10u;
  let x = 20 / v;
...
TEST_F(BuiltinPolyfillTest, u32_ai) {
    auto* src = R"(
fn f() {
  let v = 10u;
  let x = v / 20;
...
TEST_F(BuiltinPolyfillTest, u32_u32) {
    auto* src = R"(
fn f() {
  let v = 10u;
  let x = 20u / v;
...
TEST_F(BuiltinPolyfillTest, vec3_ai_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = vec3(20) / v;
...
TEST_F(BuiltinPolyfillTest, vec3_i32_ai) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = vec3(v) / 20;
...
TEST_F(BuiltinPolyfillTest, vec3_i32_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
...
TEST_F(BuiltinPolyfillTest, vec3_u32_u32) {
    auto* src = R"(
fn f() {
  let v = 10u;
...
TEST_F(BuiltinPolyfillTest, ai_vec3_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
  let x = 20 / vec3(v);
...
TEST_F(BuiltinPolyfillTest, i32_vec3_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
...
TEST_F(BuiltinPolyfillTest, u32_vec3_u32) {
    auto* src = R"(
fn f() {
  let v = 10u;
...
TEST_F(BuiltinPolyfillTest, vec3_i32_vec3_i32) {
    auto* src = R"(
fn f() {
  let v = 10i;
...
TEST_F(BuiltinPolyfillTest, vec3_u32_vec3_u32) {
    auto* src = R"(
fn f() {
  let v = 10u;
