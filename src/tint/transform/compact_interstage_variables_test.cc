...
//         DataMap data;
//         //
//         data.Add<CompactInterstageVariables::Config>({std::vector<sem::InterStageVariableInfo>{
//         //   { 1, sem::InterStageComponentType::Float, 4 }
//         // }});
...
fn f() -> ShaderIO {
  ...
  return io;
    ...
    CompactInterstageVariables::Config cfg;
    // cfg.interstage_variables.push_back({3, sem::InterStageComponentType::Float, 1});

    cfg.interstage_locations.Resize(16);  // temp
