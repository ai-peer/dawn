...
TEST_F(DirectVariableAccessTest, Param_ptr_uniform_i32) {
    auto* src = R"(
...
TEST_F(DirectVariableAccessTest, Param_ptr_storage_i32_via_struct) {
    auto* src = R"(
struct S {
  i : i32,
};
...
TEST_F(DirectVariableAccessTest, Param_ptr_workgroup_vec4i32_via_array_static) {
    auto* src = R"(
...
TEST_F(DirectVariableAccessTest, Param_ptr_uniform_vec4i32_via_array_dynamic) {
    auto* src = R"(
...
TEST_F(DirectVariableAccessTest, Param_ptr_mixed_vec4i32_via_multiple) {
    auto* src = R"(
struct str {
  i : vec4<i32>,
};
...
fn b() {
  let p0 = &(U);
  let tint_symbol_5 = first();
  let p1 = &((*(p0))[tint_symbol_5]);
  let tint_symbol_4 = second();
  let tint_symbol_3 = third();
  let p2 = &((*(p1))[tint_symbol_4][tint_symbol_3]);
  a_U_X_X_X(U_X_X_X(u32(tint_symbol_5), u32(tint_symbol_4), u32(tint_symbol_3)));
}

fn c_U() {
  let p0 = &(U);
  let tint_symbol_2 = first();
  let p1 = &((*(p0))[tint_symbol_2]);
  let tint_symbol_1 = second();
  let tint_symbol = third();
  let p2 = &((*(p1))[tint_symbol_1][tint_symbol]);
  a_U_X_X_X(U_X_X_X(u32(tint_symbol_2), u32(tint_symbol_1), u32(tint_symbol)));
}
...
fn b() {
  ...
  for(let p1 = &(U[tint_symbol_3]); true; ) {
    let tint_symbol_2 = second();
    a_U_X_X(U_X_X(u32(tint_symbol_3), u32(tint_symbol_2)));
  }
}
...
fn b() {
  loop {
    let tint_symbol_3 = first();
    let tint_symbol_2 = second();
    if (!((a_U_X_X(U_X_X(u32(tint_symbol_3), u32(tint_symbol_2))).x < 4))) {
      break;
    }
    {
      let body = 1;
...
fn b() {
  ...
  if (true) {
    ...
    if (true) {
      let I = 2;
      let tint_symbol_4 = I;
      let p2 = &((*(p1))[tint_symbol_4]);
      if (true) {
        let I = 3;
        let tint_symbol_3 = I;
        let p3 = &((*(p2))[tint_symbol_3]);
        if (true) {
          let I = 4;
          a_U_X_X_X(U_X_X_X(u32(tint_symbol_5), u32(tint_symbol_4), u32(tint_symbol_3)));
        }
