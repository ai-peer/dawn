...
TEST_F(DirectVariableAccessTest, Fn_ptr_unused) {
    auto* src = R"(
...
fn b(p0 : ptr<uniform, array<array<array<vec4<i32>, 8>, 8>, 8>>) {
  if (true) {
    let I = 1;
    let p1 = &(*p0)[I];
    if (true) {
...
@group(0) @binding(0) var<uniform> A : array<array<array<vec4<i32>, 8>, 8>, 8>;
@group(0) @binding(1) var<uniform> B : array<array<array<vec4<i32>, 8>, 8>, 8>;
...
fn c() {
  ...
  b(&B);
    ...
    auto* expect =
        R"(
type A_X_X_X = array<u32, 3u>;

fn a_A_X_X_X(p : A_X_X_X) -> vec4<i32> {
  return *(&(A[p[0]][p[1]][p[2]]));
}

type B_X_X_X = array<u32, 3u>;

fn a_B_X_X_X(p : B_X_X_X) -> vec4<i32> {
...
fn b_A() {
  if (true) {
    let I = 1;
    let tint_symbol = I;
    let p1 = &(A[u32(tint_symbol)]);
    if (true) {
      let I = 2;
      let tint_symbol_1 = I;
      let p2 = &(A[u32(tint_symbol)][u32(tint_symbol_1)]);
      if (true) {
        let I = 3;
        let tint_symbol_2 = I;
        let p3 = &(A[u32(tint_symbol)][u32(tint_symbol_1)][u32(tint_symbol_2)]);
        if (true) {
          let I = 4;
          a_A_X_X_X(A_X_X_X(u32(tint_symbol), u32(tint_symbol_1), u32(tint_symbol_2)));
        }
      }
    }
  }
...
fn b_B() {
  if (true) {
    let I = 1;
    let tint_symbol = I;
    let p1 = &(B[u32(tint_symbol)]);
    if (true) {
      let I = 2;
      let tint_symbol_1 = I;
      let p2 = &(B[u32(tint_symbol)][u32(tint_symbol_1)]);
      if (true) {
        let I = 3;
        let tint_symbol_2 = I;
        let p3 = &(B[u32(tint_symbol)][u32(tint_symbol_1)][u32(tint_symbol_2)]);
        if (true) {
          let I = 4;
          a_B_X_X_X(B_X_X_X(u32(tint_symbol), u32(tint_symbol_1), u32(tint_symbol_2)));
        }
      }
    }
  }
