...
TEST_F(DirectVariableAccessTest, PtrChains_HoistIndices) {
    auto* src = R"(
@group(0) @binding(0) var<uniform> U : array<array<array<vec4<i32>, 8>, 8>, 8>;
...
fn b() {
  ...
  let p2 = &(U[ptr_index_save][ptr_index_save_1][ptr_index_save_2]);
...
fn c_U() {
  ...
  let p2 = &(U[ptr_index_save_3][ptr_index_save_4][ptr_index_save_5]);
...
TEST_F(DirectVariableAccessTest, PtrChains_HoistInForLoopInit) {
    auto* src = R"(
...
TEST_F(DirectVariableAccessTest, PtrChains_HoistInForLoopCond) {
    auto* src = R"(
@group(0) @binding(0) var<uniform> U : array<array<vec4<i32>, 8>, 8>;
...
TEST_F(DirectVariableAccessTest, PtrChains_HoistInForLoopCont) {
    auto* src = R"(
@group(0) @binding(0) var<uniform> U : array<array<vec4<i32>, 8>, 8>;
...
TEST_F(DirectVariableAccessTest, PtrChains_HoistInWhileCond) {
    auto* src = R"(
@group(0) @binding(0) var<uniform> U : array<array<vec4<i32>, 8>, 8>;
...
fn b() {
  ...
  if (true) {
    ...
    if (true) {
      ...
      let p2 = &(U[ptr_index_save][ptr_index_save_1]);
      if (true) {
        let I = 3;
        let ptr_index_save_2 = I;
        let p3 = &(U[ptr_index_save][ptr_index_save_1][ptr_index_save_2]);
        if (true) {
          let I = 4;
          a_U_X_X_X(U_X_X_X(u32(ptr_index_save), u32(ptr_index_save_1), u32(ptr_index_save_2)));
        }
