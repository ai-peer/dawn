    ...
    return {
        ...
        b.If(b.create<ast::BinaryExpression>(
             ...
             b.Else(b.Block(
                 ...
                 // y = y - yuvToRgbConversionMatrix[0][4];
                 b.Assign("y",
                          b.Sub("y", b.IndexAccessor(
                                         b.IndexAccessor(
                                             b.MemberAccessor(
                                                 "params",
                                             ...
                                             0),
                                         3))),
                 // uv.x = uv.x - yuvToRgbConversionMatrix[1][4];
                 b.Assign(
                     b.MemberAccessor("uv", "x"),
                     b.Sub(b.MemberAccessor("uv", "x"),
                           b.IndexAccessor(
                               b.IndexAccessor(
                                   ...
                                   1),
                               3))),
                 // uv.y = uv.y - yuvToRgbConversionMatrix[1][4];
                 b.Assign(
                     b.MemberAccessor("uv", "y"),
                     b.Sub(b.MemberAccessor("uv", "y"),
                           b.IndexAccessor(
                               b.IndexAccessor(
                                   b.MemberAccessor("params",
                                                    "yuvToRgbConversionMatrix"),
                 ...
                 // vec4<f32>(y, uv.x, uv.y), 0.0);
                 b.Assign("color",
                          b.Mul(b.vec4<f32>("y", "uv", 0.0f),
                                b.MemberAccessor(
