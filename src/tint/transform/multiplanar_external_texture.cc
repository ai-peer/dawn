...
struct MultiplanarExternalTexture::State {
    ...
    auto buildTextureBuiltinBody(sem::BuiltinType call_type) {
        ...
        switch (call_type) {
            case sem::BuiltinType::kTextureSampleLevel:
                ...
                break;
            case sem::BuiltinType::kTextureSampleBaseClampToEdge:
                // textureSampleBaseClampToEdge(plane0, smp, coord.xy, 0.0);
                single_plane_call =
                    b.Call("textureSampleBaseClampToEdge", "plane0", "smp", "coord", 0_f);
                // textureSampleBaseClampToEdge(plane0, smp, coord.xy, 0.0);
                plane_0_call =
                    b.Call("textureSampleBaseClampToEdge", "plane0", "smp", "coord", 0_f);
                // textureSampleBaseClampToEdge(plane1, smp, coord.xy, 0.0);
                plane_1_call =
                    b.Call("textureSampleBaseClampToEdge", "plane1", "smp", "coord", 0_f);
                break;
            case sem::BuiltinType::kTextureLoad:
    ...
    /// @deprecated TODO(crbug.com/tint/1671): DEPRECATED
