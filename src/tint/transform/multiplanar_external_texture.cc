...
struct MultiplanarExternalTexture::State {
    ...
    void Process() {
        ...
        for (auto* global : ctx.src->AST().GlobalVariables()) {
            ...
            b.GlobalVar(syms.params, b.Ident("ExternalTextureParams"), type::AddressSpace::kUniform,
            ...
            for (const ast::Variable* param : fn->params) {
                if (auto* sem_var = sem.Get(param)) {
                    ...
                    ctx.InsertAfter(fn->params, param,
                                    b.Param(syms.params, b.Ident(params_struct_sym)));
                }
            }
        }
    ...
    void createExtTexParamsStructs() {
        ...
        utils::Vector ext_tex_params_member_list{
            ...
            b.Member("gammaDecodeParams", b.Ident("GammaTransferParams")),
            b.Member("gammaEncodeParams", b.Ident("GammaTransferParams")),
    ...
    void createGammaCorrectionFn() {
        ...
        b.Func(
            ...
            utils::Vector{
                ...
                b.Param("params", b.Ident(gamma_transfer_struct_sym)),
            },
            b.ty.vec3<f32>(),
            utils::Vector{
        ...
        if (!texture_sample_external_sym.IsValid()) {
            ...
            b.Func(texture_sample_external_sym,
                   utils::Vector{
                       ...
                       b.Param("params", b.Ident(params_struct_sym)),
                   },
                   b.ty.vec4(b.ty.f32()),
