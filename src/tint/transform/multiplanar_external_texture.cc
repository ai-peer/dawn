...
struct MultiplanarExternalTexture::State {
  ...
  void createExtTexParamsStruct() {
    ast::StructMemberList member_list = {
        ...
        b.Member("yuvToRgbConversionMatrix", b.ty.mat3x3(b.ty.f32()))};
  ...
  ast::StatementList createTexFnExtStatementList(sem::BuiltinType call_type) {
    ...
    return {
        ...
        b.If(b.create<ast::BinaryExpression>(
             ...
             b.Else(b.Block(
                 //  var y = plane_0_call.r;
                 b.Decl(
                     b.Var("y", nullptr, b.MemberAccessor(plane_0_call, "r"))),
                 // var uv = plane_1_call.rg;
                 b.Decl(b.Var("uv", nullptr,
                              b.MemberAccessor(plane_1_call, "rg"))),
                 // if(params.yuvToRgbConversionMatrix[0][0] != 1.0)
                 b.If(b.create<ast::BinaryExpression>(
                      ...
                      b.Block(
                          // y = y - 0.0625;
                          b.Assign("y", b.Sub("y", 0.0625f)),
                          // uv.x = uv.x - 0.5;
                          b.Assign(b.MemberAccessor("uv", "x"),
                                   b.Sub(b.MemberAccessor("uv", "x"), 0.5f)),
                          // uv.y = uv.y - 0.5;
                          b.Assign(b.MemberAccessor("uv", "y"),
                                   b.Sub(b.MemberAccessor("uv", "y"), 0.5f)))),
                 // color = vec4<f32>(params.yuvToRgbConversionMatrix *
                 // vec3<f32>(y, uv.x, uv.y), 1.0);
                 b.Assign("color",
                          b.Mul(b.vec3<f32>("y", "uv"),
                                b.MemberAccessor(
