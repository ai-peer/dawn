...
TEST_F(DecomposeStridedArrayTest, ReadUniformStridedArray) {
    ...
    b.Func("f", {}, b.ty.void_(),
           {
               b.Decl(b.Const("a", b.ty.array<f32, 4>(32), b.MemberAccessor("s", "a"))),
...
TEST_F(DecomposeStridedArrayTest, ReadUniformDefaultStridedArray) {
    ...
    b.Func(
        "f", {}, b.ty.void_(),
        {
            b.Decl(b.Const("a", b.ty.array(b.ty.vec4<f32>(), 4, 16), b.MemberAccessor("s", "a"))),
...
TEST_F(DecomposeStridedArrayTest, ReadStorageDefaultStridedArray) {
    ...
    b.Func("f", {}, b.ty.void_(),
           {
               b.Decl(b.Const("a", b.ty.array<f32, 4>(4), b.MemberAccessor("s", "a"))),
               b.Decl(b.Const("b", b.ty.f32(), b.IndexAccessor(b.MemberAccessor("s", "a"), 1))),
           },
           {
               b.Stage(ast::PipelineStage::kCompute),
...
TEST_F(DecomposeStridedArrayTest, ReadWriteViaPointerLets) {
    ...
    b.Func("f", {}, b.ty.void_(),
           {
               b.Decl(b.Const("a", nullptr, b.AddressOf(b.MemberAccessor("s", "a")))),
...
TEST_F(DecomposeStridedArrayTest, PrivateAliasedStridedArray) {
    ...
    b.Func("f", {}, b.ty.void_(),
           {
               b.Decl(b.Const("a", b.ty.type_name("ARR"), b.MemberAccessor("s", "a"))),
               b.Decl(b.Const("b", b.ty.f32(), b.IndexAccessor(b.MemberAccessor("s", "a"), 1))),
...
TEST_F(DecomposeStridedArrayTest, PrivateNestedStridedArray) {
    ...
    b.Func("f", {}, b.ty.void_(),
           {
               b.Decl(b.Const("a", b.ty.type_name("ARR_B"), b.MemberAccessor("s", "a"))),
