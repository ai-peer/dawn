...
class Hashmap {
  ...
  public:
    ...
    /// @returns true if this Hashmap is equal to other
    bool operator==(const Hashmap& other) const { return set_ == other.set_; }

    /// Inequality operator
    /// @param other the other Hashmap to compare this Hashmap to
    /// @returns true if this Hashmap is not equal to other
    bool operator!=(const Hashmap& other) const { return set_ != other.set_; }
