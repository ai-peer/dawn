...
class Hashset {
    ...
    /// The target length of the underlying vector length in relation to the number of elements in
    /// the set, expressed as a percentage.
  ...
  public:
    ...
    AddResult Add(V&& value) {
        return Put</* replace */ false>(std::forward<V>(value));
    }
    ...
    AddResult Replace(V&& value) {
        return Put</* replace */ true>(std::forward<V>(value));
    }
    ...
    void Reserve(size_t capacity) {
        ...
        // Put all the values back into the set. As the number of slots has grown, the slot
