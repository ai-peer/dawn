...
/// IsVectorLike<T>::value is true if T is a tint::Vector or tint::VectorRef.
template <typename T>
struct IsVectorLike {
...
/// IsVectorLike specialization for tint::Vector
template <typename T, size_t N>
struct IsVectorLike<tint::Vector<T, N>> {
    /// True for the IsVectorLike specialization of tint::Vector
    static constexpr bool value = true;
};

/// IsVectorLike specialization for tint::VectorRef
template <typename T>
struct IsVectorLike<tint::VectorRef<T>> {
    /// True for the IsVectorLike specialization of tint::VectorRef
    static constexpr bool value = true;
};
}  // namespace detail
