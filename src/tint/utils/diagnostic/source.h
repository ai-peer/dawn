...
inline tint::StringStream& operator<<(tint::StringStream& out, const Source::Location& loc) {
...
/// @returns out so calls can be chained
inline tint::StringStream& operator<<(tint::StringStream& out, const Source::Range& range) {
...
/// @returns out so calls can be chained
tint::StringStream& operator<<(tint::StringStream& out, const Source& source);

/// Writes the Source::FileContent to the stream.
/// @param out the stream to write to
/// @param content the file content to write
/// @returns out so calls can be chained
inline tint::StringStream& operator<<(tint::StringStream& out, const Source::FileContent& content) {
    out << content.data;
    return out;
}
