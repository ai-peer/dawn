...
add_library(lib_tint_utils_diagnostic STATIC
...
if ((NOT IS_LINUX)  AND  (NOT IS_MAC)  AND  (NOT IS_WIN))
  target_sources(lib_tint_utils_diagnostic PRIVATE
...
target_link_libraries(lib_tint_utils_diagnostic
  lib_tint_utils_text
  lib_tint_utils_traits
)

tint_default_compile_options(lib_tint_utils_diagnostic)

add_library(tint_utils_diagnostic_test STATIC
...
target_link_libraries(tint_utils_diagnostic_test
  lib_tint_utils_diagnostic
)

tint_default_compile_options(tint_utils_diagnostic_test)
