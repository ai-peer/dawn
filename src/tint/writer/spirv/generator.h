...
struct Options {
    ...
    /// Set to `true` to skip robustness transform on the unsized arrays.
    bool disable_unsized_array_access_with_uint_index_robustness = false;
    ...
    TINT_REFLECT(disable_robustness,
                 ...
                 disable_unsized_array_access_with_uint_index_robustness);
};
