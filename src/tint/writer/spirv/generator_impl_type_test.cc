...
TEST_F(SpvGeneratorImplTest, Type_Multiple) {
    ...
    EXPECT_EQ(generator_.Type(U32()), 2u);
    EXPECT_EQ(generator_.Type(F32()), 3u);
    EXPECT_EQ(generator_.Type(F16()), 4u);
