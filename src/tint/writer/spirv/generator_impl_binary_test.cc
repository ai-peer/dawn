...
TEST_F(SpvGeneratorImplTest, Binary_Sub_I32) {
    ...
    func->start_target->instructions.Push(CreateBinary(
        ir::Binary::Kind::kSubtract, ir.types.Get<type::I32>(), Constant(1_i), Constant(2_i)));
...
TEST_F(SpvGeneratorImplTest, Binary_Sub_U32) {
    ...
    func->start_target->instructions.Push(CreateBinary(
        ir::Binary::Kind::kSubtract, ir.types.Get<type::U32>(), Constant(1_u), Constant(2_u)));
...
TEST_F(SpvGeneratorImplTest, Binary_Sub_F32) {
    ...
    func->start_target->instructions.Push(CreateBinary(
        ir::Binary::Kind::kSubtract, ir.types.Get<type::F32>(), Constant(1_f), Constant(2_f)));
...
TEST_F(SpvGeneratorImplTest, Binary_Chain) {
    ...
    auto* a = CreateBinary(ir::Binary::Kind::kSubtract, ir.types.Get<type::I32>(), Constant(1_i),
                           Constant(2_i));
