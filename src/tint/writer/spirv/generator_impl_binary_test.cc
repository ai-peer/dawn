...
TEST_F(SpvGeneratorImplTest, Binary_Add_I32) {
    ...
    func->start_target->instructions.Push(
        CreateBinary(ir::Binary::Kind::kAdd, I32(), Constant(1_i), Constant(2_i)));
...
TEST_F(SpvGeneratorImplTest, Binary_Add_U32) {
    ...
    func->start_target->instructions.Push(
        CreateBinary(ir::Binary::Kind::kAdd, U32(), Constant(1_u), Constant(2_u)));
...
TEST_F(SpvGeneratorImplTest, Binary_Add_F32) {
    ...
    func->start_target->instructions.Push(
        CreateBinary(ir::Binary::Kind::kAdd, F32(), Constant(1_f), Constant(2_f)));
...
TEST_F(SpvGeneratorImplTest, Binary_Add_Chain) {
    ...
    auto* a = CreateBinary(ir::Binary::Kind::kAdd, I32(), Constant(1_i), Constant(2_i));
    func->start_target->instructions.Push(a);
    func->start_target->instructions.Push(CreateBinary(ir::Binary::Kind::kAdd, I32(), a, a));
