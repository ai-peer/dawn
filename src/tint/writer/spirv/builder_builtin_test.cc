...
TEST_P(Builtin_Builtin_SingleParam_Float_Test, Call_Scalar_f32) {
    auto param = GetParam();
...
TEST_P(Builtin_Builtin_SingleParam_Float_Test, Call_Scalar_f16) {
    Enable(ast::Extension::kF16);

    auto param = GetParam();
    auto* expr = Call(param.name, 1_h);
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_P(Builtin_Builtin_SingleParam_Float_Test, Call_Vector_f32) {
    auto param = GetParam();
...
TEST_P(Builtin_Builtin_SingleParam_Float_Test, Call_Vector_f16) {
    Enable(ast::Extension::kF16);

    auto param = GetParam();
    auto* expr = Call(param.name, vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_F(BuiltinBuilderTest, Call_Length_Vector_f16) {
    ...
    auto* expr = Call("length", vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_F(BuiltinBuilderTest, Call_Normalize_f16) {
    ...
    auto* expr = Call("normalize", vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_P(Builtin_Builtin_DualParam_Float_Test, Call_Scalar_f32) {
    auto param = GetParam();
...
TEST_P(Builtin_Builtin_DualParam_Float_Test, Call_Scalar_f16) {
    Enable(ast::Extension::kF16);
...
TEST_P(Builtin_Builtin_DualParam_Float_Test, Call_Vector_f32) {
    auto param = GetParam();
...
TEST_P(Builtin_Builtin_DualParam_Float_Test, Call_Vector_f16) {
    Enable(ast::Extension::kF16);
...
TEST_F(BuiltinBuilderTest, Call_Reflect_Vector_f16) {
    ...
    auto* expr = Call("reflect", vec2<f16>(1_h, 1_h), vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_F(BuiltinBuilderTest, Call_Distance_Scalar_f16) {
    ...
    auto* expr = Call("distance", 1_h, 1_h);
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_F(BuiltinBuilderTest, Call_Distance_Vector_f16) {
    ...
    auto* expr = Call("distance", vec2<f16>(1_h, 1_h), vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_F(BuiltinBuilderTest, Call_Cross_f16) {
    ...
    auto* expr = Call("cross", vec3<f16>(1_h, 1_h, 1_h), vec3<f16>(1_h, 1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_P(Builtin_Builtin_ThreeParam_Float_Test, Call_Scalar_f32) {
    auto param = GetParam();
...
TEST_P(Builtin_Builtin_ThreeParam_Float_Test, Call_Scalar_f16) {
    Enable(ast::Extension::kF16);

    auto param = GetParam();
    auto* expr = Call(param.name, 1_h, 1_h, 1_h);
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_P(Builtin_Builtin_ThreeParam_Float_Test, Call_Vector_f32) {
    auto param = GetParam();
...
TEST_P(Builtin_Builtin_ThreeParam_Float_Test, Call_Vector_f16) {
    Enable(ast::Extension::kF16);

    auto param = GetParam();
    auto* expr = Call(param.name, vec2<f16>(1_h, 1_h), vec2<f16>(1_h, 1_h), vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
...
TEST_F(BuiltinBuilderTest, Call_FaceForward_Vector_f16) {
    ...
    auto* expr = Call("faceForward", vec2<f16>(1_h, 1_h), vec2<f16>(1_h, 1_h), vec2<f16>(1_h, 1_h));
    auto* func = Func("a_func", {}, ty.void_(),
                      {
                          Assign(Phony(), expr),
                      });
