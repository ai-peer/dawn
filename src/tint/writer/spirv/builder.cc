...
bool Builder::GenerateGlobalVariable(const ast::Variable* v) {
    ...
    if (auto* override = v->As<ast::Override>(); override && !override->constructor) {
        ...
        init_id = Switch(
            type,  //
            [&](const sem::F32*) {
                ast::FloatLiteralExpression l(ProgramID{}, 0u, Source{}, 0,
                                              ast::FloatLiteralExpression::Suffix::kF);
                return GenerateLiteralIfNeeded(override, &l);
            },
            [&](const sem::U32*) {
                ast::IntLiteralExpression l(ProgramID{}, 0u, Source{}, 0,
            ...
            [&](const sem::Bool*) {
                ast::BoolLiteralExpression l(ProgramID{}, 0u, Source{}, false);
                return GenerateLiteralIfNeeded(override, &l);
            },
            [&](Default) {
