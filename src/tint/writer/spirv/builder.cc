...
bool Builder::GenerateExtension(ast::Extension::Type type) {
  /*
  TODO(Zhaoming): For each supported extension, push corresponding
  capability into the builder.
  For example:
    if (type == ast::Extension::Type::kF16) {
