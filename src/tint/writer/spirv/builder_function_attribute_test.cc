...
TEST_F(BuilderTest, Decoration_ExecutionMode_WorkgroupSize_Const) {
    GlobalConst("width", ty.i32(), Call(ty.i32(), 2_i));
    GlobalConst("height", ty.i32(), Call(ty.i32(), 3_i));
    GlobalConst("depth", ty.i32(), Call(ty.i32(), 4_i));
    auto* func = Func("main", utils::Empty, ty.void_, utils::Empty,
                      utils::Vector{
...
TEST_F(BuilderTest, Decoration_ExecutionMode_WorkgroupSize_OverridableConst) {
    Override("width", ty.i32(), Call(ty.i32(), 2_i), Id(7_u));
    Override("height", ty.i32(), Call(ty.i32(), 3_i), Id(8_u));
    Override("depth", ty.i32(), Call(ty.i32(), 4_i), Id(9_u));
    auto* func = Func("main", utils::Empty, ty.void_, utils::Empty,
                      utils::Vector{
                          WorkgroupSize("width", "height", "depth"),
                          Stage(ast::PipelineStage::kCompute),
...
TEST_F(BuilderTest, Decoration_ExecutionMode_WorkgroupSize_LiteralAndConst) {
    Override("height", ty.i32(), Call(ty.i32(), 2_i), Id(7_u));
    GlobalConst("depth", ty.i32(), Call(ty.i32(), 3_i));
    auto* func = Func("main", utils::Empty, ty.void_, utils::Empty,
                      utils::Vector{
