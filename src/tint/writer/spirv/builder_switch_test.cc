...
TEST_F(BuilderTest, Switch_WithCase) {
    ...
    auto* func = Func("a_func", utils::Empty, ty.void_(),
                      utils::Vector{
                          Switch("a",                                                     //
                                 Case(CaseSelector(Expr(1_i)), Block(Assign("v", 1_i))),  //
                                 Case(CaseSelector(Expr(2_i)), Block(Assign("v", 2_i))),  //
                                 DefaultCase()),
                      });
...
TEST_F(BuilderTest, Switch_WithCase_Unsigned) {
    ...
    auto* func = Func("a_func", utils::Empty, ty.void_(),
                      utils::Vector{
                          Switch("a",                                                     //
                                 Case(CaseSelector(Expr(1_u)), Block(Assign("v", 1_i))),  //
                                 Case(CaseSelector(Expr(2_u)), Block(Assign("v", 2_i))),  //
                                 DefaultCase()),
                      });
             ...
             utils::Vector{
                 Switch(Expr("a"),                                                             //
                        Case(CaseSelector(Expr(1_i)),                                          //
                             Block(Assign("v", 1_i))),                                         //
                        Case(utils::Vector{CaseSelector(Expr(2_i)), CaseSelector(Expr(3_i))},  //
                             Block(Assign("v", 2_i))),                                         //
    ...
    auto* func =
        Func("a_func", utils::Empty, ty.void_(),
             utils::Vector{Switch(Expr("a"),                      //
                                  Case(CaseSelector(Expr(1_i)),   //
                                       Block(Assign("v", 1_i))),  //
                                  Case(utils::Vector{CaseSelector(Expr(2_i)),
                                                     CaseSelector(Expr(3_i)), CaseSelector()},  //
                                       Block(Assign("v", 2_i)))                                 //
                                  )});
...
TEST_F(BuilderTest, Switch_AllReturn) {
    ...
    auto* fn = Func("f", utils::Empty, ty.i32(),
                    utils::Vector{
                        Switch(1_i,                                                  //
                               Case(CaseSelector(Expr(1_i)), Block(Return(1_i))),    //
                               Case(CaseSelector(Expr(2_i)), Block(Fallthrough())),  //
