...
TEST_F(SpvGeneratorImplTest, Builtin_Frexp_F32) {
    auto* str = builtin::CreateFrexpResult(ty, mod.symbols, ty.f32());
...
TEST_F(SpvGeneratorImplTest, Builtin_Frexp_F16) {
    auto* str = builtin::CreateFrexpResult(ty, mod.symbols, ty.f16());
...
TEST_F(SpvGeneratorImplTest, Builtin_Frexp_Vec2f) {
    auto* str = builtin::CreateFrexpResult(ty, mod.symbols, ty.vec2<f32>());
...
TEST_F(SpvGeneratorImplTest, Builtin_Frexp_Vec3h) {
    auto* str = builtin::CreateFrexpResult(ty, mod.symbols, ty.vec3<f16>());
...
TEST_F(SpvGeneratorImplTest, Builtin_Modf_F32) {
    auto* str = builtin::CreateModfResult(ty, mod.symbols, ty.f32());
    auto* arg = b.FunctionParam("arg", ty.f32());
    auto* func = b.Function("foo", str);
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpvGeneratorImplTest, Builtin_Modf_F16) {
    auto* str = builtin::CreateModfResult(ty, mod.symbols, ty.f16());
    auto* arg = b.FunctionParam("arg", ty.f16());
    auto* func = b.Function("foo", str);
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpvGeneratorImplTest, Builtin_Modf_Vec2f) {
    auto* str = builtin::CreateModfResult(ty, mod.symbols, ty.vec2<f32>());
    auto* arg = b.FunctionParam("arg", ty.vec2<f32>());
    auto* func = b.Function("foo", str);
    func->SetParams({arg});
    b.With(func->Block(), [&] {
...
TEST_F(SpvGeneratorImplTest, Builtin_Modf_Vec3h) {
    auto* str = builtin::CreateModfResult(ty, mod.symbols, ty.vec3<f16>());
    auto* arg = b.FunctionParam("arg", ty.vec3<f16>());
    auto* func = b.Function("foo", str);
    func->SetParams({arg});
    b.With(func->Block(), [&] {
