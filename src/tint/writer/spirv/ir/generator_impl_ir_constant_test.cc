...
TEST_F(SpvGeneratorImplTest, Constant_Vec3u) {
    ...
    ASSERT_TRUE(Generate()) << Error() << output_;
    EXPECT_INST("%uint_42 = OpConstant %uint 42");
    EXPECT_INST("%uint_0 = OpConstant %uint 0");
    EXPECT_INST("%uint_4000000000 = OpConstant %uint 4000000000");
...
TEST_F(SpvGeneratorImplTest, Constant_Vec4f) {
    ...
    ASSERT_TRUE(Generate()) << Error() << output_;
    EXPECT_INST("%float_42 = OpConstant %float 42");
    EXPECT_INST("%float_0 = OpConstant %float 0");
    EXPECT_INST("%float_0_25 = OpConstant %float 0.25");
    EXPECT_INST("%float_n1 = OpConstant %float -1");
...
TEST_F(SpvGeneratorImplTest, Constant_Vec2h) {
    ...
    ASSERT_TRUE(Generate()) << Error() << output_;
    EXPECT_INST("%half_0x1_5p_5 = OpConstant %half 0x1.5p+5");
    EXPECT_INST("%half_0x1pn2 = OpConstant %half 0x1p-2");
...
TEST_F(SpvGeneratorImplTest, Constant_Mat2x3f) {
    ...
    EXPECT_INST("%float_n1 = OpConstant %float -1");
    EXPECT_INST("%float_0_25 = OpConstant %float 0.25");
    EXPECT_INST("          %5 = OpConstantComposite %v3float %float_42 %float_n1 %float_0_25");
    EXPECT_INST("%float_n42 = OpConstant %float -42");
    EXPECT_INST("%float_0 = OpConstant %float 0");
    EXPECT_INST("%float_n0_25 = OpConstant %float -0.25");
    EXPECT_INST("          %9 = OpConstantComposite %v3float %float_n42 %float_0 %float_n0_25");
    EXPECT_INST("          %1 = OpConstantComposite %mat2v3float %5 %9");
}
...
TEST_F(SpvGeneratorImplTest, Constant_Mat4x2h) {
    ...
    EXPECT_INST("%half_0x1_5p_5 = OpConstant %half 0x1.5p+5");
    EXPECT_INST("%half_n0x1p_0 = OpConstant %half -0x1p+0");
    EXPECT_INST("          %5 = OpConstantComposite %v2half %half_0x1_5p_5 %half_n0x1p_0");
    EXPECT_INST("%half_0x0p_0 = OpConstant %half 0x0p+0");
    EXPECT_INST("%half_0x1pn2 = OpConstant %half 0x1p-2");
    EXPECT_INST("          %8 = OpConstantComposite %v2half %half_0x0p_0 %half_0x1pn2");
    EXPECT_INST("%half_n0x1_5p_5 = OpConstant %half -0x1.5p+5");
    EXPECT_INST("%half_0x1p_0 = OpConstant %half 0x1p+0");
    EXPECT_INST("         %11 = OpConstantComposite %v2half %half_n0x1_5p_5 %half_0x1p_0");
    EXPECT_INST("%half_0x1pn1 = OpConstant %half 0x1p-1");
    EXPECT_INST("         %14 = OpConstantComposite %v2half %half_0x1pn1 %half_0x0p_0");
    EXPECT_INST("          %1 = OpConstantComposite %mat4v2half %5 %8 %11 %14");
}
...
TEST_F(SpvGeneratorImplTest, Constant_Array_I32) {
    ...
    ASSERT_TRUE(Generate()) << Error() << output_;
    EXPECT_INST("%int_1 = OpConstant %int 1");
    EXPECT_INST("%int_2 = OpConstant %int 2");
    EXPECT_INST("%int_3 = OpConstant %int 3");
    EXPECT_INST("%int_4 = OpConstant %int 4");
...
TEST_F(SpvGeneratorImplTest, Constant_Array_Array_I32) {
    ...
    EXPECT_INST("%int_3 = OpConstant %int 3");
    EXPECT_INST("%int_4 = OpConstant %int 4");
    EXPECT_INST("    %7 = OpConstantComposite %_arr_int_uint_4 %int_1 %int_2 %int_3 %int_4");
    EXPECT_INST("    %1 = OpConstantComposite %_arr__arr_int_uint_4_uint_4 %7 %7 %7 %7");
}
...
TEST_F(SpvGeneratorImplTest, Constant_Struct) {
    ...
    ASSERT_TRUE(Generate()) << Error() << output_;
    EXPECT_INST("  %int_1 = OpConstant %int 1");
    EXPECT_INST(" %uint_2 = OpConstant %uint 2");
    EXPECT_INST("%float_3 = OpConstant %float 3");
