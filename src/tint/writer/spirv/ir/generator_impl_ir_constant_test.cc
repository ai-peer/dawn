...
TEST_F(SpvGeneratorImplTest, Constant_Vec2i) {
    ...
    auto* v = mod.constants.Create<constant::Composite>(mod.types.Get<type::Vector>(i, 2u),
                                                        utils::Vector{i_42->Value(), i_n1->Value()},
                                                        false, false);
    generator_.Constant(b.Constant(v));
...
TEST_F(SpvGeneratorImplTest, Constant_Vec2h) {
    ...
    auto* v = mod.constants.Create<constant::Composite>(mod.types.Get<type::Vector>(h, 2u),
                                                        utils::Vector{h_42->Value(), h_q->Value()},
                                                        false, false);
    generator_.Constant(b.Constant(v));
