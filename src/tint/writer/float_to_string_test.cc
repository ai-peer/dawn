...
TEST(DoubleToStringTest, Precision) {
    ...
    EXPECT_EQ(DoubleToString(0.0000000001), "0.0000000001");
...
TEST(DoubleToBitPreservingStringTest, Zero) {
    EXPECT_EQ(DoubleToBitPreservingString(0.000000000), "0.0");
}
...
TEST(DoubleToBitPreservingStringTest, One) {
    EXPECT_EQ(DoubleToBitPreservingString(1.000000000), "1.0");
}
