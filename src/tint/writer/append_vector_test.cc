...
TEST_F(AppendVectorTest, Vec2i32_u32) {
    ...
    EXPECT_EQ(Symbols().NameFor(u32_to_i32->target->symbol), "i32");
...
TEST_F(AppendVectorTest, Vec2i32FromVec2u32_u32) {
    ...
    ast::CheckIdentifier(Symbols(), v2u32_to_v2i32->target, "vec2", "i32");
...
TEST_F(AppendVectorTest, Vec2i32_f32) {
    ...
    EXPECT_EQ(Symbols().NameFor(f32_to_i32->target->symbol), "i32");
