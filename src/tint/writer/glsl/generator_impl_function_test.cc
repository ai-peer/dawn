...
layout(binding = 0layout(binding = 0, std140) uniform UBO_1 {
  vec4 coord;
} ubo;
...
layout(binding = 0layout(binding = 0, std140) uniform Uniforms_1 {
  vec4 coord;
} uniforms;
...
layout(binding = 0layout(binding = 0, std140) uniform S_1 {
  float x;
} coord;
