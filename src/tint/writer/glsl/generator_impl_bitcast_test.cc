...
int tint_bitcast(f16vec2 src) {
  uint r = packFloat2x16(src);
  return int(r);
}
f16vec2 tint_bitcast_1(int src) {
  uint r = uint(src);
  return unpackFloat2x16(r);
}
float tint_bitcast_2(f16vec2 src) {
  uint r = packFloat2x16(src);
  return uintBitsToFloat(r);
}
f16vec2 tint_bitcast_3(float src) {
  uint r = floatBitsToUint(src);
  return unpackFloat2x16(r);
}
uint tint_bitcast_4(f16vec2 src) {
  uint r = packFloat2x16(src);
  return uint(r);
}
f16vec2 tint_bitcast_5(uint src) {
  uint r = uint(src);
  return unpackFloat2x16(r);
}
...
void test_function() {
  ...
  int b = tint_bitcast(a);
  f16vec2 c = tint_bitcast_1(b);
  float d = tint_bitcast_2(c);
  f16vec2 e = tint_bitcast_3(d);
  uint f = tint_bitcast_4(e);
  f16vec2 g = tint_bitcast_5(f);
  return;
}
)");
}
...
ivec2 tint_bitcast(f16vec4 src) {
  uvec2 r = uvec2(packFloat2x16(src.xy), packFloat2x16(src.zw));
  return ivec2(r);
}
f16vec4 tint_bitcast_1(ivec2 src) {
  uvec2 r = uvec2(src);
  f16vec2 v_xy = unpackFloat2x16(r.x);
  f16vec2 v_zw = unpackFloat2x16(r.y);
  return f16vec4(v_xy.x, v_xy.y, v_zw.x, v_zw.y);
}
vec2 tint_bitcast_2(f16vec4 src) {
  uvec2 r = uvec2(packFloat2x16(src.xy), packFloat2x16(src.zw));
  return uintBitsToFloat(r);
}
f16vec4 tint_bitcast_3(vec2 src) {
  uvec2 r = floatBitsToUint(src);
  f16vec2 v_xy = unpackFloat2x16(r.x);
  f16vec2 v_zw = unpackFloat2x16(r.y);
  return f16vec4(v_xy.x, v_xy.y, v_zw.x, v_zw.y);
}
uvec2 tint_bitcast_4(f16vec4 src) {
  uvec2 r = uvec2(packFloat2x16(src.xy), packFloat2x16(src.zw));
  return uvec2(r);
}
f16vec4 tint_bitcast_5(uvec2 src) {
  uvec2 r = uvec2(src);
  f16vec2 v_xy = unpackFloat2x16(r.x);
  f16vec2 v_zw = unpackFloat2x16(r.y);
  return f16vec4(v_xy.x, v_xy.y, v_zw.x, v_zw.y);
...
void test_function() {
  ...
  ivec2 b = tint_bitcast(a);
  f16vec4 c = tint_bitcast_1(b);
  vec2 d = tint_bitcast_2(c);
  f16vec4 e = tint_bitcast_3(d);
  uvec2 f = tint_bitcast_4(e);
  f16vec4 g = tint_bitcast_5(f);
  return;
}
)");
}
