...
TEST_F(GlslGeneratorImplTest_Builtin, Select_Scalar) {
    GlobalVar("a", Expr(1_f), ast::StorageClass::kPrivate);
    GlobalVar("b", Expr(2_f), ast::StorageClass::kPrivate);
...
TEST_F(GlslGeneratorImplTest_Builtin, Select_Vector) {
    GlobalVar("a", vec2<i32>(1_i, 2_i), ast::StorageClass::kPrivate);
    GlobalVar("b", vec2<i32>(3_i, 4_i), ast::StorageClass::kPrivate);
