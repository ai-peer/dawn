...
TEST_F(MslGeneratorImplTest, UnsupportedExtension) {
    Enable(Source{{12, 34}}, type::Extension::kUndefined);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        MslBuiltinData{type::BuiltinValue::kPosition, "position"},
        MslBuiltinData{type::BuiltinValue::kVertexIndex, "vertex_id"},
        MslBuiltinData{type::BuiltinValue::kInstanceIndex, "instance_id"},
        MslBuiltinData{type::BuiltinValue::kFrontFacing, "front_facing"},
        MslBuiltinData{type::BuiltinValue::kFragDepth, "depth(any)"},
        MslBuiltinData{type::BuiltinValue::kLocalInvocationId, "thread_position_in_threadgroup"},
        MslBuiltinData{type::BuiltinValue::kLocalInvocationIndex, "thread_index_in_threadgroup"},
        MslBuiltinData{type::BuiltinValue::kGlobalInvocationId, "thread_position_in_grid"},
        MslBuiltinData{type::BuiltinValue::kWorkgroupId, "threadgroup_position_in_grid"},
        MslBuiltinData{type::BuiltinValue::kNumWorkgroups, "threadgroups_per_grid"},
        MslBuiltinData{type::BuiltinValue::kSampleIndex, "sample_id"},
        MslBuiltinData{type::BuiltinValue::kSampleMask, "sample_mask"},
        MslBuiltinData{type::BuiltinValue::kPointSize, "point_size"}));
