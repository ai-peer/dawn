...
bool GeneratorImpl::EmitBuiltinCall(std::ostream& out,
    ...
    // Handle builtins that only accept and return uint (not int overload). We need to explicitly
    // cast the return value (we also cast the arg for good measure).
    // See crbug.com/tint/1550
