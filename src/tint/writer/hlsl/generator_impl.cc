...
SanitizedResult Sanitize(const Program* in, const Options& options) {
    ...
    if (!options.interstage_locations.IsEmpty()) {
        ...
        truncate_interstage_variables_cfg.interstage_locations = std::move(options.interstage_locations);
    }
    ...
    data.Add<transform::TruncateInterstageVariables::Config>(std::move(truncate_interstage_variables_cfg));
