...
class CloneContext {
  ...
  public:
    ...
    /// Inserts @p object before any other objects of @p vector, when it is cloned.
    /// @param vector the vector in #src
    ...
    /// Inserts a lazily built object before any other objects of @p vector, when it is cloned.
    /// @param vector the vector in #src
    ...
    /// Inserts @p object after any other objects of @p vector, when it is cloned.
    /// @param vector the vector in #src
    /// @param object a pointer to the object in #dst that will be inserted at the
    /// end of the vector
    /// @returns this CloneContext so calls can be chained
    ...
    /// Inserts a lazily built object after any other objects of @p vector, when it is cloned.
    /// @param vector the vector in #src
