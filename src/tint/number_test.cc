...
TEST(NumberTest, F16BitsRepresentation_static) {
    ...
    EXPECT_EQ(f16::BitsRepresentation(-nan), 0x7e00u);
    // +/- zero
    EXPECT_EQ(f16::BitsRepresentation(+0.0f), 0x0000u);
    EXPECT_EQ(f16::BitsRepresentation(-0.0f), 0x8000u);
    // Value in normal f16 range
    EXPECT_EQ(f16::BitsRepresentation(1.0f), 0x3c00u);
    EXPECT_EQ(f16::BitsRepresentation(-1.0f), 0xbc00u);
    //   0.00006106496 quantized to 0.000061035156 = 0x1p-14
    EXPECT_EQ(f16::BitsRepresentation(0.00006106496f), 0x0400u);
    EXPECT_EQ(f16::BitsRepresentation(-0.00006106496f), 0x8400u);
    //   1.0004883 quantized to 1.0 = 0x1p0
    EXPECT_EQ(f16::BitsRepresentation(1.0004883f), 0x3c00u);
    EXPECT_EQ(f16::BitsRepresentation(-1.0004883f), 0xbc00u);
    //   8196.0 quantized to 8192.0 = 0x1p13
    EXPECT_EQ(f16::BitsRepresentation(-8196.0f), 0xf000u);
    EXPECT_EQ(f16::BitsRepresentation(8196.0f), 0x7000u);
    // Value in subnormal f16 range
    EXPECT_EQ(f16::BitsRepresentation(0x0.034p-14f), 0x000du);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.034p-14f), 0x800du);
    EXPECT_EQ(f16::BitsRepresentation(0x0.068p-14f), 0x001au);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.068p-14f), 0x801au);
    //   0x0.06b7p-14 quantized to 0x0.068p-14
    EXPECT_EQ(f16::BitsRepresentation(0x0.06b7p-14f), 0x001au);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.06b7p-14f), 0x801au);
    // Value out of f16 range
    EXPECT_EQ(f16::BitsRepresentation(65504.003f), 0x7c00u);
    EXPECT_EQ(f16::BitsRepresentation(-65504.003f), 0xfc00u);
    EXPECT_EQ(f16::BitsRepresentation(0x1.234p56f), 0x7c00u);
    EXPECT_EQ(f16::BitsRepresentation(-0x4.321p65f), 0xfc00u);
    ...
    // Test the mantissa discarding, the least significant mantissa bit is 0x1p-24 = 0x0.004p-14.
    EXPECT_EQ(f16::BitsRepresentation(0x0.064p-14f), 0x0019u);
    EXPECT_EQ(f16::BitsRepresentation(0x0.067fecp-14f), 0x0019u);
    EXPECT_EQ(f16::BitsRepresentation(0x0.063ffep-14f), 0x0018u);
    EXPECT_EQ(f16::BitsRepresentation(0x0.008p-14f), 0x0002u);
    EXPECT_EQ(f16::BitsRepresentation(0x0.00bffep-14f), 0x0002u);
    EXPECT_EQ(f16::BitsRepresentation(0x0.007ffep-14f), 0x0001u);
    ...
    // Test the mantissa discarding.
    EXPECT_EQ(f16::BitsRepresentation(-0x0.064p-14f), 0x8019u);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.067fecp-14f), 0x8019u);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.063ffep-14f), 0x8018u);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.008p-14f), 0x8002u);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.00bffep-14f), 0x8002u);
    EXPECT_EQ(f16::BitsRepresentation(-0x0.007ffep-14f), 0x8001u);
}
