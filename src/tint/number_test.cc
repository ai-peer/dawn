...
TEST(NumberTest, CheckedConvertLargestValue) {
    EXPECT_EQ(CheckedConvert<i32>(AInt(kHighest<i32>)), kHighest<i32>);
    EXPECT_EQ(CheckedConvert<u32>(AInt(kHighest<u32>)), kHighest<u32>);
    EXPECT_EQ(CheckedConvert<u32>(kHighest<i32>), u32(kHighest<i32>));
    EXPECT_EQ(CheckedConvert<f32>(AFloat(kHighest<f32>)), kHighest<f32>);
    EXPECT_EQ(CheckedConvert<f16>(AFloat(kHighest<f16>)), kHighest<f16>);
}

TEST(NumberTest, CheckedConvertLowestValue) {
    EXPECT_EQ(CheckedConvert<i32>(AInt(kLowest<i32>)), kLowest<i32>);
    EXPECT_EQ(CheckedConvert<u32>(AInt(kLowest<u32>)), kLowest<u32>);
    EXPECT_EQ(CheckedConvert<f32>(AFloat(kLowest<f32>)), kLowest<f32>);
    EXPECT_EQ(CheckedConvert<f16>(AFloat(kLowest<f16>)), kLowest<f16>);
}
...
TEST(NumberTest, CheckedConvertSmallestValue) {
    ...
    EXPECT_EQ(CheckedConvert<f32>(AFloat(kSmallest<f32>)), kSmallest<f32>);
    EXPECT_EQ(CheckedConvert<f16>(AFloat(kSmallest<f16>)), kSmallest<f16>);
}

TEST(NumberTest, CheckedConvertExceedsPositiveLimit) {
    EXPECT_EQ(CheckedConvert<i32>(AInt(static_cast<int64_t>(kHighest<i32>) + 1)),
              ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<u32>(AInt(static_cast<uint64_t>(kHighest<u32>) + 1)),
              ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<i32>(kHighest<u32>), ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<i32>(u32(0x80000000)), ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<u32>(kHighest<f32>), ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<i32>(kHighest<f32>), ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<u32>(kHighest<AFloat>), ConversionFailure::kExceedsPositiveLimit);
    EXPECT_EQ(CheckedConvert<i32>(kHighest<AFloat>), ConversionFailure::kExceedsPositiveLimit);
...
TEST(NumberTest, CheckedConvertExceedsNegativeLimit) {
    EXPECT_EQ(CheckedConvert<i32>(AInt(static_cast<int64_t>(kLowest<i32>) - 1)),
              ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<u32>(AInt(static_cast<uint64_t>(kLowest<u32>) - 1)),
              ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<u32>(i32(-1)), ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<u32>(kLowest<i32>), ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<u32>(kLowest<f32>), ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<i32>(kLowest<f32>), ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<u32>(kLowest<AFloat>), ConversionFailure::kExceedsNegativeLimit);
    EXPECT_EQ(CheckedConvert<i32>(kLowest<AFloat>), ConversionFailure::kExceedsNegativeLimit);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<BinaryCheckedCase>{
        ...
        {kHighest<AInt>, AInt(1), AInt(AInt::kHighestValue - 1)},
        {kLowest<AInt>, AInt(-1), AInt(AInt::kLowestValue + 1)},
        {kHighest<AInt>, AInt(0x7fffffff00000000ll), AInt(0x00000000ffffffffll)},
        {kHighest<AInt>, kHighest<AInt>, AInt(0)},
        {kLowest<AInt>, kLowest<AInt>, AInt(0)},
        {OVERFLOW, AInt(1), kHighest<AInt>},
        {OVERFLOW, AInt(-1), kLowest<AInt>},
        {OVERFLOW, AInt(2), kHighest<AInt>},
        {OVERFLOW, AInt(-2), kLowest<AInt>},
        {OVERFLOW, AInt(10000), kHighest<AInt>},
        {OVERFLOW, AInt(-10000), kLowest<AInt>},
        {OVERFLOW, kHighest<AInt>, kHighest<AInt>},
        {OVERFLOW, kLowest<AInt>, kLowest<AInt>},
        ////////////////////////////////////////////////////////////////////////
    }));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<BinaryCheckedCase>{
        ...
        {AInt(-0x8000000000000000ll), AInt(-0x1000000000000000ll), AInt(8)},
        {AInt(0), kHighest<AInt>, AInt(0)},
        {AInt(0), kLowest<AInt>, AInt(0)},
        ...
        {OVERFLOW, kHighest<AInt>, kHighest<AInt>},
        {OVERFLOW, kHighest<AInt>, kLowest<AInt>},
        ////////////////////////////////////////////////////////////////////////
    }));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(std::vector<TernaryCheckedCase>{
        ...
        {AInt(-2), AInt(-2), AInt(1), AInt(0)},
        {AInt(0), kHighest<AInt>, AInt(0), AInt(0)},
        {AInt(0), kLowest<AInt>, AInt(0), AInt(0)},
        ...
        {AInt(-0x8000000000000000ll), AInt(-0x1000000000000000ll), AInt(8), AInt(0)},
        {kHighest<AInt>, AInt(1), AInt(1), AInt(AInt::kHighestValue - 1)},
        {kLowest<AInt>, AInt(1), AInt(-1), AInt(AInt::kLowestValue + 1)},
        {kHighest<AInt>, AInt(1), AInt(0x7fffffff00000000ll), AInt(0x00000000ffffffffll)},
        {kHighest<AInt>, AInt(1), kHighest<AInt>, AInt(0)},
        {kLowest<AInt>, AInt(1), kLowest<AInt>, AInt(0)},
        ...
        {OVERFLOW, kHighest<AInt>, kHighest<AInt>, AInt(0)},
        {OVERFLOW, kHighest<AInt>, kLowest<AInt>, AInt(0)},
        {OVERFLOW, AInt(1), AInt(1), kHighest<AInt>},
        {OVERFLOW, AInt(1), AInt(-1), kLowest<AInt>},
        {OVERFLOW, AInt(1), AInt(2), kHighest<AInt>},
        {OVERFLOW, AInt(1), AInt(-2), kLowest<AInt>},
        {OVERFLOW, AInt(1), AInt(10000), kHighest<AInt>},
        {OVERFLOW, AInt(1), AInt(-10000), kLowest<AInt>},
        {OVERFLOW, AInt(1), kHighest<AInt>, kHighest<AInt>},
        {OVERFLOW, AInt(1), kLowest<AInt>, kLowest<AInt>},
        {OVERFLOW, AInt(1), kHighest<AInt>, AInt(1)},
        {OVERFLOW, AInt(1), kLowest<AInt>, AInt(-1)},
    }));
