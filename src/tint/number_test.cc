...
using F16Test = testing::TestWithParam<F16TestCase>;

TEST_P(F16Test, QuantizeF16) {
...
TEST_P(F16Test, BitsRepresentation) {
    float input_value = GetParam().input_value;
    ...
    EXPECT_EQ(f16::BitsRepresentation(input_value), representation);
