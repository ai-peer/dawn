        ...
        const ast::TypeName* storage_texture(const Source& source,
            ...
            switch (dims) {
                case type::TextureDimension::k1d:
                    return (*this)(source, "texture_storage_1d", utils::ToString(format), utils::ToString(access));
                case type::TextureDimension::k2d:
                    return (*this)(source, "texture_storage_2d", utils::ToString(format), utils::ToString(access));
                case type::TextureDimension::k2dArray:
                    return (*this)(source, "texture_storage_2d_array", utils::ToString(format), utils::ToString(access));
                case type::TextureDimension::k3d:
                    return (*this)(source, "texture_storage_3d", utils::ToString(format), utils::ToString(access));
                default:
                    break;
            }
            TINT_ICE(ProgramBuilder, builder->Diagnostics())
