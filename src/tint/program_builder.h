...
class ProgramBuilder {
  ...
  public:
    ...
    //    /// @return an unsuffixed IntLiteralExpression for the given value
    //    const ast::IntLiteralExpression* Expr(const Source& source, int value) {
    ...
    //    /// @param value the integer value
    //    /// @return an unsuffixed IntLiteralExpression for the given value
    //    const ast::IntLiteralExpression* Expr(int value) {
    //        return create<ast::IntLiteralExpression>(value,
    //        ast::IntLiteralExpression::Suffix::kNone);
    //    }
