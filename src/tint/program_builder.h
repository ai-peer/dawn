...
class ProgramBuilder {
    ...
    struct VarOptions {
      ...
      private:
        void Set(ProgramBuilder& b, ast::Type t) { type = t; }
        ...
        void Set(ProgramBuilder& b, const ast::Expression* c) { initializer = c; }
        void Set(ProgramBuilder& b, utils::VectorRef<const ast::Attribute*> l) {
            attributes = std::move(l);
        }
        void Set(ProgramBuilder& b, const ast::Attribute* a) { attributes.Push(a); }
    };
