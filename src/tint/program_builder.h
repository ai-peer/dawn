...
class ProgramBuilder {
  ...
  public:
    ...
    const ast::ElseStatement* Else(CONDITION&& condition, const ast::BlockStatement* body) {
        return create<ast::ElseStatement>(Expr(std::forward<CONDITION>(condition)), body);
    }
    ...
    const ast::IfStatement* If(const Source& source,
        ...
        return create<ast::IfStatement>(
            ...
            ast::ElseStatementList{std::forward<ELSE_STATEMENTS>(elseStatements)...});
    }
