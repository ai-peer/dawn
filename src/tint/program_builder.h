...
class ProgramBuilder {
    ...
    struct VarOptions {
      ...
      private:
        void Set(ProgramBuilder& b, const ast::Identifier* ident) { type = b.ty(ident); }
...
struct ProgramBuilder::TypesBuilder::CToAST<AInt> {
    static ast::Type get(const ProgramBuilder::TypesBuilder*) { return {}; }
};
template <>
