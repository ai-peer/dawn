...
namespace dawn_platform {
    ...
    class DAWN_PLATFORM_EXPORT CachingInterface {
      public:
        ...
        virtual size_t LoadData(void* device,
                                const void* key,
                                size_t keySize,
                                void* valueOut,
                                size_t valueSize) = 0;
        ...
        virtual void StoreData(void* device,
                               const void* key,
                               size_t keySize,
                               const void* value,
                               size_t valueSize) = 0;
    ...
    class DAWN_PLATFORM_EXPORT Platform {
      public:
        ...
        // The returned CachingInterface is expected to outlive the device which uses it to
        // persistently cache objects.
