...
namespace dawn_native { namespace vulkan {
    ...
    struct ExternalImageDescriptorOpaqueFD {
        ...
        int memoryHandle;             // A file descriptor from an export of the memory of the image
    ...
    // Exports a signal semaphore from a wrapped texture. This must be called on wrapped textures
