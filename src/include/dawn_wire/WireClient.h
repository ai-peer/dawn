          ...
          public:
            ...
            class DAWN_WIRE_EXPORT ReadHandle {
              public:
                ...
                // Update map data to user pointer. This function takes in the serialized result of
                // server::MemoryTransferService::ReadHandle::SerializeInitialData.
                // This function should write to |data| the pointer.
                // It must live at least until the ReadHandle is destructed.
