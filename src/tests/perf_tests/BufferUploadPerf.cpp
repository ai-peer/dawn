...
INSTANTIATE_TEST_SUITE_P(
    ,
    BufferUploadPerf,
    ::testing::Combine(FILTER_BACKENDS(D3D12Backend, MetalBackend, OpenGLBackend, VulkanBackend),
                       ::testing::Values(UploadMethod::SetSubData,
                                         UploadMethod::CreateBufferMapped)),
    PrintParams);
