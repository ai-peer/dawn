...
// difficult. It uses a 2D array texture with mipmaps and updates one of the layer with data from
...
class SubresourceTrackingPerf : public DawnPerfTestWithParams<SubresourceTrackingParams> {
  public:
    ...
    void SetUp() override {
        ...
        materialDesc.size = {1u << params.mipLevelCount, 1u << params.mipLevelCount,
  ...
  private:
    void Step() override {
        ...
        // Copy into the layer of the material array.
        {
            ...
            wgpu::Extent3D copySize = {1u << params.mipLevelCount, 1u << params.mipLevelCount, 1};
