...
DawnPerfTestBase::DawnPerfTestBase(const DawnTestParam& param, unsigned int iterationsPerStep)
    : DawnTestBase(param), mIterationsPerStep(iterationsPerStep), mTimer(utils::CreateTimer()) {
}
...
void DawnPerfTestBase::WaitForGPU() {
    ...
    dawn::Fence fence = queue.CreateFence(&desc);
...
void DawnPerfTestBase::StartTest() {
}

void DawnPerfTestBase::FinishTest() {
}
