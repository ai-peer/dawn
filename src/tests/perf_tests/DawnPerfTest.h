...
class DawnPerfTestBase : public DawnTestBase {
  ...
  public:
    DawnPerfTestBase(const DawnTestParam& param, unsigned int iterationsPerStep);
...
class DawnPerfTestWithParams : public DawnPerfTestBase, public ::testing::TestWithParam<Params> {
  protected:
    DawnPerfTestWithParams(unsigned int iterationsPerStep);

    virtual void SetUp() override {
        DawnPerfTestBase::SetUp();
    }

    virtual void TearDown() override {
        DawnPerfTestBase::TearDown();
    }
};

template <typename Params>
DawnPerfTestWithParams<Params>::DawnPerfTestWithParams(unsigned int iterationsPerStep)
    : DawnPerfTestBase(std::get<DawnTestParam>(this->GetParam()), iterationsPerStep) {
}

template <>
inline DawnPerfTestWithParams<DawnTestParam>::DawnPerfTestWithParams(unsigned int iterationsPerStep)
    : DawnPerfTestBase(this->GetParam(), iterationsPerStep) {
}
