...
namespace {
    ...
    constexpr TraceCategoryInfo gTraceCategories[4] = {
        ...
        {1, dawn_platform::TraceCategory::GPU},
    };
    ...
    static_assert(static_cast<uint32_t>(dawn_platform::TraceCategory::GPU) == 3, "");
...
const unsigned char* DawnPerfTestPlatform::GetTraceCategoryEnabledFlag(
    ...
    switch (category) {
        ...
        case dawn_platform::TraceCategory::GPU:
            break;
        default:
            UNREACHABLE();
    }
...
void DawnPerfTestPlatform::ResetTraceEventBuffer() {
