...
#define DAWN_TEST_PARAM_STRUCT_PRINT_STRUCT_FIELD(Type) o << "__" << #Type << "_" << param.m_##Type;
...
#define DAWN_TEST_PARAM_STRUCT(StructName, ...)                                            \
    ...
    std::ostream& operator<<(std::ostream& o, const __Base##StructName& param) {           \
    ...
    std::ostream& operator<<(std::ostream& o, const StructName& param) {                   \
        ...
        o << "_" << static_cast<const __Base##StructName&>(param);                         \
        return o;                                                                          \
    }
