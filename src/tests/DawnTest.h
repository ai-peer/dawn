...
class DawnTestBase {
  ...
  protected:
    ...
    std::ostringstream& ExpectAttachmentDepthStencilData(wgpu::Texture texture,
    ...
    std::ostringstream& ExpectAttachmentDepthData(wgpu::Texture texture,
                                                  wgpu::TextureFormat format,
                                                  uint32_t width,
                                                  uint32_t height,
                                                  uint32_t arrayLayer,
                                                  uint32_t mipLevel,
                                                  std::vector<float> expectedDepth) {
        return ExpectAttachmentDepthStencilData(texture, format, width, height, arrayLayer,
                                                mipLevel, std::move(expectedDepth), nullptr);
    }

    std::ostringstream& ExpectAttachmentStencilData(wgpu::Texture texture,
                                                    wgpu::TextureFormat format,
                                                    uint32_t width,
                                                    uint32_t height,
                                                    uint32_t arrayLayer,
