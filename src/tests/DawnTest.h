...
struct DawnTestParamInit {
    DawnTestParamInit(wgpu::BackendType backendType,
...
struct DawnTestParam : DawnTestParamInit {
    DawnTestParam(const DawnTestParamInit& init, dawn_native::Adapter adapter);
...
void InitDawnTestInstance(int argc, char** argv);
...
class DawnTestEnvironment : public testing::Environment {
  public:
    ...
    const std::vector<dawn_native::Adapter>& GetAdapters() const;
  ...
  private:
    ...
    std::vector<dawn_native::Adapter> mAdapters;
};
