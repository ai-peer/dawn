...
struct AdapterTestParam : BackendTestConfig {
    AdapterTestParam(const BackendTestConfig& config, size_t adapterIndex);
...
class DawnTestEnvironment : public testing::Environment {
  public:
    ...
    const std::vector<wgpu::AdapterProperties>& GetAdapterProperties() const;
  ...
  private:
    ...
    std::vector<wgpu::AdapterProperties> mAdapterProperties;
