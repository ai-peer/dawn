...
TEST_P(NonzeroTextureCreationTests, TextureCreationClears) {
    wgpu::Texture texture =
        utils::Create2DTexture(device, kSize, kSize, wgpu::TextureFormat::RGBA8Unorm,
...
TEST_P(NonzeroTextureCreationTests, Depth32TextureCreationDepthClears) {
    ...
    wgpu::Texture texture =
        utils::Create2DTexture(device, kSize, kSize, wgpu::TextureFormat::Depth32Float,
                               wgpu::TextureUsage::OutputAttachment | wgpu::TextureUsage::CopySrc);
...
TEST_P(NonzeroTextureCreationTests, MipMapClears) {
    ...
    wgpu::Texture texture = utils::Create2DTexture(
        ...
        wgpu::TextureUsage::OutputAttachment | wgpu::TextureUsage::CopySrc, mipLevels);
...
TEST_P(NonzeroTextureCreationTests, ArrayLayerClears) {
    ...
    wgpu::Texture texture = utils::Create2DArrayTexture(
        device, kSize, kSize, wgpu::TextureFormat::RGBA8Unorm,
        wgpu::TextureUsage::OutputAttachment | wgpu::TextureUsage::CopySrc, arrayLayers, 1);
...
TEST_P(NonzeroTextureCreationTests, NonRenderableTextureClearWithMultiArrayLayers) {
    ...
    wgpu::Texture texture =
        utils::Create2DArrayTexture(device, kSize, kSize, wgpu::TextureFormat::RGBA8Snorm,
                                    wgpu::TextureUsage::CopySrc, kArrayLayerCount, 1);
