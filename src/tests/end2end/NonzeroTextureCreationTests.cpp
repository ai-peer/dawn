...
DAWN_INSTANTIATE_TEST(NonzeroTextureCreationTests,
                      ForceWorkaround(D3D12Backend, "nonzero_clear_resources_and_no_lazy_clear"),
                      ForceWorkaround(OpenGLBackend, "nonzero_clear_resources_and_no_lazy_clear"),
                      ForceWorkaround(VulkanBackend, "nonzero_clear_resources_and_no_lazy_clear"));
