...
class D3D12MemoryAllocationStressTests : public DawnTest {};
...
TEST_P(D3D12MemoryAllocationStressTests, LargeBuffer) {
...
DAWN_INSTANTIATE_TEST(D3D12MemoryAllocationStressTests, D3D12Backend());
