    ...
    void DoTest(const TextureSpec& textureSpec,
        ...
        const utils::TextureDataCopyLayout copyLayout =
            utils::GetTextureDataCopyLayoutForTexture2DAtLevel(
                kTextureFormat, textureSpec.textureSize, textureSpec.level, dataSpec.rowsPerImage);
        ...
        for (uint32_t slice = textureSpec.copyOrigin.z; slice < maxArrayLayer; ++slice) {
            ...
            dataOffset += copyLayout.bytesPerImage;
        }
    }
};
...
// Test that writing to whole texture 2D array layers.
...
// Test that writing a range of texture 2D array layers.
...
// Test that writing into a range of texture 2D array layers
