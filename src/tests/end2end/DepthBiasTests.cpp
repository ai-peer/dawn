...
TEST_P(DepthBiasTests, PositiveBiasOn24bit) {
    ...
    EXPECT_2D_TEXTURE_RGBA8_EQ(expected.data(), mRenderTarget, 0, 0, kRTSize, kRTSize, 0, 0);
}
...
TEST_P(DepthBiasTests, PositiveBiasOn24bitWithClamp) {
    ...
    EXPECT_2D_TEXTURE_RGBA8_EQ(zero.data(), mRenderTarget, 0, 0, kRTSize, kRTSize, 0, 0);
}
