...
class DepthBiasTests : public DawnTest {
  protected:
    ...
    void RunDepthBiasTest(wgpu::TextureFormat depthFormat,
        ...
        switch (quadAngle) {
            case QuadAngle::Flat:
                // Draw a square in the bottom left quarter of the screen at z = 0.25
                mVertexModule =
...
TEST_P(DepthBiasTests, PositiveBiasOnFloat) {
    ...
    // Draw quad in bottom left flat on z = 0.25 with 0.25 bias
...
TEST_P(DepthBiasTests, PositiveBiasOnFloatWithClamp) {
    // TODO(enrico.galli@intel.com): Remove when SwiftShader supports clamping and scale is fixed.
    DAWN_SKIP_TEST_IF(IsVulkan() && IsSwiftshader());

    // Draw quad in bottom left flat on z = 0.25 with 0.25 bias clamped at 0.125.
    RunDepthBiasTest(wgpu::TextureFormat::Depth32Float, 0, QuadAngle::Flat,
...
TEST_P(DepthBiasTests, PositiveSlopeBiasOnFloat) {
    // Draw quad in bottom left with z from 0 to 0.5 with a slop bias of 1
...
TEST_P(DepthBiasTests, PositiveBiasOn24bit) {
    ...
    std::vector<RGBA8> expected = {
        ...
        RGBA8::kZero, RGBA8::kZero, RGBA8::kZero, RGBA8::kZero,  //
        RGBA8::kRed,  RGBA8::kRed,  RGBA8::kZero, RGBA8::kZero,  //
        RGBA8::kRed,  RGBA8::kRed,  RGBA8::kZero, RGBA8::kZero,  //
    };
...
TEST_P(DepthBiasTests, PositiveBiasOn24bitWithClamp) {
    // TODO(enrico.galli@intel.com): Remove when SwiftShader supports clamping.
    DAWN_SKIP_TEST_IF(IsVulkan() && IsSwiftshader());
...
TEST_P(DepthBiasTests, PositiveSlopeBiasOn24bit) {
    ...
    // Only half of the bottom left quad has colors.
    std::vector<RGBA8> expected = {
        RGBA8::kZero, RGBA8::kZero, RGBA8::kZero, RGBA8::kZero,  //
        RGBA8::kZero, RGBA8::kZero, RGBA8::kZero, RGBA8::kZero,  //
        RGBA8::kRed,  RGBA8::kRed,  RGBA8::kZero, RGBA8::kZero,  //
