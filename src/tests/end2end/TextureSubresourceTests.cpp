...
TEST_P(TextureSubresourceTest, MipmapLevelsTest) {
    ...
    std::vector<RGBA8> topRight = {RGBA8::kBlack};
    std::vector<RGBA8> bottomLeft = {RGBA8::kRed};
    EXPECT_TEXTURE_RGBA8_EQ(topRight.data(), texture, kSize / 2 - 1, 0, 1, 1, 1, 0);
    EXPECT_TEXTURE_RGBA8_EQ(bottomLeft.data(), texture, 0, kSize / 2 - 1, 1, 1, 1, 0);
}
...
TEST_P(TextureSubresourceTest, ArrayLayersTest) {
    ...
    std::vector<RGBA8> topRight = {RGBA8::kBlack};
    std::vector<RGBA8> bottomLeft = {RGBA8::kRed};
    EXPECT_TEXTURE_RGBA8_EQ(topRight.data(), texture, kSize - 1, 0, 1, 1, 0, 1);
    EXPECT_TEXTURE_RGBA8_EQ(bottomLeft.data(), texture, 0, kSize - 1, 1, 1, 0, 1);
}
