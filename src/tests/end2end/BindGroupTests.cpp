...
TEST_P(BindGroupTests, ReusedBindGroupSingleSubmit) {
    ...
    bufferDesc.usage = dawn::BufferUsageBit::CopyDst |
...
TEST_P(BindGroupTests, UBOSamplerAndTexture) {
    ...
    dawn::Buffer stagingBuffer = utils::CreateBufferFromData(device, data.data(), sizeInBytes, dawn::BufferUsageBit::CopySrc);
