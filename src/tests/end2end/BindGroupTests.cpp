...
// the bug, the destructor of BindGroupBase, when destroying member Ref<BindGroupLayoutBase> assigns
// to Ref::mPointee, AFTER calling Release(). After the BGL is destroyed, the storage for |mPointee|
// has been freed.
