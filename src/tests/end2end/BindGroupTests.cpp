...
TEST_P(BindGroupTests, ArbitraryBindingNumbers) {
    ...
    wgpu::Buffer red =
        utils::CreateBufferFromData(device, wgpu::BufferUsage::Uniform, {0.25f, 0.0f, 0.0f, 0.0f});
    wgpu::Buffer green =
        utils::CreateBufferFromData(device, wgpu::BufferUsage::Uniform, {0.0f, 0.25f, 0.0f, 0.0f});
    wgpu::Buffer blue =
        utils::CreateBufferFromData(device, wgpu::BufferUsage::Uniform, {0.0f, 0.0f, 0.25f, 0.0f});
    ...
    DoTest(green, blue, black, RGBA8(0, 64, 127, 0));
    DoTest(blue, green, black, RGBA8(0, 127, 64, 0));
    DoTest(red, green, black, RGBA8(64, 127, 0, 0));
    ...
    DoTest(black, blue, red, RGBA8(255, 0, 127, 0));
