...
TEST_P(IndexFormatTest, Uint32PrimitiveRestartTriangleStrip) {
    wgpu::RenderPipeline pipeline = MakeTestPipeline(wgpu::IndexFormat::Uint32);
...
TEST_P(IndexFormatTest, Uint16PrimitiveRestartTriangleStrip) {
    wgpu::RenderPipeline pipeline = MakeTestPipeline(wgpu::IndexFormat::Uint16);
...
//      |              |
//      |--------------|
TEST_P(IndexFormatTest, Uint32PrimitiveRestartLineStrip) {
    ...
    EXPECT_PIXEL_RGBA8_EQ(RGBA8::kZero, renderPass.color, 300, 190);   // A
}

TEST_P(IndexFormatTest, Uint16PrimitiveRestartLineStrip) {
    wgpu::RenderPipeline pipeline =
