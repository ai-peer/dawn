...
// Test that a valid chained descriptor (and that GLFWUtils creates a valid chained descriptor).
...
TEST_F(WindowSurfaceInstanceTests, XlibSurfacesAreInvalid) {
    wgpu::SurfaceDescriptorFromXlib chainedDescriptor;
    chainedDescriptor.display = nullptr chainedDescriptor.window = 0;
