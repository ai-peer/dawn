...
// Test that calling writeBuffer to overwrite the entire buffer doesn't need to lazily initalize the
// destination buffer.
...
// Test that calling writeBuffer to overwrite a part of buffer needs to lazily initalize the
// destination buffer.
