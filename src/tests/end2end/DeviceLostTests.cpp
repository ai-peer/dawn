...
TEST_P(DeviceLostTest, BufferMapWriteAsyncFails) {
    ...
    SetCallbackAndLoseForTesting();
    ASSERT_DEVICE_ERROR(buffer.MapWriteAsync(CheckMapWriteFail, userData));
}
...
TEST_P(DeviceLostTest, BufferMapWriteAsyncBeforeLossFails) {
    ...
    buffer.MapWriteAsync(CheckMapWriteFail, userData);
    SetCallbackAndLoseForTesting();
}
...
TEST_P(DeviceLostTest, BufferMapReadAsyncFails) {
    ...
    SetCallbackAndLoseForTesting();
    ASSERT_DEVICE_ERROR(buffer.MapReadAsync(CheckMapReadFail, userData));
}
...
TEST_P(DeviceLostTest, BufferMapReadAsyncBeforeLossFails) {
    ...
    buffer.MapReadAsync(CheckMapReadFail, userData);
    SetCallbackAndLoseForTesting();
}
