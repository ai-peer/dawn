...
TEST_P(DeviceLostTest, BufferMapWriteAsyncFails) {
    ...
    SetCallbackAndLoseForTesting();
    ASSERT_DEVICE_ERROR(buffer.MapWriteAsync(CheckMapWriteFail, (void*)&fakeUserData));
}
...
TEST_P(DeviceLostTest, BufferMapWriteAsyncBeforeLossFails) {
    ...
    buffer.MapWriteAsync(CheckMapWriteFail, (void*)&fakeUserData);
    SetCallbackAndLoseForTesting();
}
...
TEST_P(DeviceLostTest, BufferMapReadAsyncFails) {
    ...
    SetCallbackAndLoseForTesting();
    ASSERT_DEVICE_ERROR(buffer.MapReadAsync(CheckMapReadFail, (void*)&fakeUserData));
}
...
TEST_P(DeviceLostTest, BufferMapReadAsyncBeforeLossFails) {
    ...
    buffer.MapReadAsync(CheckMapReadFail, (void*)&fakeUserData);
    SetCallbackAndLoseForTesting();
}
