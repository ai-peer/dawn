...
// Test that BufferMapAyysync for writing calls back with device lost status when device lost after
// mapping
...
// Test that BufferMapAyysync for reading calls back with device lost status when device lost after
// mapping
