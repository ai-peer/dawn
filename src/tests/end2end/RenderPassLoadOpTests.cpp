...
TEST_P(RenderPassLoadOpTests, ColorClearThenLoadAndDraw) {
    ...
    EXPECT_TEXTURE_RGBA8_EQ(expectZero.data(), renderTarget, {0, 0}, {kRTSize, kRTSize});

    queue.Submit(1, &commandsClearGreen);
    EXPECT_TEXTURE_RGBA8_EQ(expectGreen.data(), renderTarget, {0, 0}, {kRTSize, kRTSize});
    ...
    EXPECT_TEXTURE_RGBA8_EQ(expectGreen.data(), renderTarget, {0, 0}, {kRTSize / 2, kRTSize});
