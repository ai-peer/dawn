...
class RenderPassDepthStencilLoadOpTests
  ...
  protected:
    static const uint32_t kMipLevelCount = 2u;
    static const std::array<float, kMipLevelCount> kDepthValues = {0.2f, 0.8f};
    static const std::array<uint8_t, kMipLevelCount> kStencilValues = {7u, 3u};
