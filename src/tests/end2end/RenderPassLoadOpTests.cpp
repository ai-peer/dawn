...
TEST_P(RenderPassLoadOpTests, LoadOpClearLargeIntegerValueRounding) {
    // RGBA32Uint
    {
        constexpr wgpu::Color kClearColor = {4094966911.0, 3555555555.0, 2555555555.0,
                                             1555555555.0};
        constexpr std::array<uint32_t, 4> kExpectedPixelValue = {4094966784, 3555555584, 2555555584,
                                                                 1555555584};
        TestIntegerClearColor<uint32_t>(wgpu::TextureFormat::RGBA32Uint, kClearColor,
                                        kExpectedPixelValue);
    }
...
TEST_P(RenderPassLoadOpTests, LoadOpClearLargeIntegerValueRounding2) {
    // RGBA32Uint
    {
        constexpr wgpu::Color kClearColor = {3994966911.0f, 3555555555.0, 2555555555.0,
                                             1555555555.0};
        constexpr std::array<uint32_t, 4> kExpectedPixelValue = {3994966784.0, 3555555584,
...
TEST_P(RenderPassLoadOpTests, LoadOpClearLargeIntegerValueRounding3) {
    // RGBA32Uint
    {
        constexpr wgpu::Color kClearColor = {3894966911.0, 3555555555.0, 2555555555.0,
                                             1555555555.0};
        constexpr std::array<uint32_t, 4> kExpectedPixelValue = {3894966784.0f, 3555555584,
                                                                 2555555584, 1555555584};
        TestIntegerClearColor<uint32_t>(wgpu::TextureFormat::RGBA32Uint, kClearColor,
                                        kExpectedPixelValue);
    }
