...
TEST_P(RenderPassLoadOpTests, LoadOpClearLargeIntegerValueRounding) {
    // RGBA32Uint
    {
        constexpr wgpu::Color kClearColor = {2147483447.0, 1999999999.0, 1555555555.0, 999999999.0};
        constexpr std::array<uint32_t, 4> kExpectedPixelValue = {2147483392, 2000000000, 1555555584,
                                                                 1000000000};
        TestIntegerClearColor<uint32_t>(wgpu::TextureFormat::RGBA32Uint, kClearColor,
                                        kExpectedPixelValue);
    }
