...
TEST_P(RenderPassLoadOpTests, ColorClearThenLoadAndDraw) {
    ...
    EXPECT_TEXTURE_RGBA8_EQ(expectZero.data(), renderTarget, (0, 0, 0), (kRTSize, kRTSize), 0);

    queue.Submit(1, &commandsClearGreen);
    EXPECT_TEXTURE_RGBA8_EQ(expectGreen.data(), renderTarget, (0, 0, 0), (kRTSize, kRTSize), 0);
    ...
    EXPECT_TEXTURE_RGBA8_EQ(expectGreen.data(), renderTarget, (0, 0, 0), (kRTSize / 2, kRTSize), 0);
    // Right half should now be blue
    EXPECT_TEXTURE_RGBA8_EQ(expectBlue.data(), renderTarget, (kRTSize / 2, 0, 0),
                            (kRTSize / 2, kRTSize), 0);
}
