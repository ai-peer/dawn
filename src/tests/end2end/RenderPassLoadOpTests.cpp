...
TEST_P(RenderPassLoadOpTests, LoadOpClearLargeIntegerValueRounding) {
    // RGBA32Uint
    {
        constexpr wgpu::Color kClearColor = {4294967095.0, 3555555555.0, 2555555555.0,
                                             1555555555.0};
        constexpr std::array<uint32_t, 4> kExpectedPixelValue = {4294967040, 3555555584, 2555555584,
                                                                 1555555584};
        TestIntegerClearColor<uint32_t>(wgpu::TextureFormat::RGBA32Uint, kClearColor,
                                        kExpectedPixelValue);
    }
    ...
    // RGBA32Sint
    {
        constexpr wgpu::Color kClearColor = {2147483447.0, -2147483447.0, 1000000555.0f,
                                             -1000000555.0f};
