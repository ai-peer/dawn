...
TEST_P(RenderPassLoadOpTests, LoadOpClearLargeIntegerValueRounding) {
    // RGBA32Uint
    {
        constexpr wgpu::Color kClearColor = {4294966911.0, 3555555555.0, 2555555555.0,
                                             1555555555.0};
        constexpr std::array<uint32_t, 4> kExpectedPixelValue = {4294966784, 3555555584, 2555555584,
                                                                 1555555584};
        TestIntegerClearColor<uint32_t>(wgpu::TextureFormat::RGBA32Uint, kClearColor,
                                        kExpectedPixelValue);
    }
