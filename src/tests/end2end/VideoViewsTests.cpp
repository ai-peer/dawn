...
void VideoViewsTestBackend::OnSetUp(WGPUDevice device) {
}
void VideoViewsTestBackend::OnTearDown() {
}
bool VideoViewsTestBackend::IsSupported() {
    return false;
}
bool VideoViewsTestBackend::CreateVideoTextureForTest(
...
void VideoViewsTestBackend::DestroyVideoTextureForTest(
    VideoViewsTestBackend::PlatformTexture& PlatformTexture) {
}
...
bool VideoViewsTests::CreateVideoTextureForTest(
    wgpu::TextureFormat format,
    wgpu::TextureUsage usage,
    bool isCheckerboard,
    VideoViewsTestBackend::PlatformTexture* platformTextureOut) {
    return mBackend->CreateVideoTextureForTest(format, usage, isCheckerboard, platformTextureOut);
}
void VideoViewsTests::DestroyVideoTextureForTest(
    VideoViewsTestBackend::PlatformTexture& PlatformTexture) {
    mBackend->DestroyVideoTextureForTest(PlatformTexture);
}
...
TEST_P(VideoViewsTests, NV12SampleYtoR) {
    VideoViewsTestBackend::PlatformTexture platformTexture = {};
    bool ok = CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
                                        wgpu::TextureUsage::TextureBinding,
                                        /*isCheckerboard*/ false, &platformTexture);
    ASSERT(ok);
    ASSERT_NE(platformTexture.wgpuTexture.Get(), nullptr);
    ...
    DestroyVideoTextureForTest(platformTexture);
}
...
TEST_P(VideoViewsTests, NV12SampleYUVtoRGB) {
    ...
    bool ok = CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
                                        wgpu::TextureUsage::TextureBinding,
                                        /*isCheckerboard*/ true, &platformTexture);
    ASSERT(ok);
    ASSERT_NE(platformTexture.wgpuTexture.Get(), nullptr);
