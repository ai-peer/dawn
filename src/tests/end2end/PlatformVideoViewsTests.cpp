    ...
    class PlatformVideoViewsTests : public VideoViewsTests {
      protected:
        ...
        void* CreateVideoTextureForTest(wgpu::TextureFormat format,
                                        wgpu::TextureUsage usage,
                                        bool isCheckerboard,
                                        wgpu::Texture* dawnTextureOut) override {
    ...
    class PlatformVideoViewsTests : public VideoViewsTests {
      protected:
        void SetUp() override {
            ...
            DAWN_TEST_UNSUPPORTED_IF(Nv12GbmBoAreDisjoint());
        }
        void TearDown() override {
            if (UsesWire())
                return;
...
TEST_P(PlatformVideoViewsTests, NV12SampleYtoR) {
    ...
    void* platformTexture = CreateVideoTextureForTest(wgpu::TextureFormat::R8BG8Biplanar420Unorm,
