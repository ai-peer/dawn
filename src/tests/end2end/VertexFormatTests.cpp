...
template <typename T>
std::vector<float> NormalizeHelper(std::vector<T> data) {
...
TEST_P(VertexFormatTest, UChar2Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::UChar2Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, UChar4Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::UChar4Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, Char2Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::Char2Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, Char4Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::Char4Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, UShort2Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::UShort2Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, UShort4Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::UShort4Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, Short2Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::Short2Norm, vertexData, NormalizeHelper(vertexData));
}
...
TEST_P(VertexFormatTest, Short4Norm) {
    ...
    DoVertexFormatTest(dawn::VertexFormat::Short4Norm, vertexData, NormalizeHelper(vertexData));
}
