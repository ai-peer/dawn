  ...
  protected:
    ...
    dawn::RenderPipeline MakeTestPipeline(dawn::VertexFormat format, std::vector<T>& expectedData) {
        ...
        if (!isNormalized &&
            ...
            if (componentCount > 1) {
                for (uint32_t component = 0; component < componentCount; ++component) {
                    vs << " && abs(test[" << component << "] - expected[gl_VertexIndex]["
                       << component << "]) < threshold ";
                }
            } else {
...
TEST_P(VertexFormatTest, Half2) {
    ...
    std::vector<float> expectedData = {
        float16ToFloat32(vertexData[0]), float16ToFloat32(vertexData[1]),
        float16ToFloat32(vertexData[2]), float16ToFloat32(vertexData[3]),
        float16ToFloat32(vertexData[4]), float16ToFloat32(vertexData[5])};
...
TEST_P(VertexFormatTest, Half4) {
    ...
    std::vector<float> expectedData = {
        ...
        float16ToFloat32(vertexData[2]),  float16ToFloat32(vertexData[3]),
        float16ToFloat32(vertexData[4]),  float16ToFloat32(vertexData[5]),
        float16ToFloat32(vertexData[6]),  float16ToFloat32(vertexData[7]),
        float16ToFloat32(vertexData[8]),  float16ToFloat32(vertexData[9]),
        float16ToFloat32(vertexData[10]), float16ToFloat32(vertexData[11])};
