      ...
      protected:
        ...
        void CreateVideoTextureForTest(wgpu::TextureFormat format,
            ...
            std::unique_ptr<dawn_native::d3d12::ExternalImageDXGI> externalImage =
                dawn_native::d3d12::CreateExternalImage(device.Get(), &externalImageDesc);

            // Handle is no longer needed once resources are created.
            ::CloseHandle(sharedHandle);

            dawn_native::d3d12::ExternalImageAccessDescriptor externalAccessDesc;
            externalAccessDesc.cTextureDescriptor =
