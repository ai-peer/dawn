...
namespace {
    class D3D12VideoViewsTestBase : public DawnTest {
      public:
        ...
        // Returns a pre-prepared multi-plane texture data.
        static std::vector<uint8_t> GetMultiPlaneFormatTextureData(wgpu::TextureFormat format) {
            switch (format) {
                // The encoded texture data represents a 4x4 YUV 4:2:0 solid grey image.
                case wgpu::TextureFormat::R8BG82plane420Unorm:
                    return {
                        126, 126, 126, 126, 126, 126, 126, 126, 126, 126, 126, 126,
                        126, 126, 126, 126, 128, 128, 128, 128, 128, 128, 128, 128,
                    };
                default:
                    UNREACHABLE();
                    return {};
        ...
        void CreateVideoTextureForTest(wgpu::TextureFormat format,
            ...
            d3dDescriptor.Format = dawn_native::d3d12::D3D12TextureFormat(format);
            ...
            std::vector<uint8_t> initialData = GetMultiPlaneFormatTextureData(format);
            ...
            *wgpuTextureOut = wgpu::Texture::Acquire(
            ...
            ASSERT_NE(wgpuTextureOut->Get(), nullptr);
