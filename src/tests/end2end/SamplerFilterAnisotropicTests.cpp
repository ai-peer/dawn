...
namespace {
    ...
    const RGBA8 colors[] = {RGBA8::kRed, RGBA8::kGreen, RGBA8::kBlue};
}  // namespace
...
class SamplerFilterAnisotropicTest : public DawnTest {
  protected:
    ...
    void InitTexture() {
        const uint32_t mipLevelCount = sizeof(colors) / sizeof(RGBA8);
    ...
    void TestFilterAnisotropic(const uint16_t maxAnisotropy) {
        ...
        // Tweaking happens at: https://jsfiddle.net/t64kpu81/85/
        // You can get an idea of what the test looks like at the url rendered by webgl
        float transform[] = {-1.7320507764816284,
        ...
        // https://jsfiddle.net/t64kpu81/85/
        ...
        // We will check pixel values at (8, 4) and (8, 7)
...
TEST_P(SamplerFilterAnisotropicTest, SlantedPlaneMipmap) {
    const uint16_t maxAnisotropyLists[] = {1, 2, 16};
