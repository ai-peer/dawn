  ...
  protected:
    ...
    void DoSingleTest(Type type,
        ...
        switch (type) {
            ...
            case Type::Stencil: {
                EXPECT_TEXTURE_STENCIL8_EQ(expectedStencil, renderTarget, format, textureSize,
                                           textureSize, 0, 0, renderTargetSize, renderTargetSize,
...
TEST_P(SubresourceOutputAttachmentTest, StencilTexture) {
    DoTest(Type::Stencil);
}
