...
class CreateBufferMappedTests : public DawnTest {
    protected:
      ...
      void CheckResult(const dawn::CreateBufferMappedResult& result, uint64_t size) {
      ...
      dawn::CreateBufferMappedResult CreateBufferMappedWithData(dawn::BufferUsageBit usage,
                                                                uint32_t data) {
          std::vector<uint32_t> vec{data};
          return CreateBufferMappedWithData(usage, vec);
      }
      ...
      dawn::CreateBufferMappedResult CreateBufferMappedAsyncAndWait(dawn::BufferUsageBit usage,
          ...
          CheckResult(resultInfo.result, size);
      ...
      dawn::CreateBufferMappedResult CreateBufferMappedAsyncWithDataAndWait(
          ...
          uint32_t data) {
          std::vector<uint32_t> vec{data};
          return CreateBufferMappedAsyncWithDataAndWait(usage, vec);
      }
