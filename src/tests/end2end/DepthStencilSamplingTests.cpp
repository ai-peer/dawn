...
TEST_P(DepthStencilSamplingTest, MyTest) {
    ...
    wgpu::ShaderModule module = utils::CreateShaderModule(device, R"(
        ...
        [[stage(vertex)]] fn vs([[builtin(vertex_index)]] index : u32) -> [[builtin(position)]] vec4<f32> {
            return vec4<f32>(
        ...
        [[stage(fragment)]] fn fs1() -> [[location(0)]] f32 {
            return -42.0;
        }
        ...
        [[stage(fragment)]] fn fs2([[builtin(position)]] pos : vec4<f32>) -> [[location(0)]] f32 {
