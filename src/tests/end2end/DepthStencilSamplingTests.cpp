...
TEST_P(DepthStencilSamplingTest, SampleExtraComponents) {
    ...
    // TODO(crbug.com/dawn/1239): depth24unorm-stencil8 fails on Windows Nvidia old driver version.
    DAWN_SUPPRESS_TEST_IF(format == wgpu::TextureFormat::Depth24UnormStencil8 && IsWindows() &&
                          IsNvidia());
