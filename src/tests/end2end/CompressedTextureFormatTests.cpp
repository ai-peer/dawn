...
class CompressedTextureBCFormatTest : public DawnTest {
  protected:
    ...
    dawn_native::Extensions GetRequiredExtensions() override {
        dawn_native::Extensions requiredExtensions;
        requiredExtensions.textureCompressionBC = true;
        mIsBCFormatSupported = SupportAllRequiredExtensions(requiredExtensions);

        requiredExtensions.textureCompressionBC = mIsBCFormatSupported;
