...
class CompressedTextureFormatTest : public DawnTestWithParams<CompressedTextureFormatTestParams> {
  protected:
    ...
    std::vector<uint8_t> GetOneBlockFormatTextureData() {
        switch (GetParam().mTextureFormat) {
            ...
            case wgpu::TextureFormat::ASTC4x4UnormSrgb:
                return {0x13, 0x80, 0x9d, 0x1, 0x0, 0x9c, 0x1,  0x0,
                        0x10, 0xff, 0x1,  0x0, 0x0, 0x3f, 0xf0, 0x3};
            case wgpu::TextureFormat::ASTC5x4Unorm:
            case wgpu::TextureFormat::ASTC5x4UnormSrgb:
            case wgpu::TextureFormat::ASTC5x5Unorm:
            case wgpu::TextureFormat::ASTC5x5UnormSrgb:
                return {0x83, 0x80, 0x9d, 0x1, 0x0,  0x9c, 0x1,  0x0,
                        0x10, 0xff, 0x1,  0x0, 0x80, 0x14, 0x90, 0x2};
            case wgpu::TextureFormat::ASTC6x5Unorm:
            case wgpu::TextureFormat::ASTC6x5UnormSrgb:
            case wgpu::TextureFormat::ASTC6x6Unorm:
            case wgpu::TextureFormat::ASTC6x6UnormSrgb:
                return {0x2,  0x81, 0x9d, 0x1, 0x0, 0x9c, 0x1,  0x0,
                        0x10, 0xff, 0x1,  0x0, 0x0, 0x3f, 0xf0, 0x3};
            ...
            case wgpu::TextureFormat::ASTC8x8UnormSrgb:
                return {0x6,  0x80, 0x9d, 0x1, 0x0,  0x9c, 0x1,  0x0,
                        0x10, 0xff, 0x1,  0x0, 0xff, 0x0,  0xff, 0x0};
            ...
            case wgpu::TextureFormat::ASTC10x10UnormSrgb:
                return {0x6,  0x81, 0x9d, 0x1,  0x0, 0x9c, 0x1,  0x0,
                        0x10, 0xff, 0x1,  0xff, 0x3, 0xf0, 0x3f, 0x0};
            case wgpu::TextureFormat::ASTC12x10Unorm:
            case wgpu::TextureFormat::ASTC12x10UnormSrgb:
            case wgpu::TextureFormat::ASTC12x12Unorm:
            case wgpu::TextureFormat::ASTC12x12UnormSrgb:
                return {0x4,  0x80, 0x9d, 0x1, 0x0, 0x9c, 0x1,  0x0,
                        0x10, 0xff, 0x1,  0x0, 0x0, 0x3f, 0xf0, 0x3};
    ...
    std::vector<RGBA8> GetExpectedData(const wgpu::Extent3D& testRegion) {
        ...
        constexpr RGBA8 kASTCDarkRed(206, 0, 0, kLeftAlpha);
        constexpr RGBA8 kASTCDarkGreen(0, 206, 0, kRightAlpha);
        constexpr RGBA8 kASTCDarkRedSRGB(158, 0, 0, kLeftAlpha);
        constexpr RGBA8 kASTCDarkGreenSRGB(0, 158, 0, kRightAlpha);
