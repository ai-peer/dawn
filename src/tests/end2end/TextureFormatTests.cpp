...
TEST_P(TextureFormatTest, RGBA8UnormSrgb) {
    ...
    DoSampleTest({dawn::TextureFormat::RGBA8UnormSrgb, 4, Float, 4}, textureData, expectedData, 1.0e-3);
}
...
TEST_P(TextureFormatTest, BGRA8UnormSrgb) {
    ...
    DoSampleTest({dawn::TextureFormat::BGRA8UnormSrgb, 4, Float, 4}, textureData, expectedData, 1.0e-3);
}
