...
class ExpectFloat16 : public detail::Expectation {
  public:
    ExpectFloat16(std::vector<uint16_t> expected)
  ...
  protected:
    ...
    void DoSampleTest(FormatTestInfo sampleFormatInfo,
        ...
        if (customExpectation != nullptr) {
            AddBufferExpectation(__FILE__, __LINE__, readbackBuffer, 0, expectedRenderDataSize, customExpectation);
        } else {
    ...
    void DoFloatFormatSamplingTest(FormatTestInfo formatInfo,
        ...
        // For floats use a special expectation that understands how to compare NaNs and support a
        // tolerance.
        DoFormatSamplingTest(formatInfo, textureData, expectedRenderData, new ExpectFloatWithTolerance(expectedRenderData, floatTolerance));
    }
    ...
    void DoSnormTest(FormatTestInfo formatInfo) {
        ...
        // It is not possible to render minValue because -1.0f is the minimum and corresponds to -maxValue (minValue is - maxValue -1)
    ...
    void DoFloat16Test(FormatTestInfo formatInfo) {
        ...
        DoFormatRenderingTest(formatInfo, uncompressedData, textureData, new ExpectFloat16(textureData));
    }
