...
class TextureFormatTest : public DawnTest {
  protected:
    ...
    // The sampling test uploads the sample data in a texture with the sampleFormat.format format
    // then samples from it, checking that the sampled values correspond to expectedRenderData.
