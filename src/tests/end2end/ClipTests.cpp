...
class ClipTest : public DawnTest {
  protected:
...
// TODO(jiawei.shao@intel.com): investigate why this test cannot pass on OpenGL backends only when
// running all end2end tests together.
DAWN_INSTANTIATE_TEST(ClipTest, D3D12Backend, MetalBackend, VulkanBackend);
