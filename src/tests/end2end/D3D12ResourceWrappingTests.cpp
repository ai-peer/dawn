    ...
    class D3D12ResourceTestBase : public DawnTest {
      public:
        void SetUp() override {
            ...
            const dawn_native::d3d12::Device* d3d12DawnDevice =
                reinterpret_cast<const dawn_native::d3d12::Device*>(device.Get());
            ComPtr<ID3D12Device> d3d12Device = d3d12DawnDevice->GetD3D12Device();
