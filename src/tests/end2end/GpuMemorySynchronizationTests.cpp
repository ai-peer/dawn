...
TEST_P(MultipleWriteThenMultipleReadTests, SeparateBuffers) {
    ...
    wgpu::Buffer vertexBuffer = CreateBuffer(
        kVertexBufferStride * 4, wgpu::BufferUsage::Vertex | wgpu::BufferUsage::Storage);
    ...
    wgpu::BindGroup bindGroup0 = utils::MakeBindGroup(device, bgl0,
                                                      {{0, vertexBuffer, 0, wgpu::kWholeSize},
                                                       {1, indexBuffer, 0, wgpu::kWholeSize},
                                                       {2, uniformBuffer0, 0, wgpu::kWholeSize},
                                                       {3, uniformBuffer1, 0, wgpu::kWholeSize}});
    ...
    wgpu::BindGroup bindGroup1 = utils::MakeBindGroup(
        device, bgl1,
        {{0, uniformBuffer0, 0, wgpu::kWholeSize}, {1, uniformBuffer1, 0, wgpu::kWholeSize}});
...
TEST_P(MultipleWriteThenMultipleReadTests, OneBuffer) {
    ...
    wgpu::Buffer buffer =
        CreateBuffer(sizeof(Data), wgpu::BufferUsage::Vertex | wgpu::BufferUsage::Index |
