    ...
    wgpu::RenderPipeline MakeTestPipeline() {
        wgpu::ShaderModule vsModule = utils::CreateShaderModuleFromWGSL(device, R"(
            ...
            [[stage(vertex)]] fn main() -> void {
                ...
                v_srcTexcoord = (texcoord[VertexIndex] * vec2<f32>(1.0, -1.0) +
                    vec2<f32>(0.0, 1.0)) * uniforms.u_scale + uniforms.u_offset;
        ...
        wgpu::ShaderModule fsModule = utils::CreateShaderModuleFromWGSL(device, R"(
            ...
            [[stage(fragment)]] fn main() -> void {
                ...
                if (all(clampedSrcTexcoord == v_srcTexcoord) &&
                    ...
                    var tempColor : vec4<f32> =
                        textureSample(srcTexture, srcSampler, v_srcTexcoord);
