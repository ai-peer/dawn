            ...
            fn main() -> void {
                ...
                if (uniforms.isFloat16 == 1) {
                    ...
                    if (uniforms.channelCount == 4) {
                        ...
                        // with Mesa 19.0.2) and causes bots crash. To workaround this without
                        // tint generator, we use {vector}.r/g/b/a form instead of
                        // 'loop' + {vector}[i] form to access channels in the test shader.
