...
TEST_P(TextureResetTest, MipMapClearsToBlack) {
    ...
    dawn::TextureDescriptor colorDescriptor = CreateTextureDescriptor(
        4, 1, dawn::TextureUsageBit::OutputAttachment | dawn::TextureUsageBit::TransferSrc);
    dawn::Texture color = device.CreateTexture(&colorDescriptor);
    utils::BasicRenderPass renderPass =
        utils::BasicRenderPass(kSize, kSize, color, dawn::TextureFormat::R8G8B8A8Unorm);
...
TEST_P(TextureResetTest, CopyBufferToTextureHalf) {
    ...
    RGBA8 filledWithZeros(0, 0, 0, 0);
    RGBA8 filledWith100(100, 100, 100, 100);
    std::vector<RGBA8> expected100(kSize * kSize, filledWith100);
    std::vector<RGBA8> expectedZeros(kSize * kSize, filledWithZeros);
...
// This Tests the CopyTextureToTexture's copy only to a subset of the subresource
TEST_P(TextureResetTest, CopyTextureToTextureHalf) {
    ...
    RGBA8 filledWithZeros(0, 0, 0, 0);
    RGBA8 filledWith100(100, 100, 100, 100);
    std::vector<RGBA8> expectedWithZeros(kSize * kSize, filledWithZeros);
    std::vector<RGBA8> expectedWith100(kSize * kSize, filledWith100);
