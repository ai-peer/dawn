...
class VideoViewsTestBackend {
  public:
    ...
    virtual void OnSetUp(WGPUDevice device);
    ...
    virtual bool CreateVideoTextureForTest(wgpu::TextureFormat format,
                                           wgpu::TextureUsage usage,
                                           bool isCheckerboard,
                                           PlatformTexture* platformTextureOut);
    virtual void DestroyVideoTextureForTest(PlatformTexture& PlatformTexture);
};
...
class VideoViewsTests : public DawnTest {
  ...
  protected:
    ...
    bool CreateVideoTextureForTest(wgpu::TextureFormat format,
                                   wgpu::TextureUsage usage,
                                   bool isCheckerboard,
                                   VideoViewsTestBackend::PlatformTexture* platformTextureOut);
    void DestroyVideoTextureForTest(VideoViewsTestBackend::PlatformTexture& PlatformTexture);
