...
constexpr static uint64_t kInitialValue = ~uint64_t(0);
...
class OcclusionQueryTests : public QueryTests {
  protected:
    ...
    void TestOcclusionQueryWithDepthStencilTest(bool depthTestEnabled,
        ...
        // occlusion testing
        queue.WriteBuffer(destination, 0, &kInitialValue, sizeof(kInitialValue));
