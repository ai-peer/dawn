...
namespace {
    ...
    constexpr float kNormalizedTextureValues[] = {0.0, 0.3, 0.4, 0.5, 1.0};
    constexpr float kNonNormalizedTextureValues[] = {-0.2, -0.1, 1.2, 1.3};
...
class DepthSamplingTest : public DawnTest {
  protected:
    ...
    void UpdateInputTexture(wgpu::CommandEncoder commandEncoder, float textureValue) {
        ...
        bufferCopyView.bytesPerRow = sizeof(float);
