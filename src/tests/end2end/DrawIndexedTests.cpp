...
// Out of bounds drawIndexed are treated as invalid operations (causing validation errors), thus
// removed from end2end tests. See https://github.com/gpuweb/gpuweb/pull/1866
