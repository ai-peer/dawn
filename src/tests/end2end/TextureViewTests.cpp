...
class TextureViewRenderingTest : public DawnTest {
  protected:
    void TextureLayerAsColorAttachmentTest(dawn::TextureViewDimension dimension,
        ...
        // Clear textureView by Red(255, 0, 0, 255) and render Green(0, 255, 0, 255) into it
        ...
        // Check if the right pixel (Green) has been written into the right part of the texture.
