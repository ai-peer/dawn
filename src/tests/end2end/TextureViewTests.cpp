...
protected:
    ...
    void Texture2DViewTest(uint32_t textureArrayLayers,
        ...
        // TODO(jiawei.shao@intel.com): support creating texture view by a texture view descriptor on
        // D3D12, Metal and OpenGL.
        ...
        const int expected = GetPixelValue(textureViewBaseLayer, textureViewBaseMipLevel);
