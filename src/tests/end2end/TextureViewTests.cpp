...
class TextureViewRenderingTest : public DawnTest {
  protected:
    void TextureLayerAsColorAttachmentTest(dawn::TextureViewDimension dimension,
        ...
        rDescriptor.cFragmentStage.module = oneColorFsModule;
        rDescriptor.cColorAttachments[0].format = kDefaultFormat;

        dawn::RenderPipeline oneColorPipeline = device.CreateRenderPipeline(&rDescriptor);
