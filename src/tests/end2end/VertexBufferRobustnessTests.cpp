...
TEST_P(VertexBufferRobustnessTest, VertexPullingClamps) {
    wgpu::ShaderModule vsModule = CreateShaderModuleFromWGSL(device, R"(
    ...
    wgpu::ShaderModule fsModule = CreateShaderModuleFromWGSL(device, R"(
...
DAWN_INSTANTIATE_TEST(VertexBufferRobustnessTest, MetalBackend());
