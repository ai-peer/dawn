...
TEST_P(EGLImageValidationTests, Success) {
    ...
    wgpu::Texture texture = WrapEGLImage(&descriptor, defaultEGLImage.getImage(), 0);
...
TEST_P(EGLImageValidationTests, InvalidTextureDescriptor) {
    ...
    ASSERT_DEVICE_ERROR(wgpu::Texture texture =
                            WrapEGLImage(&descriptor, defaultEGLImage.getImage(), 0));
...
TEST_P(EGLImageValidationTests, PlaneTooLarge) {
    DAWN_SKIP_TEST_IF(UsesWire());
    ASSERT_DEVICE_ERROR(wgpu::Texture texture =
                            WrapEGLImage(&descriptor, defaultEGLImage.getImage(), 1));
    ASSERT_EQ(texture.Get(), nullptr);
}
  ...
  public:
    ...
    void DoSampleTest(EGLImage eglImage, wgpu::TextureFormat format, RGBA8 expectedColor) {
        ...
        wgpu::BindGroup bindGroup;
        {
            ...
            wgpu::Texture wrappingTexture = WrapEGLImage(&textureDescriptor, eglImage, 0);
    ...
    void DoClearTest(EGLImage eglImage,
        ...
        wgpu::Texture eglImageTexture = WrapEGLImage(&textureDescriptor, eglImage, 0);
