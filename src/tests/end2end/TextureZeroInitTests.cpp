...
class CompressedTextureZeroInitTest : public TextureZeroInitTest {
  protected:
    ...
    void InitializeDataInCompressedTextureAndExpectLazyClear(
        ...
        // utils::RequiredBytesInCopy, create an empty vector and memset it to 1.
...
TEST_P(CompressedTextureZeroInitTest, FullCopyToNonZeroMipLevel) {
    ...
    const uint32_t kCopySizeAtLevel = (kActualSizeAtLevel + kFormatBlockByteSize - 1) /
                                      kFormatBlockByteSize * kFormatBlockByteSize;
