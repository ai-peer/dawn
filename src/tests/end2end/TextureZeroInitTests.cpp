...
class TextureZeroInitTest : public DawnTest {
  protected:
    ...
    wgpu::Texture Create2DTexture(wgpu::TextureUsage usage,
        ...
        return utils::Create2DArrayTexture(device, kSize, kSize, format, usage, arrayLayerCount,
                                           mipLevelCount);
    }
...
TEST_P(TextureZeroInitTest, CopyTextureToBufferSource) {
    wgpu::Texture texture = Create2DTexture(
...
TEST_P(TextureZeroInitTest, RenderingMipMapClearsToZero) {
    ...
    wgpu::Texture texture =
        Create2DTexture(wgpu::TextureUsage::OutputAttachment | wgpu::TextureUsage::CopySrc,
...
TEST_P(TextureZeroInitTest, CopyTextureToTexture) {
    wgpu::Texture srcTexture =
        Create2DTexture(wgpu::TextureUsage::Sampled | wgpu::TextureUsage::CopySrc, kColorFormat);

    wgpu::TextureCopyView srcTextureCopyView =
        utils::CreateTextureCopyView(srcTexture, 0, 0, {0, 0, 0});

    wgpu::Texture dstTexture =
        Create2DTexture(wgpu::TextureUsage::OutputAttachment | wgpu::TextureUsage::CopyDst |
...
TEST_P(TextureZeroInitTest, CopyTextureToTextureHalf) {
    wgpu::Texture srcTexture = Create2DTexture(
...
TEST_P(TextureZeroInitTest, RenderingLoadingDepth) {
    wgpu::Texture srcTexture =
        Create2DTexture(wgpu::TextureUsage::CopySrc | wgpu::TextureUsage::CopyDst |
                            wgpu::TextureUsage::OutputAttachment,
                        kColorFormat);

    wgpu::Texture depthStencilTexture = Create2DTexture(
...
TEST_P(TextureZeroInitTest, RenderPassSampledTextureClear) {
    ...
    wgpu::Texture texture = Create2DTexture(wgpu::TextureUsage::Sampled, kColorFormat);
...
TEST_P(TextureZeroInitTest, ComputePassSampledTextureClear) {
    // Create needed resources
    wgpu::Texture texture =
        utils::Create2DTexture(device, 1, 1, kColorFormat, wgpu::TextureUsage::Sampled);
...
TEST_P(TextureZeroInitTest, NonRenderableTextureClear) {
    wgpu::Texture texture = Create2DTexture(wgpu::TextureUsage::CopySrc, kNonrenderableColorFormat);
...
TEST_P(TextureZeroInitTest, NonRenderableTextureClearUnalignedSize) {
    wgpu::Texture texture =
        utils::Create2DTexture(device, kUnalignedSize, kUnalignedSize, kNonrenderableColorFormat,
                               wgpu::TextureUsage::CopySrc);
...
TEST_P(TextureZeroInitTest, NonRenderableTextureClearWithMultiArrayLayers) {
    wgpu::Texture texture =
        Create2DTexture(wgpu::TextureUsage::CopySrc, kNonrenderableColorFormat, 1, 2);
...
TEST_P(TextureZeroInitTest, RenderPassStoreOpClear) {
    // Create needed resources
    wgpu::Texture texture =
        Create2DTexture(wgpu::TextureUsage::Sampled | wgpu::TextureUsage::CopyDst, kColorFormat);
...
TEST_P(TextureZeroInitTest, PreservesInitializedMip) {
    wgpu::Texture sampleTexture = Create2DTexture(
