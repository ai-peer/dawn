    ...
    protected:
        ...
        void DoTest(const TextureSpec& textureSpec, const BufferSpec& bufferSpec) {
            ...
            wgpu::Texture texture = utils::CreateTexture(
                ...
                wgpu::TextureUsage::CopyDst | wgpu::TextureUsage::CopySrc, textureSpec.arraySize,
                textureSpec.level + 1);
...
protected:
    ...
    void DoTest(const TextureSpec& textureSpec, const BufferSpec& bufferSpec) {
        ...
        wgpu::Texture texture = utils::CreateTexture(
            device, textureSpec.width, textureSpec.height, wgpu::TextureFormat::RGBA8Unorm,
            wgpu::TextureUsage::CopyDst | wgpu::TextureUsage::CopySrc, 1, textureSpec.level + 1);
...
class CopyTests_T2T : public CopyTests {
  ...
  protected:
    void DoTest(const TextureSpec& srcSpec, const TextureSpec& dstSpec, const CopySize& copy) {
        wgpu::Texture srcTexture = utils::CreateTexture(
            device, srcSpec.width, srcSpec.height, wgpu::TextureFormat::RGBA8Unorm,
            wgpu::TextureUsage::CopySrc | wgpu::TextureUsage::CopyDst, srcSpec.arraySize,
            srcSpec.level + 1);

        wgpu::Texture dstTexture = utils::CreateTexture(
            device, dstSpec.width, dstSpec.height, wgpu::TextureFormat::RGBA8Unorm,
            wgpu::TextureUsage::CopySrc | wgpu::TextureUsage::CopyDst, dstSpec.arraySize,
            dstSpec.level + 1);
