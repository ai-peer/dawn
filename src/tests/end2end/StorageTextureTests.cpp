...
TEST_P(StorageTextureTests, SampledAndWriteonlyStorageTexturePingPong) {
    ...
    wgpu::Texture storageTexture1 = CreateTexture(
        kTextureFormat,
        wgpu::TextureUsage::Sampled | wgpu::TextureUsage::Storage | wgpu::TextureUsage::CopySrc,
        kSize, kSize);
    wgpu::Texture storageTexture2 = CreateTexture(
        kTextureFormat, wgpu::TextureUsage::Sampled | wgpu::TextureUsage::Storage, kSize, kSize);
