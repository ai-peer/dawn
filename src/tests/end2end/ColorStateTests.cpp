...
TEST_P(ColorStateTest, IndependentColorState) {
    ...
    blendComponent1.operation = wgpu::BlendOperation::Add;
    ...
    wgpu::BlendComponent blendComponent2;
    blendComponent2.operation = wgpu::BlendOperation::Subtract;
    blendComponent2.srcFactor = wgpu::BlendFactor::One;
    blendComponent2.dstFactor = wgpu::BlendFactor::One;

    wgpu::BlendState blend2;
    blend2.color = blendComponent2;
    blend2.alpha = blendComponent2;
    ...
    testDescriptor.cTargets[0].blend = &blend1;
    testDescriptor.cTargets[1].blend = &blend2;
