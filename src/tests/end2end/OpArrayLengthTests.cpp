...
class OpArrayLengthTest : public DawnTest {
  protected:
    void SetUp() {
        ...
        storageBuffer4 = device.CreateBuffer(&bufferDesc);

        bufferDesc.size = 256;
        storageBuffer256 = device.CreateBuffer(&bufferDesc);

        bufferDesc.size = 512;
        storageBuffer512 = device.CreateBuffer(&bufferDesc);
        ...
        mBindGroup = utils::MakeBindGroup(device, mBindGroupLayout,
                                          {
                                              {0, storageBuffer4, 0, 4},
                                              {1, storageBuffer256, 0, dawn::kWholeSize},
                                              {2, storageBuffer512, 0, 512},
                                          });
    ...
    dawn::Buffer storageBuffer4;
    dawn::Buffer storageBuffer256;
    dawn::Buffer storageBuffer512;
