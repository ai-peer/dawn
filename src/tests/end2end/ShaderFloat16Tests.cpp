...
// Test basic 32bit float and 16bit float arithmetic and storage features.
TEST_P(ShaderFloat16Tests, Basic32BitAnd16BitFloatFeaturesTest) {
    DAWN_SKIP_TEST_IF(!IsShaderFloat16Supported());
