...
TEST_P(ShaderFloat16Tests, VendorIdFilter) {
    ...
    uint16_t bufferInData[] = {Float32ToFloat16(2.34), Float32ToFloat16(0.0)};  // 0 is a padding.
    ...
    uint16_t expected[] = {Float32ToFloat16(3.57), Float32ToFloat16(0.0)};  // 0 is a padding.
