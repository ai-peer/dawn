...
constexpr static unsigned int kAttributeNum = 2;
...
class VertexInputTest : public DawnTest {
  protected:
    ...
    struct VertexBufferSpec {
        ...
        AttributeSpec attributes[kAttributeNum];
    };
    ...
    utils::ComboVertexInputDescriptor MakeVertexInput(
        ...
        for (const auto& buffer : buffers) {
            ...
            uint32_t numAttributesInCurrentBuffer = 0;
            for (const auto& attribute : buffer.attributes) {
                ...
                totalNumAttributes++;
                numAttributesInCurrentBuffer++;
                if (numAttributesInCurrentBuffer >= buffer.numAttributes) {
                    break;
                }
            }
            vertexInput.cBuffers[numBuffers].numAttributes = numAttributesInCurrentBuffer;
...
TEST_P(VertexInputTest, Basic) {
    utils::ComboVertexInputDescriptor vertexInput = MakeVertexInput(
        {{4 * sizeof(float), InputStepMode::Vertex, 1, {{0, 0, VertexFormat::Float4}}}});
...
TEST_P(VertexInputTest, ZeroStride) {
    ...
    utils::ComboVertexInputDescriptor vertexInput =
        MakeVertexInput({{0, InputStepMode::Vertex, 1, {{0, 0, VertexFormat::Float4}}}});
    dawn::RenderPipeline pipeline =
...
TEST_P(VertexInputTest, AttributeExpanding) {
    ...
    {
        utils::ComboVertexInputDescriptor vertexInput =
            MakeVertexInput({{0, InputStepMode::Vertex, 1, {{0, 0, VertexFormat::Float}}}});
        dawn::RenderPipeline pipeline =
    ...
    {
        utils::ComboVertexInputDescriptor vertexInput =
            MakeVertexInput({{0, InputStepMode::Vertex, 1, {{0, 0, VertexFormat::Float2}}}});
        dawn::RenderPipeline pipeline =
    ...
    {
        utils::ComboVertexInputDescriptor vertexInput =
            MakeVertexInput({{0, InputStepMode::Vertex, 1, {{0, 0, VertexFormat::Float3}}}});
        dawn::RenderPipeline pipeline =
...
TEST_P(VertexInputTest, StrideLargerThanAttributes) {
    ...
    utils::ComboVertexInputDescriptor vertexInput = MakeVertexInput(
        {{8 * sizeof(float), InputStepMode::Vertex, 1, {{0, 0, VertexFormat::Float4}}}});
    dawn::RenderPipeline pipeline =
        MakeTestPipeline(vertexInput, 1, {{0, VertexFormat::Float4, InputStepMode::Vertex}});
...
TEST_P(VertexInputTest, PureInstance) {
    utils::ComboVertexInputDescriptor vertexInput = MakeVertexInput(
        {{4 * sizeof(float), InputStepMode::Instance, 1, {{0, 0, VertexFormat::Float4}}}});
    dawn::RenderPipeline pipeline =
        MakeTestPipeline(vertexInput, 1, {{0, VertexFormat::Float4, InputStepMode::Instance}});
...
TEST_P(VertexInputTest, UnusedVertexSlot) {
    ...
    utils::ComboVertexInputDescriptor instanceVertexInput =
        MakeVertexInput({{4 * sizeof(float),
                          InputStepMode::Instance,
                          1,
                          {{0, 0, VertexFormat::Float4}}}});  // nullptr for buffer[0];
