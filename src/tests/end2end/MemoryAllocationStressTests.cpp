...
TEST_P(MemoryAllocationStressTests, LargeBuffer) {
    // TODO(crbug.com/1196993): Memory leak on D3D12, the memory of destroyed buffer cannot be
    // released.
    DAWN_TEST_UNSUPPORTED_IF(IsD3D12());

    // TODO(crbug.com/1196993): Check whether it can be reproduced on each backend.
