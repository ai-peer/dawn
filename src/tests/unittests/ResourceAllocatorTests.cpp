...
// Verify the buddy allocator can allocate a few blocks over multple resources.
...
// Verify the buddy allocator can allocate blocks with resource alignment.
TEST_F(BuddyPoolAllocatorTests, SingleResourceAligned) {
    // Specified a resource size that is below the min. resource size.
    ...
    // Specified a resource size that is above the min. resource size.
...
// Verify the buddy allocator can allocate many blocks over multiple resources.
