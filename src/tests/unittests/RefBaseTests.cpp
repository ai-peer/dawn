...
TEST(RefBase, Acquire) {
    ...
    EXPECT_THAT(events, testing::ElementsAre(Event{Action::kRelease, 1},  //
                                             Event{Action::kAssign, 1, 2}));
}
...
TEST(RefBase, Detach) {
    ...
    events.clear();
    { (void)ref.Detach(); }
    EXPECT_THAT(events, testing::ElementsAre(Event{Action::kAssign, 1, 0}));
}
...
TEST(RefBase, RefCopyAssignment) {
    ...
    EXPECT_THAT(events, testing::ElementsAre(Event{Action::kMarker, 10},    //
                                             Event{Action::kReference, 1},  //
                                             Event{Action::kAssign, 0, 1},  //
                                             Event{Action::kMarker, 20},    //
                                             Event{Action::kReference, 2},  //
                                             Event{Action::kRelease, 1},    //
                                             Event{Action::kAssign, 1, 2},  //
                                             Event{Action::kMarker, 30},    //
                                             Event{Action::kReference, 1},  //
                                             Event{Action::kRelease, 2},    //
                                             Event{Action::kAssign, 2, 1},  //
...
TEST(RefBase, RefMoveAssignment) {
    ...
    EXPECT_THAT(events, testing::ElementsAre(Event{Action::kMarker, 10},    //
                                             ...
                                             Event{Action::kMarker, 20},    //
                                             Event{Action::kRelease, 1},    // release ref
