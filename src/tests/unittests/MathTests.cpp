...
TEST(Math, Log2) {
    ...
    ASSERT_EQ(Log2(0xFFFFFFFFFFFFFFFFull), 63u);

    // Test boundary between two logs
    ASSERT_EQ(Log2(0x80000000u), 31u);
    ASSERT_EQ(Log2(0x7FFFFFFFu), 30u);
    ASSERT_EQ(Log2(0x8000000000000000ull), 63u);
    ASSERT_EQ(Log2(0x7FFFFFFFFFFFFFFFull), 62u);
...
// Tests for AlignToNextPowerOfTwo
TEST(Math, AlignToNextPowerOfTwo) {
    // Test extrema
    ASSERT_EQ(AlignToNextPowerOfTwo(0), 1ull);
    ASSERT_EQ(AlignToNextPowerOfTwo(0x7FFFFFFFFFFFFFFF), 0x8000000000000000);

    // Test boundary between powers-of-two.
    ASSERT_EQ(AlignToNextPowerOfTwo(31), 32ull);
    ASSERT_EQ(AlignToNextPowerOfTwo(33), 64ull);

    ASSERT_EQ(AlignToNextPowerOfTwo(32), 32ull);
}
