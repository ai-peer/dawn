...
TEST_F(ShaderModuleValidationTest, ComputeWorkgroupStorageSizeLimits) {
    ...
    constexpr uint32_t kMaxVec4Count = supportedLimits.maxComputeWorkgroupStorageSize / kVec4Size;
    constexpr uint32_t kMat4Size = 64;
    constexpr uint32_t kMaxMat4Count = supportedLimits.maxComputeWorkgroupStorageSize / kMat4Size;
