...
TEST_F(StorageTextureValidationTests, StorageTextureInRenderPass) {
    ...
    defaultBindGroupLayoutEntry.binding = 0;
    defaultBindGroupLayoutEntry.visibility = wgpu::ShaderStage::Compute;
    defaultBindGroupLayoutEntry.storageTextureFormat = kFormat;
    defaultBindGroupLayoutEntry.textureDimension = wgpu::TextureViewDimension::e2D;
    ...
    for (wgpu::BindingType storageTextureType : kSupportedStorageTextureBindingTypes) {
        ...
        wgpu::BindGroupLayoutEntry bindGroupLayoutEntry = defaultBindGroupLayoutEntry;
        bindGroupLayoutEntry.type = storageTextureType;
        wgpu::BindGroupLayout bindGroupLayout =
            utils::MakeBindGroupLayout(device, {bindGroupLayoutEntry});
...
TEST_F(StorageTextureValidationTests, StorageTextureAndSampledTextureInOneRenderPass) {
    ...
    defaultBindGroupLayoutEntry.storageTextureFormat = kFormat;
    defaultBindGroupLayoutEntry.textureDimension = wgpu::TextureViewDimension::e2D;
    defaultBindGroupLayoutEntry.textureComponentType = wgpu::TextureComponentType::Float;
    ...
    for (wgpu::BindingType storageTextureType : kSupportedStorageTextureBindingTypes) {
        ...
        // texture.
        wgpu::BindGroupLayoutEntry storageTextureEntry = defaultBindGroupLayoutEntry;
        storageTextureEntry.type = storageTextureType;
        wgpu::BindGroupLayoutEntry sampledTextureEntry = defaultBindGroupLayoutEntry;
        sampledTextureEntry.binding = 1u;
        sampledTextureEntry.type = wgpu::BindingType::SampledTexture;
        wgpu::BindGroupLayout bindGroupLayout =
            utils::MakeBindGroupLayout(device, {storageTextureEntry, sampledTextureEntry});
...
TEST_F(StorageTextureValidationTests, ReadOnlyStorageTextureAndWriteOnlyStorageTexture) {
    ...
    // texture.
    wgpu::BindGroupLayoutEntry readonlyStorageBindGroupLayoutEntry = defaultBindGroupLayoutEntry;
    readonlyStorageBindGroupLayoutEntry.type = wgpu::BindingType::ReadonlyStorageTexture;
    wgpu::BindGroupLayoutEntry writeonlyStorageBindGroupLayoutEntry = defaultBindGroupLayoutEntry;
    writeonlyStorageBindGroupLayoutEntry.binding = 1u;
    writeonlyStorageBindGroupLayoutEntry.type = wgpu::BindingType::WriteonlyStorageTexture;
    wgpu::BindGroupLayout bindGroupLayout = utils::MakeBindGroupLayout(
        device, {readonlyStorageBindGroupLayoutEntry, writeonlyStorageBindGroupLayoutEntry});
