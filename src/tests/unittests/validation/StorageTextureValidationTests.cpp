...
// Validate readonly storage textures can be declared in vertex and fragment
...
TEST_F(StorageTextureValidationTests, RenderPipeline) {
    ...
    // Readonly storage textures can be declared in a fragment shader.
    {
...
// Validate both readonly and writeonly storage textures can be declared in
// compute shaders.
TEST_F(StorageTextureValidationTests, ComputePipeline) {
    // Readonly storage textures can be declared in a compute shader.
    {
