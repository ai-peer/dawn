...
TEST_F(BindGroupValidationTest, WrongBindings) {
    ...
    // Check that a very large binding fails.
    ASSERT_DEVICE_ERROR(utils::MakeBindGroup(device, layout, {{1998302, mSampler}}));
}
...
TEST_F(BindGroupLayoutValidationTest, PerStageLimits) {
    ...
    constexpr TestInfo kTestInfos[] = {
        { kMaxSampledTexturesPerShaderStage, wgpu::BindingType::SampledTexture, wgpu::BindingType::UniformBuffer },
        { kMaxSamplersPerShaderStage, wgpu::BindingType::Sampler, wgpu::BindingType::UniformBuffer },
        { kMaxSamplersPerShaderStage, wgpu::BindingType::ComparisonSampler, wgpu::BindingType::UniformBuffer },
        { kMaxStorageBuffersPerShaderStage, wgpu::BindingType::StorageBuffer, wgpu::BindingType::UniformBuffer },
        { kMaxStorageTexturesPerShaderStage, wgpu::BindingType::ReadonlyStorageTexture, wgpu::BindingType::UniformBuffer },
        { kMaxStorageTexturesPerShaderStage, wgpu::BindingType::WriteonlyStorageTexture, wgpu::BindingType::UniformBuffer },
        { kMaxUniformBuffersPerShaderStage, wgpu::BindingType::UniformBuffer, wgpu::BindingType::SampledTexture },
    };
    ...
    for (TestInfo info : kTestInfos) {
        ...
        // Adding an extra binding of a different type works.
        {
            ...
            bindings.push_back(PopulateEntry({info.maxCount, wgpu::ShaderStage::Compute,
                                info.otherBindingType}));
        ...
        {
            std::vector<wgpu::BindGroupLayoutEntry> bindings = maxBindings;
            bindings.push_back(PopulateEntry({info.maxCount, wgpu::ShaderStage::Fragment,
                                info.bindingType}));
            MakeBindGroupLayout(bindings.data(), bindings.size());
        }
