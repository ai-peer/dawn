...
class SetBindGroupValidationTest : public ValidationTest {
  public:
    ...
    dawn::RenderPipeline SetEnvForRenderPipeline() {
    ...
    dawn::ComputePipeline SetEnvForComputePipeline() {
...
TEST_F(SetBindGroupValidationTest, SetBindGroupBasicRenderPipeline) {
    std::array<uint64_t, 2> offsets = {256, 0};

    // RenderPipeline SetBindGroup
    {
        dawn::RenderPipeline renderPipeline = SetEnvForRenderPipeline();
    ...
    {
        dawn::ComputePipeline computePipeline = SetEnvForComputePipeline();
...
TEST_F(SetBindGroupValidationTest, SetBindGroupDynamicOffsetsMismatch) {
    std::array<uint64_t, 1> mismatchOffsets = {0};

    // RenderPipeline SetBindGroup
    {
        dawn::RenderPipeline pipeline = SetEnvForRenderPipeline();
        DummyRenderPass renderPass(device);
...
TEST_F(SetBindGroupValidationTest, SetBindGroupDynamicOffsetsNotAligned) {
    ...
    {
        dawn::ComputePipeline pipeline = SetEnvForComputePipeline();
...
TEST_F(SetBindGroupValidationTest, SetBindGroupOutOfBoundDynamicUniformBuffer) {
...
TEST_F(SetBindGroupValidationTest, SetBindGroupOutOfBoundDynamicStorageBuffer) {
