...
TEST_F(BindGroupValidationTest, MaxUniformBufferBindingSize) {
    ...
    ASSERT_DEVICE_ERROR(utils::MakeBindGroup(
        device, uniformLayout, {{0, buffer, 0, kMaxUniformBufferBindingSize + 1}}));
    ...
    utils::MakeBindGroup(device, readonlyStorageLayout, {{0, buffer, 0, 2 * kMaxUniformBufferBindingSize}});
