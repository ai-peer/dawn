...
TEST_F(CopyCommandTest_B2T, Success) {
    ...
    // Different copies, including some that touch the OOB condition
    {
        ...
        TestB2TCopy(utils::Expectation::Success, source, bufferSize - 4, 256, 1, destination, 0,
                    {0, 0, 0}, {1, 1, 1});
        TestB2TCopy(utils::Expectation::Success, source, bufferSize - 4, 256, WGPU_STRIDE_UNDEFINED,
    ...
    {
        TestB2TCopy(utils::Expectation::Success, source, 0, WGPU_STRIDE_UNDEFINED, 2, destination,
                    0, {0, 0, 0}, {1, 1, 1});
        TestB2TCopy(utils::Expectation::Success, source, 0, WGPU_STRIDE_UNDEFINED, 2, destination,
                    0, {0, 0, 0}, {3, 1, 1});
        TestB2TCopy(utils::Expectation::Failure, source, 0, WGPU_STRIDE_UNDEFINED, 2, destination,
                    0, {0, 0, 0}, {1, 2, 1});
        TestB2TCopy(utils::Expectation::Failure, source, 0, WGPU_STRIDE_UNDEFINED, 2, destination,
                    0, {0, 0, 0}, {1, 1, 2});
    }
    ...
    // Empty copies are valid
    {
        ...
        TestB2TCopy(utils::Expectation::Success, source, 0, 0, 0, destination, 0, {0, 0, 0},
                    {0, 0, 1});
        TestB2TCopy(utils::Expectation::Success, source, 0, WGPU_STRIDE_UNDEFINED, 0, destination,
                    0, {0, 0, 0}, {0, 0, 1});
        ...
        TestB2TCopy(utils::Expectation::Success, source, bufferSize, 0, 0, destination, 0,
                    {0, 0, 0}, {0, 0, 1});
        TestB2TCopy(utils::Expectation::Success, source, bufferSize, WGPU_STRIDE_UNDEFINED, 0,
...
TEST_F(CopyCommandTest_B2T, RowsPerImageConstraints) {
    ...
    TestB2TCopy(utils::Expectation::Success, source, 0, 256, WGPU_STRIDE_UNDEFINED, destination, 0,
                {0, 0, 0}, {4, 4, 1});
    TestB2TCopy(utils::Expectation::Failure, source, 0, 256, WGPU_STRIDE_UNDEFINED, destination, 0,
                {0, 0, 0}, {4, 4, 2});
...
TEST_F(CopyCommandTest_T2B, Success) {
    ...
    // Different copies, including some that touch the OOB condition
    {
        ...
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, bufferSize - 4,
                    256, 1, {1, 1, 1});
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, bufferSize - 4,
                    256, WGPU_STRIDE_UNDEFINED, {1, 1, 1});
    }
    ...
    // bytesPerRow is undefined
    {
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, 0,
                    WGPU_STRIDE_UNDEFINED, 2, {1, 1, 1});
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, 0,
                    WGPU_STRIDE_UNDEFINED, 2, {3, 1, 1});
        TestT2BCopy(utils::Expectation::Failure, source, 0, {0, 0, 0}, destination, 0,
                    WGPU_STRIDE_UNDEFINED, 2, {1, 2, 1});
        TestT2BCopy(utils::Expectation::Failure, source, 0, {0, 0, 0}, destination, 0,
                    WGPU_STRIDE_UNDEFINED, 2, {1, 1, 2});
    }
    ...
    // Empty copies are valid
    {
        ...
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, 0, 0, 0,
                    {0, 0, 1});
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, 0,
                    WGPU_STRIDE_UNDEFINED, 0, {0, 0, 1});
        // An empty copy with depth = 0
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, 0, 0, 0,
                    {0, 0, 0});
        TestT2BCopy(utils::Expectation::Success, source, 0, {0, 0, 0}, destination, 0,
                    WGPU_STRIDE_UNDEFINED, 0, {0, 0, 0});
        // An empty copy touching the end of the buffer
