...
class CopyCommandTest_T2T : public CopyCommandTest {
  protected:
    ...
    wgpu::TextureFormat GetCompatibleFormat(wgpu::TextureFormat format) {
        switch (format) {
...
// Test copying between textures that have compatible texture formats;
TEST_F(CopyCommandTest_T2T, FormatsCompatible) {
    for (wgpu::TextureFormat srcTextureFormat :
         {wgpu::TextureFormat::BGRA8Unorm, wgpu::TextureFormat::BGRA8UnormSrgb,
          wgpu::TextureFormat::RGBA8Unorm, wgpu::TextureFormat::RGBA8UnormSrgb}) {
        wgpu::TextureFormat dstTextureFormat = GetCompatibleFormat(srcTextureFormat);
        wgpu::Texture source =
...
// Test copying between textures that have compatible texture formats;
TEST_F(CopyCommandTest_CompressedTextureFormats, FormatsCompatible) {
    ...
    for (wgpu::TextureFormat srcFormat : srcFormats) {
        ...
        wgpu::Texture texture2 =
            Create2DTexture(GetCompatibleFormat(srcFormat), kMipmapLevels, testWidth, testHeight);
