...
TEST_F(CopyCommandTest_B2T, CopyToMipmapOfNonSquareTexture) {
    ...
    TestB2TCopy(utils::Expectation::Failure, source, 0, 256, 0, destination, maxMipmapLevel - 1, 1,
                {0, 0, 0}, {1, 1, 1});
}
...
TEST_F(CopyCommandTest_T2B, CopyToMipmapOfNonSquareTexture) {
    uint32_t maxMipmapLevel = 3;
    ...
    TestT2BCopy(utils::Expectation::Failure, source, maxMipmapLevel, 0, {0, 0, 0}, destination, 0,
                256, 0, {2, 1, 1});
    // Array layer out of range
    TestT2BCopy(utils::Expectation::Failure, source, maxMipmapLevel - 1, 1, {0, 0, 0}, destination,
                0, 256, 0, {2, 1, 1});
}
...
TEST_F(CopyCommandTest_T2T, CopyToMipmapOfNonSquareTexture) {
    ...
    // Array layer out of range
    TestT2TCopy(utils::Expectation::Failure, source, maxMipmapLevel - 1, 1, {0, 0, 0}, destination,
                maxMipmapLevel - 1, 1, {0, 0, 0}, {2, 1, 1});
}
