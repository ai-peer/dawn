...
// Test a successful non square texture copy for high mipmap levels
TEST_F(CopyCommandTest_B2T, CopyNonSquareTexture) {
...
// Test a successful non square texture copy for high mipmap levels
TEST_F(CopyCommandTest_T2B, CopyNonSquareTexture) {
    uint32_t maxMipmapLevel = 3;
...
// Test a successful non square texture copy for high mipmap levels
TEST_F(CopyCommandTest_T2T, CopyNonSquareTexture) {
    uint32_t maxMipmapLevel = 3;
    dawn::Texture source = Create2DTexture(4, 2, maxMipmapLevel, 1, dawn::TextureFormat::RGBA8Unorm,
                                           dawn::TextureUsageBit::TransferSrc);
    dawn::Texture destination =
