    ...
    // Different copies, including some that touch the OOB condition
    {
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                ...
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, 0, 256, 0),
                ...
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, bufferSize - 4, 256, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
    ...
    // Copies with a 256-byte aligned row pitch but unaligned texture region
    {
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                ...
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, 31 * 4, 256, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
    ...
    // Empty copies are valid
    {
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                // An empty copy
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, 0, 0, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(0, 0, 1))
                // An empty copy touching the end of the buffer
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, bufferSize, 0, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(0, 0, 1))
...
TEST_F(CopyCommandTest_B2T, OutOfBoundsOnBuffer) {
    ...
    // OOB on the buffer because of the offset
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, 4, 256, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(4, 4, 1))
                .GetResult();
    }
    ...
    // OOB on the buffer because (row pitch * (height - 1) + width) * depth overflows
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, 0, 512, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
...
TEST_F(CopyCommandTest_B2T, IncorrectRowPitch) {
    ...
    // Row pitch is not 256-byte aligned
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, 0, 128, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(4, 4, 1))
                .GetResult();
    }
...
TEST_F(CopyCommandTest_B2T, IncorrectBufferOffset) {
    ...
    // Incorrect usages
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, bufferSize - 5, 256, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(1, 1, 1))
                .GetResult();
    }
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, bufferSize - 6, 256, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(1, 1, 1))
                .GetResult();
    }
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyBufferToTexture(
                    CreateBufferCopyView(source, bufferSize - 7, 256, 0),
                    CreateTextureCopyView(destination, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateExtent3D(1, 1, 1))
                .GetResult();
    }
    ...
    // Different copies, including some that touch the OOB condition
    {
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                ...
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 4, 1))
                // Copy from 4x4 block in opposite corner of first mip.
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 12, 12, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 4, 1))
                // Copy from 4x4 block in the 4x4 mip.
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 2, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 4, 1))
                // Copy with a buffer offset
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
    ...
    // Copies with a 256-byte aligned row pitch but unaligned texture region
    {
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                ...
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(3, 4, 1))
                // Unaligned region with texture offset
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 5, 7, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(2, 3, 1))
                // Unaligned region, with buffer offset
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 2, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 31 * 4, 256, 0), CreateExtent3D(3, 3, 1))
                .GetResult();
    }
    ...
    // Empty copies are valid
    {
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                ...
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 0, 0), CreateExtent3D(0, 0, 1))
                // An empty copy touching the end of the buffer
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, bufferSize, 0, 0), CreateExtent3D(0, 0, 1))
                // An empty copy touching the side of the texture
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 16, 16, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 0, 0), CreateExtent3D(0, 0, 1))
                .GetResult();
    }
}
...
TEST_F(CopyCommandTest_T2B, OutOfBoundsOnTexture) {
    ...
    // OOB on the texture because x + width overflows
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 13, 12, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 4, 1))
                .GetResult();
    }
    ...
    // OOB on the texture because y + width overflows
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 12, 13, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 4, 1))
                .GetResult();
    }
    ...
    // OOB on the texture because we overflow a non-zero mip
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 2, 0, 1, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 4, 1))
                .GetResult();
    }
    ...
    // OOB on the texture even on an empty copy when we copy from a non-existent mip.
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 5, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 0, 0), CreateExtent3D(0, 0, 1))
                .GetResult();
    }
}
    ...
    // OOB on the buffer because we copy too many pixels
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(4, 5, 1))
                .GetResult();
    }
    ...
    // OOB on the buffer because of the offset
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 4, 256, 0), CreateExtent3D(4, 4, 1))
                .GetResult();
    }
    ...
    // OOB on the buffer because (row pitch * (height - 1) + width) * depth overflows
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 512, 0), CreateExtent3D(4, 3, 1))
                .GetResult();
    }
    ...
    // but (row pitch * (height - 1) + width) * depth does not overlow
    {
        ...
        dawn::CommandBuffer commands =
            AssertWillBeSuccess(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destinationBuffer, 0, 256, 0), CreateExtent3D(7, 3, 1))
                .GetResult();
    }
}
...
TEST_F(CopyCommandTest_T2B, ZDepthConstraintFor2DTextures) {
    ...
    // Z=1 on an empty copy still errors
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 1, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 0, 0), CreateExtent3D(0, 0, 1))
                .GetResult();
    }
    ...
    // Depth=0 on an empty copy still errors
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 0, 0), CreateExtent3D(0, 0, 0))
                .GetResult();
    }
}
    ...
    // Incorrect destination usage
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(vertex, 0, 256, 0), CreateExtent3D(4, 4, 1))
                .GetResult();
    }
}
    ...
    // Row pitch is not 256-byte aligned
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 257, 0), CreateExtent3D(4, 4, 1))
                .GetResult();
    }
    ...
    // Row pitch is less than width * bytesPerPixel
    {
        dawn::CommandBuffer commands =
            AssertWillBeError(device.CreateCommandBufferBuilder())
                .CopyTextureToBuffer(
                    CreateTextureCopyView(source, 0, 0, 0, 0, 0, dawn::TextureAspect::Color),
                    CreateBufferCopyView(destination, 0, 256, 0), CreateExtent3D(65, 1, 1))
                .GetResult();
    }
}
