...
TEST_F(CopyCommandTest_FillBuffer, Success) {
    ...
    {
        wgpu::CommandEncoder encoder = device.CreateCommandEncoder();
        encoder.FillBuffer(destination, 0, 16, 0xff);
        encoder.FillBuffer(destination, 0, 8, 0xff);
        encoder.FillBuffer(destination, 8, 8, 0xff);
        encoder.Finish();
    }

    // Value is allowed to be omitted
    {
        wgpu::CommandEncoder encoder = device.CreateCommandEncoder();
    ...
    // Empty fills are valid
    {
        ...
        encoder.FillBuffer(destination, 0, 0, 0xff);
        encoder.FillBuffer(destination, 16, 0, 0xff);
        encoder.Finish();
    }
}
