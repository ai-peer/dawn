...
TEST_F(CopyCommandTest_B2B, BuffersInErrorState) {
    ...
    ASSERT_DEVICE_ERROR(errorBuffer = device.CreateBuffer(&errorBufferDescriptor));
...
TEST_F(CopyCommandTest_B2T, BufferOrTextureInErrorState) {
    ...
    dawn::Texture errorTexture;
    ASSERT_DEVICE_ERROR(errorTexture = device.CreateTexture(&errorTextureDescriptor));
