...
wgpu::Texture Create2DArrayTexture(wgpu::Device& device,
    ...
    return utils::CreateTexture(device, width, height, kDefaultTextureFormat,
                                wgpu::TextureUsage::Sampled, arrayLayerCount, mipLevelCount,
                                sampleCount);
}
...
TEST_F(TextureViewValidationTest, AspectMustBeAll) {
    wgpu::Texture texture =
        utils::CreateTexture(device, 1, 1, wgpu::TextureFormat::Depth32Float,
