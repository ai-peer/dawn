...
TEST_F(RenderBundleValidationTest, RenderPassColorFormatMismatch) {
    ...
    wgpu::Texture tex0 = utils::CreateTexture(device, 400, 400, wgpu::TextureFormat::RGBA8Unorm,
                                              wgpu::TextureUsage::OutputAttachment);

    wgpu::Texture tex1 = utils::CreateTexture(device, 400, 400, wgpu::TextureFormat::RG16Float,
                                              wgpu::TextureUsage::OutputAttachment);

    wgpu::Texture tex2 = utils::CreateTexture(device, 400, 400, wgpu::TextureFormat::R16Sint,
                                              wgpu::TextureUsage::OutputAttachment);
