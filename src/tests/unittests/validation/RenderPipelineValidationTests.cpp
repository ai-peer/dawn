...
TEST_F(RenderPipelineValidationTest, SampleCountCompatibilityWithRenderPass) {
    ...
    nonMultisampledPipelineDescriptor.depthStencil =
        &nonMultisampledPipelineDescriptor.cDepthStencil;
    ...
    multisampledPipelineDescriptor.depthStencil = &multisampledPipelineDescriptor.cDepthStencil;
