...
class ShaderIOMatchingValidationTest : public RenderPipelineValidationTest {
  protected:
...
TEST_F(ShaderIOMatchingValidationTest, MissingDeclarationAtSameLocation) {
    wgpu::ShaderModule vertexModuleWithOneUserDefinedOutput = utils::CreateShaderModule(device, R"(
            struct A {
                [[location(0)]] vout: f32;
    ...
    wgpu::ShaderModule fragmentModuleWithOneUserDefinedInput =
    ...
    CheckCreatingRenderPipeline(vertexModuleWithOneUserDefinedOutput, fsModule, false);
    CheckCreatingRenderPipeline(vsModule, fragmentModuleWithOneUserDefinedInput, false);

    {
        ...
        CheckCreatingRenderPipeline(vertexModuleWithOneUserDefinedOutput,
                                    fragmentModuleInputAtLocation1, false);
    }

    {
        ...
        CheckCreatingRenderPipeline(vertexModuleOutputAtLocation1,
                                    fragmentModuleWithOneUserDefinedInput, false);
    }
}
...
TEST_F(ShaderIOMatchingValidationTest, DifferentTypeAtSameLocation) {
