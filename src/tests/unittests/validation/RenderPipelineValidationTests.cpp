...
TEST_F(RenderPipelineValidationTest, DepthStencilAspectRequirement) {
    ...
    // TODO(dawn:666): Uncomment the code snippet below after the stencil8 format is implemented
    /*
    // It is invalid if the texture format doesn't have depth aspect while stencil test is enabled.
    {
        utils::ComboRenderPipelineDescriptor descriptor;
        descriptor.vertex.module = vsModule;
        descriptor.cFragment.module = fsModule;
    ...
    // It is invalid if the texture format doesn't have depth aspect while depth write is enabled.
    {
        utils::ComboRenderPipelineDescriptor descriptor;
        descriptor.vertex.module = vsModule;
        descriptor.cFragment.module = fsModule;
