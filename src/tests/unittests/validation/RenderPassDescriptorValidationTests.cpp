...
namespace {
    ...
    TEST_F(RenderPassDescriptorValidationTest, ExceedValidColorClearRange) {
        ...
        double k2toThe24 = 16777216.0;
        uint64_t k2toThe24Plus1Uint = *reinterpret_cast<uint64_t*>(&k2toThe24) + 1;
        double kLargerThan2toPower24 = *reinterpret_cast<double*>(&k2toThe24Plus1Uint);
