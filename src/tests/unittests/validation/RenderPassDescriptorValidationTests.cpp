...
namespace {
    ...
    TEST_F(RenderPassDescriptorValidationTest, ValidateDepthStencilReadOnly) {
        ...
        // Tests that a pass with depthReadOnly to be true and stencilReadOnly to be true can pass
        // when there is only depth component in the format. We actually enables readonly
        ...
        // Tests that a pass with depthReadOnly to be false and stencilReadOnly to be true can pass
        // when there is only depth component in the format. We actually doesn't enable readonly
        // depth/stencil attachment in this case.
        {
            utils::ComboRenderPassDescriptor renderPass({colorView}, depthStencilViewNoStencil);
            renderPass.cDepthStencilAttachmentInfo.depthLoadOp = wgpu::LoadOp::Load;
