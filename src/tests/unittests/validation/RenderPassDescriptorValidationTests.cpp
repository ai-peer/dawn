...
wgpu::TextureView Create2DAttachment(wgpu::Device& device,
    ...
    wgpu::Texture texture =
        utils::Create2DTexture(device, width, height, format, wgpu::TextureUsage::OutputAttachment);
...
TEST_F(RenderPassDescriptorValidationTest, DepthStencilStoreOpMismatch) {
    ...
    wgpu::Texture colorTexture =
        utils::Create2DArrayTexture(device, kSize, kSize, kArrayLayers, kColorFormat,
                                    wgpu::TextureUsage::OutputAttachment, kLevelCount);
    wgpu::Texture depthStencilTexture =
        utils::Create2DArrayTexture(device, kSize, kSize, kArrayLayers, kDepthStencilFormat,
                                    wgpu::TextureUsage::OutputAttachment, kLevelCount);
...
TEST_F(RenderPassDescriptorValidationTest, NonMultisampledColorWithResolveTarget) {
    ...
    wgpu::Texture colorTexture = utils::Create2DTexture(device, kSize, kSize, kColorFormat,
                                                        wgpu::TextureUsage::OutputAttachment);
    wgpu::Texture resolveTargetTexture = utils::Create2DTexture(
        device, kSize, kSize, kColorFormat, wgpu::TextureUsage::OutputAttachment);
...
class MultisampledRenderPassDescriptorValidationTest : public RenderPassDescriptorValidationTest {
  ...
  private:
    wgpu::TextureView CreateColorTextureView(uint32_t sampleCount) {
        wgpu::Texture colorTexture = utils::Create2DMultisampledTexture(
            device, kSize, kSize, kColorFormat, wgpu::TextureUsage::OutputAttachment, sampleCount);
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, ResolveTargetArrayLayerMoreThanOne) {
    ...
    wgpu::Texture resolveTexture = utils::Create2DArrayTexture(
        device, kSize, kSize, kArrayLayers2, kColorFormat, wgpu::TextureUsage::OutputAttachment);
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, ResolveTargetMipmapLevelMoreThanOne) {
    ...
    wgpu::Texture resolveTexture = utils::Create2DTexture(
        device, kSize, kSize, kColorFormat, wgpu::TextureUsage::OutputAttachment, kLevelCount2);
    wgpu::TextureView resolveTextureView = resolveTexture.CreateView();
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, ResolveTargetUsageNoOutputAttachment) {
    ...
    wgpu::Texture nonColorUsageResolveTexture =
        utils::Create2DTexture(device, kSize, kSize, kColorFormat, kUsage);
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, ResolveTargetInErrorState) {
    constexpr uint32_t kArrayLayers = 1;
    wgpu::Texture resolveTexture = utils::Create2DArrayTexture(
        device, kSize, kSize, kArrayLayers, kColorFormat, wgpu::TextureUsage::OutputAttachment);
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, ResolveTargetDifferentFormat) {
    ...
    wgpu::Texture resolveTexture = utils::Create2DTexture(device, kSize, kSize, kColorFormat2,
                                                          wgpu::TextureUsage::OutputAttachment);
    wgpu::TextureView resolveTextureView = resolveTexture.CreateView();
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, ColorAttachmentResolveTargetCompatibility) {
    ...
    wgpu::Texture resolveTexture =
        utils::Create2DTexture(device, kSize2, kSize2, kColorFormat,
                               wgpu::TextureUsage::OutputAttachment, kLevelCount + 1);
...
TEST_F(MultisampledRenderPassDescriptorValidationTest, DepthStencilAttachmentSampleCount) {
    ...
    wgpu::Texture multisampledDepthStencilTexture =
        utils::Create2DMultisampledTexture(device, kSize, kSize, kDepthStencilFormat,
                                           wgpu::TextureUsage::OutputAttachment, kSampleCount);
    ...
    {
        wgpu::Texture depthStencilTexture = utils::Create2DTexture(
            device, kSize, kSize, kDepthStencilFormat, wgpu::TextureUsage::OutputAttachment);
