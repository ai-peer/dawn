...
// Tests on the resolve target in a render pass descriptor.
TEST_F(MultisampledRenderPassDescriptorValidationTest, ResolveTarget) {
...
// Tests on the compatibility between the color attachment and resolve target.
TEST_F(MultisampledRenderPassDescriptorValidationTest, ColorAttachmentResolveTargetCompatibility) {
    ...
    // It is not allowed to use a resolve target whose size is different from the color attachment.
    {
