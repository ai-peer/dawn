...
TEST_F(RenderPassDescriptorValidationTest, OneAttachment) {
    ...
    {
        dawn::TextureView depthStencil = Create2DAttachment(device, 1, 1, dawn::TextureFormat::Depth24PlusStencil8);
...
TEST_F(RenderPassDescriptorValidationTest, SizeMustMatch) {
    ...
    dawn::TextureView depthStencil1x1 = Create2DAttachment(device, 1, 1, dawn::TextureFormat::Depth24PlusStencil8);
    dawn::TextureView depthStencil2x2 = Create2DAttachment(device, 2, 2, dawn::TextureFormat::Depth24PlusStencil8);
