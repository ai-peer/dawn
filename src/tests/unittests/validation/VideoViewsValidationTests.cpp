...
namespace {
    ...
    class VideoViewsValidation : public ValidationTest {
      protected:
        WGPUDevice CreateTestDevice() override {
            ...
            descriptor.requiredExtensions = {"multiplane_textures"};
    ...
    TEST_F(VideoViewsValidation, CreateViewFails) {
        wgpu::Texture videoTexture = CreateVideoTextureForTest(
            wgpu::TextureFormat::R8BG82plane420Unorm, wgpu::TextureUsage::None);
    ...
    TEST_F(VideoViewsValidation, T2TCopyAllAspectsFails) {
        wgpu::Texture srcTexture = CreateVideoTextureForTest(
            wgpu::TextureFormat::R8BG82plane420Unorm, wgpu::TextureUsage::Sampled);
    ...
    TEST_F(VideoViewsValidation, SamplingMultiPlaneTexture) {
        wgpu::BindGroupLayout layout = utils::MakeBindGroupLayout(
            device, {{0, wgpu::ShaderStage::Fragment, wgpu::TextureSampleType::Float}});

        // R8BG82plane420Unorm is allowed to be sampled, if plane 0 or plane 1 is selected.
        wgpu::Texture texture = CreateVideoTextureForTest(wgpu::TextureFormat::R8BG82plane420Unorm,
    ...
    // Tests writing into a multi-plane texture fails.
    ...
    // Tests writing into a multi-plane texture per plane fails.
