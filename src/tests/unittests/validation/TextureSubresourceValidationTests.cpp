...
namespace {
    ...
    TEST_F(TextureSubresourceValidationTest, MipmapLevelsTest) {
        ...
        wgpu::TextureViewDescriptor samplerTextureView = CreateTextureViewDescriptor(0, 0);
        wgpu::TextureViewDescriptor renderTextureView = CreateTextureViewDescriptor(1, 0);
        ...
        renderPipelineDescriptor.cFragmentStage.module =
            CreateSampledTextureFragmentShaderForTest(device);
    ...
    TEST_F(TextureSubresourceValidationTest, ArrayLayersTest) {
        ...
        wgpu::TextureViewDescriptor samplerTextureView = CreateTextureViewDescriptor(0, 0);
        wgpu::TextureViewDescriptor renderTextureView = CreateTextureViewDescriptor(0, 1);
