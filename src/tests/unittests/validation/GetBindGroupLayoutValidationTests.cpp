...
TEST_F(GetBindGroupLayoutTests, UnusedIndex) {
    ...
    EXPECT_NE(pipeline.GetBindGroupLayout(0), nullptr);  // Used
    EXPECT_EQ(pipeline.GetBindGroupLayout(1), nullptr);  // Not used.
    EXPECT_NE(pipeline.GetBindGroupLayout(2), nullptr);  // Used.
    EXPECT_EQ(pipeline.GetBindGroupLayout(3), nullptr);  // Not used
}
