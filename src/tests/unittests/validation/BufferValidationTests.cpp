...
// Test SetSubData with unpacked size
TEST_F(BufferValidationTest, SetSubDataWithUnpackedSize) {
    dawn::BufferDescriptor descriptor;
    descriptor.size = 4;
...
// Test SetSubData with unpacked offset
TEST_F(BufferValidationTest, SetSubDataWithUnpackedOffset) {
    dawn::BufferDescriptor descriptor;
