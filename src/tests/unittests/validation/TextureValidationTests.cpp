...
class CompressedTextureFormatsValidationTests : public TextureValidationTest {
  protected:
    ...
    const std::array<dawn::TextureFormat, 14> kBCFormats = {
        dawn::TextureFormat::Bc1Unorm, dawn::TextureFormat::Bc1UnormSrgb,
        dawn::TextureFormat::Bc2Unorm, dawn::TextureFormat::Bc2UnormSrgb,
        dawn::TextureFormat::Bc3Unorm, dawn::TextureFormat::Bc3UnormSrgb,
        dawn::TextureFormat::Bc4Unorm, dawn::TextureFormat::Bc4Snorm,
        dawn::TextureFormat::Bc5Unorm, dawn::TextureFormat::Bc5Snorm,
        dawn::TextureFormat::Bc6hUfloat, dawn::TextureFormat::Bc6hSfloat,
        dawn::TextureFormat::Bc7Unorm, dawn::TextureFormat::Bc7UnormSrgb};
};
