...
// Check out of bounds condition on attribute offset
TEST_F(InputStateTest, SetAttributeOffsetOutOfBounds) {
    ...
    attribute.offset = 0;
    attribute.format = dawn::VertexFormat::UnormR8;
    AssertWillBeSuccess(device.CreateInputStateBuilder())
        .SetInput(&kBaseInput)
        .SetAttribute(&attribute)
        .GetResult();
...
// Check attribute offset alignment
TEST_F(InputStateTest, SetAttributeOffsetUnalignment) {
    // Control case, setting max attribute offset for FloatR32 vertex format
    dawn::VertexAttributeDescriptor attribute;
    attribute.shaderLocation = 0;
    attribute.inputSlot = 0;
    attribute.offset = kMaxVertexAttributeOffset;
    attribute.offset = kMaxVertexAttributeOffset + 1 - sizeof(dawn::VertexFormat::FloatR32);
    attribute.format = dawn::VertexFormat::FloatR32;
    AssertWillBeSuccess(device.CreateInputStateBuilder())
        .SetInput(&kBaseInput)
        .SetAttribute(&attribute)
    ...
    // Test attribute offset unalignment
    attribute.offset = kMaxVertexAttributeOffset;
    AssertWillBeError(device.CreateInputStateBuilder())
        .SetInput(&kBaseInput)
        .SetAttribute(&attribute)
