...
TEST_F(WireDawnDevicePropertiesTests, SerializeDawnDeviceProperties) {
    ...
    constexpr uint64_t kDawnDevicePropertiesSize = sizeof(DawnDeviceProperties);

    char buffer[sizeof(DawnDeviceProperties)];
    dawn_wire::SerializeDawnDeviceProperties(&sentDawnDeviceProperties, kDawnDevicePropertiesSize,
                                             buffer);

    DawnDeviceProperties receivedDawnDeviceProperties;
    dawn_wire::DeserializeDawnDeviceProperties(&receivedDawnDeviceProperties,
                                               kDawnDevicePropertiesSize, buffer);
