...
// This should be called if |apiDevice| is no longer exists on the wire. When it is removed,
// its uncapturedError and deviceLost callbacks are cleared to nullptr.
