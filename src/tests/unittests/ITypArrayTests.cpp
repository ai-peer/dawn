...
TEST_F(ITypArrayTest, Constexpr) {
    constexpr Array kArr = {Val(0), Val(1), Val(2), Val(3), Val(4),
...
// Test that the array can be is iterated in order with a range-based for loop
