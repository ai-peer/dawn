...
namespace {
    ...
    dawn_native::WorkaroundsController InitWorkaround(const char* forceEnabledWorkaround) {
        dawn_native::WorkaroundsController workaroundsController;
        dawn_native::Workarounds workaroundEnum =
            dawn_native::WorkaroundsController::WorkaroundStringToEnum(forceEnabledWorkaround);
        workaroundsController.ShouldWorkaroundBeUsed(workaroundEnum, true);
        return workaroundsController;
    }
...
void DawnTest::SetUp() {
    ...
    if (forceEnabledWorkaround != nullptr) {
        ...
        deviceDescriptor.workaroundsController = InitWorkaround(forceEnabledWorkaround);
