...
extern const DawnTestParam D3D12Backend(dawn_native::BackendType::D3D12);
extern const DawnTestParam MetalBackend(dawn_native::BackendType::Metal);
extern const DawnTestParam OpenGLBackend(dawn_native::BackendType::OpenGL);
extern const DawnTestParam VulkanBackend(dawn_native::BackendType::Vulkan);
