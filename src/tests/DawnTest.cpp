...
DawnTestEnvironment::DawnTestEnvironment(int argc, char** argv) {
    ...
    for (const dawn_native::Adapter& adapter : mInstance->GetAdapters()) {
        ...
        bool selected =
            ...
            // Always select Unknown adapters. Unfortunately OpenGL will always be unknown because
            // we can't query the device type.
            (adapter.GetDeviceType() == wgpu::AdapterType::Unknown) ||
