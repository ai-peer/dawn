...
=======
    dawn::native::DeviceType preferredDeviceType = static_cast<dawn::native::DeviceType>(-1);
    bool hasDevicePreference = false;
    for (dawn::native::DeviceType devicePreference : mDevicePreferences) {
        for (const dawn::native::Adapter& adapter : instance->GetAdapters()) {
>>>>>>> 8301d3bf (Rename namespace dawn_native to dawn::native.)
...
=======
                (preferredDeviceType != dawn::native::DeviceType::CPU &&
                 adapter.GetDeviceType() == dawn::native::DeviceType::Unknown &&
>>>>>>> 8301d3bf (Rename namespace dawn_native to dawn::native.)
