...
bool DawnTestBase::IsAMD() const {
    return mAdapterProperties.vendorID == kVendorID_AMD;
}

bool DawnTestBase::IsARM() const {
    return mAdapterProperties.vendorID == kVendorID_ARM;
}

bool DawnTestBase::IsImgTec() const {
    return mAdapterProperties.vendorID == kVendorID_ImgTec;
}

bool DawnTestBase::IsIntel() const {
    return mAdapterProperties.vendorID == kVendorID_Intel;
}

bool DawnTestBase::IsNvidia() const {
    return mAdapterProperties.vendorID == kVendorID_Nvidia;
}

bool DawnTestBase::IsQualcomm() const {
    return mAdapterProperties.vendorID == kVendorID_Qualcomm;
}
