...
std::ostringstream& DawnTest::AddTextureExpectation(const char* file,
    ...
    dawn::TextureCopyView textureCopyView = utils::CreateTextureCopyView(texture, level, 0, x, y, 0, dawn::TextureAspect::Color);
    dawn::BufferCopyView bufferCopyView = utils::CreateBufferCopyView(readback.buffer, readback.offset, rowPitch, 0);
