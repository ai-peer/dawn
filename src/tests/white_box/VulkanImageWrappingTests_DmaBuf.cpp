...
namespace dawn::native::vulkan {
    ...
    class VulkanImageWrappingTestBackendDmaBuf : public VulkanImageWrappingTestBackend {
      public:
        VulkanImageWrappingTestBackendDmaBuf(const wgpu::Device& device) : mDevice(device) {
        }
        ...
        wgpu::Texture WrapImage(
            ...
            descriptorDmaBuf.cTextureDescriptor = descriptor.cTextureDescriptor;
            descriptorDmaBuf.isInitialized = descriptor.isInitialized;
            descriptorDmaBuf.releasedOldLayout = descriptor.releasedOldLayout;
            descriptorDmaBuf.releasedNewLayout = descriptor.releasedNewLayout;
