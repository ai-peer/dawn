...
class InternalStorageBufferBindingTests : public DawnTest {
  protected:
    ...
    wgpu::ComputePipeline CreateComputePipelineWithInternalStorage() {
        ...
        wgpu::BindGroupLayoutEntry blgEntry;
        blgEntry.binding = 0;
        blgEntry.buffer.type = dawn_native::kInternalStorageBufferBinding;
        blgEntry.visibility = wgpu::ShaderStage::Compute;

        wgpu::BindGroupLayoutDescriptor bglDesc;
        bglDesc.entryCount = 1;
        bglDesc.entries = &blgEntry;
