...
namespace dawn_native { namespace vulkan {
        ...
        class VulkanImageWrappingTestBase : public DawnTest {
          public:
            ...
            gbm_device* CreateGbmDevice() {
                ...
                // [2] https://cs.chromium.org/chromium/src/ui/ozone/platform/wayland/gpu/drm_render_node_path_finder.cc
    ...
    TEST_P(VulkanImageWrappingValidationTests, MissingTextureDescriptor) {
        ASSERT_DEVICE_ERROR(wgpu::Texture texture = WrapVulkanImage(device, nullptr, defaultFd,
    ...
    TEST_P(VulkanImageWrappingValidationTests, InvalidTextureDescriptor) {
        ...
        ASSERT_DEVICE_ERROR(wgpu::Texture texture = WrapVulkanImage(device, &defaultDescriptor,
                defaultFd, defaultStride, defaultModifier, {}, true, false));
        EXPECT_EQ(texture.Get(), nullptr);
        close(defaultFd);
    }
    ...
    TEST_P(VulkanImageWrappingUsageTests, ClearImageAcrossDevices) {
        ...
        wgpu::Texture wrappedTexture = WrapVulkanImage(secondDevice, &defaultDescriptor,
                defaultFd, defaultStride, defaultModifier, {});
        ...
        wgpu::Texture nextWrappedTexture = WrapVulkanImage(device, &defaultDescriptor,
                nextFd, defaultStride, defaultModifier, {signalFd});
    ...
    TEST_P(VulkanImageWrappingUsageTests, ClearImageAcrossDevicesAliased) {
        ...
        wgpu::Texture nextWrappedTexture = WrapVulkanImage(device, &defaultDescriptor, nextFd,
                defaultStride, defaultModifier, {signalFd});
    ...
    TEST_P(VulkanImageWrappingUsageTests, UnclearedTextureIsCleared) {
        ...
        int nextFd = gbm_bo_get_fd(defaultGbmBo);
        wgpu::Texture nextWrappedTexture = WrapVulkanImage(device, &defaultDescriptor, nextFd,
                defaultStride, defaultModifier, {signalFd}, false);
    ...
    TEST_P(VulkanImageWrappingUsageTests, CopyTextureToTextureSrcSync) {
        ...
        // Import the image to |device|, making sure we wait on |signalFd|
        int nextFd = gbm_bo_get_fd(defaultGbmBo);
        wgpu::Texture deviceWrappedTexture = WrapVulkanImage(device, &defaultDescriptor, nextFd,
                defaultStride, defaultModifier, {signalFd});
    ...
    TEST_P(VulkanImageWrappingUsageTests, CopyTextureToTextureDstSync) {
        ...
        int signalFd = dawn_native::vulkan::ExportSignalSemaphoreOpaqueFD(
                device.Get(), wrappedTexture.Get());

        // Import the image to |secondDevice|, making sure we wait on |signalFd|
        int nextFd = gbm_bo_get_fd(defaultGbmBo);
        wgpu::Texture secondDeviceWrappedTexture = WrapVulkanImage(secondDevice,
                &defaultDescriptor, nextFd, defaultStride, defaultModifier, {signalFd});
    ...
    TEST_P(VulkanImageWrappingUsageTests, ChainTextureCopy) {
        ...
        wgpu::Texture wrappedTexADevice3 = WrapVulkanImage(
            thirdDevice, &defaultDescriptor, fdA, strideA, modifierA, {});

        wgpu::Texture wrappedTexBDevice3 = WrapVulkanImage(
            thirdDevice, &defaultDescriptor, fdB, strideB, modifierB, {});
        ...
        wgpu::Texture wrappedTexBDevice2 = WrapVulkanImage(secondDevice, &defaultDescriptor, fdB,
                strideB, modifierB, {signalFdTexBDevice3});

        wgpu::Texture wrappedTexCDevice2 = WrapVulkanImage(secondDevice, &defaultDescriptor, fdC,
                strideC, modifierC, {});
        ...
        wgpu::Texture wrappedTexCDevice1 = WrapVulkanImage(device, &defaultDescriptor, fdC,
                strideC, modifierC, {signalFdTexCDevice2});
    ...
    TEST_P(VulkanImageWrappingUsageTests, LargerImage) {
        ...
        // Import the image on |secondDevice|
        wgpu::Texture wrappedTexture = WrapVulkanImage(secondDevice, &descriptor, fd, stride,
                modifier, {});
        ...
        // Import the image on |device|
        wgpu::Texture nextWrappedTexture = WrapVulkanImage(device, &descriptor, nextFd, stride,
                modifier, {signalFd});
