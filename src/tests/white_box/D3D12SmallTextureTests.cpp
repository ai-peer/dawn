...
TEST_P(D3D12SmallTextureTests, AlignSmallCompressedTexture) {
    ...
    wgpu::Texture texture = utils::Create2DTexture(device, 8, 8, wgpu::TextureFormat::BC1RGBAUnorm,
    ...
    texture = utils::Create2DTexture(device, kWidth, kHeight, wgpu::TextureFormat::BC1RGBAUnorm,
                                     wgpu::TextureUsage::Sampled);
