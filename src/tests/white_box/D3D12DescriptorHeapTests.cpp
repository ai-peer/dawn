...
// Verify shader-visible heaps that are pool-allocated can be recycled for multiple submits.
// Switches over |kFrameDepth| x 2 times using small heaps which can only be pool-allocated.
