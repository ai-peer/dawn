...
TEST_P(D3D12DescriptorHeapTests, EncodeManyUBOAndSamplers) {
...

    {
        ...
        const Serial viewHeapSerial = viewAllocator->GetShaderVisibleHeapSerial();
        const Serial samplerHeapSerial = samplerAllocator->GetShaderVisibleHeapSerial();
        ...
        EXPECT_EQ(viewAllocator->GetShaderVisibleHeapSerial(), viewHeapSerial + kNumOfViewHeaps);
        ...
        EXPECT_EQ(samplerAllocator->GetShaderVisibleHeapSerial(),
