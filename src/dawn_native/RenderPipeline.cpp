...
namespace dawn_native {
    ...
    namespace {
        ...
        MaybeError ValidateVertexState(DeviceBase* device,
            ...
            DAWN_TRY(ValidateProgrammableStageDescriptor(device, AsProgrammableStage(descriptor),
        ...
        // TODO: Validation methods below here are for the deprecated RenderPipelineDescriptor
        // format and should be removed once it is no longer necessary to validate that format.
    ...
    const ProgrammableStageDescriptor* AsProgrammableStage(const VertexState* descriptor) {
        return reinterpret_cast<const ProgrammableStageDescriptor*>(descriptor);
    }
