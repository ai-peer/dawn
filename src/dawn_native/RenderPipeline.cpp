    ...
    namespace {
        ...
        MaybeError ValidateVertexAttribute(
            ...
            DAWN_INVALID_IF(
                ...
                "Attribute offset (%u) with format %s (size: %u) exeeds the maximum vertex buffer "
                "stride (%u).",
            ...
            DAWN_INVALID_IF(
                ...
                "Attribute offset (%u) with format %s (size: %u) exeeds the vertex buffer "
                "stride (%u).",
            ...
            // FIXME(dawn:563): what can I print about these formats?
            DAWN_INVALID_IF(metadata.usedVertexInputs[location] &&
                                formatInfo.baseType != metadata.vertexInputBaseTypes[location],
                            "Attribute base type does not match the base type in the shader.");
        ...
        MaybeError ValidateVertexState(DeviceBase* device,
            ...
            DAWN_TRY_CONTEXT(
                ...
                "validating vertex shader module %s.", descriptor->module);
        ...
        MaybeError ValidateColorTargetState(
            ...
            if (fragmentWritten) {
                DAWN_INVALID_IF(fragmentOutputVariable.baseType !=
                                ...
                                "Color format (%s) does not match the fragment stage output type.",
                                descriptor->format);
        ...
        MaybeError ValidateFragmentState(DeviceBase* device,
            ...
            DAWN_TRY_CONTEXT(
                ...
                "validating fragment shader module %s.", descriptor->module);
        ...
        MaybeError ValidateInterStageMatching(DeviceBase* device,
            ...
            for (size_t i : IterateBitSet(vertexMetadata.usedInterStageVariables)) {
                ...
                DAWN_INVALID_IF(
                    ...
                    "The base type of the vertex output at location %u is different from the "
                    "base type of the fragment input at location %u.",
                    i, i);
                ...
                DAWN_INVALID_IF(
                    ...
                    "The interpolation type of the vertex output at location %u is different from "
                    "the interpolation type of the fragment input at location %u.",
                    i, i);

                DAWN_INVALID_IF(
                    vertexOutputInfo.interpolationSampling !=
                        fragmentInputInfo.interpolationSampling,
                    "The interpolation sampling of the vertex output at location %u is different "
                    "from the interpolation sampling of the fragment input at location %u.",
                    i, i);
            }
