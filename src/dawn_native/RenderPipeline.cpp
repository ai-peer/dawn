...
#include "dawn_native/ChainUtils.h"
...
namespace dawn_native {
    ...
    RenderPipelineBase::RenderPipelineBase(DeviceBase* device,
        ...
        const ChainedStruct* clampChain = FindInChain(mPrimitive.nextInChain,
            wgpu::SType::PrimitiveDepthClampingState);
        if (clampChain) {
            const auto* clampInfo = static_cast<const PrimitiveDepthClampingState*>(clampChain);
