...
namespace dawn_native {
    ...
    struct InternalPipelineStore {
        ...
        std::unordered_map<uint32_t, Ref<RenderPipelineBase>> CopyTextureForBrowserPipeline;
        Ref<ShaderModuleBase> CopyTextureForBrowserVS;
        std::unordered_map<uint32_t, Ref<ShaderModuleBase>> CopyTextureForBrowserFS;
    };
}  // namespace dawn_native
