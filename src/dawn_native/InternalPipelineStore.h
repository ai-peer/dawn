...
#include "dawn_native/pipelines/InternalPipelineUtils.h"
...
namespace dawn_native {
    ...
    class InternalPipelineStore : public ObjectBase {
      public:
        IntenralPipelineStore(DeviceBase* device);
        ~InternalPipelineStore();

        const RenderPipelineBase* GetBlitTextureForBrowserPipeline(wgpu::TextureDimension srcDim,
