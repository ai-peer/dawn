...
#ifndef DAWNNATIVE_ALLOCATOR_H_
#define DAWNNATIVE_ALLOCATOR_H_
...
namespace dawn_native {
    ...
    // Uses a single buddy allocator with multiple resource heaps.
    //
    // Creates a large buddy system using a fixed resource heap size.
    // When the buddy system allocates a block, the resource heap will be created on-demand.
    ...
    class BuddyResourceMemoryAllocator {
      public:
        ...
        // Required methods.
        ResourceMemoryAllocation Allocate(size_t allocationSize, int heapFlags = 0);
...
#include "dawn_native/Allocator.cpp"
#endif  // DAWNNATIVE_ALLOCATOR_H_
