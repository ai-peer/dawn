...
namespace dawn_native { namespace vulkan {
    ...
    enum class InstanceLayer {
        ...
        // Fuchsia implements the swapchain through a layer (VK_LAYER_FUCHSIA_image_pipe_swapchain), which adds an instance extensions (VK_FUCHSIA_image_surface) to all ICDs.
    ...
    using InstanceLayerSet = ityp::bitset<InstanceLayer, static_cast<uint32_t>(InstanceLayer::EnumCount)>;
