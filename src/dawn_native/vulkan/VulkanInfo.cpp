    ...
    ResultOrError<VulkanGlobalInfo> GatherGlobalInfo(const Backend& backend) {
        ...
        // Gather the info about the instance layers
        {
            ...
            for (const auto& layer : info.layers) {
                ...
                //   a handle to the buffer managed by the 'sysmem' system service,
                //   which manages all kind of buffers shared between Fuchsia processes.
                //
                ...
                //   performance.
                //
                // For now, only use the second one, which is by far the simplest
                // and most useful.
