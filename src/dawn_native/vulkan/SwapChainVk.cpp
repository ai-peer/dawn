...
namespace dawn_native { namespace vulkan {
            ...
            switch (surface->GetType()) {
                ...
                case Surface::Type::WindowsHWND:
                    if (info.HasExt(InstanceExt::Win32Surface)) {
                        ...
                        createInfo.pNext = nullptr;
                        createInfo.flags = 0;
                        createInfo.hinstance = surface->GetHInstance();
                        createInfo.hwnd = surface->GetHWND();
                ...
                case Surface::Type::Xlib:
                    if (info.HasExt(InstanceExt::XlibSurface)) {
                        ...
                        createInfo.pNext = nullptr;
                        createInfo.flags = 0;
                        createInfo.dpy = surface->GetXDisplay();
    ...
    MaybeError SwapChain::Initialize(NewSwapChainBase* previousSwapChain) {
        ...
        if (mConfig.needsBlit) {
            // TODO create blit texture if needed.
        } else {
    ...
    ResultOrError<SwapChain::Config> SwapChain::ChooseConfig(
        ...
        // FIFO.
        {
            ...
            const VkPresentModeKHR kPresentModeFallbacks[] = {
        ...
        if (config.needsBlit) {
            ...
            // then we'll need to have a single fallback with a blit shader :(
    ...
    MaybeError SwapChain::PresentImpl() {
        ...
        if (result == VK_ERROR_OUT_OF_DATE_KHR) {
            // This present is lost, re-initialize the VkSwapchain but we can't do anything else.
