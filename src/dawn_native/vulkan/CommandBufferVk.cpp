    ...
    MaybeError CommandBuffer::RecordCommands(CommandRecordingContext* recordingContext) {
        ...
        auto TransitionForPass = [](Device* device, CommandRecordingContext* recordingContext,
            ...
            for (size_t i = 0; i < usages.textures.size(); ++i) {
                ...
                texture->TransitionUsageForPass(
                    recordingContext, usages.textureUsages[i].sameUsagesAcrossSubresources,
                    usages.textureUsages[i].subresourceUsages, &imageBarriers, &srcStages,
                    &dstStages);
            }
