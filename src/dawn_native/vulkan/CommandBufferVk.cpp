...
namespace dawn_native { namespace vulkan {
    ...
    void CommandBuffer::RecordCopyImageWithTemporaryBuffer(
        ...
        // The ref count of *tempBuffer should be 3 (tempBuffer, tempBufferCopy.buffer and
        // recordingContext->tempBuffers.back()) at the end of this function so that it can be
        // released correctly when all these Ref<> objects are released.
        ASSERT(tempBuffer->GetRefCount() == 3u);
    }
