    ...
    namespace {
        ...
        void RecordBeginRenderPass(VkCommandBuffer commands,
            ...
            uint32_t attachmentCount = 0;
            {
                ...
                createInfo.width = renderPassCmd->width;
                createInfo.height = renderPassCmd->height;
                createInfo.layers = 1;
            ...
            beginInfo.renderArea.extent.width = renderPassCmd->width;
            beginInfo.renderArea.extent.height = renderPassCmd->height;
