...
namespace dawn_native { namespace vulkan {
    ...
    void CommandBuffer::RecordCopyImageWithTemporaryBuffer(
        ...
        recordingContext->tempBuffers.emplace_back(device->CreateBuffer(&tempBufferDescriptor));
        BufferCopy tempBufferCopy;
        tempBufferCopy.buffer = recordingContext->tempBuffers.back();
        ...
        ToBackend(recordingContext->tempBuffers.back())
        ...
        device->fn.CmdCopyImageToBuffer(
            commands, srcImage, VK_IMAGE_LAYOUT_GENERAL,
            ToBackend(recordingContext->tempBuffers.back())->GetHandle(), 1,
        ...
        device->fn.CmdCopyBufferToImage(
            commands, ToBackend(recordingContext->tempBuffers.back())->GetHandle(), dstImage,
            VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, 1, &tempBufferToDstRegion);
    }
