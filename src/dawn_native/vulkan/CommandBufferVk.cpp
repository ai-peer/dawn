        ...
        void RecordBeginRenderPass(VkCommandBuffer commands,
            ...
            VkRenderPass renderPassVK = VK_NULL_HANDLE;
            {
                ...
                for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                    ...
                    ASSERT(attachmentInfo.view->GetLevelCount() == 1);
                    ASSERT(attachmentInfo.view->GetLayerCount() == 1);
        ...
        while (mCommands.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::CopyBufferToTexture: {
                    ...
                    dst.texture->SetIsSubresourceContentInitialized(subresource.mipLevel, 1,
                ...
                case Command::CopyTextureToTexture: {
                    ...
                    dst.texture->SetIsSubresourceContentInitialized(dstSubresource.mipLevel, 1,
