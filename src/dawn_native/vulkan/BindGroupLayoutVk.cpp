...
namespace dawn_native { namespace vulkan {
    ...
    MaybeError BindGroupLayout::Initialize() {
        ...
        // counts.
        mDescriptorSetAllocator = AcquireRef(new DescriptorSetAllocator(
            ToBackend(GetDevice()), mHandle, std::move(descriptorCountPerType)));
        return {};
    }
    ...
    BindGroupLayout::~BindGroupLayout() {
        ...
        // However, Swiftshader isn't correct in this regard, so we still use the FencedDeleter.
        // TODO(b/154522740): Delete immediately when this bug is resolved.
