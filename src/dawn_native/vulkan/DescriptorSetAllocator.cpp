...
namespace dawn_native { namespace vulkan {
    ...
    DescriptorSetAllocator::DescriptorSetAllocator(
        ...
        : RefCounted(), mDevice(device), mDescriptorSetLayout(descriptorSetLayout) {
    ...
    void DescriptorSetAllocator::Tick(Serial completedSerial) {
    ...
    MaybeError DescriptorSetAllocator::AllocateDescriptorPool() {
        ...
        DAWN_TRY(CheckVkSuccess(mDevice->fn.CreateDescriptorPool(
                                    mDevice->GetVkDevice(), &createInfo, nullptr, &*descriptorPool),
                                "CreateDescriptorPool"));

        std::vector<VkDescriptorSetLayout> layouts(mMaxSets, mDescriptorSetLayout);
