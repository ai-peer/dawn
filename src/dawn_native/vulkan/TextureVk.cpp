                ...
                if (mipLevel < levelCount - 1 || arrayLayer < layerCount - 1) {
                    ...
                    if (levelCount == 1) {
                        ...
                        barriers.push_back(BuildMemoryBarrier(format, mHandle, srcUsage, usage,
                                                              startLevel, totalLevels, startLayer,
                                                              1));
                    } else {
                        ...
                        if (!startLevel) {
                            ...
                            barriers.push_back(
                                BuildMemoryBarrier(format, mHandle, srcUsage, usage, startLevel,
                                                   levelCount - startLevel, startLayer, 1));
                        }
                        ...
                        if (curSrcUsage == srcUsage) {
                            ...
                            if (mipLevel > 0) {
                                barriers.push_back(BuildMemoryBarrier(
                                    format, mHandle, srcUsage, usage, 0, mipLevel, arrayLayer, 1));
                            }
                        }
                        // Build memory barrier for the middle if needed
                        if (fullLayers >= 1) {
                            barriers.push_back(BuildMemoryBarrier(format, mHandle, srcUsage, usage,
                                                                  0, levelCount, startLayer,
                                                                  fullLayers));
                        }
                    }
