...
namespace dawn_native { namespace vulkan {
    ...
    BindGroup::BindGroup(Device* device,
        ...
        ityp::array_vec<uint32_t, VkWriteDescriptorSet, kMaxOptimalBindingsPerGroup> writes(
            bindingCount);
        ityp::array_vec<uint32_t, VkDescriptorBufferInfo, kMaxOptimalBindingsPerGroup>
            writeBufferInfo(bindingCount);
        ityp::array_vec<uint32_t, VkDescriptorImageInfo, kMaxOptimalBindingsPerGroup>
