...
namespace dawn_native { namespace vulkan {
    ...
    ResultOrError<VulkanDeviceKnobs> Device::CreateDevice(VkPhysicalDevice physicalDevice) {
        ...
        DeviceExtSet extensionsToRequest = mDeviceInfo.extensions;

        // TODO(cwallez@chromium.org): figure out if some extensions have drawbacks when just
        // enabled, and disable them (unless needed for a requested WebGPU feature).
