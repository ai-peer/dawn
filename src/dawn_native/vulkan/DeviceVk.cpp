...
namespace dawn_native { namespace vulkan {
    ...
    CommandRecordingContext* Device::GetPendingCommandRecordingContext() {
        return &mCommandRecordingContext;
    }
    ...
    void Device::SubmitPendingCommands() {
        ...
        for (VkSemaphore semaphore : mCommandRecordingContext.waitSemaphores) {
            AddWaitSemaphore(semaphore);
        }

        for (VkSemaphore semaphore : mCommandRecordingContext.signalSemaphores) {
            AddSignalSemaphore(semaphore);
        }

        mCommandRecordingContext = CommandRecordingContext();
