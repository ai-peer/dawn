...
namespace dawn_native { namespace vulkan {
    ...
    PipelineCache::PipelineCache(Device* device) : PipelineCacheBase(device), mDevice(device) {
    ...
    MaybeError PipelineCache::storePipelineCache() {
        ...
        // TODO: Figure out if it's possible for the cache size to change between calls to
        // vkvkGetPipelineCacheData.
