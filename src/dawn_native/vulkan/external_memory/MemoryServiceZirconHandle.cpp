...
namespace dawn_native { namespace vulkan { namespace external_memory {
    ...
    ResultOrError<VkDeviceMemory> Service::ImportMemory(ExternalMemoryHandle handle,
        ...
        importMemoryHandleInfo.sType = VK_STRUCTURE_TYPE_TEMP_MEMORY_ZIRCON_HANDLE_PROPERTIES_FUCHSIA;
        importMemoryHandleInfo.pNext = nullptr;
        importMemoryHandleInfo.handleType = VK_EXTERNAL_MEMORY_HANDLE_TYPE_TEMP_ZIRCON_VMO_BIT_FUCHSIA;
