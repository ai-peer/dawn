...
namespace dawn_native { namespace vulkan {
    ...
    namespace {
        ...
        void ComputeDepthStencilDesc(VkPipelineDepthStencilStateCreateInfo* depthStencilState,
            ...
            depthStencilState->stencilTestEnable = stencilTestEnabled ? VK_TRUE : VK_FALSE;
    ...
    RenderPipeline::RenderPipeline(Device* device, const RenderPipelineDescriptor* descriptor)
        ...
        ComputeDepthStencilDesc(&depthStencilState, StencilTestEnabled(),
