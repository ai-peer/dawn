...
namespace dawn_native { namespace vulkan {
    ...
    namespace {
        ...
        VkColorComponentFlags VulkanColorWriteMask(dawn::ColorWriteMask mask,
            ...
            return isUsedInFragmentShader ? static_cast<VkColorComponentFlags>(mask)
        ...
        VkPipelineColorBlendAttachmentState ComputeColorDesc(const ColorStateDescriptor* descriptor,
            ...
            attachment.colorWriteMask =
                VulkanColorWriteMask(descriptor->writeMask, isUsedInFragmentShader);
            return attachment;
        }
    ...
    RenderPipeline::RenderPipeline(Device* device, const RenderPipelineDescriptor* descriptor)
        ...
        for (uint32_t i : IterateBitSet(GetColorAttachmentsMask())) {
            ...
            bool usedInFragmentOutput = fragmentOutputBaseTypes[i] != Format::Other;
            colorBlendAttachments[i] = ComputeColorDesc(colorStateDescriptor, usedInFragmentOutput);
        }
