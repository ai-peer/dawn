...
namespace dawn_native { namespace vulkan {
    ...
    MaybeError RenderPipeline::Initialize() {
        ...
        std::unique_ptr<VkPipelineColorBlendStateCreateInfo> colorBlend;
        ...
        if (GetStageMask() & wgpu::ShaderStage::Fragment) {
            ...
            colorBlend = std::make_unique<VkPipelineColorBlendStateCreateInfo>();
        ...
        createInfo.pColorBlendState = colorBlend.get();
