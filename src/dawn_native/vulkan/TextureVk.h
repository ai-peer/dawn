...
namespace dawn_native { namespace vulkan {
    ...
    class Texture final : public TextureBase {
      ...
      private:
        ...
        // Says whether we should go down the path of combining depth and stencil barriers together
        // to work around the limitation in base Vulkan that depth and stencil can only be
