...
namespace dawn_native { namespace vulkan {
    ...
    class ResourceMemoryAllocator::SingleTypeAllocator : public MemoryAllocator {
      public:
        ...
        ResultOrError<std::unique_ptr<ResourceHeapBase>> AllocateResourceHeap(
            ...
            // Handle vkAllocateMemory error but differentiate OOM that we want to sureface to
            // the application.
