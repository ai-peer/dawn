...
namespace dawn_native {
    ...
    class BindGroupLayoutBase : public CachedObject {
      public:
        ...
        BindingIndex GetUnverifiedBufferCount() const;
      ...
      private:
        ...
        BindingIndex mUnverifiedBufferCount = 0;  // Buffers with minimum buffer size unspecified
