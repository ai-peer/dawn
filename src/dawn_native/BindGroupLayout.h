...
#include "common/TypeIndexedArray.h"
#include "common/TypeIndexedSpan.h"
    ...
    class BindGroupLayoutBase : public CachedObject {
      public:
        ...
        struct BindingDataPointers {
            TypeIndexedSpan<BindingIndex, BufferBindingData> const bufferData = {};
            TypeIndexedSpan<BindingIndex, Ref<ObjectBase>> const bindings = {};
        };
      ...
      private:
        ...
        TypeIndexedArray<BindingIndex, BindingInfo, kMaxBindingsPerGroup> mBindingInfo;
