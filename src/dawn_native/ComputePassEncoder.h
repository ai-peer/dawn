...
namespace dawn_native {
    ...
    class ComputePassEncoder final : public ProgrammablePassEncoder {
      ...
      private:
        ...
        // Mark the bindgroups for the current dispatch state as used a return a
        // SyncScopeUsageTracker containing their resources.
        SyncScopeUsageTracker UseBindGroupsInDispatch();
    };
