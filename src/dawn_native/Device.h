...
namespace dawn_native {
    ...
    class DeviceBase {
      public:
        ...
        void LoseForTesting();
        void SetFutureCallbackSerial(Serial serial);
      ...
      private:
        ...
        // mFutureCallbackSerial tracks the largest serial a map operation has been mapped to, and
        // we need to tick to that serial for the callbacks to fire
