...
namespace dawn_native {
    ...
    class DeviceBase {
      public:
        ...
        RefCountedTracker* GetRefCountedTracker() const;
      ...
      protected:
        ...
        // RefCountedTracker helps keep resources alive until the next queue submit finishes
        std::unique_ptr<RefCountedTracker> mRefCountedTracker;
