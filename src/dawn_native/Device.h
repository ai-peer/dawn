...
namespace dawn_native {
    ...
    class DeviceBase : public RefCounted {
      public:
        ...
        ExecutionSerial GetFutureSerial();
        ...
        dawn_platform::WorkerTaskPool* GetWorkerTaskPool();
      ...
      protected:
        ...
        friend class ComputePipelineAsyncTask;
      ...
      private:
        ...
        class ConcurrentExecutionSerial {
          public:
            ConcurrentExecutionSerial() : mSerial(ExecutionSerial(0)) {
            }

            ExecutionSerial GetSerial() {
                std::lock_guard<std::mutex> lock(mMutex);
                return mSerial;
            }

            void TestAndSetGreaterSerial(ExecutionSerial serial) {
                std::lock_guard<std::mutex> lock(mMutex);
                if (serial > mSerial) {
                    mSerial = serial;
                }
