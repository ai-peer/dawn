...
namespace dawn_native {
    ...
    class BindGroupAndStorageBarrierTrackerBase
      ...
      protected:
        std::array<TypedBitset<BindingIndex, kMaxBindingsPerGroup>, kMaxBindGroups>
            mBindingsNeedingBarrier = {};
        std::array<TypeIndexedArray<BindingIndex, wgpu::BindingType, kMaxBindingsPerGroup>,
                   kMaxBindGroups>
            mBindingTypes = {};
        std::array<TypeIndexedArray<BindingIndex, ObjectBase*, kMaxBindingsPerGroup>,
                   kMaxBindGroups>
            mBindings = {};
    };
