...
namespace dawn_native {
    ...
    Aspect SelectFormatAspects(const Format& format, wgpu::TextureAspect aspect) {
        switch (aspect) {
            ...
            // A per plane view |format| with a color aspect must be selected with a plane
            // aspect while a texture |format| aspect is equal to all plane aspects. Since |format|
