...
namespace dawn_native {
    ...
    uint8_t* CommandAllocator::Allocate(uint32_t commandId,
        ...
        static constexpr size_t kWorstCaseAdditionalSize = sizeof(uint32_t) + kMaxSupportedAlignment +
        ...
        *idAlloc = EndOfBlock;
        ...
        // We'll request a block that can contain at least the command ID, the command and an addiotnal
        // ID to contain the EndOfBlock tag.
