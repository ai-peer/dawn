...
namespace dawn_native {
    ...
    const uint32_t kMaxDrawCallsPerIndirectValidationBatch = kMaxComputePerDimensionDispatchSize;
        ...
        for (auto& entry : bufferInfoMap) {
            ...
            for (const IndirectDrawMetadata::IndexedIndirectValidationBatch& batch :
                ...
                if (validatedParamsSize > kMaxStorageBufferBindingSize) {
                    return DAWN_VALIDATION_ERROR("Too many drawIndexedIndirect calls to validate");
                }
