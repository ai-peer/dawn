...
#ifndef DAWNNATIVE_PIPELINES_INTERNALPIPELINEUTILS_H_
#define DAWNNATIVE_PIPELINES_INTERNALPIPELINEUTILS_H_
...
namespace dawn_native {
    ...
    static constexpr std::array<InternalShaderType, kInternalShaderCount> kAllInternalShaders = {
        ...
        InternalShaderType::Passthrough4Channel2DTexturesFragment,
    };
...
#endif  // DAWNNATIVE_PIPELINES_INTERNALPIPELINEUTILS_H_
