...
#ifndef DAWNNATIVE_PIPELINES_BLITTEXTUREFORBROWSERPIPELINEINFO_H_
#define DAWNNATIVE_PIPELINES_BLITTEXTUREFORBROWSERPIPELINEINFO_H_
...
#endif  // DAWNNATIVE_PIPELINES_BLITTEXTUREFORBROWSERPIPELINEINFO_H_
