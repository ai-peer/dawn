...
namespace dawn_native { namespace metal {
    ...
    void Device::SetCompletedCommandSerialImpl(Serial completedSerial) {
    ...
    MaybeError Device::TickImpl() {
        ...
        if (mCommandContext.GetCommands() != nil) {
            ...
            SetCompletedCommandSerialImpl(completedSerial + 1);
    ...
    void Device::SubmitPendingCommandBuffer() {
        ...
        [pendingCommands addCompletedHandler:^(id<MTLCommandBuffer>) {
            ...
            this->SetCompletedCommandSerialImpl(pendingSerial);
        }];
    ...
    MaybeError Device::WaitForIdleForDestruction() {
        ...
        SetCompletedCommandSerialImpl(mCompletedSerial + 1);
        IncrementLastSubmittedCommandSerial();
