...
namespace dawn_native { namespace metal {
    ...
    id<MTLCommandBuffer> Device::GetPendingCommandBuffer() {
        TRACE_EVENT0(GetPlatform(), dawn_platform::TraceCategory::General,
    ...
    void Device::SubmitPendingCommandBuffer() {
        ...
        [mPendingCommands addCompletedHandler:^(id<MTLCommandBuffer>) {
            TRACE_EVENT_ASYNC_END0(GetPlatform(), dawn_platform::TraceCategory::GPU,
        ...
        TRACE_EVENT_ASYNC_BEGIN0(GetPlatform(), dawn_platform::TraceCategory::GPU,
                                 "DeviceMTL::SubmitPendingCommandBuffer", pendingSerial);
