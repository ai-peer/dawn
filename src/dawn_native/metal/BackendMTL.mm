...
namespace dawn_native { namespace metal {
    ...
    namespace {
        ...
        std::map<std::string, uint32_t> kVendorIdMap = {
            {kVendorName_AMD, kVendorID_AMD},          {kVendorName_ARM, kVendorID_ARM},
            {kVendorName_ATI, kVendorID_AMD},          {kVendorName_ImgTec, kVendorID_ImgTec},
            {kVendorName_Intel, kVendorID_Intel},      {kVendorName_Nvidia, kVendorID_Nvidia},
            {kVendorName_Qualcomm, kVendorID_Qualcomm}};
