...
#    error "Unsupported Apple platform."
        ...
        if (@available(macOS 10.15, iOS 14.0, *)) {
            // The counter set names and counter names of Timestamp query and PipelineStatistics
            // query
            const std::map<MTLCommonCounterSet, std::vector<MTLCommonCounter>> kGPUCounters{
