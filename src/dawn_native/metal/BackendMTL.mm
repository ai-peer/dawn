...
#define FEATURE_INFO(X)                                                                                                       \
    ...
    X(uint32_t,                  maxTotalThreadgroupMemory, 16352, 16352, 16384, 32768, 32768, 32768, 32768,  32768, 32768 )  \
    ...
    X(uint32_t,                   minBufferOffsetAlignment,     4,     4,     4,     4,     4,     4,     4,    256,   256 )
                // clang-format on
...
#undef SWITCH_CASE
                ...
                limits->v1.minUniformBufferOffsetAlignment =
                    mtlFeatureInfo.minBufferOffsetAlignment;
