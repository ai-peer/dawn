...
namespace dawn_native { namespace metal {
    ...
    class CommandRecordingContext {
      public:
        ...
        CommandRecordingContext(id<MTLCommandBuffer> commands) : mCommands(commands) {
        }
        ...
        CommandRecordingContext(CommandRecordingContext&& rhs) : mCommands(rhs.AcquireCommands()) {
        }
