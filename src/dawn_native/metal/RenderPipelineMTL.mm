...
namespace dawn_native { namespace metal {
    ...
    MaybeError RenderPipeline::Initialize() {
        ...
        DAWN_TRY(CreateFunctionWithConstantValues(vertexStage, SingleShaderStage::Vertex,
        ...
        if (GetStageMask() & wgpu::ShaderStage::Fragment) {
            ...
            DAWN_TRY(CreateFunctionWithConstantValues(fragmentStage, SingleShaderStage::Fragment,
