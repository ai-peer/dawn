...
namespace dawn_native { namespace metal {
    ...
    MaybeError RenderPipeline::Initialize(const RenderPipelineDescriptor* descriptor) {
        ...
        DAWN_TRY(vertexModule->CreateFunctionWithSPIRVCross(
            vertexEntryPoint, SingleShaderStage::Vertex, ToBackend(GetLayout()), &vertexData,
            0xFFFFFFFF, this));
        ...
        DAWN_TRY(fragmentModule->CreateFunctionWithSPIRVCross(
            fragmentEntryPoint, SingleShaderStage::Fragment, ToBackend(GetLayout()), &fragmentData,
