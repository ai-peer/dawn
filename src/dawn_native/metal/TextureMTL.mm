...
#    error "Unsupported Apple platform."
    ...
    Texture::Texture(Device* device, const TextureDescriptor* descriptor)
        ...
        if (device->IsToggleEnabled(Toggle::NonzeroClearResourcesOnCreationForTesting)) {
            ...
            device->ConsumedError(ClearTexture(range, TextureBase::ClearValue::NonZero));
        }
    }
    ...
    MaybeError Texture::ClearTexture(const Subresource& range, TextureBase::ClearValue clearValue) {
            ...
            if (GetFormat().HasDepthOrStencil()) {
                ...
                for (uint32_t level = range.baseMipLevel;
                    ...
                    for (uint32_t arrayLayer = range.baseArrayLayer;
                        ...
                        SubresourceRange subresource = {level, 1, arrayLayer, 1};
