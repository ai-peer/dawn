...
namespace dawn_native { namespace metal {
        ...
        MTLTextureType MetalTextureType(dawn::TextureDimension dimension,
            ...
            switch (dimension) {
                case dawn::TextureDimension::e2D:
                    // MTLTextureType2DMultisampleArray requires macOS 10.14+, so currently we don't
                    // support it.
                    if (sampleCount > 1) {
        ...
        MTLTextureType MetalTextureViewType(dawn::TextureViewDimension dimension,
            ...
            switch (dimension) {
                case dawn::TextureViewDimension::e2D:
                    return (sampleCount > 1) ? MTLTextureType2DMultisample
                                             : MTLTextureType2D;
    ...
    MTLTextureDescriptor* CreateMetalTextureDescriptor(const TextureDescriptor* descriptor) {
        ...
        mtlDesc.textureType =
            MetalTextureType(descriptor->dimension, descriptor->arrayLayerCount,
