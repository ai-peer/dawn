...
namespace dawn_native::metal {
    ...
    ResultOrError<std::string> ShaderModule::TranslateToMSL(
        ...
        TRACE_EVENT_BEGIN0(GetDevice()->GetPlatform(), General, "tint::writer::msl::Generate");
        auto result = tint::writer::msl::Generate(&program, options);
        TRACE_EVENT_END0(GetDevice()->GetPlatform(), General, "tint::writer::msl::Generate");
...
#pragma clang diagnostic ignored "-Wall"
        ...
        TRACE_EVENT_BEGIN0(GetDevice()->GetPlatform(), General, "MTLDevice::newLibraryWithSource");
