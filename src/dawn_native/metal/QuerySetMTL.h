...
namespace dawn_native { namespace metal {
    ...
    class QuerySet final : public QuerySetBase {
      public:
        ...
        id<MTLCounterSampleBuffer> GetCounterSampleBuffer() const API_AVAILABLE(macos(10.15));
      ...
      private:
        ...
        id<MTLCounterSampleBuffer> mCounterSampleBuffer API_AVAILABLE(macos(10.15)) = nil;
    };
