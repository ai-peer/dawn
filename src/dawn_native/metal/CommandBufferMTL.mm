        ...
        struct StorageBufferLengthTracker {
            ...
            void Apply(id<MTLRenderCommandEncoder> render,
                ...
                if (stagesToApply & wgpu::ShaderStage::Vertex) {
                    ...
                    if (device->IsToggleEnabled(Toggle::MetalEnableVertexPulling)) {
        ...
        auto EncodeRenderBundleCommand = [&](CommandIterator* iter, Command type) {
            switch (type) {
                case Command::Draw: {
                    ...
                    vertexBuffers.Apply(encoder, lastPipeline, ToBackend(GetDevice()));
                    bindGroups.Apply(encoder);
                    storageBufferLengths.Apply(encoder, lastPipeline, ToBackend(GetDevice()));
