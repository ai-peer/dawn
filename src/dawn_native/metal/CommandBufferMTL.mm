...
namespace dawn_native { namespace metal {
    ...
    namespace {
        ...
        void ResolveInAnotherRenderPass(
            ...
            // All the members in BeginRenderPassCmd have not been initialized, so we do this
            // initialization here to prevent some flaky issues caused by undefined values.
            renderPassForResolve.hasDepthStencilAttachment = false;
