    ...
    namespace {
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptorImpl(
            ...
            for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                ...
                TextureBase* colorTexture = attachmentInfo.view->GetTexture();
                if (colorTexture == nil) {
                    printf("Error: color texture is nil.\n");
                }
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptor(
            ...
            if (appliedRenderPass.hasDepthStencilAttachment) {
            ...
            return CreateMTLRenderPassDescriptorImpl(&appliedRenderPass,
        ...
        void ResolveInAnotherRenderPass(
            ...
            printf("Resolve in another render pass.\n");
            ...
            for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                ...
                if (attachmentInfo.view.Get() == nil) {
                    printf("Error, color attachment is nil.\n");
                }
