...
namespace dawn_native { namespace metal {
    ...
    namespace {
        ...
        void ComputeDepthStencilDesc(MTLDepthStencilDescriptor* mtlDepthStencilDescriptor,
        ...
        while (mCommands.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::SetRenderPipeline: {
                    ...
                    ComputeDepthStencilDesc(mtlDepthStencilDescriptor,
                                            lastPipeline->StencilTestEnabled(),
                                            lastPipeline->GetDepthStencilStateDescriptor());
                    auto mtlDevice = mDevice->GetMTLDevice();
                    [encoder setDepthStencilState:[mtlDevice newDepthStencilStateWithDescriptor:
