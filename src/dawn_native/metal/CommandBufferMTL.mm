...
namespace dawn_native { namespace metal {
    ...
    namespace {
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptor(
            ...
            const bool UseTemporaryResolveTarget = (resolveTexturesForWorkaround != nil);
            for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                ...
                if (attachmentInfo.resolveTarget.Get() != nil) {
                    ...
                    if (UseTemporaryResolveTarget && (resolveLevel > 0 || resolveSlice > 0)) {
