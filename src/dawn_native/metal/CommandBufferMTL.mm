...
#pragma clang diagnostic pop
    ...
    TextureBufferCopySplit ComputeTextureBufferCopySplit(wgpu::TextureDimension dimension,
        ...
        // texture.
        uint32_t clampedCopyExtentWidth = (origin.x + copyExtent.width > virtualSizeAtLevel.width)
        ...
        if (copyExtent.depth > 1) {
            ...
            copy.copies[copy.count].copyExtent = {clampedCopyExtentWidth, clampedCopyExtentHeight,
                                                  copyExtent.depth - 1};
        ...
        if (copyBlockRowCount > 1) {
            ...
            copy.copies[copy.count].copyExtent = {clampedCopyExtentWidth,
        ...
        copy.copies[copy.count].textureOrigin = {
            ...
            origin.z + copyExtent.depth - 1};
        copy.copies[copy.count].copyExtent = {clampedCopyExtentWidth, lastRowCopyExtentHeight, 1};
        ++copy.count;
