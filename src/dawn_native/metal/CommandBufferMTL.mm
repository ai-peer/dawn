...
namespace dawn_native { namespace metal {
    ...
    namespace {
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptorImpl(
            ...
            const std::bitset<kMaxColorAttachments>& forceUnsetResolveTargetSet,
            ...
            for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                ...
                if (attachmentInfo.storeOp == dawn::StoreOp::Store) {
                    if (resolveTarget != nil && !forceUnsetResolveTargetSet.test(i)) {
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptorImpl(BeginRenderPassCmd* renderPass) {
            return CreateMTLRenderPassDescriptorImpl(renderPass, true,
                                                     std::bitset<kMaxColorAttachments>(), nil);
        }
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptor(
            ...
            return CreateMTLRenderPassDescriptorImpl(
                renderPass, !shouldEmulateStoreAndMSAAResolve, removeResolveTargetSetForWorkaround,
