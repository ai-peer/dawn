    ...
    namespace {
        ...
        void ResolveInAnotherRenderPass(
            ...
            for (uint32_t i = 0; i < kMaxColorAttachments; ++i) {
                ...
                renderPassForResolve.colorAttachments[i].resolveTexture = resolveTextures[i];
            ...
            switch (type) {
                ...
                case Command::BeginRenderPass: {
                    ...
                    MTLRenderPassDescriptor* descriptor =
                        CreateMTLRenderPassDescriptorImpl(cmd);
    ...
    void CommandBuffer::EncodeRenderPass(id<MTLCommandBuffer> commandBuffer,
        ...
        if (device->IsToggleEnabled(Toggle::EmulateStoreAndMSAAResolve)) {
            ...
            if (hasStoreAndMSAAResolve) {
                ...
                ResolveInAnotherRenderPass(device, commandBuffer, mtlRenderPass, resolveTextures);
                return;
            }
        }
