    ...
    namespace {
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptorImpl(
            ...
            if (renderPass->hasDepthStencilAttachment) {
                ...
                TextureBase* depthTexture = attachmentInfo.view->GetTexture();
                if (depthTexture == nil) {
                    printf("Error: depth texture is nil.\n");
                }
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptor(
            ...
            for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                appliedRenderPass.colorAttachments[i].view =
                    renderPass->colorAttachments[i].view.Get();
            ...
            if (renderPass->hasDepthStencilAttachment) {
                ...
                appliedRenderPass.depthStencilAttachment.view = depthStencilView;
