    ...
    namespace {
            ...
            for (uint32_t i : IterateBitSet(renderPass->colorAttachmentsSet)) {
                ...
                if (resolveTarget != nil) {
                    if (resolveTexturesForWorkaround != nil &&
                        ...
                        descriptor.colorAttachments[i] = (*resolveTexturesForWorkaround)[i];
                        ...
                        descriptor.colorAttachments[i].resolveLevel = resolveLevel;
                        descriptor.colorAttachments[i].resolveSlice = resolveSlice;
                    }
                }
            }
        ...
        MTLRenderPassDescriptor* CreateMTLRenderPassDescriptor(
            ...
            MTLRenderPassDescriptor* outputMTLRenderPassDescriptor =
                CreateMTLRenderPassDescriptorImpl(renderPass, resolveTexturesForWorkaround);
