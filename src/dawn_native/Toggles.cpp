...
namespace dawn_native {
    namespace {
        ...
        static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
            ...
            {Toggle::MetalUseDummyFragmentInVertexOnlyPipeline,
             {"metal_use_dummy_fragment_in_vertex_only_pipeline",
              "Use a dummy empty fragment shader in vertex only render pipeline for Metal. This "
              "workaround is by default enabled on some devices with Intel GPU to ensure the depth "
              "result is correct.",
