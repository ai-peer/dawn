...
namespace dawn_native {
    namespace {
        ...
        static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
            ...
            {Toggle::DisableStencilCopy,
             {"disable_stencil_copy",
              "Disables copies of stencil textures which is unsupported on some platforms.",
              "https://crbug.com/dawn/667"}},
            {Toggle::DisableSnormCopy,
             {"disable_snorm_copy",
              "Disables copies of SNORM textures which is unsupported on some platforms.",
              "https://crbug.com/dawn/667"}},
