        ...
        static constexpr ToggleEnumAndInfoList kToggleNameAndInfoList = {{
            ...
            {Toggle::UseD3D12ResourceHeapTier2,
             {"use_d3d12_resource_heap_tier2",
              ...
              "fragmentation.",
              "https://bugs.chromium.org/p/dawn/issues/detail?id=27"}},
            {Toggle::UseD3D12RenderPass,
             {"use_d3d12_render_pass",
              ...
              "https://bugs.chromium.org/p/dawn/issues/detail?id=36"}},
            {Toggle::SkipValidation,
             {"skip_validation", "Skip expensive validation of Dawn commands.",
              "https://bugs.chromium.org/p/dawn/issues/detail?id=271"}},
            {Toggle::UseSpvc,
             {"use_spvc",
              "Enable use of spvc for shader compilation, instead of accessing spirv_cross "
              "directly.",
              "https://bugs.chromium.org/p/dawn/issues/detail?id=288"}},
            {Toggle::UseSpvcIRGen,
             {"use_spvc_ir_gen",
            ...
            {Toggle::VulkanUseD32S8,
             {"vulkan_use_d32s8",
              ...
              "https://bugs.chromium.org/p/dawn/issues/detail?id=286"}},
        }};
