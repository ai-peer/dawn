...
namespace dawn_native { namespace d3d12 {
    ...
    ResultOrError<ResourceHeapAllocation> ResourceAllocatorManager::CreatePlacedResource(
        ...
        DAWN_TRY(CheckHRESULT(mDevice->GetD3D12Device()->CreatePlacedResource(
                                  heap, allocation.GetOffset(), &resourceDescriptor, initialUsage,
    ...
    ResultOrError<ResourceHeapAllocation> ResourceAllocatorManager::CreateCommittedResource(
        ...
        DAWN_TRY(CheckHRESULT(mDevice->GetD3D12Device()->CreateCommittedResource(
