...
namespace dawn_native { namespace d3d12 {
    ...
    // This class is used to represent ID3D12Heap allocations. It inherits from Pageable because
    // ID3D12Heap allocations are managed in the ResidencyManager.
