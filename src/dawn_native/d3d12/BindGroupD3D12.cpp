...
namespace dawn_native { namespace d3d12 {
    ...
    BindGroup::BindGroup(Device* device,
        ...
        if (bgl->GetCbvUavSrvDescriptorCount() > 0) {
            mCPUCbvSrvUavAllocation.baseDescriptor = viewAllocation.GetCPUHandle(0);
            mCPUCbvSrvUavAllocation.heapIndex = viewAllocation.GetHeapIndex();
        }
            ...
            switch (bindingInfo.type) {
                case wgpu::BindingType::UniformBuffer: {
                    ...
                    d3d12Device->CreateConstantBufferView(
                        &desc, viewAllocation.GetCPUHandle(bindingOffsets[bindingIndex]));
                } break;
                case wgpu::BindingType::StorageBuffer: {
                    ...
                    d3d12Device->CreateUnorderedAccessView(
                        ...
                        viewAllocation.GetCPUHandle(bindingOffsets[bindingIndex]));
                } break;
    ...
    BindGroup::~BindGroup() {
        ToBackend(GetLayout())
            ->DeallocateBindGroup(this, mCPUCbvSrvUavAllocation, mCPUSamplerAllocation);
    }
