...
namespace dawn_native { namespace d3d12 {
    ...
    BindGroup::BindGroup(Device* device,
        ...
        if (viewAllocation.IsValid()) {
            mCPUViewAllocation.baseDescriptor = viewAllocation.GetCPUHandle(0);
            mCPUViewAllocation.heapIndex = viewAllocation.GetHeapIndex();
        }
    ...
    ResultOrError<bool> BindGroup::Populate(ShaderVisibleDescriptorAllocator* allocator) {
        ...
        if (viewDescriptorCount > 0) {
            ...
            d3d12Device->CopyDescriptorsSimple(
                ...
                mCPUViewAllocation.baseDescriptor, D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
