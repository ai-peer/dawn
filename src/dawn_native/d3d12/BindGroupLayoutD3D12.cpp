...
namespace dawn_native { namespace d3d12 {
    ...
    BindGroupLayout::BindGroupLayout(Device* device, const BindGroupLayoutDescriptor* descriptor)
        ...
        for (BindingIndex bindingIndex = GetDynamicBufferCount(); bindingIndex < GetBindingCount();
            ...
            // In the future, special handling will be needed for external textures here because
            // they encompass multiple views.
        ...
        for (BindingIndex bindingIndex{0}; bindingIndex < GetBindingCount(); ++bindingIndex) {
            ...
            // In the future, special handling will be needed here for external textures because
            // they encompass multiple views.
            DescriptorType descriptorType = WGPUBindingInfoToDescriptorType(bindingInfo);
