...
namespace dawn_native { namespace d3d12 {
    ...
    class PipelineCache : public RefCounted {
      public:
        PipelineCache(dawn_platform::ScopedCachedData pipelineCacheBlob);
        ...
        // Tells this pipeline cache to unlink itself from |sharedPipelineCaches|.
        void DisconnectFromSharedPipelineCaches();
      ...
      private:
        ...
        // If |mLibraryBlob| is nullptr, it means the pipeline cache data is not being shared
        // between Dawn devices. Otherwise, a non-nullptr |mLibraryBlob| is used to create a shared
        // pipeline library which will valid for the lifetime of the |mLibrary|.
        dawn_platform::ScopedCachedData mLibraryBlob;
        ...
        // The |mLibrary| cannot tell us when it's data gets updated so a dirty bit is needed.
    ...
    class SharedPipelineCaches {
      public:
        ...
        dawn_platform::ScopedCachedData LoadPipelineCacheData(PersistentCache* persistentCache);
