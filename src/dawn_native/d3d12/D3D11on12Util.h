...
namespace dawn_native { namespace d3d12 {
    ...
    // Since each Dawn device also equals a 11on12 device, the 11on12 device
    // is used as the key which ensures only the same 11 wrapped resource is re-used and
    // also fully released.
    //
    ...
    class D3D11on12ResourceCache {
      public:
        D3D11on12ResourceCache() = default;
        ~D3D11on12ResourceCache() = default;
      ...
      private:
        // TODO(625): Figure out a large enough cache size.
