...
namespace dawn_native { namespace d3d12 {
    ...
    ResultOrError<std::unique_ptr<Resource>> CommittedResourceAllocator::Allocate(
    ...
    void CommittedResourceAllocator::Deallocate(std::unique_ptr<Resource> allocation) {
