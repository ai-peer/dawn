...
namespace dawn::native::d3d12 {
    ...
    extern void RecordBufferTextureCopyWithBufferHandle(CommandRecordingContext* commandContext,
    ...
    template<BufferToTextureCopyDirection Direction>
    extern void RecordBufferTextureCopy(ID3D12GraphicsCommandList* commandList,
                                 const TextureCopy& textureCopy,
