...
namespace dawn_native { namespace d3d12 {
    ...
    TextureCopySplit ComputeTextureCopySplit(Origin3D origin,
        ...
        uint64_t alignedOffset = offset & ~static_cast<uint64_t>(D3D12_TEXTURE_DATA_PLACEMENT_ALIGNMENT - 1);
        ...
        Origin3D texelOffset;
        ComputeTexelOffsets(static_cast<uint32_t>(offset - alignedOffset), rowPitch, rowPitch * imageHeight, texelSize,
                            &texelOffset);
