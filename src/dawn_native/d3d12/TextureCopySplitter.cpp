...
namespace dawn_native { namespace d3d12 {
    ...
    Texture2DCopySplit ComputeTextureCopySplit(Origin3D origin,
        ...
        if (copyBytesPerRowPitch + byteOffsetInRowPitch <= bytesPerRow) {
            ...
            copy.copies[0].bufferSize.depthOrArrayLayers =
                copySize.depthOrArrayLayers + texelOffset.z;
        ...
        copy.copies[0].bufferSize.height = rowsPerImageInTexels + texelOffset.y;
        copy.copies[0].bufferSize.depthOrArrayLayers = copySize.depthOrArrayLayers + texelOffset.z;
        ...
        copy.copies[1].bufferSize.depthOrArrayLayers = copySize.depthOrArrayLayers + texelOffset.z;
