...
namespace dawn_native { namespace d3d12 {
    ...
    void Recompute3DTextureCopyRegionsForBlockWithEmptyFirstRow(Origin3D origin,
        ...
        //
        // Copied data for images(layers) is showed below if it is a 2D texture:
        //
        //   - image 0: row N to row (N + 3). Row (N - 1) is in this copy region but it is skipped
        //     via parameter bufferOffset. See the figure below.
        //   - image 1: row (N + 4) to row (N + 7). Row (N + 3) is in this copy region but it is
        //     skipped. It won't be copied twice.
        //
        ...
        // We will copy 5 rows every time, and every first row of each slice will be skipped. As
        // a result, the copied data will be:
        //
