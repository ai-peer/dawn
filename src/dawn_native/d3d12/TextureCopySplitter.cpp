...
namespace dawn_native { namespace d3d12 {
    ...
    void Compute3DTextureCopyRegionsForBlockWithEmptyFirstRow(Origin3D origin,
        ...
        //              |-------------------|
        //
        // Solutions: copy 4 (bufferSize.height) rows in copy 0, and expand to all depth slices.
        // Then copy the last rows in copy 1, and expand to copySize.depthOrArrayLayers - 1
        // depth slices. And copy the last row of the last depth slice in copy 2.

        // Copy 0: copy 4 (bufferSize.height) rows, and expand to z-axis (all depth slices).
