...
namespace dawn_native { namespace d3d12 {
    ...
    TextureCopySubresource Compute2DTextureCopySubresource(Origin3D origin,
        ...
        ASSERT(texelOffsetForCopy1.y <= 1);
    ...
    TextureCopySubresource Compute3DTextureCopySplits(Origin3D origin,
        ...
        // will be in a mess. This situation can be introduced by 2 special cases:
        ...
        //
        // For these special cases, we need to recompute the copy regions for 3D textures.
