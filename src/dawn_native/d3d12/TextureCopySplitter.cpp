...
namespace dawn_native { namespace d3d12 {
    ...
    TextureCopySplits ComputeTextureCopySplits(Origin3D origin,
        ...
        const dawn_native::Extent3D copyOneLayerSize = {
            copySize.width, copySize.height, is3DTexture ? copySize.depthOrArrayLayers : 1};
        const dawn_native::Origin3D copyFirstLayerOrigin = {origin.x, origin.y,
                                                            is3DTexture ? origin.z : 0};
