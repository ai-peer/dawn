...
namespace dawn_native { namespace d3d12 {
    ...
    TextureCopySubresource Compute3DTextureCopySplits(Origin3D origin,
        ...
        // TODO(yunchao.he@intel.com): recompute/modify all copy regions if any copy region's
        // bufferSize.height is bigger than copySize.height due to an empty row at the beginning
        // of the copy region because of alignment adjustment. It can be divided into a few
        // scenarios:
        //     - copySize.height is 1. This is a very special case. We need to split copy regions
        //       separately for this situation.
        //     - copySize.height is greater than 1. And data in one row in original layout never
        //       straddle two rows in new layout.
        //     - copySize.height is greater than 1. And Data in one row in original layout
        //       straddles two rows in new layout due to alignment adjustment.
