...
namespace dawn_native { namespace d3d12 {
    ...
    ResourceHeapBase* ResourceHeapAllocator::CreateHeap(uint64_t heapSize, int heapFlags) {
    ...
    ResourceMemoryAllocation PlacedResourceAllocator::Allocate(
        ...
        const ResourceMemoryAllocation heapAllocation =
            mDirectAllocator.Allocate(allocationSize, allocationAlignment, heapFlags);
