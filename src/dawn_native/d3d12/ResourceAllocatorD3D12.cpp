...
namespace dawn_native { namespace d3d12 {
    ...
    ResourceMemoryAllocation PlacedResourceAllocator::Allocate(
        ...
        const ResourceMemoryAllocation heapAllocation = mDirectAllocator.Allocate(allocationSize, allocationAlignment, heapFlags);
    ...
    void PlacedResourceAllocator::Tick(uint64_t lastCompletedSerial) {
        ...
        return mDirectAllocator.GetResourceHeapAllocator().Tick(lastCompletedSerial);
    }
