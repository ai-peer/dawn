...
namespace dawn_native { namespace d3d12 {
    ...
    void PlatformFunctions::LoadDXCLibraries() {
        ...
        // Staticly linked with dxcompiler.lib in UWP
        // currently linked with dxcompiler.lib making CoreApp unable to activate
        // LoadDXIL and LoadDXCompiler will failed in UWP, but LoadFunctions() can still be successfully executed.
    ...
    void PlatformFunctions::LoadPIXRuntime() {
        // TODO(cjj19970505@live.cn)
        // In UWP PIX should be staticly linked WinPixEventRuntime_UAP.lib
        // So maybe we should put WinPixEventRuntime as a third party package
        // Currently PIX is not going to be loaded in UWP since the following mPIXEventRuntimeLib.Open will fail.
