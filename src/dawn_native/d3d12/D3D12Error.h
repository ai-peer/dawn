...
namespace dawn_native { namespace d3d12 {
    ...
    constexpr HRESULT E_FAKE_OUTOFMEMORY_ERROR_FOR_TESTING = E_FAKE_ERROR_FOR_TESTING - 1;
...
#define CheckOutOfMemoryHRESULT(resultIn, contextIn)   \
    ::dawn_native::d3d12::CheckOutOfMemoryHRESULTImpl( \
        INJECT_ERROR_OR_RUN(resultIn, E_FAKE_OUTOFMEMORY_ERROR_FOR_TESTING), contextIn)
