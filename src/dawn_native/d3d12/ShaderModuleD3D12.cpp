...
namespace dawn_native { namespace d3d12 {
    ...
    const std::string ShaderModule::GetHLSLSource(PipelineLayout* layout) const {
        ...
        // TODO (hao.x.li@intel.com): These compat options are required temporarily for
        // https://bugs.chromium.org/p/dawn/issues/detail?id=146 but should be removed once WebGPU
        // requires there is no gl_PointSize builtin (https://github.com/gpuweb/gpuweb/issues/332).
