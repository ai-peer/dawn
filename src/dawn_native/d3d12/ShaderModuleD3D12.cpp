    ...
    namespace {
        ...
        struct ShaderCompilationRequest {
            ...
            static ResultOrError<ShaderCompilationRequest> Create(
                ...
                request.useNumWorkgroups = entryPoint.useNumWorkgroups;
            ...
            ResultOrError<PersistentCacheKey> CreateCacheKey() const {
                ...
                stream << " useNumWorkgroups=" << useNumWorkgroups;
        ...
        ResultOrError<std::string> TranslateToHLSL(const ShaderCompilationRequest& request,
            ...
            if (request.useNumWorkgroups) {
                options.root_constant_binding_point.group =
                    PipelineLayout::GetNumWorkgroupsRegisterSpace();
                options.root_constant_binding_point.binding =
                    PipelineLayout::GetNumWorkgroupsShaderRegister();
            }
