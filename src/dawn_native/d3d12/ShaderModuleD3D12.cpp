...
namespace dawn_native { namespace d3d12 {
    ...
    ResultOrError<CompiledShader> ShaderModule::Compile(const char* entryPointName,
        ...
        bool useCachedShaders = !device->IsToggleEnabled(Toggle::DisableD3D12ShaderCaching);
        ...
        const std::string shaderCacheKey = GetShaderSourceForKey(entryPointName, stage);
            ...
            device->GetPersistentCache()->LoadFromCacheOrCreate(
                shaderCacheKey, [&](PersistentCache::DoCache doCache) -> MaybeError {
                    ...
                    if (useCachedShaders) {
                        ...
                        useCachedShaders = doCache(shader.pShaderBytecode, shader.BytecodeLength);
                    }
                    return {};
                }));
        ...
        *useCachedPipeline = useCachedShaders || (compileFlags & D3DCOMPILE_DEBUG) == 0;
    ...
    std::string ShaderModule::GetShaderSourceForKey(const char* entryPointName,
