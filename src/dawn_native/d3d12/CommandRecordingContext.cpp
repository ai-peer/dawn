...
namespace dawn_native { namespace d3d12 {
    ...
    ResultOrError<ComPtr<ID3D12GraphicsCommandList>> CommandRecordingContext::Close() {
        ASSERT(IsOpen());
        mIsOpen = false;
        ...
        return ComPtr<ID3D12GraphicsCommandList>(mD3d12CommandList);
    }

    ComPtr<ID3D12GraphicsCommandList> CommandRecordingContext::GetCommandList() {
        ASSERT(mD3d12CommandList != nullptr);
        ASSERT(IsOpen());
        return mD3d12CommandList;
    }
