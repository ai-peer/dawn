            ...
            switch (type) {
                ...
                case Command::CopyTextureToTexture: {
                    ...
                    if (CanUseCopyResource(copy->source, copy->destination, copy->copySize)) {
                        ...
                        // TODO(jiawei.shao@intel.com): support copying with 1D textures.
                            ...
                            for (uint32_t slice = 0; slice < copy->copySize.depthOrArrayLayers;
                                ...
                                switch (source->GetDimension()) {
                                    case wgpu::TextureDimension::e2D:
                                        sourceLayer = copy->source.origin.z + slice;
                                        break;
                                    case wgpu::TextureDimension::e3D:
                                        sourceZ = copy->source.origin.z + slice;
                                ...
                                switch (destination->GetDimension()) {
                                    case wgpu::TextureDimension::e2D:
                                        destinationLayer = copy->destination.origin.z + slice;
                                        break;
                                    case wgpu::TextureDimension::e3D:
                                        destinationZ = copy->destination.origin.z + slice;
                                        break;
                                    case wgpu::TextureDimension::e1D:
                                        UNREACHABLE();
                                }
