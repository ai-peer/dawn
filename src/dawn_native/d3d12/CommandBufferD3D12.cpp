    ...
    class BindGroupStateTracker {
      public:
        ...
        void SetBindGroup(ComPtr<ID3D12GraphicsCommandList> commandList,
            ...
            // so always try to apply dynamic offsets even if the offset and
            // bind group stays the same
      ...
      private:
        ...
        std::array<std::array<uint64_t, kMaxDynamicOffsetsPerGroup>, kMaxBindGroups>
            mLastDynamicOffsets;
