            ...
            switch (type) {
                ...
                case Command::CopyBufferToTexture: {
                    ...
                    auto copySplit = ComputeTextureCopySplit(
                        copy->destination.origin.x, copy->destination.origin.y, copy->destination.origin.z,
                ...
                case Command::CopyTextureToBuffer: {
                    ...
                    auto copySplit = ComputeTextureCopySplit(
                        copy->source.origin.x, copy->source.origin.y, copy->source.origin.z, copy->copySize.width,
                        copy->copySize.height, copy->copySize.depth,
                        static_cast<uint32_t>(TextureFormatPixelSize(texture->GetFormat())),
                    ...
                    for (uint32_t i = 0; i < copySplit.count; ++i) {
                        ...
                        bufferLocation.PlacedFootprint.Footprint.Height = info.bufferSize.height;
                        bufferLocation.PlacedFootprint.Footprint.Depth = info.bufferSize.depth;
                        bufferLocation.PlacedFootprint.Footprint.RowPitch = copy->destination.rowPitch;
