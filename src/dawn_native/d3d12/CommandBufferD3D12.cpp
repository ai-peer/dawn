...
namespace dawn_native { namespace d3d12 {
    ...
    namespace {
        ...
        void RecordCopyTextureWithTemporaryBuffer(CommandRecordingContext* recordingContext,
            ...
            CopyTextureToBuffer(recordingContext->GetCommandList(), srcCopy, bufferCopy, srcTexture,
                                tempBuffer.Get(), copySize);
            ...
            CopyBufferToTexture(recordingContext, dstCopy, tempBuffer->GetD3D12Resource(), 0,
                                bytesPerRow, rowsPerImage, copySize, dstTexture, dstCopy.aspect);
        ...
        while (mCommands.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::CopyBufferToTexture: {
                    ...
                    CopyBufferToTexture(commandContext, copy->destination,
                ...
                case Command::CopyTextureToBuffer: {
                    ...
                    CopyTextureToBuffer(commandList, copy->source, copy->destination, texture,
