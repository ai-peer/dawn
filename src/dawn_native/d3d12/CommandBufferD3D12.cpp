    ...
    MaybeError CommandBuffer::RecordCommands(CommandRecordingContext* commandContext,
        ...
        auto TransitionForPass = [](CommandRecordingContext* commandContext,
            ...
            for (size_t i = 0; i < usages.buffers.size(); ++i) {
                ...
                commandContext->TrackResourceHeapUsage(buffer->GetResourceHeapAllocation());
            }
            ...
            for (size_t i = 0; i < usages.textures.size(); ++i) {
                ...
                commandContext->TrackResourceHeapUsage(texture->GetResourceHeapAllocation());
            }
        ...
        while (mCommands.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::CopyBufferToBuffer: {
                    ...
                    commandContext->TrackResourceHeapUsage(srcBuffer->GetResourceHeapAllocation());
                    commandContext->TrackResourceHeapUsage(dstBuffer->GetResourceHeapAllocation());
                ...
                case Command::CopyTextureToTexture: {
                    ...
                    commandContext->TrackResourceHeapUsage(source->GetResourceHeapAllocation());
                    commandContext->TrackResourceHeapUsage(
                        destination->GetResourceHeapAllocation());
