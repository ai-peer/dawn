      ...
      public:
        ...
        MaybeError Apply(CommandRecordingContext* commandContext) {
            ...
            Serial cbvSrvUavHeapSerial =
                mDevice->GetDescriptorHeapAllocator()->GetGPUDescriptorHeapSerial(
            ...
            for (uint32_t index : IterateBitSet(mDirtyBindGroupsObjectChangedOrIsDynamic)) {
                ...
                // re-populated as it does not need to be re-allocated.
                if (mDirtyBindGroups[index] &&
                    ...
                    // the |serial| is remembered. This works because the bindgroup
                    // allocation cannot outlive this serial while ensuring the bindgroup allocation
                    // can be uniquely identified to check if it already exists.
