    ...
    namespace {
        ...
        MaybeError RecordCopyTextureWithTemporaryBuffer(CommandRecordingContext* recordingContext,
            ...
            RecordBufferTextureCopy<BufferTextureCopyDirection::T2B>(
                recordingContext->GetCommandList(), bufferCopy, srcCopy, copySize);
            ...
            RecordBufferTextureCopy<BufferTextureCopyDirection::B2T>(
                recordingContext->GetCommandList(), bufferCopy, dstCopy, copySize);
        ...
        while (mCommands.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::CopyBufferToTexture: {
                    ...
                    RecordBufferTextureCopy<BufferTextureCopyDirection::B2T>(
                        commandList, copy->source, copy->destination, copy->copySize);
                ...
                case Command::CopyTextureToBuffer: {
                    ...
                    RecordBufferTextureCopy<BufferTextureCopyDirection::T2B>(
                        commandList, copy->destination, copy->source, copy->copySize);
