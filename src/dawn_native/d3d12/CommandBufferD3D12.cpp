...
namespace dawn_native { namespace d3d12 {
    ...
    namespace {
        ...
        bool CanUseCopyResource(Texture* src, Texture* dst, const Extent3D& copySize) {
            ...
            return (src->GetNumMipLevels() == dst->GetNumMipLevels() &&
                    ...
                    src->GetArrayLayers() == dst->GetArrayLayers() &&
                    src->GetArrayLayers() == srcSize.depth && srcSize.width == dstSize.width &&
                    srcSize.width == copySize.width && srcSize.height == dstSize.height &&
                    srcSize.height == copySize.height && srcSize.depth == dstSize.depth &&
