      ...
      public:
        ...
        MaybeError Apply(CommandRecordingContext* commandContext) {
            ...
            for (uint32_t index : IterateBitSet(mDirtyBindGroups)) {
                ...
                DAWN_TRY_ASSIGN(didCreateBindGroupViews, group->PopulateViews(mViewAllocator));
                DAWN_TRY_ASSIGN(didCreateBindGroupSamplers,
                                group->PopulateSamplers(mSamplerAllocator));
