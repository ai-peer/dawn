...
namespace dawn_native { namespace d3d12 {
    ...
    class BindGroup final : public BindGroupBase, public PlacementAllocated {
      public:
        ...
        ResultOrError<bool> PopulateViews(ShaderVisibleDescriptorAllocator* viewAllocator);
        ResultOrError<bool> PopulateSamplers(ShaderVisibleDescriptorAllocator* samplerAllocator);
