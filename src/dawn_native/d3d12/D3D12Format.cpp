...
namespace dawn_native { namespace d3d12 {
    ...
    D3D12FormatTable BuildD3D12FormatTable() {
        ...
        AddFormat(wgpu::TextureFormat::RGBA8Unorm,          DXGI_FORMAT_R8G8B8A8_TYPELESS,          DXGI_FORMAT_R8G8B8A8_UNORM,         DXGI_FORMAT_R8G8B8A8_UNORM);
        AddFormat(wgpu::TextureFormat::RGBA8UnormSrgb,      DXGI_FORMAT_R8G8B8A8_TYPELESS,          DXGI_FORMAT_R8G8B8A8_UNORM_SRGB,    DXGI_FORMAT_R8G8B8A8_UNORM_SRGB);
        AddFormat(wgpu::TextureFormat::RGBA8Snorm,          DXGI_FORMAT_R8G8B8A8_TYPELESS,          DXGI_FORMAT_R8G8B8A8_SNORM,         DXGI_FORMAT_R8G8B8A8_SNORM);
        AddFormat(wgpu::TextureFormat::RGBA8Uint,           DXGI_FORMAT_R8G8B8A8_TYPELESS,          DXGI_FORMAT_R8G8B8A8_UINT,          DXGI_FORMAT_R8G8B8A8_UINT);
        AddFormat(wgpu::TextureFormat::RGBA8Sint,           DXGI_FORMAT_R8G8B8A8_TYPELESS,          DXGI_FORMAT_R8G8B8A8_SINT,          DXGI_FORMAT_R8G8B8A8_SINT);
