...
namespace dawn_native { namespace d3d12 {
    ...
    void ReleaseD3D11on12Device(ID3D11DeviceContext2* d3d11DeviceContext) {
        ...
        d3d11DeviceContext->TiledResourceBarrier(nullptr, nullptr);
    ...
    D3D11on12ResourceCacheEntry::~D3D11on12ResourceCacheEntry() {
        ...
        ReleaseD3D11on12Device(d3d11DeviceContext2.Get());
    }
