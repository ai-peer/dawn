...
namespace dawn_native { namespace d3d12 {
    ...
    size_t D3D11on12ResourceCacheEntry::HashFunc::operator()(
        const std::shared_ptr<D3D11on12ResourceCacheEntry> a) const {
        size_t hash = 0;
    ...
    bool D3D11on12ResourceCacheEntry::EqualityFunc::operator()(
        const std::shared_ptr<D3D11on12ResourceCacheEntry> a,
    ...
    std::shared_ptr<D3D11on12ResourceCacheEntry>
    D3D11on12ResourceCache::GetOrCreateD3D11on12Resource(WGPUDevice device,
        ...
        std::shared_ptr<D3D11on12ResourceCacheEntry> blueprint =
            std::make_shared<D3D11on12ResourceCacheEntry>(d3d11on12Device);
        ...
        std::shared_ptr<D3D11on12ResourceCacheEntry> entry =
            std::make_shared<D3D11on12ResourceCacheEntry>(dxgiKeyedMutex,
