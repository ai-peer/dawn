...
namespace dawn_native { namespace d3d12 {
    ...
    RenderPipeline::RenderPipeline(DeviceBase* device, const RenderPipelineDescriptor* descriptor)
        ...
        dawn::ShaderStageBit renderStages = dawn::ShaderStageBit::Vertex |
        ...
        descriptorD3D12.RasterizerState.SlopeScaledDepthBias = D3D12_DEFAULT_SLOPE_SCALED_DEPTH_BIAS;
        ...
        Device* deviceD3D12 = ToBackend(GetDevice());
        ASSERT_SUCCESS(deviceD3D12->GetD3D12Device()->CreateGraphicsPipelineState(
