...
namespace dawn_native { namespace d3d12 {
    ...
    void Buffer::DestroyImpl() {
        // TODO(lokokung) Reintroduce optimization to skip flushing the writes to the GPU memory
        // when we unmap in destruction case since the buffer will be destroyed anyways.
