...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Buffer::MapInternal(bool isWrite,
        ...
        // We need to offset manually, MSDN says (not the weird use of "never"):
        //
        //   When ppData is not NULL, the pointer returned is never offset by any values in
        //   pReadRange.
        //
        // https://docs.microsoft.com/en-us/windows/win32/api/d3d12/nf-d3d12-id3d12resource-map
        mMappedData = static_cast<uint8_t*>(mappedData) + start;
        return {};
    }
    ...
    MaybeError Buffer::MapAsyncImpl(wgpu::MapMode mode, size_t offset, size_t size) {
        return MapInternal(mode & wgpu::MapMode::Write, offset, offset + size, "D3D12 map async");
    }
