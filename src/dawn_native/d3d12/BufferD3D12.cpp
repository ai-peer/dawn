...
namespace dawn_native { namespace d3d12 {
    ...
    bool Buffer::TransitionUsageAndGetResourceBarrier(D3D12_RESOURCE_BARRIER* barrier,
        ...
        // All possible states used by Dawn are eligible for implicit promotion to COMMON. These
        // are: COPY_SOURCE, VERTEX_AND_COPY_BUFFER, INDEX_BUFFER, COPY_DEST, UNORDERED_ACCESS, and
        // INDIRECT_ARGUMENT. Note that for implicit promotion, the destination state cannot be 1)
        // more one write state, or 2) both a read and write state. This goes unchecked here because
        // it should not be allowed through render/compute pass validation.
