...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Buffer::MapReadAsyncImpl(uint32_t serial) {
        ...
        DAWN_TRY(
            CheckHRESULT(GetD3D12Resource()->Map(0, &readRange, reinterpret_cast<void**>(&mMappedData)),
    ...
    MaybeError Buffer::MapWriteAsyncImpl(uint32_t serial) {
        ...
        DAWN_TRY(CheckHRESULT(
            GetD3D12Resource()->Map(0, &mWrittenMappedRange, reinterpret_cast<void**>(&mMappedData)),
