...
namespace dawn_native { namespace d3d12 {
    ...
    bool Buffer::TransitionUsageAndGetResourceBarrier(CommandRecordingContext* commandContext,
        ...
        // We need UAV barriers if src and dst states are both D3D12_RESOURCE_STATE_UNORDERED_ACCESS
        // to synchronize possible writes to storage buffers.
        // D3D12 doesn't have readonly storage buffers.
        // Otherwise, a transition barrier is sufficient.
