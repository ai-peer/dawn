...
namespace dawn_native { namespace d3d12 {
    ...
    bool ResidencyManager::ShouldTrackHeap(Heap* heap) const {
        ...
        // DXGI_MEMORY_SEGMENT_GROUP_NON_LOCAL. The ResidencyManager only manages heaps in
        // DXGI_MEMORY_SEGMENT_GROUP_LOCAL, so we leave UPLOAD and READBACK heaps permanently
        // resident. Only DEFAULT heaps are managed on non-UMA devices.
        return heap->GetD3D12HeapType() == D3D12_HEAP_TYPE_DEFAULT;
    }
