...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Device::Initialize() {
        ...
        // introduced since Windows 10 Anniversary Update (WDDM 2.1+). Checking for pipeline support
        // is only temporary. All future versions of the OS and drivers will have support.
        bool supportsPipelineLibrary = SUCCEEDED(mD3d12Device.As(&mD3d12Device1));
    ...
    void Device::InitTogglesFromDriver() {
        ...
        SetToggle(Toggle::UseD3D12ShaderCaching, true);
    ...
    void Device::ShutDownImpl() {
        ...
        // The ID3D12PipelineLibrary must be stored to a persistent cache to be reloaded.
        // Error upon store should not happen but must be ignored to continue shutdown.
