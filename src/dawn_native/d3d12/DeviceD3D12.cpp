...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Device::ExecuteCommandContext(CommandRecordingContext* commandContext) {
        ...
        ID3D12GraphicsCommandList* d3d12CommandListPending;
        ID3D12GraphicsCommandList* d3d12CommandListIn;
        ...
        if (mPendingCommands.IsOpen()) {
            ...
            d3d12CommandLists[numLists++] = d3d12CommandListPending;
        }
        if (commandContext != nullptr) {
            DAWN_TRY_ASSIGN(d3d12CommandListIn, commandContext->Close());
            d3d12CommandLists[numLists++] = d3d12CommandListIn;
        }
        if (numLists > 0) {
