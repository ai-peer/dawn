...
namespace dawn_native { namespace d3d12 {
    ...
    void Device::InitTogglesFromDriver() {
        ...
        // bug is fixed.
        bool shouldUseTemporaryBufferInTextureToTextureCopy =
            gpu_info::IsIntel(pciInfo.vendorId) &&
            (gpu_info::IsSkylake(pciInfo.deviceId) || gpu_info::IsKabylake(pciInfo.deviceId) ||
             gpu_info::IsCoffeelake(pciInfo.deviceId));
        SetToggle(Toggle::UseTemporaryBufferInTextureToTextureCopy,
                  shouldUseTemporaryBufferInTextureToTextureCopy);
    }
