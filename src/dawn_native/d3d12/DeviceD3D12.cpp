...
namespace dawn_native { namespace d3d12 {
    ...
    void Device::DeallocateMemory(std::unique_ptr<Resource> allocation) {
    ...
    ResultOrError<std::unique_ptr<Resource>> Device::AllocateMemory(
        ...
        std::unique_ptr<Resource> allocation;
