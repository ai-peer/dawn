...
namespace dawn_native { namespace d3d12 {
    ...
    bool Device::IsBindGroupInvalidated(const DescriptorHeapAllocation& bindGroupAllocation) const {
        return mDescriptorAllocatorManager->IsBindGroupInvalidated(bindGroupAllocation);
    }
