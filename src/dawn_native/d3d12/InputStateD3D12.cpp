...
namespace dawn_native { namespace d3d12 {
    ...
    static DXGI_FORMAT VertexFormatType(dawn::VertexFormat format) {
        switch (format) {
            ...
            case dawn::VertexFormat::UChar3:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
            case dawn::VertexFormat::UChar4:
                return DXGI_FORMAT_R8G8B8A8_UINT;
            case dawn::VertexFormat::Char2:
                return DXGI_FORMAT_R8G8_SINT;
            case dawn::VertexFormat::Char3:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
            ...
            case dawn::VertexFormat::UChar3Norm:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
            ...
            case dawn::VertexFormat::Char3Norm:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
            ...
            case dawn::VertexFormat::UShort3:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
            ...
            case dawn::VertexFormat::UShort3Norm:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
            ...
            case dawn::VertexFormat::Short3Norm:
                // No direct mapping format;
                return DXGI_FORMAT_UNKNOWN;
