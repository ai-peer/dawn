...
// SLOB is backed by a linked-list of blocks (free-list). The heap is in one of two states:
// AVAILABLE or not. To allocate, a block of the range [base + start, base + end] is removed from
// the free-list. A "free" heap always has room for at-least one block. Iff no available heap
...
namespace dawn_native { namespace d3d12 {
    ...
    class NonShaderVisibleDescriptorAllocator {
      ...
      private:
        ...
        std::list<uint32_t> mAvailableHeaps;
