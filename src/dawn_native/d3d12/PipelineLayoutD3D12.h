...
namespace dawn_native { namespace d3d12 {
    ...
    class PipelineLayout : public PipelineLayoutBase {
      public:
        ...
        uint32_t GetRootParameterInfo(uint32_t group, uint32_t binding) const;
      ...
      private:
        ...
        std::array<std::array<uint32_t, kMaxBindingsPerGroup>, kMaxBindGroups> mRootParameterInfo;
