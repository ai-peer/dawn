...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Adapter::InitializeSupportedLimitsImpl(CombinedLimits* limits) {
        ...
        //  RESERVED:
        //  - max(2, 3)
        //    - 2 root constants are reserved for the baseVertex/baseInstance
        //      constants.
        //    - OR 3 root constants for num workgroups X, Y, Z
        //  - (1)
        ...
        // the 32Kb that is available to Direct3D 11 hardware. So, D3D12 is at least 32kb.
        // TODO(crbug.com/dawn/685): Discover the actual limit for D3D12 hardware.
