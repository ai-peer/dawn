...
namespace dawn_native { namespace d3d12 {
    ...
    void Adapter::InitializeDebugLayerFilters() {
        ...
        ASSERT_SUCCESS(infoQueue->PushStorageFilter(&storageFilter));
        ...
        ASSERT_SUCCESS(infoQueue->PushRetrievalFilter(&retrievalFilter));
    }
