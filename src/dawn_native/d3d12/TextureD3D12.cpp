...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Texture::InitializeAsExternalTexture(const TextureDescriptor* descriptor,
        ...
        DAWN_TRY(mResourceAllocation.SetDebugName("ExternalTexture"));
    ...
    MaybeError Texture::InitializeAsInternalTexture() {
        ...
        DAWN_TRY(mResourceAllocation.SetDebugName("InternalTexture"));
    ...
    MaybeError Texture::InitializeAsSwapChainTexture(ComPtr<ID3D12Resource> d3d12Texture) {
        ...
        DAWN_TRY(mResourceAllocation.SetDebugName("SwapChainTexture"));
        return {};
    }
