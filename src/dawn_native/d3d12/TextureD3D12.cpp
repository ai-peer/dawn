...
namespace dawn_native { namespace d3d12 {
    ...
    bool Texture::TransitionUsageAndGetResourceBarrier(CommandRecordingContext* commandContext,
        ...
        // 1. the state of the texture in the transition barrier must be
        ...
        //    copy. When we do a texture-to-buffer copy after finishing the texture-to-texture
        //    copy within the same texture, before the copy we must insert an transition barrier
        //    from D3D12_RESOURCE_STATE_COPY_DEST to D3D12_RESOURCE_STATE_COPY_SOURCE.
