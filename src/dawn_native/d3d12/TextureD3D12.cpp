...
namespace dawn_native { namespace d3d12 {
    ...
    TextureView::TextureView(TextureBase* texture, const TextureViewDescriptor* descriptor)
        ...
        // D3D12_TEX2D_SRV structure describes the subresource from a 2D texture to use in a
        // shader-resource view.
        // https://docs.microsoft.com/en-us/windows/desktop/api/d3d12/ns-d3d12-d3d12_tex2d_srv
        // D3D12_TEX2D_ARRAY_SRV structure describes the subresources from an array of 2D textures
        // to use in a shader-resource view.
