...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError Texture::InitializeAsExternalTexture(const TextureDescriptor* descriptor,
        ...
        const bool supportsResourceSharingNV12 =
            ToBackend(GetDevice())->GetDeviceInfo().supportsResourceSharingNV12;
        DAWN_TRY(ValidateD3D12SharedVideoTexture(supportsResourceSharingNV12, descriptor));
