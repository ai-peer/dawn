...
namespace dawn_native { namespace d3d12 {
            ...
            // Enable the debug layer (requires the Graphics Tools "optional feature").
            {
                if (validationLevel != BackendValidationLevel::Disabled) {
                    ...
                    if (SUCCEEDED(
                        ...
                        if (validationLevel == BackendValidationLevel::Performance) {
    ...
    MaybeError Backend::Initialize() {
        ...
        DAWN_TRY_ASSIGN(mFactory,
                        CreateFactory(mFunctions.get(), instance->IsBeginCaptureOnStartupEnabled(),
                                      instance->GetBackendValidationLevel()));
