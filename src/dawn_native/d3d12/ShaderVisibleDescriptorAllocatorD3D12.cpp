...
namespace dawn_native { namespace d3d12 {
    ...
    MaybeError ShaderVisibleDescriptorAllocator::Initialize() {
        ...
        DAWN_TRY(AllocateAndSwitchShaderVisibleHeap());
        return {};
    }
    ...
    bool ShaderVisibleDescriptorAllocator::AllocateGPUDescriptors(
        ...
        *baseCPUDescriptor = {descriptorHeap->GetCPUDescriptorHandleForHeapStart().ptr +
                              heapOffset};

        *baseGPUDescriptor = {descriptorHeap->GetGPUDescriptorHandleForHeapStart().ptr +
                              heapOffset};
    ...
    Serial ShaderVisibleDescriptorAllocator::GetShaderVisibleHeapSerial() const {
        return mHeapSerial;
    }
    ...
    bool ShaderVisibleDescriptorAllocator::IsAllocationStillValid(
        GPUDescriptorHeapAllocation* allocation) const {
