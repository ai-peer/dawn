...
namespace dawn_native { namespace d3d12 {
    ...
    bool ShaderVisibleDescriptorAllocator::AllocateGPUDescriptors(
        ...
        ID3D12DescriptorHeap* descriptorHeap = mHeap->GetD3D12DescriptorHeap().Get();
    ...
    ID3D12DescriptorHeap* ShaderVisibleDescriptorAllocator::GetShaderVisibleHeap() const {
        return mHeap->GetD3D12DescriptorHeap().Get();
    }
    ...
    MaybeError ShaderVisibleDescriptorAllocator::AllocateAndSwitchShaderVisibleHeap() {
        std::unique_ptr<Heap> descriptorHeap;
        ...
        if (descriptorHeap == nullptr) {
            ...
            descriptorHeap =
                std::make_unique<Heap>(std::move(d3d12DescriptorHeap), MemorySegment::Local,
