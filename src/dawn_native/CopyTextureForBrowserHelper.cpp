...
namespace dawn_native {
    namespace {
        ...
        static const char sPassthrough2D4ChannelFrag[] = R"(
            ...
            [[binding(3), group(0)]] var<uniform> colorConversionOp : ColorConversionOp;
    ...
    MaybeError DoCopyTextureForBrowser(DeviceBase* device,
        ...
        device->GetQueue()->WriteBuffer(colorConversionOpsBuffer.Get(), 0, colorConversionOps,
                                        sizeof(colorConversionOps));
