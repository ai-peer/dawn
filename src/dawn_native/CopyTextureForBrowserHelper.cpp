    ...
    namespace {
        ...
        static const char sCopyTextureForBrowserVertex[] = R"(
            ...
            [[stage(vertex)]] fn main() -> void {
                ...
                if (flipY) {
                    // For the flipY case, we need to get the mirror positions(mirrored based on y = 0.5).
                    // Adopt transform to src texture and then mapping it to triangle coord which do a
                    // +1 shift on Y dimension will help us got that mirror position perfectly.
