...
namespace dawn_native {
    namespace {
        ...
        static const char sCopyTextureForBrowserShader[] = R"(
            ...
            fn fs_main(
                ...
                // Decode for copying from non-srgb-ness formats to srgb-ness formats
    ...
    // Whether the format of dst texture of CopyTextureForBrowser() is srgb-ness.
    ...
    MaybeError DoCopyTextureForBrowser(DeviceBase* device,
        ...
        DAWN_TRY_ASSIGN(dstView,
                        device->CreateTextureView(destination->texture.Get(), &dstTextureViewDesc));
