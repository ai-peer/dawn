...
namespace dawn_native {
        ...
        MaybeError ValidateCopyTextureFormatConversion(const wgpu::TextureFormat srcFormat,
            ...
            switch (srcFormat) {
                ...
                case wgpu::TextureFormat::RGBA8Unorm:
                    break;
                default:
                    DAWN_INVALID_IF(true, "Source texture format (%s) is not supported.",
                                    srcFormat);
            }
            ...
            switch (dstFormat) {
                ...
                case wgpu::TextureFormat::RGB10A2Unorm:
                    break;
                default:
                    DAWN_INVALID_IF(true, "Destination texture format (%s) is not supported.",
                                    srcFormat);
            }
    ...
    MaybeError ValidateCopyTextureForBrowser(DeviceBase* device,
        ...
        DAWN_TRY_CONTEXT(ValidateImageCopyTexture(device, *source, *copySize),
                         "validating the source ImageCopyTexture for the source");
        DAWN_TRY_CONTEXT(ValidateImageCopyTexture(device, *destination, *copySize),
                         "validating the destination ImageCopyTexture for the destination");
        ...
        DAWN_INVALID_IF(
            ...
            "The source or destination texture is multisampled.");
