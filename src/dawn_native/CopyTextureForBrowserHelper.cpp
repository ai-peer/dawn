        ...
        static const char sCopyTextureForBrowserShader[] = R"(
            ...
            fn fs_main(
                ...
                if (bool(uniforms.steps_mask & kDecodeToLinearStep)) {
                    color = vec4<f32>(gamma_conversion(color.rgb, uniforms.gamma_decoding_params), color.a);
                }
                ...
                if (bool(uniforms.steps_mask & kEncodeToGammaStep)) {
                    color = vec4<f32>(gamma_conversion(color.rgb, uniforms.gamma_encoding_params), color.a);
                }
