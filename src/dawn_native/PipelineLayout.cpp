...
namespace dawn_native {
    ...
    ResultOrError<PipelineLayoutBase*> PipelineLayoutBase::CreateDefault(
        ...
        Ref<PipelineLayoutBase> pipelineLayout = nullptr;
        {
        ...
        for (const StageAndDescriptor& stage : stages) {
            ...
            ASSERT(ValidateCompatibilityWithPipelineLayout(metadata, pipelineLayout.Get()).IsSuccess());
        }

        return pipelineLayout.Detach();
    }
