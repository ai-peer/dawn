...
namespace dawn_native {
    ...
    struct Format {
      ...
      private:
        ...
        // Helper used by BuildFormatTable to populate aspect info per plane.
        friend AspectInfo GetSinglePlaneAspectInfo(wgpu::TextureFormat format, FormatTable& table);
    };
