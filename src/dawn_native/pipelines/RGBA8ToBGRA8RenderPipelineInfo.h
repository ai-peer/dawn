...
#ifndef DAWNNATIVE_PIPELINES_RGBA8TOBGRA8RENDERPIPELINEINFO_H_
#define DAWNNATIVE_PIPELINES_RGBA8TOBGRA8RENDERPIPELINEINFO_H_
...
namespace dawn_native {
    class RGBA8ToBGRA8RenderPipelineInfo : public BaseRenderPipelineInfo {
      public:
        RGBA8ToBGRA8RenderPipelineInfo();
...
#endif  // DAWNNATIVE_PIPELINES_RGBA8TOBGRA8RENDERPIPELINEINFO_H_
