...
namespace dawn_native {
    ...
    MaybeError ValidateLinearTextureData(const TextureDataLayout& layout, uint64_t byteSize,
                                         const Format& format, const Extent3D& copyExtent);
    MaybeError ValidateTextureCopyRange(const TextureCopyView& textureCopyView, const Extent3D& copySize);
