...
namespace dawn_native {
    ...
    BufferBase::BufferBase(DeviceBase* device, const BufferDescriptor* descriptor)
        ...
        // only compatible with InternalStorageBuffer binding type in BGL. And It shouldn't be
        // compatible with StorageBuffer binding type to make the query resolve buffer cannot be
        // binded as storage buffer if it's created without Storage usage.
