...
namespace dawn_native {
    ...
    // Populate |limits| and any chained limit structs with the default limits
    void GetDefaultLimits(wgpu::Limits* limits);

    // Assigns members of |updatedLimits| to |currentLimits| if members are not the
    // special value WGPU_LIMIT_UNDEFINED.
