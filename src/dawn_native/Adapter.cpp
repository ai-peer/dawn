...
namespace dawn_native {
    ...
    AdapterBase::AdapterBase(InstanceBase* instance, BackendType backend) : mInstance(instance), mBackend(backend) {
    }
    ...
    MaybeError AdapterBase::CreateDeviceInternal(DeviceBase** result) {
        // This will eventually have validation that the device descriptor is valid and is a subset of what's allowed on this adapter.
