...
namespace dawn_native {
    ...
    MaybeError ValidateTextureToTextureCopyCommonRestrictions(const TextureCopyView& src,
    ...
    // CopyTextureForBrowser could handle color conversion during the copy
    MaybeError ValidateCopyTextureForBrowserRestrictions(const TextureCopyView& src,
                                                         const TextureCopyView& dst,
                                                         const Extent3D& copySize) {
        return ValidateTextureToTextureCopyCommonRestrictions(src, dst, copySize);
    }
