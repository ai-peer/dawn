...
namespace dawn_native {
    ...
    namespace {
        ...
        bool CompatibleBindingType(const BindingInfo& layoutInfo,
                                   const EntryPointMetadata::ShaderBindingInfo& shaderInfo) {
            ...
            switch (layoutInfo.bindingType) {
                case BindingInfoType::Buffer: {
                    ...
                    return validBindingConversion ||
                           (layoutInfo.buffer.type == shaderInfo.buffer.type);
                }
                ...
                case BindingInfoType::Texture:
                    return layoutInfo.texture.multisampled == shaderInfo.texture.multisampled;

                case BindingInfoType::StorageTexture:
                    return layoutInfo.storageTexture.access == shaderInfo.storageTexture.access;
            }
        }
        ...
        MaybeError ValidateCompatibilityWithBindGroupLayout(DeviceBase* device,
            ...
            for (const auto& it : entryPoint.bindings[group]) {
                ...
                if (!CompatibleBindingType(layoutInfo, shaderInfo)) {
        ...
        ResultOrError<std::unique_ptr<EntryPointMetadata>> ExtractSpirvInfo(
            ...
            auto ExtractResourcesBinding =
                ...
                for (const auto& resource : resources) {
                    ...
                    if (bindingType == BindingInfoType::Buffer) {
