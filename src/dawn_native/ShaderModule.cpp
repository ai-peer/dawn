...
namespace dawn_native {
    ...
    ShaderModuleBase::ShaderBindingInfo::ShaderBindingInfo() {
        this->textureDimension = wgpu::TextureViewDimension::Undefined;
        this->textureComponentType = Format::Type::Float;
        this->multisampled = false;
        this->storageTextureFormat = wgpu::TextureFormat::Undefined;
    }
