...
namespace dawn_native {
    ...
    std::unique_ptr<tint::transform::VertexPulling::Config> MakeVertexPullingTransformConfig(
        ...
        return std::make_unique<tint::transform::VertexPulling::Config>(cfg);
    }
    ...
    ResultOrError<std::vector<uint32_t>> ShaderModuleBase::GeneratePullingSpirv(
        ...
        tint::transform::DataMap transformInputs;
        transformInputs.Put(
            MakeVertexPullingTransformConfig(vertexState, entryPoint, pullingBufferBindingSet));
