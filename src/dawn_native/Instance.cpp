...
namespace dawn_native {
    ...
    // Conditionnally compiled declarations are used to avoid using static constructors instead.
    ...
    void InstanceBase::DiscoverDefaultAdapters() {
        ...
        for (auto& backend : mBackends) {
            std::vector<std::unique_ptr<AdapterBase>> backendAdapters = backend->DiscoverDefaultAdapters();
            for (auto& adapter : backendAdapters) {
