...
namespace dawn_native {
    ...
    ResultOrError<ResourceMemoryAllocationBase>
    BuddyMemoryAllocator::Allocate(uint64_t allocationSize, uint64_t alignment, int memoryFlags) {
        ResourceMemoryAllocationBase invalidAllocation = ResourceMemoryAllocationBase{};
        ...
        return ResourceMemoryAllocationBase{info, memoryOffset};
    }  // namespace dawn_native

    void BuddyMemoryAllocator::Deallocate(const ResourceMemoryAllocationBase& allocation) {
