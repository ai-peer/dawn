...
namespace dawn_native {
    ...
    ComputePassEncoder* CommandEncoder::APIBeginComputePass(
        ...
        bool success = TRY_ENCODE_CONTEXT(
            (&mEncodingContext),
            ...
            "encoding BeginComputePass with %s", descriptor);
    ...
    RenderPassEncoder* CommandEncoder::APIBeginRenderPass(const RenderPassDescriptor* descriptor) {
        ...
        bool success = TRY_ENCODE_CONTEXT(
            ...
            "encoding BeginRenderPass with %s", descriptor);
    ...
    void CommandEncoder::APICopyBufferToBuffer(BufferBase* source,
        ...
        TRY_ENCODE_CONTEXT(
            ...
            "encoding CopyBufferToBuffer from %s to %s", source, destination);
    }
    ...
    void CommandEncoder::APICopyBufferToTexture(const ImageCopyBuffer* source,
        ...
        TRY_ENCODE_CONTEXT(
            ...
            "encoding CopyBufferToTexture from %s to %s", source->buffer, destination->texture);
    }
    ...
    void CommandEncoder::APICopyTextureToBuffer(const ImageCopyTexture* source,
        ...
        TRY_ENCODE_CONTEXT(
            ...
            "encoding CopyTextureToBuffer from %s to %s", source->texture, destination->buffer);
    }
    ...
    void CommandEncoder::APICopyTextureToTextureHelper(const ImageCopyTexture* source,
        ...
        TRY_ENCODE_CONTEXT(
            ...
            "encoding CopyTextureToTexture from %s to %s", source->texture, destination->texture);
    }
    ...
    void CommandEncoder::APIPopDebugGroup() {
        TRY_ENCODE_CONTEXT((&mEncodingContext),
                           [&](CommandAllocator* allocator) -> MaybeError {
                               if (GetDevice()->IsValidationEnabled()) {
    ...
    void CommandEncoder::APIResolveQuerySet(QuerySetBase* querySet,
        ...
        TRY_ENCODE_CONTEXT(
            ...
            "encoding ResolveQuerySet from %s to %s", querySet, destination);
    }
    ...
    void CommandEncoder::APIWriteBuffer(BufferBase* buffer,
        ...
        TRY_ENCODE_CONTEXT(
            ...
            "encoding WriteBuffer with %s", buffer);
    }
