...
namespace dawn_native {
    ...
    ComputePassEncoder* CommandEncoder::BeginComputePass(const ComputePassDescriptor* descriptor) {
        ...
        bool success =
            mEncodingContext.TryEncode(this, [&](CommandAllocator* allocator) -> MaybeError {
                ...
                ASSERT(mEncodingContext.GetUsageTracker()->PassUsagesEmpty());
    ...
    CommandBufferBase* CommandEncoder::Finish(const CommandBufferDescriptor* descriptor) {
        ...
        if (DAWN_UNLIKELY(GetDevice()->ConsumedError(mEncodingContext.Finish()) ||
                          GetDevice()->ConsumedError(
                              ValidateFinish(descriptor, mEncodingContext.GetIterator())))) {
