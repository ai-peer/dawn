    ...
    namespace {
        ...
        MaybeError ValidateRenderPassColorAttachment(
            ...
            if (colorAttachment.loadOp == wgpu::LoadOp::Clear) {
                ...
                if (std::abs(colorAttachment.clearColor.r) > 16777215.0 ||
                    ...
                    return DAWN_VALIDATION_ERROR("Clear values with an absolute value of more than 16777215.0 (2^24 - 1) are invalid.");
                }
            }
