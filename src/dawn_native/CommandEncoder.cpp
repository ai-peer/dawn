    ...
    void CommandEncoder::CopyBufferToTexture(const BufferCopyView* source,
        ...
        mEncodingContext.TryEncode(this, [&](CommandAllocator* allocator) -> MaybeError {
            ...
            if (GetDevice()->IsValidationEnabled()) {
                ...
                DAWN_TRY(ValidateLinearTextureData(sourceAsTextureDataLayout, source->buffer->GetSize(),
    ...
    void CommandEncoder::CopyTextureToBuffer(const TextureCopyView* source,
        ...
        mEncodingContext.TryEncode(this, [&](CommandAllocator* allocator) -> MaybeError {
            ...
            if (GetDevice()->IsValidationEnabled()) {
                ...
                DAWN_TRY(ValidateLinearTextureData(dstAsTextureDataLayout, destination->buffer->GetSize(),
