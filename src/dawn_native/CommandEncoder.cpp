...
namespace dawn_native {
    ...
    namespace {
        ...
        MaybeError ValidateQuerySetResolve(const QuerySetBase* querySet,
            ...
            // The maximum count of queries for that can be resolved. If the queryCount is too
            // large, the computation of queryCount and sizeof(uint64_t) (each query result is
            // written into 64-bits) maybe overflow in 32bit mode compilation.
