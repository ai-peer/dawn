...
namespace dawn_native {
    ...
    namespace {
        ...
        MaybeError ValidateCopySizeAlignment(uint32_t dataSize, uint32_t srcOffset, uint32_t dstOffset) {
        ...
        while (mIterator.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::CopyBufferToBuffer: {
                    ...
                    DAWN_TRY(ValidateCopySizeAlignment(copy->size, copy->source.offset, copy->destination.offset));
