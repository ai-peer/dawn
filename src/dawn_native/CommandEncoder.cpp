        ...
        while (mIterator.NextCommandId(&type)) {
            switch (type) {
                ...
                case Command::CopyBufferToBuffer: {
                    ...
                    ASSERT(GetDevice()->ValidateObject(copy->source.buffer.Get()).IsSuccess());
                    ASSERT(GetDevice()->ValidateObject(copy->destination.buffer.Get()).IsSuccess());
                ...
                case Command::CopyBufferToTexture: {
                    ...
                    ASSERT(GetDevice()->ValidateObject(copy->source.buffer.Get()).IsSuccess());
                    ASSERT(GetDevice()->ValidateObject(copy->destination.texture.Get()).IsSuccess());
                ...
                case Command::CopyTextureToBuffer: {
                    ...
                    ASSERT(GetDevice()->ValidateObject(copy->source.texture.Get()).IsSuccess());
                    ASSERT(GetDevice()->ValidateObject(copy->destination.buffer.Get()).IsSuccess());
