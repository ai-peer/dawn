...
namespace dawn_native {
    ...
    // For the enum for formats are packed but this might change when we have a broader extension mechanism for webgpu.h
    ...
    FormatTable BuildFormatTable(const DeviceBase*) {
        ...
        auto AddFormat = [&table, &formatsSet](Format format) {
            ...
            // This checks that each format is set at most once, the first part of checking that all formats are set exactly once.
        ...
        // This checks that each format is set at least once, the second part of checking that all formats are checked exactly once.
