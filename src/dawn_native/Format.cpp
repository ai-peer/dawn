...
namespace dawn_native {
    ...
    bool IsColor(const AspectMask& aspectMask) {
        return aspectMask == SingleAspectMask(TextureAspect::Color);
    }
    ...
    static_assert(AspectMask().size() == kTextureAspectCount, "");
    ...
    FormatTable BuildFormatTable(const DeviceBase* device) {
        ...
        auto AddColorFormat = [&AddFormat](wgpu::TextureFormat format, bool renderable,
            ...
            internalFormat.aspectMask = SingleAspectMask(TextureAspect::Color);
        ...
        auto AddDepthFormat = [&AddFormat](wgpu::TextureFormat format, uint32_t byteSize,
            ...
            internalFormat.isSupported = true;
            internalFormat.supportsStorageUsage = false;
            internalFormat.aspectMask = SingleAspectMask(TextureAspect::Depth);
            internalFormat.type = type;
            internalFormat.blockByteSize = byteSize;
            internalFormat.blockWidth = 1;
            internalFormat.blockHeight = 1;
        ...
        AddDepthStencilFormat(wgpu::TextureFormat::Depth24Plus, SingleAspectMask(TextureAspect::Depth), 4);
        ...
        AddDepthStencilFormat(wgpu::TextureFormat::Depth24PlusStencil8,
                              SingleAspectMask(TextureAspect::Depth) | SingleAspectMask(TextureAspect::Stencil), 4);
