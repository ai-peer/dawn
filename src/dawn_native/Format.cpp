...
namespace dawn_native {
    ...
    FormatTable BuildFormatTable(const DeviceBase* device) {
        ...
        auto AddFormat = [&table, &formatsSet](Format format) {
            ...
            // Multi-plane textures are not copyable and have no first aspect.
        ...
        const bool isMultiPlaneFormatSupported = device->IsExtensionEnabled(Extension::MultiPlaneTextures);
