...
namespace dawn_native {
    ...
    FormatTable BuildFormatTable(const DeviceBase* device) {
        ...
        auto AddMultiAspectFormat =
            [&AddFormat, &table, &formatsSet](
                wgpu::TextureFormat format, Aspect aspects, wgpu::TextureFormat firstFormat,
                wgpu::TextureFormat secondFormat, bool isRenderable, bool isSupported) {
                Format internalFormat;
                internalFormat.format = format;
                ...
                ASSERT(formatsSet[firstFormatIndex]);
                ASSERT(formatsSet[secondFormatIndex]);
