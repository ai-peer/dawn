...
namespace dawn_native {
    ...
    enum class InternalErrorType : uint32_t { Validation, ContextLost, Unimplemented, OutOfMemory };
...
#define DAWN_CONTEXT_LOST_ERROR(MESSAGE) DAWN_MAKE_ERROR(InternalErrorType::ContextLost, MESSAGE)
