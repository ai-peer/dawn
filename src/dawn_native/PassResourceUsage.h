...
namespace dawn_native {
    ...
    // at frontend.
    //
    // - definitelySameUsagesAcrossSubresources is used for optimization at backend. If the texture
    // view we are using covers all subresources, then the texture's usages of all subresources are
    ...
    // TODO(yunchao.he@intel.com): if definitelySameUsagesAcrossSubresources is true, we don't need
    ...
    struct PassTextureUsage {
        ...
        bool definitelySameUsagesAcrossSubresources;
