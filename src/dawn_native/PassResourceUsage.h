...
namespace dawn_native {
    ...
    // Note that if sameUsagesAcrossSubresources is true, we won't store every single subresource's
    // usages. We can use the entire texture's usage. In that case, this vector is null.
