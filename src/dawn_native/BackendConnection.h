...
namespace dawn_native {
    ...
    // An common interface for all backends. Mostly used to create adapters for a particular backend.
    class BackendConnection {
      public:
        ...
        // Returns all the adapters for the system that can be created by the backend, without extra options (such as debug adapters, custom driver libraries, etc.)
