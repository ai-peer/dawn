...
namespace dawn_native {
    ...
    void PassResourceUsageTracker::TextureViewUsedAs(TextureViewBase* view,
        ...
        textureUsage.definitelySameUsagesAcrossSubresources =
    ...
    void PassResourceUsageTracker::AddTextureUsage(TextureBase* texture,
        ...
        if (passTextureUsage.definitelySameUsagesAcrossSubresources !=
            textureUsage.definitelySameUsagesAcrossSubresources) {
            passTextureUsage.definitelySameUsagesAcrossSubresources = false;
        }
