...
namespace dawn_native {
    ...
    enum class PassResourceUsageTracker::PassType {
        Render,
        Compute,
    };
    ...
    MaybeError PassResourceUsageTracker::ValidateComputePassUsages() const {
        return ValidateUsages(PassType::Compute);
    }

    MaybeError PassResourceUsageTracker::ValidateRenderPassUsages() const {
        return ValidateUsages(PassType::Render);
    }

    // Performs the per-pass usage validation checks
    MaybeError PassResourceUsageTracker::ValidateUsages(PassType pass) const {
