...
namespace dawn_native {
    ...
    class QueueBase : public ObjectBase {
      public:
        struct TaskInFlight {
            enum class Type { FenceInFlightTask, MapRequestTask };
            Type type;
        };
        ...
        void TrackTasksInFlight(std::unique_ptr<TaskInFlight> task);
        void TickTasksInFlight(ExecutionSerial finishedSerial);
