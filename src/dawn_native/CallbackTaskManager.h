    ...
    class WorkerThreadTaskManager {
      ...
      private:
        class WaitableTask : public RefCounted {
          public:
            dawn_platform::WaitableEvent* GetWaitableEvent();
            void SetWaitableEvent(std::unique_ptr<dawn_platform::WaitableEvent> waitableEvent);
          ...
          private:
            ...
            std::mutex mWaitableEventMutex;
            std::condition_variable mWaitableEventConditionVariable;
        };
