...
namespace dawn_native {
    ...
    bool DeviceBase::IsDeviceIdle() {
        if (mWaitableEventManager->HasWaitableEventsInFlight()) {
            return false;
        }
    ...
    std::unique_ptr<CallbackTask> DeviceBase::CreateComputePipelineAsyncWaitableCallbackTask(
        ...
        return std::make_unique<CreateComputePipelineAsyncWaitableCallbackTask>(
