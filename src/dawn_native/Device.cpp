...
namespace dawn_native {
    ...
    ResultOrError<Ref<ComputePipelineBase>> DeviceBase::CreateComputePipelineInternal(
        ...
        DAWN_TRY(ValidateAndGetComputePipelineDescriptorWithDefaults(
            *descriptor, &appliedDescriptor, &layoutRef));
    ...
    MaybeError DeviceBase::ValidateAndGetComputePipelineDescriptorWithDefaults(
        const ComputePipelineDescriptor& descriptor,
