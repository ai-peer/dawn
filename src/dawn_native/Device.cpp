...
namespace dawn_native {
    ...
    void DeviceBase::ShutDownBase() {
        ...
        if (mState != State::BeingCreated) {
            ...
            auto callbackTasks = mCallbackTaskManager->FetchAndClearAllCallbackTasks();
    ...
    MaybeError DeviceBase::Tick() {
        ...
        // Currently we have to check mCallbackTaskManager in every Tick because it is not related
        // to any global serials.
