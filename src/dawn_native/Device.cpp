...
namespace dawn_native {
    ...
    void DeviceBase::AddRenderPipelineAsyncCallbackTask(
        ...
        struct CreateRenderPipelineAsyncWaitableCallbackTask final
            ...
            void Finish() final {
                // TODO(jiawei.shao@intel.com): call AddOrGetCachedRenderPipeline() asynchronously
                // in CreateRenderPipelineAsyncTaskImpl::Run() when the front-end pipeline cache is
                // thread-safe.
                if (mPipeline.Get() != nullptr) {
