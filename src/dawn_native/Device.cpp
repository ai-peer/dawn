...
namespace dawn_native {
    ...
    void DeviceBase::ShutDownBase() {
        ...
        // Wait for the completion of all the in-flight async CreatePipelineAsync tasks and clear
        // them
        if (mCreatePipelineAsyncTaskManager) {
            mCreatePipelineAsyncTaskManager->WaitAll();
    ...
    dawn_platform::WorkerTaskPool* DeviceBase::GetOrCreateWorkerTaskPool() {
        if (mWorkerTaskPool) {
