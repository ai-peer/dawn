...
namespace dawn_native {
    ...
    ResultOrError<Ref<ComputePipelineBase>> DeviceBase::CreateComputePipeline(
        ...
        Ref<ComputePipelineBase> uninitializedComputePipeline =
            CreateUnintializedComputePipeline(&appliedDescriptor);
    ...
    Ref<ComputePipelineBase> DeviceBase::CreateUnintializedComputePipeline(
        const ComputePipelineDescriptor* descriptor) {
        ...
        struct CreateComputePipelineAsyncWaitableCallbackTask final
            ...
            void Finish() final {
                ...
                if (mPipeline.Get() != nullptr) {
                    mPipeline =
                        mPipeline->GetDevice()->AddOrGetCachedComputePipeline(std::move(mPipeline));
                }
    ...
    void DeviceBase::AddRenderPipelineAsyncCallbackTask(
        ...
        struct CreateRenderPipelineAsyncWaitableCallbackTask final
            ...
            void Finish() final {
                ...
                if (mPipeline.Get() != nullptr) {
                    mPipeline =
                        mPipeline->GetDevice()->AddOrGetCachedRenderPipeline(std::move(mPipeline));
                }
