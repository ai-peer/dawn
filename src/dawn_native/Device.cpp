...
namespace dawn_native {
    ...
    ResultOrError<Ref<ComputePipelineBase>> DeviceBase::CreateComputePipeline(
        ...
        ComboComputePipelineDescriptor appliedDescriptor(descriptor);
    ...
    MaybeError DeviceBase::CreateComputePipelineAsync(
        ...
        std::unique_ptr<ComboComputePipelineDescriptor> appliedDescriptor =
            std::make_unique<ComboComputePipelineDescriptor>(descriptor);
    ...
    MaybeError DeviceBase::ValidateLayoutAndSetDefaultLayout(
        ComboComputePipelineDescriptor* outDescriptor) {
