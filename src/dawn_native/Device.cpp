...
namespace dawn_native {
    ...
    void DeviceBase::ShutDownBase() {
        ...
        if (mState != State::BeingCreated) {
            ...
            auto callbacksInFlight =
                mCallbackQueue->AcquireCallbacksWithFinishedSerial(GetCompletedCommandSerial());
    ...
    MaybeError DeviceBase::Tick() {
        ...
        if (mLastSubmittedSerial > mCompletedSerial || mCompletedSerial < mFutureSerial) {
            ...
            auto callbacksInFlight =
                mCallbackQueue->AcquireCallbacksWithFinishedSerial(mCompletedSerial);
            for (auto& callback : callbacksInFlight) {
                if (IsLost()) {
