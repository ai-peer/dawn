...
namespace dawn_native {
    ...
    class CommandIterator {
      public:
        ...
        // Needs to be called after commands have been deleted. This indicates that the commands
        // have been submitted and they is no longer valid.
        void ResetAndMakeEmpty();
