...
namespace dawn_native {
    ...
    namespace {
        ...
        // first.
        bool CheckBufferBindingsFirst(TypeIndexedSpan<BindingIndex, const BindingInfo> bindings) {
    ...
    BindGroupLayoutBase::BindGroupLayoutBase(DeviceBase* device,
        ...
        ASSERT(CheckBufferBindingsFirst(
            TypeIndexedSpan<BindingIndex, const BindingInfo>(mBindingInfo.data(), mBindingCount)));
    }
    ...
    BindingIndex BindGroupLayoutBase::GetDynamicBufferCount() const {
        // This is a binding index because dynamic buffers are packed at the front if the binding
        // info.
