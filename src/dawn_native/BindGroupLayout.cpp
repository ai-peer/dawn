...
namespace dawn_native {
    ...
    MaybeError ValidateBindGroupLayoutDescriptor(DeviceBase* device,
        ...
        for (uint32_t i = 0; i < descriptor->entryCount; ++i) {
            ...
            if (entry.externalTexture.allowedType != wgpu::ExternalTextureAllowedType::Undefined) {
                bindingMemberCount++;
            }
    ...
    namespace {
        ...
        bool operator!=(const BindingInfo& a, const BindingInfo& b) {
            ...
            switch (a.bindingType) {
                ...
                case BindingInfoType::ExternalTexture:
                    return a.externalTexture.allowedType != b.externalTexture.allowedType;
            }
        }
        ...
        bool IsBufferBinding(const BindGroupLayoutEntry& binding) {
            if (binding.buffer.type != wgpu::BufferBindingType::Undefined) {
                ...
                return false;
            } else if (binding.externalTexture.allowedType !=
        ...
        BindingInfo CreateBindGroupLayoutInfo(const BindGroupLayoutEntry& binding) {
            ...
            if (binding.buffer.type != wgpu::BufferBindingType::Undefined) {
                ...
                switch (binding.type) {
                    ...
                    case wgpu::BindingType::ExternalTexture:
                        bindingInfo.bindingType = BindingInfoType::ExternalTexture;
                        bindingInfo.externalTexture.allowedType =
                            binding.externalTexture.allowedType;
                        break;
                    case wgpu::BindingType::Undefined:
                        UNREACHABLE();
                }
    ...
    size_t BindGroupLayoutBase::ComputeContentHash() {
        ...
        for (const auto& it : mBindingMap) {
            ...
            recorder.Record(info.buffer.hasDynamicOffset, info.visibility, info.bindingType,
                            ...
                            info.externalTexture.allowedType);
        }
