...
namespace dawn_native {
                    ...
                    if (binding.dynamic) {
                        ...
                        if (dynamicUniformBufferCount > kMaxDynamicUniformBufferCount) {
                            return DAWN_VALIDATION_ERROR(
                                "Dynamic uniform buffer numbers exceed the maximum value");
                        }
                    }
                    break;
                case dawn::BindingType::StorageBuffer:
                    if (binding.dynamic) {
                        ...
                        if (dynamicStorageBufferCount > kMaxDynamicStorageBufferCount) {
                            return DAWN_VALIDATION_ERROR(
                                "Dynamic storage buffer numbers exceed the maximum value");
                        }
                    }
                    break;
    ...
    BindGroupLayoutBase::BindGroupLayoutBase(DeviceBase* device,
        ...
        mDynamicBufferCount = mDynamicUniformBufferCount + mDynamicStorageBufferCount;
    }
