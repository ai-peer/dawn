...
namespace dawn_native {
    ...
    class PersistentCache {
      public:
        ...
        // If the load was successfull, a non-empty blob is returned to the caller.
