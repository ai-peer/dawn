...
namespace dawn_native {
    ...
    class TextureBase : public ObjectBase {
      public:
        ...
        // size is the one with paddings if necessary, which is always a multiple of 4 and used in
        // texture copying. Thevirtual size is the one without paddings, which is not required to be
        // a multiple of 4 and used in texture sampling.
