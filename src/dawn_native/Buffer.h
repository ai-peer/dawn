    ...
    class BufferBase : public ObjectBase {
      ...
      public:
        ...
        void MapAsync(wgpu::MapMode mode,
                      ...
                      void* userdata);
        void* GetMappedRange(size_t offset = 0, size_t size = 0);
        const void* GetConstMappedRange(size_t offset = 0, size_t size = 0);
        void Unmap();
        void Destroy();
      ...
      private:
        ...
        void* GetMappedRangeInternal(bool writable, size_t offset = 0, size_t size = 0);
