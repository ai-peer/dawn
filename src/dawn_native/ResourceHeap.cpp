...
namespace dawn_native {
    ...
    ResourceHeapBase::ResourceHeapBase(size_t size, uint32_t heapTypeIndex)
        : mSize(size), mHeapTypeIndex(heapTypeIndex) {
    }
    ...
    uint32_t ResourceHeapBase::GetHeapTypeIndex() const {
        return mHeapTypeIndex;
    }
