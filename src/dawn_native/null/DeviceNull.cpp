...
namespace dawn_native { namespace null {
    ...
    CommandBufferBase* Device::CreateCommandBuffer(CommandEncoderBase* encoder, const CommandBufferDescriptor* descriptor) {
        return new CommandBuffer(this, encoder, descriptor);
    }
    ...
    CommandBuffer::CommandBuffer(Device* device, CommandEncoderBase* encoder, const CommandBufferDescriptor* descriptor)
        : CommandBufferBase(device, encoder), mCommands(encoder->AcquireCommands(), descriptor) {
    }
