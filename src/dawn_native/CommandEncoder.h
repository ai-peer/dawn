...
namespace dawn_native {
    ...
    // Query states are used to indicate and validate the state of the queries used in the encoders.
    // The query states as below:
    ...
    class CommandEncoder final : public ObjectBase {
      public:
        ...
        void AddQueryStatesMap(QueryStatesMap& queryStatesMap);
