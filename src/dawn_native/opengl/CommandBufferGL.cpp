...
namespace dawn_native { namespace opengl {
            ...
            switch (type) {
                ...
                case Command::CopyTextureToTexture: {
                    ...
                    if (gl.IsAtLeastGL(4, 3) || gl.IsAtLeastGLES(3, 2)) {
                        ...
                        CopyTextureToTextureWithBlit(src, dst, copySize);
                    }
                    break;
                }
    ...
    void CommandBuffer::CopyTextureToTextureWithBlit(const TextureCopy& src,
            ...
            for (Aspect aspect : IterateEnumMask(src.aspect)) {
                ...
                if (srcTexture->GetArrayLayers() == 1) {
                    ...
                    gl.FramebufferTextureLayer(
                        GL_READ_FRAMEBUFFER, glAttachment, srcTexture->GetHandle(),
                        static_cast<GLint>(src.mipLevel), static_cast<GLint>(src.origin.z + layer));
                }
                if (dstTexture->GetArrayLayers() == 1) {
                    ...
                    gl.FramebufferTextureLayer(
                        GL_DRAW_FRAMEBUFFER, glAttachment, dstTexture->GetHandle(),
                        static_cast<GLint>(dst.mipLevel), static_cast<GLint>(dst.origin.z + layer));
                }
            }
