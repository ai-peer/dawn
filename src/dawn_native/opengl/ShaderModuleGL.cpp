...
namespace dawn_native { namespace opengl {
    ...
    std::string ShaderModule::TranslateToGLSL(const char* entryPointName,
        ...
        //
        // Note that this loops over all the bindings of either SPIRV-Cross or Tint, but the
        // reflection data could have been generated by a different compiler that reflects fewer
        // bindings. (Tint is more precise than SPIRV-Cross) so we defensively check that the
        // binding exists in the layout.
