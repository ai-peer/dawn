...
namespace dawn_native { namespace opengl {
    ...
    std::string ShaderModule::TranslateToGLSL(const char* entryPointName,
        ...
        //
        // Note that this loops overall all the bindings of either SPIRV-Cross or Tint, but the
        // reflection data can have been generated by a different compiler that reflects less
