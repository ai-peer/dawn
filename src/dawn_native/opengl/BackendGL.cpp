      ...
      private:
        ...
        void InitializeSupportedExtensions() {
            // TextureCompressionBC
            {
                ...
                bool supportsS3TC =
                    mFunctions.IsExtensionSupported("GL_EXT_texture_compression_s3tc");
                ...
                bool supportsTextureSRGB = mFunctions.IsExtensionSupported("GL_EXT_texture_sRGB");

                // GL_EXT_texture_compression_s3tc_srgb is an extension in OpenGL ES.
                bool supportsS3TCSRGB =
                    mFunctions.IsExtensionSupported("GL_EXT_texture_compression_s3tc_srgb");

                // BC4 and BC5
                bool supportsRGTC =
                    mFunctions.IsAtLeastGL(3, 0) ||
                    mFunctions.IsExtensionSupported("GL_ARB_texture_compression_rgtc") ||
                    mFunctions.IsExtensionSupported("GL_EXT_texture_compression_rgtc");

                // BC6 and BC7
                bool supportsBPTC =
                    mFunctions.IsAtLeastGL(4, 2) ||
                    mFunctions.IsExtensionSupported("GL_ARB_texture_compression_bptc") ||
                    mFunctions.IsExtensionSupported("GL_EXT_texture_compression_bptc");
