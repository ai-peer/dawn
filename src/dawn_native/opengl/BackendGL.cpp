      ...
      private:
        ...
        void InitializeSupportedExtensions() {
            ...
            for (int32_t i = 0; i < numExtensions; ++i) {
                ...
                supportedExtensionsSet.insert(extensionName);
            }

            auto IsExtensionSupported = [&](const char* extension) -> bool {
                return supportedExtensionsSet.find(extension) != supportedExtensionsSet.cend();
            };

            // TextureCompressionBC
            {
                // BC1, BC2 and BC3 are not supported in OpenGL or OpenGL ES core features.
                bool supportsS3TC = IsExtensionSupported("GL_EXT_texture_compression_s3tc");
                ...
                bool supportsTextureSRGB = IsExtensionSupported("GL_EXT_texture_sRGB");

                // GL_EXT_texture_compression_s3tc_srgb is an extension in OpenGL ES.
                bool supportsS3TCSRGB =
                    IsExtensionSupported("GL_EXT_texture_compression_s3tc_srgb");

                // BC4 and BC5
                bool supportsRGTC = mFunctions.IsAtLeastGL(3, 0) ||
                                    IsExtensionSupported("GL_ARB_texture_compression_rgtc") ||
                                    IsExtensionSupported("GL_EXT_texture_compression_rgtc");

                // BC6 and BC7
                bool supportsBPTC = mFunctions.IsAtLeastGL(4, 2) ||
                                    IsExtensionSupported("GL_ARB_texture_compression_bptc") ||
                                    IsExtensionSupported("GL_EXT_texture_compression_bptc");
