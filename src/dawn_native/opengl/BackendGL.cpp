      ...
      private:
        ...
        void InitializeSupportedFeatures() {
            ...
            // TextureCompressionASTC
            {
                ...
                // Note that the HDR profile is a superset of the LDR support, so we only check for
                // the HDR support extension. See
                // https://www.khronos.org/registry/OpenGL/extensions/KHR/KHR_texture_compression_astc_hdr.txt
                bool supportedInGL =
                    mFunctions.IsGLExtensionSupported("GL_KHR_texture_compression_astc_hdr");
