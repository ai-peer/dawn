        ...
        GLenum TargetForTextureViewDimension(dawn::TextureViewDimension dimension,
            ...
            switch (dimension) {
                ...
                case dawn::TextureViewDimension::e2DArray:
                    return (sampleCount > 1)? GL_TEXTURE_2D_MULTISAMPLE_ARRAY : GL_TEXTURE_2D_ARRAY;
            ...
            case dawn::TextureDimension::e2D:
                if (arrayLayers > 1) {
                    if (IsMultisampledTexture()) {
                        // glTexStorage3DMultisample() is supported on OpenGL version >= 4.3
                        // TODO(jiawei.shao@intel.com): support multisampled 2D array texture on
                        // OpenGL version <= 4.2
                        glTexStorage3DMultisample(mTarget, sampleCount, formatInfo.internalFormat,
                                                  width, height, arrayLayers, true);
                    } else {
