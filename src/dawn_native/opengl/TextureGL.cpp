        ...
        TextureFormatInfo GetGLFormatInfo(dawn::TextureFormat format) {
            switch (format) {
                ...
                case dawn::TextureFormat::RGB10A2Unorm:
                    return {GL_RGB10A2, GL_RGBA, GL_INSIGNED_INT_2_10_10_10_REV};
                case dawn::TextureFormat::RG11B10Float:
                    return {GL_R11F_G11F_B10F, GL_RGB, GL_INSIGNED_INT_10F_11F_11F_REV};

                case dawn::TextureFormat::RG32Uint:
                    return {GL_RG32UI, GL_RG_INTEGER, GL_UNSIGNED_INT};
                case dawn::TextureFormat::RG32Sint:
                    return {GL_RG32I, GL_RG_INTEGER, GL_SIGNED_INT};
                ...
                case dawn::TextureFormat::RGBA16Sint:
                    return {GL_RGBA16I, GL_RGBA_INTEGER, GL_SIGNED_SHORT};
                ...
                case dawn::TextureFormat::RGBA32Sint:
                    return {GL_RGBA32I, GL_RGBA_INTEGER, GL_SIGNED_INT};
                ...
                // Not supported, only RGB565 is.
                case dawn::TextureFormat::B5G6R5Unorm:

                // Only 4 channel SRGB exists in OpenGL.
