...
namespace dawn_native {
    ...
    using PipelineStatisticsArray =
        std::array<wgpu::PipelineStatisticsName, kMaxPipelineStatisticsCount>;
    ...
    class QuerySetBase : public ObjectBase {
      public:
        ...
        PipelineStatisticsArray GetPipelineStatistics() const;
      ...
      private:
        ...
        PipelineStatisticsArray mPipelineStatistics;
