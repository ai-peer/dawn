...
namespace dawn::native {
    ...
    namespace {
        ...
        static const char sConvertTimestampsToNanoseconds[] = R"(
            ...
            fn main([[builtin(global_invocation_id)]] GlobalInvocationID : vec3<u32>) {
                ...
                chunks[1] = (timestamp.low >> 16u) & 0xFFFFu;
                chunks[2] = timestamp.high & 0xFFFFu;
                chunks[3] = (timestamp.high >> 16u) & 0xFFFFu;
                chunks[4] = 0u;
    ...
    TimestampParams::TimestampParams(uint32_t first, uint32_t count, uint32_t offset, float period)
        ...
        // The conversion shader uses chunks of 16bit to compute the multiplication with the period
        // with better precesion. It takes both a multiplier and a right shift. Try to maximize the
        // value of the right shift while keeping the multiplier under 2^16.
