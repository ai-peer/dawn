...
namespace dawn_native {
    ...
    namespace {
        ...
        MaybeError ValidateBufferBinding(const BindGroupBinding& binding, dawn::BufferUsageBit requiredUsage) {
            if (binding.bufferView == nullptr || binding.sampler != nullptr || binding.textureView != nullptr) {
        ...
        MaybeError ValidateTextureBinding(const BindGroupBinding& binding, dawn::TextureUsageBit requiredUsage) {
            if (binding.textureView == nullptr || binding.sampler != nullptr || binding.bufferView != nullptr) {
        ...
        MaybeError ValidateSamplerBinding(const BindGroupBinding& binding) {
            if (binding.sampler == nullptr || binding.textureView != nullptr || binding.bufferView != nullptr) {
