...
namespace dawn_native {
    ...
    void RenderPassDescriptorBuilder::SetColorAttachments(
        uint32_t count,
        const dawn_native::RenderPassColorAttachmentDescriptor* attachments) {
        ...
        for (uint32_t i = 0; i < count; ++i) {
            dawn_native::TextureViewBase* textureView = attachments[i].attachment;
    ...
    void RenderPassDescriptorBuilder::SetDepthStencilAttachment(
        const dawn_native::RenderPassDepthStencilAttachmentDescriptor* attachment) {
        dawn_native::TextureViewBase* textureView = attachment->attachment;
        if (textureView == nullptr) {
