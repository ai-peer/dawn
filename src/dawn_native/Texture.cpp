...
namespace dawn_native {
    ...
    uint32_t TextureFormatPixelSize(dawn::TextureFormat format) {
        switch (format) {
            ...
            // TODO(jiawei.shao@intel.com): it is not correct to list BC formats here. Handle BC
            // formats separately when we implement the full validations on texture copies with
            // BC formats.
            case dawn::TextureFormat::BC1RGBAUnorm:
                return 2;
            case dawn::TextureFormat::BC5RGSnorm:
