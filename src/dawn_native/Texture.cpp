...
namespace dawn_native {
            ...
            switch (descriptor->sampleCount) {
                ...
                case 4:
                    if (descriptor->mipLevelCount > 1) {
                        return DAWN_VALIDATION_ERROR("The mipmap level count of a multisampled "
                                                     "cannot be greater than 1");
                    }
                    break;
                default:
                    return DAWN_VALIDATION_ERROR("The sample count of the texture is not "
                                                 "supported.");
            }
    ...
    bool TextureBase::IsMultisampleTexture() const {
