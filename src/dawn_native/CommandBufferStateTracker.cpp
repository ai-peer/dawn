...
namespace dawn_native {
    ...
    RenderPipelineBase* CommandBufferStateTracker::GetRenderPipeline() const {
        ASSERT(mLastPipeline == nullptr || mLastPipeline->GetType() == ObjectType::RenderPipeline);
    ...
    ComputePipelineBase* CommandBufferStateTracker::GetComputePipeline() const {
        ASSERT(mLastPipeline == nullptr || mLastPipeline->GetType() == ObjectType::ComputePipeline);
