...
namespace dawn_native {
    ...
    enum class AllocatorResourceUsage {
        ...
        // "dynamic". Used for mapped buffer uploads (ie. Map[Read|Write]).
        Upload,
    ...
    class BuddyBlockAllocator {
      ...
      private:
        ...
        static const uint32_t MAX_LEVELS = 32;  // 4GB
    ...
    // minBlockSize: Smallest block size allowed across resources.
