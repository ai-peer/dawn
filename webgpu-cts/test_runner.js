...
// MAINTENANCE_TODO(gman): remove use_worker and use worker=1 instead
async function runCtsTest(queryString, use_worker) {
  ...
  const { queries, options: { compatibility, powerPreference }} = parseSearchParamLikeWithCTSOptions(queryString);
