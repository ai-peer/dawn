...
tint_symbol_4 truncate_shader_output(tint_symbol io) {
  const tint_symbol_4 tint_symbol_5 = {io.pos};
...
Interface vert_main_inner() {
  const Interface tint_symbol_6 = (Interface)0;
...
tint_symbol_3 frag_main(tint_symbol_2 tint_symbol_1) {
  const Interface tint_symbol_7 = {tint_symbol_1.i, tint_symbol_1.u, tint_symbol_1.vi, tint_symbol_1.vu, tint_symbol_1.pos};
  const int inner_result_1 = frag_main_inner(tint_symbol_7);
