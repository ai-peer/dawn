...
atomic_compare_exchange_weak_ret_type atomicCompareExchangeWeak_1(RWByteAddressBuffer buffer, uint offset, uint compare, uint value) {
...
void atomicCompareExchangeWeak_63d8e6() {
  atomic_compare_exchange_weak_ret_type res = atomicCompareExchangeWeak_1(sb_rw, 0u, 1u, 1u);
}
