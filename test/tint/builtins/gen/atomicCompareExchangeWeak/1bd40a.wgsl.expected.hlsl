...
atomic_compare_exchange_weak_ret_type atomicCompareExchangeWeak_1(RWByteAddressBuffer buffer, uint offset, int compare, int value) {
...
void atomicCompareExchangeWeak_1bd40a() {
  atomic_compare_exchange_weak_ret_type res = atomicCompareExchangeWeak_1(sb_rw, 0u, 1, 1);
}
