...
void transpose_faeb05() {
  matrix<float16_t, 4, 2> res = matrix<float16_t, 4, 2>(vector<float16_t, 2>(float16_t(1.0h), float16_t(1.0h)), vector<float16_t, 2>(float16_t(1.0h), float16_t(1.0h)), vector<float16_t, 2>(float16_t(1.0h), float16_t(1.0h)), vector<float16_t, 2>(float16_t(1.0h), float16_t(1.0h)));
