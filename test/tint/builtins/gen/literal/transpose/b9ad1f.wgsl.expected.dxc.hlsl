...
void transpose_b9ad1f() {
  matrix<float16_t, 2, 3> res = matrix<float16_t, 2, 3>(vector<float16_t, 3>(float16_t(1.0h), float16_t(1.0h), float16_t(1.0h)), vector<float16_t, 3>(float16_t(1.0h), float16_t(1.0h), float16_t(1.0h)));
