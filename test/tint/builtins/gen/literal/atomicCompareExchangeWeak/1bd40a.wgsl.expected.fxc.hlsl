...
atomic_compare_exchange_weak_ret_type tint_atomicCompareExchangeWeak(uint offset, int compare, int value) {
...
void atomicCompareExchangeWeak_1bd40a() {
  atomic_compare_exchange_weak_ret_type res = tint_atomicCompareExchangeWeak(0u, 1, 1);
}
