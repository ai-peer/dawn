...
float3x4 tint_symbol_3(uint offset) {
...
GammaTransferParams tint_symbol_5(uint offset) {
  ...
  const GammaTransferParams tint_symbol_11 = {asfloat(ext_tex_params[scalar_offset_3 / 4][scalar_offset_3 % 4]), asfloat(ext_tex_params[scalar_offset_4 / 4][scalar_offset_4 % 4]), asfloat(ext_tex_params[scalar_offset_5 / 4][scalar_offset_5 % 4]), asfloat(ext_tex_params[scalar_offset_6 / 4][scalar_offset_6 % 4]), asfloat(ext_tex_params[scalar_offset_7 / 4][scalar_offset_7 % 4]), asfloat(ext_tex_params[scalar_offset_8 / 4][scalar_offset_8 % 4]), asfloat(ext_tex_params[scalar_offset_9 / 4][scalar_offset_9 % 4]), ext_tex_params[scalar_offset_10 / 4][scalar_offset_10 % 4]};
  return tint_symbol_11;
}

float3x3 tint_symbol_7(uint offset) {
...
float3x2 tint_symbol_9(uint offset) {
...
ExternalTextureParams tint_symbol_1(uint offset) {
  const uint scalar_offset_17 = ((offset + 0u)) / 4;
  const uint scalar_offset_18 = ((offset + 4u)) / 4;
  const ExternalTextureParams tint_symbol_12 = {ext_tex_params[scalar_offset_17 / 4][scalar_offset_17 % 4], ext_tex_params[scalar_offset_18 / 4][scalar_offset_18 % 4], tint_symbol_3((offset + 16u)), tint_symbol_5((offset + 64u)), tint_symbol_5((offset + 96u)), tint_symbol_7((offset + 128u)), tint_symbol_9((offset + 176u))};
  return tint_symbol_12;
}

void textureSampleBaseClampToEdge_7c04e6() {
  float4 res = textureSampleExternal(arg_0, ext_tex_plane_1, arg_1, (1.0f).xx, tint_symbol_1(0u));
}
