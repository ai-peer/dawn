...
ExternalTextureParams ext_tex_params_load(uint offset) {
  ...
  ExternalTextureParams tint_symbol_2 = {ext_tex_params[scalar_offset_17 / 4][scalar_offset_17 % 4], ext_tex_params[scalar_offset_18 / 4][scalar_offset_18 % 4], ext_tex_params_load_2((offset + 16u)), ext_tex_params_load_4((offset + 64u)), ext_tex_params_load_4((offset + 96u)), ext_tex_params_load_6((offset + 128u)), ext_tex_params_load_8((offset + 176u)), ((scalar_offset_19 & 2) ? ubo_load_3.zw : ubo_load_3.xy), ((scalar_offset_20 & 2) ? ubo_load_4.zw : ubo_load_4.xy), ((scalar_offset_21 & 2) ? ubo_load_5.zw : ubo_load_5.xy), ((scalar_offset_22 & 2) ? ubo_load_6.zw : ubo_load_6.xy)};
