...
ExternalTextureParams tint_symbol_2(uint4 buffer[12], uint offset) {
  ...
  const ExternalTextureParams tint_symbol_11 = {buffer[scalar_offset_13 / 4][scalar_offset_13 % 4], tint_symbol_4(buffer, (offset + 16u)), tint_symbol_6(buffer, (offset + 64u)), tint_symbol_6(buffer, (offset + 96u)), tint_symbol_8(buffer, (offset + 128u))};
