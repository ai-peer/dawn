...
ExternalTextureParams tint_symbol_2(uint4 buffer[11], uint offset) {
  ...
  const ExternalTextureParams tint_symbol_11 = {buffer[scalar_offset_index_14 / 4][scalar_offset_index_14 % 4], buffer[scalar_offset_index_15 / 4][scalar_offset_index_15 % 4], tint_symbol_4(buffer, (offset + 16u)), tint_symbol_6(buffer, (offset + 64u)), tint_symbol_6(buffer, (offset + 96u)), tint_symbol_8(buffer, (offset + 128u))};
