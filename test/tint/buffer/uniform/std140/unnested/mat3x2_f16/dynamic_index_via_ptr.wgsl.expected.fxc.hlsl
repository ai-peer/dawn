...
void f() {
  ...
  const uint scalar_offset_bytes_3 = ((4u * uint(p_m_i_save)));
  const uint scalar_offset_index_3 = scalar_offset_bytes_3 / 4;
  uint ubo_load_3 = m[scalar_offset_index_3 / 4][scalar_offset_index_3 % 4];
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001AFB730AF60(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
