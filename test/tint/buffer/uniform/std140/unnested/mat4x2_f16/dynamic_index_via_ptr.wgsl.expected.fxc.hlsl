...
void f() {
  ...
  const uint scalar_offset_bytes_4 = ((4u * uint(p_m_i_save)));
  const uint scalar_offset_index_4 = scalar_offset_bytes_4 / 4;
  uint ubo_load_4 = m[scalar_offset_index_4 / 4][scalar_offset_index_4 % 4];
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001C2CDECA800(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
