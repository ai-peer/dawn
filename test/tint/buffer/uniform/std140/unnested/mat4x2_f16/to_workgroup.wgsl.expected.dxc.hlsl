...
void f_inner(uint local_invocation_index) {
  {
    w = matrix<float16_t, 4, 2>(vector<float16_t, 2>(float16_t(0.0h), float16_t(0.0h)), vector<float16_t, 2>(float16_t(0.0h), float16_t(0.0h)), vector<float16_t, 2>(float16_t(0.0h), float16_t(0.0h)), vector<float16_t, 2>(float16_t(0.0h), float16_t(0.0h)));
  }
