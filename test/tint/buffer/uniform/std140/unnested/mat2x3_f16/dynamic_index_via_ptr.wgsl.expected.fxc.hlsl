...
void f() {
  ...
  const uint scalar_offset_bytes_2 = ((8u * uint(p_m_i_save)));
  const uint scalar_offset_index_2 = scalar_offset_bytes_2 / 4;
  uint4 ubo_load_5 = m[scalar_offset_index_2 / 4];
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001D19F6A4570(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
