...
void f() {
  ...
  const uint scalar_offset_bytes_3 = ((8u * uint(p_m_i_save)));
  const uint scalar_offset_index_3 = scalar_offset_bytes_3 / 4;
  uint4 ubo_load_7 = m[scalar_offset_index_3 / 4];
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001C182D2EBF0(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
