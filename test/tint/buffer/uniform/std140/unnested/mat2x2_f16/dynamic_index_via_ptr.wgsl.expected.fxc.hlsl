...
void f() {
  ...
  const uint scalar_offset_bytes_2 = ((4u * uint(p_m_i_save)));
  const uint scalar_offset_index_2 = scalar_offset_bytes_2 / 4;
  uint ubo_load_2 = m[scalar_offset_index_2 / 4][scalar_offset_index_2 % 4];
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x0000023F6C8F4980(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
