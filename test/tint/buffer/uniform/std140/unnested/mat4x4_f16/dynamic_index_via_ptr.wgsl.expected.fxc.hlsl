...
void f() {
  ...
  const uint scalar_offset_bytes_4 = ((8u * uint(p_m_i_save)));
  const uint scalar_offset_index_4 = scalar_offset_bytes_4 / 4;
  uint4 ubo_load_9 = m[scalar_offset_index_4 / 4];
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000002254D91C7F0(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
