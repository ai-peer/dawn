...
S tint_symbol_1(uint offset) {
  ...
  const S tint_symbol_5 = {asint(u[scalar_offset_3 / 4][scalar_offset_3 % 4]), tint_symbol_3((offset + 16u)), asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4])};
