...
float3x2 tint_symbol_5(uint offset) {
...
S tint_symbol_3(uint offset) {
  ...
  const S tint_symbol_8 = {asint(u[scalar_offset_3 / 4][scalar_offset_3 % 4]), tint_symbol_5((offset + 8u)), asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4])};
