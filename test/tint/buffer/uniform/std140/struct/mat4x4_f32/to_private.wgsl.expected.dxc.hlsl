...
float4x4 tint_symbol_3(uint offset) {
...
S tint_symbol_1(uint offset) {
  ...
  const S tint_symbol_5 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_3((offset + 16u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
...
tint_symbol_ret tint_symbol(uint offset) {
  S arr[4] = (S[4])0;
  {
    for(uint i = 0u; (i < 4u); i = (i + 1u)) {
      arr[i] = tint_symbol_1((offset + (i * 192u)));
    }
  }
  return arr;
}
...
void f() {
  p = tint_symbol(0u);
  p[1] = tint_symbol_1(384u);
  p[3].m = tint_symbol_3(400u);
