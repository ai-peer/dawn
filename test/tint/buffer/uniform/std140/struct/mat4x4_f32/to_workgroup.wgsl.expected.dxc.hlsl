...
float4x4 tint_symbol_5(uint offset) {
...
S tint_symbol_3(uint offset) {
  ...
  const S tint_symbol_8 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_5((offset + 16u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
...
tint_symbol_2_ret tint_symbol_2(uint offset) {
  S arr[4] = (S[4])0;
  {
    for(uint i_1 = 0u; (i_1 < 4u); i_1 = (i_1 + 1u)) {
      arr[i_1] = tint_symbol_3((offset + (i_1 * 192u)));
    }
  }
  return arr;
}
...
void f_inner(uint local_invocation_index) {
  ...
  w = tint_symbol_2(0u);
  w[1] = tint_symbol_3(384u);
  w[3].m = tint_symbol_5(400u);
