...
S tint_symbol_3(uint4 buffer[48], uint offset) {
  ...
  const S tint_symbol_8 = {asint(buffer[scalar_offset_index_4 / 4][scalar_offset_index_4 % 4]), tint_symbol_5(buffer, (offset + 16u)), asint(buffer[scalar_offset_index_5 / 4][scalar_offset_index_5 % 4])};
