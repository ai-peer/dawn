...
void f() {
  ...
  const uint scalar_offset_bytes_3 = ((((256u * uint(p_a_i_save)) + (64u * uint(p_a_i_a_i_save))) + (8u * uint(p_a_i_a_i_m_i_save))));
  const uint scalar_offset_index_3 = scalar_offset_bytes_3 / 4;
  uint4 ubo_load_7 = a[scalar_offset_index_3 / 4];
  ...
  const uint scalar_offset_bytes_4 = (((((256u * uint(tint_symbol)) + (64u * uint(tint_symbol_1))) + (8u * uint(tint_symbol_2))) + (2u * uint(tint_symbol_3))));
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001B8E675B5B0(2,10-18): error X3000: syntax error: unexpected token 'float16_t'
