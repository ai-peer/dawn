...
void f() {
  ...
  mat2 p_a_i_a_i_m = load_a_inner_p0_a_p1_m(uint(uint(tint_symbol)), uint(uint(tint_symbol_1)));
  int tint_symbol_2 = i();
  ...
  mat2 l_a_i_a_i_m = load_a_inner_p0_a_p1_m(uint(uint(tint_symbol)), uint(uint(tint_symbol_1)));
