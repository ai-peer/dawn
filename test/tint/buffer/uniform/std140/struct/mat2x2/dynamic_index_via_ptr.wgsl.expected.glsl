...
void f() {
  ...
  mat2 p_a_i_a_i_m = load_a_inner_p0_a_p1_m(uint(ptr_index_save), uint(ptr_index_save_1));
  ...
  mat2 l_a_i_a_i_m = load_a_inner_p0_a_p1_m(uint(ptr_index_save), uint(ptr_index_save_1));
