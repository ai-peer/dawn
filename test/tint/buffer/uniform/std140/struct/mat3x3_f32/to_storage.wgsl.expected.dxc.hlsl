...
S tint_symbol_6(uint4 buffer[32], uint offset) {
  ...
  const S tint_symbol_10 = {asint(buffer[scalar_offset_index_3 / 4][scalar_offset_index_3 % 4]), tint_symbol_8(buffer, (offset + 16u)), asint(buffer[scalar_offset_index_4 / 4][scalar_offset_index_4 % 4])};
