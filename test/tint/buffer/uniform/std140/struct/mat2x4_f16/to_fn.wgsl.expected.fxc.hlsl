...
S tint_symbol_1(uint4 buffer[32], uint offset) {
  ...
  const S tint_symbol_5 = {asint(buffer[scalar_offset_index_2 / 4][scalar_offset_index_2 % 4]), tint_symbol_3(buffer, (offset + 8u)), asint(buffer[scalar_offset_index_3 / 4][scalar_offset_index_3 % 4])};
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000002425BA00AD0(3,10-18): error X3000: syntax error: unexpected token 'float16_t'
