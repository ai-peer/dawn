...
S tint_symbol_6(uint4 buffer[32], uint offset) {
  ...
  const uint scalar_offset_bytes_3 = ((offset + 64u));
  const uint scalar_offset_index_3 = scalar_offset_bytes_3 / 4;
  const S tint_symbol_10 = {asint(buffer[scalar_offset_index_2 / 4][scalar_offset_index_2 % 4]), tint_symbol_8(buffer, (offset + 4u)), asint(buffer[scalar_offset_index_3 / 4][scalar_offset_index_3 % 4])};
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001EF6977FF90(3,10-18): error X3000: syntax error: unexpected token 'float16_t'
