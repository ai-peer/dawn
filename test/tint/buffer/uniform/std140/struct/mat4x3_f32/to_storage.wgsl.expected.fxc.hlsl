...
void tint_symbol_3(uint offset, float4x3 value) {
...
void tint_symbol(uint offset, S value[4]) {
  S array_1[4] = value;
  {
    for(uint i = 0u; (i < 4u); i = (i + 1u)) {
      tint_symbol_1((offset + (i * 192u)), array_1[i]);
    }
  }
}

float4x3 tint_symbol_8(uint offset) {
...
S tint_symbol_6(uint offset) {
  ...
  const S tint_symbol_10 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_8((offset + 16u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
...
tint_symbol_5_ret tint_symbol_5(uint offset) {
  S arr[4] = (S[4])0;
  {
    for(uint i_1 = 0u; (i_1 < 4u); i_1 = (i_1 + 1u)) {
      arr[i_1] = tint_symbol_6((offset + (i_1 * 192u)));
    }
  }
  return arr;
}
...
void f() {
  ...
  tint_symbol_1(192u, tint_symbol_6(384u));
  tint_symbol_3(592u, tint_symbol_8(400u));
