...
float2x3 tint_symbol_5(uint offset) {
...
S tint_symbol_3(uint offset) {
  ...
  const S tint_symbol_8 = {asint(u[scalar_offset_2 / 4][scalar_offset_2 % 4]), tint_symbol_5((offset + 16u)), asint(u[scalar_offset_3 / 4][scalar_offset_3 % 4])};
