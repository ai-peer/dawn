...
void f() {
  ...
  const Outer l_a_i = tint_symbol_5(a, (256u * uint(ptr_index_save)));
  const Inner l_a_i_a[4] = tint_symbol_6(a, (256u * uint(ptr_index_save)));
  const Inner l_a_i_a_i = tint_symbol_7(a, ((256u * uint(ptr_index_save)) + (64u * uint(ptr_index_save_1))));
  const float3x2 l_a_i_a_i_m = tint_symbol_8(a, ((256u * uint(ptr_index_save)) + (64u * uint(ptr_index_save_1))));
  const uint scalar_offset_3 = ((((256u * uint(ptr_index_save)) + (64u * uint(ptr_index_save_1))) + (8u * uint(ptr_index_save_2)))) / 4;
