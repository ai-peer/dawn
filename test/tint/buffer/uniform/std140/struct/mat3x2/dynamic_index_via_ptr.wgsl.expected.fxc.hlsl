...
void f() {
  ...
  uint4 ubo_load_3 = a[scalar_offset_index_3 / 4];
  const float2 l_a_i_a_i_m_i = asfloat(((scalar_offset_index_3 & 2) ? ubo_load_3.zw : ubo_load_3.xy));
  ...
  const uint scalar_offset_bytes_4 = (((((256u * uint(tint_symbol)) + (64u * uint(tint_symbol_1))) + (8u * uint(tint_symbol_2))) + (4u * uint(tint_symbol_3))));
