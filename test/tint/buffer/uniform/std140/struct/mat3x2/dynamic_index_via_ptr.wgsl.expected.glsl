...
void f() {
  ...
  mat3x2 p_a_i_a_i_m = load_a_inner_p0_a_p1_m(uint(uint(tint_symbol)), uint(uint(tint_symbol_1)));
  int tint_symbol_2 = i();
  ...
  mat3x2 l_a_i_a_i_m = load_a_inner_p0_a_p1_m(uint(uint(tint_symbol)), uint(uint(tint_symbol_1)));
  vec2 l_a_i_a_i_m_i = load_a_inner_p0_a_p1_m_p2(uint(uint(tint_symbol)), uint(uint(tint_symbol_1)), uint(uint(tint_symbol_2)));
  int tint_symbol_3 = i();
  float l_a_i_a_i_m_i_i = load_a_inner_p0_a_p1_m_p2_p3(uint(uint(tint_symbol)), uint(uint(tint_symbol_1)), uint(uint(tint_symbol_2)), uint(uint(tint_symbol_3)));
}
