...
void tint_symbol_3(uint offset, matrix<float16_t, 4, 2> value) {
...
matrix<float16_t, 4, 2> tint_symbol_8(uint offset) {
...
S tint_symbol_6(uint offset) {
  ...
  const S tint_symbol_10 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_8((offset + 4u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
