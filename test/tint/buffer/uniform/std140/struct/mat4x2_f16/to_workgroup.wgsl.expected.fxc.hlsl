...
S tint_symbol_3(uint4 buffer[32], uint offset) {
  ...
  const S tint_symbol_8 = {asint(buffer[scalar_offset_index_4 / 4][scalar_offset_index_4 % 4]), tint_symbol_5(buffer, (offset + 4u)), asint(buffer[scalar_offset_index_5 / 4][scalar_offset_index_5 % 4])};
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x0000026ECF720100(3,10-18): error X3000: syntax error: unexpected token 'float16_t'
