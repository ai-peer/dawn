...
void f() {
  ...
  const uint scalar_offset_bytes_4 = ((((256u * uint(p_a_i_save)) + (64u * uint(p_a_i_a_i_save))) + (4u * uint(p_a_i_a_i_m_i_save))));
  ...
  const uint scalar_offset_bytes_5 = (((((256u * uint(tint_symbol)) + (64u * uint(tint_symbol_1))) + (4u * uint(tint_symbol_2))) + (2u * uint(tint_symbol_3))));
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001ACF148DDB0(2,10-18): error X3000: syntax error: unexpected token 'float16_t'
