...
matrix<float16_t, 4, 2> tint_symbol_3(uint offset) {
...
S tint_symbol_1(uint offset) {
  ...
  const S tint_symbol_5 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_3((offset + 4u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
