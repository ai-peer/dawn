...
void tint_symbol_3(uint offset, matrix<float16_t, 4, 3> value) {
...
void tint_symbol_1(uint offset, S value) {
  ...
  tint_symbol_3((offset + 8u), value.m);
...
matrix<float16_t, 4, 3> tint_symbol_8(uint offset) {
...
S tint_symbol_6(uint offset) {
  ...
  const S tint_symbol_10 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_8((offset + 8u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
...
void f() {
  ...
  tint_symbol_3(392u, tint_symbol_8(264u));
