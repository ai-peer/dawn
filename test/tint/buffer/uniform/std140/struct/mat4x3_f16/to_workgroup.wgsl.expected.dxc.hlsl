...
matrix<float16_t, 4, 3> tint_symbol_5(uint offset) {
...
S tint_symbol_3(uint offset) {
  ...
  const S tint_symbol_8 = {asint(u[scalar_offset_4 / 4][scalar_offset_4 % 4]), tint_symbol_5((offset + 8u)), asint(u[scalar_offset_5 / 4][scalar_offset_5 % 4])};
