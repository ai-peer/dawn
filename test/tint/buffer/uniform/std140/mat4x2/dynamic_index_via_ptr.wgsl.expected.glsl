...
mat4x2 load_a_p0_a_p1_m_1(uint p0, uint p1) {
  uint s_save_2 = p0;
  uint s_save_3 = p1;
  return mat4x2(a.inner[s_save_2].a[s_save_3].m_0, a.inner[s_save_2].a[s_save_3].m_1, a.inner[s_save_2].a[s_save_3].m_2, a.inner[s_save_2].a[s_save_3].m_3);
}

vec2 load_a_p0_a_p1_m_p2_1(uint p0, uint p1, uint p2) {
  switch(p2) {
    case 0u: {
      return a.inner[p0].a[p1].m_0;
      break;
...
void f() {
  ...
  mat4x2 l_a_i_a_i_m = load_a_p0_a_p1_m_1(uint(tint_symbol), uint(tint_symbol_1));
  vec2 l_a_i_a_i_m_i = load_a_p0_a_p1_m_p2_1(uint(tint_symbol), uint(tint_symbol_1), uint(tint_symbol_2));
  int tint_symbol_3 = i();
