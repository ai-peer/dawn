...
tint_symbol_3_ret tint_symbol_3(uint offset) {
  float3x3 arr[4] = (float3x3[4])0;
  {
    for(uint i_1 = 0u; (i_1 < 4u); i_1 = (i_1 + 1u)) {
      arr[i_1] = tint_symbol_4((offset + (i_1 * 48u)));
    }
  }
  return arr;
}
...
void f() {
  ...
  tint_symbol_1(48u, tint_symbol_4(96u));
