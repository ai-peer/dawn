...
void tint_symbol_1(uint offset, matrix<float16_t, 2, 4> value) {
  s.Store<vector<float16_t, 4> >((offset + 0u), value[0u]);
  s.Store<vector<float16_t, 4> >((offset + 8u), value[1u]);
}

void tint_symbol(uint offset, matrix<float16_t, 2, 4> value[4]) {
...
matrix<float16_t, 2, 4> tint_symbol_4(uint offset) {
