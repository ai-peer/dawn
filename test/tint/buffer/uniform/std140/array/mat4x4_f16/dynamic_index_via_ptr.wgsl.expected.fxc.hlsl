...
void f() {
  ...
  const uint scalar_offset_bytes_4 = (((32u * uint(p_a_i_save)) + (8u * uint(p_a_i_i_save))));
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000001A7ACC9D720(11,8-16): error X3000: syntax error: unexpected token 'float16_t'
