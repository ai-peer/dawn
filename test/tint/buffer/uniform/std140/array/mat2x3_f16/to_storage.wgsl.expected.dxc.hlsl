...
void tint_symbol_1(uint offset, matrix<float16_t, 2, 3> value) {
  s.Store<vector<float16_t, 3> >((offset + 0u), value[0u]);
  s.Store<vector<float16_t, 3> >((offset + 8u), value[1u]);
}

void tint_symbol(uint offset, matrix<float16_t, 2, 3> value[4]) {
  matrix<float16_t, 2, 3> array_1[4] = value;
  {
    for(uint i = 0u; (i < 4u); i = (i + 1u)) {
      tint_symbol_1((offset + (i * 16u)), array_1[i]);
    }
  }
}
...
tint_symbol_3_ret tint_symbol_3(uint offset) {
  matrix<float16_t, 2, 3> arr[4] = (matrix<float16_t, 2, 3>[4])0;
  {
    for(uint i_1 = 0u; (i_1 < 4u); i_1 = (i_1 + 1u)) {
      arr[i_1] = tint_symbol_4((offset + (i_1 * 16u)));
    }
  }
  return arr;
}
...
void f() {
  ...
  tint_symbol_1(16u, tint_symbol_4(32u));
