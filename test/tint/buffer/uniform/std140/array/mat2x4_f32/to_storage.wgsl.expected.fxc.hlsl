...
void tint_symbol_1(uint offset, float2x4 value) {
  s.Store4((offset + 0u), asuint(value[0u]));
  s.Store4((offset + 16u), asuint(value[1u]));
}

void tint_symbol(uint offset, float2x4 value[4]) {
  float2x4 array_1[4] = value;
  {
    for(uint i = 0u; (i < 4u); i = (i + 1u)) {
      tint_symbol_1((offset + (i * 32u)), array_1[i]);
    }
  }
}
...
tint_symbol_3_ret tint_symbol_3(uint offset) {
  float2x4 arr[4] = (float2x4[4])0;
  {
    for(uint i_1 = 0u; (i_1 < 4u); i_1 = (i_1 + 1u)) {
      arr[i_1] = tint_symbol_4((offset + (i_1 * 32u)));
    }
  }
  return arr;
}
...
void f() {
  ...
  tint_symbol_1(32u, tint_symbol_4(64u));
