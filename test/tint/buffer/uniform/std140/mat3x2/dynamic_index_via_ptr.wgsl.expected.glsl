...
mat3x2 load_a_p0_a_p1_m_1(uint p0, uint p1) {
  uint s_save_2 = p0;
  uint s_save_3 = p1;
  return mat3x2(a.inner[s_save_2].a[s_save_3].m_0, a.inner[s_save_2].a[s_save_3].m_1, a.inner[s_save_2].a[s_save_3].m_2);
}
...
void f() {
  ...
  mat3x2 l_a_i_a_i_m = load_a_p0_a_p1_m_1(uint(tint_symbol), uint(tint_symbol_1));
