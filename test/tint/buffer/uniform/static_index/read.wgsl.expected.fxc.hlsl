...
Inner tint_symbol_22(uint offset) {
  ...
  const Inner tint_symbol_24 = {asint(ub[scalar_offset_28 / 4][scalar_offset_28 % 4]), asfloat(ub[scalar_offset_29 / 4][scalar_offset_29 % 4])};
...
tint_symbol_23_ret tint_symbol_23(uint offset) {
  Inner arr_1[4] = (Inner[4])0;
  {
    for(uint i_1 = 0u; (i_1 < 4u); i_1 = (i_1 + 1u)) {
      arr_1[i_1] = tint_symbol_22((offset + (i_1 * 32u)));
    }
  }
  return arr_1;
}
...
void main() {
  ...
  const Inner array_struct_inner[4] = tint_symbol_23(576u);
  return;
}
