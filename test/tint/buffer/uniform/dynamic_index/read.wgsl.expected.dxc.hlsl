...
float2x2 tint_symbol_14(uint offset) {
...
float2x3 tint_symbol_15(uint offset) {
...
float2x4 tint_symbol_16(uint offset) {
...
float3x2 tint_symbol_17(uint offset) {
...
float3x3 tint_symbol_18(uint offset) {
...
float3x4 tint_symbol_19(uint offset) {
...
float4x2 tint_symbol_20(uint offset) {
...
float4x3 tint_symbol_21(uint offset) {
...
float4x4 tint_symbol_22(uint offset) {
...
void main_inner(uint idx) {
  ...
  const float2x2 mat2x2_f32 = tint_symbol_14(((544u * idx) + 144u));
  const float2x3 mat2x3_f32 = tint_symbol_15(((544u * idx) + 160u));
  const float2x4 mat2x4_f32 = tint_symbol_16(((544u * idx) + 192u));
  const float3x2 mat3x2_f32 = tint_symbol_17(((544u * idx) + 224u));
  const float3x3 mat3x3_f32 = tint_symbol_18(((544u * idx) + 256u));
  const float3x4 mat3x4_f32 = tint_symbol_19(((544u * idx) + 304u));
  const float4x2 mat4x2_f32 = tint_symbol_20(((544u * idx) + 352u));
  const float4x3 mat4x3_f32 = tint_symbol_21(((544u * idx) + 384u));
  const float4x4 mat4x4_f32 = tint_symbol_22(((544u * idx) + 448u));
  const float3 arr2_vec3_f32[2] = tint_symbol_23(((544u * idx) + 512u));
}
