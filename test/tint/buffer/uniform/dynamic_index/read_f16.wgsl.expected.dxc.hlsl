...
float2x2 tint_symbol_18(uint offset) {
...
float2x3 tint_symbol_19(uint offset) {
...
float2x4 tint_symbol_20(uint offset) {
...
float3x2 tint_symbol_21(uint offset) {
...
float3x3 tint_symbol_22(uint offset) {
...
float3x4 tint_symbol_23(uint offset) {
...
float4x2 tint_symbol_24(uint offset) {
...
float4x3 tint_symbol_25(uint offset) {
...
float4x4 tint_symbol_26(uint offset) {
...
matrix<float16_t, 2, 2> tint_symbol_27(uint offset) {
...
matrix<float16_t, 2, 3> tint_symbol_28(uint offset) {
...
matrix<float16_t, 2, 4> tint_symbol_29(uint offset) {
...
matrix<float16_t, 3, 2> tint_symbol_30(uint offset) {
...
matrix<float16_t, 3, 3> tint_symbol_31(uint offset) {
...
matrix<float16_t, 3, 4> tint_symbol_32(uint offset) {
...
matrix<float16_t, 4, 2> tint_symbol_33(uint offset) {
...
matrix<float16_t, 4, 3> tint_symbol_34(uint offset) {
...
matrix<float16_t, 4, 4> tint_symbol_35(uint offset) {
...
tint_symbol_36_ret tint_symbol_36(uint offset) {
...
tint_symbol_37_ret tint_symbol_37(uint offset) {
  matrix<float16_t, 4, 2> arr_2[2] = (matrix<float16_t, 4, 2>[2])0;
  {
    for(uint i_1 = 0u; (i_1 < 2u); i_1 = (i_1 + 1u)) {
      arr_2[i_1] = tint_symbol_33((offset + (i_1 * 16u)));
    }
  }
  return arr_2;
}
...
void main_inner(uint idx) {
  ...
  const float2x2 mat2x2_f32 = tint_symbol_18(((800u * idx) + 168u));
  const float2x3 mat2x3_f32 = tint_symbol_19(((800u * idx) + 192u));
  const float2x4 mat2x4_f32 = tint_symbol_20(((800u * idx) + 224u));
  const float3x2 mat3x2_f32 = tint_symbol_21(((800u * idx) + 256u));
  const float3x3 mat3x3_f32 = tint_symbol_22(((800u * idx) + 288u));
  const float3x4 mat3x4_f32 = tint_symbol_23(((800u * idx) + 336u));
  const float4x2 mat4x2_f32 = tint_symbol_24(((800u * idx) + 384u));
  const float4x3 mat4x3_f32 = tint_symbol_25(((800u * idx) + 416u));
  const float4x4 mat4x4_f32 = tint_symbol_26(((800u * idx) + 480u));
  const matrix<float16_t, 2, 2> mat2x2_f16 = tint_symbol_27(((800u * idx) + 544u));
  const matrix<float16_t, 2, 3> mat2x3_f16 = tint_symbol_28(((800u * idx) + 552u));
  const matrix<float16_t, 2, 4> mat2x4_f16 = tint_symbol_29(((800u * idx) + 568u));
  const matrix<float16_t, 3, 2> mat3x2_f16 = tint_symbol_30(((800u * idx) + 584u));
  const matrix<float16_t, 3, 3> mat3x3_f16 = tint_symbol_31(((800u * idx) + 600u));
  const matrix<float16_t, 3, 4> mat3x4_f16 = tint_symbol_32(((800u * idx) + 624u));
  const matrix<float16_t, 4, 2> mat4x2_f16 = tint_symbol_33(((800u * idx) + 648u));
  const matrix<float16_t, 4, 3> mat4x3_f16 = tint_symbol_34(((800u * idx) + 664u));
  const matrix<float16_t, 4, 4> mat4x4_f16 = tint_symbol_35(((800u * idx) + 696u));
  const float3 arr2_vec3_f32[2] = tint_symbol_36(((800u * idx) + 736u));
  const matrix<float16_t, 4, 2> arr2_mat4x2_f16[2] = tint_symbol_37(((800u * idx) + 768u));
}
