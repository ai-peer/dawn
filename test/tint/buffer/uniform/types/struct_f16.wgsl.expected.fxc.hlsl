...
Inner tint_symbol_1(uint4 buffer[2], uint offset) {
  ...
  uint4 ubo_load_5 = buffer[scalar_offset_index_3 / 4];
  uint2 ubo_load_4 = ((scalar_offset_index_3 & 2) ? ubo_load_5.zw : ubo_load_5.xy);
  vector<float16_t, 2> ubo_load_4_xz = vector<float16_t, 2>(f16tof32(ubo_load_4 & 0xFFFF));
  float16_t ubo_load_4_y = f16tof32(ubo_load_4[0] >> 16);
  const Inner tint_symbol_6 = {float16_t(f16tof32(((buffer[scalar_offset_index_2 / 4][scalar_offset_index_2 % 4] >> (scalar_offset_bytes_2 % 4 == 0 ? 0 : 16)) & 0xFFFF))), vector<float16_t, 3>(ubo_load_4_xz[0], ubo_load_4_y, ubo_load_4_xz[1]), tint_symbol_4(buffer, (offset + 16u))};
...
D:\Projects\RampUp\dawn\test\tint\buffer\Shader@0x000002834F01DB40(2,3-11): error X3000: unrecognized identifier 'float16_t'
