...
Inner tint_symbol_1(uint4 buffer[4], uint offset) {
  ...
  const Inner tint_symbol_6 = {asfloat(buffer[scalar_offset_index_2 / 4][scalar_offset_index_2 % 4]), asfloat(buffer[scalar_offset_index_3 / 4].xyz), tint_symbol_4(buffer, (offset + 32u))};
