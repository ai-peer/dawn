...
void tint_symbol() {
  ...
  sb.mat4x3_f16 = f16mat4x3(f16vec3(0.0hf), f16vec3(0.0hf), f16vec3(0.0hf), f16vec3(0.0hf));
  ...
  sb.arr2_vec3_f32 = tint_symbol_1;
