...
float2x4 tint_symbol_6(uint offset) {
  return float2x4(asfloat(tint_symbol.Load4((offset + 0u))), asfloat(tint_symbol.Load4((offset + 16u))));
}

Inner tint_symbol_3(uint offset) {
  const Inner tint_symbol_14 = {asfloat(tint_symbol.Load((offset + 0u))), asfloat(tint_symbol.Load3((offset + 16u))), tint_symbol_6((offset + 32u))};
...
void tint_symbol_12(uint offset, float2x4 value) {
...
void tint_symbol_9(uint offset, Inner value) {
  ...
  tint_symbol_12((offset + 32u), value.mat2x4_f32);
}
