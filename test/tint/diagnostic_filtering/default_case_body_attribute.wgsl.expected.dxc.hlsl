SKIP: triggers crbug.com/tint/1820
...
shader.hlsl:9:7: error: redefinition of 'x' with a different type: 'int' vs 'float'
  int(x);
      ^
shader.hlsl:8:23: note: previous definition is here
void main_inner(float x) {
                      ^
