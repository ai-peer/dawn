...
layout(binding = 0, std140) uniform params_block_0_0_ubo {
  SimParams inner;
} params;

layout(binding = 1, std430) buffer particlesA_block_0_1_ssbo {
  Particles inner;
} particlesA;

layout(binding = 2, std430) buffer particlesA_block_0_1_ssbo_1 {
  Particles inner;
} particlesB;
