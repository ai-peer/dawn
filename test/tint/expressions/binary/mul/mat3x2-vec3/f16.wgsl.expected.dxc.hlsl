...
matrix<float16_t, 3, 2> tint_symbol_2(uint offset) {
...
void main() {
  ...
  const vector<float16_t, 2> x = mul(vector<float16_t, 3>(ubo_load_3_xz[0], ubo_load_3_y, ubo_load_3_xz[1]), tint_symbol_2(0u));
  return;
}
