...
vector<float16_t, 2> tint_bitcast(float src) {
  uint v = asuint(src);
...
D:\Projects\RampUp\dawn\test\tint\Shader@0x000001AB19015CC0(1,8-16): error X3000: syntax error: unexpected token 'float16_t'
