...
void tint_symbol_3(uint offset, int4 value[4]) {
...
tint_symbol_7_ret tint_symbol_7(uint offset) {
...
void tint_symbol_11(uint offset, int value[2]) {
  int array_4[2] = value;
  {
...
void tint_symbol_10(uint offset, int value[3][2]) {
  int array_3[3][2] = value;
  {
    for(uint i_4 = 0u; (i_4 < 3u); i_4 = (i_4 + 1u)) {
      tint_symbol_11((offset + (i_4 * 8u)), array_3[i_4]);
    }
  }
}

void tint_symbol_9(uint offset, int value[4][3][2]) {
  int array_2[4][3][2] = value;
  {
    for(uint i_5 = 0u; (i_5 < 4u); i_5 = (i_5 + 1u)) {
      tint_symbol_10((offset + (i_5 * 24u)), array_2[i_5]);
    }
  }
}
...
void foo(int4 src_param[4]) {
  ...
  tint_symbol_3(0u, tint_symbol_15);
  tint_symbol_3(0u, src_param);
  const int4 tint_symbol_1[4] = ret_arr();
  tint_symbol_3(0u, tint_symbol_1);
  const int4 src_let[4] = (int4[4])0;
  tint_symbol_3(0u, src_let);
  tint_symbol_3(0u, src_function);
  tint_symbol_3(0u, src_private);
  tint_symbol_3(0u, src_workgroup);
  const S tint_symbol_2 = ret_struct_arr();
  tint_symbol_3(0u, tint_symbol_2.arr);
  tint_symbol_3(0u, tint_symbol_5(0u));
  tint_symbol_3(0u, tint_symbol_7(0u));
  int src_nested[4][3][2] = (int[4][3][2])0;
  tint_symbol_9(0u, src_nested);
}
