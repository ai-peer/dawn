...
void main_1() {
  ...
  int x_52_phi = 0;
  float x_40 = x_6._.x_GLF_uniform_float_values[0].el;
  m32 = mat3x2(vec2(x_40, 0.0f), vec2(0.0f, x_40), vec2(0.0f));
  int x_45 = x_8._.x_GLF_uniform_int_values[0].el;
  if ((x_45 == 1)) {
    m32[3][x_45] = x_40;
  }
  ...
  while (true) {
    int x_53 = 0;
    int x_52 = x_52_phi;
    int x_56 = x_8._.x_GLF_uniform_int_values[2].el;
    if ((x_52 < x_56)) {
    } else {
      break;
    }
  ...
  float x_67 = x_6._.x_GLF_uniform_float_values[1].el;
  int x_69 = x_8._.x_GLF_uniform_int_values[1].el;
