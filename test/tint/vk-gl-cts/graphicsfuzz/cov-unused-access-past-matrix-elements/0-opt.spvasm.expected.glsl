...
void main_1() {
  ...
  int a = 0;
  int x_67_phi = 0;
  float x_44 = x_6._.x_GLF_uniform_float_values[1].el;
  vec3 x_48 = vec3(0.0f);
  m43 = mat4x3(vec3(x_44, 0.0f, 0.0f), vec3(0.0f, x_44, 0.0f), vec3(0.0f, 0.0f, x_44), vec3(0.0f));
  int x_51 = x_8._.x_GLF_uniform_int_values[0].el;
  int x_53 = x_8._.x_GLF_uniform_int_values[0].el;
  float x_55 = x_6._.x_GLF_uniform_float_values[0].el;
  m43[x_51][x_53] = x_55;
  float x_58 = x_6._.x_GLF_uniform_float_values[0].el;
  float x_60 = x_6._.x_GLF_uniform_float_values[0].el;
  float x_62 = x_6._.x_GLF_uniform_float_values[0].el;
  ...
  sums = tint_symbol_4;
  int x_65 = x_8._.x_GLF_uniform_int_values[0].el;
  i = x_65;
  x_67_phi = x_65;
  while (true) {
    int x_67 = x_67_phi;
    int x_73 = x_8._.x_GLF_uniform_int_values[3].el;
    if ((x_67 < x_73)) {
    } else {
      break;
    }
    int x_77 = x_8._.x_GLF_uniform_int_values[0].el;
    int x_79 = x_8._.x_GLF_uniform_int_values[0].el;
  ...
  int x_87 = x_8._.x_GLF_uniform_int_values[1].el;
  if ((x_87 == 1)) {
    a = 4;
    int x_92 = x_8._.x_GLF_uniform_int_values[2].el;
    int x_94 = x_8._.x_GLF_uniform_int_values[0].el;
    float x_96 = m43[4][x_94];
    float x_98 = sums[x_92].el;
    sums[x_92].el = (x_98 + x_96);
  }
  int x_102 = x_8._.x_GLF_uniform_int_values[1].el;
  float x_104 = sums[x_102].el;
  int x_106 = x_8._.x_GLF_uniform_int_values[0].el;
  float x_108 = sums[x_106].el;
  float x_111 = x_6._.x_GLF_uniform_float_values[2].el;
  if (((x_104 + x_108) == x_111)) {
    int x_117 = x_8._.x_GLF_uniform_int_values[0].el;
    int x_120 = x_8._.x_GLF_uniform_int_values[1].el;
    int x_123 = x_8._.x_GLF_uniform_int_values[1].el;
    int x_126 = x_8._.x_GLF_uniform_int_values[0].el;
    x_GLF_color = vec4(float(x_117), float(x_120), float(x_123), float(x_126));
  } else {
    int x_130 = x_8._.x_GLF_uniform_int_values[1].el;
