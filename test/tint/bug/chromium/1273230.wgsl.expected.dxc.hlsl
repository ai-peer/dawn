...
int tint_atomicLoad_1(uint offset) {
  int value = 0;
...
int tint_atomicAdd(uint offset, int value) {
...
void main_count_inner(uint3 GlobalInvocationID) {
  ...
  int triangleOffset = tint_atomicAdd((4u * i1), 1);
}
