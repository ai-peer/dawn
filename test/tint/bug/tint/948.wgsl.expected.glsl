...
void main_1() {
  ...
  tileUV.y = (1.0f - x_91);
  tileID = floor(tUV);
  vec2 x_101 = x_20._.spriteMapSize;
  sheetUnits = (vec2(1.0f) / x_101);
  float x_106 = x_20._.spriteCount;
  spriteUnits = (1.0f / x_106);
  vec2 x_111 = x_20._.stageSize;
  ...
  i = 0;
  {
    for(; (i < 2); i = (i + 1)) {
      ...
      if ((x_174 > 0.0f)) {
        ...
        f = 0.0f;
        {
          for(; (f < 8.0f); f = (f + 1.0f)) {
            ...
            float x_211 = x_20._.spriteCount;
      ...
      vec2 x_231 = x_20._.spriteMapSize;
