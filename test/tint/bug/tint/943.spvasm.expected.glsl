...
float mm_readA_i1_i1_(inout int row, inout int col) {
  ...
  float x_430 = 0.0f;
  int x_417 = x_48._.aShape.y;
  int x_419 = x_48._.aShape.z;
...
float mm_readB_i1_i1_(inout int row_1, inout int col_1) {
  ...
  float x_468 = 0.0f;
  int x_455 = x_48._.bShape.y;
  int x_457 = x_48._.bShape.z;
...
int getOutputFlatIndex_vi3_(inout ivec3 coords) {
  ivec3 x_99 = coords;
  int x_105 = x_48._.outShapeStrides.x;
  int x_107 = x_48._.outShapeStrides.y;
...
void main_1() {
  ...
  int param_19 = 0;
  int param_20 = 0;
  int x_67 = x_48._.aShape.y;
  dimAOuter_1 = x_67;
  int x_71 = x_48._.aShape.z;
  dimInner_1 = x_71;
  int x_75 = x_48._.bShape.z;
  dimBOuter_1 = x_75;
