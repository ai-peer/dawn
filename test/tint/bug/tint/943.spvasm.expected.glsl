...
float mm_readA_i1_i1_(inout int row, inout int col) {
  ...
  if (x_429) {
    ...
    int x_445 = col;
    int tint_symbol_5 = (((x_438 * x_439) + (x_441 * x_442)) + x_445);
    float x_448 = x_165.A[uint(tint_symbol_5)];
    x_430 = x_448;
  } else {
    x_430 = 0.0f;
  }
...
float mm_readB_i1_i1_(inout int row_1, inout int col_1) {
  ...
  if (x_467) {
    ...
    int x_482 = col_1;
    int tint_symbol_6 = (((x_475 * x_476) + (x_478 * x_479)) + x_482);
    float x_485 = x_185.B[uint(tint_symbol_6)];
    x_468 = x_485;
  } else {
    x_468 = 0.0f;
  }
  ...
  while (true) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        int x_316 = tileCol;
        int x_317 = inner;
        int tint_symbol_7 = (x_316 + x_317);
        float x_320 = mm_Bsub[uint(x_315)][uint(tint_symbol_7)];
        BCached[x_314] = x_320;
        {
          int x_322 = inner;
          inner = (x_322 + 1);
      ...
      while (true) {
        ...
        int x_336 = k;
        int tint_symbol_8 = (x_333 + x_334);
        float x_338 = mm_Asub[uint(tint_symbol_8)][uint(x_336)];
        ACached = x_338;
        innerCol_3 = 0;
        while (true) {
