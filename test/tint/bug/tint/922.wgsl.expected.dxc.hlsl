...
void main1() {
  ...
  const int tint_symbol = int(x_e15);
  const Mat4x3_ x_e18 = tint_symbol_4(global2, (48u * uint(tint_symbol)));
  t_PosMtx = x_e18;
  ...
  const Mat4x4_ x_e35 = tint_symbol_6(global, 0u);
  ...
  if ((x_e52.x == 2.0f)) {
    {
      ...
      const Mat4x2_ x_e64 = tint_symbol_9(global1, 0u);
  ...
  } else {
    {
      ...
      const Mat4x2_ x_e79 = tint_symbol_9(global1, 0u);
...
VertexOutput main_inner(float3 a_Position, float2 a_UV, float4 a_Color, float3 a_Normal, float a_PosMtxIdx) {
  ...
  const VertexOutput tint_symbol_13 = {x_e11, x_e13, x_e15};
  return tint_symbol_13;
}

tint_symbol_3 main(tint_symbol_2 tint_symbol_1) {
  const VertexOutput inner_result = main_inner(tint_symbol_1.a_Position, tint_symbol_1.a_UV, tint_symbol_1.a_Color, tint_symbol_1.a_Normal, tint_symbol_1.a_PosMtxIdx);
