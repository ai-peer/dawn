...
atomic_compare_exchange_weak_ret_type_1 tint_atomicCompareExchangeWeak_1(uint offset, int compare, int value) {
...
void main_inner(uint local_invocation_index) {
  ...
  {
    uint value = 42u;
    const atomic_compare_exchange_weak_ret_type r1 = tint_atomicCompareExchangeWeak(0u, 0u, value);
    const atomic_compare_exchange_weak_ret_type r2 = tint_atomicCompareExchangeWeak(0u, 0u, value);
    const atomic_compare_exchange_weak_ret_type r3 = tint_atomicCompareExchangeWeak(0u, 0u, value);
  }
  {
    int value = 42;
    const atomic_compare_exchange_weak_ret_type_1 r1 = tint_atomicCompareExchangeWeak_1(0u, 0, value);
    const atomic_compare_exchange_weak_ret_type_1 r2 = tint_atomicCompareExchangeWeak_1(0u, 0, value);
    const atomic_compare_exchange_weak_ret_type_1 r3 = tint_atomicCompareExchangeWeak_1(0u, 0, value);
  }
  {
    uint value = 42u;
