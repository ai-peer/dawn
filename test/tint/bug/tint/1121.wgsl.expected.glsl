...
layout(binding = 0, std430) buffer LightsBuffer_ssbo_0 {
  LightData lights[];
} lightsBuffer;
...
layout(binding = 0, std430) buffer tileLightId_block_ssbo_0 {
  Tiles inner;
} tileLightId;
...
layout(binding = 0, std140) uniform config_block_ubo_0 {
  Config inner;
} config;
