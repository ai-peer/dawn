...
float3x4 tint_symbol_6(uint offset) {
...
GammaTransferParams tint_symbol_8(uint offset) {
  ...
  const GammaTransferParams tint_symbol_14 = {asfloat(ext_tex_params[scalar_offset_3 / 4][scalar_offset_3 % 4]), asfloat(ext_tex_params[scalar_offset_4 / 4][scalar_offset_4 % 4]), asfloat(ext_tex_params[scalar_offset_5 / 4][scalar_offset_5 % 4]), asfloat(ext_tex_params[scalar_offset_6 / 4][scalar_offset_6 % 4]), asfloat(ext_tex_params[scalar_offset_7 / 4][scalar_offset_7 % 4]), asfloat(ext_tex_params[scalar_offset_8 / 4][scalar_offset_8 % 4]), asfloat(ext_tex_params[scalar_offset_9 / 4][scalar_offset_9 % 4]), ext_tex_params[scalar_offset_10 / 4][scalar_offset_10 % 4]};
  return tint_symbol_14;
}

float3x3 tint_symbol_10(uint offset) {
...
float3x2 tint_symbol_12(uint offset) {
...
ExternalTextureParams tint_symbol_4(uint offset) {
  const uint scalar_offset_17 = ((offset + 0u)) / 4;
  const uint scalar_offset_18 = ((offset + 4u)) / 4;
  const ExternalTextureParams tint_symbol_15 = {ext_tex_params[scalar_offset_17 / 4][scalar_offset_17 % 4], ext_tex_params[scalar_offset_18 / 4][scalar_offset_18 % 4], tint_symbol_6((offset + 16u)), tint_symbol_8((offset + 64u)), tint_symbol_8((offset + 96u)), tint_symbol_10((offset + 128u)), tint_symbol_12((offset + 176u))};
...
void main() {
  ...
  float4 red = textureLoadExternal(t, ext_tex_plane_1, tint_symbol, tint_symbol_4(0u));
  int2 tint_tmp_1;
  ...
  float4 green = textureLoadExternal(t, ext_tex_plane_1, tint_symbol_2, tint_symbol_4(0u));
  int2 tint_tmp_3;
