...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build@9e67e4f778c1cef09915349007e292af2f1e06d3',
    'condition': 'dawn_standalone',
  },
  'buildtools': {
    'url': '{chromium_git}/chromium/src/buildtools@466954eda391b83e90f8b925767e6152318d690b',
    'condition': 'dawn_standalone',
  },
  ...
  # WGSL support
  'third_party/tint': {
    'url': '{dawn_git}/tint@e6d171ac668e5cee00b9bf074416f9ea3b56d05f',
  },
  ...
  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@6cbd7212ad426ce8ccdb61fb8b6007d3b7ab5de6',
    'condition': 'dawn_standalone',
  },
...
hooks = [
  ...
  {
    # Download LLD on mac because it is not included in the default clang bundle.
    # Download it separately. This should run after the clang hook.
    'name': 'lld_mac',
    'pattern': '.',
