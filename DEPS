...
deps = {
  ...
  # WGSL support
  'third_party/tint': {
    'url': '{dawn_git}/tint@c6d8cadd3300543542f4a9074701ae5347131b98',
  },
...
hooks = [
  ...
  },
  {
    ...
    'pattern': '.',
    'action': [ 'git', '-C', 'third_party/tint/',
                'fetch', 'https://dawn.googlesource.com/tint', 'c4bd57d8646590ca514da293a235ec8eaaf592c1',
    ],
  },
  {
