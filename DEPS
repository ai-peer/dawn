...
deps = {
  ...
  'third_party/glslang': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/glslang@4508a8170a8f62ede770fb1da34c1cc600e0c596',
    'condition': 'dawn_standalone',
  },
  'third_party/shaderc': {
    'url': '{chromium_git}/external/github.com/google/shaderc@a84571caead1f963701fd6ff859a32c4b2d5a702',
    'condition': 'dawn_standalone',
  },
