...
deps = {
  ...
  # The //build, //tools/clang, and //tools/rust should all be updated together, as they
  # have depedencies between them.
  'build': {
    'url': '{chromium_git}/chromium/src/build@38fc65ec5354f2cae7580aacea7345dbb26c9689',
    'condition': 'dawn_standalone',
  },
  'tools/clang': {
    'url': '{chromium_git}/chromium/src/tools/clang@ceb8145f558999832ded3df3232f49f1dec0bdfd',
    'condition': 'dawn_standalone',
  },
  'tools/rust': {
  ...
  'third_party/angle': {
    'url': '{chromium_git}/angle/angle@aef9a1b3160dcdf1c6327aa138ef0def9a1c4bd1',
    'condition': 'dawn_standalone',
  },

  'third_party/swiftshader': {
    'url': '{swiftshader_git}/SwiftShader@91b84ac6d8eae53bb105975db11325d11f214b79',
    'condition': 'dawn_standalone',
  },

  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@3d986ea7a169236e419032154c27928627e96563',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/dxc': {
    'url': '{chromium_git}/external/github.com/microsoft/DirectXShaderCompiler@1a4ff5c147722af77d77ffdeb4685934b87e3947',
  },
