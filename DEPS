...
deps = {
  ...
  # have moved to third_party/libcxx/lib*/src paths.
  ...
  'third_party/libcxx/libc++/src': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libcxx.git@0e4617cf8c09a8e2b6704a51a8a0a9560715cf70',
    'condition': 'dawn_standalone',
  },

  'third_party/libcxx/libc++abi/src': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libcxxabi.git@307bd163607c315d46103ebe1d68aab44bf93986',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/angle': {
    'url': '{chromium_git}/angle/angle@b53d99d87e6ae4865b64a4110e4d4a86ecb40e28',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@5adeb7151c790984536a708200e917df1a38aedf',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/dxc': {
    'url': '{chromium_git}/external/github.com/microsoft/DirectXShaderCompiler@212a2bf3c3e117236e9ab795afe905e4fd497158',
  },
