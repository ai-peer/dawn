...
deps = {
  ...
  'third_party/glslang': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/glslang@834ee546f93d33a80fb2dea6fdef6764f8730b75',
    'condition': 'dawn_standalone',
  },
  'third_party/shaderc': {
  ...
  # TODO(hao.x.li): add condition for linux once segmentation fault is resolved.
