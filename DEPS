...
vars = {
  ...
  # The path that contains this file. On Dawn builders on Dawn CQ, this is set
  # to 'dawn'.
  'dawn_root': '.',
...
# Export variables used by chromium's //build GN files. In regular Dawn builds
# the path i
gclient_gn_args_file = Var('dawn_root') + '/build/config/gclient_args.gni'
gclient_gn_args = [
  'mac_xcode_version',
]
