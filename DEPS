...
deps = {
  ...
  # WGSL support
  'third_party/tint': {
    'url': '{dawn_git}/tint@4cfa725fb3297d1ed83df9282360e0d6b1bf7e85',
  },
  ...
  'third_party/angle': {
    'url': '{chromium_git}/angle/angle@5debe6156f57d86ff8d19f6a7714b81418322ba8',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@refs/heads/chromium/4708',
    'condition': 'dawn_standalone',
  },
