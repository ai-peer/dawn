...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build@5aa939d2691b2ee756068a8f474683c60c3551d0',
  ...
  # WGSL support
  'third_party/tint': {
    'url': '{dawn_git}/tint@d9d08aecf4df1216da00d92b813319a2a0df17e7',
  },
  ...
  'third_party/angle': {
    'url': '{chromium_git}/angle/angle@09f55382dac4e57d820746bcc742202ef73f05ae',
    'condition': 'dawn_standalone',
  },
