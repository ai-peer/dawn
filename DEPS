...
deps = {
  ...
  'third_party/angle': {
    'url': '{chromium_git}/angle/angle@c31e783fb8456cf913bc0ac0f75bd8b2d754829b',
    'condition': 'dawn_standalone',
  },

  'third_party/swiftshader': {
    'url': '{swiftshader_git}/SwiftShader@cfcb44322bccc5212d6cb0d850dd4b94f272f4f9',
    'condition': 'dawn_standalone',
  },

  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@4e67065f9f8eedd2faad1c85a505ffadcd148e9d',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/webgpu-cts': {
    'url': '{chromium_git}/external/github.com/gpuweb/cts@5a30cb44c56ae83fb3b88f5a3e9ce6b5a342e9d6',
