...
If the full set of optimization flags isn't needed for testing, building the `dawn_perf_tests` target from a Dawn checkout will also work. For more information on building, please see [building.md](./building.md).
