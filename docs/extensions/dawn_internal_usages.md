...
The `dawn-internal-usages` extension allows adding additional usage which affects how a buffer or texture is allocated, but does not affect frontend validation.
