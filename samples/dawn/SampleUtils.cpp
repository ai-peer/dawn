...
wgpu::Device CreateCppDawnHeadlessDevice() {
    ...
    // Enabled disallowing unsafe APIs so we can test them.
    // --enable-dawn-features=record_detailed_timing_in_trace_events,disable_timestamp_query_conversion
    forceEnabledToggles.push_back("record_detailed_timing_in_trace_events");
    forceEnabledToggles.push_back("disable_timestamp_query_conversion");
