...
#    define PIXSetCPUMarkerOnContext(context, metadata, ...) \
        MakeCPUSetMarkerForContext(metadata, context, __VA_ARGS__)
#    define PIXBeginCPUEventOnContext(context, metadata, ...) \
        MakeCPUBeginEventForContext(metadata, context, __VA_ARGS__)
