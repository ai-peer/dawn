...
//
#    if (!defined(USE_PIX)) &&                                                 \
        ((defined(_DEBUG) || DBG || (defined(PROFILE) && !defined(FASTCAP)) || \
          defined(PROFILE_BUILD)) &&                                           \
         !defined(i386) && defined(_AMD64_) && !defined(_PREFAST_))
#        define USE_PIX
#    endif
...
extern "C" HRESULT WINAPI PIXBeginCapture(DWORD captureFlags,
