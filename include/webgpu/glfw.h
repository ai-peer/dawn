...
WGPU_EXPORT wgpu::Surface CreateSurfaceForWindow(const wgpu::Instance& instance,
                                                 GLFWwindow* window);
...
WGPU_EXPORT std::unique_ptr<wgpu::ChainedStruct> SetupWindowAndGetSurfaceDescriptor(
    GLFWwindow* window);
