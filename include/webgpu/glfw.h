...
#ifndef INCLUDE_WEBGPU_GLFW_H_
#define INCLUDE_WEBGPU_GLFW_H_
...
WGPU_EXPORT wgpu::Surface CreateSurfaceForWindow(const wgpu::Instance& instance, GLFWwindow* window);
...
WGPU_EXPORT std::unique_ptr<wgpu::ChainedStruct> SetupWindowAndGetSurfaceDescriptor(GLFWwindow* window);

}  // namespace wgpu::glfw

#endif  // INCLUDE_WEBGPU_GLFW_H_
