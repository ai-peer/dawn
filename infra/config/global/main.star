...
def dawn_standalone_builder(name, clang, debug, fuzzer, cpu):
...
#                        name, clang, debug, fuzzer, cpu
dawn_standalone_builder("linux-clang-dbg-x64", True, True, False, "x64")
dawn_standalone_builder("linux-clang-dbg-x86", True, True, False, "x86")
dawn_standalone_builder("linux-clang-rel-x64", True, False, False, "x64")
dawn_standalone_builder("linux-clang-rel-x86", True, False, False, "x86")
dawn_standalone_builder("mac-dbg", True, True, False, "x64")
dawn_standalone_builder("mac-rel", True, False, False, "x64")
dawn_standalone_builder("win-clang-dbg-x64", True, True, False, "x64")
dawn_standalone_builder("win-clang-dbg-x86", True, True, False, "x86")
dawn_standalone_builder("win-clang-rel-x64", True, False, False, "x64")
dawn_standalone_builder("win-clang-rel-x86", True, False, False, "x86")
dawn_standalone_builder("win-msvc-dbg-x64", False, True, False, "x64")
dawn_standalone_builder("win-msvc-rel-x64", False, False, False, "x64")
dawn_standalone_builder("cron-linux-clang-rel-x64", True, False, True, "x64")
