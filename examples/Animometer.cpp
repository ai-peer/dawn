...
void init() {
    ...
    // we need to set descriptor.depthStencilState directly. Vaules set in
    // cDepthStencilState don't work. Because descriptor.depthStencilState
    // doesn't point to cDepthStencilState
