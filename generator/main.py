...
def get_renders_for_targets(api_params, wire_json, targets):
    ...
    if 'dawn_wire' in targets:
        ...
        renders.append(FileRender('dawn_wire/client/CommandDoers.cpp', 'dawn_wire/client/CommandDoers_autogen.cpp', wire_params))
        renders.append(FileRender('dawn_wire/client/CommandHandlers.cpp', 'dawn_wire/client/CommandHandlers_autogen.cpp', wire_params))
