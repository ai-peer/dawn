...
class Record:
    ...
    def update_metadata(self):
        ...
        # set may_have_dawn_object to true if the type is chained or extensible.
        # Chained structs may contain a Dawn object.
...
# Sort structures so that if struct A has struct B as a member, then B is listed
# before A.
#
