...
class StructureType(Record, Type):
    def __init__(self, name, json_data):
        ...
        # Chained structs inherit from wgpu::SubDescriptor which has nextInChain so setting
        # both extensible and sub_descriptor would result in two nextInChain members.
