...
class MultiGeneratorFromDawnJSON(Generator):
    ...
    def get_file_renders(self, args):
        ...
        if 'mock_webgpu' in targets:
            renders.append(FileRender('mock_webgpu.h', 'src/dawn/mock_webgpu.h', [base_params, api_params]))
            renders.append(FileRender('mock_webgpu.cpp', 'src/dawn/mock_webgpu.cpp', [base_params, api_params]))
