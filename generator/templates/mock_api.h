...
class ProcTableAsClass {
    public:
        ...
        void DeviceCreateBufferMappedAsync(dawnDevice self, const dawnBufferDescriptor* descriptor, dawnCreateBufferMappedCallback callback, dawnCallbackUserdata userdata);
        ...
        virtual void OnDeviceCreateBufferMappedAsyncCallback(dawnDevice device,
        ...
        void CallDeviceCreateBufferMappedAsyncCallback(dawnDevice device, dawnBuffer buffer, dawnBufferMapAsyncStatus status, void* data, uint32_t dataLength);
        ...
        struct Object {
            ...
            dawnCreateBufferMappedCallback deviceCreateBufferMappedAsyncCallback = nullptr;
    ...
    public:
        ...
        MOCK_METHOD4(OnFenceOnCompletionCallback,
                     void(dawnFence fence,
                          ...
                          dawnFenceOnCompletionCallback callback,
                          dawnCallbackUserdata userdata));
        MOCK_METHOD4(OnDeviceCreateBufferMappedAsyncCallback,
                     void(dawnDevice device,
                          const dawnBufferDescriptor* descriptor,
                          dawnCreateBufferMappedCallback callback,
                          dawnCallbackUserdata userdata));
};
