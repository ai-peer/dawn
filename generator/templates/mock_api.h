...
class ProcTableAsClass {
    public:
        ...
        void DeviceSetUncapturedErrorCallback(DawnDevice self,
                                    ...
                                    void* userdata);
        void DevicePopErrorScope(DawnDevice self, DawnErrorCallback callback, void* userdata);
        ...
        virtual void OnDeviceSetUncapturedErrorCallback(DawnDevice device,
                                              DawnErrorCallback callback,
                                              void* userdata) = 0;
        virtual void OnDevicePopErrorScopeCallback(DawnDevice device,
                                              DawnErrorCallback callback,
                                              void* userdata) = 0;
...
class MockProcTable : public ProcTableAsClass {
    public:
        ...
        MOCK_METHOD3(OnDevicePopErrorScopeCallback, void(DawnDevice device, DawnErrorCallback callback, void* userdata));
