...
namespace dawn_native {
    ...
    {% set pure_frontend_types = ["command encoder", "compute pass encoder", "fence", "render pass encoder", "render bundle encoder"] %}
    ...
    {% for type in by_category["object"] %}
        {% if type.name.canonical_case() not in skip_types and type.name.canonical_case() not in pure_frontend_types %}
            ...
            AbslFormatConvert(const {{as_frontendType(type)}} value,
                                ...
                                absl::FormatSink* s);
        {% endif %}
        {% if type.name.canonical_case() in pure_frontend_types %}
            class {{type.name.CamelCase()}};
            absl::FormatConvertResult<absl::FormatConversionCharSet::kString>
            AbslFormatConvert(const {{type.name.CamelCase()}}* value,
                                const absl::FormatConversionSpec& spec,
                                absl::FormatSink* s);
        {% endif %}
    {% endfor %}
