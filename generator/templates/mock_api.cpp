...
void ProcTableAsClass::DevicePopErrorScope(DawnDevice self, DawnErrorCallback callback, void* userdata) {
    OnDevicePopErrorScopeCallback(self, callback, userdata);
}
