...
void ProcTableAsClass::DeviceCreateBufferMappedAsync(
        dawnDevice self,
        const dawnBufferDescriptor* descriptor,
        dawnCreateBufferMappedCallback callback,
        dawnCallbackUserdata userdata) {
    auto object = reinterpret_cast<ProcTableAsClass::Object*>(self);
    object->deviceCreateBufferMappedAsyncCallback = callback;
    object->userdata1 = userdata;
...
void ProcTableAsClass::CallDeviceCreateBufferMappedAsyncCallback(
        dawnDevice device,
        dawnBuffer buffer,
        ...
        uint32_t dataLength) {
    auto object = reinterpret_cast<ProcTableAsClass::Object*>(device);
    object->deviceCreateBufferMappedAsyncCallback(buffer, status, data, dataLength, object->userdata1);
}
