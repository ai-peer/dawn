...
typedef void (*dawnCreateBufferMappedCallback)(dawnBuffer buffer, dawnBufferMapAsyncStatus status, void* data, uint32_t dataLength, dawnCallbackUserdata userdata);
