...
#ifndef DAWNWIRE_CLIENT_WIRECLIENTBASE_AUTOGEN_H_
#define DAWNWIRE_CLIENT_WIRECLIENTBASE_AUTOGEN_H_

#include "dawn_wire/WireCmd_autogen.h"
#include "dawn_wire/client/WireClientObjects.h"
#include "dawn_wire/client/WireClientObjectAllocator.h"

namespace dawn_wire {
    namespace client {
        template <typename Derived>
        class WireClientBase : public ObjectIdProvider {
          Derived* mDerived;
          ...
          public:
            WireClientBase()
              ...
              {% for type in by_category["object"] %}
                  , m{{type.name.CamelCase()}}Allocator(mDerived)
              {% endfor %} {
            }
...
#endif  // DAWNWIRE_CLIENT_WIRECLIENTBASE_AUTOGEN_H_
