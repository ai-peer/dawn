...
class MockProcTable : public ProcTableAsClass {
    public:
        ...
        MOCK_METHOD(void, OnDeviceCreateBufferMappedAsyncCallback, (WGPUDevice device, const WGPUBufferDescriptor* descriptor, WGPUBufferCreateMappedCallback callback, void* userdata), (override));
