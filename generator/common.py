...
class StructureType(Type):
    ...
    def update_metadata(self):
        ...
        self.has_dawn_object = reduce(lambda acc, curr: acc or has_dawn_object(curr), self.members, False)

class CommandType(StructureType):
    def __init__(self, name, json_data):
        StructureType.__init__(self, name, json_data)
