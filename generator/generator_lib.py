...
def run_generator(generator):
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Name of the "JSON tarball" to create (tar is too annoying to use in python).'
    )
    parser.add_argument(
        '--depfile',
        default=None,
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help='Optional source root directory for Python dependency computations'
    )
    parser.add_argument(
        ...
        type=str,
        help=
        "File containing a list of allowed directories where files can be output."
    )
    parser.add_argument(
        ...
        action="store_true",
        help=
        "Prints a semi-colon separated list of dependencies to stdout and exits."
    )
    parser.add_argument(
        '--print-cmake-outputs',
        default=False,
        action="store_true",
        help=
        "Prints a semi-colon separated list of outputs to stdout and exits.")
    ...
    if args.allowed_output_dirs_file != None:
        ...
        for directory in allowed_dirs:
            if not directory.endswith('/'):
                print(
                    'Allowed directory entry "{}" doesn\'t end with /'.format(
                        directory))
                return 1
        ...
        for render in renders:
            if not any(
                    ...
                    for directory in allowed_dirs):
                print(
                    'Output file "{}" is not in the allowed directory list below:'
