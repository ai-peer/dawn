 ...
 * This will be contributed back to Emscripten after reaching approximately
 * webgpu.h "1.0".
 *
 * IMPORTANT: Requires the following files to be passed as
 * additional --js-library arguments before this one:
 * - library_webgpu_enum_tables.js
 * - library_webgpu_webgpu_struct_info.js
 *
 * To "test" this, check out Skia, update its third_party/externals/dawn repo,
 * and follow the build instructions in modules/canvaskit, except use
 * `make release_webgpu` to build with WebGPU enabled:
 * https://skia.googlesource.com/skia/+/refs/heads/main/modules/canvaskit
 */

{{{
  if (USE_WEBGPU || !C_STRUCTS.__HAVE_DAWN_WEBGPU_STRUCT_INFO || !__HAVE_DAWN_WEBGPU_ENUM_TABLES) {
