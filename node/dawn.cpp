...
class Device : public Napi::ObjectWrap<Device> {
            ...
            DefineClass(env, "Device",
                        {
                            ...
                            // TODO: flush shouldn't be exposed
  ...
  public:
    ...
    void init() {
        {
            utils::BackendBinding* binding = utils::CreateBinding(utils::BackendType::Vulkan);
            assert(binding);
            ...
            dawn_wire::CommandHandler* wireServer =
                dawn_wire::NewServerCommandHandler(backendDevice, backendProcs, s2cBuf);
            c2sBuf->SetHandler(wireServer);

            dawnDevice clientDevice;
            dawnProcTable clientProcs;
            dawn_wire::CommandHandler* wireClient =
                dawn_wire::NewClientDevice(&clientProcs, &clientDevice, c2sBuf);
            ...
            mDevice = dawn::Device::Acquire(cDevice);
        }
  ...
  private:
    ...
    utils::TerribleCommandBuffer* c2sBuf = nullptr;
    utils::TerribleCommandBuffer* s2cBuf = nullptr;
